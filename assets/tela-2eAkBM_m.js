    ...
    <div class="cartao cartao--com-acao" ?data-favorito=${t}>
      ...
      >
        <span class="cartao__topo">
          ...
          ${e.local?c`<kk-badge variant="success" pill>${s.acervo.meu}</kk-badge>`:u}
        </span>
