import{ct as e,gt as t,it as n,m as r,u as i}from"./index-EsbOy3qu.js";import{t as a}from"./qr-BWyZ-des.js";var o=`https://luizcmarin.github.io/kobi-note`;function s(e=o){return`${n.convite.mensagem}\n\n${e}`}function c(e){return`https://wa.me/?text=${encodeURIComponent(s(e))}`}async function l(e){try{await navigator.clipboard.writeText(s(e)),i(n.convite.copiado)}catch{i(n.leitura.semCopiar,`warning`)}}async function u(e){if(typeof navigator.share!=`function`){await l(e);return}try{await navigator.share({title:t.displayName,text:n.convite.mensagem,url:e})}catch{}}function d(){let i=o;return a(),r(n.convite.titulo,void 0,(r,a)=>e`
        <div class="convite">
          <img
