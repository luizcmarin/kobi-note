...
`,Fv,Iv,Lv,Rv,zv,Bv,Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv,Xv,Zv,Qv,$v,ey,ty,ny,ry,iy,ay,oy,sy,cy,ly,Q,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Ay,jy,My,Ny,Py,$=class extends (ly=M,cy=[A(`.textarea__control`)],sy=[k()],oy=[O()],ay=[O()],iy=[O()],ry=[O({reflect:!0})],ny=[O({type:Boolean,reflect:!0})],ty=[O()],ey=[O({attribute:`help-text`})],$v=[O()],Qv=[O({type:Number})],Zv=[O()],Xv=[O({type:Boolean,reflect:!0})],Yv=[O({type:Boolean,reflect:!0})],Jv=[O({reflect:!0})],qv=[O({type:Boolean,reflect:!0})],Kv=[O({type:Number})],Gv=[O({type:Number})],Wv=[O()],Uv=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],Hv=[O()],Vv=[O({type:Boolean})],Bv=[O()],zv=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],Rv=[O()],Lv=[co()],Iv=[j(`disabled`,{waitUntilFirstUpdate:!0})],Fv=[j(`value`,{waitUntilFirstUpdate:!0})],ly){constructor(){super(...arguments),m(Q,5,this),g(this,`formControlController`,new Ro(this,{assumeInteractionOn:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new Js(this,`help-text`,`label`)),_(this,uy,m(Q,8,this)),m(Q,11,this),_(this,dy,m(Q,12,this,!1)),m(Q,15,this),_(this,fy,m(Q,16,this,``)),m(Q,19,this),_(this,py,m(Q,20,this,``)),m(Q,23,this),_(this,my,m(Q,24,this,``)),m(Q,27,this),_(this,hy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,gy,m(Q,32,this,!1)),m(Q,35,this),_(this,_y,m(Q,36,this,``)),m(Q,39,this),_(this,vy,m(Q,40,this,``)),m(Q,43,this),_(this,yy,m(Q,44,this,``)),m(Q,47,this),_(this,by,m(Q,48,this,4)),m(Q,51,this),_(this,xy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Sy,m(Q,56,this,!1)),m(Q,59,this),_(this,Cy,m(Q,60,this,!1)),m(Q,63,this),_(this,wy,m(Q,64,this,``)),m(Q,67,this),_(this,Ty,m(Q,68,this,!1)),m(Q,71,this),_(this,Ey,m(Q,72,this)),m(Q,75,this),_(this,Dy,m(Q,76,this)),m(Q,79,this),_(this,Oy,m(Q,80,this)),m(Q,83,this),_(this,ky,m(Q,84,this,!0)),m(Q,87,this),_(this,Ay,m(Q,88,this)),m(Q,91,this),_(this,jy,m(Q,92,this)),m(Q,95,this),_(this,My,m(Q,96,this)),m(Q,99,this),_(this,Ny,m(Q,100,this,!0)),m(Q,103,this),_(this,Py,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
    ...
    `}};Q=f(ly),uy=new WeakMap,dy=new WeakMap,fy=new WeakMap,py=new WeakMap,my=new WeakMap,hy=new WeakMap,gy=new WeakMap,_y=new WeakMap,vy=new WeakMap,yy=new WeakMap,by=new WeakMap,xy=new WeakMap,Sy=new WeakMap,Cy=new WeakMap,wy=new WeakMap,Ty=new WeakMap,Ey=new WeakMap,Dy=new WeakMap,Oy=new WeakMap,ky=new WeakMap,Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,h(Q,4,`input`,cy,$,uy),h(Q,4,`hasFocus`,sy,$,dy),h(Q,4,`title`,oy,$,fy),h(Q,4,`name`,ay,$,py),h(Q,4,`value`,iy,$,my),h(Q,4,`size`,ry,$,hy),h(Q,4,`filled`,ny,$,gy),h(Q,4,`label`,ty,$,_y),h(Q,4,`helpText`,ey,$,vy),h(Q,4,`placeholder`,$v,$,yy),h(Q,4,`rows`,Qv,$,by),h(Q,4,`resize`,Zv,$,xy),h(Q,4,`disabled`,Xv,$,Sy),h(Q,4,`readonly`,Yv,$,Cy),h(Q,4,`form`,Jv,$,wy),h(Q,4,`required`,qv,$,Ty),h(Q,4,`minlength`,Kv,$,Ey),h(Q,4,`maxlength`,Gv,$,Dy),h(Q,4,`autocapitalize`,Wv,$,Oy),h(Q,4,`autocorrect`,Uv,$,ky),h(Q,4,`autocomplete`,Hv,$,Ay),h(Q,4,`autofocus`,Vv,$,jy),h(Q,4,`enterkeyhint`,Bv,$,My),h(Q,4,`spellcheck`,zv,$,Ny),h(Q,4,`inputmode`,Rv,$,Py),h(Q,1,`handleDisabledChange`,Iv,$),h(Q,1,`handleValueChange`,Fv,$),h(Q,5,`defaultValue`,Lv,$),p(Q,$),g($,`styles`,[D,sp,Pv]),$.define(`kk-textarea`),ee(`./ui`);var Fy=document.querySelector(`#app`);function Iy(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:li({executar:()=>void Gy(!0),ocupado:Hy})};let t=Wt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Pr()};if(Ly[t.id]===void 0||!Kt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Nr(t)};let n=Vy.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Ir(n)};let r=Ry.get(t.id);return r===void 0?(By(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Fr()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var Ly={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-ja2eN4hr.js`);return{telaAnotacoes:e}},__vite__mapDeps([20,5,3,4,21,22,23]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-DzZNcDD9.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-622BqHAR.js`);return{telaCalendario:e}},__vite__mapDeps([24,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-D2PIi5x6.js`);return{telaCriacao:e}},__vite__mapDeps([25,4,22,21,26,27,28,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-D2PIi5x6.js`);return{telaCriacao:e}},__vite__mapDeps([25,4,22,21,26,27,28,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-BUrRsf8O.js`);return{telaFaq:e}},__vite__mapDeps([29,4,30,31,21,22,27]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-DJuZwqEO.js`);return{telaImite:e}},__vite__mapDeps([32,21,22,27]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-BBBrwy6V.js`);return{telaCronologia:e}},__vite__mapDeps([33,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-CZsgQzdo.js`);return{telaEstudo:e}},__vite__mapDeps([34,11,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-ByLe1T9M.js`);return{telaFinanceiro:e}},__vite__mapDeps([35,8,9,26,22,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-euIfhj0S.js`);return{telaGuias:e}},__vite__mapDeps([36,4,5,21,22,23,37,14]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-CT2G3cEq.js`);return{telaJogo:e}},__vite__mapDeps([38,4,21,22]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-Bhu_3UGN.js`);return{telaLeitura:e}},__vite__mapDeps([39,40]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-PeffKvav.js`);return{telaMetas:e}},__vite__mapDeps([41,10,9,8,4,5]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-nq0xa9Gt.js`);return{telaMinisterio:e}},__vite__mapDeps([42,37,12,4,5]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-Nvs2ZCQQ.js`);return{telaPerfil:e}},__vite__mapDeps([43,4,37,19]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-D6ejlzmH.js`);return{telaPoesia:e}},__vite__mapDeps([44,4,5,31,21,22,23,37,14]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-DQsuJGhh.js`);return{telaPrep:e}},__vite__mapDeps([45,9,4,17,16,5,15]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-DGG9g6EZ.js`);return{telaPrincipios:e}},__vite__mapDeps([46,4,30,31,21,22,27]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-W-3b7Iv6.js`);return{telaReceitas:e}},__vite__mapDeps([47,5,31,21,22,23,37,14,13,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-BjYjAUJ0.js`);return{telaServico:e}},__vite__mapDeps([48,10,9,8,4,5]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-DDcqHnIz.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-mmNac-0I.js`);return{telaTutorial:e}},__vite__mapDeps([49,4,21,22,50]),import.meta.url)).telaTutorial},Ry=new Map,zy=new Set;function By(e){let t=Ly[e];t===void 0||Ry.has(e)||zy.has(e)||(zy.add(e),t().then(t=>{Ry.set(e,t),Uy()}).catch(t=>{zy.delete(e),Vy.set(e,String(t)),Uy()}))}var Vy=new Map,Hy=!1;function Uy(){if(Fy===null)return;let e=Wy,{cabecalho:t,conteudo:n}=Iy(e);document.title=e.modulo===`home`?l.displayName:`${t.titulo} — ${l.displayName}`,Ct(tr(t,n,Uy),Fy),Zn()}var Wy={modulo:`home`,args:[],query:new URLSearchParams};async function Gy(e){if(!Hy){Hy=!0,Uy();try{let t=await Rn();if(!e)return;t.ok?hi(x.home.sincronizado(t.atualizados.length)):hi(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{Hy=!1,Uy()}}}function Ky(){Fy!==null&&Ct(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
