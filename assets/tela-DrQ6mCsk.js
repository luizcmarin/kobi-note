import{$ as e,at as t,ct as n,ft as r,it as i,tt as a,u as o,ut as s}from"./index-BBOYxO_i.js";import{salvarMeta as c}from"./dados-BL0H4DC9.js";var l=4.348,u=[{chave:`publicador`,nome:`Publicador`,horasMes:0,resumo:`Sem cota de horas — o que se relata é a participação.`},{chave:`auxiliar`,nome:`Pioneiro auxiliar`,horasMes:30,resumo:`Um mês por vez, ao lado do trabalho ou do estudo.`},{chave:`regular`,nome:`Pioneiro regular`,horasMes:50,resumo:`O ano de serviço inteiro, como rotina de vida.`},{chave:`especial`,nome:`Pioneiro especial`,horasMes:100,resumo:`Designação de tempo integral, sustentada pela organização.`}];function d(e){return u.find(t=>t.chave===e)??u[0]}var f=[`Dom`,`Seg`,`Ter`,`Qua`,`Qui`,`Sex`,`Sáb`];function p(e){let t=Math.max(1,e.meses),n=Math.max(0,e.totalHoras),r=e.dias.length,i=n/t,a=i/l,o=r*l,s=r===0?0:a/r;return{porMes:i,porSemana:a,porAno:i*12,porSaida:s,saidasPorMes:o,saidasTotais:Math.round(o*t),inviavel:s>10}}function m(e){if(!Number.isFinite(e)||e<=0)return`0 min`;let t=Math.round(e*60),n=Math.floor(t/60),r=t%60;return n===0?`${r} min`:r===0?`${n} h`:`${n} h ${r} min`}function h(e,t,n){let r=new Date(e,t,1),i=new Date(e,t+1,0).getDate(),a=r.getDay(),o=new Set(n),s=[];for(let n=0;n<42;n++){let r=n-a+1,c=r>=1&&r<=i;s.push({dia:c?r:0,fora:!c,deServico:c&&o.has(new Date(e,t,r).getDay())})}return s}function g(e,t){let n=new Date(e,t,1).toLocaleDateString(`pt-BR`,{month:`long`,year:`numeric`});return n.charAt(0).toUpperCase()+n.slice(1)}function _(e,t,n){return h(e,t,n).filter(e=>e.deServico).length}function v(t,n,r=new Date){let i=new Date(r.getFullYear(),r.getMonth()+Math.max(1,t.meses),0);return{titulo:n,item:`min_horas`,ativo_nome:``,data_meta:r.getTime(),prazo_final:a(e(i)),progresso_atual:0,progresso_alvo:Math.round(t.totalHoras),esta_concluida:0}}var y=[0,3],b=`regular`,x=600,S=12,C=[...y],w=0,T=!1,E=!1;function D(){return{totalHoras:x,meses:S,dias:C}}function O(e){b=e;let t=d(e).horasMes;t>0&&(x=t*S),E=!1,i()}function k(e){let t=d(b).horasMes;S=e,t>0&&(x=t*e),E=!1,i()}function A(e){C=C.includes(e)?C.filter(t=>t!==e):[...C,e].sort(),E=!1,i()}function j(e,t,n,i,a,o,s){return r`
  ...
  `;return r`
    <section class="servico__bloco">
      ...
      ${e.inviavel?r`<kk-alert variant="danger" open>${n.servico.inviavel}</kk-alert>`:s}
    </section>
  `}function F(){let e=p(D()),t=new Date,a=new Date(t.getFullYear(),t.getMonth()+w,1),o=a.getFullYear(),c=a.getMonth(),l=_(o,c,C),u=l===0?0:e.porMes/l;return r`
    <section class="servico__bloco">
      ...
      <div class="servico__grade">
        ...
        ${h(o,c,C).map(e=>r`
            ...
            >
              ${e.fora?``:e.dia}
              ${e.deServico?r`<small>${m(u)}</small>`:s}
            </span>
          `)}
      </div>
  ...
  `}function I(){T||(T=!0,i(),(async()=>{try{await c(v(D(),n.servico.tituloDaMeta(d(b).nome))),E=!0}catch(e){console.error(`servico: o registro da meta falhou.`,e),o(n.servico.naoGravada,`danger`)}finally{T=!1,i()}})())}function L(){return r`
    <section class="servico__bloco">
      ...
      ${E?r`
            <kk-alert variant="success" open>
              ${n.servico.gravada}
              <kk-button size="small" variant="success" @click=${()=>t(`metas`)}>
                ${n.servico.verMetas}
              </kk-button>
            </kk-alert>
          `:s}
  ...
  `}var R={voltarPara:()=>`ministerio`,conteudo(e){let t=p(D());return r`
      <div class="servico">
        ...
        <section class="servico__bloco">
          ${j(n.servico.alvo,n.servico.alvoValor(x),0,2400,10,x,e=>{x=e,E=!1,i()})}
