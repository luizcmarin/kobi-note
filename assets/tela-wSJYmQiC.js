import{ct as e,et as t,it as n,ot as r}from"./index-7-UXbWO3.js";import{VISOES as i,alternarCapitulo as a,alternarDia as o,capituloLido as s,capitulosDe as c,capitulosDoGrupo as l,detalheDoLivro as u,diasLidos as d,itensDaVisao as f,lerCelebracao as p,lerLidos as m,lerVisao as h,lidosDoGrupo as g,lidosDoLivro as _,livroCompleto as v,livrosConcluidos as y,marcarLivro as b,n as x,percentualCelebracao as S,percentualDoLivro as C,percentualGeral as w,r as T,salvarVisao as E,t as D,totalLidos as O}from"./dados-CrToLRPu.js";var k=new Map,A=new Set,j=`canonica`,M=null,N=!1;function P(){N||(N=!0,k=m(),A=p(),j=h())}function F(e){j=e,M=null,E(e),t()}function I(t){return e`
  ...
  `}function R(r){let i=c(r);return e`
    <div class="capitulos">
  ...
  `}function z(n){let i=M===n,a=v(k,n),o=u(j,n);return e`
    <div class="livro" ?data-completo=${a}>
      ...
      ${o===``?r:e`<span class="livro__detalhe">${o}</span>`}
      ${I(C(k,n))}
      ${i?R(n):r}
    </div>
  ...
  `}function U(){let r=S(A);return e`
    ...
    <div class="livros">
      ${x.map(n=>{let r=A.has(n.id);return e`
            ...
            >
              ...
              <span class="dia__texto">
                ...
                <span class="dia__leituras">
                  ${n.leituras.map(t=>e`<kk-badge variant="success" pill>${t}</kk-badge>`)}
                </span>
              </span>
            </button>
          </div>
