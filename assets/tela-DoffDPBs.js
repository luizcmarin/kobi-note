import{c as e,o as t}from"./banco-CsCRyC2b.js";import{r as n}from"./catalogo-B2Z121mU.js";import{S as r,U as i,at as a,ct as o,ft as s,it as c,ut as l,x as u}from"./index-DtxwN5g2.js";import{alternarFavorito as d,chaveFavorito as ee,lerFavoritos as te}from"./favoritos-DAEWA_Gd.js";import{t as f}from"./unsafe-html-e5X31ccZ.js";import{t as ne}from"./rascunho-CTD2iMeK.js";var p=`note_faq_favoritos`,re=`message-question`;async function ie(){return(await e(`faq`).todos()).sort((e,t)=>h(e.categoria)-h(t.categoria)||Number(e.ordem)-Number(t.ordem)||Number(e.id??0)-Number(t.id??0))}var m=Object.keys(n);function h(e){let t=m.indexOf(e);return t===-1?m.length:t}function g(e){return e===``?n.crencas??e:n[e]??e}function _(e){try{let t=JSON.parse(e===``?`[]`:e);return Array.isArray(t)?t:[]}catch{return[]}}function v(e){return e===null?[]:_(e.lentes)}function ae(e){return e===null?[]:_(e.exemplos)}function oe(e,t){return e===null||t===null||t===``?!1:t===e.correta&&v(e).some(e=>e.id===t)}function se(e){return e!==null&&v(e).some(t=>t.id===e.correta)}function y(e,t){return(v(e).find(e=>e.id===t)?.resposta??``).trim()}var b={busca:``};function ce(e,t){return t===null?e:e.filter(e=>t.has(Number(e.id)))}function le(e,t){let n=new Map;for(let t of e){let e=n.get(t.categoria);e===void 0?n.set(t.categoria,[t]):e.push(t)}return[...n].map(([e,n])=>({categoria:e,rotulo:g(e),perguntas:n,concluida:n.every(t)}))}var x=`note_faq_progresso`;function S(){return{respondidos:{}}}function ue(){try{let e=JSON.parse(localStorage.getItem(x)??`null`);return{...S(),...e}}catch{return S()}}function de(e){localStorage.setItem(x,JSON.stringify(e))}function fe(e,t){let n=e.respondidos[String(t)],r={...e,respondidos:{...e.respondidos,[String(t)]:{tentativas:(n?.tentativas??0)+1,respondidoEm:Date.now()}}};return de(r),r}function C(e,t){return t?.id!==void 0&&e.respondidos[String(t.id)]!==void 0}function w(e,t){return t.filter(t=>C(e,t)).length}function T(e){return`faq:${e}`}async function pe(){let e=new Map;for(let t of await i()){if(t.origem!==`faq`||t.ref_chave===null)continue;let n=Number(t.ref_chave.split(`:`)[1]);Number.isFinite(n)&&e.set(n,t.conteudo)}return e}function me(e,t,n){return n?.id!==void 0&&C(e,n)&&(t.get(n.id)??``).trim()!==``}function he(e,t){return t?.id!==void 0&&(e.get(t.id)??``).trim()!==``}var E=[],D=new Map,O=new Set,k=S(),A=!1,j=!1,M=null,N=b,P=null,F=``;function I(e){F=e,t(`not_faq`,e).then(t=>{F===e&&(P=t===null?null:new Set(t),c())})}var L=-1,R=null,z=!1,B=!1,V=``,H=``,U=ne({origem:`faq`,idDe:e=>e.id,chaveDe:e=>T(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${o.faq.titulo} — ${e.titulo}`,lembrete:()=>D});function W(){A||j||M!==null||(j=!0,(async()=>{try{[E,D]=await Promise.all([ie(),pe()]),O=te(p),k=ue(),A=!0}catch(e){console.error(`faq: a carga falhou.`,e),M=r(e)}finally{j=!1,c()}})())}function ge(){M=null,W(),c()}function _e(e){return E.find(t=>t.id===e)}function ve(e){L!==e.id&&(L=e.id??-1,R=null,z=!1,B=!1,V=``,H=``,U.abrir(e.id===void 0?``:D.get(e.id)??``))}function ye(e){z||R===null||(oe(e,R)?(z=!0,H=`ok`,V=y(e,R)||o.faq.acerto,G(e)):(H=`erro`,V=y(e,R)||o.faq.erro),c())}function G(e){B||e.id===void 0||(k=fe(k,e.id),B=!0)}function K(e){return ee(`curado`,e.id)}function q(e){return O.has(K(e))}function J(e){O=d(p,O,K(e)),c()}function be(e){return e.icone===``?re:e.icone}function xe(e){return me(k,D,e)}function Se(e){let t=q(e);return s`
  ...
  `}function Y(e,t,n,r,i=!1){return s`
    <kk-details class="faq__secao" name="faq-categorias" ?open=${n}>
      ...
      >
        ${e}
        ${r?s`<kk-icon name="check" title=${o.faq.categoriaConcluida}></kk-icon>`:l}
      </span>
    ...
    <div class="faq">
      ...
      <div class="filtros">
        <kk-input
          ...
          .value=${N.busca}
          @kk-input=${e=>{N={...N,busca:e.target.value},I(N.busca),c()}}
        ></kk-input>
      </div>

      ${e.length===0?s`<p class="vazio">${o.faq.semResultado}</p>`:s`
            <kk-accordion class="faq__categorias">
              ${u.length===0?l:Y(o.faq.favoritos,u,!0,u.every(n),!0)}
    ...
    <div class="faq__lentes">
      ${t.map(e=>s`
          ...
          >
            ...
            ${e.nota===void 0||e.nota===``?l:s`<small>${e.nota}</small>`}
          </button>
        `)}
    </div>
  `}function Ee(e){return ve(e),se(e)?s`
    <div class="faq">
      <article class="faq__bloco faq__bloco--impulso">
        ...
        ${V===``?l:s`<p class="faq__feedback faq__feedback--${H}">${V}</p>`}
  ...
  `:(B||G(e),s`<div class="faq">${Z(e)}</div>`)}function De(e){let t=ae(e);return t.length===0?l:s`
    <article class="faq__bloco">
      ...
      <ul class="faq__exemplos">
        ${t.map(e=>s`
            <li>
              ...
              ${e.nota===void 0||e.nota===``?l:s`<span>${e.nota}</span>`}
            </li>
          `)}
      </ul>
    </article>
  `}function Z(e){return s`
    <div class="faq__final">
      ${xe(e)?s`<p class="faq__selo-feito"><kk-icon name="notes"></kk-icon>${o.faq.seloFeito}</p>`:l}

      <article class="faq__bloco faq__bloco--sucesso">
        <h2 class="faq__secao-titulo">${o.faq.aResposta}</h2>
        <div class="prosa">${f(e.resposta)}</div>
        ${e.referencia===``?l:s`<p class="faq__base"><kk-icon name="book"></kk-icon>${e.referencia}</p>`}
        ${e.link_jw===``?l:s`
              <p class="faq__fonte">
      ...
      ${U.campo({item:e,id:`faq-preparo`,rotulo:o.faq.paraPreparar,placeholder:o.faq.respostaPlaceholder,apoio:e.preparo===``?l:s`<p class="rascunho__apoio">${e.preparo}</p>`})}
