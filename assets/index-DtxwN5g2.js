...
\f\r]`,tt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,nt=/-->/g,rt=/>/g,it=RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),at=/'/g,ot=/"/g,st=/^(?:script|style|textarea|title)$/i,v=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),ct=Symbol.for(`lit-noChange`),y=Symbol.for(`lit-nothing`),lt=new WeakMap,ut=Ye.createTreeWalker(Ye,129);function dt(e,t){if(!Qe(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return We===void 0?t:We.createHTML(t)}var ft=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=tt;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===tt?c[1]===`!--`?o=nt:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=it):(st.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=it):o=rt:o===it?c[0]===`>`?(o=i??tt,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?it:c[3]===`"`?ot:at):o===ot||o===at?o=it:o===nt||o===rt?o=tt:(o=it,i=void 0);let d=o===it&&e[t+1].startsWith(`/>`)?` `:``;a+=o===tt?n+Je:l>=0?(r.push(s),n.slice(0,l)+Ge+n.slice(l)+Ke+d):n+Ke+(l===-2?t:d)}return[dt(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},pt=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=ft(t,n);if(this.el=e.createElement(l,r),ut.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=ut.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(Ge)){let t=u[o++],n=i.getAttribute(e).split(Ke),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?vt:r[1]===`?`?yt:r[1]===`@`?bt:_t}),i.removeAttribute(e)}else e.startsWith(Ke)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(st.test(i.tagName)){let e=i.textContent.split(Ke),t=e.length-1;if(t>0){i.textContent=Ue?Ue.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Xe()),ut.nextNode(),c.push({type:2,index:++a});i.append(e[t],Xe())}}}else if(i.nodeType===8){if(i.data===qe)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Ke,e+1))!==-1;)c.push({type:7,index:a}),e+=Ke.length-1}}a++}}static createElement(e,t){let n=Ye.createElement(`template`);return n.innerHTML=e,n}};function mt(e,t,n=e,r){if(t===ct)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=Ze(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=mt(e,i._$AS(e,t.values),i,r)),t}var ht=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Ye).importNode(t,!0);ut.currentNode=r;let i=ut.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new gt(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new xt(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=ut.nextNode(),a++)}return ut.currentNode=Ye,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},gt=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=mt(this,e,t),Ze(e)?e===y||e==null||e===``?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==ct&&this._(e):e._$litType$===void 0?e.nodeType===void 0?$e(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&Ze(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ye.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=pt.createElement(dt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new ht(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=lt.get(e.strings);return t===void 0&&lt.set(e.strings,t=new pt(e)),t}k(t){Qe(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(Xe()),this.O(Xe()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=He(e).nextSibling;He(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},_t=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=mt(this,e,t,0),a=!Ze(e)||e!==this._$AH&&e!==ct,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=mt(this,r[n+o],t,o),s===ct&&(s=this._$AH[o]),a||=!Ze(s)||s!==this._$AH[o],s===y?e=y:e!==y&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},vt=class extends _t{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},yt=class extends _t{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},bt=class extends _t{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=mt(this,e,t,0)??y)===ct)return;let n=this._$AH,r=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==y&&(n===y||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},xt=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){mt(this,e)}},St={M:Ge,P:Ke,A:qe,C:1,L:ft,R:ht,D:$e,V:mt,I:gt,H:_t,N:yt,U:bt,B:vt,F:xt},Ct=Ve.litHtmlPolyfillSupport;Ct?.(pt,gt),(Ve.litHtmlVersions??=[]).push(`3.3.3`);var wt=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new gt(t.insertBefore(Xe(),e),e,void 0,n??{})}return i._$AI(e),i},Tt=globalThis,Et=class extends Be{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=wt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ct}};Et._$litElement$=!0,Et.finalized=!0,Tt.litElementHydrateSupport?.({LitElement:Et});var Dt=Tt.litElementPolyfillSupport;Dt?.({LitElement:Et}),(Tt.litElementVersions??=[]).push(`4.2.2`);var Ot=`Sua mente fora da nuvem. Estudo pessoal, criatividade, finanças e preparo tático reunidos em um espaço sob seu domínio absoluto com zero distrações.`,kt={app:{nome:`Kobi Note`,carregando:`Carregando...`},home:{saudacao:`Kobi Note`,sub:Ot,modulos:`Módulos`,sincronizar:`Sincronizar conteúdo`,sincronizando:`Sincronizando...`,sincronizado:e=>e===0?`Nenhuma novidade para hoje.`:`Conteúdo atualizado (${e} módulo(s)).`,semRede:`Sem conexão — o app continua funcionando com o que já está no aparelho.`,semManifesto:`O servidor de conteúdo não respondeu com um manifesto válido.`},modulos:{anotacoes:`Anotações`,guias:`Guias`,poesia:`Poesia`,receitas:`Receitas`,jogo:`Exercitando a Língua Pura`,criacao:`Teve um Projeto?`,entenda:`Entenda Melhor`,imite:`Imite a Sua Fé`,principios:`Fazendo as Contas...`,faq:`Perguntas Frequentes`,cronologia:`Cronologia`,caderno:`Caderno de Estudo`,prep:`Esteja Preparado`,financeiro:`Financeiro`,metas:`Metas`,ministerio:`Vida e Ministério`,servico:`Fazer Mais`,estudo:`Meu Momento de Estudo`,leitura:`Leitura da Bíblia`,calendario:`Calendário`,perfil:`Perfil / ICE`,tutorial:`Tutorial`,sobre:`Sobre`},secoes:{estudo:`Estudo Pessoal`,prep:`Esteja Preparado`,extras:`Extras`,pessoal:`Pessoal`,aplicativo:`O Aplicativo`},painel:{semEventos:`Nada marcado para hoje.`,diaInteiro:`Dia inteiro`,anotacoes:t=>e(t,{one:`1 anotação`,other:`${t} anotações`}),eventosHoje:t=>e(t,{one:`1 evento hoje`,other:`${t} eventos hoje`}),contasVencendo:t=>e(t,{one:`1 conta a vencer`,other:`${t} contas a vencer`}),leitura:e=>`${e}% da Bíblia`,metas:t=>e(t,{one:`1 meta em andamento`,other:`${t} metas em andamento`}),horas:t=>e(t,{one:`1 hora este mês`,other:`${t} horas este mês`}),foco:e=>`${Math.round(e/60)} h de foco no mês`,favoritas:t=>e(t,{one:`1 favorita`,other:`${t} favoritas`}),rotuloContas:`Contas a vencer`,rotuloFoco:`Estudo focado`,rotuloMetas:`Metas`,emHoras:e=>`${Math.round(e/60*10)/10} h`},convite:{titulo:`Compartilhar o Kobi Note`,tile:`Compartilhar`,tileResumo:`Convide alguém`,lema:`Compartilhe o Kobi Note com seus amigos. Eles vão gostar!`,mascote:`Kobi, a raposa do Kobi Note`,mensagem:`Oi! Descobri o Kobi Note para organizar meu estudo pessoal, anotações, finanças e preparo tático — tudo fica no meu próprio aparelho, sem conta e sem nuvem, e funciona sem internet. Acho que você vai gostar:`,qrAlt:`QR com o endereço do Kobi Note`,dica:`Aponte a câmera para o código, ou use um dos botões abaixo.`,whatsapp:`WhatsApp`,compartilhar:`Compartilhar`,copiar:`Copiar`,copiado:`Convite copiado. É só colar onde quiser.`},rodape:{termos:`Termos de uso`,privacidade:`Privacidade`,direitos:e=>`© ${e} Luiz Marin`,feitoPara:`Feito com ❤️ para você.`},boasVindas:{titulo:`Boas-vindas`,reabrir:`Rever as boas-vindas`,mascote:`Kobi, a raposa do Kobi Note, acenando boas-vindas`,pular:`Pular`,voltar:`Voltar`,proximo:`Próximo`,comecar:`Começar a usar`,passo:(e,t)=>`Passo ${e} de ${t}`,passos:{bemVindo:{titulo:`Bem-vindo ao Kobi Note`,texto:Ot,dica:`Leva um minuto para conhecer o básico.`},painel:{titulo:`A tela inicial é o seu painel`,texto:`Cada cartão abre uma área do app e mostra um resumo do que está acontecendo nela. A tela é dividida em seções — Estudo Pessoal, Esteja Preparado, Pessoal — e não há tela intermediária: o cartão já abre a área.`,dica:`O botão ← sempre traz você de volta.`},offline:{titulo:`Funciona sem internet`,texto:`O Kobi Note guarda tudo no próprio aparelho. Você pode usar no ônibus, no campo ou em qualquer lugar sem sinal.`,dica:`Conteúdo novo é baixado sozinho quando houver internet.`},privado:{titulo:`Seus dados são só seus`,texto:`Não há nuvem, conta nem rastreador. Tudo fica apenas no seu aparelho.`,dica:`Ninguém — nem nós — consegue ver o que você faz aqui.`},instalar:{titulo:`Instale na tela inicial`,texto:`Pelo menu do navegador, escolha “Instalar aplicativo” ou “Adicionar à tela inicial”. O Kobi Note abrirá em tela cheia, oferecendo uma experiência imersiva e nativa.`,dica:`Quer saber mais? Veja o Tutorial.`,botao:`Instalar agora`}}},instalacao:{instalar:`Instalar na tela inicial`},sobre:{titulo:`Sobre`,versao:e=>`Versão ${e}`,lema:Ot,seloOffline:`100% offline`,seloPrivado:`Privado`,seloSemRastreio:`Sem rastreadores`,seloInstalavel:`Instalável`,tudoNumLugar:`Tudo em um só lugar`,recEstudo:`Estudo e leitura`,recEstudoTexto:`Momento de Estudo, leitura, caderno e guias`,recJogo:`Aprender brincando`,recJogoTexto:`Jogo Língua Pura, Entenda Melhor, Imite a Sua Fé e "Teve um Projeto?"`,recCriar:`Criatividade`,recCriarTexto:`Poesia, receitas e anotações`,recFinancas:`Finanças e metas`,recFinancasTexto:`Orçamento, objetivos e calendário`,recPreparo:`Esteja Preparado`,recPreparoTexto:`Kits, estoque e cofre protegido`,recMinisterio:`Ministério e você`,recMinisterioTexto:`Vida e ministério, perfil e ICE`,privacidadeTitulo:`Seus dados são só seus`,privacidadeTexto:`Para quem não precisa de notificações, mas de espaço: estude, crie e organize sua rotina com total privacidade no seu dispositivo — sem anúncios, sem assinaturas. Apenas você e o Kobi Note.`,documentos:`Documentos`,vejaTambem:`Veja também`,contato:`Contato:`,email:`luizcmarin@gmail.com`},emBreve:{titulo:`Em breve`,texto:e=>`O módulo “${e}” ainda não foi liberado para esta versão do Kobi Note.`,ajuda:`Ele ainda está em desenvolvimento... espere mais um pouquinho.`,voltar:`Voltar ao início`},erro:{banco:`Não foi possível abrir o banco local`,naoEncontrado:`Não encontramos esta tela`,naoEncontradoTexto:`O endereço não corresponde a nenhum módulo do Kobi Note.`,telaNaoVeio:`Não foi possível abrir este módulo`,telaNaoVeioTexto:`A tela é baixada na primeira vez que você entra nela, e desta vez ela não chegou. Verifique a conexão e tente de novo; se o app foi atualizado agora há pouco, recarregar a página resolve.`,telaNaoVeioRecarregar:`Recarregar`,cargaFalhou:`Este módulo não abriu`,cargaFalhouTexto:`Alguma coisa deu errado ao ler os dados deste módulo. O que já estava salvo continua no aparelho — nada foi perdido.`,cargaTentarDeNovo:`Tentar de novo`},armazenamento:{memoriaOrigemInsegura:`Este endereço não é uma origem confiável: os dados ficam num armazenamento de reserva. Abra o app por HTTPS para usar o armazenamento definitivo.`,memoriaInstanciaDupla:`O Kobi Note já está aberto em outra janela, e só uma por vez pode usar o armazenamento definitivo. Feche a outra janela e recarregue esta — o que você escrever aqui até lá não será guardado.`,memoriaIndisponivel:`O navegador não liberou o armazenamento definitivo neste aparelho: os dados ficam num armazenamento de reserva e podem se perder. Verifique o espaço livre e as permissões de dados do site.`,apagarTudo:`Apagar todos os dados deste aparelho`,apagarTudoTitulo:`Apagar tudo deste aparelho?`,apagarTudoTexto:`Isto remove o banco, as anotações, o progresso, os favoritos e as preferências guardados neste aparelho. O conteúdo curado volta na próxima sincronização; o que é seu, não. Desinstalar o app não faz esta limpeza — o navegador guarda os dados mesmo sem o atalho.`,apagarTudoConfirmar:`Apagar tudo`,apagarTudoFeito:`Dados apagados. Recarregando...`,apagarTudoFalhou:`Não foi possível apagar tudo. Tente de novo.`},bloqueio:{protegerTitulo:`Proteja o Kobi Note neste aparelho`,protegerTexto:`O Kobi Note abre pela biometria do aparelho (a mesma da tela de bloqueio), por um passkey criado só para ele. A chave que cifra o seu banco nasce desse gesto e não é gravada em lugar nenhum. Sem o passkey — aparelho trocado, dados do navegador apagados — não há como recuperar o que está guardado aqui.`,proteger:`Continuar com a biometria`,bloqueadoTitulo:`Kobi Note bloqueado`,bloqueadoTexto:`Use a biometria do aparelho para abrir.`,desbloquear:`Desbloquear`,semPrf:`O autenticador deste aparelho não entrega a chave (extensão PRF). Sem ela o Kobi Note não abre neste navegador — tente outro autenticador, como o celular pelo QR.`,gestoRecusado:`O gesto foi cancelado.`,segredoNaoConfere:`Este passkey não abre a chave deste aparelho. Só o passkey que protegeu o Kobi Note aqui consegue abri-lo.`},atualizacao:{titulo:`Kobi Note atualizado`,texto:`Uma versão nova do app foi baixada.`,acao:`Recarregar`},acoes:{voltar:`Voltar`,tema:`Alternar tema`,idioma:`Idioma`,fechar:`Fechar`,cancelar:`Cancelar`,confirmar:`Confirmar`,salvar:`Salvar`,criar:`Criar`,renomear:`Renomear`,excluir:`Excluir`,editar:`Editar`,substituir:`Substituir`,obrigatorio:`Preencha este campo.`},leitura:{apresentar:`Apresentar (rolagem automática)`,ler:`Ler em voz alta`,pausarLeitura:`Pausar leitura`,retomarLeitura:`Retomar leitura`,pausar:`Pausar`,continuar:`Continuar`,maisDevagar:`Mais devagar`,maisRapido:`Mais rápido`,velocidade:e=>`Vel. ${e}`,compartilhar:`Compartilhar`,copiado:`Conteúdo copiado para a área de transferência.`,semCopiar:`Não foi possível copiar o conteúdo.`},acervo:{meu:`Minha`,semTitulo:`Sem título`,salvando:`Salvando...`,salvoAs:e=>`Salvo às ${e}`,informeTitulo:`Informe um título para salvar`,tituloEConteudo:`Informe o título e o conteúdo para salvar`,excluirTexto:`A ação não pode ser desfeita.`},pasta:{nova:`Nova pasta`,novaTexto:`Como quer chamar a pasta?`,placeholder:`Nome da pasta`,renomear:`Renomear pasta`,excluir:`Excluir pasta`,excluirTexto:`As anotações dela voltam para “Sem pasta”.`,erroVazio:`Dê um nome à pasta.`},anotacoes:{nova:`Nova anotação`,buscar:`Buscar anotações...`,todosModelos:`Todos os modelos`,todas:`Todas`,arquivadas:`Arquivadas`,semAnotacoes:`Nenhuma anotação por aqui. Toque em + para criar a primeira.`,semArquivadas:`Nada arquivado.`,semTitulo:`(sem título)`,semPasta:`Sem pasta`,escolhaModelo:`Escolha um modelo`,tituloPlaceholder:`Título...`,salvando:`Salvando...`,informeTitulo:`Informe um título para salvar`,salvoAs:e=>`Salvo às ${e}`,fixar:`Fixar`,desafixar:`Desafixar`,arquivar:`Arquivar`,restaurar:`Restaurar`,reuniao:`Ir para a reunião (abre a anotação com o modelo do dia)`,excluir:`Excluir anotação`,excluirTexto:`A ação não pode ser desfeita.`,excluida:`Anotação excluída.`},guias:{nova:`Nova guia`,buscar:`Buscar guias...`,vazio:`Nenhuma guia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da guia...`,novaTitulo:`Nova guia`,excluir:`Excluir guia`,excluida:`Guia excluída.`},poesia:{nova:`Nova poesia`,buscar:`Buscar poesias...`,vazio:`Nenhuma poesia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da poesia...`,novaTitulo:`Nova poesia`,excluir:`Excluir poesia`,excluida:`Poesia excluída.`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`,anterior:`Anterior`,proxima:`Próxima`,sobre:`Sobre estas obras`,referencia:e=>`#${e??``}`,aviso:[`As obras aqui expostas têm um valor artístico, literário, baseado nas crenças das Testemunhas de Jeová. Seu objetivo é enaltecer a Jeová, o verdadeiro Deus e legítimo Soberano Universal, fortalecer a esperança em Suas maravilhosas e incomparáveis promessas, ocupar nossos pensamentos com “tudo que é verdadeiro, tudo que é de séria preocupação, tudo que é justo, tudo que é casto, tudo que é amável, tudo de que se fala bem, tudo que é virtuoso e tudo que é digno de louvor.” (Fil 4:8) A glória por qualquer benefício daqui derivado cabe a Jeová, o dador de todo presente perfeito, inclusive nossa capacidade de pensar e amar.`,`Todos os personagens usados nesta obra são fictícios. Quaisquer nomes de personagens originam-se de nomes de raças felinas e as imagens são meramente ilustrativas.`,`Para saber mais sobre as crenças das Testemunhas de Jeová acesse o site jw.org.`]},receitas:{nova:`Nova receita`,buscar:`Buscar receitas...`,vazio:`Nenhuma receita disponível. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da receita...`,novaTitulo:`Nova receita`,excluir:`Excluir receita`,excluida:`Receita excluída.`,todas:`Todas`,categoria:`Categoria`,ingredientes:`Ingredientes`,preparo:`Modo de preparo`,ingredientesPlaceholder:`Um ingrediente por linha...`,preparoPlaceholder:`Um passo por linha...`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`},estudo:{intro:`Uma sessão de estudo: escolha o tipo, ore, cronometre e guarde a pérola.`,tipo:`Tipo de estudo`,assunto:`Assunto`,assuntoPlaceholder:`O que você vai estudar...`,semAssunto:`(sem assunto)`,alvo:`Alvo de tempo`,minutos:e=>`${e} min`,de:e=>`de ${e} min`,comecar:`Começar`,oracaoTitulo:`Antes de começar`,oracaoTexto:`Peça a Jeová o espírito santo para entender o que vai ler e para aplicar o que aprender.`,orei:`Orei — começar`,emSessao:`Em estudo`,alvoAtingido:`Alvo de tempo atingido. Siga enquanto o assunto render.`,encerrar:`Encerrar`,descartar:`Descartar`,perola:`Pérola`,perolaIntro:e=>`${e} min de estudo. O que você leva daqui?`,perolaPlaceholder:`Uma ideia, um texto, uma aplicação...`,viraAnotacao:`Virar anotação`,viraAnotacaoFeito:`Anotação criada`,vaiCaderno:`Salvar no caderno`,vaiCadernoFeito:`Salvo no caderno`,salvarSessao:`Salvar sessão`,historico:`Histórico`,totais:(t,n)=>`${e(t,{one:`${t} sessão`,other:`${t} sessões`})} · ${n} de estudo.`,semSessoes:`Nenhuma sessão registrada ainda.`,excluir:`Excluir sessão`},prep:{indice:`Índice de prontidão`,indiceAjuda:`Checklists + autonomia de alimentos`,kits:`Kits de checklist`,estoque:`Estoque de alimentos`,cofre:`Cofre de documentos`,guias:`Guias`,guiasResumo:`Orientações e procedimentos`,cofreResumo:`Documentos criptografados`,contagemKits:t=>e(t,{one:`${t} kit`,other:`${t} kits`}),diasAutonomia:t=>e(t,{one:`${t} dia de autonomia`,other:`${t} dias de autonomia`}),semKits:`Nenhum kit ainda. Toque em + para criar o primeiro checklist.`,novoKit:`Novo checklist`,editarKit:`Editar checklist`,kitSemNome:`Sem nome`,nomeDoKit:`Nome do checklist`,emoji:`Emoji`,emojiAjuda:`Um emoji para reconhecer o kit na lista (opcional).`,itens:`Itens`,descricaoDoItem:`O que levar...`,quantidade:`Quantidade`,observacoes:`Observações`,adicionarItem:`Adicionar item`,removerItem:`Remover item`,removerItemTexto:`O item sai deste checklist.`,kitSalvo:`Checklist salvo.`,excluirKit:`Excluir checklist`,kitExcluido:`Checklist excluído.`,vence:e=>`vence ${e}`,novoItem:`Novo item`,editarItem:`Editar item`,item:`Item`,categoria:`Categoria`,pesoUnitario:`Peso unitário (g)`,kcal:`Calorias por 100 g`,validade:`Validade`,itemSalvo:`Item salvo.`,excluirItem:`Excluir item`,itemExcluido:`Item excluído.`,buscarItens:`Buscar no estoque...`,semEstoque:`O estoque está vazio.`,semEstoqueFiltro:`Nenhum item para esta busca.`,resumoDoItem:(e,t)=>`${e} × ${t} g`,alertas:t=>e(t,{one:`${t} alerta de validade`,other:`${t} alertas de validade`}),vencidoHa:e=>`Vencido há ${e} d`,venceHoje:`Vence hoje`,venceEm:e=>`Vence em ${e} d`,calculadora:`Calculadora de autonomia`,calculadoraAjuda:`Quem come, quanto gasta e quantos são`,faixaEtaria:`Faixa etária`,atividade:`Atividade física`,pessoas:`Pessoas`,maisPessoas:`Mais uma pessoa`,menosPessoas:`Menos uma pessoa`,diasDeAutonomia:`Dias de autonomia`,aguaSugerida:`Água sugerida`,pesoTotal:`Peso total`,metaAutonomia:e=>`${e}% da meta de 30 dias`,necessidadeDiaria:e=>`${e} kcal por dia para o grupo`,logistica:`Logística tática`,diasSemFogo:`Dias sem água/fogo`,diasComFogo:`Dias com cozimento`,itensDeFibra:`Itens de fibra`,vulneravel:`Poucos itens de fibras e vitaminas. Numa autonomia longa isso vira problema de saúde antes de virar problema de caloria.`,semBiometria:`Este navegador não oferece passkey. O cofre precisa dele para existir.`,semPrf:`O autenticador deste aparelho não entrega a chave (extensão PRF).`,gestoRecusado:`O gesto foi cancelado.`,destrancarComBiometria:`Destrancar com a biometria`,cofreTrancado:`Cofre trancado`,destranqueAjuda:`Ele volta a trancar sozinho quando você sai desta tela.`,destrancar:`Destrancar`,trancar:`Trancar`,guardarDocumento:`Guardar um documento`,nomeDoDocumento:`Nome do documento`,informeNome:`Informe um nome.`,documentoGuardado:`Documento guardado e cifrado.`,semDocumentos:`Nenhum documento guardado ainda.`,renomearDocumento:`Renomear documento`,excluirDocumento:`Excluir documento`,excluirDocumentoTexto:`O documento cifrado é apagado do aparelho. Não há como recuperá-lo.`,documentoExcluido:`Documento excluído.`,falhaAoDecifrar:`Não foi possível decifrar: este documento foi guardado com outra chave.`,semPreVisualizacao:`Este tipo de arquivo não abre aqui. Baixe para ver.`,baixar:`Baixar`},financeiro:{transacoes:`Transações`,novaTransacao:`Nova transação`,transacaoSalva:`Transação salva.`,excluirTransacao:`Excluir transação`,transacaoExcluida:`Transação excluída.`,categorias:`Categorias`,novaCategoria:`Nova categoria`,categoriaSalva:`Categoria salva.`,excluirCategoria:`Excluir categoria`,excluirCategoriaTexto:`As transações dela continuam existindo, mas ficam sem categoria.`,categoriaExcluida:`Categoria excluída.`,recorrencias:`Recorrências`,novaRecorrencia:`Nova recorrência`,recorrenciaSalva:`Recorrência salva.`,excluirRecorrencia:`Excluir recorrência`,excluirRecorrenciaTexto:`Os lançamentos já gerados por ela continuam onde estão.`,recorrenciaExcluida:`Recorrência excluída.`,receber:`Confirmar recebimento`,receberTexto:(e,t)=>`Marcar “${e}” como recebida, no valor de ${t}?`,pagar:`Confirmar pagamento`,pagarTexto:(e,t)=>`Marcar “${e}” como paga, no valor de ${t}?`,estornar:`Desfazer a baixa`,estornarTexto:e=>`“${e}” volta a constar como em aberto.`},calendario:{vista:`Visualização`,vistas:{dia:`Dia`,semana:`Semana`,mes:`Mês`,ano:`Ano`,agenda:`Agenda`},meses:[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],mes:`Mês`,ano:`Ano`,anterior:`Período anterior`,proximo:`Próximo período`,hoje:`Hoje`,novoEvento:`Novo evento`,editarEvento:`Editar evento`,novoAs:(e,t)=>`Novo evento em ${e}, ${t}`,novoEm:e=>`Novo evento em ${e}`,titulo:`Título`,tituloPlaceholder:`Ex.: Reunião do meio de semana`,tipo:`Tipo`,diaInteiro:`Dia inteiro`,dataInicio:`Data de início`,horaInicio:`Hora de início`,dataFim:`Data de fim`,horaFim:`Hora de fim`,descricao:`Descrição`,descricaoPlaceholder:`Detalhes (opcional)...`,eventoSalvo:`Evento salvo.`,excluirEvento:`Excluir evento`,eventoExcluido:`Evento excluído.`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),semEventos:`Nenhum evento nesta semana.`,tipos:`Tipos de evento`,novoTipo:`Novo tipo`,tipoNome:`Nome`,cor:`Cor`,icone:`Ícone`,marcaEspecial:`Contar no “próximo especial”`,especial:`Especial`,tipoSemNome:`Sem nome`,excluirTipo:`Excluir tipo`,tipoEmUsoTitulo:`Tipo em uso`,tipoEmUsoTexto:`Este tipo tem eventos e não pode ser excluído.`,dataInvalida:`A data de início não é uma data válida.`,eventoNaoSalvo:`O evento não pôde ser salvo. Confira os campos e tente de novo.`,eventoNaoExcluido:`O evento não pôde ser excluído.`,tipoNaoSalvo:`O tipo não pôde ser salvo.`,tipoNaoExcluido:`O tipo não pôde ser excluído. Ele pode ter ganhado eventos agora há pouco.`},ministerio:{esfriando:(t,n)=>e(t,{one:`${t} estudo está esfriando (${n}+ dias).`,other:`${t} estudos estão esfriando (${n}+ dias).`}),verEstudos:`Ver`,lembrete:(e,t)=>`Relatório de ${e} ainda ${t?`não foi enviado`:`não foi feito`}.`,preencher:`Preencher`,atalhoRelatorios:`Relatórios`,atalhoRelatoriosSub:e=>`${e} no total`,atalhoEstudos:`Estudos`,atalhoEstudosSub:e=>`${e} ativos`,atalhoServico:`Fazer mais`,atalhoServicoSub:`Planejar as horas e virar meta`,ultimoRelatorio:`Último relatório`,participou:`Participou`,naoParticipou:`Não participou`,estudosDoRelatorio:e=>`${e} estudos`,enviado:`Enviado`,pendente:`Pendente`,contadores:`Contadores do mês`,zerar:`Zerar contadores`,zerarTexto:`Os cinco contadores deste mês voltam a zero. Quer continuar?`,tempo:`Tempo`,estudos:`Estudos`,revisitas:`Revisitas`,publicacoes:`Publicações`,videos:`Vídeos`,maisUmaHora:`+1h`,aumentar:e=>`Aumentar ${e}`,diminuir:e=>`Diminuir ${e}`,gerarRelatorio:`Gerar relatório do mês`,obsRevisitas:e=>`Revisitas: ${e}`,obsPublicacoes:e=>`Publicações: ${e}`,obsVideos:e=>`Vídeos: ${e}`,obsTempo:e=>`Tempo: ${e}`,novoRelatorio:`Novo relatório`,editarRelatorio:`Editar relatório`,semRelatorios:`Nenhum relatório ainda.`,mes:`Mês`,ano:`Ano`,tipoPublicador:`Tipo de publicador`,participacao:`Participou no ministério`,horas:`Horas`,metaHoras:`Meta de horas`,estudosBiblicos:`Estudos bíblicos`,observacoes:`Observações`,compartilhar:`Compartilhar`,marcarEnviado:`Marcar como enviado`,marcarPendente:`Marcar como pendente`,excluirRelatorio:`Excluir relatório`,relatorioSalvo:`Relatório salvo.`,relatorioExcluido:`Relatório excluído.`,resumoRelatorio:(e,t,n,r)=>`${e} · ${t?`participou`:`não participou`} · ${n} estudos${r}`,sufixoHoras:e=>` · ${e}h`,relatorioDe:e=>`📋 Relatório — ${e}`,linhaTipo:e=>`Tipo: ${e}`,linhaParticipacao:e=>`Participou no ministério: ${e?`Sim`:`Não`}`,linhaHoras:e=>`Horas: ${e}`,linhaEstudos:e=>`Estudos bíblicos: ${e}`,linhaObservacoes:e=>`Observações: ${e}`,novoEstudo:`Novo estudo`,editarEstudo:`Editar estudo`,buscarEstudos:`Buscar estudos...`,semEstudos:`Nenhum estudo aqui.`,semEstudosFiltro:`Nenhum estudo para esta busca.`,nome:`Nome`,semNome:`Sem nome`,contato:`Contato`,contatoPlaceholder:`Telefone, e-mail...`,endereco:`Endereço`,publicacaoAtual:`Publicação atual`,publicacaoPlaceholder:`Publicação usada no estudo`,diaSemana:`Dia da semana`,escolhaDia:`Escolha o dia...`,horario:`Horário`,notas:`Notas`,excluirEstudo:`Excluir estudo`,excluirEstudoTexto:`A linha do tempo deste estudo é apagada junto.`,estudoSalvo:`Estudo salvo.`,estudoExcluido:`Estudo excluído.`,informeNome:`Dê um nome ao estudo.`,seloEsfriando:`Esfriando`,ultimoEstudo:`Último estudo:`,parouEm:`Parou em:`,nenhumRegistro:`Nenhum registro`,hoje:`Hoje`,ontem:`Ontem`,haDias:e=>`Há ${e} dias`,estudoDe:e=>`📖 ${e}`,linhaPublicacao:e=>`Publicação: ${e}`,linhaOndeParou:e=>`Onde parou: ${e}`,linhaDia:(e,t)=>`Dia: ${e} ${t}`,linhaContato:e=>`Contato: ${e}`,linhaEndereco:e=>`Endereço: ${e}`,linhaDoTempo:`Linha do tempo`,registrarEstudo:`Registrar estudo`,editarRegistro:`Editar registro`,semRegistros:`Nenhum registro ainda. Toque em + após cada estudo.`,data:`Data`,ondeParou:`Onde parou`,ondeParouPlaceholder:`Ex.: lição 12, parágrafo 5`,informeOndeParou:`Informe onde o estudo parou.`,comentario:`Comentário`,comentarioPlaceholder:`Como foi o estudo, dúvidas, próximos passos...`,excluirRegistro:`Excluir registro`,registroSalvo:`Registro salvo.`,registroExcluido:`Registro excluído.`},jogo:{restantes:`Restantes`,acertos:`Acertos`,erros:`Erros`,partidas:`Partidas`,xpDisponivel:`XP disponível`,modo:`Modo`,modos:{estudo:`Estudo`,desafio:`Desafio`},desafioAjuda:`Timer por pergunta · bônus de XP por velocidade e sequência`,dificuldade:`Dificuldade`,dificuldades:[`Todas`,`Fácil`,`Médio`,`Difícil`],jogar:`Jogar`,semBanco:`Sem perguntas — sincronize`,semPerguntas:`Esta dificuldade não tem perguntas suficientes (mínimo 2). Escolha outra ou sincronize mais perguntas.`,tudoConcluido:`Você já respondeu todas as perguntas desta dificuldade!`,reiniciar:`Reiniciar`,reiniciarTitulo:`Reiniciar perguntas`,reiniciarTexto:`Zera as perguntas já respondidas (seu XP é mantido). Quer continuar?`,encerrar:`Encerrar quiz`,segundos:e=>`${e}s`,pausadoSelo:`pausado`,pausar:`Pausar`,retomar:`Retomar`,dica:e=>`Dica (${e} XP)`,explicacao:`Explicação`,feedbackCorreto:e=>`Correto! +${e} XP`,feedbackIncorreto:`Resposta incorreta`,feedbackTempo:`Tempo esgotado!`,proxima:`Próxima`,verResultado:`Ver resultado`,tituloResultado:`Resultado`,resultados:{perfeito:`Perfeito! 🎉`,excelente:`Excelente!`,muitoBem:`Muito bem!`,continue:`Continue praticando!`,naoDesista:`Não desista, tente de novo!`},acertosDe:(e,t,n)=>`${e} de ${t} acertos (${n}%)`,xpGanho:`XP ganho`,nivel:`Nível`,xpSaldo:`XP saldo`,anotarNoCaderno:`Anotar no Caderno de Estudo`,cadernoReferencia:`Jogo Língua Pura`,cadernoTitulo:`Jogo Língua Pura`,cadernoConteudo:(e,t,n)=>`Acertei ${e} de ${t} (${n}%). O que aprendi:\n`,jogarDeNovo:`Jogar de novo`,inicio:`Início`},leituraBiblia:{visualizacao:`Visualização`,visoes:{canonica:`Canônica`,cronologica:`Cronológica`,escritor:`Escritor`,celebracao:`Celebração`},visoesAjuda:{canonica:`Ordem canônica: Gênesis a Apocalipse`,cronologica:`Pela estimativa de quando cada livro foi escrito`,escritor:`Agrupada por escritor`,celebracao:`Leitura para a época da Celebração da morte de Cristo`},progressoGeral:`Progresso geral`,capitulos:(e,t)=>`${e} de ${t} capítulos`,capituloAbrev:(e,t)=>`${e}/${t} cap.`,livros:(e,t)=>`${e} de ${t} livros`,livroInteiro:`Livro inteiro`,limpar:`Limpar`,roteiro:`Roteiro da Celebração`,roteiroNota:`Acontecimentos da última semana de Jesus na Terra (Nisã 8 a 16) — leitura para a época da Celebração da morte de Cristo.`,trechos:(e,t)=>`${e} de ${t} trechos lidos`},servico:{intro:`Uma meta anual não cabe na cabeça de ninguém; "duas horas e meia, três vezes por semana" cabe. Escolha o alvo e os dias, e veja o que ele pede de cada saída.`,modalidade:`Modalidade de serviço`,semCota:`sem cota de horas`,horasMes:e=>`${e} h por mês`,alvo:`Alvo de horas no período`,alvoValor:e=>`${e} h`,prazo:`Período`,prazoValor:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mediaMes:e=>`Média de ${e} por mês.`,diasTitulo:`Dias em que pretendo sair`,semDias:`Escolha ao menos um dia da semana para a conta ter onde cair.`,gradeTitulo:`O que isso significa`,porSaida:`Em cada saída`,porSemana:`Por semana`,porMes:`Por mês`,porAno:`No ritmo de um ano`,saidas:`Saídas no período`,saidasValor:t=>e(t,{one:`${t} saída`,other:`${t} saídas`}),inviavel:`Mais de dez horas numa só saída — o alvo não cabe nos dias escolhidos. Acrescente dias, alongue o período ou reduza o alvo.`,mesAnterior:`Mês anterior`,mesSeguinte:`Próximo mês`,resumoDoMes:(t,n)=>e(t,{one:`${t} saída neste mês, para ${n}.`,other:`${t} saídas neste mês, para ${n}.`}),registrar:`Registrar como meta`,gravando:`Gravando...`,gravada:`Meta registrada. Ela acompanha sozinha as horas dos seus relatórios.`,naoGravada:`A meta não pôde ser registrada. Tente de novo.`,verMetas:`Ver metas`,tituloDaMeta:e=>`${e}: horas de campo`,fonteAviso:`As horas de cada modalidade são um ponto de partida para preencher o campo, não uma exigência afirmada por este app: confirme sempre a instrução vigente. Referências no jw.org:`,referencias:[{rotulo:`🌐 Alcance mais no serviço a Jeová`,url:`https://www.jw.org/finder?wtlocale=T&docid=201999284`},{rotulo:`🌐 Você pode aumentar sua participação?`,url:`https://www.jw.org/finder?wtlocale=T&docid=201998083`}]},metas:{nova:`Nova meta`,editar:`Editar meta`,buscar:`Buscar metas...`,filtros:{ativas:`Ativas`,concluidas:`Concluídas`,todas:`Todas`},resumo:(t,n)=>`${t} em andamento · ${e(n,{one:`${n} concluída`,other:`${n} concluídas`})}.`,vazio:`Nenhuma meta ainda. Toque em + para criar a primeira.`,semFiltro:`Nenhuma meta para este filtro.`,titulo:`Título`,tituloPlaceholder:`O que você quer alcançar...`,informeTitulo:`Dê um título à meta.`,categoria:`Categoria`,ativo:`Categoria do Financeiro`,alvo:e=>`Alvo (${e})`,automatica:`Automática`,automaticaAjuda:`O progresso vem do módulo de origem — não é digitado aqui.`,inicio:`Início`,prazoFinal:`Prazo final`,prazo:e=>`prazo ${e}`,aumentar:`Aumentar o progresso`,diminuir:`Diminuir o progresso`,concluir:`Concluir`,reabrir:`Reabrir`,salva:`Meta salva.`,excluir:`Excluir meta`,excluida:`Meta excluída.`},perfil:{cartao:`Cartão de visita`,secretario:`Secretário da Congregação`,saude:`Saúde (ICE)`,gestacao:`Gestação`,dpa:`Diretrizes de sangue (DPA)`,emergencia:`Contato de emergência`,colih:`CoLiH`,identificacao:`Identificação complementar`,nome:`Nome completo`,telefone:`Telefone`,email:`E-mail`,link:`Link pessoal`,comentario:`Observação (nota aparece no contato)`,telefoneDuvidoso:`Este telefone não parece completo — dá para salvar assim mesmo.`,emailDuvidoso:`Este e-mail não parece completo — dá para salvar assim mesmo.`,cpfDuvidoso:`Este CPF não confere — dá para salvar assim mesmo.`,dataDuvidosa:`Esta data não existe no calendário — dá para salvar assim mesmo.`,tipo_sanguineo:`Tipo sanguíneo`,selecione:`Selecione...`,doador:`Doador de órgãos`,alergias:`Alergias`,medicamentos:`Medicamentos em uso`,observacoes:`Observações médicas`,gestante:`Gestante`,meses:`Meses de gestação`,mes:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mesesGestacao:t=>e(t,{one:`${t} mês de gestação`,other:`${t} meses de gestação`}),parto:`Data prevista do parto`,partoEm:e=>`parto previsto ${e}`,recusa:`Recuso transfusão de sangue`,naoApliqueSangue:`NÃO APLIQUE SANGUE`,portadorDiretriz:`Portador de diretriz de recusa de transfusão.`,fracoes:`Frações aceitas por consciência`,dpaAssinado:`Cartão DPA físico atualizado e assinado em`,dpa_assinado_em:e=>`DPA assinado em ${e}`,dpaRenovar:e=>`· renovar em ${e} dias`,dpaVencido:`· vencido`,contatoNome:`Nome do contato`,contatoTelefone:`Telefone do contato`,sus:`Cartão SUS`,cpf:`CPF do titular`,upa:`UPA / hospital de referência`,sim:`Sim`,gestanteMaiusculo:`GESTANTE`,tituloCartao:`Cartão de contato`,tituloFicha:`Ficha de emergência`,semNome:`Sem nome`,semCartao:`Preencha nome e telefone no perfil para gerar o cartão.`,qrAlt:`QR com o cartão de contato (vCard)`,semFicha:`Sem dados de emergência. Preencha no perfil.`},cronologia:{intro:`De um lado a cronologia bíblica, do outro os fatos da história. Cada evento tem o link da fonte de onde saiu. Os cards “históricos” vêm de acervos oficiais fora de jw.org (UNESCO, Louvre, ONU, arquivos, museus, etc.) e seguem a datação acadêmica convencional.`,buscar:`Buscar na linha do tempo...`,limpar:`Limpar filtros`,fonte:`Ver a fonte`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),vazio:`A linha do tempo ainda não foi sincronizada. Aguarde novidades em breve.`,semFiltro:`Nenhum evento para este filtro.`},imite:{titulo:`Imite a Sua Fé`,subtitulo:`Um atrito por cartão, e a pergunta que o desarma: e se a intenção dele fosse boa? A lente certa (o modo como vemos as coisas) muda a história que contamos a nós mesmos. Errar a lente não custa nada — é nas lentes erradas que está o ensino.`,vazio:`Nenhum cartão disponível ainda. Aguarde novidades em breve.`,cenario:`O atrito`,julgamento:`O que passa pela cabeça`,pergunta:`Qual destas lentes explica melhor a intenção do outro?`,espelhoDica:`No fim do cartão há uma pergunta sobre você. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que muda quando a intenção é lida assim.`,erro:`Essa lente ainda julga a pessoa, e não a intenção. Olhe de novo.`,lente:`A lente da boa intenção`,exemplos:`Quem mais fez isso na Bíblia`,lerFonte:`Ler a fonte no jw.org`,espelhoTitulo:`O Reflexo no Espelho`,espelhoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,seloEspelho:`Espelho Escrito`,seloFeito:`Selo do Espelho Escrito conquistado!`,outrosCartoes:`Outros cartões`,inicio:`Início`},principios:{titulo:`Princípios Bíblicos`,subtitulo:`O que a Bíblia diz sobre as decisões do dia a dia — a frase que resume, os textos que a sustentam e como ela se parece numa terça-feira comum.`,vazio:`Nenhum princípio disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhum princípio para esta busca.`,buscar:`Buscar por assunto ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,comAnotacao:`Você escreveu sobre este princípio`,lido:`Você já leu este princípio`,areaLida:`Você leu todos os princípios desta área`,progresso:`Quantos princípios do acervo você já leu`,porQue:`Por que isso existe`,naPratica:`Como isso se parece num dia comum`,lerFonte:`Ler o texto na Bíblia on-line`,paraRefletir:`Para refletir`,reflexaoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,outros:`Outros princípios`,inicio:`Início`},faq:{titulo:`Perguntas Frequentes`,subtitulo:`Uma pergunta por vez, das que aparecem na porta, no trabalho, na mesa de domingo. Primeiro a cena e a resposta que vem de impulso; depois as lentes — os ângulos por onde dá para responder. Errar a lente não custa nada: é nelas que está o ensino.`,vazio:`Nenhuma pergunta disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhuma pergunta para esta busca.`,buscar:`Buscar por pergunta ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,respondida:`Você já fez esta pergunta`,categoriaConcluida:`Você fez todas as perguntas desta categoria`,progresso:`Quantas perguntas do acervo você já fez`,cenario:`Onde a pergunta aparece`,impulso:`O que vem primeiro à cabeça`,enunciado:`Qual destas lentes responde de verdade o que foi perguntado?`,preparoDica:`No fim há um espaço para a sua resposta, com as suas palavras. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que ela abre em vez de fechar.`,erro:`Essa lente responde outra coisa, ou encerra a conversa. Olhe de novo.`,aResposta:`A resposta pela Bíblia`,exemplos:`Quem respondeu assim na Bíblia`,lerArtigo:`Ler o assunto no jw.org`,paraPreparar:`Com as suas palavras`,respostaPlaceholder:`Escreva como você diria isso — ninguém além de você vai ler...`,seloPalavras:`Você escreveu a sua resposta`,seloFeito:`Selo “Com as Suas Palavras” conquistado!`,outras:`Outras perguntas`,inicio:`Início`},criacao:{vazio:`Nenhum módulo disponível ainda. Aguarde novidades em breve.`,acerto:`Isso mesmo!`,erro:`Ainda não. Observe e tente de novo.`,ajuste:`Quase lá — ajuste até alcançar a meta.`,escolha:`Escolha uma opção antes de verificar.`,equilValorX:`Valor do x`,equilPendeDir:`A balança pende para a direita: o lado do x está leve. Aumente o x.`,equilPendeEsq:`A balança pende para a esquerda: o lado do x está pesado. Diminua o x.`,equilOk:e=>`Equilíbrio! Os dois lados pesam ${e}. Você achou o x que nivela a balança.`,paresErro:`Reveja: marque exatamente as colunas com pareamento errado (A-T, C-G).`,rotaIncompleta:`Visite todas as flores antes de verificar.`,rotaOtima:`Rota mais curta encontrada!`,rotaLonga:`Há um caminho mais curto. Tente recomeçar.`,orbInforme:`Ajuste a velocidade de impulso e toque em Lançar.`,orbVoando:`Em trajetória...`,orbCai:`Velocidade baixa demais: o corpo caiu em direção ao Sol.`,orbEscapa:`Velocidade alta demais: o corpo escapou para o espaço.`,orbAjuste:`Ainda não. Ajuste a velocidade e lance de novo até obter uma órbita estável.`,escudoFraco:`Campo fraco: o vento solar ainda atinge a Terra.`,escudoOk:`Campo forte: as partículas são desviadas para os polos (auroras) ✔`,conceito:`Conceito`,desafio:`Desafio`,ampliar:`Toque para ampliar`,fechar:`Fechar`,fonte:`Fonte: jw.org`,lerFonte:`Ler a fonte no jw.org`,comecar:`Começar`,verificar:`Verificar`,avancar:`Confirmar e avançar`,concluirMapa:`Concluir o mapa`,concluir:`Concluir`,leiaReflexao:`Leia a reflexão a seguir.`,concluido:`Módulo concluído — leia a reflexão abaixo.`,diligenteSelo:`Estudo Diligente`,diligenteDica:`Ao concluir, escreva no Caderno o que você aprendeu para ganhar o selo de Estudo Diligente.`,diligenteFeito:`Selo de Estudo Diligente conquistado!`,reflexaoTitulo:`Teve um Projeto?`,reflexaoEntenda:`O que você acabou de entender`,cadernoTitulo:`Caderno do Investigador`,cadernoPlaceholder:`Escreva, com suas palavras, o que este módulo lhe ensinou sobre a sabedoria do Criador...`,outrosModulos:`Outros módulos`,inicio:`Início`,recomecar:`Recomeçar`,lancar:`Lançar`,girar:`Arraste para girar · pinça/scroll para aproximar.`,atomoDica:`Um próton por vez: veja as camadas se refazerem a cada elemento.`,proximoNumero:`Escolha o próximo número`,ordenarDica:`Toque os eventos na ordem em que aconteceram (toque de novo para tirar).`,paresDica:`Toque nas colunas cujo pareamento está errado (válidos: A-T e C-G).`,rotaDica:`A abelha sai da colmeia, visita todas as flores e volta. Toque nas flores na ordem que faz o caminho mais curto (toque de novo para desfazer).`,rotaMedida:(e,t)=>`Seu caminho: ${e}  ·  menor possível: ${t}`,ciclosRecomecar:`Começar de novo`,explorarDica:`Toque cada visão para abri-la.`,explorarDesdobra:`desdobra`,gaivotaMesmo:`Mesma direção`,gaivotaOposto:`Direções opostas`,gaivotaVolta:`Volta ao corpo`,gaivotaPe:`Chega ao pé`,gaivotaCalor:`Calor recuperado`,proteinaRecorde:`Recorde`,proteinaAgora:`Agora`,proteinaRelogio:`Relógio da improbabilidade`,proteinaNecessarias:`Tentativas necessárias`,proteinaFaltam:`Ainda faltam`,proteinaTempo:`A 1 bilhão de tentativas por segundo, o cálculo levaria`,proteinaAnos:`anos para concluir.`,ciclosFechados:`ciclos fechados`,visoes:`visões`,camadas:`camadas`},caderno:{ver:`Ver no Caderno de Estudo`,intro:`Reúne o que você escreve em Entenda Melhor, Teve um Projeto?, Momento de Estudo e o jogo Língua Pura — e as suas anotações avulsas.`,nova:`Nova anotação`,editar:`Editar anotação`,buscar:`Buscar...`,todasOrigens:`Todas as origens`,origem:`Origem`,titulo:`Título`,tituloPlaceholder:`Um título curto (opcional)`,referencia:`Referência`,referenciaPlaceholder:`Módulo, texto bíblico, assunto... (opcional)`,conteudo:`O que você aprendeu`,conteudoPlaceholder:`Escreva, com suas palavras, o que este estudo lhe ensinou...`,semConteudo:`Escreva o que você aprendeu antes de salvar.`,vazio:`Seu caderno está vazio. Anote o que aprender nos estudos.`,semFiltro:`Nenhuma anotação para este filtro.`,salva:`Anotação salva.`,excluir:`Excluir anotação`,excluida:`Anotação excluída.`},tutorial:{intro:`Como usar o Kobi Note — uma explicação por módulo.`,visaoGeral:`Visão geral`,modulos:`Módulos`,vazio:`O tutorial ainda não foi sincronizado. Aguarde novidades em breve.`,semTopico:`Este módulo ainda não tem um tópico escrito no tutorial.`},notas:{titulo:`Notas de rodapé`,voltar:`Voltar ao ponto da nota`}},At=`modulepreload`,jt=function(e,t){return new URL(e,t).href},Mt={},b=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=jt(t,n),t=s(t),t in Mt)return;Mt[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:At,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Nt=[{tag:`pt-BR`,nome:`Português (Brasil)`},{tag:`en`,nome:`English`,carregar:()=>b(()=>import(`./en-B8-UBp4D.js`),__vite__mapDeps([0,1]),import.meta.url)},{tag:`es-ES`,nome:`Español (España)`,carregar:()=>b(()=>import(`./es-ES-DSx76R2m.js`),__vite__mapDeps([2,1]),import.meta.url)}],Pt=`note_idioma`,Ft=kt,It=Nt[0]?.tag??`pt-BR`,x=Ft;function Lt(){let e=null;try{e=localStorage.getItem(Pt)}catch{}if(e!==null&&Nt.some(({tag:t})=>t===e))return e;let t=navigator.language?.toLowerCase()??``;return Nt.find(({tag:e})=>e.toLowerCase().split(`-`)[0]===t.split(`-`)[0])?.tag??It}function Rt(e,t){let n={...e};for(let[r,i]of Object.entries(t)){let t=e[r];n[r]=typeof t==`object`&&t&&!Array.isArray(t)?{...t,...i}:i}return n}async function zt(e){let n=Nt.find(t=>t.tag===e);if(n===void 0)throw Error(`idioma desconhecido: ${e} (ver src/i18n/idioma.ts)`);Ft=n.carregar===void 0?kt:Rt(kt,(await n.carregar()).default),x=Ft,It=n.tag,t(n.tag),document.documentElement.lang=n.tag;try{localStorage.setItem(Pt,n.tag)}catch{}}var Bt=[{id:`prep-kits`,get rotulo(){return x.prep.kits},icone:`clipboard-list`,cor:`#dc3545`,rota:`prep/kits`},{id:`prep-estoque`,get rotulo(){return x.prep.estoque},icone:`package`,cor:`#e8590c`,rota:`prep/estoque`},{id:`prep-cofre`,get rotulo(){return x.prep.cofre},icone:`lock`,cor:`#495057`,rota:`prep/cofre`}],Vt=[{id:`anotacoes`,get rotulo(){return x.modulos.anotacoes},icone:`notes`,cor:`#0d6efd`},{id:`guias`,get rotulo(){return x.modulos.guias},icone:`map-2`,cor:`#20c997`},{id:`poesia`,get rotulo(){return x.modulos.poesia},icone:`feather`,cor:`#0dcaf0`},{id:`receitas`,get rotulo(){return x.modulos.receitas},icone:`chef-hat`,cor:`#fd7e14`},{id:`jogo`,get rotulo(){return x.modulos.jogo},icone:`device-gamepad-2`,cor:`#2f9e44`},{id:`criacao`,get rotulo(){return x.modulos.criacao},icone:`compass`,cor:`#0ca678`},{id:`entenda`,get rotulo(){return x.modulos.entenda},icone:`bulb`,cor:`#fd7e14`},{id:`imite`,get rotulo(){return x.modulos.imite},icone:`heart-handshake`,cor:`#d63384`},{id:`principios`,get rotulo(){return x.modulos.principios},icone:`scale`,cor:`#c92a2a`},{id:`faq`,get rotulo(){return x.modulos.faq},icone:`message-question`,cor:`#4263eb`},{id:`cronologia`,get rotulo(){return x.modulos.cronologia},icone:`timeline`,cor:`#82c91e`},{id:`caderno`,get rotulo(){return x.modulos.caderno},icone:`book-2`,cor:`#f59f00`},{id:`prep`,get rotulo(){return x.modulos.prep},icone:`shield-check`,cor:`#dc3545`},{id:`financeiro`,get rotulo(){return x.modulos.financeiro},icone:`cash`,cor:`#198754`},{id:`metas`,get rotulo(){return x.modulos.metas},icone:`target`,cor:`#0d6efd`,noPainel:!0},{id:`ministerio`,get rotulo(){return x.modulos.ministerio},icone:`users`,cor:`#0ca678`},{id:`servico`,get rotulo(){return x.modulos.servico},icone:`trending-up`,cor:`#0dcaf0`,dentroDe:`ministerio`},{id:`estudo`,get rotulo(){return x.modulos.estudo},icone:`hourglass`,cor:`#7048e8`},{id:`leitura`,get rotulo(){return x.modulos.leitura},icone:`book`,cor:`#1c7ed6`},{id:`calendario`,get rotulo(){return x.modulos.calendario},icone:`calendar`,cor:`#0dcaf0`},{id:`perfil`,get rotulo(){return x.modulos.perfil},icone:`id-badge-2`,cor:`#dc3545`},{id:`tutorial`,get rotulo(){return x.modulos.tutorial},icone:`help-circle`,cor:`#f59f00`},{id:`sobre`,get rotulo(){return x.modulos.sobre},icone:`info-circle`,cor:`#6c757d`}],Ht=[{id:`dia`,painel:`hoje`,itens:[{tipo:`modulo`,id:`anotacoes`},{tipo:`modulo`,id:`calendario`},{tipo:`modulo`,id:`ministerio`}]},{id:`numeros`,painel:`indicadores`,itens:[]},{id:`estudo`,get titulo(){return x.secoes.estudo},itens:[{tipo:`modulo`,id:`leitura`},{tipo:`modulo`,id:`estudo`},{tipo:`modulo`,id:`imite`},{tipo:`modulo`,id:`principios`},{tipo:`modulo`,id:`faq`},{tipo:`modulo`,id:`jogo`},{tipo:`modulo`,id:`entenda`},{tipo:`modulo`,id:`criacao`},{tipo:`modulo`,id:`cronologia`},{tipo:`modulo`,id:`poesia`},{tipo:`modulo`,id:`caderno`}]},{id:`prep`,get titulo(){return x.secoes.prep},painel:`prontidao`,itens:[{tipo:`atalho`,id:`prep-kits`},{tipo:`atalho`,id:`prep-estoque`},{tipo:`atalho`,id:`prep-cofre`},{tipo:`modulo`,id:`guias`}]},{id:`extras`,get titulo(){return x.secoes.extras},itens:[{tipo:`modulo`,id:`receitas`}]},{id:`pessoal`,get titulo(){return x.secoes.pessoal},itens:[{tipo:`modulo`,id:`financeiro`},{tipo:`modulo`,id:`perfil`}]},{id:`aplicativo`,get titulo(){return x.secoes.aplicativo},itens:[{tipo:`modulo`,id:`tutorial`},{tipo:`acao`,id:`sincronizar`},{tipo:`acao`,id:`convite`},{tipo:`modulo`,id:`sobre`}]}],Ut=new Map(Vt.map(e=>[e.id,e])),Wt=new Map(Bt.map(e=>[e.id,e]));function Gt(e){return Ut.get(e)}function Kt(e){return Wt.get(e)}function qt(e){return u.features[e]===!0}function Jt(){let[e=``,t=``]=location.hash.replace(/^#\/?/,``).split(`?`),n=e.split(`/`).filter(e=>e!==``);return{modulo:n[0]??`home`,args:n.slice(1),query:new URLSearchParams(t)}}function Yt(e){location.hash=e.startsWith(`#`)?e:`#/${e.replace(/^\//,``)}`}function Xt(e){addEventListener(`hashchange`,()=>e(Jt())),e(Jt())}var Zt=()=>{};function Qt(e){Zt=e}function $t(){Zt()}var en=`false`,tn=`false`,nn=en===`true`,rn=tn===`true`;function an(e={}){let{immediate:t=!1,onNeedReload:n,onNeedRefresh:r,onOfflineReady:i,onRegistered:a,onRegisteredSW:o,onRegisterError:s}=e,c,l,u,d=async(e=!0)=>{await l,nn||u?.()};async function ee(){if(`serviceWorker`in navigator){if(c=await b(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-Bd17z0YL.js`);return{Workbox:e}},[],import.meta.url).then(({Workbox:e})=>new e(`./sw.js`,{scope:`./`,type:`classic`})).catch(e=>{s?.(e)}),!c)return;if(u=()=>{c?.messageSkipWaiting()},!rn){if(nn)c.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&(n?n():window.location.reload())}),c.addEventListener(`installed`,e=>{e.isUpdate||i?.()});else{let e=!1,t=()=>{e=!0,c?.addEventListener(`controlling`,e=>{e.isUpdate&&(n?n():window.location.reload())}),r?.()};c.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&i?.():n.isExternal?t():!e&&i?.():n.isUpdate||i?.()}),c.addEventListener(`waiting`,t)}}c.register({immediate:t}).then(e=>{o?o(`./sw.js`,e):a?.(e)}).catch(e=>{s?.(e)})}}return l=ee(),d}function on(){let e=an({onNeedRefresh(){sn(()=>{e(!0)})}})}function sn(e){let t=Object.assign(document.createElement(`kk-alert`),{variant:`primary`,closable:!0}),n=document.createElement(`kk-icon`);n.setAttribute(`slot`,`icon`),n.setAttribute(`name`,`sparkles`);let r=document.createElement(`strong`);r.textContent=x.atualizacao.titulo;let i=document.createElement(`kk-button`);i.setAttribute(`size`,`small`),i.setAttribute(`variant`,`primary`),i.textContent=x.atualizacao.acao,i.addEventListener(`click`,e),t.append(n,r,document.createTextNode(` ${x.atualizacao.texto} `),i),document.body.append(t),t.toast()}var cn=864e5;function ln(e=new Date){let t=e instanceof Date?e:new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function un(e=new Date){return ln(e).slice(0,7)}function dn(e){return ln(new Date(Date.now()+e*cn))}function fn(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1,0,0,0,0).getTime()}var pn=e=>String(e).padStart(2,`0`);function mn(e){return`${pn(e.getDate())}/${pn(e.getMonth()+1)}/${e.getFullYear()}`}function hn(e){return e===void 0||e===0||Number.isNaN(e)?``:mn(new Date(e))}function gn(e){if(e===void 0||e===0||Number.isNaN(e))return``;let t=new Date(e);return`${mn(t)}, ${pn(t.getHours())}:${pn(t.getMinutes())}`}function _n(e){if(e===void 0||e===``)return``;let[t,n,r]=e.split(`-`);return t===void 0||n===void 0||r===void 0?e:`${r}/${n}/${t}`}function vn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number);return ln(new Date(n,r-1,i+t))}function yn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number),a=new Date(n,r-1+t,1),o=new Date(a.getFullYear(),a.getMonth()+1,0).getDate();return ln(new Date(a.getFullYear(),a.getMonth(),Math.min(i,o)))}function bn(e,t){if(e===``||t===``)return 0;let[n=0,r=1,i=1]=e.split(`-`).map(Number),[a=0,o=1,s=1]=t.split(`-`).map(Number),c=new Date(a,o-1,s).getTime()-new Date(n,r-1,i).getTime();return Math.round(c/cn)}function xn(){let e=ln();return{inicio:fn(e),fim:fn(vn(e,1))-1}}async function Sn(){let{inicio:e,fim:t}=xn(),[n]=await i(`eventosDoDia`,[t,e]);return Number(n?.total??0)}async function Cn(){if(typeof navigator.setAppBadge==`function`)try{let e=await Sn();await(e>0?navigator.setAppBadge(e):navigator.clearAppBadge())}catch{}}var wn=!1;function Tn(){Cn(),!wn&&(wn=!0,document.addEventListener(`visibilitychange`,()=>{Cn()}))}var En=10,Dn=100,On=e=>new Promise(t=>setTimeout(t,e));async function kn(){let e=await navigator.storage?.getDirectory?.();if(e!==void 0)for(let t=0;t<En;t++){let t=[];for await(let n of e.keys())t.push(n);if(t.length===0)return;let n=!1;for(let r of t)try{await e.removeEntry(r,{recursive:!0})}catch{n=!0}if(!n)return;await On(Dn)}}function An(e){return new Promise(t=>{let n=indexedDB.deleteDatabase(e);n.onsuccess=()=>t(!0),n.onerror=()=>t(!1),n.onblocked=()=>t(!1)})}async function jn(){for(let e=0;e<En;e++){let e=(await indexedDB.databases?.()??[]).map(({name:e})=>e).filter(e=>e!==void 0);if(e.length===0||(await Promise.all(e.map(An))).every(Boolean))return;await On(Dn)}}async function Mn(){let e=await navigator.serviceWorker?.getRegistrations?.()??[];await Promise.all(e.map(e=>e.unregister()));let t=await caches?.keys?.()??[];await Promise.all(t.map(e=>caches.delete(e)))}async function Nn(){n(),await kn(),await Mn(),await jn(),localStorage.clear(),sessionStorage.clear()}var Pn=`note_versoes_curado`,Fn={perguntas:`perguntas`,poesias:`poesias`,receitas:`receitas`,guias:`guias`,kits:`kits`,criacao_modulos:`criacao_modulos`,imite_cartoes:`imite_cartoes`,principios:`principios`,faq:`faq`,cronologia:`cronologia`,anotacao_modelos:`anotacao_modelos`,estoque_catalogo:`estoque_catalogo`,tutorial:`tutorial`};async function In(e,t){return t.registros===void 0||t.registros===0||await r(e).contar().then(e=>e>0).catch(()=>!0)}function Ln(){try{return JSON.parse(localStorage.getItem(Pn)??`{}`)}catch{return{}}}async function Rn(e){try{let t=await fetch(`${u.apiEndpoint}/${e}`,{cache:`no-cache`});return t.ok?await t.json():void 0}catch{return}}async function zn(){let e=await Rn(`manifesto.json`);if(e===void 0)return{ok:!1,motivo:`offline`};let t=e.modulos;if(t===void 0)return{ok:!1,motivo:`sem-manifesto`};let n=Ln(),i=[];for(let[e,o]of Object.entries(t)){let t=Fn[e];if(t===void 0||!a.includes(t)||o.versao!==void 0&&n[e]===o.versao&&await In(t,o))continue;let s=await Rn(`${e}.json`);s!==void 0&&(await r(t).substituirTudo(s),o.versao!==void 0&&(n[e]=o.versao),i.push(e))}return localStorage.setItem(Pn,JSON.stringify(n)),await Vn(`categorias_financeiro`,`categorias.json`).catch(Bn),await Un().catch(Bn),{ok:!0,atualizados:i}}function Bn(e){console.warn(`semeadura do padrão de fábrica falhou:`,e)}async function Vn(e,t){let n=r(e);if((await n.todos().catch(()=>[])).length>0)return;let i=await Rn(t);if(i!==void 0)for(let e of i){let{publicar:t,...r}=e;await n.salvar(r)}}var Hn;function Un(){return Hn??=Vn(`calendario_tipos`,`calendario_tipos.json`).catch(e=>{throw Hn=void 0,e}),Hn}var Wn=`note_tema`,Gn=`#ffffff`,Kn=`#0f1115`;function qn(){return document.documentElement.classList.contains(`kk-theme-dark`)?`escuro`:`claro`}function Jn(e){let t=e===`escuro`,n=document.documentElement.classList;n.toggle(`kk-theme-dark`,t),n.toggle(`kk-theme-light`,!t),document.querySelector(`meta[name="theme-color"]`)?.setAttribute(`content`,t?Kn:Gn),localStorage.setItem(Wn,e)}function Yn(){let e=qn()===`escuro`?`claro`:`escuro`;return Jn(e),e}var Xn,Zn;function Qn(){let e=document.querySelector(`.barra`);e!==null&&e!==Zn&&(Xn??=new ResizeObserver(e=>{let t=e[e.length-1]?.target;if(t===void 0)return;let n=t.getBoundingClientRect().height;document.documentElement.style.setProperty(`--note-barra-altura`,`${n}px`)}),Zn!==void 0&&Xn.unobserve(Zn),Xn.observe(e),Zn=e)}var $n={projetos:{bioma:{versao:`1.0.0`,build:`2026-09-11T23:04:46.040Z`},admin:{versao:`1.0.129`,build:`2026-09-11T23:04:46.040Z`},note:{versao:`0.0.225`,build:`2026-09-11T22:44:37.248Z`},ui:{versao:`1.0.80`,build:`2026-09-11T22:42:49.640Z`},dev:{versao:`1.1.102`,build:`2026-09-10T23:17:21.120Z`},flow:{versao:`0.0.84`,build:`2026-09-10T23:40:16.940Z`},bin:{versao:`0.0.0`,build:`2026-09-04T17:43:53.952Z`},sql:{versao:`3.53.4`,build:`2026-09-04T17:18:39.584Z`}},componentesUi:81,pacotes:[{nome:`@kobi/admin`,versao:`1.0.129`,caminho:`apps/admin`},{nome:`kobi-dev`,versao:`1.1.102`,caminho:`apps/dev`},{nome:`@kobi/flow`,versao:`0.0.84`,caminho:`apps/flow`},{nome:`@kobi/note`,versao:`0.0.225`,caminho:`apps/note`},{nome:`@bioma/bin`,versao:`0.0.0`,caminho:`packages/bin`},{nome:`@bioma/core`,versao:`0.0.0`,caminho:`packages/core`},{nome:`@bioma/js`,versao:`0.1.0`,caminho:`packages/js`},{nome:`@kobi/kit`,versao:`1.0.80`,caminho:`packages/kit`},{nome:`@bioma/sabores`,versao:`0.0.0`,caminho:`packages/sabores`},{nome:`@bioma/sql`,versao:`3.53.4`,caminho:`packages/sql`},{nome:`@bioma/wasm`,versao:`1.0.0`,caminho:`packages/wasm`}],sementes:{flw_respostas_rapidas:8,not_anotacao_modelos:7,not_calendario_tipos:6,not_categorias_financeiro:17,not_criacao_modulos:63,not_cronologia_eventos:594,not_estoque_alimentos:32,not_guias:15,not_imite_cartoes:89,not_itens_checklist:96,not_kits_checklist:6,not_perguntas:1273,not_poesias:275,not_principios:112,not_receitas:4}}.projetos.note?.build.slice(0,4)??``;function er(){return v`
  ...
  `}function zr(e){return e instanceof Error?e.message:String(e)}var S={anotacoes:0,eventosHoje:[],contasVencendo:0,leituraPercentual:0,metasAtivas:0,metasConcluidas:0,focoMinutos:0,horasDoMes:0,receitasFavoritas:0,prontidao:0,prontidaoTom:`perigo`,kits:0,autonomiaDias:0},Br=!1,Vr=!1,Hr=!0,Ur=!1;function Wr(){Ur||(Ur=!0,addEventListener(`hashchange`,()=>{location.hash.replace(/^#\/?/,``).split(`/`)[0]!==`home`&&(Hr=!0)}))}async function Gr(e,t){try{return await e()}catch{return t}}async function Kr(){let e=ln(),t=un(),[n,r,i,a,o,s,c,l,u]=await Promise.all([Gr(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await b(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await import(`./dados-BVOaoWLs.js`);return{FILTROS_INICIAIS:e,listarAnotacoes:t}},__vite__mapDeps([3,4,5]),import.meta.url);return(await t(e)).length},0),Gr(async()=>{let t=await b(()=>import(`./dados-CZCwgwuE.js`),__vite__mapDeps([6,4]),import.meta.url),{eventos:n,tipos:r}=await t.carregar();return t.eventosDoDia(n,e).map(e=>({titulo:e.titulo,quando:e.dia_inteiro===1?x.painel.diaInteiro:t.comoHora(e.hora_inicio_min),cor:t.corDoTipo(r,e.tipo_id)}))},[]),Gr(async()=>{let{carregar:t,TIPO_DESPESA:n}=await b(async()=>{let{carregar:e,TIPO_DESPESA:t}=await import(`./dados-8R9lKAmy.js`);return{carregar:e,TIPO_DESPESA:t}},__vite__mapDeps([7,8,9,4]),import.meta.url),{transacoes:r}=await t(),i=new Date(`${e}T23:59:59`).getTime();return r.filter(e=>e.tipo===n&&e.esta_pago!==1&&e.data_vencimento!==0&&e.data_vencimento<=i).length},0),Gr(async()=>{let{lerLidos:e,percentualGeral:t}=await b(async()=>{let{lerLidos:e,percentualGeral:t}=await import(`./dados-CrToLRPu.js`);return{lerLidos:e,percentualGeral:t}},[],import.meta.url);return t(e())},0),Gr(async()=>{let{listarMetas:e}=await b(async()=>{let{listarMetas:e}=await import(`./dados-BL0H4DC9.js`);return{listarMetas:e}},__vite__mapDeps([10,9,8,4,5]),import.meta.url),t=await e();return{ativas:t.filter(e=>e.esta_concluida!==1).length,concluidas:t.filter(e=>e.esta_concluida===1).length}},{ativas:0,concluidas:0}),Gr(async()=>{let{listarSessoes:e,totalDeMinutos:n}=await b(async()=>{let{listarSessoes:e,totalDeMinutos:t}=await import(`./dados-DpMyNUKi.js`);return{listarSessoes:e,totalDeMinutos:t}},__vite__mapDeps([11,4]),import.meta.url);return n((await e()).filter(e=>un(e.concluido_em)===t))},0),Gr(async()=>{let{carregar:e}=await b(async()=>{let{carregar:e}=await import(`./dados-D4GL8eM0.js`);return{carregar:e}},__vite__mapDeps([12,4,5]),import.meta.url),{contador:t}=await e();return Math.floor(t.minutos/60)},0),Gr(async()=>{let{lerFavoritos:e}=await b(async()=>{let{lerFavoritos:e}=await import(`./favoritos-DAEWA_Gd.js`);return{lerFavoritos:e}},[],import.meta.url),{CHAVE_FAVORITOS:t}=await b(async()=>{let{CHAVE_FAVORITOS:e}=await import(`./dados-DndfAb6P.js`);return{CHAVE_FAVORITOS:e}},__vite__mapDeps([13,4,14]),import.meta.url);return e(t).size},0),Gr(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await b(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await import(`./dados-BgDpV8rv.js`);return{calcularProntidao:e,tomDaProntidao:t}},[],import.meta.url),{carregarKits:n,lerProgresso:r}=await b(async()=>{let{carregarKits:e,lerProgresso:t}=await import(`./kits-wSJKcpc9.js`);return{carregarKits:e,lerProgresso:t}},__vite__mapDeps([15,4]),import.meta.url),{calcularAutonomia:i,carregarEstoque:a,lerPerfil:o}=await b(async()=>{let{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}=await import(`./estoque-Buk0873C.js`);return{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}},__vite__mapDeps([16,4,5,17]),import.meta.url),[s,c]=await Promise.all([n(),a()]),l=o(),u=e({kits:s,progresso:r(),estoque:c,perfil:l});return{prontidao:u,tom:t(u),kits:s.length,autonomiaDias:i(c,l).dias}},{prontidao:0,tom:`perigo`,kits:0,autonomiaDias:0})]);return{anotacoes:n,eventosHoje:r,contasVencendo:i,leituraPercentual:a,metasAtivas:o.ativas,metasConcluidas:o.concluidas,focoMinutos:s,horasDoMes:c,receitasFavoritas:l,prontidao:u.prontidao,prontidaoTom:u.tom,kits:u.kits,autonomiaDias:u.autonomiaDias}}function qr(){Wr(),!Vr&&Hr&&(Hr=!1,Vr=!0,(async()=>{try{S=await Kr(),Br=!0}finally{Vr=!1,$t()}})())}function Jr(e){if(Br&&qt(e)){if(e===`anotacoes`&&S.anotacoes>0)return x.painel.anotacoes(S.anotacoes);if(e===`calendario`&&S.eventosHoje.length>0)return x.painel.eventosHoje(S.eventosHoje.length);if(e===`financeiro`&&S.contasVencendo>0)return x.painel.contasVencendo(S.contasVencendo);if(e===`leitura`&&S.leituraPercentual>0)return x.painel.leitura(S.leituraPercentual);if(e===`metas`&&S.metasAtivas>0)return x.painel.metas(S.metasAtivas);if(e===`ministerio`&&S.horasDoMes>0)return x.painel.horas(S.horasDoMes);if(e===`estudo`&&S.focoMinutos>0)return x.painel.foco(S.focoMinutos);if(e===`receitas`&&S.receitasFavoritas>0)return x.painel.favoritas(S.receitasFavoritas);if(e===`guias`)return x.prep.guiasResumo}}function Yr(e){if(Br&&qt(`prep`)){if(e===`prep-kits`)return x.prep.contagemKits(S.kits);if(e===`prep-estoque`)return x.prep.diasAutonomia(S.autonomiaDias);if(e===`prep-cofre`)return x.prep.cofreResumo}}function Xr(e,t,n){let r=Gt(e);return v`
    <button
      class="indicador"
      data-modulo=${e}
  ...
  `}function ei(e){return qr(),Br?e===`hoje`?Zr():e===`indicadores`?Qr():$r():e===`hoje`?v`<p class="intro">${x.home.sub}</p>`:y}var ti=`#82c91e`,ni=`#ae3ec9`;function ri(e){let t=qt(e.id);return si({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:Jr(e.id),emBreve:!t,aoTocar:()=>Yt(e.id)})}function ii(e){let t=qt(e.rota.split(`/`)[0]??``);return si({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:Yr(e.id),emBreve:!t,aoTocar:()=>Yt(e.rota)})}function ai(e){return si({cor:ti,icone:`refresh`,rotulo:x.home.sincronizar,resumo:e.ocupado?x.home.sincronizando:void 0,ocupado:e.ocupado,aoTocar:()=>e.executar()})}function oi(){return si({cor:ni,icone:`share`,rotulo:x.convite.tile,resumo:x.convite.tileResumo,aoTocar:()=>{(async()=>{let{abrirConvite:e}=await b(async()=>{let{abrirConvite:e}=await import(`./convite-DkMvZG5K.js`);return{abrirConvite:e}},__vite__mapDeps([18,19]),import.meta.url);await e()})()}})}function si(e){return v`
    <button
      class="tile"
      style="--cor: ${e.cor}"
  ...
  `}function li(e,t){return e.itens.map(e=>{if(e.tipo===`acao`)return e.id===`sincronizar`?ai(t):e.id===`convite`?oi():y;if(e.tipo===`atalho`){let t=Kt(e.id);return t===void 0?y:ii(t)}let n=Gt(e.id);return n===void 0?y:ri(n)}).filter(e=>e!==y)}function ui(e){return v`
    ${Ht.map((t,n)=>{let r=t.painel===void 0?y:ei(t.painel),i=li(t,e);return r===y&&i.length===0?y:v`
        ${ci(t,n===0)}
        ${r}
        ${i.length===0?y:v`<div class="tiles">${i}</div>`}
      `})}
  `}var di=`note_passkey`,fi=32;function pi(e){let t=String.fromCharCode(...new Uint8Array(e));return btoa(t).replaceAll(`+`,`-`).replaceAll(`/`,`_`).replace(/=+$/,``)}function mi(e){let t=atob(e.replaceAll(`-`,`+`).replaceAll(`_`,`/`));return Uint8Array.from(t,e=>e.charCodeAt(0))}function hi(){let e=localStorage.getItem(di);if(e===null)return null;try{let t=JSON.parse(e);return typeof t.id==`string`&&typeof t.sal==`string`?{id:t.id,sal:t.sal}:null}catch{return null}}function gi(){return hi()!==null}function _i(){return isSecureContext&&typeof PublicKeyCredential<`u`}var vi=class extends Error{},yi=class extends Error{};function bi(){return location.hostname}var xi=new TextEncoder().encode(`kobi-note`);async function Si(){let e=crypto.getRandomValues(new Uint8Array(fi)),t;try{t=await navigator.credentials.create({publicKey:{rp:{name:`Kobi Note`,id:bi()},user:{id:xi,name:`kobi-note`,displayName:`Kobi Note`},challenge:crypto.getRandomValues(new Uint8Array(32)),pubKeyCredParams:[{type:`public-key`,alg:-7},{type:`public-key`,alg:-257}],authenticatorSelection:{residentKey:`required`,userVerification:`required`},extensions:{prf:{}}}})}catch{throw new vi}if(!(t instanceof PublicKeyCredential))throw new vi;if(t.getClientExtensionResults().prf?.enabled!==!0)throw new yi;let n={id:pi(t.rawId),sal:pi(e)},r=await Ci(n);return localStorage.setItem(di,JSON.stringify(n)),r}async function Ci(e){let t;try{t=await navigator.credentials.get({publicKey:{rpId:bi(),challenge:crypto.getRandomValues(new Uint8Array(32)),allowCredentials:[{type:`public-key`,id:mi(e.id)}],userVerification:`required`,extensions:{prf:{eval:{first:mi(e.sal)}}}}})}catch{throw new vi}if(!(t instanceof PublicKeyCredential))throw new vi;let n=t.getClientExtensionResults().prf?.results?.first;if(n===void 0)throw new yi;let r=new Uint8Array(n.byteLength);return r.set(n instanceof ArrayBuffer?new Uint8Array(n):new Uint8Array(n.buffer,n.byteOffset,n.byteLength)),r}async function wi(){let e=hi();if(e===null)throw new vi;return Ci(e)}function Ti(e){return e instanceof yi?x.bloqueio.semPrf:e instanceof vi?x.bloqueio.gestoRecusado:String(e)}async function Ei(e){if(!_i())return null;if(gi())try{return await wi()}catch(t){return Di(e,`desbloquear`,Ti(t))}return Di(e,`proteger`,``)}function Di(e,t,n){return new Promise(r=>{let i=!1,a=n,o=async()=>{if(!i){i=!0,a=``,s();try{r(t===`proteger`?await Si():await wi())}catch(e){a=Ti(e),i=!1,s()}}},s=()=>{e!==null&&wt(v`
          <div class="bloqueio">
            <img
              class="bloqueio__mascote"
              src="./icons/mascote-kobi-note.svg"
              alt=""
              width="640"
              height="768"
            />
            <h2 class="bloqueio__titulo">
              ${t===`proteger`?x.bloqueio.protegerTitulo:x.bloqueio.bloqueadoTitulo}
            </h2>
            <p class="bloqueio__texto">
              ${t===`proteger`?x.bloqueio.protegerTexto:x.bloqueio.bloqueadoTexto}
            </p>
            ${a===``?y:v`<p class="erro">${a}</p>`}
            <kk-button variant="primary" size="large" ?loading=${i} @click=${()=>void o()}>
              <kk-icon slot="prefix" name="fingerprint"></kk-icon>
              ${t===`proteger`?x.bloqueio.proteger:x.bloqueio.desbloquear}
            </kk-button>
          </div>
        `,e)};s()})}function Oi(e,t,n,r={}){let i=document.createElement(`kk-dialog`);return i.setAttribute(`label`,e),r.semCabecalho===!0&&i.setAttribute(`no-header`,``),r.classe!==void 0&&(i.className=r.classe),document.body.append(i),new Promise(e=>{let r=t,a=e=>{r=e,i.open=!1},o=()=>{wt(n(a,i,o),i)};i.addEventListener(`kk-after-hide`,t=>{t.target===i&&(i.remove(),e(r))}),o(),i.updateComplete.then(()=>{i.open=!0})})}function ki(e){return Oi(e.titulo,!1,t=>v`
      ${e.texto??``}
    ...
    `})}var ji=null,Mi=new Set;function Ni(){for(let e of Mi)e()}typeof window<`u`&&(window.addEventListener(`beforeinstallprompt`,e=>{e.preventDefault(),ji=e,Ni()}),window.addEventListener(`appinstalled`,()=>{ji=null,Ni()}));function Pi(){return ji!==null}async function Fi(){let e=ji;if(e===null)return!1;ji=null,Ni();let{outcome:t}=await e.prompt();return t===`accepted`}function Ii(e){return Mi.add(e),()=>Mi.delete(e)}var Li=`note_boas_vindas_visto`,Ri=[{id:`bemVindo`,cor:`#fdf10d`},{id:`painel`,icone:`layout-grid`,cor:`#6f42c1`},{id:`offline`,icone:`wifi-off`,cor:`#198754`},{id:`privado`,icone:`shield-lock`,cor:`#dc3545`},{id:`instalar`,icone:`device-mobile`,cor:`#fd7e14`}];function zi(){try{return localStorage.getItem(Li)!==null}catch{return!0}}function Bi(){try{localStorage.setItem(Li,`1`)}catch{}}function Vi(e){let t=Ri[e];if(t===void 0)return v``;let n=x.boasVindas.passos[t.id];return v`
    <div class="bv" style="--cor: ${t.cor}">
      ...
      ${t.id===`instalar`&&Pi()?v`
            <kk-button class="bv__instalar" variant="primary" @click=${()=>void Fi()}>
      ...
      <div
        ...
        role="progressbar"
        aria-valuemin="1"
        aria-valuemax=${Ri.length}
        aria-valuenow=${e+1}
        aria-valuetext=${x.boasVindas.passo(e+1,Ri.length)}
      >
        ${Ri.map((t,n)=>v`<span class="bv__ponto ${n===e?`bv__ponto--atual`:``}"></span>`)}
      </div>
    </div>
  `}function Hi(){let e=0,t=()=>{};return Oi(x.boasVindas.passos.bemVindo.titulo,void 0,(n,r,i)=>{t(),t=Ii(i);let a=e===Ri.length-1;return v`
...
`,vo={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},yo=e=>(...t)=>({_$litDirective$:e,values:t}),bo=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},E=yo(class extends bo{constructor(e){if(super(e),e.type!==vo.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return Xa}}),D=C`
...
`,xo={attribute:!0,type:String,converter:Ta,reflect:!1,hasChanged:Ea},So=(e=xo,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function O(e){return(t,n)=>typeof n==`object`?So(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function k(e){return O({...e,state:!0,attribute:!1})}var Co=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n);function A(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return Co(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return Co(n,r,{get(){return a(this)}})}}var wo=new WeakMap,To=(e=`value`)=>(t,n)=>{n.addInitializer(function(){let t={observada:e,destino:String(n.name)},r=wo.get(this);r?r.push(t):wo.set(this,[t])})};function Eo(e,t,n){let r=wo.get(e);if(!r)return;let i=e.constructor,a=e;for(let{observada:e,destino:o}of r){let r=i.getPropertyOptions(e);if(t!==(typeof r.attribute==`string`?r.attribute:e))continue;let s=r.converter||Ta,c=(typeof s==`function`?s:s?.fromAttribute??Ta.fromAttribute)(n,r.type);a[e]!==c&&(a[o]=c)}}var Do=new WeakMap;function j(e,t){let n=Array.isArray(e)?e:[e],r=t?.waitUntilFirstUpdate??!1;return(e,t)=>{t.addInitializer(function(){let t={propriedades:n,handler:e,esperarPrimeiroRender:r},i=Do.get(this);i?i.push(t):Do.set(this,[t])})}}function Oo(e,t){let n=Do.get(e);if(!n)return;let r=e,i=new Set;for(let a=0;a<10;a++){let a=!1;for(let[o,{propriedades:s,handler:c,esperarPrimeiroRender:l}]of n.entries())if(!l||e.hasUpdated)for(let n of s){if(!t.has(n))continue;let s=`${o}:${n}`;if(i.has(s))continue;let l=t.get(n),u=r[n];l!==u&&(i.add(s),a=!0,c.call(e,l,u))}if(!a)return}}var ko,Ao,jo,Mo,No,Po,Fo,M=class extends (jo=ho,Ao=[O()],ko=[O()],jo){constructor(){super(),g(this,`_internals`),_(this,No,m(Mo,8,this)),m(Mo,11,this),_(this,Po,m(Mo,12,this)),m(Mo,15,this),_(this,Fo,!1),g(this,`initialReflectedProperties`,new Map),this._internals=this.attachInternals(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...t});return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v${t.version}`),`version`in r&&r.version&&(a=` v${r.version}`),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}addState(e){this._internals.states&&this._internals.states.add(e.startsWith(`--`)?e:`--${e}`)}removeState(e){this._internals.states&&this._internals.states.delete(e.startsWith(`--`)?e:`--${e}`)}toggleState(e,t){let n=e.startsWith(`--`)?e:`--${e}`;this._internals.states&&(typeof t==`boolean`?t?this._internals.states.add(n):this._internals.states.delete(n):this._internals.states.has(n)?this._internals.states.delete(n):this._internals.states.add(n))}attributeChangedCallback(e,t,n){he(this,Fo)||(this.constructor.elementProperties.forEach((e,t)=>{let n=t;e.reflect&&this[n]!=null&&this.initialReflectedProperties.set(n,this[n])}),ge(this,Fo,!0)),Eo(this,e,n),super.attributeChangedCallback(e,t,n)}update(e){Oo(this,e),super.update(e)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{let r=n;e.has(r)&&this[r]==null&&(this[r]=t)})}};Mo=f(jo),No=new WeakMap,Po=new WeakMap,Fo=new WeakMap,h(Mo,4,`dir`,Ao,M,No),h(Mo,4,`lang`,ko,M,Po),p(Mo,M),g(M,`version`,`0.0.0`),g(M,`dependencies`,{});var Io,Lo,Ro,zo,Bo=class extends (Lo=M,Io=[O({reflect:!0})],Lo){constructor(){super(...arguments),_(this,zo,m(Ro,8,this,`grouped`)),m(Ro,11,this),g(this,`aoAbrirSecao`,e=>{let t=this.secoes(),n=t.find(t=>t===e.target);if(n?.name)for(let e of t)e!==n&&e.name===n.name&&e.open&&e.hide()}),g(this,`aoTrocarSecoes`,()=>{let e=new Set;for(let t of this.secoes())!t.name||!t.open||(e.has(t.name)?t.open=!1:e.add(t.name))})}connectedCallback(){super.connectedCallback(),this.addEventListener(`kk-show`,this.aoAbrirSecao)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`kk-show`,this.aoAbrirSecao)}secoes(){return[...this.querySelectorAll(`:scope > kk-details`)]}render(){return w`
      <div
        part="base"
    ...
    `}};Ro=f(Lo),zo=new WeakMap,h(Ro,4,`appearance`,Io,Bo,zo),p(Ro,Bo),g(Bo,`styles`,[D,_o]),Bo.define(`kk-accordion`);var Vo=e=>{let{activeElement:t}=document;t&&e.contains(t)&&document.activeElement?.blur()},Ho=C`
  :host {
...
`,Uo=Symbol.for(``),Wo=e=>{if(e?.r===Uo)return e?._$litStatic$},Go=(e,...t)=>({_$litStatic$:t.reduce((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(n)+e[r+1],e[0]),r:Uo}),Ko=new Map,qo=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=Wo(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=Ko.get(e))===void 0&&(o.raw=o,Ko.set(e,t=o)),n=s}return e(t,...n)})(w),Jo={fromAttribute:e=>e??``,toAttribute:e=>e===``?null:e},Yo=new WeakMap,Xo=new WeakMap,Zo=new WeakMap,Qo=new WeakSet,$o=new WeakMap,es=class{host;form;options;constructor(e,t){this.host=e,e.addController(this),this.options={form:e=>{let t=e.form;if(t){let n=e.getRootNode().querySelector(`#${t}`);if(n)return n}return e.closest(`form`)},name:e=>e.name,value:e=>e.value,defaultValue:e=>e.defaultValue,disabled:e=>e.disabled??!1,reportValidity:e=>typeof e.reportValidity!=`function`||e.reportValidity(),checkValidity:e=>typeof e.checkValidity!=`function`||e.checkValidity(),setValue:(e,t)=>e.value=t,assumeInteractionOn:[`kk-input`],...t}}hostConnected(){let e=this.options.form(this.host);e&&this.attachForm(e),$o.set(this.host,[]),this.options.assumeInteractionOn.forEach(e=>{this.host.addEventListener(e,this.handleInteraction)})}hostDisconnected(){this.detachForm(),$o.delete(this.host),this.options.assumeInteractionOn.forEach(e=>{this.host.removeEventListener(e,this.handleInteraction)})}hostUpdated(){let e=this.options.form(this.host);e||this.detachForm(),e&&this.form!==e&&(this.detachForm(),this.attachForm(e)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(e){e?(this.form=e,Yo.has(this.form)?Yo.get(this.form).add(this.host):Yo.set(this.form,new Set([this.host])),this.form.addEventListener(`formdata`,this.handleFormData),this.form.addEventListener(`submit`,this.handleFormSubmit),this.form.addEventListener(`reset`,this.handleFormReset),Xo.has(this.form)||(Xo.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity()),Zo.has(this.form)||(Zo.set(this.form,this.form.checkValidity),this.form.checkValidity=()=>this.checkFormValidity())):this.form=void 0}detachForm(){if(!this.form)return;let e=Yo.get(this.form);e&&(e.delete(this.host),e.size<=0&&(this.form.removeEventListener(`formdata`,this.handleFormData),this.form.removeEventListener(`submit`,this.handleFormSubmit),this.form.removeEventListener(`reset`,this.handleFormReset),Xo.has(this.form)&&(this.form.reportValidity=Xo.get(this.form),Xo.delete(this.form)),Zo.has(this.form)&&(this.form.checkValidity=Zo.get(this.form),Zo.delete(this.form)),this.form=void 0))}handleFormData=e=>{let t=this.options.disabled(this.host),n=this.options.name(this.host),r=this.options.value(this.host),i=this.host.tagName.toLowerCase()===`kk-button`;this.host.isConnected&&!t&&!i&&typeof n==`string`&&n.length>0&&typeof r<`u`&&(Array.isArray(r)?r.forEach(t=>{e.formData.append(n,t.toString())}):e.formData.append(n,r.toString()))};handleFormSubmit=e=>{let t=this.options.disabled(this.host),n=this.options.reportValidity;this.form&&!this.form.noValidate&&Yo.get(this.form)?.forEach(e=>{this.setUserInteracted(e,!0)}),this.form&&!this.form.noValidate&&!t&&!n(this.host)&&(e.preventDefault(),e.stopImmediatePropagation())};handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),$o.set(this.host,[])};handleInteraction=e=>{let t=$o.get(this.host);t.includes(e.type)||t.push(e.type),t.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)};checkFormValidity=()=>{if(this.form&&!this.form.noValidate){let e=this.form.querySelectorAll(`*`);for(let t of e)if(typeof t.checkValidity==`function`&&!t.checkValidity())return!1}return!0};reportFormValidity=()=>{if(this.form&&!this.form.noValidate){let e=this.form.querySelectorAll(`*`);for(let t of e)if(typeof t.reportValidity==`function`&&!t.reportValidity())return!1}return!0};setUserInteracted(e,t){t?Qo.add(e):Qo.delete(e),e.requestUpdate()}doAction(e,t){this.form&&ns(this.form,e,t)}getForm(){return this.form??null}reset(e){this.doAction(`reset`,e)}submit(e){this.doAction(`submit`,e)}setValidity(e){let t=this.host,n=!!Qo.has(t),r=!!t.required;t.toggleAttribute(`data-required`,r),t.toggleAttribute(`data-optional`,!r),t.toggleAttribute(`data-invalid`,!e),t.toggleAttribute(`data-valid`,e),t.toggleAttribute(`data-user-invalid`,!e&&n),t.toggleAttribute(`data-user-valid`,e&&n)}updateValidity(){let e=this.host;this.setValidity(e.validity.valid)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.host.dispatchEvent(t)||e?.preventDefault()}},ts=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1});Object.freeze({...ts,valid:!1,valueMissing:!0}),Object.freeze({...ts,valid:!1,customError:!0});function ns(e,t,n){let r=document.createElement(`button`);r.type=t,r.style.position=`absolute`,r.style.width=`0`,r.style.height=`0`,r.style.clipPath=`inset(50%)`,r.style.overflow=`hidden`,r.style.whiteSpace=`nowrap`,n&&(r.name=n.name,r.value=n.value,[`formaction`,`formenctype`,`formmethod`,`formnovalidate`,`formtarget`].forEach(e=>{n.hasAttribute(e)&&r.setAttribute(e,n.getAttribute(e))})),e.append(r),r.click(),r.remove()}var N=e=>e??T,{I:rs}=uo,is=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t,as=e=>e.strings===void 0,os={},ss=(e,t=os)=>e._$AH=t,cs=C`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`,ls={name:`default`,resolver:(e,t)=>ne(`assets/icons/${t}/${e}.svg`)},us={caret:`
  ...
  `},ds=[ls,{name:`system`,resolver:e=>e in us?`data:image/svg+xml,${encodeURIComponent(us[e])}`:``}],fs=[];function ps(e){fs.push(e)}function ms(e){fs=fs.filter(t=>t!==e)}function hs(e){return ds.find(t=>t.name===e)}var gs=Symbol(),_s=Symbol(),vs,ys=new Map,bs,xs,Ss,Cs,ws,Ts,Es,Ds,Os,P,ks,As,js,Ms,Ns,Ps,Fs=class extends (Os=M,Ds=[k()],Es=[O({reflect:!0})],Ts=[O()],ws=[O()],Cs=[O({reflect:!0})],Ss=[O({reflect:!0})],xs=[j(`label`)],bs=[j([`name`,`src`,`library`,`variant`])],Os){constructor(){super(...arguments),m(P,5,this),g(this,`initialRender`,!1),_(this,ks,m(P,8,this,null)),m(P,11,this),_(this,As,m(P,12,this)),m(P,15,this),_(this,js,m(P,16,this)),m(P,19,this),_(this,Ms,m(P,20,this,``)),m(P,23,this),_(this,Ns,m(P,24,this,`default`)),m(P,27,this),_(this,Ps,m(P,28,this,`outline`)),m(P,31,this)}async resolveIcon(e,t){let n;if(t?.spriteSheet)return this.svg=w`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(n=await fetch(e,{mode:`cors`}),!n.ok)return n.status===410?gs:_s}catch{return _s}try{let e=document.createElement(`div`);e.innerHTML=await n.text();let t=e.firstElementChild;if(t?.tagName?.toLowerCase()!==`svg`)return gs;vs||=new DOMParser;let r=vs.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return r?(r.part.add(`svg`),document.adoptNode(r)):gs}catch{return gs}}connectedCallback(){super.connectedCallback(),ps(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),ms(this)}getIconSource(){let e=hs(this.library);return this.name&&e?{url:e.resolver(this.name,this.variant),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){let{url:e,fromLibrary:t}=this.getIconSource(),n=t?hs(this.library):void 0;if(!e){this.svg=null;return}let r=ys.get(e);if(r||(r=this.resolveIcon(e,n),ys.set(e,r)),!this.initialRender)return;let i=await r;if(i===_s&&ys.delete(e),e===this.getIconSource().url){if(is(i)){if(this.svg=i,n){await this.updateComplete;let e=this.shadowRoot.querySelector(`[part='svg']`);typeof n.mutator==`function`&&e&&n.mutator(e)}return}switch(i){case _s:case gs:this.svg=null,this.emit(`kk-error`);break;default:this.svg=i.cloneNode(!0),n?.mutator?.(this.svg),this.emit(`kk-load`)}}}render(){return this.svg}};P=f(Os),ks=new WeakMap,As=new WeakMap,js=new WeakMap,Ms=new WeakMap,Ns=new WeakMap,Ps=new WeakMap,h(P,4,`svg`,Ds,Fs,ks),h(P,4,`name`,Es,Fs,As),h(P,4,`src`,Ts,Fs,js),h(P,4,`label`,ws,Fs,Ms),h(P,4,`library`,Cs,Fs,Ns),h(P,4,`variant`,Ss,Fs,Ps),h(P,1,`handleLabelChange`,xs,Fs),h(P,1,`setIcon`,bs,Fs),p(P,Fs),g(Fs,`styles`,[D,cs]);var Is,Ls,Rs,zs,Bs,Vs,Hs,Us,Ws,Gs,Ks,qs,Js,Ys,F,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,oc,sc,cc,I=class extends (Ys=M,Js=[A(`.icon-button`)],qs=[k()],Ks=[O()],Gs=[O()],Ws=[O()],Us=[O()],Hs=[O()],Vs=[O()],Bs=[O()],zs=[O()],Rs=[O({type:Boolean,reflect:!0})],Ls=[O()],Is=[O({reflect:!0})],Ys){constructor(){super(...arguments),_(this,Xs,m(F,8,this)),m(F,11,this),_(this,Zs,m(F,12,this,!1)),m(F,15,this),_(this,Qs,m(F,16,this)),m(F,19,this),_(this,$s,m(F,20,this)),m(F,23,this),_(this,ec,m(F,24,this,`outline`)),m(F,27,this),_(this,tc,m(F,28,this)),m(F,31,this),_(this,nc,m(F,32,this)),m(F,35,this),_(this,rc,m(F,36,this)),m(F,39,this),_(this,ic,m(F,40,this)),m(F,43,this),_(this,ac,m(F,44,this,``)),m(F,47,this),_(this,oc,m(F,48,this,!1)),m(F,51,this),_(this,sc,m(F,52,this,`button`)),m(F,55,this),_(this,cc,m(F,56,this)),m(F,59,this)}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}if(this.type!==`button`){let e=this.form?this.getRootNode().querySelector(`#${this.form}`):this.closest(`form`);e&&ns(e,this.type)}}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?Go`a`:Go`button`;return qo`
      <${t}
        part="base"
    ...
    `}};F=f(Ys),Xs=new WeakMap,Zs=new WeakMap,Qs=new WeakMap,$s=new WeakMap,ec=new WeakMap,tc=new WeakMap,nc=new WeakMap,rc=new WeakMap,ic=new WeakMap,ac=new WeakMap,oc=new WeakMap,sc=new WeakMap,cc=new WeakMap,h(F,4,`button`,Js,I,Xs),h(F,4,`hasFocus`,qs,I,Zs),h(F,4,`name`,Ks,I,Qs),h(F,4,`library`,Gs,I,$s),h(F,4,`variant`,Ws,I,ec),h(F,4,`src`,Us,I,tc),h(F,4,`href`,Hs,I,nc),h(F,4,`target`,Vs,I,rc),h(F,4,`download`,Bs,I,ic),h(F,4,`label`,zs,I,ac),h(F,4,`disabled`,Rs,I,oc),h(F,4,`type`,Ls,I,sc),h(F,4,`form`,Is,I,cc),p(F,I),g(I,`styles`,[D,Ho]),g(I,`dependencies`,{"kk-icon":Fs});function lc(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}var uc=class{host;slotNames=[];constructor(e,...t){this.host=e,e.addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!==``)return!0;if(e.nodeType===e.ELEMENT_NODE){let t=e;if(t.tagName.toLowerCase()===`kk-visually-hidden`)return!1;if(!t.hasAttribute(`slot`))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e===`[default]`?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener(`slotchange`,this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener(`slotchange`,this.handleSlotChange)}handleSlotChange=e=>{let t=e.target;(this.slotNames.includes(`[default]`)&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}};function dc(e){if(!e)return``;let t=e.assignedNodes({flatten:!0}),n=``;return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(n+=e.textContent)}),n}var fc=C`
  :host {
    display: contents;
...
`,pc,mc,hc,gc,_c,vc,yc,bc,xc,Sc,Cc,wc,L,Tc,Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc=class e extends (wc=M,Cc=[A(`[part~="base"]`)],Sc=[A(`.alert__countdown-elapsed`)],xc=[O({type:Boolean,reflect:!0})],bc=[O({type:Boolean,reflect:!0})],yc=[O({reflect:!0})],vc=[O({type:Number})],_c=[O({type:String,reflect:!0})],gc=[k()],hc=[k()],mc=[j(`open`,{waitUntilFirstUpdate:!0})],pc=[j(`duration`)],wc){constructor(){super(...arguments),m(L,5,this),g(this,`autoHideTimeout`),g(this,`remainingTimeInterval`),g(this,`countdownAnimation`),g(this,`hasSlotController`,new uc(this,`icon`,`suffix`)),g(this,`localize`,new aa(this)),_(this,Tc,m(L,8,this)),m(L,11,this),_(this,Ec,m(L,12,this)),m(L,15,this),_(this,Dc,m(L,16,this,!1)),m(L,19,this),_(this,Oc,m(L,20,this,!1)),m(L,23,this),_(this,kc,m(L,24,this,`primary`)),m(L,27,this),_(this,Ac,m(L,28,this,1/0)),m(L,31,this),_(this,jc,m(L,32,this)),m(L,35,this),_(this,Mc,m(L,36,this,this.duration)),m(L,39,this),_(this,Nc,m(L,40,this,!1)),m(L,43,this)}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`kk-toast-stack`}),this.currentToastStack}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:e}=this;this.countdownAnimation=e.animate([{width:`100%`},{width:`0`}],{duration:this.duration,easing:`linear`})}}handleCloseClick(){this.hide()}async handleOpenChange(){this.transicao=!0,this.open?(this.emit(`kk-show`),this.duration<1/0&&this.restartAutoHide(),await this.esperarTransicao(),this.emit(`kk-after-show`)):(Vo(this),this.emit(`kk-hide`),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await this.esperarTransicao(),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.base.getAnimations().map(e=>e.finished))}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,lc(this,`kk-after-show`)}async hide(){if(this.open)return this.open=!1,lc(this,`kk-after-hide`)}async toast(){return new Promise(t=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`kk-after-hide`,()=>{e.toastStack.removeChild(this),t(),e.toastStack.querySelector(`kk-alert`)===null&&e.toastStack.remove()},{once:!0})})}render(){return w`
    ...
    `}};L=f(wc),Tc=new WeakMap,Ec=new WeakMap,Dc=new WeakMap,Oc=new WeakMap,kc=new WeakMap,Ac=new WeakMap,jc=new WeakMap,Mc=new WeakMap,Nc=new WeakMap,h(L,4,`base`,Cc,Pc,Tc),h(L,4,`countdownElement`,Sc,Pc,Ec),h(L,4,`open`,xc,Pc,Dc),h(L,4,`closable`,bc,Pc,Oc),h(L,4,`variant`,yc,Pc,kc),h(L,4,`duration`,vc,Pc,Ac),h(L,4,`countdown`,_c,Pc,jc),h(L,4,`remainingTime`,gc,Pc,Mc),h(L,4,`transicao`,hc,Pc,Nc),h(L,1,`handleOpenChange`,mc,Pc),h(L,1,`handleDurationChange`,pc,Pc),p(L,Pc),g(Pc,`styles`,[D,fc]),g(Pc,`dependencies`,{"kk-icon-button":I}),g(Pc,`currentToastStack`),Pc.define(`kk-alert`);var Fc=C`
  :host {
    display: inline-flex;
  }
...
`,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc=class extends (zc=M,Rc=[O({reflect:!0})],Lc=[O({type:Boolean,reflect:!0})],Ic=[O({type:Boolean,reflect:!0})],zc){constructor(){super(...arguments),_(this,Vc,m(Bc,8,this,`primary`)),m(Bc,11,this),_(this,Hc,m(Bc,12,this,!1)),m(Bc,15,this),_(this,Uc,m(Bc,16,this,!1)),m(Bc,19,this)}render(){return w`
      <span
        part="base"
    ...
    `}};Bc=f(zc),Vc=new WeakMap,Hc=new WeakMap,Uc=new WeakMap,h(Bc,4,`variant`,Rc,Wc,Vc),h(Bc,4,`pill`,Lc,Wc,Hc),h(Bc,4,`pulse`,Ic,Wc,Uc),p(Bc,Wc),g(Wc,`styles`,[D,Fc]),Wc.define(`kk-badge`);var Gc=C`
  :host {
...
`,Kc=class extends M{static styles=[D,Gc];localize=new aa(this);render(){return w`
...
`,Jc,Yc,Xc,Zc,Qc,$c,el,tl,nl,rl,il,al,ol,sl,cl,ll,ul,dl,fl,pl,ml,hl,gl,_l,vl,yl,bl,xl,Sl,Cl,R,wl,Tl,El,Dl,Ol,kl,Al,jl,Ml,Nl,Pl,Fl,Il,Ll,Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl,z=class extends (Cl=M,Sl=[A(`.button`)],xl=[k()],bl=[k()],yl=[O()],vl=[O({reflect:!0})],_l=[O({reflect:!0})],gl=[O({type:Boolean,reflect:!0})],hl=[O({type:Boolean,reflect:!0})],ml=[O({type:Boolean,reflect:!0})],pl=[O({type:Boolean,reflect:!0})],fl=[O({type:Boolean,reflect:!0})],dl=[O({type:Boolean,reflect:!0})],ul=[O({type:Boolean,reflect:!0})],ll=[O({type:Boolean,reflect:!0})],cl=[O()],sl=[O()],ol=[O()],al=[O()],il=[O()],rl=[O()],nl=[O()],tl=[O()],el=[O({attribute:`formaction`})],$c=[O({attribute:`formenctype`})],Qc=[O({attribute:`formmethod`})],Zc=[O({attribute:`formnovalidate`,type:Boolean})],Xc=[O({attribute:`formtarget`})],Yc=[j(`disabled`,{waitUntilFirstUpdate:!0})],Jc=[j(`loading`,{waitUntilFirstUpdate:!0})],Cl){constructor(){super(...arguments),m(R,5,this),g(this,`formControlController`,new es(this,{assumeInteractionOn:[`click`]})),g(this,`hasSlotController`,new uc(this,`[default]`,`prefix`,`suffix`)),g(this,`localize`,new aa(this)),_(this,wl,m(R,8,this)),m(R,11,this),_(this,Tl,m(R,12,this,!1)),m(R,15,this),_(this,El,m(R,16,this,!1)),m(R,19,this),_(this,Dl,m(R,20,this,``)),m(R,23,this),_(this,Ol,m(R,24,this,`default`)),m(R,27,this),_(this,kl,m(R,28,this,`medium`)),m(R,31,this),_(this,Al,m(R,32,this,!1)),m(R,35,this),_(this,jl,m(R,36,this,!1)),m(R,39,this),_(this,Ml,m(R,40,this,!1)),m(R,43,this),_(this,Nl,m(R,44,this,!1)),m(R,47,this),_(this,Pl,m(R,48,this,!1)),m(R,51,this),_(this,Fl,m(R,52,this,!1)),m(R,55,this),_(this,Il,m(R,56,this,!1)),m(R,59,this),_(this,Ll,m(R,60,this,!1)),m(R,63,this),_(this,Rl,m(R,64,this,`button`)),m(R,67,this),_(this,zl,m(R,68,this,``)),m(R,71,this),_(this,Bl,m(R,72,this,``)),m(R,75,this),_(this,Vl,m(R,76,this,``)),m(R,79,this),_(this,Hl,m(R,80,this)),m(R,83,this),_(this,Ul,m(R,84,this,`noreferrer noopener`)),m(R,87,this),_(this,Wl,m(R,88,this)),m(R,91,this),_(this,Gl,m(R,92,this)),m(R,95,this),_(this,Kl,m(R,96,this)),m(R,99,this),_(this,ql,m(R,100,this)),m(R,103,this),_(this,Jl,m(R,104,this)),m(R,107,this),_(this,Yl,m(R,108,this)),m(R,111,this),_(this,Xl,m(R,112,this)),m(R,115,this)}get validity(){return this.isButton()?this.button.validity:ts}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.isButton()&&this.formControlController.updateValidity()}handleLoadingChange(){this.toggleState(`--loading`,this.loading)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?Go`a`:Go`button`;return qo`
      <${t}
        part="base"
        ...
        @click=${this.handleClick}
      >
        ${this.swipe?qo`<span part="decor" class="button__decor"></span>`:``}
        <slot name="prefix" part="prefix" class="button__prefix"></slot>
        ${this.expand?qo`<span class="button__reveal"><slot part="label" class="button__label"></slot></span>`:qo`<slot part="label" class="button__label"></slot>`}
        <slot name="suffix" part="suffix" class="button__suffix"></slot>
        ${this.caret?qo` <kk-icon part="caret" class="button__caret" library="system" name="caret"></kk-icon> `:``}
        ${this.loading?qo`<kk-spinner part="spinner"></kk-spinner>`:``}
      </${t}>
    `}};R=f(Cl),wl=new WeakMap,Tl=new WeakMap,El=new WeakMap,Dl=new WeakMap,Ol=new WeakMap,kl=new WeakMap,Al=new WeakMap,jl=new WeakMap,Ml=new WeakMap,Nl=new WeakMap,Pl=new WeakMap,Fl=new WeakMap,Il=new WeakMap,Ll=new WeakMap,Rl=new WeakMap,zl=new WeakMap,Bl=new WeakMap,Vl=new WeakMap,Hl=new WeakMap,Ul=new WeakMap,Wl=new WeakMap,Gl=new WeakMap,Kl=new WeakMap,ql=new WeakMap,Jl=new WeakMap,Yl=new WeakMap,Xl=new WeakMap,h(R,4,`button`,Sl,z,wl),h(R,4,`hasFocus`,xl,z,Tl),h(R,4,`invalid`,bl,z,El),h(R,4,`title`,yl,z,Dl),h(R,4,`variant`,vl,z,Ol),h(R,4,`size`,_l,z,kl),h(R,4,`caret`,gl,z,Al),h(R,4,`disabled`,hl,z,jl),h(R,4,`loading`,ml,z,Ml),h(R,4,`outline`,pl,z,Nl),h(R,4,`pill`,fl,z,Pl),h(R,4,`circle`,dl,z,Fl),h(R,4,`swipe`,ul,z,Il),h(R,4,`expand`,ll,z,Ll),h(R,4,`type`,cl,z,Rl),h(R,4,`name`,sl,z,zl),h(R,4,`value`,ol,z,Bl),h(R,4,`href`,al,z,Vl),h(R,4,`target`,il,z,Hl),h(R,4,`rel`,rl,z,Ul),h(R,4,`download`,nl,z,Wl),h(R,4,`form`,tl,z,Gl),h(R,4,`formAction`,el,z,Kl),h(R,4,`formEnctype`,$c,z,ql),h(R,4,`formMethod`,Qc,z,Jl),h(R,4,`formNoValidate`,Zc,z,Yl),h(R,4,`formTarget`,Xc,z,Xl),h(R,1,`handleDisabledChange`,Yc,z),h(R,1,`handleLoadingChange`,Jc,z),p(R,z),g(z,`styles`,[D,qc]),g(z,`dependencies`,{"kk-icon":Fs,"kk-spinner":Kc}),z.define(`kk-button`);var Zl=C`
  :host {
...
`,Ql,$l,eu,tu,nu,ru,iu=class extends (eu=M,$l=[O({reflect:!0})],Ql=[O({reflect:!0})],eu){constructor(){super(...arguments),g(this,`hasSlotController`,new uc(this,`footer`,`header`,`image`)),_(this,nu,m(tu,8,this,`vertical`)),m(tu,11,this),_(this,ru,m(tu,12,this,`default`)),m(tu,15,this)}render(){return w`
      <div
        part="base"
    ...
    `}};tu=f(eu),nu=new WeakMap,ru=new WeakMap,h(tu,4,`orientation`,$l,iu,nu),h(tu,4,`variant`,Ql,iu,ru),p(tu,iu),g(iu,`styles`,[D,Zl]),iu.define(`kk-card`);var au=C`
  :host {
    display: block;
  }
...
`,ou,su,cu,lu,uu,du,fu,pu,mu,hu,gu,B,_u,vu,yu,bu,xu,Su,Cu,wu,Tu,Eu=class extends (gu=M,hu=[A(`.details`)],mu=[A(`.details__header`)],pu=[A(`.details__body`)],fu=[A(`.details__expand-icon-slot`)],du=[k()],uu=[O({type:Boolean,reflect:!0})],lu=[O()],cu=[O({type:Boolean,reflect:!0})],su=[O({reflect:!0})],ou=[j(`open`,{waitUntilFirstUpdate:!0})],gu){constructor(){super(...arguments),m(B,5,this),g(this,`localize`,new aa(this)),_(this,_u,m(B,8,this)),m(B,11,this),_(this,vu,m(B,12,this)),m(B,15,this),_(this,yu,m(B,16,this)),m(B,19,this),_(this,bu,m(B,20,this)),m(B,23,this),g(this,`detailsObserver`),_(this,xu,m(B,24,this,!1)),m(B,27,this),_(this,Su,m(B,28,this,!1)),m(B,31,this),_(this,Cu,m(B,32,this)),m(B,35,this),_(this,wu,m(B,36,this,!1)),m(B,39,this),_(this,Tu,m(B,40,this)),m(B,43,this)}firstUpdated(){this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.transicao=!0,this.open){if(this.details.open=!0,this.emit(`kk-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await this.esperarTransicao(),this.emit(`kk-after-show`)}else{if(this.emit(`kk-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await this.esperarTransicao(),this.open||(this.details.open=!1),this.emit(`kk-after-hide`)}}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.body.getAnimations().map(e=>e.finished))}async show(){if(!(this.open||this.disabled))return this.open=!0,lc(this,`kk-after-show`)}async hide(){if(this.open&&!this.disabled)return this.open=!1,lc(this,`kk-after-hide`)}render(){let e=this.localize.dir()===`rtl`;return w`
      <details
        part="base"
    ...
    `}};B=f(gu),_u=new WeakMap,vu=new WeakMap,yu=new WeakMap,bu=new WeakMap,xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,wu=new WeakMap,Tu=new WeakMap,h(B,4,`details`,hu,Eu,_u),h(B,4,`header`,mu,Eu,vu),h(B,4,`body`,pu,Eu,yu),h(B,4,`expandIconSlot`,fu,Eu,bu),h(B,4,`transicao`,du,Eu,xu),h(B,4,`open`,uu,Eu,Su),h(B,4,`summary`,lu,Eu,Cu),h(B,4,`disabled`,cu,Eu,wu),h(B,4,`name`,su,Eu,Tu),h(B,1,`handleOpenChange`,ou,Eu),p(B,Eu),g(Eu,`styles`,[D,au]),g(Eu,`dependencies`,{"kk-icon":Fs}),Eu.define(`kk-details`);var Du=C`
  :host {
    display: contents;
  }
...
`,Ou,ku,Au,ju,Mu,Nu,Pu,Fu,Iu,Lu,Ru,zu=class extends (Nu=M,Mu=[A(`.dialog`)],ju=[O({type:Boolean,reflect:!0})],Au=[O({reflect:!0})],ku=[O({attribute:`no-header`,type:Boolean,reflect:!0})],Ou=[j(`open`,{waitUntilFirstUpdate:!0})],Nu){constructor(){super(...arguments),m(Pu,5,this),g(this,`hasSlotController`,new uc(this,`footer`)),g(this,`localize`,new aa(this)),_(this,Fu,m(Pu,8,this)),m(Pu,11,this),_(this,Iu,m(Pu,12,this,!1)),m(Pu,15,this),_(this,Lu,m(Pu,16,this,``)),m(Pu,19,this),_(this,Ru,m(Pu,20,this,!1)),m(Pu,23,this)}requestClose(e){this.emit(`kk-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented||this.hide()}firstUpdated(){this.open&&this.abrir()}abrir(){this.dialog.open||(this.dialog.showModal(),this.emit(`kk-initial-focus`,{cancelable:!0}))}fechar(){this.dialog.open&&this.dialog.close()}handleOpenChange(){this.open?(this.emit(`kk-show`),this.abrir(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.fechar(),this.emit(`kk-after-hide`))}async show(){this.open||=!0}async hide(){this.open&&=!1}handleCancel(e){e.preventDefault(),this.requestClose(`keyboard`)}handleClose(){this.open=!1}render(){return w`
      <dialog
        part="base"
        class="dialog"
    ...
    `}};Pu=f(Nu),Fu=new WeakMap,Iu=new WeakMap,Lu=new WeakMap,Ru=new WeakMap,h(Pu,4,`dialog`,Mu,zu,Fu),h(Pu,4,`open`,ju,zu,Iu),h(Pu,4,`label`,Au,zu,Lu),h(Pu,4,`noHeader`,ku,zu,Ru),h(Pu,1,`handleOpenChange`,Ou,zu),p(Pu,zu),g(zu,`styles`,[D,Du]),g(zu,`dependencies`,{"kk-icon-button":I}),zu.define(`kk-dialog`);var Bu=C`
  :host {
...
`,Vu={top:`bottom`,bottom:`top`,left:`right`,right:`left`};function Hu(e){return e.split(`-`)[0]}function Uu(e){return e.split(`-`)[1]}function Wu(e){return e===`top`||e===`bottom`}function Gu(e){let t=Uu(e),n=Vu[Hu(e)];return t===void 0?n:`${n}-${t}`}function Ku(e,t){let n={esquerda:0,topo:0,direita:window.innerWidth,base:window.innerHeight},r=e===void 0?[]:Array.isArray(e)?e:[e];for(let e of r){let t=e.getBoundingClientRect();n.esquerda=Math.max(n.esquerda,t.left),n.topo=Math.max(n.topo,t.top),n.direita=Math.min(n.direita,t.right),n.base=Math.min(n.base,t.bottom)}return{esquerda:n.esquerda+t,topo:n.topo+t,direita:n.direita-t,base:n.base-t}}function qu(e,t,n,r,i,a){let o=Hu(r),s=Uu(r),c=0,l=0;return Wu(o)?(l=o===`top`?e.top-n-i:e.bottom+i,c=s===`start`?e.left:s===`end`?e.right-t:e.left+(e.width-t)/2,c+=a):(c=o===`left`?e.left-t-i:e.right+i,l=s===`start`?e.top:s===`end`?e.bottom-n:e.top+(e.height-n)/2,l+=a),{x:c,y:l}}function Ju(e,t,n,r,i){return Math.max(0,i.esquerda-e)+Math.max(0,i.topo-t)+Math.max(0,e+n-i.direita)+Math.max(0,t+r-i.base)}function Yu(e,t,n,r,i,a){switch(i){case`top`:return Math.max(0,a.topo-t);case`bottom`:return Math.max(0,t+r-a.base);case`left`:return Math.max(0,a.esquerda-e);case`right`:return Math.max(0,e+n-a.direita)}}function Xu(e,t,n,r){let i=r.direita-r.esquerda,a=r.base-r.topo;switch(t){case`top`:return{largura:i,altura:e.top-r.topo-n};case`bottom`:return{largura:i,altura:r.base-e.bottom-n};case`left`:return{largura:e.left-r.esquerda-n,altura:a};case`right`:return{largura:r.direita-e.right-n,altura:a}}}function Zu(e){let t=e.contextElement??(e instanceof Element?e:void 0);if(t===void 0)return!1;let n=t.getBoundingClientRect();if(n.width===0&&n.height===0)return!0;for(let e=t.parentElement;e!==null;e=e.parentElement){let t=getComputedStyle(e);if(!/auto|scroll|hidden|clip/.test(t.overflow+t.overflowX+t.overflowY))continue;let r=e.getBoundingClientRect();if(n.bottom<=r.top||n.top>=r.bottom||n.right<=r.left||n.left>=r.right)return!0}return!1}function Qu(e,t,n){let r=n.distancia??0,i=n.desvio??0,a=e.getBoundingClientRect();if(n.espelhar!==void 0){let e=n.espelhar===`width`||n.espelhar===`both`,r=n.espelhar===`height`||n.espelhar===`both`;t.style.width=e?`${a.width}px`:``,t.style.height=r?`${a.height}px`:``}else t.style.width=``,t.style.height=``;let o=t.offsetWidth,s=t.offsetHeight,c=n.posicionamento,l=Ku(n.virarLimite,n.virarPreenchimento??0);if(n.virar===!0){let e=[n.posicionamento,...n.virarAlternativas??[Gu(n.posicionamento)]],t=n.posicionamento,u=1/0,d=!1;for(let n of e){let{x:e,y:c}=qu(a,o,s,n,r,i);if(Yu(e,c,o,s,Hu(n),l)===0){t=n,d=!0;break}let ee=Ju(e,c,o,s,l);ee<u&&(u=ee,t=n)}c=d||(n.virarEstrategia??`melhor-encaixe`)===`melhor-encaixe`?t:n.posicionamento}let u=Hu(c),{x:d,y:ee}=qu(a,o,s,c,r,i);if(n.deslizar===!0){let e=Ku(n.deslizarLimite,n.deslizarPreenchimento??0);Wu(u)?d=Math.min(Math.max(d,e.esquerda),Math.max(e.esquerda,e.direita-o)):ee=Math.min(Math.max(ee,e.topo),Math.max(e.topo,e.base-s))}let te=n.medirEspaco===!0?Xu(a,u,r,Ku(n.medirLimite,n.medirPreenchimento??0)):{largura:1/0,altura:1/0},ne={};if(n.seta!==void 0){let e=n.setaPreenchimento??0,t=Wu(u)?n.seta.offsetWidth:n.seta.offsetHeight;if(Wu(u)){let n=a.left+a.width/2-d-t/2;ne.x=Math.min(Math.max(n,e),o-t-e)}else{let n=a.top+a.height/2-ee-t/2;ne.y=Math.min(Math.max(n,e),s-t-e)}}return{x:Math.round(d),y:Math.round(ee),posicionamento:c,espacoLivre:te,ancoraOculta:Zu(e),seta:ne}}function $u(e,t,n){let r=e.contextElement??(e instanceof Element?e:void 0),i=[window];for(let e=r?.parentElement??null;e!==null;e=e.parentElement){let t=getComputedStyle(e);/auto|scroll|overlay/.test(t.overflow+t.overflowX+t.overflowY)&&i.push(e)}for(let e of i)e.addEventListener(`scroll`,n,{passive:!0,capture:!0});window.addEventListener(`resize`,n,{passive:!0});let a=new ResizeObserver(n);return r!==void 0&&a.observe(r),a.observe(t),n(),()=>{for(let e of i)e.removeEventListener(`scroll`,n,{capture:!0});window.removeEventListener(`resize`,n),a.disconnect()}}function ed(e){return(Array.isArray(e)?e:String(e).split(` `)).map(e=>e.trim()).filter(e=>e!==``)}function td(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e.contextElement instanceof Element:!0)}var nd,rd,id,ad,od,sd,cd,ld,ud,dd,fd,pd,md,hd,gd,_d,vd,yd,bd,xd,Sd,Cd,wd,Td,Ed,V,Dd,Od,kd,Ad,jd,Md,Nd,Pd,Fd,Id,Ld,Rd,zd,Bd,Vd,Hd,Ud,Wd,Gd,Kd,qd,Jd,Yd,Xd,H=class extends (Ed=M,Td=[A(`.popup`)],wd=[A(`.popup__arrow`)],Cd=[A(`.popup-hover-bridge`)],Sd=[O()],xd=[O({type:Boolean,reflect:!0})],bd=[O({reflect:!0})],yd=[O({type:Number})],vd=[O({type:Number})],_d=[O({type:Boolean})],gd=[O({attribute:`arrow-placement`})],hd=[O({attribute:`arrow-padding`,type:Number})],md=[O({type:Boolean})],pd=[O({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],fd=[O({attribute:`flip-fallback-strategy`})],dd=[O({type:Object})],ud=[O({attribute:`flip-padding`,type:Number})],ld=[O({type:Boolean})],cd=[O({type:Object})],sd=[O({attribute:`shift-padding`,type:Number})],od=[O({attribute:`auto-size`})],ad=[O()],id=[O({type:Object})],rd=[O({attribute:`auto-size-padding`,type:Number})],nd=[O({attribute:`hover-bridge`,type:Boolean})],Ed){constructor(){super(...arguments),g(this,`anchorEl`),g(this,`cleanup`),g(this,`localize`,new aa(this)),_(this,Dd,m(V,8,this)),m(V,11,this),_(this,Od,m(V,12,this)),m(V,15,this),_(this,kd,m(V,16,this)),m(V,19,this),_(this,Ad,m(V,20,this)),m(V,23,this),_(this,jd,m(V,24,this,!1)),m(V,27,this),_(this,Md,m(V,28,this,`top`)),m(V,31,this),_(this,Nd,m(V,32,this,0)),m(V,35,this),_(this,Pd,m(V,36,this,0)),m(V,39,this),_(this,Fd,m(V,40,this,!1)),m(V,43,this),_(this,Id,m(V,44,this,`anchor`)),m(V,47,this),_(this,Ld,m(V,48,this,10)),m(V,51,this),_(this,Rd,m(V,52,this,!1)),m(V,55,this),_(this,zd,m(V,56,this,``)),m(V,59,this),_(this,Bd,m(V,60,this,`best-fit`)),m(V,63,this),_(this,Vd,m(V,64,this)),m(V,67,this),_(this,Hd,m(V,68,this,0)),m(V,71,this),_(this,Ud,m(V,72,this,!1)),m(V,75,this),_(this,Wd,m(V,76,this)),m(V,79,this),_(this,Gd,m(V,80,this,0)),m(V,83,this),_(this,Kd,m(V,84,this)),m(V,87,this),_(this,qd,m(V,88,this)),m(V,91,this),_(this,Jd,m(V,92,this)),m(V,95,this),_(this,Yd,m(V,96,this,0)),m(V,99,this),_(this,Xd,m(V,100,this,!1)),m(V,103,this),g(this,`updateHoverBridge`,()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--kk-popup-hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-y`,`${u}px`)}})}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),(e.has(`active`)||e.has(`hoverBridge`))&&this.syncTopLayer(),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}syncTopLayer(){if(!this.isConnected||!this.popup||!this.hoverBridgeEl)return;let e=this.active&&this.hoverBridge;e&&!this.hoverBridgeEl.matches(`:popover-open`)&&this.popup.matches(`:popover-open`)&&this.popup.hidePopover(),e!==this.hoverBridgeEl.matches(`:popover-open`)&&(e?this.hoverBridgeEl.showPopover():this.hoverBridgeEl.hidePopover()),this.active!==this.popup.matches(`:popover-open`)&&(this.active?this.popup.showPopover():this.popup.hidePopover())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor==`string`){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchorEl=this.anchor instanceof Element||td(this.anchor)?this.anchor:this.querySelector(`[slot="anchor"]`);this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=$u(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.removeAttribute(`data-anchor-hidden`),this.style.removeProperty(`--kk-popup-auto-size-available-width`),this.style.removeProperty(`--kk-popup-auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let{x:e,y:t,posicionamento:n,espacoLivre:r,ancoraOculta:i,seta:a}=Qu(this.anchorEl,this.popup,{posicionamento:this.placement,distancia:this.distance,desvio:this.skidding,virar:this.flip,...this.flipFallbackPlacements.length>0?{virarAlternativas:ed(this.flipFallbackPlacements)}:{},virarEstrategia:this.flipFallbackStrategy===`best-fit`?`melhor-encaixe`:`inicial`,virarLimite:this.flipBoundary,virarPreenchimento:this.flipPadding,deslizar:this.shift,deslizarLimite:this.shiftBoundary,deslizarPreenchimento:this.shiftPadding,medirEspaco:!!this.autoSize,medirLimite:this.autoSizeBoundary,medirPreenchimento:this.autoSizePadding,...this.sync?{espelhar:this.sync}:{},...this.arrow?{seta:this.arrowEl,setaPreenchimento:this.arrowPadding}:{}});if(this.setAttribute(`data-current-placement`,n),this.toggleAttribute(`data-anchor-hidden`,i),this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-height`,`${r.altura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-width`,`${r.largura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-width`),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=this.localize.dir()===`rtl`,t={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[n.split(`-`)[0]],r=``,i=``,o=``,s=``;if(this.arrowPlacement===`start`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;r=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``,i=e?t:``,s=e?``:t}else if(this.arrowPlacement===`end`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;i=e?``:t,s=e?t:``,o=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(s=typeof a.x==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``,r=typeof a.y==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``):(s=typeof a.x==`number`?`${a.x}px`:``,r=typeof a.y==`number`?`${a.y}px`:``);Object.assign(this.arrowEl.style,{top:r,right:i,bottom:o,left:s,[t]:`calc(var(--kk-popup-arrow-size-diagonal) * -1)`})}requestAnimationFrame(()=>this.updateHoverBridge()),this.emit(`kk-reposition`)}render(){return w`
    ...
    `}};V=f(Ed),Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=new WeakMap,Hd=new WeakMap,Ud=new WeakMap,Wd=new WeakMap,Gd=new WeakMap,Kd=new WeakMap,qd=new WeakMap,Jd=new WeakMap,Yd=new WeakMap,Xd=new WeakMap,h(V,4,`popup`,Td,H,Dd),h(V,4,`arrowEl`,wd,H,Od),h(V,4,`hoverBridgeEl`,Cd,H,kd),h(V,4,`anchor`,Sd,H,Ad),h(V,4,`active`,xd,H,jd),h(V,4,`placement`,bd,H,Md),h(V,4,`distance`,yd,H,Nd),h(V,4,`skidding`,vd,H,Pd),h(V,4,`arrow`,_d,H,Fd),h(V,4,`arrowPlacement`,gd,H,Id),h(V,4,`arrowPadding`,hd,H,Ld),h(V,4,`flip`,md,H,Rd),h(V,4,`flipFallbackPlacements`,pd,H,zd),h(V,4,`flipFallbackStrategy`,fd,H,Bd),h(V,4,`flipBoundary`,dd,H,Vd),h(V,4,`flipPadding`,ud,H,Hd),h(V,4,`shift`,ld,H,Ud),h(V,4,`shiftBoundary`,cd,H,Wd),h(V,4,`shiftPadding`,sd,H,Gd),h(V,4,`autoSize`,od,H,Kd),h(V,4,`sync`,ad,H,qd),h(V,4,`autoSizeBoundary`,id,H,Jd),h(V,4,`autoSizePadding`,rd,H,Yd),h(V,4,`hoverBridge`,nd,H,Xd),p(V,H),g(H,`styles`,[D,Bu]);function*Zd(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Zd(e.shadowRoot.activeElement)))}function Qd(){return[...Zd()].pop()}var $d=new WeakMap;function ef(e){let t=$d.get(e);return t||(t=window.getComputedStyle(e,null),$d.set(e,t)),t}function tf(e){if(typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=ef(e);return t.visibility!==`hidden`&&t.display!==`none`}function nf(e){let{overflowY:t,overflowX:n}=ef(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function rf(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));if(e.hasAttribute(`tabindex`)&&(Number.isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`))return!1;if(t===`input`&&e.getAttribute(`type`)===`radio`){let t=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute(`name`)}"]`,r=t.querySelector(`${n}:checked`);return r?r===e:t.querySelector(n)===e}return tf(e)?(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:nf(e):!1}function af(e){let t=sf(e);return{start:t[0]??null,end:t.at(-1)??null}}function of(e,t){return e.getRootNode({composed:!0})?.host!==t}function sf(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),i instanceof HTMLElement&&!n.includes(i)&&rf(i)&&n.push(i),i instanceof HTMLSlotElement&&of(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of i.children)r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var cf=C`
  :host {
    display: inline-block;
  }
...
`,lf,uf,df,ff,pf,mf,hf,gf,_f,vf,yf,bf,xf,U,Sf,Cf,wf,Tf,Ef,Df,Of,kf,Af,jf,Mf,Nf=class extends (xf=M,bf=[A(`.dropdown`)],yf=[A(`.dropdown__trigger`)],vf=[A(`.dropdown__panel`)],_f=[O({type:Boolean,reflect:!0})],gf=[O({reflect:!0})],hf=[O({type:Boolean,reflect:!0})],mf=[O({attribute:`stay-open-on-select`,type:Boolean,reflect:!0})],pf=[O({attribute:!1})],ff=[O({type:Number})],df=[O({type:Number})],uf=[O({reflect:!0})],lf=[j(`open`,{waitUntilFirstUpdate:!0})],xf){constructor(){super(...arguments),m(U,5,this),_(this,Sf,m(U,8,this)),m(U,11,this),_(this,Cf,m(U,12,this)),m(U,15,this),_(this,wf,m(U,16,this)),m(U,19,this),g(this,`closeWatcher`),_(this,Tf,m(U,20,this,!1)),m(U,23,this),_(this,Ef,m(U,24,this,`bottom-start`)),m(U,27,this),_(this,Df,m(U,28,this,!1)),m(U,31,this),_(this,Of,m(U,32,this,!1)),m(U,35,this),_(this,kf,m(U,36,this)),m(U,39,this),_(this,Af,m(U,40,this,0)),m(U,43,this),_(this,jf,m(U,44,this,0)),m(U,47,this),_(this,Mf,m(U,48,this)),m(U,51,this),g(this,`handleKeyDown`,e=>{this.open&&e.key===`Escape`&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())}),g(this,`handleDocumentKeyDown`,e=>{if(e.key===`Escape`&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key===`Tab`){if(this.open&&document.activeElement?.tagName.toLowerCase()===`kk-menu-item`){e.preventDefault(),this.hide(),this.focusOnTrigger();return}let t=(e,n)=>{if(!e)return null;let r=e.closest(n);if(r)return r;let i=e.getRootNode();return i instanceof ShadowRoot?t(i.host,n):null};setTimeout(()=>{let e=this.containingElement?.getRootNode()instanceof ShadowRoot?Qd():document.activeElement;(!this.containingElement||t(e,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}}),g(this,`handleDocumentMouseDown`,e=>{let t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()}),g(this,`handlePanelSelect`,e=>{let t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()===`kk-menu`&&(this.hide(),this.focusOnTrigger())})}connectedCallback(){super.connectedCallback(),this.containingElement||=this}firstUpdated(){this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){let e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus==`function`&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()===`kk-menu`)}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([` `,`Enter`].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}let t=this.getMenu();if(t){let n=t.getAllItems();if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){e.preventDefault(),this.open||(this.show(),await this.updateComplete);let r=e.key===`ArrowDown`||e.key===`Home`?n.at(0):n.at(-1);r&&this.updateComplete.then(()=>{t.setCurrentItem(r),r.focus()})}}}handleTriggerKeyUp(e){e.key===` `&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){let e=this.trigger.assignedElements({flatten:!0}).find(e=>af(e).start),t;if(e){switch(e.tagName.toLowerCase()){case`kk-button`:case`kk-icon-button`:t=e.button;break;default:t=e}t.setAttribute(`aria-haspopup`,`true`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`)}}async show(){if(!this.open)return this.open=!0,lc(this,`kk-after-show`)}painelTemFoco(){let e=this.panel?.assignedElements({flatten:!0})??[];for(let t of Zd())if(e.some(e=>e===t||e.contains(t)))return!0;return!1}async hide(){if(this.open)return this.painelTemFoco()&&this.focusOnTrigger(),this.open=!1,lc(this,`kk-after-hide`)}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener(`kk-select`,this.handlePanelSelect),`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`mousedown`,this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener(`kk-select`,this.handlePanelSelect),this.panel.removeEventListener(`keydown`,this.handleKeyDown)),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`mousedown`,this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}this.updateAccessibleTrigger(),this.open?(this.emit(`kk-show`),this.addOpenListeners(),this.popup.active=!0,await this.esperarTransicao(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.removeOpenListeners(),await this.esperarTransicao(),this.open||(this.popup.active=!1),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.popup.popup.getAnimations().map(e=>e.finished))}render(){return w`
      <kk-popup
        part="base"
    ...
    `}};U=f(xf),Sf=new WeakMap,Cf=new WeakMap,wf=new WeakMap,Tf=new WeakMap,Ef=new WeakMap,Df=new WeakMap,Of=new WeakMap,kf=new WeakMap,Af=new WeakMap,jf=new WeakMap,Mf=new WeakMap,h(U,4,`popup`,bf,Nf,Sf),h(U,4,`trigger`,yf,Nf,Cf),h(U,4,`panel`,vf,Nf,wf),h(U,4,`open`,_f,Nf,Tf),h(U,4,`placement`,gf,Nf,Ef),h(U,4,`disabled`,hf,Nf,Df),h(U,4,`stayOpenOnSelect`,mf,Nf,Of),h(U,4,`containingElement`,pf,Nf,kf),h(U,4,`distance`,ff,Nf,Af),h(U,4,`skidding`,df,Nf,jf),h(U,4,`sync`,uf,Nf,Mf),h(U,1,`handleOpenChange`,lf,Nf),p(U,Nf),g(Nf,`styles`,[D,cf]),g(Nf,`dependencies`,{"kk-popup":H}),Nf.define(`kk-dropdown`);var Pf=C`
  :host {
    display: block;
    position: relative;
...
`,Ff,If,Lf,Rf,zf=class extends (If=M,Ff=[A(`slot`)],If){constructor(){super(...arguments),_(this,Rf,m(Lf,8,this)),m(Lf,11,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`menu`)}handleClick(e){let t=[`menuitem`,`menuitemcheckbox`],n=e.composedPath(),r=n.find(e=>e instanceof Element&&t.includes(e.getAttribute(`role`)??``));if(!r||n.find(e=>e instanceof Element&&e.getAttribute(`role`)===`menu`)!==this)return;let i=r;i.type===`checkbox`&&(i.checked=!i.checked),this.emit(`kk-select`,{detail:{item:i}})}handleKeyDown(e){if(e.key===`Enter`||e.key===` `){let t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){let t=this.getAllItems(),n=this.getCurrentItem(),r=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key===`ArrowDown`?r++:e.key===`ArrowUp`?r--:e.key===`Home`?r=0:e.key===`End`&&(r=t.length-1),r<0&&(r=t.length-1),r>t.length-1&&(r=0),this.setCurrentItem(t[r]),t[r].focus())}}handleMouseDown(e){let t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){let e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()===`kk-menu-item`||[`menuitem`,`menuitemcheckbox`,`menuitemradio`].includes(e.getAttribute(`role`)??``)}getAllItems(){return this.defaultSlot.assignedElements({flatten:!0}).filter(e=>!(!(e instanceof HTMLElement)||e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute(`tabindex`)===`0`)}setCurrentItem(e){this.getAllItems().forEach(t=>{t.setAttribute(`tabindex`,t===e?`0`:`-1`)})}render(){return w`
      ...
      ></slot>
    `}};Lf=f(If),Rf=new WeakMap,h(Lf,4,`defaultSlot`,Ff,zf,Rf),p(Lf,zf),g(zf,`styles`,[D,Pf]);var Bf=C`
  :host {
...
`,Vf=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Vf(e,t);return!0},Hf=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Uf=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Kf(t)}};function Wf(e){this._$AN===void 0?this._$AM=e:(Hf(this),this._$AM=e,Uf(this))}function Gf(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0){if(t){if(Array.isArray(r))for(let e=n;e<r.length;e++)Vf(r[e],!1),Hf(r[e]);else r!=null&&(Vf(r,!1),Hf(r))}else Vf(this,e)}}var Kf=e=>{e.type==vo.CHILD&&(e._$AP??=Gf,e._$AQ??=Wf)},qf=class extends bo{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Uf(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Vf(this,e),Hf(this))}setValue(e){if(as(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Jf=()=>new Yf,Yf=class{},Xf=new WeakMap,Zf=yo(class extends qf{render(e){return T}update(e,[t]){let n=t!==this.G;return n&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),T}rt(e){if(this.G!==void 0){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Xf.get(t);n===void 0&&(n=new WeakMap,Xf.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}}get lt(){return typeof this.G==`function`?Xf.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Qf=class{host;popupRef=Jf();enableSubmenuTimer=-1;isConnected=!1;isPopupConnected=!1;skidding=0;hasSlotController;submenuOpenDelay=100;constructor(e,t){this.host=e,e.addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test(`submenu`)&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test(`submenu`)&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||=(this.host.addEventListener(`mousemove`,this.handleMouseMove),this.host.addEventListener(`mouseover`,this.handleMouseOver),this.host.addEventListener(`keydown`,this.handleKeyDown),this.host.addEventListener(`click`,this.handleClick),this.host.addEventListener(`focusout`,this.handleFocusOut),!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.addEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&=(this.host.removeEventListener(`mousemove`,this.handleMouseMove),this.host.removeEventListener(`mouseover`,this.handleMouseOver),this.host.removeEventListener(`keydown`,this.handleKeyDown),this.host.removeEventListener(`click`,this.handleClick),this.host.removeEventListener(`focusout`,this.handleFocusOut),!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.removeEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!1)}handleMouseMove=e=>{this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-x`,`${e.clientX}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-y`,`${e.clientY}px`)};handleMouseOver=()=>{this.hasSlotController.test(`submenu`)&&this.enableSubmenu()};handleSubmenuEntry(e){let t=this.host.renderRoot.querySelector(`slot[name='submenu']`);if(!t){console.error(`Cannot activate a submenu if no corresponding menuitem can be found.`,this);return}let n=null;for(let e of t.assignedElements())if(n=e.querySelectorAll(`kk-menu-item, [role^='menuitem']`),n.length!==0)break;if(n&&n.length!==0){n[0].setAttribute(`tabindex`,`0`);for(let e=1;e!==n.length;++e)n[e].setAttribute(`tabindex`,`-1`);this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?n[0]instanceof HTMLElement&&n[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{n[0]instanceof HTMLElement&&n[0].focus()}),this.host.requestUpdate()))}}handleKeyDown=e=>{switch(e.key){case`Escape`:case`Tab`:this.disableSubmenu();break;case`ArrowLeft`:e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case`ArrowRight`:case`Enter`:case` `:this.handleSubmenuEntry(e)}};handleClick=e=>{e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName===`kk-menu-item`||e.target.role?.startsWith(`menuitem`))&&this.disableSubmenu()};handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu()};handlePopupMouseover=e=>{e.stopPropagation()};handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector(`slot[name='submenu']`)?.assignedElements({flatten:!0}).filter(e=>e.localName===`kk-menu`)[0],t=getComputedStyle(this.host).direction===`rtl`;if(!e)return;let{left:n,top:r,width:i,height:a}=e.getBoundingClientRect();this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-y`,`${r}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-y`,`${r+a}px`)};setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;let e=this.host.parentElement.computedStyleMap(),t=[`padding-top`,`border-top-width`,`margin-top`].reduce((t,n)=>{let r=e.get(n)??new CSSUnitValue(0,`px`);return t-(r instanceof CSSUnitValue?r:new CSSUnitValue(0,`px`)).to(`px`).value},0);this.skidding=t}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){let e=getComputedStyle(this.host).direction===`rtl`;return this.isConnected?w`
    ...
    `:w` <slot name="submenu" hidden></slot> `}},$f,ep,tp,np,rp,ip,ap,op,sp,cp,lp,W,up,dp,fp,pp,mp,hp,gp,_p=class extends (lp=M,cp=[A(`slot:not([name])`)],sp=[A(`.menu-item`)],op=[O()],ap=[O({type:Boolean,reflect:!0})],ip=[O()],rp=[O({type:Boolean,reflect:!0})],np=[O({type:Boolean,reflect:!0})],tp=[j(`checked`)],ep=[j(`disabled`)],$f=[j(`type`)],lp){constructor(){super(...arguments),m(W,5,this),g(this,`cachedTextLabel`),g(this,`localize`,new aa(this)),_(this,up,m(W,8,this)),m(W,11,this),_(this,dp,m(W,12,this)),m(W,15,this),_(this,fp,m(W,16,this,`normal`)),m(W,19,this),_(this,pp,m(W,20,this,!1)),m(W,23,this),_(this,mp,m(W,24,this,``)),m(W,27,this),_(this,hp,m(W,28,this,!1)),m(W,31,this),_(this,gp,m(W,32,this,!1)),m(W,35,this),g(this,`hasSlotController`,new uc(this,`submenu`)),g(this,`submenuController`,new Qf(this,this.hasSlotController)),g(this,`handleHostClick`,e=>{this.disabled&&(e.preventDefault(),e.stopImmediatePropagation())}),g(this,`handleMouseOver`,e=>{this.focus(),e.stopPropagation()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.handleHostClick),this.addEventListener(`mouseover`,this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.handleHostClick),this.removeEventListener(`mouseover`,this.handleMouseOver)}handleDefaultSlotChange(){let e=this.getTextLabel();if(typeof this.cachedTextLabel>`u`){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit(`slotchange`,{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!==`checkbox`){this.checked=!1,console.error(`The checked attribute can only be used on menu items with type="checkbox"`,this);return}this.type===`checkbox`?this.setAttribute(`aria-checked`,this.checked?`true`:`false`):this.removeAttribute(`aria-checked`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleTypeChange(){this.type===`checkbox`?(this.setAttribute(`role`,`menuitemcheckbox`),this.setAttribute(`aria-checked`,this.checked?`true`:`false`)):(this.setAttribute(`role`,`menuitem`),this.removeAttribute(`aria-checked`))}getTextLabel(){return dc(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test(`submenu`)}render(){let e=this.localize.dir()===`rtl`,t=this.submenuController.isExpanded();return w`
      <div
        id="anchor"
        part="base"
    ...
    `}};W=f(lp),up=new WeakMap,dp=new WeakMap,fp=new WeakMap,pp=new WeakMap,mp=new WeakMap,hp=new WeakMap,gp=new WeakMap,h(W,4,`defaultSlot`,cp,_p,up),h(W,4,`menuItem`,sp,_p,dp),h(W,4,`type`,op,_p,fp),h(W,4,`checked`,ap,_p,pp),h(W,4,`value`,ip,_p,mp),h(W,4,`loading`,rp,_p,hp),h(W,4,`disabled`,np,_p,gp),h(W,1,`handleCheckedChange`,tp,_p),h(W,1,`handleDisabledChange`,ep,_p),h(W,1,`handleTypeChange`,$f,_p),p(W,_p),g(_p,`styles`,[D,Bf]),g(_p,`dependencies`,{"kk-icon":Fs,"kk-popup":H,"kk-spinner":Kc});var vp=C`
  /*
...
`,wp,Tp,Ep,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp,zp,Bp,Vp,Hp,Up,Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,G,cm,lm,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm,Tm,Em,Dm,Om,km,Am,jm,Mm,Nm,Pm,Fm,Im,Lm,Rm,zm,Bm,K=class extends (sm=M,om=[A(`.input__control`)],am=[k()],im=[O()],rm=[O({reflect:!0})],nm=[O()],tm=[O()],em=[To()],$p=[O({reflect:!0})],Qp=[O({type:Boolean,reflect:!0})],Zp=[O({type:Boolean,reflect:!0})],Xp=[O()],Yp=[O({attribute:`help-text`})],Jp=[O({type:Boolean})],qp=[O({type:Boolean,reflect:!0})],Kp=[O()],Gp=[O({type:Boolean,reflect:!0})],Wp=[O({attribute:`password-toggle`,type:Boolean})],Up=[O({attribute:`password-visible`,type:Boolean})],Hp=[O({attribute:`no-spin-buttons`,type:Boolean})],Vp=[O({reflect:!0,converter:Jo})],Bp=[O({type:Boolean,reflect:!0})],zp=[O()],Rp=[O({type:Number})],Lp=[O({type:Number})],Ip=[O()],Fp=[O()],Pp=[O()],Np=[O()],Mp=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],jp=[O()],Ap=[O({type:Boolean})],kp=[O()],Op=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],Dp=[O()],Ep=[j(`disabled`,{waitUntilFirstUpdate:!0})],Tp=[j(`step`,{waitUntilFirstUpdate:!0})],wp=[j(`value`,{waitUntilFirstUpdate:!0})],sm){constructor(){super(...arguments),m(G,5,this),g(this,`validade`,new Sp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new uc(this,`help-text`,`label`)),g(this,`localize`,new aa(this)),_(this,cm,m(G,8,this)),m(G,11,this),_(this,lm,m(G,12,this,!1)),m(G,15,this),_(this,um,m(G,16,this,``)),m(G,19,this),g(this,`__numberInput`,Object.assign(document.createElement(`input`),{type:`number`})),g(this,`__dateInput`,Object.assign(document.createElement(`input`),{type:`date`})),_(this,dm,m(G,20,this,`text`)),m(G,23,this),_(this,fm,m(G,24,this,``)),m(G,27,this),_(this,pm,m(G,28,this,``)),m(G,31,this),g(this,`defaultValue`,m(G,140,this,``)),m(G,143,this),_(this,mm,m(G,32,this,`medium`)),m(G,35,this),_(this,hm,m(G,36,this,!1)),m(G,39,this),_(this,gm,m(G,40,this,!1)),m(G,43,this),_(this,_m,m(G,44,this,``)),m(G,47,this),_(this,vm,m(G,48,this,``)),m(G,51,this),_(this,ym,m(G,52,this,!1)),m(G,55,this),_(this,bm,m(G,56,this,!1)),m(G,59,this),_(this,xm,m(G,60,this,``)),m(G,63,this),_(this,Sm,m(G,64,this,!1)),m(G,67,this),_(this,Cm,m(G,68,this,!1)),m(G,71,this),_(this,wm,m(G,72,this,!1)),m(G,75,this),_(this,Tm,m(G,76,this,!1)),m(G,79,this),_(this,Em,m(G,80,this,``)),m(G,83,this),_(this,Dm,m(G,84,this,!1)),m(G,87,this),_(this,Om,m(G,88,this)),m(G,91,this),_(this,km,m(G,92,this)),m(G,95,this),_(this,Am,m(G,96,this)),m(G,99,this),_(this,jm,m(G,100,this)),m(G,103,this),_(this,Mm,m(G,104,this)),m(G,107,this),_(this,Nm,m(G,108,this)),m(G,111,this),_(this,Pm,m(G,112,this)),m(G,115,this),_(this,Fm,m(G,116,this,!0)),m(G,119,this),_(this,Im,m(G,120,this)),m(G,123,this),_(this,Lm,m(G,124,this)),m(G,127,this),_(this,Rm,m(G,128,this)),m(G,131,this),_(this,zm,m(G,132,this,!0)),m(G,135,this),_(this,Bm,m(G,136,this)),m(G,139,this)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`kk-clear`),this.emit(`kk-input`),this.emit(`kk-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.updateValidity(),this.emit(`kk-input`)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this._internals.form?.requestSubmit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.input.disabled=this.disabled,this.updateValidity()}handleStepChange(){this.input.step=String(this.step),this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){let e=this.input.validity.valid;this.toggleState(`--empty`,!this.value),this.validade.aplicar(e,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,xp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return w`
      <div
        part="form-control"
    ...
    `}};G=f(sm),cm=new WeakMap,lm=new WeakMap,um=new WeakMap,dm=new WeakMap,fm=new WeakMap,pm=new WeakMap,mm=new WeakMap,hm=new WeakMap,gm=new WeakMap,_m=new WeakMap,vm=new WeakMap,ym=new WeakMap,bm=new WeakMap,xm=new WeakMap,Sm=new WeakMap,Cm=new WeakMap,wm=new WeakMap,Tm=new WeakMap,Em=new WeakMap,Dm=new WeakMap,Om=new WeakMap,km=new WeakMap,Am=new WeakMap,jm=new WeakMap,Mm=new WeakMap,Nm=new WeakMap,Pm=new WeakMap,Fm=new WeakMap,Im=new WeakMap,Lm=new WeakMap,Rm=new WeakMap,zm=new WeakMap,Bm=new WeakMap,h(G,4,`input`,om,K,cm),h(G,4,`hasFocus`,am,K,lm),h(G,4,`title`,im,K,um),h(G,4,`type`,rm,K,dm),h(G,4,`name`,nm,K,fm),h(G,4,`value`,tm,K,pm),h(G,4,`size`,$p,K,mm),h(G,4,`filled`,Qp,K,hm),h(G,4,`pill`,Zp,K,gm),h(G,4,`label`,Xp,K,_m),h(G,4,`helpText`,Yp,K,vm),h(G,4,`clearable`,Jp,K,ym),h(G,4,`disabled`,qp,K,bm),h(G,4,`placeholder`,Kp,K,xm),h(G,4,`readonly`,Gp,K,Sm),h(G,4,`passwordToggle`,Wp,K,Cm),h(G,4,`passwordVisible`,Up,K,wm),h(G,4,`noSpinButtons`,Hp,K,Tm),h(G,4,`form`,Vp,K,Em),h(G,4,`required`,Bp,K,Dm),h(G,4,`pattern`,zp,K,Om),h(G,4,`minlength`,Rp,K,km),h(G,4,`maxlength`,Lp,K,Am),h(G,4,`min`,Ip,K,jm),h(G,4,`max`,Fp,K,Mm),h(G,4,`step`,Pp,K,Nm),h(G,4,`autocapitalize`,Np,K,Pm),h(G,4,`autocorrect`,Mp,K,Fm),h(G,4,`autocomplete`,jp,K,Im),h(G,4,`autofocus`,Ap,K,Lm),h(G,4,`enterkeyhint`,kp,K,Rm),h(G,4,`spellcheck`,Op,K,zm),h(G,4,`inputmode`,Dp,K,Bm),h(G,1,`handleDisabledChange`,Ep,K),h(G,1,`handleStepChange`,Tp,K),h(G,1,`handleValueChange`,wp,K),h(G,5,`defaultValue`,em,K),p(G,K),g(K,`styles`,[D,Cp,yp]),g(K,`dependencies`,{"kk-icon":Fs}),g(K,`formAssociated`,!0);function Vm(e,t,n){return(e=>Object.is(e,-0)?0:e)(e<t?t:e>n?n:e)}var Hm=new Set(`p.br.div.span.h1.h2.h3.h4.strong.b.em.i.u.s.strike.sub.sup.mark.ul.ol.li.blockquote.hr.a.img.table.thead.tbody.tr.th.td`.split(`.`)),Um={"*":[`class`,`style`],a:[`href`,`title`,`data-nota`],img:[`src`,`alt`],td:[`colspan`,`rowspan`],th:[`colspan`,`rowspan`]},Wm=new Set([`script`,`style`,`iframe`,`object`,`embed`,`template`]),Gm=[{classe:`destaque--azul`,termo:`editorColorBlue`,icone:`highlight`},{classe:`destaque--verde`,termo:`editorColorGreen`,icone:`highlight`},{classe:`destaque--vermelho`,termo:`editorColorRed`,icone:`highlight`},{classe:`destaque--amarelo`,termo:`editorColorYellow`,icone:`highlight`},{classe:`destaque--ciano`,termo:`editorColorCyan`,icone:`highlight`}],Km=Gm.map(e=>e.classe),qm=[{classe:`paragrafo--espacado`,termo:`editorParagraphSpaced`,icone:`line-height`},{classe:`paragrafo--emoldurado`,termo:`editorParagraphBordered`,icone:`border-horizontal`},{classe:`paragrafo--recuado`,termo:`editorParagraphIndented`,icone:`indent-increase`},{classe:`paragrafo--capitular`,termo:`editorParagraphDropCap`,icone:`letter-a`},{classe:`paragrafo--epigrafe`,termo:`editorParagraphEpigraph`,icone:`quote`},{classe:`paragrafo--epigrafe-subtitulo`,termo:`editorParagraphEpigraphSubtitle`,icone:`text-caption`},{classe:`paragrafo--versaletes`,termo:`editorParagraphSmallCaps`,icone:`letter-case-upper`},{classe:`paragrafo--versaletes-subtitulo`,termo:`editorParagraphSmallCapsSubtitle`,icone:`text-caption`},{classe:`paragrafo--miudo`,termo:`editorParagraphFinePrint`,icone:`text-decrease`},{classe:`paragrafo--colunas`,termo:`editorParagraphColumns`,icone:`columns-2`},{classe:`rodape-notas`,termo:`editorParagraphFootnotes`,icone:`notes`}],Jm=qm.map(e=>e.classe),Ym={"paragrafo--epigrafe":`paragrafo--epigrafe-subtitulo`,"paragrafo--versaletes":`paragrafo--versaletes-subtitulo`,"poesia--escritura":`poesia--fonte`},Xm=Object.keys(Ym).map(e=>`.${e}`).join(`, `);function Zm(e){let t=[...e.querySelectorAll(`br`)];if(t.length===0)return null;for(let n of t){let t=document.createRange();if(t.setStartAfter(n),t.setEnd(e,e.childNodes.length),/^[\s\u00a0]*[—–]/.test(t.toString()))return n}return t[t.length-1]??null}function Qm(e,t){let n=Zm(e);if(n===null)return;let r=document.createRange();r.setStartAfter(n),r.setEnd(e,e.childNodes.length);let i=r.extractContents();n.remove();let a=document.createElement(`p`);a.className=t,a.append(i),$m(a),$m(e),a.textContent?.trim()!==``&&e.after(a)}function $m(e){let t=e.querySelector(`:not(br, img, hr):empty`);for(;t!==null;)t.remove(),t=e.querySelector(`:not(br, img, hr):empty`)}function eh(e){if(!Object.keys(Ym).some(t=>e.includes(t)))return e;let t=document.createElement(`div`);t.innerHTML=e;for(let e of t.querySelectorAll(Xm))for(let[t,n]of Object.entries(Ym))e.classList.contains(t)&&Qm(e,n);return t.innerHTML}var th=[{classe:`poesia--tema`,termo:`editorPoetryTheme`,icone:`book-2`},{classe:`poesia--verso`,termo:`editorPoetryVerse`,icone:`text-wrap`},{classe:`poesia--escritura`,termo:`editorPoetryScripture`,icone:`quote`},{classe:`poesia--fonte`,termo:`editorPoetrySource`,icone:`signature`},{classe:`poesia--refrao`,termo:`editorPoetryRefrain`,icone:`repeat`},{classe:`poesia--dedicatoria`,termo:`editorPoetryDedication`,icone:`gift`}],nh=th.map(e=>e.classe),rh=[{termo:`editorTypoEmDash`,amostra:`—`,abre:`— `},{termo:`editorTypoEnDash`,amostra:`–`,abre:`–`},{termo:`editorTypoDoubleQuotes`,amostra:`“ ”`,abre:`“`,fecha:`”`},{termo:`editorTypoSingleQuotes`,amostra:`‘ ’`,abre:`‘`,fecha:`’`},{termo:`editorTypoNbsp`,amostra:`␣`,abre:`\xA0`}],ih=new Set([...Km,...Jm,...nh,`note-nota-ref`]),ah=/^var\(--kk-color-[a-z0-9-]+\)$/,oh={"text-align":/^(left|center|right|justify)$/,color:ah,"background-color":ah};function sh(e){let t=[];for(let n of e.split(`;`)){let e=n.indexOf(`:`);if(e<0)continue;let r=n.slice(0,e).trim().toLowerCase(),i=n.slice(e+1).replace(/!\s*important/i,``).toLowerCase().replace(/\s+/g,``),a=oh[r];a===void 0||!a.test(i)||t.push(`${r}: ${i}`)}return t.join(`; `)}var ch=/^data:image\/(?:png|jpeg|jpg|gif|webp|avif|bmp);base64,[A-Za-z0-9+/=]+$/,lh=[`image/png`,`image/jpeg`,`image/gif`,`image/webp`,`image/avif`,`image/bmp`],uh=`http://www.w3.org/1999/xhtml`;function dh(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function fh(e){let t=new DOMParser().parseFromString(e,`text/html`),n=t.createTreeWalker(t.body,NodeFilter.SHOW_COMMENT),r=[];for(let e=n.nextNode();e!==null;e=n.nextNode())r.push(e);for(let e of r)e.remove();for(let e of[...t.body.querySelectorAll(`*`)]){if(e.namespaceURI!==uh){e.remove();continue}let t=e.tagName.toLowerCase();if(Wm.has(t)){e.remove();continue}if(!Hm.has(t)){e.replaceWith(...e.childNodes);continue}let n=[...Um[`*`]??[],...Um[t]??[]];for(let t of[...e.attributes]){if(!n.includes(t.name)){e.removeAttribute(t.name);continue}if(t.name===`style`){let n=sh(t.value);n===``?e.removeAttribute(`style`):e.setAttribute(`style`,n)}if(t.name===`class`){let n=t.value.split(/\s+/).filter(e=>ih.has(e));n.length===0?e.removeAttribute(`class`):e.setAttribute(`class`,n.join(` `))}if(t.name===`href`||t.name===`src`){let n=t.value.trim();/^(https?:|mailto:|#|\/|\.)/i.test(n)||t.name===`src`&&ch.test(n)||e.removeAttribute(t.name)}}}return t.body.innerHTML}function ph(e){let t=e??``;for(let e=0;e<3;e+=1){let e=fh(t);if(e===t)return e;t=e}return dh(new DOMParser().parseFromString(t,`text/html`).body.textContent??``)}var mh=[{rampa:`neutral`,termo:`editorColorGray`},{rampa:`red`,termo:`editorColorRed`},{rampa:`orange`,termo:`editorColorOrange`},{rampa:`yellow`,termo:`editorColorYellow`},{rampa:`lime`,termo:`editorColorLime`},{rampa:`green`,termo:`editorColorGreen`},{rampa:`teal`,termo:`editorColorTeal`},{rampa:`cyan`,termo:`editorColorCyan`},{rampa:`blue`,termo:`editorColorBlue`},{rampa:`violet`,termo:`editorColorViolet`},{rampa:`pink`,termo:`editorColorPink`}],hh=[{valor:`var(--kk-color-neutral-900)`,termo:`editorColorDefault`},...mh.map(e=>({valor:`var(--kk-color-${e.rampa}-600)`,termo:e.termo}))],gh=[{valor:`var(--kk-color-neutral-0)`,termo:`editorColorDefault`},...mh.map(e=>({valor:`var(--kk-color-${e.rampa}-200)`,termo:e.termo}))],_h={color:`#010203`,"background-color":`#040506`};function vh(e,t){let n=document.createElement(`span`);return n.style.setProperty(e,t),n.style.getPropertyValue(e)}var yh=`p, h1, h2, h3, h4, li, blockquote, div, td, th`,bh=8,xh=10,Sh=Array.from({length:bh*xh},(e,t)=>({linha:Math.floor(t/xh)+1,coluna:t%xh+1}));function Ch(e){let t=document.createElement(e);return t.append(document.createElement(`br`)),t}function wh(e,t){return`<table><tbody>${`<tr>${`<td><br></td>`.repeat(t)}</tr>`.repeat(e)}</tbody></table><p><br></p>`}function Th(e,t){if(e.tagName.toLowerCase()===t)return;let n=document.createElement(t);for(let t of[...e.attributes])n.setAttribute(t.name,t.value);n.append(...e.childNodes),e.replaceWith(n)}function Eh(e,t){let n=e.closest(`tr`),r=n?.parentElement;if(n===null||r==null)return;let i=document.createElement(`tr`),a=r.tagName===`THEAD`?`th`:`td`;for(let e=0;e<n.cells.length;e+=1)i.append(Ch(a));r.insertBefore(i,t?n.nextSibling:n)}function Dh(e){let t=e.closest(`tr`),n=e.closest(`table`);if(t===null||n===null)return;if(n.rows.length<=1){n.remove();return}let r=t.parentElement;t.remove(),r!==null&&r.children.length===0&&r.remove()}function Oh(e,t){let n=e.closest(`table`);if(n===null)return;let r=e.cellIndex;for(let e of[...n.rows]){let n=e.cells[r],i=Ch(n?.tagName===`TH`?`th`:`td`);n===void 0?e.append(i):e.insertBefore(i,t?n.nextSibling:n)}}function kh(e){let t=e.closest(`table`);if(t===null)return;let n=e.cellIndex;if(Math.max(...[...t.rows].map(e=>e.cells.length))<=1){t.remove();return}for(let e of[...t.rows])e.cells[n]?.remove()}function Ah(e){let t=e.closest(`table`);if(t===null)return;let n=t.tHead;if(n!==null){let e=t.tBodies[0]??t.createTBody();for(let t of[...n.rows].reverse()){for(let e of[...t.cells])Th(e,`td`);e.insertBefore(t,e.firstChild)}n.remove();return}let r=t.rows[0];if(r===void 0)return;for(let e of[...r.cells])Th(e,`th`);let i=r.parentElement;t.createTHead().append(r),i!==null&&i.children.length===0&&i.remove()}function jh(e){e.closest(`table`)?.remove()}var Mh=[{termo:`editorTableRowAbove`,icone:`row-insert-top`,executar:e=>Eh(e,!1)},{termo:`editorTableRowBelow`,icone:`row-insert-bottom`,executar:e=>Eh(e,!0)},{termo:`editorTableRowDelete`,icone:`row-remove`,executar:Dh},{termo:`editorTableColumnBefore`,icone:`column-insert-left`,executar:e=>Oh(e,!1)},{termo:`editorTableColumnAfter`,icone:`column-insert-right`,executar:e=>Oh(e,!0)},{termo:`editorTableColumnDelete`,icone:`column-remove`,executar:kh},{termo:`editorTableHeader`,icone:`layout-navbar`,executar:Ah},{termo:`editorTableDelete`,icone:`trash`,executar:jh}],Nh=[{icone:`arrow-back-up`,termo:`editorUndo`,comando:`undo`},{icone:`arrow-forward-up`,termo:`editorRedo`,comando:`redo`}],Ph=[[{icone:`bold`,termo:`editorBold`,comando:`bold`,alterna:!0},{icone:`italic`,termo:`editorItalic`,comando:`italic`,alterna:!0},{icone:`underline`,termo:`editorUnderline`,comando:`underline`,alterna:!0},{icone:`strikethrough`,termo:`editorStrikethrough`,comando:`strikeThrough`,alterna:!0}],[{icone:`list`,termo:`editorBulletList`,comando:`insertUnorderedList`,alterna:!0},{icone:`list-numbers`,termo:`editorNumberedList`,comando:`insertOrderedList`,alterna:!0}],[{icone:`align-left`,termo:`editorAlignLeft`,comando:`justifyLeft`,alterna:!0},{icone:`align-center`,termo:`editorAlignCenter`,comando:`justifyCenter`,alterna:!0},{icone:`align-right`,termo:`editorAlignRight`,comando:`justifyRight`,alterna:!0},{icone:`align-justified`,termo:`editorAlignJustify`,comando:`justifyFull`,alterna:!0}],[{icone:`corner-down-left`,termo:`editorLineBreak`,comando:`insertLineBreak`},{icone:`separator-horizontal`,termo:`editorHorizontalRule`,comando:`insertHorizontalRule`}]],Fh=[Nh,...Ph].flat().filter(e=>e.alterna===!0).map(e=>e.comando),Ih={tag:`p`,termo:`editorParagraph`,icone:`pilcrow`},Lh=[Ih,{tag:`h1`,termo:`editorHeading1`,icone:`h-1`},{tag:`h2`,termo:`editorHeading2`,icone:`h-2`},{tag:`h3`,termo:`editorHeading3`,icone:`h-3`},{tag:`h4`,termo:`editorHeading4`,icone:`h-4`},{tag:`blockquote`,termo:`editorQuote`,icone:`blockquote`}];typeof document<`u`&&vp.styleSheet!==void 0&&(document.adoptedStyleSheets=[...document.adoptedStyleSheets,vp.styleSheet]);function Rh(e){let t=e.getRootNode(),n=vp.styleSheet;n===void 0||!(t instanceof ShadowRoot)||t.adoptedStyleSheets.includes(n)||(t.adoptedStyleSheets=[...t.adoptedStyleSheets,n])}var zh,Bh,Vh,Hh,Uh,Wh,Gh,Kh,qh=class e extends (Hh=M,Vh=[k()],Bh=[k()],zh=[O({type:Boolean,reflect:!0})],Hh){constructor(){super(...arguments),g(this,`localize`,new aa(this)),g(this,`area`,document.createElement(`div`)),g(this,`fonte`,document.createElement(`textarea`)),g(this,`conteudo`,``),_(this,Wh,m(Uh,8,this,!1)),m(Uh,11,this),_(this,Gh,m(Uh,12,this,0)),m(Uh,15,this),g(this,`assinaturaDaBarra`,``),g(this,`ultimaFaixa`,null),g(this,`quadro`,0),_(this,Kh,m(Uh,16,this,!1)),m(Uh,19,this),g(this,`handleFonteInput`,()=>{this.conteudo=this.fonte.value,this.emit(`kk-input`,{detail:{value:this.conteudo}})}),g(this,`handleInput`,()=>{this.conteudo=this.area.innerHTML,this.emit(`kk-input`,{detail:{value:this.conteudo}}),this.sincronizarBarra()}),g(this,`sincronizarBarra`,()=>{this.guardarSelecao(),this.quadro===0&&(this.quadro=requestAnimationFrame(()=>{this.quadro=0;let e=[this.tagDoBlocoCorrente(),...Fh.map(e=>this.comandoLigado(e)?`1`:`0`),this.corCorrente(`color`)??``,this.corCorrente(`background-color`)??``,this.blocoCorrente()?.className??``,this.celulaCorrente()===void 0?``:`tabela`].join(`|`);e!==this.assinaturaDaBarra&&(this.assinaturaDaBarra=e,this.selecao+=1)}))}),g(this,`handlePaste`,e=>{e.preventDefault();let t=e.clipboardData;if(t===null)return;let n=t.getData(`text/html`),r=t.getData(`text/plain`);n===``?document.execCommand(`insertText`,!1,r):document.execCommand(`insertHTML`,!1,ph(n)),this.handleInput()}),g(this,`aoApontarNaGrade`,e=>{let t=e.target.closest(`[data-linha]`);t!==null&&this.marcarGrade(Number(t.dataset.linha),Number(t.dataset.coluna))}),g(this,`aoTeclarNaGrade`,e=>{let t={ArrowUp:[-1,0],ArrowDown:[1,0],ArrowLeft:[0,-1],ArrowRight:[0,1]}[e.key],n=e.target.closest(`[data-linha]`);if(t===void 0||n===null)return;e.preventDefault();let r=Vm(Number(n.dataset.linha)+t[0],1,bh),i=Vm(Number(n.dataset.coluna)+t[1],1,xh);this.querySelector(`[data-linha="${r}"][data-coluna="${i}"]`)?.focus()})}get value(){return this.conteudo}set value(e){let t=eh(ph(e??``));t===this.conteudo||t===eh(ph(this.conteudo))||(this.conteudo=t,this.area.innerHTML=t,this.codigo&&(this.fonte.value=t))}connectedCallback(){super.connectedCallback(),Rh(this),this.area.className=`kk-editor__content kk-prose`,this.area.contentEditable=this.readonly?`false`:`true`,this.area.spellcheck=!0,this.area.setAttribute(`role`,`textbox`),this.area.setAttribute(`aria-multiline`,`true`),this.area.setAttribute(`aria-label`,this.localize.term(`editorArea`)),this.area.innerHTML=this.conteudo,document.execCommand(`styleWithCSS`,!1,`false`),this.fonte.className=`kk-editor__source`,this.fonte.spellcheck=!1,this.fonte.setAttribute(`aria-label`,this.localize.term(`editorSource`)),this.area.addEventListener(`input`,this.handleInput),this.area.addEventListener(`paste`,this.handlePaste),this.area.addEventListener(`keyup`,this.sincronizarBarra),this.area.addEventListener(`mouseup`,this.sincronizarBarra),this.area.addEventListener(`focus`,this.sincronizarBarra),this.fonte.addEventListener(`input`,this.handleFonteInput)}disconnectedCallback(){super.disconnectedCallback(),this.area.removeEventListener(`input`,this.handleInput),this.area.removeEventListener(`paste`,this.handlePaste),this.area.removeEventListener(`keyup`,this.sincronizarBarra),this.area.removeEventListener(`mouseup`,this.sincronizarBarra),this.area.removeEventListener(`focus`,this.sincronizarBarra),this.fonte.removeEventListener(`input`,this.handleFonteInput),this.quadro!==0&&(cancelAnimationFrame(this.quadro),this.quadro=0)}createRenderRoot(){return this}focus(e){(this.codigo?this.fonte:this.area).focus(e)}get travado(){return this.readonly||this.codigo}alternarCodigo(){if(this.codigo){let e=eh(ph(this.fonte.value)),t=e!==this.conteudo;this.conteudo=e,this.area.innerHTML=e,this.codigo=!1,t&&this.emit(`kk-input`,{detail:{value:e}})}else this.conteudo=this.area.innerHTML,this.fonte.value=this.conteudo,this.fonte.readOnly=this.readonly,this.codigo=!0;this.updateComplete.then(()=>this.focus())}aplicar(e,t){this.area.focus(),this.restaurarSelecao(),document.execCommand(e,!1,t),this.handleInput()}selecaoAtual(){let e=this.getRootNode();return`getSelection`in e?e.getSelection():getSelection()}guardarSelecao(){let e=this.selecaoAtual();if(e===null||e.rangeCount===0)return;let t=e.getRangeAt(0);this.area.contains(t.commonAncestorContainer)&&(this.ultimaFaixa=t.cloneRange())}restaurarSelecao(){let e=this.ultimaFaixa,t=this.selecaoAtual();e===null||t===null||this.area.contains(e.commonAncestorContainer)&&(t.removeAllRanges(),t.addRange(e))}faixaCorrente(){let e=this.selecaoAtual();if(e!==null&&e.rangeCount>0){let t=e.getRangeAt(0);if(this.area.contains(t.commonAncestorContainer))return t}let t=this.ultimaFaixa;if(t!==null&&this.area.contains(t.commonAncestorContainer))return t}elementoCorrente(){let e=this.faixaCorrente()?.startContainer;return e===void 0?void 0:(e.nodeType===Node.ELEMENT_NODE?e:e.parentElement)??void 0}blocoCorrente(){let e=this.elementoCorrente()?.closest(yh);return e!=null&&this.area.contains(e)?e:void 0}celulaCorrente(){let e=this.elementoCorrente()?.closest(`td, th`);return e!=null&&this.area.contains(e)?e:void 0}blocosDaSelecao(){let e=this.faixaCorrente();if(e===void 0)return[];if(e.collapsed){let e=this.blocoCorrente();return e===void 0?[]:[e]}return[...this.area.querySelectorAll(yh)].filter(t=>t.querySelector(yh)===null&&e.intersectsNode(t))}marcarBlocos(e,t){this.area.focus(),this.restaurarSelecao();let n=this.blocosDaSelecao();if(n.length===0)return;let r=n[0]?.classList.contains(e)===!0;for(let i of n){i.classList.remove(...t),i.classList.toggle(e,!r),i.className===``&&i.removeAttribute(`class`);let n=Ym[e];!r&&n!==void 0&&Qm(i,n)}this.handleInput()}limparFormatacao(){this.area.focus(),this.restaurarSelecao(),document.execCommand(`removeFormat`),document.execCommand(`unlink`);for(let e of this.blocosDaSelecao())e.removeAttribute(`class`),e.removeAttribute(`style`);let e=this.tagDoBlocoCorrente();e!==`p`&&e!==`li`&&e!==`td`&&e!==`th`&&document.execCommand(`formatBlock`,!1,`p`),this.handleInput()}inserirTipografia(e,t){this.area.focus(),this.restaurarSelecao();let n=t===void 0?``:this.faixaCorrente()?.toString()??``;if(document.execCommand(`insertText`,!1,`${e}${n}${t??``}`),t!==void 0&&n===``){let e=this.selecaoAtual()?.getRangeAt(0);e!==void 0&&e.startContainer.nodeType===Node.TEXT_NODE&&(e.setStart(e.startContainer,e.startOffset-t.length),e.collapse(!0),this.ultimaFaixa=e.cloneRange())}this.handleInput()}corCorrente(e){let t=this.elementoCorrente();for(;t!==void 0&&t!==this.area;){let n=t.style?.getPropertyValue(e)??``;if(n!==``)return n;t=t.parentElement??void 0}}pintar(e,t){this.area.focus(),this.restaurarSelecao();let n=_h[e];document.execCommand(`styleWithCSS`,!1,`true`),document.execCommand(e===`color`?`foreColor`:`hiliteColor`,!1,n),document.execCommand(`styleWithCSS`,!1,`false`);let r=vh(e,n);for(let n of[...this.area.querySelectorAll(`[style]`)])n.style.getPropertyValue(e)===r&&(t===null?n.style.removeProperty(e):n.style.setProperty(e,t),n.getAttribute(`style`)===``&&n.removeAttribute(`style`),n.tagName===`SPAN`&&n.attributes.length===0&&n.replaceWith(...n.childNodes));this.handleInput()}pedirTexto(e){let t=document.createElement(`kk-dialog`);return t.label=e.rotulo,document.body.append(t),new Promise(n=>{let r=null,i=e=>{r=e,t.open=!1},a=()=>{let e=t.querySelector(`kk-input`),n=e?.value.trim()??``;if(n===``){e?.focus();return}i(n)};t.addEventListener(`kk-after-hide`,e=>{e.target===t&&(t.remove(),n(r))}),po(w`
          <p>${e.texto}</p>
          <kk-input
            autofocus
            placeholder=${e.placeholder??``}
    ...
    </div>`}renderSeletorDeBloco(){let e=this.tagDoBlocoCorrente(),t=Lh.find(t=>t.tag===e)??Ih,n=`${this.localize.term(`editorBlockType`)}: ${this.localize.term(t.termo)}`;return w`
      ...
      <kk-dropdown hoist @kk-show=${()=>this.marcarGrade(1,1)}>
        ...
        <div class="kk-editor__panel">
          <div
            ...
            style="--kk-editor-grade-colunas: ${xh}"
    ...
    `}render(){return this.selecao,w`
      <div class="kk-editor__toolbar" role="toolbar" aria-label=${this.localize.term(`editorToolbar`)}>
        ...
        ${Ph.map(e=>this.renderGrupo(e))}

        <div class="kk-editor__group">
          ${this.renderPaleta(`color`,hh,`text-color`,`editorTextColor`)}
          ${this.renderPaleta(`background-color`,gh,`background`,`editorBackgroundColor`)}
          ${this.renderMenuDeClasses(`article`,`editorParagraphStyle`,qm,Jm)}
          ${this.renderMenuDeClasses(`feather`,`editorPoetry`,th,nh)}
          ${this.renderMenuDeClasses(`highlight`,`editorHighlight`,Gm,Km)}
    ...
    `}};Uh=f(Hh),Wh=new WeakMap,Gh=new WeakMap,Kh=new WeakMap,h(Uh,4,`codigo`,Vh,qh,Wh),h(Uh,4,`selecao`,Bh,qh,Gh),h(Uh,4,`readonly`,zh,qh,Kh),p(Uh,qh),g(qh,`dependencies`,{"kk-button":z,"kk-dialog":zu,"kk-dropdown":Nf,"kk-icon":Fs,"kk-input":K,"kk-menu":zf,"kk-menu-item":_p}),qh.define(`kk-editor`);var Jh=C`
  :host {
    display: block;
...
`,Xh,Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg,cg,lg,ug,q,dg,fg,pg,mg,hg,gg,_g,vg,yg,bg,xg,Sg=class extends (ug=M,lg=[A(`input[type="checkbox"]`)],cg=[k()],sg=[O()],og=[O()],ag=[O()],ig=[O({reflect:!0})],rg=[O({type:Boolean,reflect:!0})],ng=[O({type:Boolean,reflect:!0})],tg=[To(`checked`)],eg=[O({reflect:!0})],$h=[O({type:Boolean,reflect:!0})],Qh=[O({attribute:`help-text`})],Zh=[j(`checked`,{waitUntilFirstUpdate:!0})],Xh=[j(`disabled`,{waitUntilFirstUpdate:!0})],ug){constructor(){super(...arguments),m(q,5,this),g(this,`formControlController`,new es(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=!!t})),g(this,`hasSlotController`,new uc(this,`help-text`)),_(this,dg,m(q,8,this)),m(q,11,this),_(this,fg,m(q,12,this,!1)),m(q,15,this),_(this,pg,m(q,16,this,``)),m(q,19,this),_(this,mg,m(q,20,this,``)),m(q,23,this),_(this,hg,m(q,24,this)),m(q,27,this),_(this,gg,m(q,28,this,`medium`)),m(q,31,this),_(this,_g,m(q,32,this,!1)),m(q,35,this),_(this,vg,m(q,36,this,!1)),m(q,39,this),g(this,`defaultChecked`,m(q,52,this,!1)),m(q,55,this),_(this,yg,m(q,40,this,``)),m(q,43,this),_(this,bg,m(q,44,this,!1)),m(q,47,this),_(this,xg,m(q,48,this,``)),m(q,51,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleInput(){this.emit(`kk-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`kk-change`),this.emit(`kk-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`kk-change`),this.emit(`kk-input`))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return w`
      <div
    ...
    `}};q=f(ug),dg=new WeakMap,fg=new WeakMap,pg=new WeakMap,mg=new WeakMap,hg=new WeakMap,gg=new WeakMap,_g=new WeakMap,vg=new WeakMap,yg=new WeakMap,bg=new WeakMap,xg=new WeakMap,h(q,4,`input`,lg,Sg,dg),h(q,4,`hasFocus`,cg,Sg,fg),h(q,4,`title`,sg,Sg,pg),h(q,4,`name`,og,Sg,mg),h(q,4,`value`,ag,Sg,hg),h(q,4,`size`,ig,Sg,gg),h(q,4,`disabled`,rg,Sg,_g),h(q,4,`checked`,ng,Sg,vg),h(q,4,`form`,eg,Sg,yg),h(q,4,`required`,$h,Sg,bg),h(q,4,`helpText`,Qh,Sg,xg),h(q,1,`handleCheckedChange`,Zh,Sg),h(q,1,`handleDisabledChange`,Xh,Sg),h(q,5,`defaultChecked`,tg,Sg),p(q,Sg),g(Sg,`styles`,[D,Cp,Yh]);var Cg=C`
  :host {
    display: block;
  }
...
`,wg=class extends bo{constructor(e){if(super(e),this.it=T,e.type!==vo.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===T||e==null)return this._t=void 0,this.it=e;if(e===Xa)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};wg.directiveName=`unsafeHTML`,wg.resultType=1;var Tg=yo(wg);function Eg(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}function Dg(e,t,n=`vertical`,r=`smooth`){let i=Eg(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,s=t.scrollLeft,c=t.scrollLeft+t.offsetWidth,l=t.scrollTop,u=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<s?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>c&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<l?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>u&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}var Og=C`
  :host {
    display: inline-block;
  }
...
`,kg,Ag,jg,Mg,Ng,Pg,Fg,Ig,Lg,Rg,zg=class extends (Ng=M,Mg=[O({reflect:!0})],jg=[O({reflect:!0})],Ag=[O({type:Boolean,reflect:!0})],kg=[O({type:Boolean})],Ng){constructor(){super(...arguments),g(this,`localize`,new aa(this)),_(this,Fg,m(Pg,8,this,`neutral`)),m(Pg,11,this),_(this,Ig,m(Pg,12,this,`medium`)),m(Pg,15,this),_(this,Lg,m(Pg,16,this,!1)),m(Pg,19,this),_(this,Rg,m(Pg,20,this,!1)),m(Pg,23,this)}handleRemoveClick(){this.emit(`kk-remove`)}render(){return w`
      <span
        part="base"
    ...
    `}};Pg=f(Ng),Fg=new WeakMap,Ig=new WeakMap,Lg=new WeakMap,Rg=new WeakMap,h(Pg,4,`variant`,Mg,zg,Fg),h(Pg,4,`size`,jg,zg,Ig),h(Pg,4,`pill`,Ag,zg,Lg),h(Pg,4,`removable`,kg,zg,Rg),p(Pg,zg),g(zg,`styles`,[D,Og]),g(zg,`dependencies`,{"kk-icon-button":I});var Bg,Vg,Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_,r_,i_,a_,o_,s_,c_,l_,u_,d_,f_,p_,m_,h_,g_,__,J,v_,y_,b_,x_,S_,C_,w_,T_,E_,D_,O_,k_,A_,j_,M_,N_,P_,F_,I_,L_,R_,z_,B_,V_,H_,U_,W_,Y=class extends (__=M,g_=[A(`.select`)],h_=[A(`.select__combobox`)],m_=[A(`.select__display-input`)],p_=[A(`.select__value-input`)],f_=[A(`.select__listbox`)],d_=[k()],u_=[k()],l_=[k()],c_=[k()],s_=[k()],o_=[O()],a_=[k()],i_=[O({attribute:`value`})],r_=[O({reflect:!0})],n_=[O()],t_=[O({type:Boolean,reflect:!0})],e_=[O({attribute:`max-options-visible`,type:Number})],$g=[O({type:Boolean,reflect:!0})],Qg=[O({type:Boolean})],Zg=[O({type:Boolean,reflect:!0})],Xg=[O({type:Boolean,reflect:!0})],Yg=[O({type:Boolean,reflect:!0})],Jg=[O()],qg=[O({reflect:!0})],Kg=[O({attribute:`help-text`})],Gg=[O({reflect:!0,converter:Jo})],Wg=[O({type:Boolean,reflect:!0})],Ug=[O()],Hg=[j(`disabled`,{waitUntilFirstUpdate:!0})],Vg=[j([`defaultValue`,`value`],{waitUntilFirstUpdate:!0})],Bg=[j(`open`,{waitUntilFirstUpdate:!0})],__){constructor(){super(...arguments),m(J,5,this),g(this,`validade`,new Sp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new uc(this,`help-text`,`label`)),g(this,`localize`,new aa(this)),g(this,`typeToSelectString`,``),g(this,`typeToSelectTimeout`),g(this,`closeWatcher`),_(this,v_,m(J,8,this)),m(J,11,this),_(this,y_,m(J,12,this)),m(J,15,this),_(this,b_,m(J,16,this)),m(J,19,this),_(this,x_,m(J,20,this)),m(J,23,this),_(this,S_,m(J,24,this)),m(J,27,this),_(this,C_,m(J,28,this,!1)),m(J,31,this),_(this,w_,m(J,32,this,``)),m(J,35,this),_(this,T_,m(J,36,this)),m(J,39,this),_(this,E_,m(J,40,this,[])),m(J,43,this),_(this,D_,m(J,44,this,!1)),m(J,47,this),_(this,O_,m(J,48,this,``)),m(J,51,this),g(this,`_value`,``),_(this,k_,m(J,52,this,``)),m(J,55,this),_(this,A_,m(J,56,this,`medium`)),m(J,59,this),_(this,j_,m(J,60,this,``)),m(J,63,this),_(this,M_,m(J,64,this,!1)),m(J,67,this),_(this,N_,m(J,68,this,3)),m(J,71,this),_(this,P_,m(J,72,this,!1)),m(J,75,this),_(this,F_,m(J,76,this,!1)),m(J,79,this),_(this,I_,m(J,80,this,!1)),m(J,83,this),_(this,L_,m(J,84,this,!1)),m(J,87,this),_(this,R_,m(J,88,this,!1)),m(J,91,this),_(this,z_,m(J,92,this,``)),m(J,95,this),_(this,B_,m(J,96,this,`bottom`)),m(J,99,this),_(this,V_,m(J,100,this,``)),m(J,103,this),_(this,H_,m(J,104,this,``)),m(J,107,this),_(this,U_,m(J,108,this,!1)),m(J,111,this),_(this,W_,m(J,112,this,e=>w`
      <kk-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};J=f(__),v_=new WeakMap,y_=new WeakMap,b_=new WeakMap,x_=new WeakMap,S_=new WeakMap,C_=new WeakMap,w_=new WeakMap,T_=new WeakMap,E_=new WeakMap,D_=new WeakMap,O_=new WeakMap,k_=new WeakMap,A_=new WeakMap,j_=new WeakMap,M_=new WeakMap,N_=new WeakMap,P_=new WeakMap,F_=new WeakMap,I_=new WeakMap,L_=new WeakMap,R_=new WeakMap,z_=new WeakMap,B_=new WeakMap,V_=new WeakMap,H_=new WeakMap,U_=new WeakMap,W_=new WeakMap,h(J,4,`popup`,g_,Y,v_),h(J,4,`combobox`,h_,Y,y_),h(J,4,`displayInput`,m_,Y,b_),h(J,4,`valueInput`,p_,Y,x_),h(J,4,`listbox`,f_,Y,S_),h(J,4,`hasFocus`,d_,Y,C_),h(J,4,`displayLabel`,u_,Y,w_),h(J,4,`currentOption`,l_,Y,T_),h(J,4,`selectedOptions`,c_,Y,E_),h(J,4,`valueHasChanged`,s_,Y,D_),h(J,4,`name`,o_,Y,O_),h(J,3,`value`,a_,Y),h(J,4,`defaultValue`,i_,Y,k_),h(J,4,`size`,r_,Y,A_),h(J,4,`placeholder`,n_,Y,j_),h(J,4,`multiple`,t_,Y,M_),h(J,4,`maxOptionsVisible`,e_,Y,N_),h(J,4,`disabled`,$g,Y,P_),h(J,4,`clearable`,Qg,Y,F_),h(J,4,`open`,Zg,Y,I_),h(J,4,`filled`,Xg,Y,L_),h(J,4,`pill`,Yg,Y,R_),h(J,4,`label`,Jg,Y,z_),h(J,4,`placement`,qg,Y,B_),h(J,4,`helpText`,Kg,Y,V_),h(J,4,`form`,Gg,Y,H_),h(J,4,`required`,Wg,Y,U_),h(J,4,`getTag`,Ug,Y,W_),h(J,1,`handleDisabledChange`,Hg,Y),h(J,1,`handleValueChange`,Vg,Y),h(J,1,`handleOpenChange`,Bg,Y),p(J,Y),g(Y,`styles`,[D,Cp,Cg]),g(Y,`dependencies`,{"kk-icon":Fs,"kk-popup":H,"kk-tag":zg}),g(Y,`formAssociated`,!0);var G_=C`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,K_,q_,J_,Y_,X_,Z_,Q_,$_,ev,tv,X,nv,rv,iv,av,ov,sv,cv=class extends (tv=M,ev=[A(`.option__label`)],$_=[k()],Q_=[k()],Z_=[k()],X_=[O({reflect:!0})],Y_=[O({type:Boolean,reflect:!0})],J_=[j(`disabled`)],q_=[j(`selected`)],K_=[j(`value`)],tv){constructor(){super(...arguments),m(X,5,this),g(this,`localize`,new aa(this)),g(this,`isInitialized`,!1),_(this,nv,m(X,8,this)),m(X,11,this),_(this,rv,m(X,12,this,!1)),m(X,15,this),_(this,iv,m(X,16,this,!1)),m(X,19,this),_(this,av,m(X,20,this,!1)),m(X,23,this),_(this,ov,m(X,24,this,``)),m(X,27,this),_(this,sv,m(X,28,this,!1)),m(X,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`kk-select`).then(()=>{let e=this.closest(`kk-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return w`
    ...
    `}};X=f(tv),nv=new WeakMap,rv=new WeakMap,iv=new WeakMap,av=new WeakMap,ov=new WeakMap,sv=new WeakMap,h(X,4,`defaultSlot`,ev,cv,nv),h(X,4,`current`,$_,cv,rv),h(X,4,`selected`,Q_,cv,iv),h(X,4,`hasHover`,Z_,cv,av),h(X,4,`value`,X_,cv,ov),h(X,4,`disabled`,Y_,cv,sv),h(X,1,`handleDisabledChange`,J_,cv),h(X,1,`handleSelectedChange`,q_,cv),h(X,1,`handleValueChange`,K_,cv),p(X,cv),g(cv,`styles`,[D,G_]),g(cv,`dependencies`,{"kk-icon":Fs});var lv=`🛒.🍕.☕.🏠.💡.💧.🔌.🚌.⛽.🚗.💊.🏥.🩺.👕.🎁.🎮.🎵.📚.🎓.🏖️.💰.💳.🧾.🐾.📱.💼.💇.🧴.🧺.🏋️.🛡️.🧸`.split(`.`),uv=[[`diaria`,`financeDaily`],[`semanal`,`financeWeekly`],[`mensal`,`financeMonthly`],[`anual`,`financeYearly`]],dv=`••••`,fv={descricao:!1,valor:!1,diaMes:!1};function pv(e){let t=new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function mv(e){return pv(e).slice(0,7)}function hv(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1).getTime()}var gv,_v,vv,yv,bv,xv,Sv,Cv,wv,Tv,Ev,Z,Dv,Ov,kv,Av,jv,Mv,Nv,Pv,Fv,Iv=class e extends (Ev=M,Tv=[O({reflect:!0})],wv=[O({type:Array})],Cv=[O({type:Array})],Sv=[O({type:Array})],xv=[O({type:Array})],bv=[O({reflect:!0})],yv=[O({type:Boolean,reflect:!0})],vv=[O()],_v=[k()],gv=[j(`vista`,{waitUntilFirstUpdate:!0})],Ev){constructor(){super(...arguments),m(Z,5,this),g(this,`localize`,new aa(this)),_(this,Dv,m(Z,8,this,`painel`)),m(Z,11,this),_(this,Ov,m(Z,12,this,[])),m(Z,15,this),_(this,kv,m(Z,16,this,[])),m(Z,19,this),_(this,Av,m(Z,20,this,[])),m(Z,23,this),_(this,jv,m(Z,24,this,[])),m(Z,27,this),_(this,Mv,m(Z,28,this,``)),m(Z,31,this),_(this,Nv,m(Z,32,this,!1)),m(Z,35,this),_(this,Pv,m(Z,36,this,`BRL`)),m(Z,39,this),_(this,Fv,m(Z,40,this,null)),m(Z,43,this)}get aberto(){return this.formulario!==null}novo(){this.vista===`transacoes`&&this.abrir({especie:`transacao`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,vencimento:pv(Date.now()),pago:!1,parte:0}}),this.vista===`categorias`&&this.abrir({especie:`categoria`,dados:{id:0,nome:``,icone:``,cor:`#0d6efd`,limite:``,erroNome:!1}}),this.vista===`recorrencias`&&this.abrir({especie:`recorrencia`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,periodicidade:`mensal`,diaMes:1,diaSemana:1,gerarComoPago:!1,ativa:!0,erros:fv}})}fechar(){this.formulario!==null&&(this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}))}handleVistaChange(){this.fechar()}abrir(e){this.formulario=e,this.emit(`kk-form`,{detail:{aberto:!0}})}get mesCorrente(){return this.mes===``?mv(Date.now()):this.mes}dinheiro(e){return this.localize.number(e,{style:`currency`,currency:this.moeda,minimumFractionDigits:2,maximumFractionDigits:2})}cifra(e){return this.oculto?dv:this.dinheiro(e)}data(e){return e===0?`—`:this.localize.date(new Date(e),{dateStyle:`short`})}get simboloDaMoeda(){return new Intl.NumberFormat(this.localize.lang(),{style:`currency`,currency:this.moeda}).formatToParts(0).find(e=>e.type===`currency`)?.value??this.moeda}get separadores(){let e=new Intl.NumberFormat(this.localize.lang(),{minimumFractionDigits:2}).formatToParts(1234.5);return{grupo:e.find(e=>e.type===`group`)?.value??`.`,decimal:e.find(e=>e.type===`decimal`)?.value??`,`}}mascarar(e){let t=e.replace(/\D/g,``).replace(/^0+(?=\d)/,``);if(t===``)return``;let n=t.padStart(3,`0`),r=Number(n.slice(0,-2));return`${this.localize.number(r)}${this.separadores.decimal}${n.slice(-2)}`}desmascarar(e){let{grupo:t,decimal:n}=this.separadores,r=Number(e.split(t).join(``).replace(n,`.`));return Number.isFinite(r)?Math.abs(r):0}valorEmTexto(e){return e===0?``:this.localize.number(e,{minimumFractionDigits:2,maximumFractionDigits:2})}categoriaPorId(e){return this.categorias.find(t=>t.id===e)}partePorId(e){return e===void 0||e===0?void 0:this.partes.find(t=>t.id===e)}get partesOrdenadas(){return[...this.partes].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get categoriasOrdenadas(){return[...this.categorias].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get doMes(){return this.transacoes.filter(e=>e.vencimento!==0&&mv(e.vencimento)===this.mesCorrente)}static soma(e){return e.reduce((e,t)=>e+Number(t.valor),0)}corDa(e){let t=this.categoriaPorId(e.categoria);return t!==void 0&&t.cor!==``?t.cor:e.tipo===`receita`?`var(--kk-financeiro-receita)`:`var(--kk-financeiro-despesa)`}get anosComMovimento(){let e=new Set([new Date().getFullYear(),Number(this.mesCorrente.slice(0,4))]);for(let t of this.transacoes)t.vencimento!==0&&e.add(new Date(t.vencimento).getFullYear());return[...e].sort((e,t)=>t-e)}renderSaldo(){let e=this.transacoes.reduce((e,t)=>e+(t.tipo===`receita`?Number(t.valor):-Number(t.valor)),0);return w`
      <div class="saldo">
              ...
              <span class="limite__topo">
                ...
                <span class="limite__valores">
                  ...
                  ${e.limite===0?T:w`<small>
                        ${this.localize.term(`financeOfLimit`,this.oculto?dv:this.dinheiro(e.limite))}
                      </small>`}
                </span>
              </span>
    ...
    `}salvar(e,t){this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}),this.emit(`kk-save`,{detail:{especie:e,registro:t}})}renderFormTransacao(e){let t=t=>{this.formulario={especie:`transacao`,dados:{...e,...t}}};return w`
      <div class="formulario">
        ...
        ${this.renderAcoes(()=>this.salvar(`transacao`,{id:e.id,descricao:e.descricao.trim(),valor:this.desmascarar(e.valor),tipo:e.tipo,categoria:Number(e.categoria),vencimento:e.vencimento===``?Date.now():hv(e.vencimento),pago:e.pago,parte:Number(e.parte)}))}
      </div>
        ...
        ${e.map(e=>{let t=e.tipo===`receita`,n=this.categoriaPorId(e.categoria),r=this.partePorId(e.parte),i=this.corDa(e);return w`
            <div class="registro" data-status=${e.pago?`ok`:`pendente`}>
              ...
              <button
                ...
                type="button"
                @click=${()=>this.abrir({especie:`transacao`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,vencimento:pv(e.vencimento===0?Date.now():e.vencimento),pago:e.pago,parte:e.parte??0}})}
              >
      ...
      <div class="categorias">
        ${this.categoriasOrdenadas.map(e=>w`
            <div class="categoria">
              ...
              ${e.limite>0?w`
                    <span class="discreto">
                      ${this.localize.term(`financeLimitOf`,this.oculto?dv:this.dinheiro(e.limite))}
                    </span>
                  `:T}
              <kk-icon-button
                name="pencil"
        ...
        ${this.recorrencias.map(e=>{let t=e.tipo===`receita`;return w`
            <div class="registro" data-status=${e.ativa?`ok`:`pendente`}>
              ...
              <button
                class="registro__alvo"
                type="button"
                @click=${()=>this.abrir({especie:`recorrencia`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,periodicidade:e.periodicidade,diaMes:e.diaMes,diaSemana:e.diaSemana,gerarComoPago:e.gerarComoPago,ativa:e.ativa,erros:fv}})}
              >
                <span class="registro__topo">
                  <span class="registro__titulo">${e.descricao}</span>
                  <span class="registro__valor" data-tom=${e.tipo}>
    ...
    `}renderVista(){let e=this.formulario;return e===null?this.vista===`transacoes`?this.renderTransacoes():this.vista===`categorias`?this.renderCategorias():this.vista===`recorrencias`?this.renderRecorrencias():this.renderPainel():e.especie===`transacao`?this.renderFormTransacao(e.dados):e.especie===`categoria`?this.renderFormCategoria(e.dados):this.renderFormRecorrencia(e.dados)}render(){return w`<div part="base" class="financeiro">${this.renderVista()}</div>`}};Z=f(Ev),Dv=new WeakMap,Ov=new WeakMap,kv=new WeakMap,Av=new WeakMap,jv=new WeakMap,Mv=new WeakMap,Nv=new WeakMap,Pv=new WeakMap,Fv=new WeakMap,h(Z,4,`vista`,Tv,Iv,Dv),h(Z,4,`categorias`,wv,Iv,Ov),h(Z,4,`partes`,Cv,Iv,kv),h(Z,4,`transacoes`,Sv,Iv,Av),h(Z,4,`recorrencias`,xv,Iv,jv),h(Z,4,`mes`,bv,Iv,Mv),h(Z,4,`oculto`,yv,Iv,Nv),h(Z,4,`moeda`,vv,Iv,Pv),h(Z,4,`formulario`,_v,Iv,Fv),h(Z,1,`handleVistaChange`,gv,Iv),p(Z,Iv),g(Iv,`styles`,[D,Jh]),g(Iv,`dependencies`,{"kk-button":z,"kk-icon":Fs,"kk-icon-button":I,"kk-input":K,"kk-option":cv,"kk-select":Y,"kk-switch":Sg}),Iv.define(`kk-financeiro`),Fs.define(`kk-icon`),I.define(`kk-icon-button`),K.define(`kk-input`),zf.define(`kk-menu`),_p.define(`kk-menu-item`),cv.define(`kk-option`);var Lv=C`
  :host {
...
`,Rv=`important`,zv=` !`+Rv,Bv=yo(class extends bo{constructor(e){if(super(e),e.type!==vo.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(zv);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Rv:``):n[e]=r}}return Xa}}),Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv=class extends (Wv=M,Uv=[O({type:Number,reflect:!0})],Hv=[O({type:Boolean,reflect:!0})],Vv=[O()],Wv){constructor(){super(...arguments),g(this,`localize`,new aa(this)),_(this,Kv,m(Gv,8,this,0)),m(Gv,11,this),_(this,qv,m(Gv,12,this,!1)),m(Gv,15,this),_(this,Jv,m(Gv,16,this,``)),m(Gv,19,this)}render(){return w`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${Bv({width:`${this.value}%`})}>
          ${this.indeterminate?``:w` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};Gv=f(Wv),Kv=new WeakMap,qv=new WeakMap,Jv=new WeakMap,h(Gv,4,`value`,Uv,Yv,Kv),h(Gv,4,`indeterminate`,Hv,Yv,qv),h(Gv,4,`label`,Vv,Yv,Jv),p(Gv,Yv),g(Yv,`styles`,[D,Lv]),Yv.define(`kk-progress-bar`),Y.define(`kk-select`),Kc.define(`kk-spinner`),Sg.define(`kk-switch`);var Xv=C`
  :host {
    display: block;
  }
...
`,Zv,Qv,$v,ey,ty,ny,ry,iy,ay,oy,sy,cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Q,Ey,Dy,Oy,ky,Ay,jy,My,Ny,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy,$=class extends (Ty=M,wy=[A(`.textarea__control`)],Cy=[k()],Sy=[O()],xy=[O()],by=[O()],yy=[O({reflect:!0})],vy=[O({type:Boolean,reflect:!0})],_y=[O()],gy=[O({attribute:`help-text`})],hy=[O()],my=[O({type:Number})],py=[O()],fy=[O({type:Boolean,reflect:!0})],dy=[O({type:Boolean,reflect:!0})],uy=[O({reflect:!0})],ly=[O({type:Boolean,reflect:!0})],cy=[O({type:Number})],sy=[O({type:Number})],oy=[O()],ay=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],iy=[O()],ry=[O({type:Boolean})],ny=[O()],ty=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],ey=[O()],$v=[To()],Qv=[j(`disabled`,{waitUntilFirstUpdate:!0})],Zv=[j(`value`,{waitUntilFirstUpdate:!0})],Ty){constructor(){super(...arguments),m(Q,5,this),g(this,`formControlController`,new es(this,{assumeInteractionOn:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new uc(this,`help-text`,`label`)),_(this,Ey,m(Q,8,this)),m(Q,11,this),_(this,Dy,m(Q,12,this,!1)),m(Q,15,this),_(this,Oy,m(Q,16,this,``)),m(Q,19,this),_(this,ky,m(Q,20,this,``)),m(Q,23,this),_(this,Ay,m(Q,24,this,``)),m(Q,27,this),_(this,jy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,My,m(Q,32,this,!1)),m(Q,35,this),_(this,Ny,m(Q,36,this,``)),m(Q,39,this),_(this,Py,m(Q,40,this,``)),m(Q,43,this),_(this,Fy,m(Q,44,this,``)),m(Q,47,this),_(this,Iy,m(Q,48,this,4)),m(Q,51,this),_(this,Ly,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Ry,m(Q,56,this,!1)),m(Q,59,this),_(this,zy,m(Q,60,this,!1)),m(Q,63,this),_(this,By,m(Q,64,this,``)),m(Q,67,this),_(this,Vy,m(Q,68,this,!1)),m(Q,71,this),_(this,Hy,m(Q,72,this)),m(Q,75,this),_(this,Uy,m(Q,76,this)),m(Q,79,this),_(this,Wy,m(Q,80,this)),m(Q,83,this),_(this,Gy,m(Q,84,this,!0)),m(Q,87,this),_(this,Ky,m(Q,88,this)),m(Q,91,this),_(this,qy,m(Q,92,this)),m(Q,95,this),_(this,Jy,m(Q,96,this)),m(Q,99,this),_(this,Yy,m(Q,100,this,!0)),m(Q,103,this),_(this,Xy,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
      <div
        part="form-control"
        class=${E({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            <textarea
              ...
              placeholder=${N(this.placeholder)}
              rows=${N(this.rows)}
              style=${Bv({"--rows":String(this.rows)})}
              minlength=${N(this.minlength)}
              maxlength=${N(this.maxlength)}
              autocapitalize=${N(this.autocapitalize)}
              autocorrect=${this.autocorrect?`on`:`off`}
    ...
    `}};Q=f(Ty),Ey=new WeakMap,Dy=new WeakMap,Oy=new WeakMap,ky=new WeakMap,Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,Fy=new WeakMap,Iy=new WeakMap,Ly=new WeakMap,Ry=new WeakMap,zy=new WeakMap,By=new WeakMap,Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakMap,Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakMap,qy=new WeakMap,Jy=new WeakMap,Yy=new WeakMap,Xy=new WeakMap,h(Q,4,`input`,wy,$,Ey),h(Q,4,`hasFocus`,Cy,$,Dy),h(Q,4,`title`,Sy,$,Oy),h(Q,4,`name`,xy,$,ky),h(Q,4,`value`,by,$,Ay),h(Q,4,`size`,yy,$,jy),h(Q,4,`filled`,vy,$,My),h(Q,4,`label`,_y,$,Ny),h(Q,4,`helpText`,gy,$,Py),h(Q,4,`placeholder`,hy,$,Fy),h(Q,4,`rows`,my,$,Iy),h(Q,4,`resize`,py,$,Ly),h(Q,4,`disabled`,fy,$,Ry),h(Q,4,`readonly`,dy,$,zy),h(Q,4,`form`,uy,$,By),h(Q,4,`required`,ly,$,Vy),h(Q,4,`minlength`,cy,$,Hy),h(Q,4,`maxlength`,sy,$,Uy),h(Q,4,`autocapitalize`,oy,$,Wy),h(Q,4,`autocorrect`,ay,$,Gy),h(Q,4,`autocomplete`,iy,$,Ky),h(Q,4,`autofocus`,ry,$,qy),h(Q,4,`enterkeyhint`,ny,$,Jy),h(Q,4,`spellcheck`,ty,$,Yy),h(Q,4,`inputmode`,ey,$,Xy),h(Q,1,`handleDisabledChange`,Qv,$),h(Q,1,`handleValueChange`,Zv,$),h(Q,5,`defaultValue`,$v,$),p(Q,$),g($,`styles`,[D,Cp,Xv]),$.define(`kk-textarea`),te(`./ui`);var Zy=document.querySelector(`#app`);function Qy(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:ui({executar:()=>void sb(!0),ocupado:ib})};let t=Gt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Fr()};if($y[t.id]===void 0||!qt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Pr(t)};let n=rb.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Lr(n)};let r=eb.get(t.id);return r===void 0?(nb(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Ir()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var $y={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-DSGQHLnk.js`);return{telaAnotacoes:e}},__vite__mapDeps([20,5,3,4,21,22,23]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-Buh_cmVr.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-BaUadJim.js`);return{telaCalendario:e}},__vite__mapDeps([24,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-CMdAZO00.js`);return{telaCriacao:e}},__vite__mapDeps([25,4,22,21,26,27,28,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-CMdAZO00.js`);return{telaCriacao:e}},__vite__mapDeps([25,4,22,21,26,27,28,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-DoffDPBs.js`);return{telaFaq:e}},__vite__mapDeps([29,4,30,31,21,22,27]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-DlyrPYIj.js`);return{telaImite:e}},__vite__mapDeps([32,21,22,27]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-CF3JV733.js`);return{telaCronologia:e}},__vite__mapDeps([33,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-ClPpgTlt.js`);return{telaEstudo:e}},__vite__mapDeps([34,11,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-CBh5CbT9.js`);return{telaFinanceiro:e}},__vite__mapDeps([35,8,9,26,22,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-DKzPG67k.js`);return{telaGuias:e}},__vite__mapDeps([36,4,5,21,22,23,37,14]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-B1kSNRAF.js`);return{telaJogo:e}},__vite__mapDeps([38,4,21,22]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-BG-XnqHo.js`);return{telaLeitura:e}},__vite__mapDeps([39,40]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-HHYCCIfK.js`);return{telaMetas:e}},__vite__mapDeps([41,10,9,8,4,5]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-UpbdUaCy.js`);return{telaMinisterio:e}},__vite__mapDeps([42,37,12,4,5]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-EAYm-zcW.js`);return{telaPerfil:e}},__vite__mapDeps([43,4,37,19]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-CKZJM0VF.js`);return{telaPoesia:e}},__vite__mapDeps([44,4,5,31,21,22,23,37,14]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-DxKU-mTf.js`);return{telaPrep:e}},__vite__mapDeps([45,9,4,17,16,5,15]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-CVcJpgCH.js`);return{telaPrincipios:e}},__vite__mapDeps([46,4,30,31,21,22,27]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-CsxfOEMw.js`);return{telaReceitas:e}},__vite__mapDeps([47,5,31,21,22,23,37,14,13,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-DLyxYOlk.js`);return{telaServico:e}},__vite__mapDeps([48,10,9,8,4,5]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-TwiOrJwX.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-Dj_rWcQd.js`);return{telaTutorial:e}},__vite__mapDeps([49,4,21,22,50]),import.meta.url)).telaTutorial},eb=new Map,tb=new Set;function nb(e){let t=$y[e];t===void 0||eb.has(e)||tb.has(e)||(tb.add(e),t().then(t=>{eb.set(e,t),ab()}).catch(t=>{tb.delete(e),rb.set(e,String(t)),ab()}))}var rb=new Map,ib=!1;function ab(){if(Zy===null)return;let e=ob,{cabecalho:t,conteudo:n}=Qy(e);document.title=e.modulo===`home`?u.displayName:`${t.titulo} — ${u.displayName}`,wt(nr(t,n,ab),Zy),Qn()}var ob={modulo:`home`,args:[],query:new URLSearchParams};async function sb(e){if(!ib){ib=!0,ab();try{let t=await zn();if(!e)return;t.ok?Ki(x.home.sincronizado(t.atualizados.length)):Ki(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{ib=!1,ab()}}}function cb(){Zy!==null&&wt(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
    `,Zy)}function lb(e){Zy!==null&&wt(v`
      <div class="aviso">
        <kk-icon class="aviso__icone" name="alert-triangle"></kk-icon>
        <h2>${x.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
      </div>
    `,Zy)}function ub(e){switch(e){case`instancia-dupla`:return x.armazenamento.memoriaInstanciaDupla;case`indisponivel`:return x.armazenamento.memoriaIndisponivel;default:return x.armazenamento.memoriaOrigemInsegura}}async function db(){await zt(Lt()),cb(),Qt(ab);let e=await Ei(Zy);cb();try{let t=await o(e);t.persistente||Ki(ub(t.motivo),`warning`)}catch(e){lb(e instanceof s&&e.motivo===`segredo-nao-confere`?x.bloqueio.segredoNaoConfere:String(e));return}Zy?.removeAttribute(`aria-busy`),Xt(e=>{ob=e,ab(),scrollTo({top:0})}),on(),sb(!1),Tn(),Ii(ab),Ui()}window.__note={repositorio:r,apagarDados:Nn,navegacao:{MODULOS:Vt,ATALHOS:Bt,HOME:Ht},imite:{carregarCartoes:_r,lerLentes:yr},caderno:{listarAnotacoes:or},badge:{atualizar:Cn}},location.hash===``&&Yt(`home`),db();export{ln as $,Dr as A,ur as B,wr as C,xr as D,Nr as E,Cr as F,fr as G,mr as H,Sr as I,Un as J,hr as K,sr as L,jr as M,Ar as N,br as O,kr as P,gn as Q,rr as R,zr as S,Mr as T,or as U,cr as V,ir as W,hn as X,Nn as Y,_n as Z,vi as _,h as _t,O as a,Yt as at,_i as b,u as bt,w as c,x as ct,Hi as d,ct as dt,bn as et,Fi as f,v as ft,Ai as g,m as gt,ki as h,f as ht,A as i,$t as it,Er as j,yr as k,C as l,b as lt,Oi as m,p as mt,ph as n,dn as nt,M as o,Vt as ot,Pi as p,St as pt,lr as q,j as r,yn as rt,D as s,Gt as st,Bv as t,fn as tt,Ki as u,y as ut,yi as v,g as vt,_r as w,Rr as x,wi as y,_ as yt,pr as z};