    ...
    END;`,...r?[`CREATE VIRTUAL TABLE IF NOT EXISTS ${e}_vocab USING fts5vocab(${a}, row);`]:[],...i?[`CREATE INDEX IF NOT EXISTS idx_${e}_publicar ON ${e} (id) WHERE publicar = 1;`]:[]]}function L(e){return e.map(({tabela:e})=>{let t=F(e);return`INSERT INTO ${t} (${t}) VALUES ('rebuild');`})}P.map(({tabela:e})=>`SELECT '${e}' AS acervo, term, doc, cnt FROM ${e}_vocab`).join(` UNION ALL `),P.flatMap(e=>I(e,{vocabulario:!0,indiceDePublicar:!0})),L(P),Math.max(...[{versao:1,nome:`esquemaBase`,oQue:`o esquema canônico inteiro, com as sementes, o Tutorial e o catálogo de fábrica`},{versao:2,nome:`ordemNoAno`,oQue:"a coluna `ordem_no_ano` da Cronologia, que o `ordem_absoluta` não sabe dar"},{versao:3,nome:`cartoesImite`,oQue:`a tabela e o acervo de "Imite a Sua Fé"`},{versao:4,nome:`principiosBiblicos`,oQue:`a tabela e o acervo dos Princípios Bíblicos`},{versao:5,nome:`aplicarBusca`,oQue:"a FTS5 dos sete acervos, os gatilhos e o `rebuild`"},{versao:6,nome:`umaFonteDeVersao`,oQue:"a `_migracoes` do migrador legado sai: `bioma_esquema` fica como única"},{versao:7,nome:`limiteEmCentavos`,oQue:"o `limite_mensal` da categoria vira centavo em `INTEGER`, como o dinheiro do Kobi Note"},{versao:8,nome:`bancada`,oQue:`a bancada: toda tabela do Kobi Note e do Kobi Flow passa a existir também no admin`},{versao:9,nome:`perguntasFrequentes`,oQue:`a tabela de "Perguntas Frequentes" e o tópico do Tutorial`},{versao:10,nome:`perguntasComLentes`,oQue:`"Perguntas Frequentes" vira exercício de lentes: a tabela é refeita e o acervo velho sai`}].map(e=>e.versao)),te(`nucleo`);function R(e,t,n,r,i){return{id:e,modulo_id:t,titulo:n,resumo:r,conteudo:i.map(e=>`<p>${e}</p>`).join(``),ordem:e,publicar:1}}R(1,``,`Visão geral`,`O que é o Kobi Note e como ele guarda suas coisas`,[`O Kobi Note é um aplicativo <strong>do seu aparelho</strong>. Tudo o que você escreve — anotações, metas, finanças, relatórios — fica gravado localmente e não é enviado a servidor nenhum.`,`A tela inicial é o mapa do app: cada tile abre um módulo direto, e os tiles são agrupados em seções (Estudo Pessoal, Esteja Preparado, Extras, Pessoal, O Aplicativo). Não há tela intermediária. O botão de voltar do cabeçalho sempre sobe um nível.`,`Logo abaixo da agenda de hoje vem a <strong>faixa de números</strong> do mês: leitura, horas, estudo e metas. O cartão de metas é um botão — ele mostra as atingidas sobre o total e abre as Metas.`,`O botão de sincronizar, na tela inicial, baixa o <strong>conteúdo curado</strong> (guias, poesias, receitas, perguntas do jogo). Ele nunca apaga o que é seu, e o app funciona sem rede: sincronizar só atualiza o acervo.`,`Em cada módulo, o botão “?” do cabeçalho abre exatamente o tópico daquele módulo aqui no tutorial.`]),R(2,`anotacoes`,`Anotações`,`Escrever, organizar em pastas e apresentar`,[`Serve para tudo que você escreve: reuniões, discursos, visitas, estudos. Toque em <strong>+</strong> e escolha um modelo — ele já entra com os títulos prontos.`,`A gravação é automática: o texto é salvo pouco depois de você parar de digitar, e o rodapé do editor mostra a hora do último salvamento. Sem título, nada é gravado.`,`Dicas: <strong>fixe</strong> a anotação que você abre toda semana; <strong>arquive</strong> em vez de excluir o que já passou; e use o modo <strong>apresentar</strong> para ler no palco — o texto rola sozinho e a velocidade é ajustável.`]),R(3,`guias`,`Guias`,`Ler os guias do acervo e escrever os seus`,[`Os guias são explicações prontas, que vêm no acervo curado. A lista mistura os do acervo com os seus; os seus aparecem com a marca <em>Minha</em>.`,`No guia aberto você pode ouvir em voz alta, apresentar com rolagem automática ou compartilhar o texto. Editar e excluir só valem para os seus.`,`Dica: toque em <strong>+</strong> para escrever um guia próprio — ele fica no aparelho e nunca é substituído por uma sincronização.`]),R(4,`poesia`,`Poesia`,`Ler o acervo, favoritar e escrever`,[`O acervo de poesias é curado; as suas entram pelo <strong>+</strong> e ficam misturadas na mesma lista, com a marca <em>Minha</em>.`,`Na leitura há navegação sequencial (anterior/próxima) pelo acervo, barra de progresso, leitura em voz alta e modo apresentação.`,`Dica: a <strong>estrela</strong> marca favoritos, e favoritos sobem para o topo da lista. O botão de informação, na lista, explica o propósito das obras.`]),R(5,`receitas`,`Receitas`,`Buscar por categoria e guardar as suas`,[`A lista traz o acervo curado e as suas receitas. Os chips de emoji filtram por categoria — toque de novo no chip aceso para ver todas.`,`Ingredientes e modo de preparo são campos de <strong>linhas</strong>: um item por linha. É o formato que fica legível na leitura e na hora de ouvir em voz alta.`,`Dica: aqui você pode editar até as receitas do acervo — a sua versão fica no aparelho.`]),R(6,`jogo`,`Língua Pura`,`Praticar com as perguntas do acervo`,[`É um jogo de perguntas para fixar o que você estuda. As perguntas vêm do acervo curado e aumentam a cada sincronização.`,`Dica: erre sem medo — a explicação de cada resposta é a parte que ensina.`]),R(7,`criacao`,`Teve um Projeto?`,`Puzzles sobre o projeto na natureza`,[`Cada módulo apresenta um ser vivo e o que a engenharia aprendeu dele. Você mexe nos controles do gráfico e vê o efeito na hora.`,`Dica: a ilustração de cada módulo ensina o que o puzzle não mostra — a conta, o mecanismo, o contexto. Vale abrir.`]),R(8,`entenda`,`Entenda Melhor`,`Assuntos explicados com gráficos`,[`Assuntos que rendem mais quando visualizados: escalas, medições, cronologias. Os controles ficam dentro do próprio gráfico, e os textos mudam conforme você mexe.`,`Dica: as referências ficam no fim de cada assunto — vale conferir a fonte.`]),R(9,`cronologia`,`Cronologia`,`A linha do tempo dos períodos bíblicos`,[`A linha do tempo vai da criação aos nossos dias. Toque num período para posicionar a linha nele e ver os eventos daquele trecho.`,`Dica: use junto do Caderno de Estudo — datar o que você lê ajuda a fixar.`]),R(10,`caderno`,`Caderno de Estudo`,`Perguntas e respostas do seu estudo`,[`Um caderno para as suas perguntas e o que você descobriu sobre cada uma. Diferente das Anotações, aqui o formato é pergunta e resposta.`,`Dica: registre a pergunta assim que ela aparecer, mesmo sem resposta. A lista de perguntas abertas é o seu roteiro de estudo.`]),R(11,`prep`,`Esteja Preparado`,`Kits, estoque e documentos`,[`O preparo para emergências: listas de verificação (kits), estoque de alimentos com validade e um cofre de documentos. Os três abrem de tiles próprios, na seção "Esteja Preparado" da tela inicial, que começa com o índice de prontidão.`,`O cofre guarda os documentos <strong>cifrados</strong> no próprio aparelho, com a sua senha. Sem a senha ninguém abre — nem o app.`,`Dica: comece pelo kit sugerido e marque o que já tem; o indicador de prontidão mostra o quanto falta.`]),R(12,`financeiro`,`Financeiro`,`Entradas, saídas e recorrências`,[`Lançamentos de entrada e saída por categoria, com recorrências para o que repete todo mês.`,`Dica: crie as categorias que você realmente usa e apague as que não usa — relatório com categoria vazia não informa nada.`]),R(13,`metas`,`Metas`,`Objetivos com progresso`,[`Metas com prazo e progresso. Elas não têm tile próprio: quem as abre é o cartão de metas da faixa de números da tela inicial, o que mostra as atingidas sobre o total.`,`Dica: meta boa é a que caber num número — horas, capítulos, visitas. O progresso se calcula sozinho a partir dele.`]),R(14,`ministerio`,`Vida e Ministério`,`Relatório do mês e contadores`,[`Os contadores do mês e o relatório. Os contadores somam durante o dia, e o relatório fecha o mês com o total. Os atalhos da tela abrem os relatórios, os estudos e o "Fazer Mais".`,`Dica: registre no fim de cada saída, não no fim do mês — é a diferença entre um número exato e um número lembrado.`]),R(15,`estudo`,`Momento de Estudo`,`Sessões de estudo com tempo`,[`Marca sessões de estudo com duração, para você ver quanto tempo dedicou e a quê.`,`Dica: uma sessão curta registrada vale mais que uma longa esquecida.`]),R(16,`leitura`,`Leitura da Bíblia`,`Acompanhar a leitura por livro`,[`Acompanha a leitura livro por livro, marcando o que já foi lido.`,`Dica: o progresso é por capítulo — marcar assim que terminar mantém o histórico honesto.`]),R(17,`calendario`,`Calendário`,`Eventos por tipo`,[`Eventos coloridos por tipo (reunião, compromisso, consulta, pessoal), em cinco vistas: dia, semana, mês, ano e agenda.`,`Os três cartões do topo falam do período que está na tela: as <strong>horas</strong> somadas, os <strong>conflitos</strong> (eventos com hora marcada que se sobrepõem) e os dias até o <strong>próximo especial</strong> — este contado de hoje, e não do período.`,`Dica: os tipos padrão já vêm criados; você pode criar os seus e reaproveitar em cada evento. É no cadastro de tipos que se marca qual deles é <em>especial</em>.`]),R(18,`perfil`,`Perfil / ICE`,`Seus dados e o cartão de emergência`,[`Guarda os seus dados, incluindo as informações de emergência (ICE) e a recusa de sangue. Na seção de diretrizes há a data em que o cartão DPA físico foi atualizado e assinado — é dela que sai o aviso de renovação, um ano depois.`,`Dica: preencha os contatos de emergência mesmo que pareça improvável precisar — é a tela que outra pessoa vai abrir no seu lugar.`]),R(19,`tutorial`,`Tutorial`,`Este próprio guia`,[`Este módulo. A lista tem um tópico por módulo, e cada módulo tem um botão “?” que abre o tópico dele direto.`,`O conteúdo é curado: ele melhora a cada sincronização, sem precisar atualizar o app.`]),R(20,`imite`,`Imite a Sua Fé`,`Enxergar a boa intenção por trás do atrito`,[`Cada cartão traz um atrito comum da convivência e o julgamento apressado que ele provoca. Você escolhe entre três <strong>lentes</strong> qual explica melhor a intenção do outro.`,`Errar não custa nada: cada lente errada tem uma resposta própria, e é ali que está o ensino. Depois de acertar, aparecem o princípio bíblico, os textos e a galeria de quem mais fez aquilo na Bíblia.`,`Dica: a última parte de cada cartão é o <strong>Reflexo no Espelho</strong> — uma pergunta sobre você. O que você escreve ali vai para o Caderno de Estudo, e reler essas respostas meses depois vale mais do que o cartão em si.`]),R(21,`principios`,`Princípios Bíblicos`,`O que a Bíblia diz sobre as decisões do dia a dia`,[`É a parte de <strong>consulta</strong> do app: cada princípio traz a frase que o resume, os textos que o sustentam, por que ele existe e como ele se parece num dia comum. Não há exercício, não há acerto e não há erro — quem abre este módulo já sabe o que veio procurar.`,`A lista é filtrada por <strong>área da vida</strong> (família, trabalho, dinheiro, o que sai da boca...) e pela busca, que varre o título, a frase e os textos citados. A estrela guarda o princípio na faixa de favoritos, no alto da lista.`,`Dica: o fim de cada princípio traz perguntas de reflexão. O que você escreve ali vai para o Caderno de Estudo, junto com o que você escreveu no “Imite a Sua Fé” — é o mesmo caderno.`]),R(22,`faq`,`Perguntas Frequentes`,`Treine a responder o que perguntam a você`,[`Não é um repositório de respostas prontas: é <strong>treino</strong>. Cada pergunta abre com a cena em que ela aparece — na porta, no trabalho, na mesa de domingo — e com a resposta que vem primeiro à cabeça, aquela que geralmente encerra a conversa em vez de abri-la.`,`Depois você escolhe entre <strong>lentes</strong>: os ângulos por onde dá para responder. Errar não custa nada — é nas lentes que não servem que está o ensino, e você pode tentar de novo. Acertando, aparecem a resposta pela Bíblia, os textos que a sustentam, quem na Bíblia respondeu assim e o link do artigo no jw.org, para ler o assunto na fonte.`,`A lista é filtrada por <strong>categoria</strong> (crenças, organização, pregação, vida familiar...) e pela busca. A estrela guarda a pergunta na faixa de favoritos, e a barra do alto mostra quantas você já fez.`,`Dica: o fim de cada pergunta pede a sua resposta, com as suas palavras. O que você escreve ali vai para o Caderno de Estudo — o mesmo do “Imite a Sua Fé” e dos “Princípios Bíblicos” —, e é o que dá o selo da pergunta.`]);const z=[{tabela:`not_guias`,colunas:[`titulo`,`texto`]},{tabela:`not_guias_local`,colunas:[`titulo`,`texto`]},{tabela:`not_poesias`,colunas:[`titulo`,`conteudo`]},{tabela:`not_poesias_local`,colunas:[`titulo`,`conteudo`]},{tabela:`not_receitas`,colunas:[`titulo`,`categoria`]},{tabela:`not_receitas_local`,colunas:[`titulo`,`categoria`]},{tabela:`not_cronologia`,colunas:[`titulo`,`resumo`,`referencia`]},{tabela:`not_principios`,colunas:[`titulo`,`principio`,`referencia`]},{tabela:`not_faq`,colunas:[`titulo`,`referencia`]}],Ee=z.flatMap(e=>I(e)),De=L(z);function Oe(e){return`busca:${e}`}const ke={...Object.fromEntries(z.map(({tabela:e})=>{let t=F(e);return[Oe(e),`SELECT rowid AS id, bm25(${t}) AS relevancia
     ...
     ORDER BY relevancia
        LIMIT 200`]})),metasFontes:`SELECT * FROM vw_note_metas_fontes`,despesaPorCategoria:`SELECT categoria_id, total FROM vw_note_despesa_por_categoria`,categoriasEmOrdem:`SELECT * FROM vw_note_categorias_financeiro`,eventosDoDia:`SELECT count(*) AS total
                  ...
                  WHERE data_inicio_epoch <= ? AND data_fim_epoch >= ?`};function Ae(e){let t=ke[e];if(t===void 0)throw Error(`consulta desconhecida: ${e} (ver src/db/consultas.ts)`);return t}const je={perguntas:{tabela:`not_perguntas`,familia:`curado`},poesias:{tabela:`not_poesias`,familia:`curado`,apelidos:{anteriorId:`anterior_id`,proximoId:`proximo_id`}},receitas:{tabela:`not_receitas`,familia:`curado`},guias:{tabela:`not_guias`,familia:`curado`},kits:{tabela:`not_kits`,familia:`curado`,filhos:[{campo:`itens`,tabela:`not_kits_itens`,chave:`kit_id`}]},criacao_modulos:{tabela:`not_criacao_modulos`,familia:`curado`},imite_cartoes:{tabela:`not_imite_cartoes`,familia:`curado`},principios:{tabela:`not_principios`,familia:`curado`},faq:{tabela:`not_faq`,familia:`curado`},cronologia:{tabela:`not_cronologia`,familia:`curado`},anotacao_modelos:{tabela:`not_anotacao_modelos`,familia:`curado`},estoque_catalogo:{tabela:`not_estoque_catalogo`,familia:`curado`},tutorial:{tabela:`not_tutorial`,familia:`curado`},pasta:{tabela:`not_pasta`,familia:`privado`},anotacao:{tabela:`not_anotacao`,familia:`privado`},not_caderno_estudo:{tabela:`not_caderno_estudo`,familia:`privado`},sessoes_estudo:{tabela:`not_sessoes_estudo`,familia:`privado`},categorias_financeiro:{tabela:`not_categorias_financeiro`,familia:`privado`},transacoes:{tabela:`not_transacoes`,familia:`privado`},recorrencias_financeiro:{tabela:`not_recorrencias_financeiro`,familia:`privado`},meta:{tabela:`not_meta`,familia:`privado`},kits_local:{tabela:`not_kits_local`,familia:`privado`,filhos:[{campo:`itens`,tabela:`not_kits_local_itens`,chave:`kit_id`}]},documentos_cofre:{tabela:`not_documentos_cofre`,familia:`privado`},estoque_alimentos:{tabela:`not_estoque_alimentos`,familia:`privado`},relatorios_ministerio:{tabela:`not_relatorios_ministerio`,familia:`privado`},contadores_ministerio:{tabela:`not_contadores_ministerio`,familia:`privado`},estudos_biblicos:{tabela:`not_estudos_biblicos`,familia:`privado`},estudo_registros:{tabela:`not_estudo_registros`,familia:`privado`},meu_perfil:{tabela:`not_meu_perfil`,familia:`privado`},calendario_tipos:{tabela:`not_calendario_tipos`,familia:`privado`},calendario_eventos:{tabela:`not_calendario_eventos`,familia:`privado`},poesias_local:{tabela:`not_poesias_local`,familia:`privado`},guias_local:{tabela:`not_guias_local`,familia:`privado`},receitas_local:{tabela:`not_receitas_local`,familia:`privado`}};let B;function V(){if(B===void 0)throw Error(`o repositório ainda não foi montado`);return B}function Me(e){B=new fe(e,je),B.lerEsquemaAplicado()}function H(){return V().tabelas()}function Ne(e,t,n){let r=S(t,V().colunasDa(t),n);e.executar(r.sql,r.parametros)}function Pe(e,t,n,r){switch(t.op){case`otimizar`:return n&&(e.executar(`PRAGMA optimize`),e.executar(`PRAGMA incremental_vacuum(64)`)),n;case`pronto`:return n;case`todos`:return V().todos(t.store);case`consulta`:return e.consultar(Ae(t.nome),[...t.parametros??[]]);case`obter`:return V().obter(t.store,t.id);case`contar`:return V().contar(t.store);case`salvar`:{let e=V().salvar(t.store,t.registro);return r(),e}case`excluir`:return V().excluir(t.store,t.id),r(),null;case`substituirTudo`:return V().substituirTudo(t.store,t.registros),r(),null}}function Fe(e){let t=e.consultar(`PRAGMA table_info(not_faq)`).map(e=>String(e.name));t.length===0||t.includes(`lentes`)||e.emTransacao(()=>{e.executar(`DROP TABLE IF EXISTS not_faq_fts`),e.executar(`DROP TABLE not_faq`)})}function Ie(e){if(Number(e.escalar(`SELECT COUNT(*) FROM sqlite_schema WHERE type = 'table' AND name = 'not_dados'`)??0)===0){U(e);return}let t=new Set;V().emTransacao(()=>{for(let n of V().stores()){let r=e.consultar(`SELECT dados FROM not_dados WHERE tabela = ? ORDER BY id`,[n]);for(let e of r){let r;try{r=JSON.parse(String(e.dados))}catch{t.add(`${n} (JSON ilegível)`);continue}V().salvar(n,r)}e.executar(`DELETE FROM not_dados WHERE tabela = ?`,[n])}for(let n of e.consultar(`SELECT DISTINCT tabela FROM not_dados`))t.add(String(n.tabela));t.size===0&&(e.executar(`DROP TABLE IF EXISTS not_dados`),e.executar(`DROP TABLE IF EXISTS not_seq`)),U(e)}),t.size>0&&console.warn(`migração da Fase 8: store(s) sem destino, mantidos em \`not_dados\`: ${[...t].join(`, `)}. A tabela antiga não foi apagada.`)}function U(e){e.executar(`INSERT INTO not_meta_banco (chave, valor) VALUES (?, ?) ON CONFLICT(chave) DO NOTHING`,[`esquema_em_colunas`,`1`])}const W=`note.sqlite`,G=`dump`;let K,q=!1,J;function Y(){if(K===void 0)throw Error(`banco ainda não abriu`);return K}let X;function Z(){return X??=new Promise((e,t)=>{let n=indexedDB.open(`note_fallback`,1);n.onupgradeneeded=()=>n.result.createObjectStore(`kv`),n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error??Error(`IndexedDB não abriu`))}),X}async function Le(e){let t=await Z();return new Promise((n,r)=>{let i=t.transaction(`kv`,`readonly`).objectStore(`kv`).get(e);i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error??Error(`leitura do IndexedDB falhou`))})}async function Re(e,t){let n=await Z();return new Promise((r,i)=>{let a=n.transaction(`kv`,`readwrite`);a.objectStore(`kv`).put(t,e),a.oncomplete=()=>r(),a.onerror=()=>i(a.error??Error(`gravação no IndexedDB falhou`))})}async function ze(){return await Le(G)}async function Be(e){return Re(G,e)}function Ve(e){if(e===void 0||(e.tamanhoDe(e.caminhoDoBanco)??0)===0)return null;let t=e.abrir(e.caminhoDoBanco,{criar:!1,truncar:!1,exclusivo:!1});if(t===null)return null;let n=new Uint8Array(16);return t.ler(n,0),n}async function He(){let e;try{e=await ze()}catch{return}if(e===void 0||e.versao!==2)return;let t=new Set(H());Y().emTransacao(()=>{for(let[n,r]of Object.entries(e.tabelas))if(t.has(n))for(let e of r)Ne(Y(),n,e)})}let Q;function Ue(){q||Q!==void 0||(Q=setTimeout(()=>{Q=void 0;let e={};for(let t of H())e[t]=Y().consultar(`SELECT * FROM ${y(t)}`);Be({versao:2,tabelas:e}).catch(e=>{console.warn(`persistência de fallback falhou`,e)})},200))}function We(e){return self.isSecureContext?e instanceof DOMException&&e.name===`NoModificationAllowedError`?`instancia-dupla`:`indisponivel`:`origem-insegura`}function Ge(){let e=Y().escalar(`SELECT count(*) FROM sqlite_master WHERE name = 'sqlite_stat1'`);Number(e??0)===0&&Y().executar(`ANALYZE`)}function Ke(){Y().executarRoteiro(oe(`note`).join(`
`)),Y().executar(se)}function qe(){if(Y().executarRoteiro(Ee.join(`
`)),!(Y().consultar(`SELECT valor FROM not_meta_banco WHERE chave = ?`,[`busca_construida`]).length>0)){for(let e of De)Y().executar(e);Y().executar(`INSERT INTO not_meta_banco (chave, valor) VALUES (?, ?) ON CONFLICT(chave) DO NOTHING`,[`busca_construida`,`1`])}}async function Je(){let e;try{e=await Te.preparar({pasta:`note-opfs`,banco:W}),q=!0}catch(e){J=We(e),console.warn(`OPFS indisponível (${J}); Bioma SQL em memória com despejo no IndexedDB.`,e)}let t=Ve(e),n=e===void 0?`sem-arquivo`:le(t),r=e===void 0?void 0:await de(Le,Re);K=await be({modulo:fetch(Ce),caminho:e?.caminhoDoBanco??`/${W}`,...e===void 0?{}:{arquivos:e},...r===void 0||n===`em-claro`?{}:{chave:r}}),n===`em-claro`&&r!==void 0&&(console.info(`Kobi Note: cifrando o banco deste aparelho pela primeira vez.`),Y().rechavear(r)),Y().executar(`PRAGMA auto_vacuum = INCREMENTAL`),Fe(Y()),Y().executarRoteiro(ee(`note`).join(`;
`)),Me(Y()),Ie(Y()),q||await He(),qe(),Ke(),Ge();let i={tipo:`pronto`,versaoSqlite:Y().versao,persistente:q,...J===void 0?{}:{motivo:J}};self.postMessage(i)}const $=Je();self.addEventListener(`message`,e=>{let t=e.data;$.then(()=>{let e={seq:t.seq,ok:!0,valor:Pe(Y(),t.operacao,q,Ue)};self.postMessage(e)}).catch(e=>{let n={seq:t.seq,ok:!1,erro:String(e)};self.postMessage(n)})}),$.catch(e=>{let t={tipo:`falha`,erro:String(e)};self.postMessage(t)});