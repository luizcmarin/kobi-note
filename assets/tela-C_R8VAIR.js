import{$ as e,Q as t,at as n,nt as r,p as i,rt as a,u as o}from"./index-BIyMCMf-.js";import{ALVOS_MIN as s,TIPOS as c,emojiDoTipo as l,excluirSessao as u,horasEMinutos as d,listarSessoes as f,ordenar as p,perolaComoAnotacao as m,perolaNoCaderno as h,relogio as g,rotuloDoTipo as _,salvarSessao as v,totalDeMinutos as y}from"./dados-BxxZFxhq.js";var b=90,x=2*Math.PI*b,S=`inicio`,C=`pessoal`,w=``,T=30,E=!1,D=0,O=0,k=0,A,j=``,M=null,N=!1,P=!1,F=[],I=!1,L=!1;async function R(){F=await f(),t()}function z(){I||L||(L=!0,(async()=>{try{await R(),I=!0}finally{L=!1,t()}})())}function B(){E=!0,k=Date.now(),clearInterval(A),A=setInterval(()=>{D=O+Math.floor((Date.now()-k)/1e3),t()},250),t()}function V(){E&&(O+=Math.floor((Date.now()-k)/1e3),D=O,E=!1,clearInterval(A),A=void 0,t())}function H(){let e=T*60;return e<=0?0:Math.min(1,D/e)}function U(){return Math.max(0,Math.round(D/60))}function W(){S=`oracao`,t()}function G(){D=0,O=0,j=``,M=null,N=!1,P=!1,S=`cronometro`,B()}function K(){V(),S=`perola`,t()}async function q(){let e={...M?.id===void 0?{}:{id:M.id},assunto:w===``?r.estudo.semAssunto:w,tipo_ciclo:C,duracao_minutos:U(),concluido_em:Date.now(),nota_meditacao:j,anotacao_criada:+!!N},t=await v(e);return M={...e,id:t},await R(),M}async function J(){M===null&&await q(),w=``,S=`inicio`,e(`estudo/historico`)}function Y(){clearInterval(A),A=void 0,E=!1,w=``,D=0,O=0,S=`inicio`,t()}function X(){return n`
