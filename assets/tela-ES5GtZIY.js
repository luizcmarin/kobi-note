      ...
      <div class="crono__cartao">
        ...
        ${t?i`
              <div class="crono__detalhe">
                ${e.resumo===``?o:i`<p>${e.resumo}</p>`}
                ${e.referencia===``?o:i`<p class="crono__referencia">${e.referencia}</p>`}
                ${e.link_fonte===``?o:i`
