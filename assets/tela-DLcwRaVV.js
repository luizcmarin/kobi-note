import{E as e,S as t,T as n,b as r,ct as i,et as a,h as o,it as s,ot as c,u as l}from"./index-EsbOy3qu.js";import{CORES as u,ICONES as d,ULTIMO_MINUTO as f,agendaDosDias as p,carregar as ee,comoHora as m,corDoTipo as h,deHora as g,diaFinal as te,diaInicial as ne,excluirEvento as re,excluirTipo as _,iconeDoTipo as ie,proximaOrdem as ae,salvarEvento as oe,salvarTipo as se,tipoEmUso as ce,tipoPadrao as v,tipoPorId as y}from"./dados-DeTaREhN.js";var le=[`dia`,`semana`,`mes`,`ano`,`agenda`],b=[`Seg`,`Ter`,`Qua`,`Qui`,`Sex`,`Sáb`,`Dom`];function x(e){let t=new Date(e);return t.setHours(0,0,0,0),t}function S(e,t){let n=x(e);return n.setDate(n.getDate()+t),n}function C(e){return S(e,-((e.getDay()+6)%7))}function w(e,t){if(e===`dia`){let e=r(t);return{de:e,ate:e}}if(e===`semana`||e===`agenda`){let e=C(t);return{de:r(e),ate:r(S(e,6))}}if(e===`mes`){let e=new Date(t.getFullYear(),t.getMonth(),1),n=new Date(t.getFullYear(),t.getMonth()+1,0);return{de:r(e),ate:r(n)}}let n=new Date(t.getFullYear(),0,1),i=new Date(t.getFullYear(),11,31);return{de:r(n),ate:r(i)}}function T(e,t,n){let r=x(t);return e===`dia`?r.setDate(r.getDate()+n):e===`semana`||e===`agenda`?r.setDate(r.getDate()+n*7):e===`mes`?r.setMonth(r.getMonth()+n,1):r.setFullYear(r.getFullYear()+n,0,1),r}function E(e,t){if(e===`dia`)return t.toLocaleDateString(`pt-BR`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`});if(e===`semana`||e===`agenda`){let e=C(t),n=S(e,6),r={day:`numeric`,month:`short`};return`${e.toLocaleDateString(`pt-BR`,r)} – ${n.toLocaleDateString(`pt-BR`,r)} de ${n.getFullYear()}`}return e===`mes`?t.toLocaleDateString(`pt-BR`,{month:`long`,year:`numeric`}):String(t.getFullYear())}function D(e,t){let n=C(new Date(e,t,1)),i=S(C(new Date(e,t+1,0)),6),a=[];for(let e=n;e<=i;e=S(e,1))a.push({dia:r(e),numero:e.getDate(),doMes:e.getMonth()===t});return a}function ue(e){let t=C(e);return Array.from({length:7},(e,n)=>{let i=S(t,n);return{dia:r(i),rotulo:b[n]??``,numero:i.getDate()}})}function de(){return Array.from({length:17},(e,t)=>6+t)}function fe(e){return Array.from({length:12},(t,n)=>({mes:n,rotulo:new Date(e,n,1).toLocaleDateString(`pt-BR`,{month:`long`}),celulas:D(e,n)}))}function pe(e){let t=[],[n=1970,i=1,a=1]=e.de.split(`-`).map(Number);for(let o=new Date(n,i-1,a);;o=S(o,1)){let n=r(o);if(n>e.ate)break;t.push(n)}return t}function me(e){let[t=1970,n=1,r=1]=e.split(`-`).map(Number);return new Date(t,n-1,r).toLocaleDateString(`pt-BR`,{weekday:`long`,day:`numeric`,month:`long`})}var he=15;function ge(e,t){let n=Math.min(Math.max(e,360),1365);return{de:n,ate:Math.min(Math.max(t,n+he),1380)}}function O(e=new Date){let t=e.getHours()*60+e.getMinutes();return t<360||t>1380?null:(t-360)/1020}function _e(e){let t=e.map(e=>ge(e.inicioMin,e.fimMin)),n=1020,r=t.map((e,t)=>({...e,indice:t})).sort((e,t)=>e.de-t.de||e.ate-t.ate||e.indice-t.indice),i=Array(e.length).fill(0),a=Array(e.length).fill(1),o=[],s=[],c=-1/0,l=()=>{for(let e of o)a[e]=s.length;o=[],s=[],c=-1/0};for(let e of r){e.de>=c&&l();let t=s.findIndex(t=>t<=e.de);t===-1?t=s.push(e.ate)-1:s[t]=e.ate,i[e.indice]=t,o.push(e.indice),c=Math.max(c,e.ate)}return l(),t.map((e,t)=>({topo:(e.de-360)/n,altura:(e.ate-e.de)/n,coluna:i[t]??0,colunas:a[t]??1}))}var k=[],A=[],j=`semana`,M=new Date,N=null,P=!1,F=null,I=!1,L=!1,R=null;async function z(){let e=await ee();k=e.tipos,A=e.eventos,R=null,a()}function B(){I||L||R!==null||(L=!0,(async()=>{try{await z(),I=!0}catch(t){console.error(`Calendário: a carga falhou.`,t),R=e(t)}finally{L=!1,a()}})())}function ve(){R=null,B(),a()}var V=5;function ye(){let e=new Date().getFullYear(),t=new Set;for(let n=e-V;n<=e+V;n+=1)t.add(n);return t.add(M.getFullYear()),[...t].sort((e,t)=>e-t)}function H(e,t){M=new Date(e,t,1),a()}function be(){return i`
    ...
    <div class="calendario__salto">
      ...
      >
        ${s.calendario.meses.map((e,t)=>i`<kk-option value=${t}>${e}</kk-option>`)}
      </kk-select>
  ...
  `}function U(e){N={id:e.id??0,titulo:e.titulo,tipoId:e.tipo_id,diaInteiro:e.dia_inteiro===1,dataInicio:ne(e),horaInicio:m(e.hora_inicio_min),dataFim:te(e),horaFim:m(e.hora_fim_min),descricao:e.descricao},a()}function W(e){return e.dia_inteiro===1?`${s.calendario.diaInteiro} — ${e.titulo}`:`${m(e.hora_inicio_min)} – ${m(e.hora_fim_min)} — ${e.titulo}`}function G(e){let t=h(k,e.tipo_id);return i`
    <button
      class="pastilha"
      style=${`--cor-evento:${t}`}
      title=${W(e)}
      @click=${()=>U(e)}
    >
      ${e.dia_inteiro===1?c:i`<span class="pastilha__hora">${m(e.hora_inicio_min)}</span>`}
  ...
  `}function xe(e){let t=h(k,e.tipo_id),n=y(k,e.tipo_id);return i`
    <button class="evento" style=${`--cor-evento:${t}`} @click=${()=>U(e)}>
      ...
      ${n===void 0?c:i`<span class="evento__tipo">${n.nome}</span>`}
      ${e.descricao===``?c:i`<span class="evento__descricao">${e.descricao}</span>`}
    </button>
    ...
    <div class="grade" style=${`--colunas:${e.length}`}>
      ...
      ${e.map(e=>{let r=a.get(e.dia)??[],l=r.filter(e=>e.dia_inteiro===1),u=r.filter(e=>e.dia_inteiro===0),d=_e(u.map(e=>({inicioMin:e.hora_inicio_min,fimMin:e.hora_fim_min})));return i`
          <div class="grade__coluna">
            ${o===null||e.dia!==n?c:i`<span class="grade__agora" style=${`top:${o*100}%`}></span>`}
            ...
            ${u.map((e,t)=>{let n=d[t];if(n===void 0)return c;let r=100/n.colunas;return i`
                <button
                  class="grade__evento"
  ...
  `}function De(){return Y([{dia:r(M),rotulo:M.toLocaleDateString(`pt-BR`,{weekday:`short`}),numero:M.getDate()}])}function Oe(){return Y(ue(M))}function ke(){let e=r(),n=fe(M.getFullYear()),o=p(A,n.flatMap(e=>e.celulas.map(e=>e.dia)));return i`
    <div class="ano">
      ${n.map(n=>i`
          <div class="ano__mes">
            <button
            ...
            <div class="ano__grade">
              ...
              ${n.celulas.map(n=>{let r=(o.get(n.dia)??[]).length;return i`
                  <button
                    class="ano__dia"
                    ?data-fora=${!n.doMes}
                    ?data-hoje=${n.dia===e}
                    ?data-com-evento=${r>0}
                    title=${r===0?``:s.calendario.eventos(r)}
  ...
  `}function je(){return j===`dia`?De():j===`semana`?Oe():j===`mes`?Ce():j===`ano`?ke():Ae()}function X(e){N!==null&&(N={...N,...e})}function Z(e){F!==null&&(F={...F,...e})}function Q(e){if(!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t=0,n=0,r=0]=e.split(`-`).map(Number),i=new Date(t,n-1,r);return i.getFullYear()===t&&i.getMonth()===n-1&&i.getDate()===r}async function Me(e){if(!Q(e.dataInicio)){l(s.calendario.dataInvalida,`warning`);return}let n=!Q(e.dataFim)||e.dataFim<e.dataInicio?e.dataInicio:e.dataFim,r=+!!e.diaInteiro,i=g(e.horaInicio),a=g(e.horaFim),o=n===e.dataInicio&&a<i?i:a;try{await oe({...e.id>0?{id:e.id}:{},titulo:e.titulo.trim()===``?s.acervo.semTitulo:e.titulo.trim(),tipo_id:e.tipoId??v(k),data_inicio_epoch:t(e.dataInicio),hora_inicio_min:r===1?0:i,data_fim_epoch:t(n),hora_fim_min:r===1?f:o,dia_inteiro:r,descricao:e.descricao.trim()})}catch(e){console.error(`Calendário: a gravação do evento falhou.`,e),l(s.calendario.eventoNaoSalvo,`danger`);return}N=null,l(s.calendario.eventoSalvo),await z()}async function $(e){if(await o({titulo:s.calendario.excluirEvento,texto:s.acervo.excluirTexto,rotuloConfirmar:s.acoes.excluir,variante:`danger`})){try{await re(e.id)}catch(e){console.error(`Calendário: a exclusão do evento falhou.`,e),l(s.calendario.eventoNaoExcluido,`danger`);return}N=null,l(s.calendario.eventoExcluido),await z()}}function Ne(e){return i`
    <kk-dialog
      open
  ...
  `}async function Pe(e){let t=e.nome.trim()===``?s.calendario.tipoSemNome:e.nome.trim(),n=e.id>0?y(k,e.id):void 0;try{await se({...n??{ordem:ae(k)},...e.id>0?{id:e.id}:{},nome:t,cor_chave:e.cor,icone:e.icone,marca_especial:+!!e.especial})}catch(e){console.error(`Calendário: a gravação do tipo falhou.`,e),l(s.calendario.tipoNaoSalvo,`danger`);return}F=null,await z()}async function Fe(e){if(e.id!==void 0){if(ce(A,e.id)){await o({titulo:s.calendario.tipoEmUsoTitulo,texto:s.calendario.tipoEmUsoTexto,rotuloConfirmar:s.acoes.fechar});return}if(await o({titulo:s.calendario.excluirTipo,texto:s.acervo.excluirTexto,rotuloConfirmar:s.acoes.excluir,variante:`danger`})){try{await _(e.id)}catch(e){console.error(`Calendário: a exclusão do tipo falhou.`,e),l(s.calendario.tipoNaoExcluido,`danger`);return}await z()}}}function Ie(e){return i`
            ...
            <div class="tipos-lista">
              ${k.map(e=>i`
                  <div class="tipo-linha">
                    ...
                    ${e.marca_especial===1?i`<kk-badge variant="success" pill>${s.calendario.especial}</kk-badge>`:c}
                    <kk-icon-button
                      name="pencil"
