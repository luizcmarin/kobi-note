import{r as e}from"./numero-Elgnatu7.js";import{s as t}from"./banco-DhjAojIe.js";import{Z as n,_ as r,b as i,ct as a,g as o,gt as s,m as c,pt as l,tt as u,vt as d,y as ee}from"./index-sA5grpgQ.js";import{CATEGORIAS as f,CATEGORIA_PADRAO as p,EMOJIS_DE_KIT as te,caloriasDoItem as ne,categoria as re}from"./dados-BgDpV8rv.js";import{FAIXAS as ie,NIVEIS as ae,alertas as oe,calcularAutonomia as se,calcularLogistica as ce,carregarEstoque as le,diasParaVencer as ue,excluirItem as de,lerPerfil as fe,obterItem as pe,porCategoria as me,rotuloDaFaixa as he,rotuloDoNivel as ge,salvarItem as _e,salvarPerfil as ve,statusDeValidade as ye,visiveis as be}from"./estoque-lPVfTwGN.js";import{alternarItem as xe,carregarKits as Se,excluirKit as Ce,itemMarcado as we,kitCompleto as Te,lerProgresso as Ee,marcadosDoKit as De,obterKit as Oe,percentualDoKit as ke,salvarKit as Ae}from"./kits-AgidQQ9x.js";var m=`note_passkey`,je=32;function h(e){let t=String.fromCharCode(...new Uint8Array(e));return btoa(t).replaceAll(`+`,`-`).replaceAll(`/`,`_`).replace(/=+$/,``)}function g(e){let t=atob(e.replaceAll(`-`,`+`).replaceAll(`_`,`/`));return Uint8Array.from(t,e=>e.charCodeAt(0))}function _(){let e=localStorage.getItem(m);if(e===null)return null;try{let t=JSON.parse(e);return typeof t.id==`string`&&typeof t.sal==`string`?{id:t.id,sal:t.sal}:null}catch{return null}}function Me(){return _()!==null}function Ne(){return isSecureContext&&typeof PublicKeyCredential<`u`}var v=class extends Error{},y=class extends Error{};function b(){return location.hostname}var Pe=new TextEncoder().encode(`kobi-note`);async function Fe(){let e=crypto.getRandomValues(new Uint8Array(je)),t;try{t=await navigator.credentials.create({publicKey:{rp:{name:`Kobi Note`,id:b()},user:{id:Pe,name:`kobi-note`,displayName:`Kobi Note`},challenge:crypto.getRandomValues(new Uint8Array(32)),pubKeyCredParams:[{type:`public-key`,alg:-7},{type:`public-key`,alg:-257}],authenticatorSelection:{residentKey:`required`,userVerification:`required`},extensions:{prf:{}}}})}catch{throw new v}if(!(t instanceof PublicKeyCredential))throw new v;if(t.getClientExtensionResults().prf?.enabled!==!0)throw new y;let n={id:h(t.rawId),sal:h(e)},r=await x(n);return localStorage.setItem(m,JSON.stringify(n)),r}async function x(e){let t;try{t=await navigator.credentials.get({publicKey:{rpId:b(),challenge:crypto.getRandomValues(new Uint8Array(32)),allowCredentials:[{type:`public-key`,id:g(e.id)}],userVerification:`required`,extensions:{prf:{eval:{first:g(e.sal)}}}}})}catch{throw new v}if(!(t instanceof PublicKeyCredential))throw new v;let n=t.getClientExtensionResults().prf?.results?.first;if(n===void 0)throw new y;let r=new Uint8Array(n.byteLength);return r.set(n instanceof ArrayBuffer?new Uint8Array(n):new Uint8Array(n.buffer,n.byteOffset,n.byteLength)),r}async function Ie(){let e=_();if(e===null)throw new v;return x(e)}var S=16,Le=12,Re=new TextEncoder().encode(`kobi-note-cofre`),C=()=>t(`documentos_cofre`);async function w(e,t){let n=await crypto.subtle.importKey(`raw`,e,`HKDF`,!1,[`deriveKey`]);return crypto.subtle.deriveKey({name:`HKDF`,hash:`SHA-256`,salt:t,info:Re},n,{name:`AES-GCM`,length:256},!1,[`encrypt`,`decrypt`])}async function ze(e,t){let n=crypto.getRandomValues(new Uint8Array(S)),r=crypto.getRandomValues(new Uint8Array(Le)),i=await w(e,n),a=await crypto.subtle.encrypt({name:`AES-GCM`,iv:r},i,t),o=new Uint8Array(28+a.byteLength);return o.set(n,0),o.set(r,S),o.set(new Uint8Array(a),28),o}async function Be(e,t){let n=t.slice(0,S),r=t.slice(S,28),i=t.slice(28),a=await w(e,n);return crypto.subtle.decrypt({name:`AES-GCM`,iv:r},a,i)}function T(){return C().todos()}async function Ve(e,t,n){await C().salvar({rotulo:n,tipo_mime:t.type===``?`application/octet-stream`:t.type,blob_criptografado:await ze(e,await t.arrayBuffer()),data_criacao:Date.now()})}function He(e,t){return C().salvar({...e,rotulo:t})}function Ue(e){return C().excluir(e)}async function We(e,t){let n=await Be(e,t.blob_criptografado);return URL.createObjectURL(new Blob([n],{type:t.tipo_mime}))}var E=[],D={},O=[],k=fe(),A=new Set,j=new Set,M=!1,N=``,P=null,F=null,I=null,L=[],R=``,z=!1,B=null,V=!1,H=!1,U=null;async function W(){[E,O]=await Promise.all([Se(),le()]),D=Ee(),a()}function G(){V||H||U!==null||(H=!0,Ke(),(async()=>{try{await W(),V=!0}catch(e){console.error(`prep: a carga falhou.`,e),U=i(e)}finally{H=!1,a()}})())}function Ge(){U=null,G(),a()}function K(e){let t=e.args[0];return t===`estoque`||t===`cofre`?t:`kits`}function q(){I=null,L=[],R=``,J()}function J(){B!==null&&URL.revokeObjectURL(B.url),B=null}var Y=!1;function Ke(){Y||(Y=!0,addEventListener(`hashchange`,()=>{let e=location.hash.replace(/^#\/?/,``).split(`/`);(e[0]!==`prep`||e[1]!==`cofre`)&&q()}))}function qe(e,t){let r=we(D,e,t.id),i=[t.quantidade,t.observacoes,t.data_vencimento===0?``:l.prep.vence(n(t.data_vencimento))].filter(e=>e!==``).join(` · `);return d`
      ...
      ${E.map(e=>{let t=String(e.id),n=A.has(t),r=Te(D,e);return d`
          <div class="grupo" ?data-completo=${r}>
            <button
              ...
              class="grupo__alvo"
              aria-expanded=${n}
              @click=${()=>{let e=new Set(A);e.delete(t)||e.add(t),A=e,a()}}
            >
  ...
  `}async function Ye(e){await o({titulo:l.prep.excluirKit,texto:l.acervo.excluirTexto,rotuloConfirmar:l.acoes.excluir,variante:`danger`})&&(D=await Ce(e,D),c(l.prep.kitExcluido),await W())}function X(){return{id:0,descricao:``,quantidade:``,observacoes:``,vencimento:``}}function Xe(){return{id:0,nome:``,icone:``,itens:[X()],criacao:0}}async function Ze(e){if(e.id===void 0)return;let t=await Oe(e.id)??e;P={id:t.id??0,nome:t.nome,icone:t.icone,criacao:t.data_criacao,itens:t.itens.length===0?[X()]:t.itens.map(e=>({id:e.id,descricao:e.descricao,quantidade:e.quantidade,observacoes:e.observacoes,vencimento:e.data_vencimento===0?``:u(e.data_vencimento)}))},a()}function Qe(e){let t=t=>{P={...P??e,...t}},n=(n,r,i)=>{t({itens:(P??e).itens.map((e,t)=>t===n?{...e,[r]:i}:e)})};return d`
    <div class="formulario formulario--cartao">
      <h2 class="formulario__titulo">
        ${e.id>0?l.prep.editarKit:l.prep.novoKit}
      </h2>

      <kk-input
        label=${l.prep.nomeDoKit}
        .value=${e.nome}
        @kk-input=${e=>t({nome:e.target.value})}
      ></kk-input>

      <h3 class="secao">${l.prep.emoji}</h3>
      <p class="formulario__ajuda">${l.prep.emojiAjuda}</p>
      ...
      <h3 class="secao">${l.prep.itens}</h3>
          ...
          <div class="item-editor">
            <div class="item-editor__topo">
              <kk-input
                ...
                placeholder=${l.prep.descricaoDoItem}
                .value=${e.descricao}
                @kk-input=${e=>n(t,`descricao`,e.target.value)}
              ></kk-input>
              <kk-icon-button
                name="trash"
                label=${l.prep.removerItem}
                @click=${()=>void $e(t)}
              ></kk-icon-button>
            </div>
            ...
            <kk-input
              size="small"
              placeholder=${l.prep.observacoes}
              .value=${e.observacoes}
      ...
      <kk-button
        outline
        @click=${()=>{t({itens:[...(P??e).itens,X()]}),a()}}
      >
        <kk-icon slot="prefix" name="plus"></kk-icon>${l.prep.adicionarItem}
      </kk-button>
  ...
  `}async function $e(e){await o({titulo:l.prep.removerItem,texto:l.prep.removerItemTexto,rotuloConfirmar:l.acoes.excluir,variante:`danger`})&&P!==null&&(P={...P,itens:P.itens.filter((t,n)=>n!==e)},a())}async function et(){let e=P;if(e===null)return;let t=e.itens.some(e=>e.descricao.trim()!==``);if(e.nome.trim()===``&&!t){P=null,a();return}await Ae(e),P=null,c(l.prep.kitSalvo),await W()}function tt(){return{id:0,item:``,categoria:p,quantidade:1,peso:0,kcal:0,vencimento:``}}async function nt(){let e=F;e!==null&&(await _e({...e.id>0?{id:e.id}:{},item:e.item.trim(),categoria:e.categoria===``?p:e.categoria,quantidade:Number(e.quantidade),peso_unitario:Number(e.peso),calorias_por_100g:Number(e.kcal),data_vencimento:e.vencimento===``?0:rt(e.vencimento)}),F=null,c(l.prep.itemSalvo),await W())}function rt(e){let[t=1970,n=1,r=1]=e.split(`-`).map(Number);return new Date(t,n-1,r).getTime()}function it(e){let t=t=>{F={...F??e,...t}};return d`
    <div class="formulario formulario--cartao">
      <h2 class="formulario__titulo">
        ${e.id>0?l.prep.editarItem:l.prep.novoItem}
      </h2>
  ...
  `}function at(t){let n=e=>{k={...k,...e,pessoas:Math.max(1,e.pessoas??k.pessoas)},ve(k),a()},r=ce(O,k);return d`
    <div class="tally">
      <div class="tally__topo">
        <kk-icon class="tally__icone" name="calculator"></kk-icon>
        <span class="tally__titulo">
          ${l.prep.calculadora}
          <small>${l.prep.calculadoraAjuda}</small>
        </span>
      </div>

      <div class="formulario__par">
        <kk-select
          label=${l.prep.faixaEtaria}
          size="small"
          .value=${k.idade}
      ...
      <div class="tally__linha">
        <span class="tally__nome"><kk-icon name="users"></kk-icon>${l.prep.pessoas}</span>
        <kk-icon-button
          name="minus"
          label=${l.prep.menosPessoas}
          @click=${()=>n({pessoas:k.pessoas-1})}
        ></kk-icon-button>
        <span class="tally__valor">${k.pessoas}</span>
        <kk-icon-button
          name="plus"
          label=${l.prep.maisPessoas}
          @click=${()=>n({pessoas:k.pessoas+1})}
        ></kk-icon-button>
      </div>
      ...
      <div class="placares">
        <div class="placar">
          ...
          <span class="placar__rotulo">${l.prep.diasDeAutonomia}</span>
        </div>
        <div class="placar">
          <span class="placar__valor">${e(t.litrosDeAgua)} L</span>
          <span class="placar__rotulo">${l.prep.aguaSugerida}</span>
        </div>
        <div class="placar">
          <span class="placar__valor">${e(t.pesoTotalKg)} kg</span>
          <span class="placar__rotulo">${l.prep.pesoTotal}</span>
        </div>
      </div>
      ...
      <p class="discreto">
        ${l.prep.metaAutonomia(t.metaPercentual)} ·
        ${l.prep.necessidadeDiaria(e(t.doGrupo))}
      </p>

      <h3 class="secao">${l.prep.logistica}</h3>
      <div class="placares">
        <div class="placar">
          <span class="placar__valor">${r.diasFrios}</span>
          <span class="placar__rotulo">${l.prep.diasSemFogo}</span>
        </div>
        <div class="placar">
          <span class="placar__valor">${r.diasTotais}</span>
          <span class="placar__rotulo">${l.prep.diasComFogo}</span>
        </div>
        <div class="placar">
          <span class="placar__valor" data-tom=${r.vulneravel?`perigo`:`sucesso`}>
            ${r.fibras}
          </span>
          <span class="placar__rotulo">${l.prep.itensDeFibra}</span>
        </div>
      </div>
  ...
  `}function Z(e){let t=ue(e);return t===null?s:t<0?d`<kk-badge variant="danger" pill>${l.prep.vencidoHa(Math.abs(t))}</kk-badge>`:t===0?d`<kk-badge variant="danger" pill>${l.prep.venceHoje}</kk-badge>`:t<7?d`<kk-badge variant="warning" pill>${l.prep.venceEm(t)}</kk-badge>`:s}function ot(t){let r=re(t.categoria),i=ne(t);return d`
    <div class="registro" data-status=${ye(t)}>
      ...
      <button class="registro__alvo" @click=${()=>void Q(t)}>
        ...
        <span class="registro__resumo">
          ${l.prep.resumoDoItem(t.quantidade,e(t.peso_unitario))}
          ${i===null?``:`· ${e(i)} kcal`}
        </span>
        ${t.data_vencimento===0?s:d`<span class="registro__resumo">${l.prep.vence(n(t.data_vencimento))}</span>`}
      </button>
  ...
  `}async function Q(e){if(e.id===void 0)return;let t=await pe(e.id)??e;F={id:t.id??0,item:t.item,categoria:t.categoria,quantidade:t.quantidade,peso:t.peso_unitario,kcal:t.calorias_por_100g,vencimento:t.data_vencimento===0?``:u(t.data_vencimento)},a()}async function st(e){await o({titulo:l.prep.excluirItem,texto:l.acervo.excluirTexto,rotuloConfirmar:l.acoes.excluir,variante:`danger`})&&e.id!==void 0&&(await de(e.id),c(l.prep.itemExcluido),await W())}function ct(){if(F!==null)return it(F);let e=se(O,k),t=oe(O),n=me(be(O,N));return d`
    ${t.total===0?s:d`
          <div class="alertas">
            ...
            >
              ...
              <span class="alertas__titulo">${l.prep.alertas(t.total)}</span>
    ...
    <div class="filtros">
      <kk-input
        ...
        type="search"
        clearable
        placeholder=${l.prep.buscarItens}
        .value=${N}
    ...
    ${n.length===0?d`
          <div class="vazio">
            ...
            <p>${O.length===0?l.prep.semEstoque:l.prep.semEstoqueFiltro}</p>
          </div>
        `:d`
          <div class="grupos">
            ${n.map(e=>{let t=j.has(e.nome);return d`
                <div class="grupo">
                  <button
                    class="grupo__alvo"
                    aria-expanded=${t}
                    @click=${()=>{let t=new Set(j);t.delete(e.nome)||t.add(e.nome),j=t,a()}}
                  >
        ...
        `}
  `}function lt(e){return e instanceof y?l.prep.semPrf:(e instanceof v,l.prep.gestoRecusado)}async function $(e){if(!z){z=!0,R=``,a();try{await e()}catch(e){R=lt(e)}finally{z=!1,a()}}}function ut(){return $(async()=>{I=await Fe(),L=await T()})}function dt(){return $(async()=>{I=await Ie(),L=await T()})}async function ft(e){let t=e.files?.[0];if(t===void 0||I===null)return;let n=await r({titulo:l.prep.nomeDoDocumento,valor:t.name,placeholder:l.prep.nomeDoDocumento,rotuloConfirmar:l.acoes.salvar,erroVazio:l.prep.informeNome});e.value=``,n!==null&&(await Ve(I,t,n),L=await T(),c(l.prep.documentoGuardado),a())}function pt(){let e=R===``?s:d`<p class="erro">${R}</p>`;return I===null&&!Me()?d`
      <div class="formulario formulario--cartao">
        <h2 class="formulario__titulo">${l.prep.configurarBiometria}</h2>
        <p class="discreto">${l.prep.biometriaAjuda}</p>
        ${Ne()?d`
              ${e}
              <kk-button variant="primary" ?loading=${z} @click=${()=>void ut()}>
                <kk-icon slot="prefix" name="fingerprint"></kk-icon>${l.prep.criarCofre}
              </kk-button>
            `:d`<p class="erro">${l.prep.semBiometria}</p>`}
      </div>
    `:I===null?d`
      <div class="formulario formulario--cartao">
        <h2 class="formulario__titulo">${l.prep.cofreTrancado}</h2>
        <p class="discreto">${l.prep.destranqueAjuda}</p>
        ${e}
        <kk-button
          variant="primary"
          ?loading=${z}
          @click=${()=>void dt()}
        >
          <kk-icon slot="prefix" name="fingerprint"></kk-icon>${l.prep.destrancarComBiometria}
        </kk-button>
      </div>
    `:d`
    <div class="cofre__acoes">
      ...
      <kk-button
        ...
        @click=${()=>{q(),a()}}
      >
        <kk-icon slot="prefix" name="lock"></kk-icon>${l.prep.trancar}
      </kk-button>
    </div>
            ...
            ${L.map(e=>d`
                <div class="registro">
                  ...
                  <div class="registro__acoes">
                    <kk-icon-button
                      name="pencil"
                      label=${l.acoes.renomear}
                      @click=${()=>void ht(e)}
                    ></kk-icon-button>
                    <kk-icon-button
                      name="trash"
                      label=${l.prep.excluirDocumento}
                      @click=${()=>void gt(e)}
                    ></kk-icon-button>
                  </div>
                </div>
    ...
    ${B===null?s:d`
          ...
          >
            ${B.tipo.startsWith(`image/`)?d`<img class="previa" src=${B.url} alt=${B.rotulo} />`:d`
                  <p>${l.prep.semPreVisualizacao}</p>
                  <kk-button variant="primary" href=${B.url} download=${B.rotulo}>
                    <kk-icon slot="prefix" name="download"></kk-icon>${l.prep.baixar}
                  </kk-button>
                `}
          </kk-dialog>
        `}
  `}async function mt(e){if(I!==null)try{J(),B={rotulo:e.rotulo,url:await We(I,e),tipo:e.tipo_mime},a()}catch{c(l.prep.falhaAoDecifrar,`warning`)}}async function ht(e){let t=await r({titulo:l.prep.renomearDocumento,valor:e.rotulo,placeholder:l.prep.nomeDoDocumento,rotuloConfirmar:l.acoes.renomear,erroVazio:l.prep.informeNome});t!==null&&t!==e.rotulo&&(await He(e,t),L=await T(),a())}async function gt(e){await o({titulo:l.prep.excluirDocumento,texto:l.prep.excluirDocumentoTexto,rotuloConfirmar:l.acoes.excluir,variante:`danger`})&&e.id!==void 0&&(await Ue(e.id),L=await T(),c(l.prep.documentoExcluido),a())}var _t={kits:l.prep.kits,estoque:l.prep.estoque,cofre:l.prep.cofre},vt={voltarPara(){return`home`},aoVoltar(e){let t=K(e);return t===`estoque`&&F!==null?(F=null,a(),!0):t===`kits`&&P!==null&&(P=null,a(),!0)},titulo(e){return _t[K(e)]},acoes(e){let t=K(e);if(t===`kits`&&P===null)return d`
        <kk-icon-button
          name="plus"
          label=${l.prep.novoKit}
          @click=${()=>{P=Xe(),a()}}
        ></kk-icon-button>
      `;if(t===`estoque`&&F===null)return d`
        <kk-icon-button
          name="plus"
          label=${l.prep.novoItem}
          @click=${()=>{F=tt(),a()}}
        ></kk-icon-button>
      `},conteudo(e){if(G(),U!==null)return ee(U,Ge);let t=K(e);return t!==`estoque`&&(F=null),t!==`kits`&&(P=null),V?t===`estoque`?ct():t===`cofre`?pt():P===null?Je():Qe(P):d`<div class="carregando"><kk-spinner></kk-spinner></div>`}};export{vt as telaPrep};