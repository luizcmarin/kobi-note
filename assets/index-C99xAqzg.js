...
`,ty,ny,ry,iy,ay,oy,sy,cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Q,Ay,jy,My,Ny,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy,Zy,Qy,$y,eb,$=class extends (ky=M,Oy=[A(`.textarea__control`)],Dy=[k()],Ey=[O()],Ty=[O()],wy=[O()],Cy=[O({reflect:!0})],Sy=[O({type:Boolean,reflect:!0})],xy=[O()],by=[O({attribute:`help-text`})],yy=[O()],vy=[O({type:Number})],_y=[O()],gy=[O({type:Boolean,reflect:!0})],hy=[O({type:Boolean,reflect:!0})],my=[O({reflect:!0,converter:Xo})],py=[O({type:Boolean,reflect:!0})],fy=[O({type:Number})],dy=[O({type:Number})],uy=[O()],ly=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],cy=[O()],sy=[O({type:Boolean})],oy=[O()],ay=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],iy=[O()],ry=[Do()],ny=[j(`disabled`,{waitUntilFirstUpdate:!0})],ty=[j(`value`,{waitUntilFirstUpdate:!0})],ky){constructor(){super(...arguments),m(Q,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),_(this,Ay,m(Q,8,this)),m(Q,11,this),_(this,jy,m(Q,12,this,!1)),m(Q,15,this),_(this,My,m(Q,16,this,``)),m(Q,19,this),_(this,Ny,m(Q,20,this,``)),m(Q,23,this),_(this,Py,m(Q,24,this,``)),m(Q,27,this),_(this,Fy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,Iy,m(Q,32,this,!1)),m(Q,35,this),_(this,Ly,m(Q,36,this,``)),m(Q,39,this),_(this,Ry,m(Q,40,this,``)),m(Q,43,this),_(this,zy,m(Q,44,this,``)),m(Q,47,this),_(this,By,m(Q,48,this,4)),m(Q,51,this),_(this,Vy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Hy,m(Q,56,this,!1)),m(Q,59,this),_(this,Uy,m(Q,60,this,!1)),m(Q,63,this),_(this,Wy,m(Q,64,this,``)),m(Q,67,this),_(this,Gy,m(Q,68,this,!1)),m(Q,71,this),_(this,Ky,m(Q,72,this)),m(Q,75,this),_(this,qy,m(Q,76,this)),m(Q,79,this),_(this,Jy,m(Q,80,this)),m(Q,83,this),_(this,Yy,m(Q,84,this,!0)),m(Q,87,this),_(this,Xy,m(Q,88,this)),m(Q,91,this),_(this,Zy,m(Q,92,this)),m(Q,95,this),_(this,Qy,m(Q,96,this)),m(Q,99,this),_(this,$y,m(Q,100,this,!0)),m(Q,103,this),_(this,eb,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.toggleState(`--empty`,!this.value),this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
    ...
    `}};Q=f(ky),Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,Fy=new WeakMap,Iy=new WeakMap,Ly=new WeakMap,Ry=new WeakMap,zy=new WeakMap,By=new WeakMap,Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakMap,Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakMap,qy=new WeakMap,Jy=new WeakMap,Yy=new WeakMap,Xy=new WeakMap,Zy=new WeakMap,Qy=new WeakMap,$y=new WeakMap,eb=new WeakMap,h(Q,4,`input`,Oy,$,Ay),h(Q,4,`hasFocus`,Dy,$,jy),h(Q,4,`title`,Ey,$,My),h(Q,4,`name`,Ty,$,Ny),h(Q,4,`value`,wy,$,Py),h(Q,4,`size`,Cy,$,Fy),h(Q,4,`filled`,Sy,$,Iy),h(Q,4,`label`,xy,$,Ly),h(Q,4,`helpText`,by,$,Ry),h(Q,4,`placeholder`,yy,$,zy),h(Q,4,`rows`,vy,$,By),h(Q,4,`resize`,_y,$,Vy),h(Q,4,`disabled`,gy,$,Hy),h(Q,4,`readonly`,hy,$,Uy),h(Q,4,`form`,my,$,Wy),h(Q,4,`required`,py,$,Gy),h(Q,4,`minlength`,fy,$,Ky),h(Q,4,`maxlength`,dy,$,qy),h(Q,4,`autocapitalize`,uy,$,Jy),h(Q,4,`autocorrect`,ly,$,Yy),h(Q,4,`autocomplete`,cy,$,Xy),h(Q,4,`autofocus`,sy,$,Zy),h(Q,4,`enterkeyhint`,oy,$,Qy),h(Q,4,`spellcheck`,ay,$,$y),h(Q,4,`inputmode`,iy,$,eb),h(Q,1,`handleDisabledChange`,ny,$),h(Q,1,`handleValueChange`,ty,$),h(Q,5,`defaultValue`,ry,$),p(Q,$),g($,`styles`,[D,Cp,ey]),g($,`formAssociated`,!0),$.define(`kk-textarea`),te(`./ui`);var tb=document.querySelector(`#app`);function nb(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:Ei({executar:()=>void db(!0),ocupado:cb})};let t=Gt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Zr()};if(rb[t.id]===void 0||!qt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Xr(t)};let n=sb.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:$r(n)};let r=ib.get(t.id);return r===void 0?(ob(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Qr()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var rb={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-DV2NdZcR.js`);return{telaAnotacoes:e}},__vite__mapDeps([22,5,3,4,23,24,25]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-DVlUdqAh.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-BkD4QhtJ.js`);return{telaCalendario:e}},__vite__mapDeps([26,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-CrMNX-Os.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,23,28,29,30,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-CrMNX-Os.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,23,28,29,30,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-YQKH5r9T.js`);return{telaFaq:e}},__vite__mapDeps([31,4,32,33,23,24,29]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-ClOgLsuB.js`);return{telaImite:e}},__vite__mapDeps([34,23,24,29]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-vPgFHfht.js`);return{telaCronologia:e}},__vite__mapDeps([35,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-DSMg-AR0.js`);return{telaEstudo:e}},__vite__mapDeps([36,12,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-BmUTLJGs.js`);return{telaFinanceiro:e}},__vite__mapDeps([37,8,9,28,24,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-DZmD_qil.js`);return{telaGuias:e}},__vite__mapDeps([38,4,5,23,24,25,39,15]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-CCmhxYub.js`);return{telaJogo:e}},__vite__mapDeps([40,23,24,11,4]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-CIPxcoX8.js`);return{telaLeitura:e}},__vite__mapDeps([41,42]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-BJyR87OI.js`);return{telaMetas:e}},__vite__mapDeps([43,10,9,8,4,5,11]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-DWeIPeYZ.js`);return{telaMinisterio:e}},__vite__mapDeps([44,23,24,39,13,4,5]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-1BaLtIvS.js`);return{telaPerfil:e}},__vite__mapDeps([45,39,19,4,21]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-CByj8oFS.js`);return{telaPoesia:e}},__vite__mapDeps([46,4,5,33,23,24,25,39,15]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-CMD1J3gw.js`);return{telaPrep:e}},__vite__mapDeps([47,9,4,18,17,5,16]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-D8CGY6Yc.js`);return{telaPrincipios:e}},__vite__mapDeps([48,4,32,33,23,24,29]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-Nx3ty0MK.js`);return{telaReceitas:e}},__vite__mapDeps([49,5,33,23,24,25,39,15,14,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-DV3fG7gF.js`);return{telaServico:e}},__vite__mapDeps([50,10,9,8,4,5,11]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-CYYhwg03.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-CMfH6k-Q.js`);return{telaTutorial:e}},__vite__mapDeps([51,4,23,24,52]),import.meta.url)).telaTutorial},ib=new Map,ab=new Set;function ob(e){let t=rb[e];t===void 0||ib.has(e)||ab.has(e)||(ab.add(e),t().then(t=>{ib.set(e,t),lb()}).catch(t=>{ab.delete(e),sb.set(e,String(t)),lb()}))}var sb=new Map,cb=!1;function lb(){if(tb===null)return;let e=ub,{cabecalho:t,conteudo:n}=nb(e);document.title=e.modulo===`home`?u.displayName:`${t.titulo} — ${u.displayName}`,document.documentElement.dataset.modulo=e.modulo,wt(vr(t,n,lb),tb),mr()}var ub={modulo:`home`,args:[],query:new URLSearchParams};async function db(e){if(!cb){cb=!0,lb();try{let t=await tr();if(!e)return;t.ok?Ni(x.home.sincronizado(t.atualizados.length)):Ni(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{cb=!1,lb()}}}function fb(){tb!==null&&wt(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
