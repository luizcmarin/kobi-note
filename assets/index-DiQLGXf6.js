...
`,ds={name:`default`,resolver:(e,t)=>ne(`assets/icons/${t}/${e}.svg`)},fs={caret:`
  ...
  `},ps=[ds,{name:`system`,resolver:e=>e in fs?`data:image/svg+xml,${encodeURIComponent(fs[e])}`:``}],ms=[];function hs(e){ms.push(e)}function gs(e){ms=ms.filter(t=>t!==e)}function _s(e){return ps.find(t=>t.name===e)}var vs=Symbol(),ys=Symbol(),bs,xs=new Map,Ss,Cs,ws,Ts,Es,Ds,Os,ks,As,P,js,Ms,Ns,Ps,Fs,Is,Ls=class extends (As=M,ks=[k()],Os=[O({reflect:!0})],Ds=[O()],Es=[O()],Ts=[O({reflect:!0})],ws=[O({reflect:!0})],Cs=[j(`label`)],Ss=[j([`name`,`src`,`library`,`variant`])],As){constructor(){super(...arguments),m(P,5,this),g(this,`initialRender`,!1),_(this,js,m(P,8,this,null)),m(P,11,this),_(this,Ms,m(P,12,this)),m(P,15,this),_(this,Ns,m(P,16,this)),m(P,19,this),_(this,Ps,m(P,20,this,``)),m(P,23,this),_(this,Fs,m(P,24,this,`default`)),m(P,27,this),_(this,Is,m(P,28,this,`outline`)),m(P,31,this)}async resolveIcon(e,t){let n;if(t?.spriteSheet)return this.svg=w`<svg part="svg">
    ...
    `}};F=f(Zs),Qs=new WeakMap,$s=new WeakMap,ec=new WeakMap,tc=new WeakMap,nc=new WeakMap,rc=new WeakMap,ic=new WeakMap,ac=new WeakMap,oc=new WeakMap,sc=new WeakMap,cc=new WeakMap,lc=new WeakMap,uc=new WeakMap,h(F,4,`button`,Xs,I,Qs),h(F,4,`hasFocus`,Ys,I,$s),h(F,4,`name`,Js,I,ec),h(F,4,`library`,qs,I,tc),h(F,4,`variant`,Ks,I,nc),h(F,4,`src`,Gs,I,rc),h(F,4,`href`,Ws,I,ic),h(F,4,`target`,Us,I,ac),h(F,4,`download`,Hs,I,oc),h(F,4,`label`,Vs,I,sc),h(F,4,`disabled`,Bs,I,cc),h(F,4,`type`,zs,I,lc),h(F,4,`form`,Rs,I,uc),p(F,I),g(I,`styles`,[D,Wo]),g(I,`dependencies`,{"kk-icon":Ls});function dc(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}var fc=class{host;slotNames=[];constructor(e,...t){this.host=e,e.addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!==``)return!0;if(e.nodeType===e.ELEMENT_NODE){let t=e;if(t.tagName.toLowerCase()===`kk-visually-hidden`)return!1;if(!t.hasAttribute(`slot`))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e===`[default]`?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener(`slotchange`,this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener(`slotchange`,this.handleSlotChange)}handleSlotChange=e=>{let t=e.target;(this.slotNames.includes(`[default]`)&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}};function pc(e){if(!e)return``;let t=e.assignedNodes({flatten:!0}),n=``;return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(n+=e.textContent)}),n}var mc=C`
  :host {
    display: contents;
...
`,hc,gc,_c,vc,yc,bc,xc,Sc,Cc,wc,Tc,Ec,L,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc,Ic=class e extends (Ec=M,Tc=[A(`[part~="base"]`)],wc=[A(`.alert__countdown-elapsed`)],Cc=[O({type:Boolean,reflect:!0})],Sc=[O({type:Boolean,reflect:!0})],xc=[O({reflect:!0})],bc=[O({type:Number})],yc=[O({type:String,reflect:!0})],vc=[k()],_c=[k()],gc=[j(`open`,{waitUntilFirstUpdate:!0})],hc=[j(`duration`)],Ec){constructor(){super(...arguments),m(L,5,this),g(this,`autoHideTimeout`),g(this,`remainingTimeInterval`),g(this,`countdownAnimation`),g(this,`hasSlotController`,new fc(this,`icon`,`suffix`)),g(this,`localize`,new sa(this)),_(this,Dc,m(L,8,this)),m(L,11,this),_(this,Oc,m(L,12,this)),m(L,15,this),_(this,kc,m(L,16,this,!1)),m(L,19,this),_(this,Ac,m(L,20,this,!1)),m(L,23,this),_(this,jc,m(L,24,this,`primary`)),m(L,27,this),_(this,Mc,m(L,28,this,1/0)),m(L,31,this),_(this,Nc,m(L,32,this)),m(L,35,this),_(this,Pc,m(L,36,this,this.duration)),m(L,39,this),_(this,Fc,m(L,40,this,!1)),m(L,43,this)}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`kk-toast-stack`}),this.currentToastStack}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:e}=this;this.countdownAnimation=e.animate([{width:`100%`},{width:`0`}],{duration:this.duration,easing:`linear`})}}handleCloseClick(){this.hide()}async handleOpenChange(){this.transicao=!0,this.open?(this.emit(`kk-show`),this.duration<1/0&&this.restartAutoHide(),await this.esperarTransicao(),this.emit(`kk-after-show`)):(Uo(this),this.emit(`kk-hide`),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await this.esperarTransicao(),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.base.getAnimations().map(e=>e.finished))}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,dc(this,`kk-after-show`)}async hide(){if(this.open)return this.open=!1,dc(this,`kk-after-hide`)}async toast(){return new Promise(t=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`kk-after-hide`,()=>{e.toastStack.removeChild(this),t(),e.toastStack.querySelector(`kk-alert`)===null&&e.toastStack.remove()},{once:!0})})}render(){return w`
    ...
    `}};L=f(Ec),Dc=new WeakMap,Oc=new WeakMap,kc=new WeakMap,Ac=new WeakMap,jc=new WeakMap,Mc=new WeakMap,Nc=new WeakMap,Pc=new WeakMap,Fc=new WeakMap,h(L,4,`base`,Tc,Ic,Dc),h(L,4,`countdownElement`,wc,Ic,Oc),h(L,4,`open`,Cc,Ic,kc),h(L,4,`closable`,Sc,Ic,Ac),h(L,4,`variant`,xc,Ic,jc),h(L,4,`duration`,bc,Ic,Mc),h(L,4,`countdown`,yc,Ic,Nc),h(L,4,`remainingTime`,vc,Ic,Pc),h(L,4,`transicao`,_c,Ic,Fc),h(L,1,`handleOpenChange`,gc,Ic),h(L,1,`handleDurationChange`,hc,Ic),p(L,Ic),g(Ic,`styles`,[D,mc]),g(Ic,`dependencies`,{"kk-icon-button":I}),g(Ic,`currentToastStack`),Ic.define(`kk-alert`);var Lc=C`
  :host {
    display: inline-flex;
  }
...
`,Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc=class extends (Vc=M,Bc=[O({reflect:!0})],zc=[O({type:Boolean,reflect:!0})],Rc=[O({type:Boolean,reflect:!0})],Vc){constructor(){super(...arguments),_(this,Uc,m(Hc,8,this,`primary`)),m(Hc,11,this),_(this,Wc,m(Hc,12,this,!1)),m(Hc,15,this),_(this,Gc,m(Hc,16,this,!1)),m(Hc,19,this)}render(){return w`
      <span
        part="base"
    ...
    `}};Hc=f(Vc),Uc=new WeakMap,Wc=new WeakMap,Gc=new WeakMap,h(Hc,4,`variant`,Bc,Kc,Uc),h(Hc,4,`pill`,zc,Kc,Wc),h(Hc,4,`pulse`,Rc,Kc,Gc),p(Hc,Kc),g(Kc,`styles`,[D,Lc]),Kc.define(`kk-badge`);var qc=C`
  :host {
...
`,Jc=class extends M{static styles=[D,qc];localize=new sa(this);render(){return w`
...
`,Xc,Zc,Qc,$c,el,tl,nl,rl,il,al,ol,sl,cl,ll,ul,dl,fl,pl,ml,hl,gl,_l,vl,yl,bl,xl,Sl,Cl,wl,Tl,R,El,Dl,Ol,kl,Al,jl,Ml,Nl,Pl,Fl,Il,Ll,Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,z=class extends (Tl=M,wl=[A(`.button`)],Cl=[k()],Sl=[k()],xl=[O()],bl=[O({reflect:!0})],yl=[O({reflect:!0})],vl=[O({type:Boolean,reflect:!0})],_l=[O({type:Boolean,reflect:!0})],gl=[O({type:Boolean,reflect:!0})],hl=[O({type:Boolean,reflect:!0})],ml=[O({type:Boolean,reflect:!0})],pl=[O({type:Boolean,reflect:!0})],fl=[O({type:Boolean,reflect:!0})],dl=[O({type:Boolean,reflect:!0})],ul=[O()],ll=[O()],cl=[O()],sl=[O()],ol=[O()],al=[O()],il=[O()],rl=[O()],nl=[O({attribute:`formaction`})],tl=[O({attribute:`formenctype`})],el=[O({attribute:`formmethod`})],$c=[O({attribute:`formnovalidate`,type:Boolean})],Qc=[O({attribute:`formtarget`})],Zc=[j(`disabled`,{waitUntilFirstUpdate:!0})],Xc=[j(`loading`,{waitUntilFirstUpdate:!0})],Tl){constructor(){super(...arguments),m(R,5,this),g(this,`formControlController`,new ns(this,{assumeInteractionOn:[`click`]})),g(this,`hasSlotController`,new fc(this,`[default]`,`prefix`,`suffix`)),g(this,`localize`,new sa(this)),_(this,El,m(R,8,this)),m(R,11,this),_(this,Dl,m(R,12,this,!1)),m(R,15,this),_(this,Ol,m(R,16,this,!1)),m(R,19,this),_(this,kl,m(R,20,this,``)),m(R,23,this),_(this,Al,m(R,24,this,`default`)),m(R,27,this),_(this,jl,m(R,28,this,`medium`)),m(R,31,this),_(this,Ml,m(R,32,this,!1)),m(R,35,this),_(this,Nl,m(R,36,this,!1)),m(R,39,this),_(this,Pl,m(R,40,this,!1)),m(R,43,this),_(this,Fl,m(R,44,this,!1)),m(R,47,this),_(this,Il,m(R,48,this,!1)),m(R,51,this),_(this,Ll,m(R,52,this,!1)),m(R,55,this),_(this,Rl,m(R,56,this,!1)),m(R,59,this),_(this,zl,m(R,60,this,!1)),m(R,63,this),_(this,Bl,m(R,64,this,`button`)),m(R,67,this),_(this,Vl,m(R,68,this,``)),m(R,71,this),_(this,Hl,m(R,72,this,``)),m(R,75,this),_(this,Ul,m(R,76,this,``)),m(R,79,this),_(this,Wl,m(R,80,this)),m(R,83,this),_(this,Gl,m(R,84,this,`noreferrer noopener`)),m(R,87,this),_(this,Kl,m(R,88,this)),m(R,91,this),_(this,ql,m(R,92,this)),m(R,95,this),_(this,Jl,m(R,96,this)),m(R,99,this),_(this,Yl,m(R,100,this)),m(R,103,this),_(this,Xl,m(R,104,this)),m(R,107,this),_(this,Zl,m(R,108,this)),m(R,111,this),_(this,Ql,m(R,112,this)),m(R,115,this)}get validity(){return this.isButton()?this.button.validity:rs}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.isButton()&&this.formControlController.updateValidity()}handleLoadingChange(){this.toggleState(`--loading`,this.loading)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?qo`a`:qo`button`;return Yo`
      <${t}
        part="base"
    ...
    `}};R=f(Tl),El=new WeakMap,Dl=new WeakMap,Ol=new WeakMap,kl=new WeakMap,Al=new WeakMap,jl=new WeakMap,Ml=new WeakMap,Nl=new WeakMap,Pl=new WeakMap,Fl=new WeakMap,Il=new WeakMap,Ll=new WeakMap,Rl=new WeakMap,zl=new WeakMap,Bl=new WeakMap,Vl=new WeakMap,Hl=new WeakMap,Ul=new WeakMap,Wl=new WeakMap,Gl=new WeakMap,Kl=new WeakMap,ql=new WeakMap,Jl=new WeakMap,Yl=new WeakMap,Xl=new WeakMap,Zl=new WeakMap,Ql=new WeakMap,h(R,4,`button`,wl,z,El),h(R,4,`hasFocus`,Cl,z,Dl),h(R,4,`invalid`,Sl,z,Ol),h(R,4,`title`,xl,z,kl),h(R,4,`variant`,bl,z,Al),h(R,4,`size`,yl,z,jl),h(R,4,`caret`,vl,z,Ml),h(R,4,`disabled`,_l,z,Nl),h(R,4,`loading`,gl,z,Pl),h(R,4,`outline`,hl,z,Fl),h(R,4,`pill`,ml,z,Il),h(R,4,`circle`,pl,z,Ll),h(R,4,`swipe`,fl,z,Rl),h(R,4,`expand`,dl,z,zl),h(R,4,`type`,ul,z,Bl),h(R,4,`name`,ll,z,Vl),h(R,4,`value`,cl,z,Hl),h(R,4,`href`,sl,z,Ul),h(R,4,`target`,ol,z,Wl),h(R,4,`rel`,al,z,Gl),h(R,4,`download`,il,z,Kl),h(R,4,`form`,rl,z,ql),h(R,4,`formAction`,nl,z,Jl),h(R,4,`formEnctype`,tl,z,Yl),h(R,4,`formMethod`,el,z,Xl),h(R,4,`formNoValidate`,$c,z,Zl),h(R,4,`formTarget`,Qc,z,Ql),h(R,1,`handleDisabledChange`,Zc,z),h(R,1,`handleLoadingChange`,Xc,z),p(R,z),g(z,`styles`,[D,Yc]),g(z,`dependencies`,{"kk-icon":Ls,"kk-spinner":Jc}),z.define(`kk-button`);var $l=C`
  :host {
...
`,eu,tu,nu,ru,iu,au,ou=class extends (nu=M,tu=[O({reflect:!0})],eu=[O({reflect:!0})],nu){constructor(){super(...arguments),g(this,`hasSlotController`,new fc(this,`footer`,`header`,`image`)),_(this,iu,m(ru,8,this,`vertical`)),m(ru,11,this),_(this,au,m(ru,12,this,`default`)),m(ru,15,this)}render(){return w`
      <div
        part="base"
    ...
    `}};ru=f(nu),iu=new WeakMap,au=new WeakMap,h(ru,4,`orientation`,tu,ou,iu),h(ru,4,`variant`,eu,ou,au),p(ru,ou),g(ou,`styles`,[D,$l]),ou.define(`kk-card`);var su=C`
  :host {
    display: block;
  }
...
`,cu,lu,uu,du,fu,pu,mu,hu,gu,_u,vu,B,yu,bu,xu,Su,Cu,wu,Tu,Eu,Du,Ou=class extends (vu=M,_u=[A(`.details`)],gu=[A(`.details__header`)],hu=[A(`.details__body`)],mu=[A(`.details__expand-icon-slot`)],pu=[k()],fu=[O({type:Boolean,reflect:!0})],du=[O()],uu=[O({type:Boolean,reflect:!0})],lu=[O({reflect:!0})],cu=[j(`open`,{waitUntilFirstUpdate:!0})],vu){constructor(){super(...arguments),m(B,5,this),g(this,`localize`,new sa(this)),_(this,yu,m(B,8,this)),m(B,11,this),_(this,bu,m(B,12,this)),m(B,15,this),_(this,xu,m(B,16,this)),m(B,19,this),_(this,Su,m(B,20,this)),m(B,23,this),g(this,`detailsObserver`),_(this,Cu,m(B,24,this,!1)),m(B,27,this),_(this,wu,m(B,28,this,!1)),m(B,31,this),_(this,Tu,m(B,32,this)),m(B,35,this),_(this,Eu,m(B,36,this,!1)),m(B,39,this),_(this,Du,m(B,40,this)),m(B,43,this)}firstUpdated(){this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.transicao=!0,this.open){if(this.details.open=!0,this.emit(`kk-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await this.esperarTransicao(),this.emit(`kk-after-show`)}else{if(this.emit(`kk-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await this.esperarTransicao(),this.open||(this.details.open=!1),this.emit(`kk-after-hide`)}}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.body.getAnimations().map(e=>e.finished))}async show(){if(!(this.open||this.disabled))return this.open=!0,dc(this,`kk-after-show`)}async hide(){if(this.open&&!this.disabled)return this.open=!1,dc(this,`kk-after-hide`)}render(){let e=this.localize.dir()===`rtl`;return w`
      <details
        part="base"
    ...
    `}};B=f(vu),yu=new WeakMap,bu=new WeakMap,xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,wu=new WeakMap,Tu=new WeakMap,Eu=new WeakMap,Du=new WeakMap,h(B,4,`details`,_u,Ou,yu),h(B,4,`header`,gu,Ou,bu),h(B,4,`body`,hu,Ou,xu),h(B,4,`expandIconSlot`,mu,Ou,Su),h(B,4,`transicao`,pu,Ou,Cu),h(B,4,`open`,fu,Ou,wu),h(B,4,`summary`,du,Ou,Tu),h(B,4,`disabled`,uu,Ou,Eu),h(B,4,`name`,lu,Ou,Du),h(B,1,`handleOpenChange`,cu,Ou),p(B,Ou),g(Ou,`styles`,[D,su]),g(Ou,`dependencies`,{"kk-icon":Ls}),Ou.define(`kk-details`);var ku=C`
  :host {
    display: contents;
  }
...
`,Au,ju,Mu,Nu,Pu,Fu,Iu,Lu,Ru,zu,Bu,Vu=class extends (Fu=M,Pu=[A(`.dialog`)],Nu=[O({type:Boolean,reflect:!0})],Mu=[O({reflect:!0})],ju=[O({attribute:`no-header`,type:Boolean,reflect:!0})],Au=[j(`open`,{waitUntilFirstUpdate:!0})],Fu){constructor(){super(...arguments),m(Iu,5,this),g(this,`hasSlotController`,new fc(this,`footer`)),g(this,`localize`,new sa(this)),_(this,Lu,m(Iu,8,this)),m(Iu,11,this),_(this,Ru,m(Iu,12,this,!1)),m(Iu,15,this),_(this,zu,m(Iu,16,this,``)),m(Iu,19,this),_(this,Bu,m(Iu,20,this,!1)),m(Iu,23,this)}requestClose(e){this.emit(`kk-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented||this.hide()}firstUpdated(){this.open&&this.abrir()}abrir(){this.dialog.open||(this.dialog.showModal(),this.emit(`kk-initial-focus`,{cancelable:!0}))}fechar(){this.dialog.open&&this.dialog.close()}handleOpenChange(){this.open?(this.emit(`kk-show`),this.abrir(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.fechar(),this.emit(`kk-after-hide`))}async show(){this.open||=!0}async hide(){this.open&&=!1}handleCancel(e){e.preventDefault(),this.requestClose(`keyboard`)}handleClose(){this.open=!1}render(){return w`
      <dialog
        part="base"
        class="dialog"
    ...
    `}};Iu=f(Fu),Lu=new WeakMap,Ru=new WeakMap,zu=new WeakMap,Bu=new WeakMap,h(Iu,4,`dialog`,Pu,Vu,Lu),h(Iu,4,`open`,Nu,Vu,Ru),h(Iu,4,`label`,Mu,Vu,zu),h(Iu,4,`noHeader`,ju,Vu,Bu),h(Iu,1,`handleOpenChange`,Au,Vu),p(Iu,Vu),g(Vu,`styles`,[D,ku]),g(Vu,`dependencies`,{"kk-icon-button":I}),Vu.define(`kk-dialog`);var Hu=C`
  :host {
...
`,Uu={top:`bottom`,bottom:`top`,left:`right`,right:`left`};function Wu(e){return e.split(`-`)[0]}function Gu(e){return e.split(`-`)[1]}function Ku(e){return e===`top`||e===`bottom`}function qu(e){let t=Gu(e),n=Uu[Wu(e)];return t===void 0?n:`${n}-${t}`}function Ju(e,t){let n={esquerda:0,topo:0,direita:window.innerWidth,base:window.innerHeight},r=e===void 0?[]:Array.isArray(e)?e:[e];for(let e of r){let t=e.getBoundingClientRect();n.esquerda=Math.max(n.esquerda,t.left),n.topo=Math.max(n.topo,t.top),n.direita=Math.min(n.direita,t.right),n.base=Math.min(n.base,t.bottom)}return{esquerda:n.esquerda+t,topo:n.topo+t,direita:n.direita-t,base:n.base-t}}function Yu(e,t,n,r,i,a){let o=Wu(r),s=Gu(r),c=0,l=0;return Ku(o)?(l=o===`top`?e.top-n-i:e.bottom+i,c=s===`start`?e.left:s===`end`?e.right-t:e.left+(e.width-t)/2,c+=a):(c=o===`left`?e.left-t-i:e.right+i,l=s===`start`?e.top:s===`end`?e.bottom-n:e.top+(e.height-n)/2,l+=a),{x:c,y:l}}function Xu(e,t,n,r,i){return Math.max(0,i.esquerda-e)+Math.max(0,i.topo-t)+Math.max(0,e+n-i.direita)+Math.max(0,t+r-i.base)}function Zu(e,t,n,r,i,a){switch(i){case`top`:return Math.max(0,a.topo-t);case`bottom`:return Math.max(0,t+r-a.base);case`left`:return Math.max(0,a.esquerda-e);case`right`:return Math.max(0,e+n-a.direita)}}function Qu(e,t,n,r){let i=r.direita-r.esquerda,a=r.base-r.topo;switch(t){case`top`:return{largura:i,altura:e.top-r.topo-n};case`bottom`:return{largura:i,altura:r.base-e.bottom-n};case`left`:return{largura:e.left-r.esquerda-n,altura:a};case`right`:return{largura:r.direita-e.right-n,altura:a}}}function $u(e){let t=e.contextElement??(e instanceof Element?e:void 0);if(t===void 0)return!1;let n=t.getBoundingClientRect();if(n.width===0&&n.height===0)return!0;for(let e=t.parentElement;e!==null;e=e.parentElement){let t=getComputedStyle(e);if(!/auto|scroll|hidden|clip/.test(t.overflow+t.overflowX+t.overflowY))continue;let r=e.getBoundingClientRect();if(n.bottom<=r.top||n.top>=r.bottom||n.right<=r.left||n.left>=r.right)return!0}return!1}function ed(e,t,n){let r=n.distancia??0,i=n.desvio??0,a=e.getBoundingClientRect();if(n.espelhar!==void 0){let e=n.espelhar===`width`||n.espelhar===`both`,r=n.espelhar===`height`||n.espelhar===`both`;t.style.width=e?`${a.width}px`:``,t.style.height=r?`${a.height}px`:``}else t.style.width=``,t.style.height=``;let o=t.offsetWidth,s=t.offsetHeight,c=n.posicionamento,l=Ju(n.virarLimite,n.virarPreenchimento??0);if(n.virar===!0){let e=[n.posicionamento,...n.virarAlternativas??[qu(n.posicionamento)]],t=n.posicionamento,u=1/0,d=!1;for(let n of e){let{x:e,y:c}=Yu(a,o,s,n,r,i);if(Zu(e,c,o,s,Wu(n),l)===0){t=n,d=!0;break}let ee=Xu(e,c,o,s,l);ee<u&&(u=ee,t=n)}c=d||(n.virarEstrategia??`melhor-encaixe`)===`melhor-encaixe`?t:n.posicionamento}let u=Wu(c),{x:d,y:ee}=Yu(a,o,s,c,r,i);if(n.deslizar===!0){let e=Ju(n.deslizarLimite,n.deslizarPreenchimento??0);Ku(u)?d=Math.min(Math.max(d,e.esquerda),Math.max(e.esquerda,e.direita-o)):ee=Math.min(Math.max(ee,e.topo),Math.max(e.topo,e.base-s))}let te=n.medirEspaco===!0?Qu(a,u,r,Ju(n.medirLimite,n.medirPreenchimento??0)):{largura:1/0,altura:1/0},ne={};if(n.seta!==void 0){let e=n.setaPreenchimento??0,t=Ku(u)?n.seta.offsetWidth:n.seta.offsetHeight;if(Ku(u)){let n=a.left+a.width/2-d-t/2;ne.x=Math.min(Math.max(n,e),o-t-e)}else{let n=a.top+a.height/2-ee-t/2;ne.y=Math.min(Math.max(n,e),s-t-e)}}return{x:Math.round(d),y:Math.round(ee),posicionamento:c,espacoLivre:te,ancoraOculta:$u(e),seta:ne}}function td(e,t,n){let r=e.contextElement??(e instanceof Element?e:void 0),i=[window];for(let e=r?.parentElement??null;e!==null;e=e.parentElement){let t=getComputedStyle(e);/auto|scroll|overlay/.test(t.overflow+t.overflowX+t.overflowY)&&i.push(e)}for(let e of i)e.addEventListener(`scroll`,n,{passive:!0,capture:!0});window.addEventListener(`resize`,n,{passive:!0});let a=new ResizeObserver(n);return r!==void 0&&a.observe(r),a.observe(t),n(),()=>{for(let e of i)e.removeEventListener(`scroll`,n,{capture:!0});window.removeEventListener(`resize`,n),a.disconnect()}}function nd(e){return(Array.isArray(e)?e:String(e).split(` `)).map(e=>e.trim()).filter(e=>e!==``)}function rd(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e.contextElement instanceof Element:!0)}var id,ad,od,sd,cd,ld,ud,dd,fd,pd,md,hd,gd,_d,vd,yd,bd,xd,Sd,Cd,wd,Td,Ed,Dd,Od,V,kd,Ad,jd,Md,Nd,Pd,Fd,Id,Ld,Rd,zd,Bd,Vd,Hd,Ud,Wd,Gd,Kd,qd,Jd,Yd,Xd,Zd,Qd,H=class extends (Od=M,Dd=[A(`.popup`)],Ed=[A(`.popup__arrow`)],Td=[A(`.popup-hover-bridge`)],wd=[O()],Cd=[O({type:Boolean,reflect:!0})],Sd=[O({reflect:!0})],xd=[O({type:Number})],bd=[O({type:Number})],yd=[O({type:Boolean})],vd=[O({attribute:`arrow-placement`})],_d=[O({attribute:`arrow-padding`,type:Number})],gd=[O({type:Boolean})],hd=[O({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],md=[O({attribute:`flip-fallback-strategy`})],pd=[O({type:Object})],fd=[O({attribute:`flip-padding`,type:Number})],dd=[O({type:Boolean})],ud=[O({type:Object})],ld=[O({attribute:`shift-padding`,type:Number})],cd=[O({attribute:`auto-size`})],sd=[O()],od=[O({type:Object})],ad=[O({attribute:`auto-size-padding`,type:Number})],id=[O({attribute:`hover-bridge`,type:Boolean})],Od){constructor(){super(...arguments),g(this,`anchorEl`),g(this,`cleanup`),g(this,`localize`,new sa(this)),_(this,kd,m(V,8,this)),m(V,11,this),_(this,Ad,m(V,12,this)),m(V,15,this),_(this,jd,m(V,16,this)),m(V,19,this),_(this,Md,m(V,20,this)),m(V,23,this),_(this,Nd,m(V,24,this,!1)),m(V,27,this),_(this,Pd,m(V,28,this,`top`)),m(V,31,this),_(this,Fd,m(V,32,this,0)),m(V,35,this),_(this,Id,m(V,36,this,0)),m(V,39,this),_(this,Ld,m(V,40,this,!1)),m(V,43,this),_(this,Rd,m(V,44,this,`anchor`)),m(V,47,this),_(this,zd,m(V,48,this,10)),m(V,51,this),_(this,Bd,m(V,52,this,!1)),m(V,55,this),_(this,Vd,m(V,56,this,``)),m(V,59,this),_(this,Hd,m(V,60,this,`best-fit`)),m(V,63,this),_(this,Ud,m(V,64,this)),m(V,67,this),_(this,Wd,m(V,68,this,0)),m(V,71,this),_(this,Gd,m(V,72,this,!1)),m(V,75,this),_(this,Kd,m(V,76,this)),m(V,79,this),_(this,qd,m(V,80,this,0)),m(V,83,this),_(this,Jd,m(V,84,this)),m(V,87,this),_(this,Yd,m(V,88,this)),m(V,91,this),_(this,Xd,m(V,92,this)),m(V,95,this),_(this,Zd,m(V,96,this,0)),m(V,99,this),_(this,Qd,m(V,100,this,!1)),m(V,103,this),g(this,`updateHoverBridge`,()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--kk-popup-hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-y`,`${u}px`)}})}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),(e.has(`active`)||e.has(`hoverBridge`))&&this.syncTopLayer(),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}syncTopLayer(){if(!this.isConnected||!this.popup||!this.hoverBridgeEl)return;let e=this.active&&this.hoverBridge;e&&!this.hoverBridgeEl.matches(`:popover-open`)&&this.popup.matches(`:popover-open`)&&this.popup.hidePopover(),e!==this.hoverBridgeEl.matches(`:popover-open`)&&(e?this.hoverBridgeEl.showPopover():this.hoverBridgeEl.hidePopover()),this.active!==this.popup.matches(`:popover-open`)&&(this.active?this.popup.showPopover():this.popup.hidePopover())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor==`string`){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchorEl=this.anchor instanceof Element||rd(this.anchor)?this.anchor:this.querySelector(`[slot="anchor"]`);this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=td(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.removeAttribute(`data-anchor-hidden`),this.style.removeProperty(`--kk-popup-auto-size-available-width`),this.style.removeProperty(`--kk-popup-auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let{x:e,y:t,posicionamento:n,espacoLivre:r,ancoraOculta:i,seta:a}=ed(this.anchorEl,this.popup,{posicionamento:this.placement,distancia:this.distance,desvio:this.skidding,virar:this.flip,...this.flipFallbackPlacements.length>0?{virarAlternativas:nd(this.flipFallbackPlacements)}:{},virarEstrategia:this.flipFallbackStrategy===`best-fit`?`melhor-encaixe`:`inicial`,virarLimite:this.flipBoundary,virarPreenchimento:this.flipPadding,deslizar:this.shift,deslizarLimite:this.shiftBoundary,deslizarPreenchimento:this.shiftPadding,medirEspaco:!!this.autoSize,medirLimite:this.autoSizeBoundary,medirPreenchimento:this.autoSizePadding,...this.sync?{espelhar:this.sync}:{},...this.arrow?{seta:this.arrowEl,setaPreenchimento:this.arrowPadding}:{}});if(this.setAttribute(`data-current-placement`,n),this.toggleAttribute(`data-anchor-hidden`,i),this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-height`,`${r.altura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-width`,`${r.largura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-width`),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=this.localize.dir()===`rtl`,t={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[n.split(`-`)[0]],r=``,i=``,o=``,s=``;if(this.arrowPlacement===`start`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;r=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``,i=e?t:``,s=e?``:t}else if(this.arrowPlacement===`end`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;i=e?``:t,s=e?t:``,o=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(s=typeof a.x==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``,r=typeof a.y==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``):(s=typeof a.x==`number`?`${a.x}px`:``,r=typeof a.y==`number`?`${a.y}px`:``);Object.assign(this.arrowEl.style,{top:r,right:i,bottom:o,left:s,[t]:`calc(var(--kk-popup-arrow-size-diagonal) * -1)`})}requestAnimationFrame(()=>this.updateHoverBridge()),this.emit(`kk-reposition`)}render(){return w`
    ...
    `}};V=f(Od),kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=new WeakMap,Hd=new WeakMap,Ud=new WeakMap,Wd=new WeakMap,Gd=new WeakMap,Kd=new WeakMap,qd=new WeakMap,Jd=new WeakMap,Yd=new WeakMap,Xd=new WeakMap,Zd=new WeakMap,Qd=new WeakMap,h(V,4,`popup`,Dd,H,kd),h(V,4,`arrowEl`,Ed,H,Ad),h(V,4,`hoverBridgeEl`,Td,H,jd),h(V,4,`anchor`,wd,H,Md),h(V,4,`active`,Cd,H,Nd),h(V,4,`placement`,Sd,H,Pd),h(V,4,`distance`,xd,H,Fd),h(V,4,`skidding`,bd,H,Id),h(V,4,`arrow`,yd,H,Ld),h(V,4,`arrowPlacement`,vd,H,Rd),h(V,4,`arrowPadding`,_d,H,zd),h(V,4,`flip`,gd,H,Bd),h(V,4,`flipFallbackPlacements`,hd,H,Vd),h(V,4,`flipFallbackStrategy`,md,H,Hd),h(V,4,`flipBoundary`,pd,H,Ud),h(V,4,`flipPadding`,fd,H,Wd),h(V,4,`shift`,dd,H,Gd),h(V,4,`shiftBoundary`,ud,H,Kd),h(V,4,`shiftPadding`,ld,H,qd),h(V,4,`autoSize`,cd,H,Jd),h(V,4,`sync`,sd,H,Yd),h(V,4,`autoSizeBoundary`,od,H,Xd),h(V,4,`autoSizePadding`,ad,H,Zd),h(V,4,`hoverBridge`,id,H,Qd),p(V,H),g(H,`styles`,[D,Hu]);function*$d(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*$d(e.shadowRoot.activeElement)))}function ef(){return[...$d()].pop()}var tf=new WeakMap;function nf(e){let t=tf.get(e);return t||(t=window.getComputedStyle(e,null),tf.set(e,t)),t}function rf(e){if(typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=nf(e);return t.visibility!==`hidden`&&t.display!==`none`}function af(e){let{overflowY:t,overflowX:n}=nf(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function of(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));if(e.hasAttribute(`tabindex`)&&(Number.isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`))return!1;if(t===`input`&&e.getAttribute(`type`)===`radio`){let t=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute(`name`)}"]`,r=t.querySelector(`${n}:checked`);return r?r===e:t.querySelector(n)===e}return rf(e)?(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:af(e):!1}function sf(e){let t=lf(e);return{start:t[0]??null,end:t.at(-1)??null}}function cf(e,t){return e.getRootNode({composed:!0})?.host!==t}function lf(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),i instanceof HTMLElement&&!n.includes(i)&&of(i)&&n.push(i),i instanceof HTMLSlotElement&&cf(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of i.children)r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var uf=C`
  :host {
    display: inline-block;
  }
...
`,df,ff,pf,mf,hf,gf,_f,vf,yf,bf,xf,Sf,Cf,U,wf,Tf,Ef,Df,Of,kf,Af,jf,Mf,Nf,Pf,Ff=class extends (Cf=M,Sf=[A(`.dropdown`)],xf=[A(`.dropdown__trigger`)],bf=[A(`.dropdown__panel`)],yf=[O({type:Boolean,reflect:!0})],vf=[O({reflect:!0})],_f=[O({type:Boolean,reflect:!0})],gf=[O({attribute:`stay-open-on-select`,type:Boolean,reflect:!0})],hf=[O({attribute:!1})],mf=[O({type:Number})],pf=[O({type:Number})],ff=[O({reflect:!0})],df=[j(`open`,{waitUntilFirstUpdate:!0})],Cf){constructor(){super(...arguments),m(U,5,this),_(this,wf,m(U,8,this)),m(U,11,this),_(this,Tf,m(U,12,this)),m(U,15,this),_(this,Ef,m(U,16,this)),m(U,19,this),g(this,`closeWatcher`),_(this,Df,m(U,20,this,!1)),m(U,23,this),_(this,Of,m(U,24,this,`bottom-start`)),m(U,27,this),_(this,kf,m(U,28,this,!1)),m(U,31,this),_(this,Af,m(U,32,this,!1)),m(U,35,this),_(this,jf,m(U,36,this)),m(U,39,this),_(this,Mf,m(U,40,this,0)),m(U,43,this),_(this,Nf,m(U,44,this,0)),m(U,47,this),_(this,Pf,m(U,48,this)),m(U,51,this),g(this,`handleKeyDown`,e=>{this.open&&e.key===`Escape`&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())}),g(this,`handleDocumentKeyDown`,e=>{if(e.key===`Escape`&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key===`Tab`){if(this.open&&document.activeElement?.tagName.toLowerCase()===`kk-menu-item`){e.preventDefault(),this.hide(),this.focusOnTrigger();return}let t=(e,n)=>{if(!e)return null;let r=e.closest(n);if(r)return r;let i=e.getRootNode();return i instanceof ShadowRoot?t(i.host,n):null};setTimeout(()=>{let e=this.containingElement?.getRootNode()instanceof ShadowRoot?ef():document.activeElement;(!this.containingElement||t(e,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}}),g(this,`handleDocumentMouseDown`,e=>{let t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()}),g(this,`handlePanelSelect`,e=>{let t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()===`kk-menu`&&(this.hide(),this.focusOnTrigger())})}connectedCallback(){super.connectedCallback(),this.containingElement||=this}firstUpdated(){this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){let e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus==`function`&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()===`kk-menu`)}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([` `,`Enter`].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}let t=this.getMenu();if(t){let n=t.getAllItems();if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){e.preventDefault(),this.open||(this.show(),await this.updateComplete);let r=e.key===`ArrowDown`||e.key===`Home`?n.at(0):n.at(-1);r&&this.updateComplete.then(()=>{t.setCurrentItem(r),r.focus()})}}}handleTriggerKeyUp(e){e.key===` `&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){let e=this.trigger.assignedElements({flatten:!0}).find(e=>sf(e).start),t;if(e){switch(e.tagName.toLowerCase()){case`kk-button`:case`kk-icon-button`:t=e.button;break;default:t=e}t.setAttribute(`aria-haspopup`,`true`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`)}}async show(){if(!this.open)return this.open=!0,dc(this,`kk-after-show`)}painelTemFoco(){let e=this.panel?.assignedElements({flatten:!0})??[];for(let t of $d())if(e.some(e=>e===t||e.contains(t)))return!0;return!1}async hide(){if(this.open)return this.painelTemFoco()&&this.focusOnTrigger(),this.open=!1,dc(this,`kk-after-hide`)}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener(`kk-select`,this.handlePanelSelect),`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`mousedown`,this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener(`kk-select`,this.handlePanelSelect),this.panel.removeEventListener(`keydown`,this.handleKeyDown)),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`mousedown`,this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}this.updateAccessibleTrigger(),this.open?(this.emit(`kk-show`),this.addOpenListeners(),this.popup.active=!0,await this.esperarTransicao(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.removeOpenListeners(),await this.esperarTransicao(),this.open||(this.popup.active=!1),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.popup.popup.getAnimations().map(e=>e.finished))}render(){return w`
      <kk-popup
        part="base"
    ...
    `}};U=f(Cf),wf=new WeakMap,Tf=new WeakMap,Ef=new WeakMap,Df=new WeakMap,Of=new WeakMap,kf=new WeakMap,Af=new WeakMap,jf=new WeakMap,Mf=new WeakMap,Nf=new WeakMap,Pf=new WeakMap,h(U,4,`popup`,Sf,Ff,wf),h(U,4,`trigger`,xf,Ff,Tf),h(U,4,`panel`,bf,Ff,Ef),h(U,4,`open`,yf,Ff,Df),h(U,4,`placement`,vf,Ff,Of),h(U,4,`disabled`,_f,Ff,kf),h(U,4,`stayOpenOnSelect`,gf,Ff,Af),h(U,4,`containingElement`,hf,Ff,jf),h(U,4,`distance`,mf,Ff,Mf),h(U,4,`skidding`,pf,Ff,Nf),h(U,4,`sync`,ff,Ff,Pf),h(U,1,`handleOpenChange`,df,Ff),p(U,Ff),g(Ff,`styles`,[D,uf]),g(Ff,`dependencies`,{"kk-popup":H}),Ff.define(`kk-dropdown`);var If=C`
  :host {
...
`,Lf=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Lf(e,t);return!0},Rf=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},zf=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Hf(t)}};function Bf(e){this._$AN===void 0?this._$AM=e:(Rf(this),this._$AM=e,zf(this))}function Vf(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0){if(t){if(Array.isArray(r))for(let e=n;e<r.length;e++)Lf(r[e],!1),Rf(r[e]);else r!=null&&(Lf(r,!1),Rf(r))}else Lf(this,e)}}var Hf=e=>{e.type==bo.CHILD&&(e._$AP??=Vf,e._$AQ??=Bf)},Uf=class extends So{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),zf(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Lf(this,e),Rf(this))}setValue(e){if(ss(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Wf=()=>new Gf,Gf=class{},Kf=new WeakMap,qf=xo(class extends Uf{render(e){return T}update(e,[t]){let n=t!==this.G;return n&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),T}rt(e){if(this.G!==void 0){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Kf.get(t);n===void 0&&(n=new WeakMap,Kf.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}}get lt(){return typeof this.G==`function`?Kf.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Jf=class{host;popupRef=Wf();enableSubmenuTimer=-1;isConnected=!1;isPopupConnected=!1;skidding=0;hasSlotController;submenuOpenDelay=100;constructor(e,t){this.host=e,e.addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test(`submenu`)&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test(`submenu`)&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||=(this.host.addEventListener(`mousemove`,this.handleMouseMove),this.host.addEventListener(`mouseover`,this.handleMouseOver),this.host.addEventListener(`keydown`,this.handleKeyDown),this.host.addEventListener(`click`,this.handleClick),this.host.addEventListener(`focusout`,this.handleFocusOut),!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.addEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&=(this.host.removeEventListener(`mousemove`,this.handleMouseMove),this.host.removeEventListener(`mouseover`,this.handleMouseOver),this.host.removeEventListener(`keydown`,this.handleKeyDown),this.host.removeEventListener(`click`,this.handleClick),this.host.removeEventListener(`focusout`,this.handleFocusOut),!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.removeEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!1)}handleMouseMove=e=>{this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-x`,`${e.clientX}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-y`,`${e.clientY}px`)};handleMouseOver=()=>{this.hasSlotController.test(`submenu`)&&this.enableSubmenu()};handleSubmenuEntry(e){let t=this.host.renderRoot.querySelector(`slot[name='submenu']`);if(!t){console.error(`Cannot activate a submenu if no corresponding menuitem can be found.`,this);return}let n=null;for(let e of t.assignedElements())if(n=e.querySelectorAll(`kk-menu-item, [role^='menuitem']`),n.length!==0)break;if(n&&n.length!==0){n[0].setAttribute(`tabindex`,`0`);for(let e=1;e!==n.length;++e)n[e].setAttribute(`tabindex`,`-1`);this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?n[0]instanceof HTMLElement&&n[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{n[0]instanceof HTMLElement&&n[0].focus()}),this.host.requestUpdate()))}}handleKeyDown=e=>{switch(e.key){case`Escape`:case`Tab`:this.disableSubmenu();break;case`ArrowLeft`:e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case`ArrowRight`:case`Enter`:case` `:this.handleSubmenuEntry(e)}};handleClick=e=>{e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName===`kk-menu-item`||e.target.role?.startsWith(`menuitem`))&&this.disableSubmenu()};handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu()};handlePopupMouseover=e=>{e.stopPropagation()};handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector(`slot[name='submenu']`)?.assignedElements({flatten:!0}).filter(e=>e.localName===`kk-menu`)[0],t=getComputedStyle(this.host).direction===`rtl`;if(!e)return;let{left:n,top:r,width:i,height:a}=e.getBoundingClientRect();this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-y`,`${r}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-y`,`${r+a}px`)};setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;let e=this.host.parentElement.computedStyleMap(),t=[`padding-top`,`border-top-width`,`margin-top`].reduce((t,n)=>{let r=e.get(n)??new CSSUnitValue(0,`px`);return t-(r instanceof CSSUnitValue?r:new CSSUnitValue(0,`px`)).to(`px`).value},0);this.skidding=t}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){let e=getComputedStyle(this.host).direction===`rtl`;return this.isConnected?w`
    ...
    `:w` <slot name="submenu" hidden></slot> `}},Yf,Xf,Zf,Qf,$f,ep,tp,np,rp,ip,ap,W,op,sp,cp,lp,up,dp,fp,pp=class extends (ap=M,ip=[A(`slot:not([name])`)],rp=[A(`.menu-item`)],np=[O()],tp=[O({type:Boolean,reflect:!0})],ep=[O()],$f=[O({type:Boolean,reflect:!0})],Qf=[O({type:Boolean,reflect:!0})],Zf=[j(`checked`)],Xf=[j(`disabled`)],Yf=[j(`type`)],ap){constructor(){super(...arguments),m(W,5,this),g(this,`cachedTextLabel`),g(this,`localize`,new sa(this)),_(this,op,m(W,8,this)),m(W,11,this),_(this,sp,m(W,12,this)),m(W,15,this),_(this,cp,m(W,16,this,`normal`)),m(W,19,this),_(this,lp,m(W,20,this,!1)),m(W,23,this),_(this,up,m(W,24,this,``)),m(W,27,this),_(this,dp,m(W,28,this,!1)),m(W,31,this),_(this,fp,m(W,32,this,!1)),m(W,35,this),g(this,`hasSlotController`,new fc(this,`submenu`,`description`)),g(this,`submenuController`,new Jf(this,this.hasSlotController)),g(this,`handleHostClick`,e=>{this.disabled&&(e.preventDefault(),e.stopImmediatePropagation())}),g(this,`handleMouseOver`,e=>{this.focus(),e.stopPropagation()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.handleHostClick),this.addEventListener(`mouseover`,this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.handleHostClick),this.removeEventListener(`mouseover`,this.handleMouseOver)}handleDefaultSlotChange(){let e=this.getTextLabel();if(typeof this.cachedTextLabel>`u`){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit(`slotchange`,{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!==`checkbox`){this.checked=!1,console.error(`The checked attribute can only be used on menu items with type="checkbox"`,this);return}this.type===`checkbox`?this.setAttribute(`aria-checked`,this.checked?`true`:`false`):this.removeAttribute(`aria-checked`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleTypeChange(){this.type===`checkbox`?(this.setAttribute(`role`,`menuitemcheckbox`),this.setAttribute(`aria-checked`,this.checked?`true`:`false`)):(this.setAttribute(`role`,`menuitem`),this.removeAttribute(`aria-checked`))}getTextLabel(){return pc(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test(`submenu`)}render(){let e=this.localize.dir()===`rtl`,t=this.submenuController.isExpanded();return w`
      <div
        id="anchor"
        part="base"
    ...
    `}};W=f(ap),op=new WeakMap,sp=new WeakMap,cp=new WeakMap,lp=new WeakMap,up=new WeakMap,dp=new WeakMap,fp=new WeakMap,h(W,4,`defaultSlot`,ip,pp,op),h(W,4,`menuItem`,rp,pp,sp),h(W,4,`type`,np,pp,cp),h(W,4,`checked`,tp,pp,lp),h(W,4,`value`,ep,pp,up),h(W,4,`loading`,$f,pp,dp),h(W,4,`disabled`,Qf,pp,fp),h(W,1,`handleCheckedChange`,Zf,pp),h(W,1,`handleDisabledChange`,Xf,pp),h(W,1,`handleTypeChange`,Yf,pp),p(W,pp),g(pp,`styles`,[D,If]),g(pp,`dependencies`,{"kk-icon":Ls,"kk-popup":H,"kk-spinner":Jc});var mp=C`
  :host {
    display: block;
    position: relative;
...
`,hp,gp,_p,vp,yp=class extends (gp=M,hp=[A(`slot`)],gp){constructor(){super(...arguments),_(this,vp,m(_p,8,this)),m(_p,11,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`menu`)}handleClick(e){let t=[`menuitem`,`menuitemcheckbox`],n=e.composedPath(),r=n.find(e=>e instanceof Element&&t.includes(e.getAttribute(`role`)??``));if(!r||n.find(e=>e instanceof Element&&e.getAttribute(`role`)===`menu`)!==this)return;let i=r;i.type===`checkbox`&&(i.checked=!i.checked),this.emit(`kk-select`,{detail:{item:i}})}handleKeyDown(e){if(e.key===`Enter`||e.key===` `){let t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){let t=this.getAllItems(),n=this.getCurrentItem(),r=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key===`ArrowDown`?r++:e.key===`ArrowUp`?r--:e.key===`Home`?r=0:e.key===`End`&&(r=t.length-1),r<0&&(r=t.length-1),r>t.length-1&&(r=0),this.setCurrentItem(t[r]),t[r].focus())}}handleMouseDown(e){let t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){let e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()===`kk-menu-item`||[`menuitem`,`menuitemcheckbox`,`menuitemradio`].includes(e.getAttribute(`role`)??``)}getAllItems(){return this.defaultSlot.assignedElements({flatten:!0}).filter(e=>!(!(e instanceof HTMLElement)||e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute(`tabindex`)===`0`)}setCurrentItem(e){this.getAllItems().forEach(t=>{t.setAttribute(`tabindex`,t===e?`0`:`-1`)})}render(){return w`
      ...
      ></slot>
    `}};_p=f(gp),vp=new WeakMap,h(_p,4,`defaultSlot`,hp,yp,vp),p(_p,yp),g(yp,`styles`,[D,mp]);var bp=C`
  /*
...
`,Sp=xo(class extends So{constructor(e){if(super(e),e.type!==bo.PROPERTY&&e.type!==bo.ATTRIBUTE&&e.type!==bo.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ss(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Qa||t===T)return t;let n=e.element,r=e.name;if(e.type===bo.PROPERTY){if(t===n[r])return Qa}else if(e.type===bo.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Qa}else if(e.type===bo.ATTRIBUTE&&n.getAttribute(r)===t+``)return Qa;return ls(e),t}}),Cp=C`
...
`;function wp(e){return e.validity.valid?``:e.validationMessage===``?` `:e.validationMessage}var Tp=class{host;interacaoEm;vistos=new Set;interagiu=!1;constructor(e,t){this.host=e,this.interacaoEm=t?.interacaoEm??[`kk-blur`,`kk-input`],e.addController(this)}hostConnected(){this.host.addEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.addEventListener(e,this.aoInteragir)}hostDisconnected(){this.host.removeEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.removeEventListener(e,this.aoInteragir)}aoInvalidar=e=>{this.conferindo||this.marcarInteragido(),this.host.emitInvalidEvent(e)};conferindo=!1;conferir(e){this.conferindo=!0;try{return e()}finally{this.conferindo=!1}}aoInteragir=e=>{this.vistos.add(e.type),!(this.vistos.size<this.interacaoEm.length)&&this.marcarInteragido()};marcarInteragido(){this.interagiu||(this.interagiu=!0,this.host.updateValidity())}esquecerInteracao(){this.vistos.clear(),this.interagiu=!1}aplicar(e,t){let n=this.host.required===!0;t(`--required`,n),t(`--optional`,!n),t(`--valid`,e),t(`--invalid`,!e),t(`--user-valid`,e&&this.interagiu),t(`--user-invalid`,!e&&this.interagiu)}},Ep,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp,zp,Bp,Vp,Hp,Up,Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,G,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm,Tm,Em,Dm,Om,km,Am,jm,Mm,Nm,Pm,Fm,Im,Lm,Rm,zm,Bm,Vm,Hm,K=class extends (lm=M,cm=[A(`.input__control`)],sm=[k()],om=[O()],am=[O({reflect:!0})],im=[O()],rm=[O()],nm=[Do()],tm=[O({reflect:!0})],em=[O({type:Boolean,reflect:!0})],$p=[O({type:Boolean,reflect:!0})],Qp=[O()],Zp=[O({attribute:`help-text`})],Xp=[O({type:Boolean})],Yp=[O({type:Boolean,reflect:!0})],Jp=[O()],qp=[O({type:Boolean,reflect:!0})],Kp=[O({attribute:`password-toggle`,type:Boolean})],Gp=[O({attribute:`password-visible`,type:Boolean})],Wp=[O({attribute:`no-spin-buttons`,type:Boolean})],Up=[O({reflect:!0,converter:Xo})],Hp=[O({type:Boolean,reflect:!0})],Vp=[O()],Bp=[O({type:Number})],zp=[O({type:Number})],Rp=[O()],Lp=[O()],Ip=[O()],Fp=[O()],Pp=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],Np=[O()],Mp=[O({type:Boolean})],jp=[O()],Ap=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],kp=[O()],Op=[j(`disabled`,{waitUntilFirstUpdate:!0})],Dp=[j(`step`,{waitUntilFirstUpdate:!0})],Ep=[j(`value`,{waitUntilFirstUpdate:!0})],lm){constructor(){super(...arguments),m(G,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),g(this,`localize`,new sa(this)),_(this,um,m(G,8,this)),m(G,11,this),_(this,dm,m(G,12,this,!1)),m(G,15,this),_(this,fm,m(G,16,this,``)),m(G,19,this),g(this,`__numberInput`,Object.assign(document.createElement(`input`),{type:`number`})),g(this,`__dateInput`,Object.assign(document.createElement(`input`),{type:`date`})),_(this,pm,m(G,20,this,`text`)),m(G,23,this),_(this,mm,m(G,24,this,``)),m(G,27,this),_(this,hm,m(G,28,this,``)),m(G,31,this),g(this,`defaultValue`,m(G,140,this,``)),m(G,143,this),_(this,gm,m(G,32,this,`medium`)),m(G,35,this),_(this,_m,m(G,36,this,!1)),m(G,39,this),_(this,vm,m(G,40,this,!1)),m(G,43,this),_(this,ym,m(G,44,this,``)),m(G,47,this),_(this,bm,m(G,48,this,``)),m(G,51,this),_(this,xm,m(G,52,this,!1)),m(G,55,this),_(this,Sm,m(G,56,this,!1)),m(G,59,this),_(this,Cm,m(G,60,this,``)),m(G,63,this),_(this,wm,m(G,64,this,!1)),m(G,67,this),_(this,Tm,m(G,68,this,!1)),m(G,71,this),_(this,Em,m(G,72,this,!1)),m(G,75,this),_(this,Dm,m(G,76,this,!1)),m(G,79,this),_(this,Om,m(G,80,this,``)),m(G,83,this),_(this,km,m(G,84,this,!1)),m(G,87,this),_(this,Am,m(G,88,this)),m(G,91,this),_(this,jm,m(G,92,this)),m(G,95,this),_(this,Mm,m(G,96,this)),m(G,99,this),_(this,Nm,m(G,100,this)),m(G,103,this),_(this,Pm,m(G,104,this)),m(G,107,this),_(this,Fm,m(G,108,this)),m(G,111,this),_(this,Im,m(G,112,this)),m(G,115,this),_(this,Lm,m(G,116,this,!0)),m(G,119,this),_(this,Rm,m(G,120,this)),m(G,123,this),_(this,zm,m(G,124,this)),m(G,127,this),_(this,Bm,m(G,128,this)),m(G,131,this),_(this,Vm,m(G,132,this,!0)),m(G,135,this),_(this,Hm,m(G,136,this)),m(G,139,this)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`kk-clear`),this.emit(`kk-input`),this.emit(`kk-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.updateValidity(),this.emit(`kk-input`)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this._internals.form?.requestSubmit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.input.disabled=this.disabled,this.updateValidity()}handleStepChange(){this.input.step=String(this.step),this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){let e=this.input.validity.valid;this.toggleState(`--empty`,!this.value),this.validade.aplicar(e,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return w`
      <div
        part="form-control"
    ...
    `}};G=f(lm),um=new WeakMap,dm=new WeakMap,fm=new WeakMap,pm=new WeakMap,mm=new WeakMap,hm=new WeakMap,gm=new WeakMap,_m=new WeakMap,vm=new WeakMap,ym=new WeakMap,bm=new WeakMap,xm=new WeakMap,Sm=new WeakMap,Cm=new WeakMap,wm=new WeakMap,Tm=new WeakMap,Em=new WeakMap,Dm=new WeakMap,Om=new WeakMap,km=new WeakMap,Am=new WeakMap,jm=new WeakMap,Mm=new WeakMap,Nm=new WeakMap,Pm=new WeakMap,Fm=new WeakMap,Im=new WeakMap,Lm=new WeakMap,Rm=new WeakMap,zm=new WeakMap,Bm=new WeakMap,Vm=new WeakMap,Hm=new WeakMap,h(G,4,`input`,cm,K,um),h(G,4,`hasFocus`,sm,K,dm),h(G,4,`title`,om,K,fm),h(G,4,`type`,am,K,pm),h(G,4,`name`,im,K,mm),h(G,4,`value`,rm,K,hm),h(G,4,`size`,tm,K,gm),h(G,4,`filled`,em,K,_m),h(G,4,`pill`,$p,K,vm),h(G,4,`label`,Qp,K,ym),h(G,4,`helpText`,Zp,K,bm),h(G,4,`clearable`,Xp,K,xm),h(G,4,`disabled`,Yp,K,Sm),h(G,4,`placeholder`,Jp,K,Cm),h(G,4,`readonly`,qp,K,wm),h(G,4,`passwordToggle`,Kp,K,Tm),h(G,4,`passwordVisible`,Gp,K,Em),h(G,4,`noSpinButtons`,Wp,K,Dm),h(G,4,`form`,Up,K,Om),h(G,4,`required`,Hp,K,km),h(G,4,`pattern`,Vp,K,Am),h(G,4,`minlength`,Bp,K,jm),h(G,4,`maxlength`,zp,K,Mm),h(G,4,`min`,Rp,K,Nm),h(G,4,`max`,Lp,K,Pm),h(G,4,`step`,Ip,K,Fm),h(G,4,`autocapitalize`,Fp,K,Im),h(G,4,`autocorrect`,Pp,K,Lm),h(G,4,`autocomplete`,Np,K,Rm),h(G,4,`autofocus`,Mp,K,zm),h(G,4,`enterkeyhint`,jp,K,Bm),h(G,4,`spellcheck`,Ap,K,Vm),h(G,4,`inputmode`,kp,K,Hm),h(G,1,`handleDisabledChange`,Op,K),h(G,1,`handleStepChange`,Dp,K),h(G,1,`handleValueChange`,Ep,K),h(G,5,`defaultValue`,nm,K),p(G,K),g(K,`styles`,[D,Cp,xp]),g(K,`dependencies`,{"kk-icon":Ls}),g(K,`formAssociated`,!0);function Um(e,t,n){return(e=>Object.is(e,-0)?0:e)(e<t?t:e>n?n:e)}var Wm=new Set(`p.br.div.span.h1.h2.h3.h4.strong.b.em.i.u.s.strike.sub.sup.mark.ul.ol.li.blockquote.hr.a.img.table.thead.tbody.tr.th.td`.split(`.`)),Gm={"*":[`class`,`style`],a:[`href`,`title`,`data-nota`],img:[`src`,`alt`],td:[`colspan`,`rowspan`],th:[`colspan`,`rowspan`]},Km=new Set([`script`,`style`,`iframe`,`object`,`embed`,`template`]),qm=[{classe:`destaque--azul`,termo:`editorColorBlue`,icone:`highlight`},{classe:`destaque--verde`,termo:`editorColorGreen`,icone:`highlight`},{classe:`destaque--vermelho`,termo:`editorColorRed`,icone:`highlight`},{classe:`destaque--amarelo`,termo:`editorColorYellow`,icone:`highlight`},{classe:`destaque--ciano`,termo:`editorColorCyan`,icone:`highlight`}],Jm=qm.map(e=>e.classe),Ym=[{classe:`paragrafo--espacado`,termo:`editorParagraphSpaced`,icone:`line-height`},{classe:`paragrafo--emoldurado`,termo:`editorParagraphBordered`,icone:`border-horizontal`},{classe:`paragrafo--recuado`,termo:`editorParagraphIndented`,icone:`indent-increase`},{classe:`paragrafo--capitular`,termo:`editorParagraphDropCap`,icone:`letter-a`},{classe:`paragrafo--epigrafe`,termo:`editorParagraphEpigraph`,icone:`quote`},{classe:`paragrafo--epigrafe-subtitulo`,termo:`editorParagraphEpigraphSubtitle`,icone:`text-caption`},{classe:`paragrafo--versaletes`,termo:`editorParagraphSmallCaps`,icone:`letter-case-upper`},{classe:`paragrafo--versaletes-subtitulo`,termo:`editorParagraphSmallCapsSubtitle`,icone:`text-caption`},{classe:`paragrafo--miudo`,termo:`editorParagraphFinePrint`,icone:`text-decrease`},{classe:`paragrafo--colunas`,termo:`editorParagraphColumns`,icone:`columns-2`},{classe:`rodape-notas`,termo:`editorParagraphFootnotes`,icone:`notes`}],Xm=Ym.map(e=>e.classe),Zm={"paragrafo--epigrafe":`paragrafo--epigrafe-subtitulo`,"paragrafo--versaletes":`paragrafo--versaletes-subtitulo`,"poesia--escritura":`poesia--fonte`},Qm=Object.keys(Zm).map(e=>`.${e}`).join(`, `);function $m(e){let t=[...e.querySelectorAll(`br`)];if(t.length===0)return null;for(let n of t){let t=document.createRange();if(t.setStartAfter(n),t.setEnd(e,e.childNodes.length),/^[\s\u00a0]*[—–]/.test(t.toString()))return n}return t[t.length-1]??null}function eh(e,t){let n=$m(e);if(n===null)return;let r=document.createRange();r.setStartAfter(n),r.setEnd(e,e.childNodes.length);let i=r.extractContents();n.remove();let a=document.createElement(`p`);a.className=t,a.append(i),th(a),th(e),a.textContent?.trim()!==``&&e.after(a)}function th(e){let t=e.querySelector(`:not(br, img, hr):empty`);for(;t!==null;)t.remove(),t=e.querySelector(`:not(br, img, hr):empty`)}function nh(e){if(!Object.keys(Zm).some(t=>e.includes(t)))return e;let t=document.createElement(`div`);t.innerHTML=e;for(let e of t.querySelectorAll(Qm))for(let[t,n]of Object.entries(Zm))e.classList.contains(t)&&eh(e,n);return t.innerHTML}var rh=[{classe:`poesia--tema`,termo:`editorPoetryTheme`,icone:`book-2`},{classe:`poesia--verso`,termo:`editorPoetryVerse`,icone:`text-wrap`},{classe:`poesia--escritura`,termo:`editorPoetryScripture`,icone:`quote`},{classe:`poesia--fonte`,termo:`editorPoetrySource`,icone:`signature`},{classe:`poesia--refrao`,termo:`editorPoetryRefrain`,icone:`repeat`},{classe:`poesia--dedicatoria`,termo:`editorPoetryDedication`,icone:`gift`}],ih=rh.map(e=>e.classe),ah=[{termo:`editorTypoEmDash`,amostra:`—`,abre:`— `},{termo:`editorTypoEnDash`,amostra:`–`,abre:`–`},{termo:`editorTypoDoubleQuotes`,amostra:`“ ”`,abre:`“`,fecha:`”`},{termo:`editorTypoSingleQuotes`,amostra:`‘ ’`,abre:`‘`,fecha:`’`},{termo:`editorTypoNbsp`,amostra:`␣`,abre:`\xA0`}],oh=new Set([...Jm,...Xm,...ih,`note-nota-ref`]),sh=/^var\(--kk-color-[a-z0-9-]+\)$/,ch={"text-align":/^(left|center|right|justify)$/,color:sh,"background-color":sh};function lh(e){let t=[];for(let n of e.split(`;`)){let e=n.indexOf(`:`);if(e<0)continue;let r=n.slice(0,e).trim().toLowerCase(),i=n.slice(e+1).replace(/!\s*important/i,``).toLowerCase().replace(/\s+/g,``),a=ch[r];a===void 0||!a.test(i)||t.push(`${r}: ${i}`)}return t.join(`; `)}var uh=/^data:image\/(?:png|jpeg|jpg|gif|webp|avif|bmp);base64,[A-Za-z0-9+/=]+$/,dh=[`image/png`,`image/jpeg`,`image/gif`,`image/webp`,`image/avif`,`image/bmp`],fh=`http://www.w3.org/1999/xhtml`;function ph(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function mh(e){let t=new DOMParser().parseFromString(e,`text/html`),n=t.createTreeWalker(t.body,NodeFilter.SHOW_COMMENT),r=[];for(let e=n.nextNode();e!==null;e=n.nextNode())r.push(e);for(let e of r)e.remove();for(let e of[...t.body.querySelectorAll(`*`)]){if(e.namespaceURI!==fh){e.remove();continue}let t=e.tagName.toLowerCase();if(Km.has(t)){e.remove();continue}if(!Wm.has(t)){e.replaceWith(...e.childNodes);continue}let n=[...Gm[`*`]??[],...Gm[t]??[]];for(let t of[...e.attributes]){if(!n.includes(t.name)){e.removeAttribute(t.name);continue}if(t.name===`style`){let n=lh(t.value);n===``?e.removeAttribute(`style`):e.setAttribute(`style`,n)}if(t.name===`class`){let n=t.value.split(/\s+/).filter(e=>oh.has(e));n.length===0?e.removeAttribute(`class`):e.setAttribute(`class`,n.join(` `))}if(t.name===`href`||t.name===`src`){let n=t.value.trim();/^(https?:|mailto:|#|\/|\.)/i.test(n)||t.name===`src`&&uh.test(n)||e.removeAttribute(t.name)}}}return t.body.innerHTML}function hh(e){let t=e??``;for(let e=0;e<3;e+=1){let e=mh(t);if(e===t)return e;t=e}return ph(new DOMParser().parseFromString(t,`text/html`).body.textContent??``)}var gh=[{rampa:`neutral`,termo:`editorColorGray`},{rampa:`red`,termo:`editorColorRed`},{rampa:`orange`,termo:`editorColorOrange`},{rampa:`yellow`,termo:`editorColorYellow`},{rampa:`lime`,termo:`editorColorLime`},{rampa:`green`,termo:`editorColorGreen`},{rampa:`teal`,termo:`editorColorTeal`},{rampa:`cyan`,termo:`editorColorCyan`},{rampa:`blue`,termo:`editorColorBlue`},{rampa:`violet`,termo:`editorColorViolet`},{rampa:`pink`,termo:`editorColorPink`}],_h=[{valor:`var(--kk-color-neutral-900)`,termo:`editorColorDefault`},...gh.map(e=>({valor:`var(--kk-color-${e.rampa}-600)`,termo:e.termo}))],vh=[{valor:`var(--kk-color-neutral-0)`,termo:`editorColorDefault`},...gh.map(e=>({valor:`var(--kk-color-${e.rampa}-200)`,termo:e.termo}))],yh={color:`#010203`,"background-color":`#040506`};function bh(e,t){let n=document.createElement(`span`);return n.style.setProperty(e,t),n.style.getPropertyValue(e)}var xh=`p, h1, h2, h3, h4, li, blockquote, div, td, th`,Sh=8,Ch=10,wh=Array.from({length:Sh*Ch},(e,t)=>({linha:Math.floor(t/Ch)+1,coluna:t%Ch+1}));function Th(e){let t=document.createElement(e);return t.append(document.createElement(`br`)),t}function Eh(e,t){return`<table><tbody>${`<tr>${`<td><br></td>`.repeat(t)}</tr>`.repeat(e)}</tbody></table><p><br></p>`}function Dh(e,t){if(e.tagName.toLowerCase()===t)return;let n=document.createElement(t);for(let t of[...e.attributes])n.setAttribute(t.name,t.value);n.append(...e.childNodes),e.replaceWith(n)}function Oh(e,t){let n=e.closest(`tr`),r=n?.parentElement;if(n===null||r==null)return;let i=document.createElement(`tr`),a=r.tagName===`THEAD`?`th`:`td`;for(let e=0;e<n.cells.length;e+=1)i.append(Th(a));r.insertBefore(i,t?n.nextSibling:n)}function kh(e){let t=e.closest(`tr`),n=e.closest(`table`);if(t===null||n===null)return;if(n.rows.length<=1){n.remove();return}let r=t.parentElement;t.remove(),r!==null&&r.children.length===0&&r.remove()}function Ah(e,t){let n=e.closest(`table`);if(n===null)return;let r=e.cellIndex;for(let e of[...n.rows]){let n=e.cells[r],i=Th(n?.tagName===`TH`?`th`:`td`);n===void 0?e.append(i):e.insertBefore(i,t?n.nextSibling:n)}}function jh(e){let t=e.closest(`table`);if(t===null)return;let n=e.cellIndex;if(Math.max(...[...t.rows].map(e=>e.cells.length))<=1){t.remove();return}for(let e of[...t.rows])e.cells[n]?.remove()}function Mh(e){let t=e.closest(`table`);if(t===null)return;let n=t.tHead;if(n!==null){let e=t.tBodies[0]??t.createTBody();for(let t of[...n.rows].reverse()){for(let e of[...t.cells])Dh(e,`td`);e.insertBefore(t,e.firstChild)}n.remove();return}let r=t.rows[0];if(r===void 0)return;for(let e of[...r.cells])Dh(e,`th`);let i=r.parentElement;t.createTHead().append(r),i!==null&&i.children.length===0&&i.remove()}function Nh(e){e.closest(`table`)?.remove()}var Ph=[{termo:`editorTableRowAbove`,icone:`row-insert-top`,executar:e=>Oh(e,!1)},{termo:`editorTableRowBelow`,icone:`row-insert-bottom`,executar:e=>Oh(e,!0)},{termo:`editorTableRowDelete`,icone:`row-remove`,executar:kh},{termo:`editorTableColumnBefore`,icone:`column-insert-left`,executar:e=>Ah(e,!1)},{termo:`editorTableColumnAfter`,icone:`column-insert-right`,executar:e=>Ah(e,!0)},{termo:`editorTableColumnDelete`,icone:`column-remove`,executar:jh},{termo:`editorTableHeader`,icone:`layout-navbar`,executar:Mh},{termo:`editorTableDelete`,icone:`trash`,executar:Nh}],Fh=[{icone:`arrow-back-up`,termo:`editorUndo`,comando:`undo`},{icone:`arrow-forward-up`,termo:`editorRedo`,comando:`redo`}],Ih=[[{icone:`bold`,termo:`editorBold`,comando:`bold`,alterna:!0},{icone:`italic`,termo:`editorItalic`,comando:`italic`,alterna:!0},{icone:`underline`,termo:`editorUnderline`,comando:`underline`,alterna:!0},{icone:`strikethrough`,termo:`editorStrikethrough`,comando:`strikeThrough`,alterna:!0}],[{icone:`list`,termo:`editorBulletList`,comando:`insertUnorderedList`,alterna:!0},{icone:`list-numbers`,termo:`editorNumberedList`,comando:`insertOrderedList`,alterna:!0}],[{icone:`align-left`,termo:`editorAlignLeft`,comando:`justifyLeft`,alterna:!0},{icone:`align-center`,termo:`editorAlignCenter`,comando:`justifyCenter`,alterna:!0},{icone:`align-right`,termo:`editorAlignRight`,comando:`justifyRight`,alterna:!0},{icone:`align-justified`,termo:`editorAlignJustify`,comando:`justifyFull`,alterna:!0}],[{icone:`corner-down-left`,termo:`editorLineBreak`,comando:`insertLineBreak`},{icone:`separator-horizontal`,termo:`editorHorizontalRule`,comando:`insertHorizontalRule`}]],Lh=[Fh,...Ih].flat().filter(e=>e.alterna===!0).map(e=>e.comando),Rh={tag:`p`,termo:`editorParagraph`,icone:`pilcrow`},zh=[Rh,{tag:`h1`,termo:`editorHeading1`,icone:`h-1`},{tag:`h2`,termo:`editorHeading2`,icone:`h-2`},{tag:`h3`,termo:`editorHeading3`,icone:`h-3`},{tag:`h4`,termo:`editorHeading4`,icone:`h-4`},{tag:`blockquote`,termo:`editorQuote`,icone:`blockquote`}];typeof document<`u`&&bp.styleSheet!==void 0&&(document.adoptedStyleSheets=[...document.adoptedStyleSheets,bp.styleSheet]);function Bh(e){let t=e.getRootNode(),n=bp.styleSheet;n===void 0||!(t instanceof ShadowRoot)||t.adoptedStyleSheets.includes(n)||(t.adoptedStyleSheets=[...t.adoptedStyleSheets,n])}var Vh,Hh,Uh,Wh,Gh,Kh,qh,Jh,Yh=class e extends (Wh=M,Uh=[k()],Hh=[k()],Vh=[O({type:Boolean,reflect:!0})],Wh){constructor(){super(...arguments),g(this,`localize`,new sa(this)),g(this,`area`,document.createElement(`div`)),g(this,`fonte`,document.createElement(`textarea`)),g(this,`conteudo`,``),_(this,Kh,m(Gh,8,this,!1)),m(Gh,11,this),_(this,qh,m(Gh,12,this,0)),m(Gh,15,this),g(this,`assinaturaDaBarra`,``),g(this,`ultimaFaixa`,null),g(this,`quadro`,0),_(this,Jh,m(Gh,16,this,!1)),m(Gh,19,this),g(this,`handleFonteInput`,()=>{this.conteudo=this.fonte.value,this.emit(`kk-input`,{detail:{value:this.conteudo}})}),g(this,`handleInput`,()=>{this.conteudo=this.area.innerHTML,this.emit(`kk-input`,{detail:{value:this.conteudo}}),this.sincronizarBarra()}),g(this,`sincronizarBarra`,()=>{this.guardarSelecao(),this.quadro===0&&(this.quadro=requestAnimationFrame(()=>{this.quadro=0;let e=[this.tagDoBlocoCorrente(),...Lh.map(e=>this.comandoLigado(e)?`1`:`0`),this.corCorrente(`color`)??``,this.corCorrente(`background-color`)??``,this.blocoCorrente()?.className??``,this.celulaCorrente()===void 0?``:`tabela`].join(`|`);e!==this.assinaturaDaBarra&&(this.assinaturaDaBarra=e,this.selecao+=1)}))}),g(this,`handlePaste`,e=>{e.preventDefault();let t=e.clipboardData;if(t===null)return;let n=t.getData(`text/html`),r=t.getData(`text/plain`);n===``?document.execCommand(`insertText`,!1,r):document.execCommand(`insertHTML`,!1,hh(n)),this.handleInput()}),g(this,`aoApontarNaGrade`,e=>{let t=e.target.closest(`[data-linha]`);t!==null&&this.marcarGrade(Number(t.dataset.linha),Number(t.dataset.coluna))}),g(this,`aoTeclarNaGrade`,e=>{let t={ArrowUp:[-1,0],ArrowDown:[1,0],ArrowLeft:[0,-1],ArrowRight:[0,1]}[e.key],n=e.target.closest(`[data-linha]`);if(t===void 0||n===null)return;e.preventDefault();let r=Um(Number(n.dataset.linha)+t[0],1,Sh),i=Um(Number(n.dataset.coluna)+t[1],1,Ch);this.querySelector(`[data-linha="${r}"][data-coluna="${i}"]`)?.focus()})}get value(){return this.conteudo}set value(e){let t=nh(hh(e??``));t===this.conteudo||t===nh(hh(this.conteudo))||(this.conteudo=t,this.area.innerHTML=t,this.codigo&&(this.fonte.value=t))}connectedCallback(){super.connectedCallback(),Bh(this),this.area.className=`kk-editor__content kk-prose`,this.area.contentEditable=this.readonly?`false`:`true`,this.area.spellcheck=!0,this.area.setAttribute(`role`,`textbox`),this.area.setAttribute(`aria-multiline`,`true`),this.area.setAttribute(`aria-label`,this.localize.term(`editorArea`)),this.area.innerHTML=this.conteudo,document.execCommand(`styleWithCSS`,!1,`false`),this.fonte.className=`kk-editor__source`,this.fonte.spellcheck=!1,this.fonte.setAttribute(`aria-label`,this.localize.term(`editorSource`)),this.area.addEventListener(`input`,this.handleInput),this.area.addEventListener(`paste`,this.handlePaste),this.area.addEventListener(`keyup`,this.sincronizarBarra),this.area.addEventListener(`mouseup`,this.sincronizarBarra),this.area.addEventListener(`focus`,this.sincronizarBarra),this.fonte.addEventListener(`input`,this.handleFonteInput)}disconnectedCallback(){super.disconnectedCallback(),this.area.removeEventListener(`input`,this.handleInput),this.area.removeEventListener(`paste`,this.handlePaste),this.area.removeEventListener(`keyup`,this.sincronizarBarra),this.area.removeEventListener(`mouseup`,this.sincronizarBarra),this.area.removeEventListener(`focus`,this.sincronizarBarra),this.fonte.removeEventListener(`input`,this.handleFonteInput),this.quadro!==0&&(cancelAnimationFrame(this.quadro),this.quadro=0)}createRenderRoot(){return this}focus(e){(this.codigo?this.fonte:this.area).focus(e)}get travado(){return this.readonly||this.codigo}alternarCodigo(){if(this.codigo){let e=nh(hh(this.fonte.value)),t=e!==this.conteudo;this.conteudo=e,this.area.innerHTML=e,this.codigo=!1,t&&this.emit(`kk-input`,{detail:{value:e}})}else this.conteudo=this.area.innerHTML,this.fonte.value=this.conteudo,this.fonte.readOnly=this.readonly,this.codigo=!0;this.updateComplete.then(()=>this.focus())}aplicar(e,t){this.area.focus(),this.restaurarSelecao(),document.execCommand(e,!1,t),this.handleInput()}selecaoAtual(){let e=this.getRootNode();return`getSelection`in e?e.getSelection():getSelection()}guardarSelecao(){let e=this.selecaoAtual();if(e===null||e.rangeCount===0)return;let t=e.getRangeAt(0);this.area.contains(t.commonAncestorContainer)&&(this.ultimaFaixa=t.cloneRange())}restaurarSelecao(){let e=this.ultimaFaixa,t=this.selecaoAtual();e===null||t===null||this.area.contains(e.commonAncestorContainer)&&(t.removeAllRanges(),t.addRange(e))}faixaCorrente(){let e=this.selecaoAtual();if(e!==null&&e.rangeCount>0){let t=e.getRangeAt(0);if(this.area.contains(t.commonAncestorContainer))return t}let t=this.ultimaFaixa;if(t!==null&&this.area.contains(t.commonAncestorContainer))return t}elementoCorrente(){let e=this.faixaCorrente()?.startContainer;return e===void 0?void 0:(e.nodeType===Node.ELEMENT_NODE?e:e.parentElement)??void 0}blocoCorrente(){let e=this.elementoCorrente()?.closest(xh);return e!=null&&this.area.contains(e)?e:void 0}celulaCorrente(){let e=this.elementoCorrente()?.closest(`td, th`);return e!=null&&this.area.contains(e)?e:void 0}blocosDaSelecao(){let e=this.faixaCorrente();if(e===void 0)return[];if(e.collapsed){let e=this.blocoCorrente();return e===void 0?[]:[e]}return[...this.area.querySelectorAll(xh)].filter(t=>t.querySelector(xh)===null&&e.intersectsNode(t))}marcarBlocos(e,t){this.area.focus(),this.restaurarSelecao();let n=this.blocosDaSelecao();if(n.length===0)return;let r=n[0]?.classList.contains(e)===!0;for(let i of n){i.classList.remove(...t),i.classList.toggle(e,!r),i.className===``&&i.removeAttribute(`class`);let n=Zm[e];!r&&n!==void 0&&eh(i,n)}this.handleInput()}limparFormatacao(){this.area.focus(),this.restaurarSelecao(),document.execCommand(`removeFormat`),document.execCommand(`unlink`);for(let e of this.blocosDaSelecao())e.removeAttribute(`class`),e.removeAttribute(`style`);let e=this.tagDoBlocoCorrente();e!==`p`&&e!==`li`&&e!==`td`&&e!==`th`&&document.execCommand(`formatBlock`,!1,`p`),this.handleInput()}inserirTipografia(e,t){this.area.focus(),this.restaurarSelecao();let n=t===void 0?``:this.faixaCorrente()?.toString()??``;if(document.execCommand(`insertText`,!1,`${e}${n}${t??``}`),t!==void 0&&n===``){let e=this.selecaoAtual()?.getRangeAt(0);e!==void 0&&e.startContainer.nodeType===Node.TEXT_NODE&&(e.setStart(e.startContainer,e.startOffset-t.length),e.collapse(!0),this.ultimaFaixa=e.cloneRange())}this.handleInput()}corCorrente(e){let t=this.elementoCorrente();for(;t!==void 0&&t!==this.area;){let n=t.style?.getPropertyValue(e)??``;if(n!==``)return n;t=t.parentElement??void 0}}pintar(e,t){this.area.focus(),this.restaurarSelecao();let n=yh[e];document.execCommand(`styleWithCSS`,!1,`true`),document.execCommand(e===`color`?`foreColor`:`hiliteColor`,!1,n),document.execCommand(`styleWithCSS`,!1,`false`);let r=bh(e,n);for(let n of[...this.area.querySelectorAll(`[style]`)])n.style.getPropertyValue(e)===r&&(t===null?n.style.removeProperty(e):n.style.setProperty(e,t),n.getAttribute(`style`)===``&&n.removeAttribute(`style`),n.tagName===`SPAN`&&n.attributes.length===0&&n.replaceWith(...n.childNodes));this.handleInput()}pedirTexto(e){let t=document.createElement(`kk-dialog`);return t.label=e.rotulo,document.body.append(t),new Promise(n=>{let r=null,i=e=>{r=e,t.open=!1},a=()=>{let e=t.querySelector(`kk-input`),n=e?.value.trim()??``;if(n===``){e?.focus();return}i(n)};t.addEventListener(`kk-after-hide`,e=>{e.target===t&&(t.remove(),n(r))}),t.addEventListener(`kk-request-close`,e=>{e.target===t&&e.detail.source===`overlay`&&e.preventDefault()}),ho(w`
          <p>${e.texto}</p>
          <kk-input
            autofocus
            placeholder=${e.placeholder??``}
    ...
    </div>`}renderSeletorDeBloco(){let e=this.tagDoBlocoCorrente(),t=zh.find(t=>t.tag===e)??Rh,n=`${this.localize.term(`editorBlockType`)}: ${this.localize.term(t.termo)}`;return w`
    ...
    `}render(){return this.selecao,w`
      <div class="kk-editor__toolbar" role="toolbar" aria-label=${this.localize.term(`editorToolbar`)}>
        ${this.renderGrupo(Fh)} ${this.renderSeletorDeBloco()}
        ${Ih.map(e=>this.renderGrupo(e))}

        <div class="kk-editor__group">
          ${this.renderPaleta(`color`,_h,`text-color`,`editorTextColor`)}
          ${this.renderPaleta(`background-color`,vh,`background`,`editorBackgroundColor`)}
          ${this.renderMenuDeClasses(`article`,`editorParagraphStyle`,Ym,Xm)}
          ${this.renderMenuDeClasses(`feather`,`editorPoetry`,rh,ih)}
          ${this.renderMenuDeClasses(`highlight`,`editorHighlight`,qm,Jm)}
    ...
    `}};Gh=f(Wh),Kh=new WeakMap,qh=new WeakMap,Jh=new WeakMap,h(Gh,4,`codigo`,Uh,Yh,Kh),h(Gh,4,`selecao`,Hh,Yh,qh),h(Gh,4,`readonly`,Vh,Yh,Jh),p(Gh,Yh),g(Yh,`dependencies`,{"kk-button":z,"kk-dialog":Vu,"kk-dropdown":Ff,"kk-icon":Ls,"kk-input":K,"kk-menu":yp,"kk-menu-item":pp}),Yh.define(`kk-editor`);var Xh=C`
  :host {
    display: block;
  ...
  /*
   * Os dois grupos empilhados, e não lado a lado: no painel lateral do Kobi
   * Flow eles têm sete pastilhas somadas, e numa linha só a última quebraria
   * sozinha embaixo — o que faz o grupo parecer três, e não dois.
   */
  .filtros {
    display: flex;
    flex-direction: column;
...
`,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg,cg,lg,ug,dg,fg,q,pg,mg,hg,gg,_g,vg,yg,bg,xg,Sg,Cg,wg=class extends (fg=M,dg=[A(`input[type="checkbox"]`)],ug=[k()],lg=[O()],cg=[O()],sg=[O()],og=[O({reflect:!0})],ag=[O({type:Boolean,reflect:!0})],ig=[O({type:Boolean,reflect:!0})],rg=[Do(`checked`)],ng=[O({reflect:!0,converter:Xo})],tg=[O({type:Boolean,reflect:!0})],eg=[O({attribute:`help-text`})],$h=[j([`checked`,`value`],{waitUntilFirstUpdate:!0})],Qh=[j(`disabled`,{waitUntilFirstUpdate:!0})],fg){constructor(){super(...arguments),m(q,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`)),_(this,pg,m(q,8,this)),m(q,11,this),_(this,mg,m(q,12,this,!1)),m(q,15,this),_(this,hg,m(q,16,this,``)),m(q,19,this),_(this,gg,m(q,20,this,``)),m(q,23,this),_(this,_g,m(q,24,this)),m(q,27,this),_(this,vg,m(q,28,this,`medium`)),m(q,31,this),_(this,yg,m(q,32,this,!1)),m(q,35,this),_(this,bg,m(q,36,this,!1)),m(q,39,this),g(this,`defaultChecked`,m(q,52,this,!1)),m(q,55,this),_(this,xg,m(q,40,this,``)),m(q,43,this),_(this,Sg,m(q,44,this,!1)),m(q,47,this),_(this,Cg,m(q,48,this,``)),m(q,51,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.checked=this.defaultChecked,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.checked?this.value||`on`:null),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleInput(){this.emit(`kk-input`)}handleClick(){this.checked=!this.checked,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`kk-change`),this.emit(`kk-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`kk-change`),this.emit(`kk-input`))}handleStateChange(){this._internals.setFormValue(this.checked?this.value||`on`:null),this.input.checked=this.checked,this.updateValidity()}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return w`
      <div
    ...
    `}};q=f(fg),pg=new WeakMap,mg=new WeakMap,hg=new WeakMap,gg=new WeakMap,_g=new WeakMap,vg=new WeakMap,yg=new WeakMap,bg=new WeakMap,xg=new WeakMap,Sg=new WeakMap,Cg=new WeakMap,h(q,4,`input`,dg,wg,pg),h(q,4,`hasFocus`,ug,wg,mg),h(q,4,`title`,lg,wg,hg),h(q,4,`name`,cg,wg,gg),h(q,4,`value`,sg,wg,_g),h(q,4,`size`,og,wg,vg),h(q,4,`disabled`,ag,wg,yg),h(q,4,`checked`,ig,wg,bg),h(q,4,`form`,ng,wg,xg),h(q,4,`required`,tg,wg,Sg),h(q,4,`helpText`,eg,wg,Cg),h(q,1,`handleStateChange`,$h,wg),h(q,1,`handleDisabledChange`,Qh,wg),h(q,5,`defaultChecked`,rg,wg),p(q,wg),g(wg,`styles`,[D,Cp,Zh]),g(wg,`formAssociated`,!0);var Tg=C`
  :host {
    display: block;
  }
...
`,jg,Mg,Ng,Pg,Fg,Ig,Lg,Rg,zg,Bg,Vg=class extends (Fg=M,Pg=[O({reflect:!0})],Ng=[O({reflect:!0})],Mg=[O({type:Boolean,reflect:!0})],jg=[O({type:Boolean})],Fg){constructor(){super(...arguments),g(this,`localize`,new sa(this)),_(this,Lg,m(Ig,8,this,`neutral`)),m(Ig,11,this),_(this,Rg,m(Ig,12,this,`medium`)),m(Ig,15,this),_(this,zg,m(Ig,16,this,!1)),m(Ig,19,this),_(this,Bg,m(Ig,20,this,!1)),m(Ig,23,this)}handleRemoveClick(){this.emit(`kk-remove`)}render(){return w`
      <span
        part="base"
    ...
    `}};Ig=f(Fg),Lg=new WeakMap,Rg=new WeakMap,zg=new WeakMap,Bg=new WeakMap,h(Ig,4,`variant`,Pg,Vg,Lg),h(Ig,4,`size`,Ng,Vg,Rg),h(Ig,4,`pill`,Mg,Vg,zg),h(Ig,4,`removable`,jg,Vg,Bg),p(Ig,Vg),g(Vg,`styles`,[D,Ag]),g(Vg,`dependencies`,{"kk-icon-button":I});var Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_,r_,i_,a_,o_,s_,c_,l_,u_,d_,f_,p_,m_,h_,g_,__,v_,y_,J,b_,x_,S_,C_,w_,T_,E_,D_,O_,k_,A_,j_,M_,N_,P_,F_,I_,L_,R_,z_,B_,V_,H_,U_,W_,G_,K_,Y=class extends (y_=M,v_=[A(`.select`)],__=[A(`.select__combobox`)],g_=[A(`.select__display-input`)],h_=[A(`.select__value-input`)],m_=[A(`.select__listbox`)],p_=[k()],f_=[k()],d_=[k()],u_=[k()],l_=[k()],c_=[O()],s_=[k()],o_=[O({attribute:`value`})],a_=[O({reflect:!0})],i_=[O()],r_=[O({type:Boolean,reflect:!0})],n_=[O({attribute:`max-options-visible`,type:Number})],t_=[O({type:Boolean,reflect:!0})],e_=[O({type:Boolean})],$g=[O({type:Boolean,reflect:!0})],Qg=[O({type:Boolean,reflect:!0})],Zg=[O({type:Boolean,reflect:!0})],Xg=[O()],Yg=[O({reflect:!0})],Jg=[O({attribute:`help-text`})],qg=[O({reflect:!0,converter:Xo})],Kg=[O({type:Boolean,reflect:!0})],Gg=[O()],Wg=[j(`disabled`,{waitUntilFirstUpdate:!0})],Ug=[j([`defaultValue`,`value`],{waitUntilFirstUpdate:!0})],Hg=[j(`open`,{waitUntilFirstUpdate:!0})],y_){constructor(){super(...arguments),m(J,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),g(this,`localize`,new sa(this)),g(this,`typeToSelectString`,``),g(this,`typeToSelectTimeout`),g(this,`closeWatcher`),_(this,b_,m(J,8,this)),m(J,11,this),_(this,x_,m(J,12,this)),m(J,15,this),_(this,S_,m(J,16,this)),m(J,19,this),_(this,C_,m(J,20,this)),m(J,23,this),_(this,w_,m(J,24,this)),m(J,27,this),_(this,T_,m(J,28,this,!1)),m(J,31,this),_(this,E_,m(J,32,this,``)),m(J,35,this),_(this,D_,m(J,36,this)),m(J,39,this),_(this,O_,m(J,40,this,[])),m(J,43,this),_(this,k_,m(J,44,this,!1)),m(J,47,this),_(this,A_,m(J,48,this,``)),m(J,51,this),g(this,`_value`,``),_(this,j_,m(J,52,this,``)),m(J,55,this),_(this,M_,m(J,56,this,`medium`)),m(J,59,this),_(this,N_,m(J,60,this,``)),m(J,63,this),_(this,P_,m(J,64,this,!1)),m(J,67,this),_(this,F_,m(J,68,this,3)),m(J,71,this),_(this,I_,m(J,72,this,!1)),m(J,75,this),_(this,L_,m(J,76,this,!1)),m(J,79,this),_(this,R_,m(J,80,this,!1)),m(J,83,this),_(this,z_,m(J,84,this,!1)),m(J,87,this),_(this,B_,m(J,88,this,!1)),m(J,91,this),_(this,V_,m(J,92,this,``)),m(J,95,this),_(this,H_,m(J,96,this,`bottom`)),m(J,99,this),_(this,U_,m(J,100,this,``)),m(J,103,this),_(this,W_,m(J,104,this,``)),m(J,107,this),_(this,G_,m(J,108,this,!1)),m(J,111,this),_(this,K_,m(J,112,this,e=>w`
      <kk-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};J=f(y_),b_=new WeakMap,x_=new WeakMap,S_=new WeakMap,C_=new WeakMap,w_=new WeakMap,T_=new WeakMap,E_=new WeakMap,D_=new WeakMap,O_=new WeakMap,k_=new WeakMap,A_=new WeakMap,j_=new WeakMap,M_=new WeakMap,N_=new WeakMap,P_=new WeakMap,F_=new WeakMap,I_=new WeakMap,L_=new WeakMap,R_=new WeakMap,z_=new WeakMap,B_=new WeakMap,V_=new WeakMap,H_=new WeakMap,U_=new WeakMap,W_=new WeakMap,G_=new WeakMap,K_=new WeakMap,h(J,4,`popup`,v_,Y,b_),h(J,4,`combobox`,__,Y,x_),h(J,4,`displayInput`,g_,Y,S_),h(J,4,`valueInput`,h_,Y,C_),h(J,4,`listbox`,m_,Y,w_),h(J,4,`hasFocus`,p_,Y,T_),h(J,4,`displayLabel`,f_,Y,E_),h(J,4,`currentOption`,d_,Y,D_),h(J,4,`selectedOptions`,u_,Y,O_),h(J,4,`valueHasChanged`,l_,Y,k_),h(J,4,`name`,c_,Y,A_),h(J,3,`value`,s_,Y),h(J,4,`defaultValue`,o_,Y,j_),h(J,4,`size`,a_,Y,M_),h(J,4,`placeholder`,i_,Y,N_),h(J,4,`multiple`,r_,Y,P_),h(J,4,`maxOptionsVisible`,n_,Y,F_),h(J,4,`disabled`,t_,Y,I_),h(J,4,`clearable`,e_,Y,L_),h(J,4,`open`,$g,Y,R_),h(J,4,`filled`,Qg,Y,z_),h(J,4,`pill`,Zg,Y,B_),h(J,4,`label`,Xg,Y,V_),h(J,4,`placement`,Yg,Y,H_),h(J,4,`helpText`,Jg,Y,U_),h(J,4,`form`,qg,Y,W_),h(J,4,`required`,Kg,Y,G_),h(J,4,`getTag`,Gg,Y,K_),h(J,1,`handleDisabledChange`,Wg,Y),h(J,1,`handleValueChange`,Ug,Y),h(J,1,`handleOpenChange`,Hg,Y),p(J,Y),g(Y,`styles`,[D,Cp,Tg]),g(Y,`dependencies`,{"kk-icon":Ls,"kk-popup":H,"kk-tag":Vg}),g(Y,`formAssociated`,!0);var q_=C`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,J_,Y_,X_,Z_,Q_,$_,ev,tv,nv,rv,X,iv,av,ov,sv,cv,lv,uv=class extends (rv=M,nv=[A(`.option__label`)],tv=[k()],ev=[k()],$_=[k()],Q_=[O({reflect:!0})],Z_=[O({type:Boolean,reflect:!0})],X_=[j(`disabled`)],Y_=[j(`selected`)],J_=[j(`value`)],rv){constructor(){super(...arguments),m(X,5,this),g(this,`localize`,new sa(this)),g(this,`isInitialized`,!1),_(this,iv,m(X,8,this)),m(X,11,this),_(this,av,m(X,12,this,!1)),m(X,15,this),_(this,ov,m(X,16,this,!1)),m(X,19,this),_(this,sv,m(X,20,this,!1)),m(X,23,this),_(this,cv,m(X,24,this,``)),m(X,27,this),_(this,lv,m(X,28,this,!1)),m(X,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`kk-select`).then(()=>{let e=this.closest(`kk-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return w`
    ...
    `}};X=f(rv),iv=new WeakMap,av=new WeakMap,ov=new WeakMap,sv=new WeakMap,cv=new WeakMap,lv=new WeakMap,h(X,4,`defaultSlot`,nv,uv,iv),h(X,4,`current`,tv,uv,av),h(X,4,`selected`,ev,uv,ov),h(X,4,`hasHover`,$_,uv,sv),h(X,4,`value`,Q_,uv,cv),h(X,4,`disabled`,Z_,uv,lv),h(X,1,`handleDisabledChange`,X_,uv),h(X,1,`handleSelectedChange`,Y_,uv),h(X,1,`handleValueChange`,J_,uv),p(X,uv),g(uv,`styles`,[D,q_]),g(uv,`dependencies`,{"kk-icon":Ls});var dv=`🛒.🍕.☕.🏠.💡.💧.🔌.🚌.⛽.🚗.💊.🏥.🩺.👕.🎁.🎮.🎵.📚.🎓.🏖️.💰.💳.🧾.🐾.📱.💼.💇.🧴.🧺.🏋️.🛡️.🧸`.split(`.`),fv=[[`diaria`,`financeDaily`],[`semanal`,`financeWeekly`],[`mensal`,`financeMonthly`],[`anual`,`financeYearly`]],pv=`••••`,mv={descricao:!1,valor:!1,diaMes:!1};function hv(e){let t=new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function gv(e){return hv(e).slice(0,7)}function _v(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1).getTime()}var vv,yv,bv,xv,Sv,Cv,wv,Tv,Ev,Dv,Ov,kv,Av,jv,Z,Mv,Nv,Pv,Fv,Iv,Lv,Rv,zv,Bv,Vv,Hv,Uv,Wv=class e extends (jv=M,Av=[O({reflect:!0})],kv=[O({type:Array})],Ov=[O({type:Array})],Dv=[O({type:Array})],Ev=[O({type:Array})],Tv=[O({reflect:!0})],wv=[O({type:Boolean,reflect:!0})],Cv=[O()],Sv=[O({type:Boolean,attribute:`lancamento-corrente`})],xv=[k()],bv=[k()],yv=[k()],vv=[j(`vista`,{waitUntilFirstUpdate:!0})],jv){constructor(){super(...arguments),m(Z,5,this),g(this,`localize`,new sa(this)),_(this,Mv,m(Z,8,this,`painel`)),m(Z,11,this),_(this,Nv,m(Z,12,this,[])),m(Z,15,this),_(this,Pv,m(Z,16,this,[])),m(Z,19,this),_(this,Fv,m(Z,20,this,[])),m(Z,23,this),_(this,Iv,m(Z,24,this,[])),m(Z,27,this),_(this,Lv,m(Z,28,this,``)),m(Z,31,this),_(this,Rv,m(Z,32,this,!1)),m(Z,35,this),_(this,zv,m(Z,36,this,`BRL`)),m(Z,39,this),_(this,Bv,m(Z,40,this,!1)),m(Z,43,this),_(this,Vv,m(Z,44,this,null)),m(Z,47,this),_(this,Hv,m(Z,48,this,`todas`)),m(Z,51,this),_(this,Uv,m(Z,52,this,`todos`)),m(Z,55,this)}get aberto(){return this.formulario!==null}novo(){this.vista===`transacoes`&&this.abrir({especie:`transacao`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,vencimento:hv(Date.now()),pago:!1,parte:0}}),this.vista===`categorias`&&this.abrir({especie:`categoria`,dados:{id:0,nome:``,icone:``,cor:`#0d6efd`,limite:``,erroNome:!1}}),this.vista===`recorrencias`&&this.abrir({especie:`recorrencia`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,periodicidade:`mensal`,diaMes:1,diaSemana:1,gerarComoPago:!1,ativa:!0,lancarCorrente:!1,erros:mv}})}fechar(){this.formulario!==null&&(this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}))}handleVistaChange(){this.fechar(),this.situacao=`todas`,this.tipoFiltro=`todos`}abrir(e){this.formulario=e,this.emit(`kk-form`,{detail:{aberto:!0}})}get mesCorrente(){return this.mes===``?gv(Date.now()):this.mes}dinheiro(e){return this.localize.number(e,{style:`currency`,currency:this.moeda,minimumFractionDigits:2,maximumFractionDigits:2})}cifra(e){return this.oculto?pv:this.dinheiro(e)}data(e){return e===0?`—`:this.localize.date(new Date(e),{dateStyle:`short`})}get simboloDaMoeda(){return new Intl.NumberFormat(this.localize.lang(),{style:`currency`,currency:this.moeda}).formatToParts(0).find(e=>e.type===`currency`)?.value??this.moeda}get separadores(){let e=new Intl.NumberFormat(this.localize.lang(),{minimumFractionDigits:2}).formatToParts(1234.5);return{grupo:e.find(e=>e.type===`group`)?.value??`.`,decimal:e.find(e=>e.type===`decimal`)?.value??`,`}}mascarar(e){let t=e.replace(/\D/g,``).replace(/^0+(?=\d)/,``);if(t===``)return``;let n=t.padStart(3,`0`),r=Number(n.slice(0,-2));return`${this.localize.number(r)}${this.separadores.decimal}${n.slice(-2)}`}desmascarar(e){let{grupo:t,decimal:n}=this.separadores,r=Number(e.split(t).join(``).replace(n,`.`));return Number.isFinite(r)?Math.abs(r):0}valorEmTexto(e){return e===0?``:this.localize.number(e,{minimumFractionDigits:2,maximumFractionDigits:2})}categoriaPorId(e){return this.categorias.find(t=>t.id===e)}partePorId(e){return e===void 0||e===0?void 0:this.partes.find(t=>t.id===e)}get partesOrdenadas(){return[...this.partes].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get categoriasOrdenadas(){return[...this.categorias].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get doMes(){return this.transacoes.filter(e=>e.vencimento!==0&&gv(e.vencimento)===this.mesCorrente)}static vencida(e){if(e.pago||e.vencimento===0)return!1;let t=new Date;return t.setHours(0,0,0,0),e.vencimento<t.getTime()}get filtradas(){return this.doMes.filter(t=>e.naSituacao(t,this.situacao)&&(this.tipoFiltro===`todos`||t.tipo===this.tipoFiltro))}static naSituacao(t,n){return n===`pagas`?t.pago:n===`vencidas`?e.vencida(t):n!==`a-vencer`||!t.pago&&!e.vencida(t)}static soma(e){return e.reduce((e,t)=>e+Number(t.valor),0)}static saldo(e){return e.reduce((e,t)=>e+(t.tipo===`receita`?Number(t.valor):-Number(t.valor)),0)}corDa(e){let t=this.categoriaPorId(e.categoria);return t!==void 0&&t.cor!==``?t.cor:e.tipo===`receita`?`var(--kk-financeiro-receita)`:`var(--kk-financeiro-despesa)`}get anosComMovimento(){let e=new Set([new Date().getFullYear(),Number(this.mesCorrente.slice(0,4))]);for(let t of this.transacoes)t.vencimento!==0&&e.add(new Date(t.vencimento).getFullYear());return[...e].sort((e,t)=>t-e)}renderSaldo(){let t=e.saldo(this.transacoes),n=e.saldo(this.transacoes.filter(e=>e.pago));return w`
      <div class="saldo">
              ...
              <span class="limite__topo">
                ...
                <span class="limite__valores">
                  ...
                  ${e.limite===0?T:w`<small>
                        ${this.localize.term(`financeOfLimit`,this.oculto?pv:this.dinheiro(e.limite))}
                      </small>`}
                </span>
              </span>
    ...
    `}salvar(e,t){this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}),this.emit(`kk-save`,{detail:{especie:e,registro:t}})}renderFormTransacao(e){let t=t=>{this.formulario={especie:`transacao`,dados:{...e,...t}}};return w`
      <div class="formulario">
        ...
        ${this.renderAcoes(()=>this.salvar(`transacao`,{id:e.id,descricao:e.descricao.trim(),valor:this.desmascarar(e.valor),tipo:e.tipo,categoria:Number(e.categoria),vencimento:e.vencimento===``?Date.now():_v(e.vencimento),pago:e.pago,parte:Number(e.parte)}))}
      </div>
    `}renderFiltros(){let t=this.doMes.filter(e=>this.tipoFiltro===`todos`||e.tipo===this.tipoFiltro),n=this.doMes.filter(t=>e.naSituacao(t,this.situacao)),r=[[`todas`,this.localize.term(`financeAllStates`)],[`vencidas`,this.localize.term(`financeOverdue`)],[`a-vencer`,this.localize.term(`financeUpcoming`)],[`pagas`,this.localize.term(`financePaidPlural`)]],i=[[`todos`,this.localize.term(`financeAllKinds`)],[`despesa`,this.localize.term(`financeExpenses`)],[`receita`,this.localize.term(`financeIncome`)]];return w`
      <div class="filtros">
        <div class="tipos" role="group" aria-label=${this.localize.term(`financeSituation`)}>
          ${r.map(([n,r])=>w`
              <button
                ...
                type="button"
                data-situacao=${n}
                aria-pressed=${this.situacao===n}
                @click=${()=>{this.situacao=n}}
              >
                ${r}
                <span class="tipo__conta">
                  ${t.filter(t=>e.naSituacao(t,n)).length}
                </span>
              </button>
            `)}
        </div>

        <div class="tipos" role="group" aria-label=${this.localize.term(`financeType`)}>
          ${i.map(([e,t])=>w`
              <button
                class="tipo"
                type="button"
                data-tipo=${e}
                aria-pressed=${this.tipoFiltro===e}
                @click=${()=>{this.tipoFiltro=e}}
              >
                ${t}
                <span class="tipo__conta">
                  ${n.filter(t=>e===`todos`||t.tipo===e).length}
                </span>
              </button>
            `)}
        </div>
      </div>
    `}renderTransacoes(){if(this.transacoes.length===0)return this.renderVazio(`receipt`,this.localize.term(`financeNoTransactions`));if(this.doMes.length===0)return w`
        ${this.renderPeriodo()}
        ${this.renderVazio(`receipt`,this.localize.term(`financeNoTransactionsInMonth`))}
      `;let e=this.filtradas.sort((e,t)=>t.vencimento-e.vencimento);return e.length===0?w`
        ${this.renderPeriodo()} ${this.renderFiltros()}
        ${this.renderVazio(`filter`,this.localize.term(`financeNoMatches`))}
      `:w`
      ${this.renderPeriodo()} ${this.renderFiltros()}
      <div class="registros">
        ${e.map(e=>{let t=e.tipo===`receita`,n=this.categoriaPorId(e.categoria),r=this.partePorId(e.parte),i=this.corDa(e);return w`
            <div class="registro" data-status=${e.pago?`ok`:`pendente`}>
              ...
              <button
                ...
                type="button"
                @click=${()=>this.abrir({especie:`transacao`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,vencimento:hv(e.vencimento===0?Date.now():e.vencimento),pago:e.pago,parte:e.parte??0}})}
              >
      ...
      <div class="categorias">
        ${this.categoriasOrdenadas.map(e=>w`
            <div class="categoria">
              ...
              ${e.limite>0?w`
                    <span class="discreto">
                      ${this.localize.term(`financeLimitOf`,this.oculto?pv:this.dinheiro(e.limite))}
                    </span>
                  `:T}
              <kk-icon-button
                name="pencil"
    ...
    `}nomeDaPeriodicidade(e){let t=fv.find(([t])=>t===e);return t===void 0?e:this.localize.term(t[1])}descreverPeriodo(e){let t=this.nomeDaPeriodicidade(e.periodicidade);return e.periodicidade===`mensal`?`${t} \xB7 ${this.localize.term(`financeDayNum`,e.diaMes)}`:e.periodicidade===`semanal`?`${t} \xB7 ${this.nomeDoDia(e.diaSemana)}`:t}nomeDoDia(e){return this.localize.date(new Date(2001,0,e),{weekday:`long`})}renderFormRecorrencia(e){let t=t=>{this.formulario={especie:`recorrencia`,dados:{...e,...t}}};return w`
      <div class="formulario">
        ...
        >
          ${fv.map(([e,t])=>w`<kk-option value=${e}>${this.localize.term(t)}</kk-option>`)}
        </kk-select>
        ...
        ${this.recorrencias.map(e=>{let t=e.tipo===`receita`;return w`
            <div class="registro" data-status=${e.ativa?`ok`:`pendente`}>
              ...
              <button
                class="registro__alvo"
                type="button"
                @click=${()=>this.abrir({especie:`recorrencia`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,periodicidade:e.periodicidade,diaMes:e.diaMes,diaSemana:e.diaSemana,gerarComoPago:e.gerarComoPago,ativa:e.ativa,lancarCorrente:!1,erros:mv}})}
              >
                <span class="registro__topo">
                  <span class="registro__titulo">${e.descricao}</span>
                  <span class="registro__valor" data-tom=${e.tipo}>
    ...
    `}renderVista(){let e=this.formulario;return e===null?this.vista===`transacoes`?this.renderTransacoes():this.vista===`categorias`?this.renderCategorias():this.vista===`recorrencias`?this.renderRecorrencias():this.renderPainel():e.especie===`transacao`?this.renderFormTransacao(e.dados):e.especie===`categoria`?this.renderFormCategoria(e.dados):this.renderFormRecorrencia(e.dados)}render(){return w`<div part="base" class="financeiro">${this.renderVista()}</div>`}};Z=f(jv),Mv=new WeakMap,Nv=new WeakMap,Pv=new WeakMap,Fv=new WeakMap,Iv=new WeakMap,Lv=new WeakMap,Rv=new WeakMap,zv=new WeakMap,Bv=new WeakMap,Vv=new WeakMap,Hv=new WeakMap,Uv=new WeakMap,h(Z,4,`vista`,Av,Wv,Mv),h(Z,4,`categorias`,kv,Wv,Nv),h(Z,4,`partes`,Ov,Wv,Pv),h(Z,4,`transacoes`,Dv,Wv,Fv),h(Z,4,`recorrencias`,Ev,Wv,Iv),h(Z,4,`mes`,Tv,Wv,Lv),h(Z,4,`oculto`,wv,Wv,Rv),h(Z,4,`moeda`,Cv,Wv,zv),h(Z,4,`lancamentoCorrente`,Sv,Wv,Bv),h(Z,4,`formulario`,xv,Wv,Vv),h(Z,4,`situacao`,bv,Wv,Hv),h(Z,4,`tipoFiltro`,yv,Wv,Uv),h(Z,1,`handleVistaChange`,vv,Wv),p(Z,Wv),g(Wv,`styles`,[D,Xh]),g(Wv,`dependencies`,{"kk-button":z,"kk-icon":Ls,"kk-icon-button":I,"kk-input":K,"kk-option":uv,"kk-select":Y,"kk-switch":wg}),Wv.define(`kk-financeiro`),Ls.define(`kk-icon`),I.define(`kk-icon-button`),K.define(`kk-input`),yp.define(`kk-menu`),pp.define(`kk-menu-item`),uv.define(`kk-option`);var Gv=C`
  :host {
...
`,Kv=`important`,qv=` !`+Kv,Jv=xo(class extends So{constructor(e){if(super(e),e.type!==bo.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(qv);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Kv:``):n[e]=r}}return Qa}}),Yv,Xv,Zv,Qv,$v,ey,ty,ny,ry=class extends (Qv=M,Zv=[O({type:Number,reflect:!0})],Xv=[O({type:Boolean,reflect:!0})],Yv=[O()],Qv){constructor(){super(...arguments),g(this,`localize`,new sa(this)),_(this,ey,m($v,8,this,0)),m($v,11,this),_(this,ty,m($v,12,this,!1)),m($v,15,this),_(this,ny,m($v,16,this,``)),m($v,19,this)}render(){return w`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${Jv({width:`${this.value}%`})}>
          ${this.indeterminate?``:w` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};$v=f(Qv),ey=new WeakMap,ty=new WeakMap,ny=new WeakMap,h($v,4,`value`,Zv,ry,ey),h($v,4,`indeterminate`,Xv,ry,ty),h($v,4,`label`,Yv,ry,ny),p($v,ry),g(ry,`styles`,[D,Gv]),ry.define(`kk-progress-bar`),Y.define(`kk-select`),Jc.define(`kk-spinner`),wg.define(`kk-switch`);var iy=C`
  :host {
    display: block;
  }
...
`,ay,oy,sy,cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Ay,jy,My,Ny,Q,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy,Zy,Qy,$y,eb,tb,nb,rb,ib,$=class extends (Ny=M,My=[A(`.textarea__control`)],jy=[k()],Ay=[O()],ky=[O()],Oy=[O()],Dy=[O({reflect:!0})],Ey=[O({type:Boolean,reflect:!0})],Ty=[O()],wy=[O({attribute:`help-text`})],Cy=[O()],Sy=[O({type:Number})],xy=[O()],by=[O({type:Boolean,reflect:!0})],yy=[O({type:Boolean,reflect:!0})],vy=[O({reflect:!0,converter:Xo})],_y=[O({type:Boolean,reflect:!0})],gy=[O({type:Number})],hy=[O({type:Number})],my=[O()],py=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],fy=[O()],dy=[O({type:Boolean})],uy=[O()],ly=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],cy=[O()],sy=[Do()],oy=[j(`disabled`,{waitUntilFirstUpdate:!0})],ay=[j(`value`,{waitUntilFirstUpdate:!0})],Ny){constructor(){super(...arguments),m(Q,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),_(this,Py,m(Q,8,this)),m(Q,11,this),_(this,Fy,m(Q,12,this,!1)),m(Q,15,this),_(this,Iy,m(Q,16,this,``)),m(Q,19,this),_(this,Ly,m(Q,20,this,``)),m(Q,23,this),_(this,Ry,m(Q,24,this,``)),m(Q,27,this),_(this,zy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,By,m(Q,32,this,!1)),m(Q,35,this),_(this,Vy,m(Q,36,this,``)),m(Q,39,this),_(this,Hy,m(Q,40,this,``)),m(Q,43,this),_(this,Uy,m(Q,44,this,``)),m(Q,47,this),_(this,Wy,m(Q,48,this,4)),m(Q,51,this),_(this,Gy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Ky,m(Q,56,this,!1)),m(Q,59,this),_(this,qy,m(Q,60,this,!1)),m(Q,63,this),_(this,Jy,m(Q,64,this,``)),m(Q,67,this),_(this,Yy,m(Q,68,this,!1)),m(Q,71,this),_(this,Xy,m(Q,72,this)),m(Q,75,this),_(this,Zy,m(Q,76,this)),m(Q,79,this),_(this,Qy,m(Q,80,this)),m(Q,83,this),_(this,$y,m(Q,84,this,!0)),m(Q,87,this),_(this,eb,m(Q,88,this)),m(Q,91,this),_(this,tb,m(Q,92,this)),m(Q,95,this),_(this,nb,m(Q,96,this)),m(Q,99,this),_(this,rb,m(Q,100,this,!0)),m(Q,103,this),_(this,ib,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.toggleState(`--empty`,!this.value),this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
      <div
        part="form-control"
        class=${E({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            <textarea
              ...
              placeholder=${N(this.placeholder)}
              rows=${N(this.rows)}
              style=${Jv({"--rows":String(this.rows)})}
              minlength=${N(this.minlength)}
              maxlength=${N(this.maxlength)}
              autocapitalize=${N(this.autocapitalize)}
              autocorrect=${this.autocorrect?`on`:`off`}
    ...
    `}};Q=f(Ny),Py=new WeakMap,Fy=new WeakMap,Iy=new WeakMap,Ly=new WeakMap,Ry=new WeakMap,zy=new WeakMap,By=new WeakMap,Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakMap,Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakMap,qy=new WeakMap,Jy=new WeakMap,Yy=new WeakMap,Xy=new WeakMap,Zy=new WeakMap,Qy=new WeakMap,$y=new WeakMap,eb=new WeakMap,tb=new WeakMap,nb=new WeakMap,rb=new WeakMap,ib=new WeakMap,h(Q,4,`input`,My,$,Py),h(Q,4,`hasFocus`,jy,$,Fy),h(Q,4,`title`,Ay,$,Iy),h(Q,4,`name`,ky,$,Ly),h(Q,4,`value`,Oy,$,Ry),h(Q,4,`size`,Dy,$,zy),h(Q,4,`filled`,Ey,$,By),h(Q,4,`label`,Ty,$,Vy),h(Q,4,`helpText`,wy,$,Hy),h(Q,4,`placeholder`,Cy,$,Uy),h(Q,4,`rows`,Sy,$,Wy),h(Q,4,`resize`,xy,$,Gy),h(Q,4,`disabled`,by,$,Ky),h(Q,4,`readonly`,yy,$,qy),h(Q,4,`form`,vy,$,Jy),h(Q,4,`required`,_y,$,Yy),h(Q,4,`minlength`,gy,$,Xy),h(Q,4,`maxlength`,hy,$,Zy),h(Q,4,`autocapitalize`,my,$,Qy),h(Q,4,`autocorrect`,py,$,$y),h(Q,4,`autocomplete`,fy,$,eb),h(Q,4,`autofocus`,dy,$,tb),h(Q,4,`enterkeyhint`,uy,$,nb),h(Q,4,`spellcheck`,ly,$,rb),h(Q,4,`inputmode`,cy,$,ib),h(Q,1,`handleDisabledChange`,oy,$),h(Q,1,`handleValueChange`,ay,$),h(Q,5,`defaultValue`,sy,$),p(Q,$),g($,`styles`,[D,Cp,iy]),g($,`formAssociated`,!0),$.define(`kk-textarea`),te(`./ui`);var ab=document.querySelector(`#app`);function ob(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:Ei({executar:()=>void hb(!0),ocupado:fb})};let t=Gt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Zr()};if(sb[t.id]===void 0||!qt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Xr(t)};let n=db.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:$r(n)};let r=cb.get(t.id);return r===void 0?(ub(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Qr()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var sb={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-CpU6qQaC.js`);return{telaAnotacoes:e}},__vite__mapDeps([23,5,3,4,24,25,26]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-CZ4dB801.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-B7YsF_Ju.js`);return{telaCalendario:e}},__vite__mapDeps([27,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-oaCksDmD.js`);return{telaCriacao:e}},__vite__mapDeps([28,4,25,24,29,30,31,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-oaCksDmD.js`);return{telaCriacao:e}},__vite__mapDeps([28,4,25,24,29,30,31,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-BWU9BIUz.js`);return{telaFaq:e}},__vite__mapDeps([32,4,33,34,24,25,30]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-CAhA2MdI.js`);return{telaImite:e}},__vite__mapDeps([35,24,25,30]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-B9r7E1Gy.js`);return{telaCronologia:e}},__vite__mapDeps([36,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-DIAOq9C4.js`);return{telaEstudo:e}},__vite__mapDeps([37,12,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-tgzKNj_Z.js`);return{telaFinanceiro:e}},__vite__mapDeps([38,8,9,29,25,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-CIO3s_SY.js`);return{telaGuias:e}},__vite__mapDeps([39,4,5,24,25,26,40,17]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-B3EpeUyx.js`);return{telaJogo:e}},__vite__mapDeps([41,24,25,11,4]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-Cjhz-eSf.js`);return{telaLeitura:e}},__vite__mapDeps([42,43]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-B5fIsPBZ.js`);return{telaMetas:e}},__vite__mapDeps([44,10,9,8,4,5,11]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-BB5c1Z4-.js`);return{telaMinisterio:e}},__vite__mapDeps([45,24,25,40,13,4,5,14,15]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-B1NjqrYe.js`);return{telaPerfil:e}},__vite__mapDeps([46,40,14,15,4,22]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-CP1cZ_da.js`);return{telaPoesia:e}},__vite__mapDeps([47,4,5,34,24,25,26,40,17]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-CVnMtL-i.js`);return{telaPrep:e}},__vite__mapDeps([48,9,4,20,19,5,18]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-CmpCYA1a.js`);return{telaPrincipios:e}},__vite__mapDeps([49,4,33,34,24,25,30]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-GLS8-lyC.js`);return{telaReceitas:e}},__vite__mapDeps([50,5,34,24,25,26,40,17,16,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-0zsWbBxT.js`);return{telaServico:e}},__vite__mapDeps([51,10,9,8,4,5,11]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-BlrhYdWx.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-CAb88i57.js`);return{telaTutorial:e}},__vite__mapDeps([52,4,24,25,53]),import.meta.url)).telaTutorial},cb=new Map,lb=new Set;function ub(e){let t=sb[e];t===void 0||cb.has(e)||lb.has(e)||(lb.add(e),t().then(t=>{cb.set(e,t),pb()}).catch(t=>{lb.delete(e),db.set(e,String(t)),pb()}))}var db=new Map,fb=!1;function pb(){if(ab===null)return;let e=mb,{cabecalho:t,conteudo:n}=ob(e);document.title=e.modulo===`home`?u.displayName:`${t.titulo} — ${u.displayName}`,document.documentElement.dataset.modulo=e.modulo,wt(vr(t,n,pb),ab),mr()}var mb={modulo:`home`,args:[],query:new URLSearchParams};async function hb(e){if(!fb){fb=!0,pb();try{let t=await tr();if(!e)return;t.ok?Ni(x.home.sincronizado(t.atualizados.length)):Ni(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{fb=!1,pb()}}}function gb(){ab!==null&&wt(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
    `,ab)}function _b(e){ab!==null&&wt(v`
      <div class="aviso">
        <kk-icon class="aviso__icone" name="alert-triangle"></kk-icon>
        <h2>${x.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
    ...
    `,ab)}function vb(e){switch(e){case`instancia-dupla`:return x.armazenamento.memoriaInstanciaDupla;case`indisponivel`:return x.armazenamento.memoriaIndisponivel;default:return x.armazenamento.memoriaOrigemInsegura}}async function yb(){await zt(Lt()),gb(),Qt(pb);try{let e=await i();e.persistente||Ni(vb(e.motivo),`warning`)}catch(e){_b(String(e));return}ab?.removeAttribute(`aria-busy`),addEventListener(`unhandledrejection`,e=>{e.preventDefault(),console.error(`Kobi Note: uma ação falhou.`,e.reason),Ni(x.app.acaoFalhou,`danger`)}),Xt(e=>{mb=e,pb(),scrollTo({top:0})}),on(),hb(!1),En(),Vi(pb),Ji()}window.__note={repositorio:o,apagarDados:Pn,navegacao:{MODULOS:Vt,ATALHOS:Bt,HOME:Ht},imite:{carregarCartoes:Nr,lerLentes:Fr},caderno:{listarAnotacoes:Sr},badge:{atualizar:wn},backup:{montar:Wn,ler:Jn,restaurar:Yn}},location.hash===``&&Yt(`home`),yb();export{_n as $,qr as A,Ar as B,Jr as C,u as Ct,Fr as D,Ir as E,Cr as F,Tr as G,br as H,yr as I,qn as J,ar as K,kr as L,Gr as M,zr as N,Ur as O,Rr as P,vn as Q,Er as R,Nr as S,_ as St,Lr as T,Or as U,Sr as V,jr as W,Yn as X,Jn as Y,gn as Z,Ai as _,p as _t,O as a,un as at,ti as b,h as bt,w as c,Yt as ct,Bi as d,x as dt,fn as et,zi as f,b as ft,ki as g,St as gt,Oi as h,v as ht,A as i,dn as it,Kr as j,Hr as k,C as l,Vt as lt,Ni as m,ct as mt,hh as n,xn as nt,M as o,bn as ot,Pi as p,y as pt,Gn as q,j as r,pn as rt,D as s,$t as st,Jv as t,ln as tt,qi as u,Gt as ut,Di as v,f as vt,Yr as w,Br as x,g as xt,ei as y,m as yt,wr as z};