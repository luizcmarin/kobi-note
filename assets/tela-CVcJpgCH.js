import{c as e,o as t}from"./banco-CsCRyC2b.js";import{t as n}from"./catalogo-B2Z121mU.js";import{S as r,U as i,at as a,ct as o,ft as s,it as c,ut as l,x as u}from"./index-DtxwN5g2.js";import{alternarFavorito as d,chaveFavorito as f,lerFavoritos as p}from"./favoritos-DAEWA_Gd.js";import{t as m}from"./unsafe-html-e5X31ccZ.js";import{t as ee}from"./rascunho-CTD2iMeK.js";var h=`note_principios_favoritos`,g=`scale`;async function _(){return(await e(`principios`).todos()).sort((e,t)=>y(e.area)-y(t.area)||Number(e.ordem)-Number(t.ordem)||Number(e.id??0)-Number(t.id??0))}var v=Object.keys(n);function y(e){let t=v.indexOf(e);return t===-1?v.length:t}function b(e){return e===``?n.coracao??e:n[e]??e}function x(e){if(e===null)return[];try{let t=JSON.parse(e.reflexoes===``?`[]`:e.reflexoes);return Array.isArray(t)?t:[]}catch{return[]}}var S={busca:``};function te(e,t){return t===null?e:e.filter(e=>t.has(Number(e.id)))}function ne(e,t){let n=new Map;for(let t of e){let e=n.get(t.area);e===void 0?n.set(t.area,[t]):e.push(t)}return[...n].map(([e,n])=>({area:e,rotulo:b(e),principios:n,concluida:n.every(t)}))}var C=`note_principios_progresso`;function w(){return{lidos:{}}}function re(){try{let e=JSON.parse(localStorage.getItem(C)??`null`);return{...w(),...e}}catch{return w()}}function ie(e){localStorage.setItem(C,JSON.stringify(e))}function T(e,t){let n=e.lidos[String(t)],r={...e,lidos:{...e.lidos,[String(t)]:{aberturas:(n?.aberturas??0)+1,lidoEm:Date.now()}}};return ie(r),r}function E(e,t){return t?.id!==void 0&&e.lidos[String(t.id)]!==void 0}function D(e,t){return t.filter(t=>E(e,t)).length}function O(e){return`principios:${e}`}async function k(){let e=new Map;for(let t of await i()){if(t.origem!==`principios`||t.ref_chave===null)continue;let n=Number(t.ref_chave.split(`:`)[1]);Number.isFinite(n)&&e.set(n,t.conteudo)}return e}function A(e,t){return t?.id!==void 0&&(e.get(t.id)??``).trim()!==``}var j=[],M=new Map,N=new Set,P=w(),F=!1,I=!1,L=null,R=S,z=null,B=``;function V(e){B=e,t(`not_principios`,e).then(t=>{B===e&&(z=t===null?null:new Set(t),c())})}var H=-1,U=ee({origem:`principios`,idDe:e=>e.id,chaveDe:e=>O(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${o.principios.titulo} — ${e.titulo}`,lembrete:()=>M});function W(){F||I||L!==null||(I=!0,(async()=>{try{[j,M]=await Promise.all([_(),k()]),N=p(h),P=re(),F=!0}catch(e){console.error(`principios: a carga falhou.`,e),L=r(e)}finally{I=!1,c()}})())}function G(){L=null,W(),c()}function K(e){return j.find(t=>t.id===e)}function q(e){H!==e.id&&(H=e.id??-1,U.abrir(e.id===void 0?``:M.get(e.id)??``),F&&e.id!==void 0&&(P=T(P,e.id)))}function J(e){return f(`curado`,e.id)}function Y(e){return N.has(J(e))}function X(e){N=d(h,N,J(e)),c()}function ae(e){return e.icone===``?g:e.icone}function oe(e){let t=Y(e);return s`
    <div class="cartao cartao--com-acao" ?data-favorito=${t}>
      <button class="cartao__alvo" @click=${()=>a(`principios/${e.id??``}`)}>
        ...
        ${e.referencia===``?l:s`<small class="principios__versos">${e.referencia}</small>`}
      </button>
  ...
  `}function Z(e,t,n,r,i=!1){return s`
    <kk-details class="principios__secao" name="principios-areas" ?open=${n}>
      ...
      >
        ${e}
        ${r?s`<kk-icon name="check" title=${o.principios.areaLida}></kk-icon>`:l}
      </span>
    ...
    <div class="principios">
      ...
      ${e.length===0?s`<p class="vazio">${o.principios.semResultado}</p>`:s`
            <kk-accordion class="principios__areas">
              ${u.length===0?l:Z(o.principios.favoritos,u,!0,u.every(n),!0)}
              ${r.map((e,t)=>Z(e.rotulo,e.principios,u.length===0&&t===d,e.concluida))}
            </kk-accordion>
          `}
    </div>
  `}function ce(e){let t=x(e);return t.length===0?l:s`
