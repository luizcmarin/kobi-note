import{_t as e,h as t,kt as n,m as r,xt as i}from"./index-tEHw1VqD.js";import{t as a}from"./qr-C0FiOTS_.js";var o=`https://luizcmarin.github.io/kobi-note`;function s(t=o){return`${e.convite.mensagem}\n\n${t}`}function c(e){return`https://wa.me/?text=${encodeURIComponent(s(e))}`}async function l(t){try{await navigator.clipboard.writeText(s(t)),r(e.convite.copiado)}catch{r(e.leitura.semCopiar,`warning`)}}async function u(t){if(typeof navigator.share!=`function`){await l(t);return}try{await navigator.share({title:n.displayName,text:e.convite.mensagem,url:t})}catch{}}function d(){let r=o;return a(),t(e.convite.titulo,void 0,(t,a)=>i`
        <div class="convite">
          <img
