import{A as e,C as t,D as n,E as r,M as i,N as a,O as o,S as s,T as c,b as l,ft as u,j as d,k as f,mt as p,ot as m,st as h,ut as g,v as _,w as v,x as y,y as b}from"./index-CWdQis_V.js";import{t as x}from"./unsafe-html-B74_ovmz.js";import{t as S}from"./rascunho-BrZb2rxr.js";var C=[],w=o(),T=new Map,E=!1,D=!1,O=null,k=-1,A=null,j=!1,M=!1,N=``,P=``,F=S({origem:`imite`,idDe:e=>e.id,chaveDe:e=>f(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${g.imite.titulo} — ${e.titulo}`,lembrete:()=>T});function I(){E||D||O!==null||(D=!0,(async()=>{try{[C,T]=await Promise.all([y(),s()]),w=n(),E=!0}catch(e){console.error(`imite: a carga falhou.`,e),O=b(e)}finally{D=!1,m()}})())}function L(){O=null,I(),m()}function R(e){return C.find(t=>t.id===e)}function z(e){k!==e.id&&(k=e.id??-1,A=null,j=!1,M=!1,N=``,P=``,F.abrir(e.id===void 0?``:T.get(e.id)??``))}function B(e){j||A===null||(v(e,A)?(j=!0,P=`ok`,N=i(e,A)||g.imite.acerto,V(e)):(P=`erro`,N=i(e,A)||g.imite.erro),m())}function V(e){M||e.id===void 0||(w=d(w,e.id),M=!0)}function H(e){return t(w,T,e)}function U(t){return p`
