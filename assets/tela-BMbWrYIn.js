import{A as e,C as t,D as n,E as r,M as i,N as a,O as o,S as s,T as c,b as l,ct as u,et as d,it as f,j as p,k as m,ot as h,tt as g,v as _,w as v,x as y,y as b}from"./index-CFqbq_HS.js";import{t as x}from"./unsafe-html-QuUKS8vu.js";import{t as S}from"./rascunho-TsVq0MpB.js";var C=[],w=o(),T=new Map,E=!1,D=!1,O=null,k=-1,A=null,j=!1,M=!1,N=``,P=``,F=S({origem:`imite`,idDe:e=>e.id,chaveDe:e=>m(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${f.imite.titulo} — ${e.titulo}`,lembrete:()=>T});function I(){E||D||O!==null||(D=!0,(async()=>{try{[C,T]=await Promise.all([y(),s()]),w=n(),E=!0}catch(e){console.error(`imite: a carga falhou.`,e),O=b(e)}finally{D=!1,d()}})())}function L(){O=null,I(),d()}function R(e){return C.find(t=>t.id===e)}function z(e){k!==e.id&&(k=e.id??-1,A=null,j=!1,M=!1,N=``,P=``,F.abrir(e.id===void 0?``:T.get(e.id)??``))}function B(e){j||A===null||(v(e,A)?(j=!0,P=`ok`,N=i(e,A)||f.imite.acerto,V(e)):(P=`erro`,N=i(e,A)||f.imite.erro),d())}function V(e){M||e.id===void 0||(w=p(w,e.id),M=!0)}function H(e){return t(w,T,e)}function U(t){return u`
