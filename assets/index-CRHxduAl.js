const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./en-cyosMc_6.js","./plural-0_xhPFb3.js","./es-ES-1zks2HkO.js","./dados-DmrSQMqn.js","./banco-CoZpC69A.js","./texto-DhKYsM3f.js","./dados-Bj9c2eZe.js","./dados-CXHIQynw.js","./dinheiro-f7T9Mvpd.js","./numero-B0JnuQJ5.js","./dados-CpoXM13k.js","./dados-DPL-adZQ.js","./dados-Cy2lM-TC.js","./dados-CTVEkYCc.js","./dados-7qK6hWo0.js","./acervo-mwj3Kh77.js","./kits-BAg-dfHO.js","./estoque-3kqT3m_y.js","./dados-BgDpV8rv.js","./dados-Dfg_tw9K.js","./convite-CTv_j0o6.js","./qr-_OKXDUdP.js","./tela-RmjnoFQf.js","./unsafe-html-D0pFEAyA.js","./directive-BSZPiF1A.js","./leitura-4vfP5Wgi.js","./tela-D_CH7e1B.js","./tela-DZIIG3Om.js","./ref-CP3bbhSB.js","./rascunho-CIsb26Fs.js","./base-DtiOyRXQ.js","./tela-DDzkypav.js","./catalogo-B2Z121mU.js","./favoritos-DAEWA_Gd.js","./tela-DFQifSe7.js","./tela-DCPGEZRw.js","./tela-DdGhc0s2.js","./tela-BjnBUNXn.js","./tela-DjPh8MqB.js","./compartilhar-D1yn7h0A.js","./tela-CrVhOn2D.js","./tela-DM5iBQFf.js","./dados-CrToLRPu.js","./tela-D7-Geaxt.js","./tela-CfmJoAvs.js","./tela-CpA_dU-L.js","./tela-BFLu7BOW.js","./tela-W3XGWnRH.js","./tela-BgWniyZz.js","./tela-C62AXJS4.js","./tela-BvSVUFcl.js","./tela-CyrwRT1-.js","./tela-CXkCKLrt.js"])))=>i.map(i=>d[i]);
...
`,J_,Y_,X_,Z_,Q_,$_,ev,tv,nv,rv,X,iv,av,ov,sv,cv,lv,uv=class extends (rv=M,nv=[A(`.option__label`)],tv=[k()],ev=[k()],$_=[k()],Q_=[O({reflect:!0})],Z_=[O({type:Boolean,reflect:!0})],X_=[j(`disabled`)],Y_=[j(`selected`)],J_=[j(`value`)],rv){constructor(){super(...arguments),m(X,5,this),g(this,`localize`,new sa(this)),g(this,`isInitialized`,!1),_(this,iv,m(X,8,this)),m(X,11,this),_(this,av,m(X,12,this,!1)),m(X,15,this),_(this,ov,m(X,16,this,!1)),m(X,19,this),_(this,sv,m(X,20,this,!1)),m(X,23,this),_(this,cv,m(X,24,this,``)),m(X,27,this),_(this,lv,m(X,28,this,!1)),m(X,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`kk-select`).then(()=>{let e=this.closest(`kk-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return w`
    ...
    `}renderVista(){let e=this.formulario;return e===null?this.vista===`transacoes`?this.renderTransacoes():this.vista===`categorias`?this.renderCategorias():this.vista===`recorrencias`?this.renderRecorrencias():this.renderPainel():e.especie===`transacao`?this.renderFormTransacao(e.dados):e.especie===`categoria`?this.renderFormCategoria(e.dados):this.renderFormRecorrencia(e.dados)}render(){return w`<div part="base" class="financeiro">${this.renderVista()}</div>`}};Z=f(kv),Av=new WeakMap,jv=new WeakMap,Mv=new WeakMap,Nv=new WeakMap,Pv=new WeakMap,Fv=new WeakMap,Iv=new WeakMap,Lv=new WeakMap,Rv=new WeakMap,zv=new WeakMap,h(Z,4,`vista`,Ov,Bv,Av),h(Z,4,`categorias`,Dv,Bv,jv),h(Z,4,`partes`,Ev,Bv,Mv),h(Z,4,`transacoes`,Tv,Bv,Nv),h(Z,4,`recorrencias`,wv,Bv,Pv),h(Z,4,`mes`,Cv,Bv,Fv),h(Z,4,`oculto`,Sv,Bv,Iv),h(Z,4,`moeda`,xv,Bv,Lv),h(Z,4,`lancamentoCorrente`,bv,Bv,Rv),h(Z,4,`formulario`,yv,Bv,zv),h(Z,1,`handleVistaChange`,vv,Bv),p(Z,Bv),g(Bv,`styles`,[D,Xh]),g(Bv,`dependencies`,{"kk-button":z,"kk-icon":Ls,"kk-icon-button":I,"kk-input":K,"kk-option":uv,"kk-select":Y,"kk-switch":wg}),Bv.define(`kk-financeiro`),Ls.define(`kk-icon`),I.define(`kk-icon-button`),K.define(`kk-input`),yp.define(`kk-menu`),pp.define(`kk-menu-item`),uv.define(`kk-option`);var Vv=C`
  :host {
...
`,Hv=`important`,Uv=` !`+Hv,Wv=xo(class extends So{constructor(e){if(super(e),e.type!==bo.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Uv);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Hv:``):n[e]=r}}return Qa}}),Gv,Kv,qv,Jv,Yv,Xv,Zv,Qv,$v=class extends (Jv=M,qv=[O({type:Number,reflect:!0})],Kv=[O({type:Boolean,reflect:!0})],Gv=[O()],Jv){constructor(){super(...arguments),g(this,`localize`,new sa(this)),_(this,Xv,m(Yv,8,this,0)),m(Yv,11,this),_(this,Zv,m(Yv,12,this,!1)),m(Yv,15,this),_(this,Qv,m(Yv,16,this,``)),m(Yv,19,this)}render(){return w`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${Wv({width:`${this.value}%`})}>
          ${this.indeterminate?``:w` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};Yv=f(Jv),Xv=new WeakMap,Zv=new WeakMap,Qv=new WeakMap,h(Yv,4,`value`,qv,$v,Xv),h(Yv,4,`indeterminate`,Kv,$v,Zv),h(Yv,4,`label`,Gv,$v,Qv),p(Yv,$v),g($v,`styles`,[D,Vv]),$v.define(`kk-progress-bar`),Y.define(`kk-select`),Jc.define(`kk-spinner`),wg.define(`kk-switch`);var ey=C`
  :host {
    display: block;
  }
...
`,ty,ny,ry,iy,ay,oy,sy,cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Q,Ay,jy,My,Ny,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy,Zy,Qy,$y,eb,$=class extends (ky=M,Oy=[A(`.textarea__control`)],Dy=[k()],Ey=[O()],Ty=[O()],wy=[O()],Cy=[O({reflect:!0})],Sy=[O({type:Boolean,reflect:!0})],xy=[O()],by=[O({attribute:`help-text`})],yy=[O()],vy=[O({type:Number})],_y=[O()],gy=[O({type:Boolean,reflect:!0})],hy=[O({type:Boolean,reflect:!0})],my=[O({reflect:!0,converter:Xo})],py=[O({type:Boolean,reflect:!0})],fy=[O({type:Number})],dy=[O({type:Number})],uy=[O()],ly=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],cy=[O()],sy=[O({type:Boolean})],oy=[O()],ay=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],iy=[O()],ry=[Do()],ny=[j(`disabled`,{waitUntilFirstUpdate:!0})],ty=[j(`value`,{waitUntilFirstUpdate:!0})],ky){constructor(){super(...arguments),m(Q,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),_(this,Ay,m(Q,8,this)),m(Q,11,this),_(this,jy,m(Q,12,this,!1)),m(Q,15,this),_(this,My,m(Q,16,this,``)),m(Q,19,this),_(this,Ny,m(Q,20,this,``)),m(Q,23,this),_(this,Py,m(Q,24,this,``)),m(Q,27,this),_(this,Fy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,Iy,m(Q,32,this,!1)),m(Q,35,this),_(this,Ly,m(Q,36,this,``)),m(Q,39,this),_(this,Ry,m(Q,40,this,``)),m(Q,43,this),_(this,zy,m(Q,44,this,``)),m(Q,47,this),_(this,By,m(Q,48,this,4)),m(Q,51,this),_(this,Vy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Hy,m(Q,56,this,!1)),m(Q,59,this),_(this,Uy,m(Q,60,this,!1)),m(Q,63,this),_(this,Wy,m(Q,64,this,``)),m(Q,67,this),_(this,Gy,m(Q,68,this,!1)),m(Q,71,this),_(this,Ky,m(Q,72,this)),m(Q,75,this),_(this,qy,m(Q,76,this)),m(Q,79,this),_(this,Jy,m(Q,80,this)),m(Q,83,this),_(this,Yy,m(Q,84,this,!0)),m(Q,87,this),_(this,Xy,m(Q,88,this)),m(Q,91,this),_(this,Zy,m(Q,92,this)),m(Q,95,this),_(this,Qy,m(Q,96,this)),m(Q,99,this),_(this,$y,m(Q,100,this,!0)),m(Q,103,this),_(this,eb,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.toggleState(`--empty`,!this.value),this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
      <div
        part="form-control"
        class=${E({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            <textarea
              ...
              placeholder=${N(this.placeholder)}
              rows=${N(this.rows)}
              style=${Wv({"--rows":String(this.rows)})}
              minlength=${N(this.minlength)}
              maxlength=${N(this.maxlength)}
              autocapitalize=${N(this.autocapitalize)}
              autocorrect=${this.autocorrect?`on`:`off`}
    ...
    `}};Q=f(ky),Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,Fy=new WeakMap,Iy=new WeakMap,Ly=new WeakMap,Ry=new WeakMap,zy=new WeakMap,By=new WeakMap,Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakMap,Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakMap,qy=new WeakMap,Jy=new WeakMap,Yy=new WeakMap,Xy=new WeakMap,Zy=new WeakMap,Qy=new WeakMap,$y=new WeakMap,eb=new WeakMap,h(Q,4,`input`,Oy,$,Ay),h(Q,4,`hasFocus`,Dy,$,jy),h(Q,4,`title`,Ey,$,My),h(Q,4,`name`,Ty,$,Ny),h(Q,4,`value`,wy,$,Py),h(Q,4,`size`,Cy,$,Fy),h(Q,4,`filled`,Sy,$,Iy),h(Q,4,`label`,xy,$,Ly),h(Q,4,`helpText`,by,$,Ry),h(Q,4,`placeholder`,yy,$,zy),h(Q,4,`rows`,vy,$,By),h(Q,4,`resize`,_y,$,Vy),h(Q,4,`disabled`,gy,$,Hy),h(Q,4,`readonly`,hy,$,Uy),h(Q,4,`form`,my,$,Wy),h(Q,4,`required`,py,$,Gy),h(Q,4,`minlength`,fy,$,Ky),h(Q,4,`maxlength`,dy,$,qy),h(Q,4,`autocapitalize`,uy,$,Jy),h(Q,4,`autocorrect`,ly,$,Yy),h(Q,4,`autocomplete`,cy,$,Xy),h(Q,4,`autofocus`,sy,$,Zy),h(Q,4,`enterkeyhint`,oy,$,Qy),h(Q,4,`spellcheck`,ay,$,$y),h(Q,4,`inputmode`,iy,$,eb),h(Q,1,`handleDisabledChange`,ny,$),h(Q,1,`handleValueChange`,ty,$),h(Q,5,`defaultValue`,ry,$),p(Q,$),g($,`styles`,[D,Cp,ey]),g($,`formAssociated`,!0),$.define(`kk-textarea`),te(`./ui`);var tb=document.querySelector(`#app`);function nb(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:Ei({executar:()=>void db(!0),ocupado:cb})};let t=Gt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Zr()};if(rb[t.id]===void 0||!qt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Xr(t)};let n=sb.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:$r(n)};let r=ib.get(t.id);return r===void 0?(ob(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Qr()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var rb={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-RmjnoFQf.js`);return{telaAnotacoes:e}},__vite__mapDeps([22,5,3,4,23,24,25]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-CkDLNGt0.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-D_CH7e1B.js`);return{telaCalendario:e}},__vite__mapDeps([26,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-DZIIG3Om.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,23,28,29,30,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-DZIIG3Om.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,23,28,29,30,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-DDzkypav.js`);return{telaFaq:e}},__vite__mapDeps([31,4,32,33,23,24,29]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-DFQifSe7.js`);return{telaImite:e}},__vite__mapDeps([34,23,24,29]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-DCPGEZRw.js`);return{telaCronologia:e}},__vite__mapDeps([35,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-DdGhc0s2.js`);return{telaEstudo:e}},__vite__mapDeps([36,12,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-BjnBUNXn.js`);return{telaFinanceiro:e}},__vite__mapDeps([37,8,9,28,24,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-DjPh8MqB.js`);return{telaGuias:e}},__vite__mapDeps([38,4,5,23,24,25,39,15]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-CrVhOn2D.js`);return{telaJogo:e}},__vite__mapDeps([40,23,24,11,4]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-DM5iBQFf.js`);return{telaLeitura:e}},__vite__mapDeps([41,42]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-D7-Geaxt.js`);return{telaMetas:e}},__vite__mapDeps([43,10,9,8,4,5,11]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-CfmJoAvs.js`);return{telaMinisterio:e}},__vite__mapDeps([44,23,24,39,13,4,5]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-CpA_dU-L.js`);return{telaPerfil:e}},__vite__mapDeps([45,39,19,4,21]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-BFLu7BOW.js`);return{telaPoesia:e}},__vite__mapDeps([46,4,5,33,23,24,25,39,15]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-W3XGWnRH.js`);return{telaPrep:e}},__vite__mapDeps([47,9,4,18,17,5,16]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-BgWniyZz.js`);return{telaPrincipios:e}},__vite__mapDeps([48,4,32,33,23,24,29]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-C62AXJS4.js`);return{telaReceitas:e}},__vite__mapDeps([49,5,33,23,24,25,39,15,14,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-BvSVUFcl.js`);return{telaServico:e}},__vite__mapDeps([50,10,9,8,4,5,11]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-CXkCKLrt.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-CyrwRT1-.js`);return{telaTutorial:e}},__vite__mapDeps([51,4,23,24,52]),import.meta.url)).telaTutorial},ib=new Map,ab=new Set;function ob(e){let t=rb[e];t===void 0||ib.has(e)||ab.has(e)||(ab.add(e),t().then(t=>{ib.set(e,t),lb()}).catch(t=>{ab.delete(e),sb.set(e,String(t)),lb()}))}var sb=new Map,cb=!1;function lb(){if(tb===null)return;let e=ub,{cabecalho:t,conteudo:n}=nb(e);document.title=e.modulo===`home`?u.displayName:`${t.titulo} — ${u.displayName}`,document.documentElement.dataset.modulo=e.modulo,wt(vr(t,n,lb),tb),mr()}var ub={modulo:`home`,args:[],query:new URLSearchParams};async function db(e){if(!cb){cb=!0,lb();try{let t=await tr();if(!e)return;t.ok?Ni(x.home.sincronizado(t.atualizados.length)):Ni(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{cb=!1,lb()}}}function fb(){tb!==null&&wt(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
    `,tb)}function pb(e){tb!==null&&wt(v`
      <div class="aviso">
        <kk-icon class="aviso__icone" name="alert-triangle"></kk-icon>
        <h2>${x.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
    ...
    `,tb)}function mb(e){switch(e){case`instancia-dupla`:return x.armazenamento.memoriaInstanciaDupla;case`indisponivel`:return x.armazenamento.memoriaIndisponivel;default:return x.armazenamento.memoriaOrigemInsegura}}async function hb(){await zt(Lt()),fb(),Qt(lb);try{let e=await i();e.persistente||Ni(mb(e.motivo),`warning`)}catch(e){pb(String(e));return}tb?.removeAttribute(`aria-busy`),addEventListener(`unhandledrejection`,e=>{e.preventDefault(),console.error(`Kobi Note: uma ação falhou.`,e.reason),Ni(x.app.acaoFalhou,`danger`)}),Xt(e=>{ub=e,lb(),scrollTo({top:0})}),on(),db(!1),En(),Vi(lb),Ji()}window.__note={repositorio:o,apagarDados:Pn,navegacao:{MODULOS:Vt,ATALHOS:Bt,HOME:Ht},imite:{carregarCartoes:Nr,lerLentes:Fr},caderno:{listarAnotacoes:Sr},badge:{atualizar:wn},backup:{montar:Wn,ler:Jn,restaurar:Yn}},location.hash===``&&Yt(`home`),hb();export{_n as $,qr as A,Ar as B,Jr as C,u as Ct,Fr as D,Ir as E,Cr as F,Tr as G,br as H,yr as I,qn as J,ar as K,kr as L,Gr as M,zr as N,Ur as O,Rr as P,vn as Q,Er as R,Nr as S,_ as St,Lr as T,Or as U,Sr as V,jr as W,Yn as X,Jn as Y,gn as Z,Ai as _,p as _t,O as a,un as at,ti as b,h as bt,w as c,Yt as ct,Bi as d,x as dt,fn as et,zi as f,b as ft,ki as g,St as gt,Oi as h,v as ht,A as i,dn as it,Kr as j,Hr as k,C as l,Vt as lt,Ni as m,ct as mt,hh as n,xn as nt,M as o,bn as ot,Pi as p,y as pt,Gn as q,j as r,pn as rt,D as s,$t as st,Wv as t,ln as tt,qi as u,Gt as ut,Di as v,f as vt,Yr as w,Br as x,g as xt,ei as y,m as yt,wr as z};