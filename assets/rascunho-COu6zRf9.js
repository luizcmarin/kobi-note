import{B as e,W as t,_t as n,ft as r,ht as i,st as a}from"./index-BESQMk3B.js";var o=500;function s(s){let c=``,l;function u(n){clearTimeout(l),l=setTimeout(()=>{(async()=>{let r=s.idDe(n);if(r===void 0)return;let i=c.trim(),o=s.chaveDe(n);i===``?(await t(o),s.lembrete().delete(r)):(await e({origem:s.origem,referencia:s.referenciaDe(n),titulo:s.tituloDe(n),conteudo:i,ref_chave:o}),s.lembrete().set(r,i)),a()})()},o)}return{get texto(){return c},abrir(e){clearTimeout(l),c=e},campo({item:e,id:t,rotulo:a,placeholder:o,apoio:s}){return n`
        <div class="rascunho">
