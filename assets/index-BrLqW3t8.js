...
\f\r]`,tt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,nt=/-->/g,rt=/>/g,it=RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),at=/'/g,ot=/"/g,st=/^(?:script|style|textarea|title)$/i,v=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),ct=Symbol.for(`lit-noChange`),y=Symbol.for(`lit-nothing`),lt=new WeakMap,ut=Ye.createTreeWalker(Ye,129);function dt(e,t){if(!Qe(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return We===void 0?t:We.createHTML(t)}var ft=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=tt;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===tt?c[1]===`!--`?o=nt:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=it):(st.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=it):o=rt:o===it?c[0]===`>`?(o=i??tt,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?it:c[3]===`"`?ot:at):o===ot||o===at?o=it:o===nt||o===rt?o=tt:(o=it,i=void 0);let d=o===it&&e[t+1].startsWith(`/>`)?` `:``;a+=o===tt?n+Je:l>=0?(r.push(s),n.slice(0,l)+Ge+n.slice(l)+Ke+d):n+Ke+(l===-2?t:d)}return[dt(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},pt=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=ft(t,n);if(this.el=e.createElement(l,r),ut.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=ut.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(Ge)){let t=u[o++],n=i.getAttribute(e).split(Ke),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?vt:r[1]===`?`?yt:r[1]===`@`?bt:_t}),i.removeAttribute(e)}else e.startsWith(Ke)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(st.test(i.tagName)){let e=i.textContent.split(Ke),t=e.length-1;if(t>0){i.textContent=Ue?Ue.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Xe()),ut.nextNode(),c.push({type:2,index:++a});i.append(e[t],Xe())}}}else if(i.nodeType===8){if(i.data===qe)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Ke,e+1))!==-1;)c.push({type:7,index:a}),e+=Ke.length-1}}a++}}static createElement(e,t){let n=Ye.createElement(`template`);return n.innerHTML=e,n}};function mt(e,t,n=e,r){if(t===ct)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=Ze(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=mt(e,i._$AS(e,t.values),i,r)),t}var ht=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Ye).importNode(t,!0);ut.currentNode=r;let i=ut.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new gt(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new xt(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=ut.nextNode(),a++)}return ut.currentNode=Ye,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},gt=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=mt(this,e,t),Ze(e)?e===y||e==null||e===``?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==ct&&this._(e):e._$litType$===void 0?e.nodeType===void 0?$e(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&Ze(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ye.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=pt.createElement(dt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new ht(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=lt.get(e.strings);return t===void 0&&lt.set(e.strings,t=new pt(e)),t}k(t){Qe(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(Xe()),this.O(Xe()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=He(e).nextSibling;He(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},_t=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=mt(this,e,t,0),a=!Ze(e)||e!==this._$AH&&e!==ct,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=mt(this,r[n+o],t,o),s===ct&&(s=this._$AH[o]),a||=!Ze(s)||s!==this._$AH[o],s===y?e=y:e!==y&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},vt=class extends _t{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},yt=class extends _t{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},bt=class extends _t{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=mt(this,e,t,0)??y)===ct)return;let n=this._$AH,r=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==y&&(n===y||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},xt=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){mt(this,e)}},St={M:Ge,P:Ke,A:qe,C:1,L:ft,R:ht,D:$e,V:mt,I:gt,H:_t,N:yt,U:bt,B:vt,F:xt},Ct=Ve.litHtmlPolyfillSupport;Ct?.(pt,gt),(Ve.litHtmlVersions??=[]).push(`3.3.3`);var wt=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new gt(t.insertBefore(Xe(),e),e,void 0,n??{})}return i._$AI(e),i},Tt=globalThis,Et=class extends Be{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=wt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ct}};Et._$litElement$=!0,Et.finalized=!0,Tt.litElementHydrateSupport?.({LitElement:Et});var Dt=Tt.litElementPolyfillSupport;Dt?.({LitElement:Et}),(Tt.litElementVersions??=[]).push(`4.2.2`);var Ot=`Sua mente fora da nuvem. Estudo pessoal, criatividade, finanças e preparo tático reunidos em um espaço sob seu domínio absoluto com zero distrações.`,kt={app:{nome:`Kobi Note`,carregando:`Carregando...`,acaoFalhou:`Não foi possível concluir. Tente de novo.`},home:{saudacao:`Kobi Note`,sub:Ot,modulos:`Módulos`,sincronizar:`Sincronizar conteúdo`,sincronizando:`Sincronizando...`,sincronizado:e=>e===0?`Nenhuma novidade para hoje.`:`Conteúdo atualizado (${e} módulo(s)).`,semRede:`Sem conexão — o app continua funcionando com o que já está no aparelho.`,semManifesto:`O servidor de conteúdo não respondeu com um manifesto válido.`,sincronizacaoFalhou:`A sincronização não terminou — o que já estava no aparelho continua lá.`},modulos:{anotacoes:`Anotações`,guias:`Guias Táticos`,poesia:`A Verdade em Poesia`,receitas:`Receitas`,jogo:`Você se lembra?`,criacao:`Teve um Projeto?`,entenda:`Entenda Melhor`,imite:`Imite a Sua Fé`,principios:`Fazendo as Contas...`,faq:`Respostas Frequentes`,cronologia:`Cronologia Comparada`,caderno:`Caderno de Estudo`,prep:`Esteja Preparado`,financeiro:`Financeiro`,metas:`Minhas Metas`,ministerio:`Vida e Ministério`,servico:`Quero Fazer Mais`,estudo:`Meu Estudo Pessoal`,leitura:`Leitura da Bíblia`,calendario:`Calendário`,perfil:`Perfil / ICE`,tutorial:`Tutorial`,sobre:`Sobre`},secoes:{estudo:`Estudo Pessoal`,prep:`Esteja Preparado`,extras:`Extras`,pessoal:`Pessoal`,aplicativo:`O Aplicativo`},painel:{semEventos:`Nada marcado para hoje.`,diaInteiro:`Dia inteiro`,anotacoes:t=>e(t,{one:`1 anotação`,other:`${t} anotações`}),eventosHoje:t=>e(t,{one:`1 evento hoje`,other:`${t} eventos hoje`}),contas:t=>[t.vencidas>0?e(t.vencidas,{one:`1 vencida`,other:`${t.vencidas} vencidas`}):``,t.hoje>0?e(t.hoje,{one:`1 vence hoje`,other:`${t.hoje} vencem hoje`}):``,t.aVencer>0?e(t.aVencer,{one:`1 a vencer`,other:`${t.aVencer} a vencer`}):``].filter(e=>e!==``).join(`, `),leitura:e=>`${e}% da Bíblia`,metas:t=>e(t,{one:`1 meta em andamento`,other:`${t} metas em andamento`}),horas:t=>e(t,{one:`1 hora este mês`,other:`${t} horas este mês`}),foco:e=>`${Math.round(e/60)} h de foco no mês`,favoritas:t=>e(t,{one:`1 favorita`,other:`${t} favoritas`}),rotuloVencidas:`Contas vencidas`,rotuloVencemHoje:`Vencem hoje`,rotuloAVencer:`A vencer em 7 dias`,rotuloFoco:`Estudo focado`,rotuloEsfriando:`Estudos esfriando`,rotuloRelatorios:`Relatórios a entregar`,rotuloMetas:`Minhas Metas`,emHoras:e=>`${Math.round(e/60*10)/10} h`},convite:{titulo:`Compartilhar o Kobi Note`,tile:`Compartilhar`,tileResumo:`Convide alguém`,lema:`Compartilhe o Kobi Note com seus amigos!`,mascote:`Kobi, o mascote do Kobi Note`,mensagem:`Oi! Descobri o Kobi Note para organizar meu estudo pessoal, leitura da Bíblia, anotações, finanças e preparo tático — tudo fica no meu próprio aparelho, sem conta e sem nuvem, e funciona sem internet. Acho que você vai gostar:`,qrAlt:`QR com o endereço do Kobi Note`,dica:`Aponte a câmera para o código, ou use um dos botões abaixo.`,whatsapp:`WhatsApp`,compartilhar:`Compartilhar`,copiar:`Copiar`,copiado:`Convite copiado. É só colar onde quiser.`},rodape:{termos:`Termos de uso`,privacidade:`Privacidade`,direitos:e=>`© ${e} Luiz Marin`,feitoPara:`Feito com ❤️ para você.`},boasVindas:{titulo:`Boas-vindas`,reabrir:`Rever as boas-vindas`,mascote:`Kobi, o mascote do Kobi Note, dando boas-vindas`,pular:`Pular`,voltar:`Voltar`,proximo:`Próximo`,comecar:`Começar a usar`,passo:(e,t)=>`Passo ${e} de ${t}`,passos:{bemVindo:{titulo:`Bem-vindo ao Kobi Note`,texto:Ot,dica:`Leva um minuto para conhecer o básico.`},painel:{titulo:`A tela inicial é o seu painel`,texto:`Cada cartão abre uma área do app e mostra um resumo do que está acontecendo nela. A tela é dividida em seções intuitivas — Estudo Pessoal, Esteja Preparado, Extras e Pessoal.`,dica:`O botão ← sempre traz você de volta.`},offline:{titulo:`Funciona sem internet`,texto:`O Kobi Note guarda tudo no próprio aparelho. Você pode usar no ônibus, no campo ou em qualquer lugar sem sinal.`,dica:`Conteúdo novo é baixado quando houver internet.`},privado:{titulo:`Seus dados são só seus`,texto:`Não há nuvem, conta nem rastreador. Tudo fica apenas no seu aparelho inclusive o conteúdo do cofre.`,dica:`Ninguém — nem nós — consegue ver o que você faz aqui.`},instalar:{titulo:`Instale na tela inicial`,texto:`Pelo menu do navegador, escolha “Instalar aplicativo” ou “Adicionar à tela inicial”. O Kobi Note será instalado como um aplicativo, oferecendo uma experiência imersiva e nativa.`,dica:`Quer saber mais? Leia o Tutorial.`,botao:`Instalar agora`}}},instalacao:{instalar:`Instalar na tela inicial`},sobre:{titulo:`Sobre`,versao:e=>`Versão ${e}`,lema:Ot,seloOffline:`100% offline`,seloPrivado:`Privado`,seloSemRastreio:`Sem rastreadores`,seloInstalavel:`Instalável`,tudoNumLugar:`Tudo em um só lugar`,recEstudo:`Estudo e leitura`,recEstudoTexto:`Estudo pessoal, leitura da Bíblia, cronologia e caderno de estudo`,recJogo:`Aprender brincando`,recJogoTexto:`Você se lembra?, Entenda Melhor, Imite a Sua Fé e Teve um Projeto?`,recCriar:`Criatividade`,recCriarTexto:`Poesia, receitas e anotações`,recFinancas:`Finanças e metas`,recFinancasTexto:`Orçamento, objetivos e calendário`,recPreparo:`Esteja Preparado`,recPreparoTexto:`Kits, estoque, cofre protegido e guias de sobrevivência`,recMinisterio:`Ministério e você`,recMinisterioTexto:`Seu ministério, estudos, relatórios, perfil e ICE`,privacidadeTitulo:`Seus dados são só seus`,privacidadeTexto:`Espaço para pensar, silêncio para criar. Apenas você e Kobi Note.`,documentos:`Documentos`,vejaTambem:`Veja também`,contato:`Contato:`,email:`kobinote.app@gmail.com`},emBreve:{titulo:`Em breve`,texto:e=>`O módulo “${e}” ainda não foi liberado para esta versão do Kobi Note.`,ajuda:`Ele ainda está em desenvolvimento... espere mais um pouquinho.`,voltar:`Voltar ao início`},erro:{banco:`Não foi possível abrir o banco local`,naoEncontrado:`Não encontramos esta tela`,naoEncontradoTexto:`O endereço não corresponde a nenhum módulo do Kobi Note.`,telaNaoVeio:`Não foi possível abrir este módulo`,telaNaoVeioTexto:`A tela é baixada na primeira vez que você entra nela, e desta vez ela não chegou. Verifique a conexão e tente de novo; se o app foi atualizado agora há pouco, recarregar a página resolve.`,telaNaoVeioRecarregar:`Recarregar`,cargaFalhou:`Este módulo não abriu`,cargaFalhouTexto:`Alguma coisa deu errado ao ler os dados deste módulo. O que já estava salvo continua no aparelho — nada foi perdido.`,cargaTentarDeNovo:`Tentar de novo`},armazenamento:{memoriaOrigemInsegura:`Este endereço não é uma origem confiável: os dados ficam num armazenamento de reserva. Abra o app por HTTPS para usar o armazenamento definitivo.`,memoriaInstanciaDupla:`O Kobi Note já está aberto em outra janela, e só uma por vez pode usar o armazenamento definitivo. Feche a outra janela e recarregue esta — o que você escrever aqui até lá não será guardado.`,memoriaIndisponivel:`O navegador não liberou o armazenamento definitivo neste aparelho: os dados ficam num armazenamento de reserva e podem se perder. Verifique o espaço livre e as permissões de dados do site.`,apagarTudo:`Apagar todos os dados deste aparelho`,apagarTudoTitulo:`Apagar tudo deste aparelho?`,apagarTudoTexto:`Isto remove o banco, as anotações, o progresso, os favoritos e as preferências guardados neste aparelho. O conteúdo original volta na próxima sincronização; o que é seu, não. Desinstalar o app não faz esta limpeza — o navegador guarda os dados mesmo sem o atalho.`,apagarTudoConfirmar:`Apagar tudo`,apagarTudoFeito:`Dados apagados. Recarregando...`,apagarTudoFalhou:`Não foi possível apagar tudo. Tente de novo.`},backup:{titulo:`Backup e restauração`,explicacao:`O backup é um arquivo com tudo o que é seu neste aparelho: anotações, caderno, finanças, metas, ministério, calendário, cofre, progresso e favoritos. O acervo (poesias, perguntas, princípios) fica de fora, porque volta sozinho na próxima sincronização. Guarde o arquivo fora do aparelho — desinstalar o app ou limpar o navegador apaga tudo, e este arquivo é o único caminho de volta.`,resumo:`O que vai no arquivo`,registros:`Registros`,tamanho:`Tamanho`,chaves:`Preferências`,baixar:`Baixar backup`,gerando:`Gerando...`,baixado:e=>`Backup gerado: ${e}. Guarde o arquivo em lugar seguro.`,falhou:`Não foi possível gerar o backup. Tente de novo.`,restaurarTitulo:`Restaurar`,restaurarExplicacao:`Escolha um arquivo de backup do Kobi Note. O que está neste aparelho será SUBSTITUÍDO pelo que vier do arquivo, e não há como desfazer — faça um backup do estado atual antes.`,escolher:`Escolher arquivo`,escolhido:`Arquivo lido`,quando:`Gerado em`,lendo:`Lendo...`,restaurar:`Restaurar`,confirmarTitulo:`Restaurar este backup?`,confirmarTexto:(t,n)=>`${e(t,{one:`1 registro`,other:`${t} registros`})}, gerados em ${n}, vão substituir o que está neste aparelho. Não há como desfazer.`,restaurado:t=>`${e(t,{one:`1 registro restaurado`,other:`${t} registros restaurados`})}. Recarregando...`,restauracaoFalhou:`A restauração falhou. Nada foi alterado.`,invalido:`Este arquivo não é um backup do Kobi Note.`,desconhecidos:e=>`O arquivo traz dados que esta versão não conhece e vai ignorar: ${e}.`,stores:{pasta:`Pastas de anotações`,anotacao:`Anotações`,not_caderno_estudo:`Caderno de estudo`,sessoes_estudo:`Sessões de estudo`,categorias_financeiro:`Categorias do Financeiro`,transacoes:`Lançamentos`,recorrencias_financeiro:`Recorrências`,meta:`Minhas Metas`,kits_local:`Checklists de Prontidão`,documentos_cofre:`Documentos do cofre`,estoque_alimentos:`Estoque`,relatorios_ministerio:`Relatórios do ministério`,contadores_ministerio:`Contadores do ministério`,estudos_biblicos:`Estudos bíblicos`,estudo_registros:`Registros de estudo`,meu_perfil:`Perfil`,calendario_tipos:`Tipos do calendário`,calendario_eventos:`Eventos do calendário`,poesias_local:`Poesias suas`,guias_local:`Guias seus`,receitas_local:`Receitas suas`,jogo_progresso:`Progresso do Você se lembra?`,jogo_respostas:`Respostas do Você se lembra?`}},atualizacao:{titulo:`Kobi Note atualizado`,texto:`Uma versão nova do Kobi Note foi baixada.`,acao:`Recarregar`},acoes:{voltar:`Voltar`,tema:`Alternar tema`,idioma:`Idioma`,fechar:`Fechar`,cancelar:`Cancelar`,confirmar:`Confirmar`,salvar:`Salvar`,criar:`Criar`,renomear:`Renomear`,excluir:`Excluir`,editar:`Editar`,substituir:`Substituir`,obrigatorio:`Preencha este campo.`},leitura:{apresentar:`Apresentar (rolagem automática)`,ler:`Ler em voz alta`,pausarLeitura:`Pausar leitura`,retomarLeitura:`Retomar leitura`,pausar:`Pausar`,continuar:`Continuar`,maisDevagar:`Mais devagar`,maisRapido:`Mais rápido`,velocidade:e=>`Vel. ${e}`,compartilhar:`Compartilhar`,copiado:`Conteúdo copiado para a área de transferência.`,semCopiar:`Não foi possível copiar o conteúdo.`},acervo:{meu:`Minha`,semTitulo:`Sem título`,salvando:`Salvando...`,salvoAs:e=>`Salvo às ${e}`,informeTitulo:`Informe um título para salvar`,tituloEConteudo:`Informe o título e o conteúdo para salvar`,excluirTexto:`A ação não pode ser desfeita.`},pasta:{nova:`Nova pasta`,novaTexto:`Como quer chamar a pasta?`,placeholder:`Nome da pasta`,renomear:`Renomear pasta`,excluir:`Excluir pasta`,excluirTexto:`As anotações dela voltam para “Sem pasta”.`,erroVazio:`Dê um nome à pasta.`},anotacoes:{nova:`Nova anotação`,buscar:`Buscar anotações...`,todosModelos:`Todos os modelos`,todas:`Todas`,arquivadas:`Arquivadas`,semAnotacoes:`Nenhuma anotação por aqui. Toque em + para criar a primeira.`,semArquivadas:`Nada arquivado.`,semTitulo:`(sem título)`,semPasta:`Sem pasta`,escolhaModelo:`Escolha um modelo`,tituloPlaceholder:`Título...`,salvando:`Salvando...`,informeTitulo:`Informe um título para salvar`,salvoAs:e=>`Salvo às ${e}`,fixar:`Fixar`,desafixar:`Desafixar`,arquivar:`Arquivar`,restaurar:`Restaurar`,reuniao:`Ir para a reunião (abre a anotação com o modelo do dia)`,excluir:`Excluir anotação`,excluirTexto:`A ação não pode ser desfeita.`,excluida:`Anotação excluída.`},guias:{nova:`Nova guia`,buscar:`Buscar guias...`,vazio:`Nenhuma guia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da guia...`,novaTitulo:`Nova guia`,excluir:`Excluir guia`,excluida:`Guia excluída.`},poesia:{nova:`Nova poesia`,buscar:`Buscar poesias...`,vazio:`Nenhuma poesia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da poesia...`,novaTitulo:`Nova poesia`,excluir:`Excluir poesia`,excluida:`Poesia excluída.`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`,anterior:`Anterior`,proxima:`Próxima`,sobre:`Sobre estas obras`,referencia:e=>`#${e??``}`,aviso:[`As obras aqui expostas têm um valor artístico, literário, baseado nas crenças das Testemunhas de Jeová. Seu objetivo é enaltecer a Jeová, o verdadeiro Deus e legítimo Soberano Universal, fortalecer a esperança em Suas maravilhosas e incomparáveis promessas, ocupar nossos pensamentos com “tudo que é verdadeiro, tudo que é de séria preocupação, tudo que é justo, tudo que é casto, tudo que é amável, tudo de que se fala bem, tudo que é virtuoso e tudo que é digno de louvor.” (Fil 4:8) A glória por qualquer benefício daqui derivado cabe a Jeová, o dador de todo presente perfeito, inclusive nossa capacidade de pensar e amar.`,`Todos os personagens usados nesta obra são fictícios. Quaisquer nomes de personagens originam-se de nomes de raças felinas e imagens são meramente ilustrativas.`,`Para saber mais sobre as crenças das Testemunhas de Jeová acesse o site jw.org.`]},receitas:{nova:`Nova receita`,buscar:`Buscar receitas...`,vazio:`Nenhuma receita disponível. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da receita...`,novaTitulo:`Nova receita`,excluir:`Excluir receita`,excluida:`Receita excluída.`,todas:`Todas`,categoria:`Categoria`,ingredientes:`Ingredientes`,preparo:`Modo de preparo`,ingredientesPlaceholder:`Um ingrediente por linha...`,preparoPlaceholder:`Um passo por linha...`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`},estudo:{intro:`Uma sessão de estudo: escolha o tipo, ore, cronometre e guarde o que aprendeu.`,tipo:`Tipo de estudo`,assunto:`Assunto`,assuntoPlaceholder:`O que você vai estudar...`,semAssunto:`(sem assunto)`,alvo:`Alvo de tempo`,minutos:e=>`${e} min`,de:e=>`de ${e} min`,comecar:`Começar`,oracaoTitulo:`Antes de começar`,oracaoTexto:`Portanto, se falta sabedoria a algum de vocês, que ele persista em pedi-la a Deus — pois ele dá a todos generosamente, sem censurar —, e ela lhe será dada. (Tiago 1:5)`,orei:`Já orei — começar`,emSessao:`Em estudo`,alvoAtingido:`Alvo de tempo atingido. Siga enquanto o assunto render.`,encerrar:`Encerrar`,descartar:`Descartar`,perola:`Pérola`,perolaIntro:e=>`${e} min de estudo. O que você leva daqui?`,perolaPlaceholder:`Uma ideia, um texto, uma aplicação...`,viraAnotacao:`Virar anotação`,viraAnotacaoFeito:`Anotação criada`,vaiCaderno:`Salvar no caderno`,vaiCadernoFeito:`Salvo no caderno de estudo`,salvarSessao:`Salvar sessão`,historico:`Histórico`,totais:(t,n)=>`${e(t,{one:`${t} sessão`,other:`${t} sessões`})} · ${n} de estudo.`,semSessoes:`Nenhuma sessão registrada ainda.`,excluir:`Excluir sessão`},prep:{indice:`Índice de prontidão`,indiceAjuda:`Checklists + autonomia de alimentos`,kits:`Checklists de Prontidão`,estoque:`Estoque de alimentos`,cofre:`Cofre de documentos`,guias:`Guias Táticos`,guiasResumo:`Orientações e procedimentos`,cofreResumo:`Documentos criptografados`,contagemKits:t=>e(t,{one:`${t} kit`,other:`${t} kits`}),diasAutonomia:t=>e(t,{one:`${t} dia de autonomia`,other:`${t} dias de autonomia`}),semKits:`Nenhum kit ainda. Toque em + para criar o primeiro checklist.`,novoKit:`Novo checklist`,editarKit:`Editar checklist`,kitSemNome:`Sem nome`,nomeDoKit:`Nome do checklist`,emoji:`Emoji`,emojiAjuda:`Um emoji para reconhecer o kit na lista (opcional).`,itens:`Itens`,descricaoDoItem:`O que levar...`,quantidade:`Quantidade`,observacoes:`Observações`,adicionarItem:`Adicionar item`,removerItem:`Remover item`,removerItemTexto:`O item sai deste checklist.`,kitSalvo:`Checklist salvo.`,excluirKit:`Excluir checklist`,kitExcluido:`Checklist excluído.`,vence:e=>`vence ${e}`,novoItem:`Novo item`,editarItem:`Editar item`,item:`Item`,categoria:`Categoria`,pesoUnitario:`Peso unitário (g)`,kcal:`Calorias por 100 g`,validade:`Validade`,itemSalvo:`Item salvo.`,excluirItem:`Excluir item`,itemExcluido:`Item excluído.`,buscarItens:`Buscar no estoque...`,semEstoque:`O estoque está vazio.`,semEstoqueFiltro:`Nenhum item para esta busca.`,resumoDoItem:(e,t)=>`${e} × ${t} g`,alertas:t=>e(t,{one:`${t} alerta de validade`,other:`${t} alertas de validade`}),vencidoHa:e=>`Vencido há ${e} d`,venceHoje:`Vence hoje`,venceEm:e=>`Vence em ${e} d`,calculadora:`Calculadora de autonomia`,calculadoraAjuda:`Quem come, quanto gasta e quantos são`,faixaEtaria:`Faixa etária`,atividade:`Atividade física`,pessoas:`Pessoas`,maisPessoas:`Mais uma pessoa`,menosPessoas:`Menos uma pessoa`,diasDeAutonomia:`Dias de autonomia`,aguaSugerida:`Água sugerida`,pesoTotal:`Peso total`,metaAutonomia:e=>`${e}% da meta de 30 dias`,necessidadeDiaria:e=>`${e} kcal por dia para o grupo`,logistica:`Logística tática`,diasSemFogo:`Dias sem água/fogo`,diasComFogo:`Dias com cozimento`,itensDeFibra:`Itens de fibra`,vulneravel:`Poucos itens de fibras e vitaminas. Numa autonomia longa isso vira problema de saúde antes de virar problema de caloria.`,semBiometria:`Este navegador não oferece passkey. O cofre precisa dele para existir.`,configurarBiometria:`Proteger o cofre com a biometria`,biometriaAjuda:`O cofre abre pela biometria do aparelho (a mesma da tela de bloqueio), por um passkey criado só para ele. A chave que cifra cada documento nasce assim e não é gravada em lugar nenhum. Sem o passkey — aparelho trocado, dados do navegador apagados — não há como recuperar o que está guardado aqui. O resto do Kobi Note não depende dele.`,criarCofre:`Criar o cofre`,semPrf:`O autenticador deste aparelho não entrega a chave necessária. Tente outro autenticador, como o celular pelo QR.`,gestoRecusado:`O gesto foi cancelado.`,destrancarComBiometria:`Destrancar com a biometria`,cofreTrancado:`Cofre trancado`,destranqueAjuda:`Ele volta a trancar sozinho quando você sai desta tela.`,destrancar:`Destrancar`,trancar:`Trancar`,guardarDocumento:`Guardar um documento`,nomeDoDocumento:`Nome do documento`,informeNome:`Informe um nome.`,documentoGuardado:`Documento guardado e cifrado.`,semDocumentos:`Nenhum documento guardado ainda.`,renomearDocumento:`Renomear documento`,excluirDocumento:`Excluir documento`,excluirDocumentoTexto:`O documento cifrado é apagado do aparelho. Não há como recuperá-lo.`,documentoExcluido:`Documento excluído.`,falhaAoDecifrar:`Não foi possível decifrar: este documento foi guardado com outra chave.`,semPreVisualizacao:`Este tipo de arquivo não abre aqui. Baixe para ver.`,baixar:`Baixar`},financeiro:{transacoes:`Transações`,novaTransacao:`Nova transação`,transacaoSalva:`Transação salva.`,excluirTransacao:`Excluir transação`,transacaoExcluida:`Transação excluída.`,categorias:`Categorias`,novaCategoria:`Nova categoria`,categoriaSalva:`Categoria salva.`,excluirCategoria:`Excluir categoria`,excluirCategoriaTexto:`As transações dela continuam existindo, mas ficam sem categoria.`,categoriaExcluida:`Categoria excluída.`,recorrencias:`Recorrências`,novaRecorrencia:`Nova recorrência`,recorrenciaSalva:`Recorrência salva.`,excluirRecorrencia:`Excluir recorrência`,excluirRecorrenciaTexto:`Os lançamentos já gerados por ela continuam onde estão.`,recorrenciaExcluida:`Recorrência excluída.`,naoSalvo:`Não foi possível salvar. Confira os campos e tente de novo.`,naoExcluido:`Não foi possível excluir.`,naoAlterado:`Não foi possível alterar. Tente de novo.`,receber:`Confirmar recebimento`,receberTexto:(e,t)=>`Marcar “${e}” como recebida, no valor de ${t}?`,pagar:`Confirmar pagamento`,pagarTexto:(e,t)=>`Marcar “${e}” como paga, no valor de ${t}?`,estornar:`Desfazer a baixa`,estornarTexto:e=>`“${e}” volta a constar como em aberto.`,saldo:`Saldo realizado`,previsto:`Previsto`,mostrarValores:`Mostrar valores`,ocultarValores:`Ocultar valores`,valoresOcultos:`Os valores estão ocultos.`,mes:`Mês`,ano:`Ano`,receitas:`Receitas`,despesas:`Despesas`,aReceber:`A receber`,aPagar:`A pagar`,porCategoria:`Por categoria`,semMovimento:`Sem movimento no mês.`,limites:`Limites do mês`,deLimite:e=>`de ${e}`,limiteDe:e=>`Limite ${e}`,registros:t=>e(t,{one:`1 registro`,other:`${t} registros`}),situacao:`Situação`,vencidas:`Vencidas`,aVencer:`A vencer`,pagas:`Pagas`,todas:`Todas`,nenhumaTransacao:`Nenhuma transação ainda.`,nenhumaVencida:`Nenhuma conta vencida.`,nadaAVencer:`Nada a vencer.`,nenhumaNoMes:`Nenhuma transação neste mês.`,nadaPagoNoMes:`Nada pago neste mês.`,marcarPago:`Marcar como pago`,desmarcarPago:`Desmarcar pago`,editarTransacao:`Editar transação`,editarCategoria:`Editar categoria`,editarRecorrencia:`Editar recorrência`,descricao:`Descrição`,descricaoObrigatoria:`Informe a descrição.`,valor:`Valor`,valorObrigatorio:`Informe um valor maior que zero.`,tipo:`Tipo`,receita:`Receita`,despesa:`Despesa`,categoria:`Categoria`,semCategoria:`Sem categoria`,vencimento:`Vencimento`,pago:`Pago`,nome:`Nome`,nomeObrigatorio:`Informe o nome.`,icone:`Ícone`,cor:`Cor`,limiteMensal:`Limite mensal`,limiteAjuda:`Zero significa sem limite.`,nenhumaCategoria:`Nenhuma categoria ainda.`,periodicidade:`Periodicidade`,diaria:`Diária`,semanal:`Semanal`,mensal:`Mensal`,anual:`Anual`,diaN:e=>`dia ${e}`,diaDoMes:`Dia do mês`,diaDoMesAjuda:`O dia 31 cai no último dia dos meses mais curtos.`,diaDoMesObrigatorio:`Informe um dia entre 1 e 31.`,diaDaSemana:`Dia da semana`,lancarJaPago:`Lançar já pago`,lancarCorrente:`Lançar o vencimento deste período agora`,lancarCorrenteAjuda:`Desligado, o primeiro lançamento nasce na próxima data.`,ativa:`Ativa`,pausar:`Pausar`,retomar:`Retomar`,proxima:e=>`Próxima: ${e}`,nenhumaRecorrencia:`Nenhuma recorrência ainda.`},calendario:{vista:`Visualização`,vistas:{dia:`Dia`,semana:`Semana`,mes:`Mês`,ano:`Ano`,agenda:`Agenda`},meses:[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],mes:`Mês`,ano:`Ano`,anterior:`Período anterior`,proximo:`Próximo período`,hoje:`Hoje`,novoEvento:`Novo evento`,editarEvento:`Editar evento`,novoAs:(e,t)=>`Novo evento em ${e}, ${t}`,novoEm:e=>`Novo evento em ${e}`,titulo:`Título`,tituloPlaceholder:`Ex.: Reunião do meio de semana`,tipo:`Tipo`,diaInteiro:`Dia inteiro`,dataInicio:`Data de início`,horaInicio:`Hora de início`,dataFim:`Data de fim`,horaFim:`Hora de fim`,descricao:`Descrição`,descricaoPlaceholder:`Detalhes (opcional)...`,eventoSalvo:`Evento salvo.`,excluirEvento:`Excluir evento`,eventoExcluido:`Evento excluído.`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),semEventos:`Nenhum evento nesta semana.`,tipos:`Tipos de evento`,novoTipo:`Novo tipo`,tipoNome:`Nome`,cor:`Cor`,icone:`Ícone`,marcaEspecial:`Contar no “próximo especial”`,especial:`Especial`,tipoSemNome:`Sem nome`,excluirTipo:`Excluir tipo`,tipoEmUsoTitulo:`Tipo em uso`,tipoEmUsoTexto:`Este tipo tem eventos e não pode ser excluído.`,dataInvalida:`A data de início não é uma data válida.`,eventoNaoSalvo:`O evento não pôde ser salvo. Confira os campos e tente de novo.`,eventoNaoExcluido:`O evento não pôde ser excluído.`,tipoNaoSalvo:`O tipo não pôde ser salvo.`,tipoNaoExcluido:`O tipo não pôde ser excluído. Ele pode ter ganhado eventos agora há pouco.`},ministerio:{esfriando:(t,n)=>e(t,{one:`${t} estudo está esfriando (${n}+ dias).`,other:`${t} estudos estão esfriando (${n}+ dias).`}),verEstudos:`Ver`,lembrete:(e,t)=>`Relatório de ${e} ainda ${t?`não foi enviado`:`não foi feito`}.`,preencher:`Preencher`,atrasados:(t,n)=>e(t,{one:`Relatório em atraso: ${n}.`,other:`${t} relatórios em atraso: ${n}.`}),verRelatorios:`Ver`,anoDeServico:e=>`Ano de serviço ${e}`,resumoDoAno:t=>[e(t.meses,{one:`1 mês relatado`,other:`${t.meses} meses relatados`}),`${t.enviados} enviados`,e(t.participacoes,{one:`1 mês com participação`,other:`${t.participacoes} meses com participação`}),t.horas>0?`${t.horas} h`:``,t.maisEstudos>0?`${t.mediaEstudos} estudos por mês (máx. ${t.maisEstudos})`:``].filter(e=>e!==``).join(` · `),atalhoRelatorios:`Relatórios`,atalhoRelatoriosSub:e=>`${e} no total`,atalhoEstudos:`Estudos`,atalhoEstudosSub:e=>`${e} ativos`,atalhoServico:`Quero fazer mais`,atalhoServicoSub:`Planejar as horas e virar meta`,ultimoRelatorio:`Último relatório`,participou:`Participou`,naoParticipou:`Não participou`,estudosDoRelatorio:e=>`${e} estudos`,enviado:`Enviado`,pendente:`Pendente`,contadores:`Contadores do mês`,zerar:`Zerar contadores`,zerarTexto:`Os cinco contadores deste mês voltam a zero. Quer continuar?`,tempo:`Tempo`,estudos:`Estudos`,revisitas:`Revisitas`,publicacoes:`Publicações`,videos:`Vídeos`,maisUmaHora:`+1h`,aumentar:e=>`Aumentar ${e}`,diminuir:e=>`Diminuir ${e}`,gerarRelatorio:`Gerar relatório do mês`,obsRevisitas:e=>`Revisitas: ${e}`,obsPublicacoes:e=>`Publicações: ${e}`,obsVideos:e=>`Vídeos: ${e}`,obsTempo:e=>`Tempo: ${e}`,novoRelatorio:`Novo relatório`,editarRelatorio:`Editar relatório`,semRelatorios:`Nenhum relatório ainda.`,mes:`Mês`,ano:`Ano`,tipoPublicador:`Tipo de publicador`,participacao:`Participou no ministério`,horas:`Horas`,metaHoras:`Meta de horas`,estudosBiblicos:`Estudos bíblicos`,observacoes:`Observações`,compartilhar:`Compartilhar`,marcarEnviado:`Marcar como enviado`,marcarPendente:`Marcar como pendente`,excluirRelatorio:`Excluir relatório`,relatorioSalvo:`Relatório salvo.`,relatorioExcluido:`Relatório excluído.`,resumoRelatorio:(e,t,n,r)=>`${e} · ${t?`participou`:`não participou`} · ${n} estudos${r}`,sufixoHoras:e=>` · ${e}h`,semPublicador:`O relatório sai sem dizer de quem é: o seu nome não está no Perfil.`,irAoPerfil:`Preencher o Perfil`,relatorioDe:e=>`📋 Relatório — ${e}`,linhaPublicador:e=>`Publicador: ${e}`,linhaTelefone:e=>`Telefone: ${e}`,linhaEmail:e=>`E-mail: ${e}`,linhaCongregacao:e=>`Congregação: ${e}`,linhaGrupo:e=>`Grupo: ${e}`,linhaTipo:e=>`Tipo: ${e}`,linhaParticipacao:e=>`Participou no ministério: ${e?`Sim`:`Não`}`,linhaHoras:e=>`Horas: ${e}`,linhaEstudos:e=>`Estudos bíblicos: ${e}`,linhaObservacoes:e=>`Observações: ${e}`,novoEstudo:`Novo estudo`,editarEstudo:`Editar estudo`,buscarEstudos:`Buscar estudos...`,semEstudos:`Nenhum estudo aqui.`,semEstudosFiltro:`Nenhum estudo para esta busca.`,nome:`Nome`,semNome:`Sem nome`,contato:`Contato`,contatoPlaceholder:`Telefone, e-mail...`,endereco:`Endereço`,publicacaoAtual:`Publicação atual`,publicacaoPlaceholder:`Publicação usada no estudo`,diaSemana:`Dia da semana`,escolhaDia:`Escolha o dia...`,horario:`Horário`,notas:`Notas`,excluirEstudo:`Excluir estudo`,excluirEstudoTexto:`A linha do tempo deste estudo é apagada junto.`,estudoSalvo:`Estudo salvo.`,estudoExcluido:`Estudo excluído.`,informeNome:`Dê um nome ao estudo.`,seloEsfriando:`Esfriando`,ultimoEstudo:`Último estudo:`,parouEm:`Parou em:`,nenhumRegistro:`Nenhum registro`,hoje:`Hoje`,ontem:`Ontem`,haDias:e=>`Há ${e} dias`,estudoDe:e=>`📖 ${e}`,linhaPublicacao:e=>`Publicação: ${e}`,linhaOndeParou:e=>`Onde parou: ${e}`,linhaDia:(e,t)=>`Dia: ${e} ${t}`,linhaContato:e=>`Contato: ${e}`,linhaEndereco:e=>`Endereço: ${e}`,linhaDoTempo:`Linha do tempo`,registrarEstudo:`Registrar estudo`,editarRegistro:`Editar registro`,semRegistros:`Nenhum registro ainda. Toque em + após cada estudo.`,data:`Data`,ondeParou:`Onde parou`,ondeParouPlaceholder:`Ex.: lição 12, parágrafo 5`,informeOndeParou:`Informe onde o estudo parou.`,comentario:`Comentário`,comentarioPlaceholder:`Como foi o estudo, dúvidas, próximos passos...`,excluirRegistro:`Excluir registro`,registroSalvo:`Registro salvo.`,registroExcluido:`Registro excluído.`},jogo:{restantes:`Restantes`,acertos:`Acertos`,erros:`Erros`,partidas:`Partidas`,xpDisponivel:`XP disponível`,modo:`Modo`,modos:{estudo:`Estudo`,desafio:`Desafio`},desafioAjuda:`Timer por pergunta · bônus de XP por velocidade e sequência`,dificuldade:`Dificuldade`,dificuldades:[`Todas`,`Fácil`,`Médio`,`Difícil`],jogar:`Jogar`,semBanco:`Sem perguntas — sincronize`,semPerguntas:`Esta dificuldade não tem perguntas suficientes (mínimo 2). Escolha outra ou sincronize mais perguntas.`,tudoConcluido:`Você já respondeu todas as perguntas desta dificuldade!`,reiniciar:`Reiniciar`,reiniciarTitulo:`Reiniciar perguntas`,reiniciarTexto:`Zera as perguntas já respondidas (seu XP é mantido). Quer continuar?`,encerrar:`Encerrar jogo`,segundos:e=>`${e}s`,pausadoSelo:`pausado`,pausar:`Pausar`,retomar:`Retomar`,dica:e=>`Dica (${e} XP)`,explicacao:`Explicação`,feedbackCorreto:e=>`Correto! +${e} XP`,feedbackIncorreto:`Resposta incorreta`,feedbackTempo:`Tempo esgotado!`,proxima:`Próxima`,verResultado:`Ver resultado`,tituloResultado:`Resultado`,resultados:{perfeito:`Perfeito! 🎉`,excelente:`Excelente!`,muitoBem:`Muito bem!`,continue:`Continue praticando!`,naoDesista:`Não desista, tente de novo!`},acertosDe:(e,t,n)=>`${e} de ${t} acertos (${n}%)`,xpGanho:`XP ganho`,nivel:`Nível`,xpSaldo:`XP saldo`,anotarNoCaderno:`Anotar no Caderno de Estudo`,cadernoReferencia:`Jogo Você se lembra?`,cadernoTitulo:`Jogo Você se lembra?`,cadernoConteudo:(e,t,n)=>`Acertei ${e} de ${t} (${n}%). O que aprendi:\n`,jogarDeNovo:`Jogar de novo`,inicio:`Início`},leituraBiblia:{visualizacao:`Visualização`,visoes:{canonica:`Canônica`,cronologica:`Cronológica`,escritor:`Escritor`,celebracao:`Celebração`},visoesAjuda:{canonica:`Ordem canônica: Gênesis a Apocalipse`,cronologica:`Pela estimativa de quando cada livro foi escrito`,escritor:`Agrupada por escritor`,celebracao:`Leitura para a época da Celebração da morte de Cristo`},progressoGeral:`Progresso geral`,capitulos:(e,t)=>`${e} de ${t} capítulos`,capituloAbrev:(e,t)=>`${e}/${t} cap.`,livros:(e,t)=>`${e} de ${t} livros`,livroInteiro:`Livro inteiro`,limpar:`Limpar`,roteiro:`Roteiro da Celebração`,roteiroNota:`Acontecimentos da última semana de Jesus na Terra (Nisã 8 a 16) — leitura para a época da Celebração da morte de Cristo.`,trechos:(e,t)=>`${e} de ${t} trechos lidos`},servico:{intro:`Uma meta anual não cabe na cabeça de ninguém; "duas horas e meia, três vezes por semana" cabe. Escolha o alvo e os dias, e veja o que ele pede de cada saída.`,modalidade:`Modalidade de serviço`,semCota:`sem cota de horas`,horasMes:e=>`${e} h por mês`,alvo:`Alvo de horas no período`,alvoValor:e=>`${e} h`,prazo:`Período`,prazoValor:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mediaMes:e=>`Média de ${e} por mês.`,diasTitulo:`Dias em que pretendo sair`,semDias:`Escolha ao menos um dia da semana para a conta ter onde cair.`,gradeTitulo:`O que isso significa`,porSaida:`Em cada saída`,porSemana:`Por semana`,porMes:`Por mês`,porAno:`No ritmo de um ano`,saidas:`Saídas no período`,saidasValor:t=>e(t,{one:`${t} saída`,other:`${t} saídas`}),inviavel:`Mais de dez horas numa só saída — o alvo não cabe nos dias escolhidos. Acrescente dias, alongue o período ou reduza o alvo.`,mesAnterior:`Mês anterior`,mesSeguinte:`Próximo mês`,resumoDoMes:(t,n)=>e(t,{one:`${t} saída neste mês, para ${n}.`,other:`${t} saídas neste mês, para ${n}.`}),registrar:`Registrar como meta`,gravando:`Gravando...`,gravada:`Meta registrada. Ela acompanha sozinha as horas dos seus relatórios.`,naoGravada:`A meta não pôde ser registrada. Tente de novo.`,verMetas:`Ver metas`,tituloDaMeta:e=>`${e}: horas de campo`,fonteAviso:`As horas de cada modalidade são um ponto de partida para preencher o campo, não uma exigência afirmada por este app: confirme sempre a instrução vigente. Referências no jw.org:`,referencias:[{rotulo:`🌐 Alcance mais no serviço a Jeová`,url:`https://www.jw.org/finder?wtlocale=T&docid=201999284`},{rotulo:`🌐 Você pode aumentar sua participação?`,url:`https://www.jw.org/finder?wtlocale=T&docid=201998083`}]},metas:{nova:`Nova meta`,editar:`Editar meta`,buscar:`Buscar metas...`,filtros:{ativas:`Ativas`,concluidas:`Concluídas`,todas:`Todas`},resumo:(t,n)=>`${t} em andamento · ${e(n,{one:`${n} concluída`,other:`${n} concluídas`})}.`,vazio:`Nenhuma meta ainda. Toque em + para criar a primeira.`,semFiltro:`Nenhuma meta para este filtro.`,titulo:`Título`,tituloPlaceholder:`O que você quer alcançar...`,informeTitulo:`Dê um título à meta.`,categoria:`Categoria`,ativo:`Categoria do Financeiro`,alvo:e=>`Alvo (${e})`,automatica:`Automática`,automaticaAjuda:`O progresso vem do módulo de origem — não é digitado aqui.`,inicio:`Início`,prazoFinal:`Prazo final`,prazo:e=>`prazo ${e}`,aumentar:`Aumentar o progresso`,diminuir:`Diminuir o progresso`,concluir:`Concluir`,reabrir:`Reabrir`,salva:`Meta salva.`,excluir:`Excluir meta`,excluida:`Meta excluída.`},perfil:{cartao:`Cartão de visita`,congregacaoSecao:`Congregação`,congregacao:`Congregação`,grupo:`Grupo de campo`,secretario:`Secretário da Congregação`,saude:`Saúde (ICE — Em Caso de Emergência)`,gestacao:`Gestação`,dpa:`Diretrizes de sangue (DPA)`,emergencia:`Contato de emergência`,colih:`CoLiH`,identificacao:`Identificação complementar`,nome:`Nome completo`,telefone:`Telefone`,email:`E-mail`,link:`Link pessoal`,comentario:`Observação (nota aparece no contato)`,telefoneDuvidoso:`Este telefone não parece completo — dá para salvar assim mesmo.`,emailDuvidoso:`Este e-mail não parece completo — dá para salvar assim mesmo.`,cpfDuvidoso:`Este CPF não confere — dá para salvar assim mesmo.`,dataDuvidosa:`Esta data não existe no calendário e não foi salva. Corrija-a.`,tipo_sanguineo:`Tipo sanguíneo`,selecione:`Selecione...`,doador:`Doador de órgãos`,alergias:`Alergias`,medicamentos:`Medicamentos em uso`,observacoes:`Observações médicas`,gestante:`Gestante`,meses:`Meses de gestação`,mes:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mesesGestacao:t=>e(t,{one:`${t} mês de gestação`,other:`${t} meses de gestação`}),parto:`Data prevista do parto`,partoEm:e=>`parto previsto ${e}`,recusa:`Recuso transfusão de sangue`,naoApliqueSangue:`NÃO APLIQUE SANGUE`,portadorDiretriz:`Portador de cartão de diretrizes de recusa de transfusão.`,fracoes:`Frações aceitas por consciência`,dpaAssinado:`Cartão DPA físico atualizado e assinado em`,dpa_assinado_em:e=>`DPA assinado em ${e}`,dpaRenovar:e=>`· renovar em ${e} dias`,dpaVencido:`· vencido`,dpaVencidoAviso:e=>`O cartão DPA venceu em ${e}. Renove-o e atualize a data da assinatura.`,dpaVencidoResumo:`DPA vencido`,abrirPerfil:`Abrir o Perfil`,contatoNome:`Nome do contato`,contatoTelefone:`Telefone do contato`,sus:`Cartão SUS`,cpf:`CPF do titular`,upa:`UPA / hospital de referência`,sim:`Sim`,gestanteMaiusculo:`GESTANTE`,tituloCartao:`Cartão de contato`,tituloFicha:`Ficha de emergência`,semNome:`Sem nome`,semCartao:`Preencha nome e telefone no perfil para gerar o cartão.`,qrAlt:`QR com o cartão de contato (vCard)`,semFicha:`Sem dados de emergência. Preencha no perfil.`},cronologia:{intro:`De um lado a cronologia bíblica, do outro os fatos da história. Cada evento tem o link da fonte de onde saiu. Os cards “históricos” vêm de acervos oficiais fora de jw.org (UNESCO, Louvre, ONU, arquivos, museus, etc.) e seguem a datação acadêmica convencional.`,buscar:`Buscar na linha do tempo...`,limpar:`Limpar filtros`,fonte:`Ver a fonte`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),vazio:`A linha do tempo ainda não foi sincronizada. Aguarde novidades em breve.`,semFiltro:`Nenhum evento para este filtro.`},imite:{titulo:`Imite a Sua Fé`,subtitulo:`Um atrito por cartão, e a pergunta que o desarma: e se a intenção dele fosse boa? A lente certa (o modo como vemos as coisas) muda a história que contamos a nós mesmos. Errar a lente não custa nada — é nas lentes erradas que está o ensino.`,vazio:`Nenhum cartão disponível ainda. Aguarde novidades em breve.`,cenario:`O atrito`,julgamento:`O que passa pela cabeça`,pergunta:`Qual destas lentes explica melhor a intenção do outro?`,espelhoDica:`No fim do cartão há uma pergunta sobre você. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que muda quando a intenção é lida assim.`,erro:`Essa lente ainda julga a pessoa, e não a intenção. Olhe de novo.`,lente:`A lente da boa intenção`,exemplos:`Quem mais fez isso na Bíblia`,lerFonte:`Ler a fonte no jw.org`,espelhoTitulo:`Seu Reflexo no Espelho`,espelhoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,seloEspelho:`Espelho Escrito`,seloFeito:`Selo do Espelho Escrito conquistado!`,outrosCartoes:`Outros cartões`,inicio:`Início`},principios:{titulo:`Princípios Bíblicos`,subtitulo:`O que a Bíblia diz sobre as decisões do dia a dia — a frase que resume, os textos que a sustentam e como ela se parece numa terça-feira comum.`,vazio:`Nenhum princípio disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhum princípio para esta busca.`,buscar:`Buscar por assunto ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,comAnotacao:`Você escreveu sobre este princípio`,lido:`Você já leu este princípio`,areaLida:`Você leu todos os princípios desta área`,progresso:`Quantos princípios do acervo você já leu`,porQue:`Por que isso existe`,naPratica:`Como isso se parece num dia comum`,lerFonte:`Ler o texto na Bíblia on-line`,paraRefletir:`Para refletir`,reflexaoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,outros:`Outros princípios`,inicio:`Início`},faq:{titulo:`Perguntas Frequentes`,subtitulo:`Uma pergunta por vez, das que aparecem na porta, no trabalho, na mesa de domingo. Primeiro a cena e a resposta que vem de impulso; depois as lentes — os ângulos por onde dá para responder. Errar a lente não custa nada: é nelas que está o ensino.`,vazio:`Nenhuma pergunta disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhuma pergunta para esta busca.`,buscar:`Buscar por pergunta ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,respondida:`Você já fez esta pergunta`,categoriaConcluida:`Você fez todas as perguntas desta categoria`,progresso:`Quantas perguntas do acervo você já fez`,cenario:`Onde a pergunta aparece`,impulso:`O que vem primeiro à cabeça`,enunciado:`Qual destas lentes responde de verdade o que foi perguntado?`,preparoDica:`No fim há um espaço para a sua resposta, com as suas palavras. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que ela abre em vez de fechar.`,erro:`Essa lente responde outra coisa, ou encerra a conversa. Olhe de novo.`,aResposta:`A resposta pela Bíblia`,exemplos:`Quem respondeu assim na Bíblia`,lerArtigo:`Ler o assunto no jw.org`,paraPreparar:`Com as suas palavras`,respostaPlaceholder:`Escreva como você diria isso em suas próprias palavras...`,seloPalavras:`Você escreveu a sua resposta`,seloFeito:`Selo “Com as Suas Palavras” conquistado!`,outras:`Outras perguntas`,inicio:`Início`},criacao:{vazio:`Nenhum módulo disponível ainda. Aguarde novidades em breve.`,acerto:`Isso mesmo!`,erro:`Ainda não. Observe e tente de novo.`,ajuste:`Quase lá — ajuste até alcançar a meta.`,escolha:`Escolha uma opção antes de verificar.`,equilValorX:`Valor do x`,equilPendeDir:`A balança pende para a direita: o lado do x está leve. Aumente o x.`,equilPendeEsq:`A balança pende para a esquerda: o lado do x está pesado. Diminua o x.`,equilOk:e=>`Equilíbrio! Os dois lados pesam ${e}. Você achou o x que nivela a balança.`,paresErro:`Reveja: marque exatamente as colunas com pareamento errado (A-T, C-G).`,rotaIncompleta:`Visite todas as flores antes de verificar.`,rotaOtima:`Rota mais curta encontrada!`,rotaLonga:`Há um caminho mais curto. Tente recomeçar.`,orbInforme:`Ajuste a velocidade de impulso e toque em Lançar.`,orbVoando:`Em trajetória...`,orbCai:`Velocidade baixa demais: o corpo caiu em direção ao Sol.`,orbEscapa:`Velocidade alta demais: o corpo escapou para o espaço.`,orbAjuste:`Ainda não. Ajuste a velocidade e lance de novo até obter uma órbita estável.`,escudoFraco:`Campo fraco: o vento solar ainda atinge a Terra.`,escudoOk:`Campo forte: as partículas são desviadas para os polos (auroras) ✔`,conceito:`Conceito`,desafio:`Desafio`,ampliar:`Toque para ampliar`,fechar:`Fechar`,fonte:`Fonte: jw.org`,lerFonte:`Ler a fonte no jw.org`,comecar:`Começar`,verificar:`Verificar`,avancar:`Confirmar e avançar`,concluirMapa:`Concluir o mapa`,concluir:`Concluir`,leiaReflexao:`Leia a reflexão a seguir.`,concluido:`Módulo concluído — leia a reflexão abaixo.`,diligenteSelo:`Estudo Diligente`,diligenteDica:`Ao concluir, escreva no Caderno o que você aprendeu para ganhar o selo de Estudo Diligente.`,diligenteFeito:`Selo de Estudo Diligente conquistado!`,reflexaoTitulo:`Teve um Projeto?`,reflexaoEntenda:`O que você acabou de entender`,cadernoTitulo:`Caderno do Investigador`,cadernoPlaceholder:`Escreva, com suas palavras, o que este módulo lhe ensinou sobre a sabedoria do Criador...`,outrosModulos:`Outros módulos`,inicio:`Início`,recomecar:`Recomeçar`,lancar:`Lançar`,girar:`Arraste para girar · pinça/scroll para aproximar.`,atomoDica:`Um próton por vez: veja as camadas se refazerem a cada elemento.`,proximoNumero:`Escolha o próximo número`,ordenarDica:`Toque os eventos na ordem em que aconteceram (toque de novo para tirar).`,paresDica:`Toque nas colunas cujo pareamento está errado (válidos: A-T e C-G).`,rotaDica:`A abelha sai da colmeia, visita todas as flores e volta. Toque nas flores na ordem que faz o caminho mais curto (toque de novo para desfazer).`,rotaMedida:(e,t)=>`Seu caminho: ${e}  ·  menor possível: ${t}`,ciclosRecomecar:`Começar de novo`,explorarDica:`Toque cada visão para abri-la.`,explorarDesdobra:`desdobra`,gaivotaMesmo:`Mesma direção`,gaivotaOposto:`Direções opostas`,gaivotaVolta:`Volta ao corpo`,gaivotaPe:`Chega ao pé`,gaivotaCalor:`Calor recuperado`,proteinaRecorde:`Recorde`,proteinaAgora:`Agora`,proteinaRelogio:`Relógio da improbabilidade`,proteinaNecessarias:`Tentativas necessárias`,proteinaFaltam:`Ainda faltam`,proteinaTempo:`A 1 bilhão de tentativas por segundo, o cálculo levaria`,proteinaAnos:`anos para concluir.`,ciclosFechados:`ciclos fechados`,visoes:`visões`,camadas:`camadas`},caderno:{ver:`Ver no Caderno de Estudo`,intro:`Reúne o que você escreve em Entenda Melhor, Teve um Projeto?, Estudo Pessoal e outros módulos — e as suas anotações avulsas.`,nova:`Nova anotação`,editar:`Editar anotação`,buscar:`Buscar...`,todasOrigens:`Todas as origens`,origem:`Origem`,titulo:`Título`,tituloPlaceholder:`Um título curto (opcional)`,referencia:`Referência`,referenciaPlaceholder:`Módulo, texto bíblico, assunto... (opcional)`,conteudo:`O que você aprendeu`,conteudoPlaceholder:`Escreva, com suas palavras, o que este estudo lhe ensinou...`,semConteudo:`Escreva o que você aprendeu antes de salvar.`,vazio:`Seu caderno está vazio. Anote o que aprender nos estudos.`,semFiltro:`Nenhuma anotação para este filtro.`,salva:`Anotação salva.`,excluir:`Excluir anotação`,excluida:`Anotação excluída.`},tutorial:{intro:`Como usar o Kobi Note — uma explicação por módulo.`,visaoGeral:`Visão geral`,modulos:`Módulos`,vazio:`O tutorial ainda não foi sincronizado. Aguarde novidades em breve.`,semTopico:`Este módulo ainda não tem um tópico escrito no tutorial.`},notas:{titulo:`Notas de rodapé`,voltar:`Voltar ao ponto da nota`}},At=`modulepreload`,jt=function(e,t){return new URL(e,t).href},Mt={},b=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=jt(t,n),t=s(t),t in Mt)return;Mt[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:At,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Nt=[{tag:`pt-BR`,nome:`Português (Brasil)`},{tag:`en`,nome:`English`,carregar:()=>b(()=>import(`./en-B74s63PT.js`),__vite__mapDeps([0,1]),import.meta.url)},{tag:`es-ES`,nome:`Español (España)`,carregar:()=>b(()=>import(`./es-ES-CY58WMH9.js`),__vite__mapDeps([2,1]),import.meta.url)}],Pt=`note_idioma`,Ft=kt,It=Nt[0]?.tag??`pt-BR`,x=Ft;function Lt(){return It}function Rt(){let e=null;try{e=localStorage.getItem(Pt)}catch{}if(e!==null&&Nt.some(({tag:t})=>t===e))return e;let t=navigator.language?.toLowerCase()??``;return Nt.find(({tag:e})=>e.toLowerCase().split(`-`)[0]===t.split(`-`)[0])?.tag??It}function zt(e,t){let n={...e};for(let[r,i]of Object.entries(t)){let t=e[r];n[r]=typeof t==`object`&&t&&!Array.isArray(t)?{...t,...i}:i}return n}async function Bt(e){let n=Nt.find(t=>t.tag===e);if(n===void 0)throw Error(`idioma desconhecido: ${e} (ver src/i18n/idioma.ts)`);Ft=n.carregar===void 0?kt:zt(kt,(await n.carregar()).default),x=Ft,It=n.tag,t(n.tag),document.documentElement.lang=n.tag;try{localStorage.setItem(Pt,n.tag)}catch{}}var Vt=[{id:`prep-kits`,get rotulo(){return x.prep.kits},icone:`clipboard-list`,cor:`#dc3545`,rota:`prep/kits`},{id:`prep-estoque`,get rotulo(){return x.prep.estoque},icone:`package`,cor:`#e8590c`,rota:`prep/estoque`},{id:`prep-cofre`,get rotulo(){return x.prep.cofre},icone:`lock`,cor:`#495057`,rota:`prep/cofre`}],Ht=[{id:`anotacoes`,get rotulo(){return x.modulos.anotacoes},icone:`notes`,cor:`#0d6efd`},{id:`guias`,get rotulo(){return x.modulos.guias},icone:`map-2`,cor:`#20c997`},{id:`poesia`,get rotulo(){return x.modulos.poesia},icone:`feather`,cor:`#0dcaf0`},{id:`receitas`,get rotulo(){return x.modulos.receitas},icone:`chef-hat`,cor:`#fd7e14`},{id:`jogo`,get rotulo(){return x.modulos.jogo},icone:`device-gamepad-2`,cor:`#2f9e44`},{id:`criacao`,get rotulo(){return x.modulos.criacao},icone:`compass`,cor:`#0ca678`},{id:`entenda`,get rotulo(){return x.modulos.entenda},icone:`bulb`,cor:`#fd7e14`},{id:`imite`,get rotulo(){return x.modulos.imite},icone:`heart-handshake`,cor:`#d63384`},{id:`principios`,get rotulo(){return x.modulos.principios},icone:`scale`,cor:`#c92a2a`},{id:`faq`,get rotulo(){return x.modulos.faq},icone:`message-question`,cor:`#4263eb`},{id:`cronologia`,get rotulo(){return x.modulos.cronologia},icone:`timeline`,cor:`#82c91e`},{id:`caderno`,get rotulo(){return x.modulos.caderno},icone:`book-2`,cor:`#f59f00`},{id:`prep`,get rotulo(){return x.modulos.prep},icone:`shield-check`,cor:`#dc3545`},{id:`financeiro`,get rotulo(){return x.modulos.financeiro},icone:`cash`,cor:`#198754`},{id:`metas`,get rotulo(){return x.modulos.metas},icone:`target`,cor:`#0d6efd`,noPainel:!0},{id:`ministerio`,get rotulo(){return x.modulos.ministerio},icone:`users`,cor:`#0ca678`},{id:`servico`,get rotulo(){return x.modulos.servico},icone:`trending-up`,cor:`#0dcaf0`,dentroDe:`ministerio`},{id:`estudo`,get rotulo(){return x.modulos.estudo},icone:`hourglass`,cor:`#7048e8`},{id:`leitura`,get rotulo(){return x.modulos.leitura},icone:`book`,cor:`#1c7ed6`},{id:`calendario`,get rotulo(){return x.modulos.calendario},icone:`calendar`,cor:`#0dcaf0`},{id:`perfil`,get rotulo(){return x.modulos.perfil},icone:`id-badge-2`,cor:`#dc3545`},{id:`tutorial`,get rotulo(){return x.modulos.tutorial},icone:`help-circle`,cor:`#f59f00`},{id:`sobre`,get rotulo(){return x.modulos.sobre},icone:`info-circle`,cor:`#6c757d`}],Ut=[{id:`dia`,painel:`hoje`,itens:[{tipo:`modulo`,id:`anotacoes`},{tipo:`modulo`,id:`calendario`},{tipo:`modulo`,id:`ministerio`}]},{id:`numeros`,painel:`indicadores`,itens:[]},{id:`estudo`,get titulo(){return x.secoes.estudo},itens:[{tipo:`modulo`,id:`leitura`},{tipo:`modulo`,id:`estudo`},{tipo:`modulo`,id:`imite`},{tipo:`modulo`,id:`principios`},{tipo:`modulo`,id:`faq`},{tipo:`modulo`,id:`jogo`},{tipo:`modulo`,id:`entenda`},{tipo:`modulo`,id:`criacao`},{tipo:`modulo`,id:`cronologia`},{tipo:`modulo`,id:`poesia`},{tipo:`modulo`,id:`caderno`}]},{id:`prep`,get titulo(){return x.secoes.prep},painel:`prontidao`,itens:[{tipo:`atalho`,id:`prep-kits`},{tipo:`atalho`,id:`prep-estoque`},{tipo:`atalho`,id:`prep-cofre`},{tipo:`modulo`,id:`guias`}]},{id:`extras`,get titulo(){return x.secoes.extras},itens:[{tipo:`modulo`,id:`receitas`}]},{id:`pessoal`,get titulo(){return x.secoes.pessoal},itens:[{tipo:`modulo`,id:`financeiro`},{tipo:`modulo`,id:`perfil`}]},{id:`aplicativo`,get titulo(){return x.secoes.aplicativo},itens:[{tipo:`modulo`,id:`tutorial`},{tipo:`acao`,id:`sincronizar`},{tipo:`acao`,id:`convite`},{tipo:`modulo`,id:`sobre`}]}],Wt=new Map(Ht.map(e=>[e.id,e])),Gt=new Map(Vt.map(e=>[e.id,e]));function Kt(e){return Wt.get(e)}function qt(e){return Gt.get(e)}function Jt(e){return u.features[e]===!0}function Yt(){let[e=``,t=``]=location.hash.replace(/^#\/?/,``).split(`?`),n=e.split(`/`).filter(e=>e!==``);return{modulo:n[0]??`home`,args:n.slice(1),query:new URLSearchParams(t)}}function Xt(e){location.hash=e.startsWith(`#`)?e:`#/${e.replace(/^\//,``)}`}function Zt(e){addEventListener(`hashchange`,()=>e(Yt())),e(Yt())}var Qt=()=>{};function $t(e){Qt=e}function en(){Qt()}var tn=`false`,nn=`false`,rn=tn===`true`,an=nn===`true`;function on(e={}){let{immediate:t=!1,onNeedReload:n,onNeedRefresh:r,onOfflineReady:i,onRegistered:a,onRegisteredSW:o,onRegisterError:s}=e,c,l,u,d=async(e=!0)=>{await l,rn||u?.()};async function ee(){if(`serviceWorker`in navigator){if(c=await b(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-Bd17z0YL.js`);return{Workbox:e}},[],import.meta.url).then(({Workbox:e})=>new e(`./sw.js`,{scope:`./`,type:`classic`})).catch(e=>{s?.(e)}),!c)return;if(u=()=>{c?.messageSkipWaiting()},!an){if(rn)c.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&(n?n():window.location.reload())}),c.addEventListener(`installed`,e=>{e.isUpdate||i?.()});else{let e=!1,t=()=>{e=!0,c?.addEventListener(`controlling`,e=>{e.isUpdate&&(n?n():window.location.reload())}),r?.()};c.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&i?.():n.isExternal?t():!e&&i?.():n.isUpdate||i?.()}),c.addEventListener(`waiting`,t)}}c.register({immediate:t}).then(e=>{o?o(`./sw.js`,e):a?.(e)}).catch(e=>{s?.(e)})}}return l=ee(),d}function sn(){let e=on({onNeedRefresh(){cn(()=>{e(!0)})}})}function cn(e){let t=Object.assign(document.createElement(`kk-alert`),{variant:`primary`,closable:!0}),n=document.createElement(`kk-icon`);n.setAttribute(`slot`,`icon`),n.setAttribute(`name`,`sparkles`);let r=document.createElement(`strong`);r.textContent=x.atualizacao.titulo;let i=document.createElement(`kk-button`);i.setAttribute(`size`,`small`),i.setAttribute(`variant`,`primary`),i.textContent=x.atualizacao.acao,i.addEventListener(`click`,e),t.append(n,r,document.createTextNode(` ${x.atualizacao.texto} `),i),document.body.append(t),t.toast()}var ln=864e5;function un(e=new Date){let t=e instanceof Date?e:new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function dn(e=new Date){return un(e).slice(0,7)}function fn(e){return un(new Date(Date.now()+e*ln))}function pn(e){if(!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t=0,n=0,r=0]=e.split(`-`).map(Number),i=new Date(t,n-1,r);return i.getFullYear()===t&&i.getMonth()===n-1&&i.getDate()===r}function mn(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1,0,0,0,0).getTime()}var hn=e=>String(e).padStart(2,`0`);function gn(e){return`${hn(e.getDate())}/${hn(e.getMonth()+1)}/${e.getFullYear()}`}function _n(e){return e===void 0||e===0||Number.isNaN(e)?``:gn(new Date(e))}function vn(e){if(e===void 0||e===0||Number.isNaN(e))return``;let t=new Date(e);return`${gn(t)}, ${hn(t.getHours())}:${hn(t.getMinutes())}`}function yn(e){if(e===void 0||e===``)return``;let[t,n,r]=e.split(`-`);return t===void 0||n===void 0||r===void 0?e:`${r}/${n}/${t}`}function bn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number);return un(new Date(n,r-1,i+t))}function xn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number),a=new Date(n,r-1+t,1),o=new Date(a.getFullYear(),a.getMonth()+1,0).getDate();return un(new Date(a.getFullYear(),a.getMonth(),Math.min(i,o)))}function Sn(e,t){if(e===``||t===``)return 0;let[n=0,r=1,i=1]=e.split(`-`).map(Number),[a=0,o=1,s=1]=t.split(`-`).map(Number),c=new Date(a,o-1,s).getTime()-new Date(n,r-1,i).getTime();return Math.round(c/ln)}function Cn(){let e=un();return{inicio:mn(e),fim:mn(bn(e,1))-1}}async function wn(){let{inicio:e,fim:t}=Cn(),[n]=await a(`eventosDoDia`,[t,e]);return Number(n?.total??0)}async function Tn(){if(typeof navigator.setAppBadge==`function`)try{let e=await wn();await(e>0?navigator.setAppBadge(e):navigator.clearAppBadge())}catch{}}var En=!1;function Dn(){Tn(),!En&&(En=!0,document.addEventListener(`visibilitychange`,()=>{Tn()}))}var On=10,kn=100,An=e=>new Promise(t=>setTimeout(t,e));async function jn(){let e=await navigator.storage?.getDirectory?.();if(e!==void 0)for(let t=0;t<On;t++){let t=[];for await(let n of e.keys())t.push(n);if(t.length===0)return;let n=!1;for(let r of t)try{await e.removeEntry(r,{recursive:!0})}catch{n=!0}if(!n)return;await An(kn)}}function Mn(e){return new Promise(t=>{let n=indexedDB.deleteDatabase(e);n.onsuccess=()=>t(!0),n.onerror=()=>t(!1),n.onblocked=()=>t(!1)})}async function Nn(){for(let e=0;e<On;e++){let e=(await indexedDB.databases?.()??[]).map(({name:e})=>e).filter(e=>e!==void 0);if(e.length===0||(await Promise.all(e.map(Mn))).every(Boolean))return;await An(kn)}}async function Pn(){let e=await navigator.serviceWorker?.getRegistrations?.()??[];await Promise.all(e.map(e=>e.unregister()));let t=await caches?.keys?.()??[];await Promise.all(t.map(e=>caches.delete(e)))}async function Fn(){r(),await jn(),await Pn(),await Nn(),localStorage.clear(),sessionStorage.clear()}var In=`kobi-note`,Ln=Object.entries(n).filter(([,e])=>e.familia===`privado`).map(([e])=>e),Rn=`note_`,zn=new Set([`note_versoes_curado`]);function Bn(e){return Ln.includes(e)}function Vn(e){return e.startsWith(Rn)&&!zn.has(e)}function Hn(e){let{id_global:t,...n}=e;return n}async function Un(){let e={};for(let t of Ln)e[t]=(await o(t).todos()).map(Hn);return e}function Wn(){let e={};try{for(let t=0;t<localStorage.length;t+=1){let n=localStorage.key(t);if(n===null||!Vn(n))continue;let r=localStorage.getItem(n);r!==null&&(e[n]=r)}}catch{}return e}async function Gn(e){return{app:In,formato:1,versao:e,gerado_em:Date.now(),stores:await Un(),local:Wn()}}async function Kn(e){let t=await Gn(e),n=Ln.map(e=>({id:e,total:t.stores[e]?.length??0}));return{porStore:n,registros:n.reduce((e,t)=>e+t.total,0),chaves:Object.keys(t.local).length,bytes:new Blob([JSON.stringify(t)]).size}}function qn(e=new Date){return`kobi-note-backup-${un(e)}.json`}async function Jn(e){let t=await Gn(e),n=new Blob([JSON.stringify(t)],{type:`application/json`}),r=qn(),i=URL.createObjectURL(n),a=document.createElement(`a`);return a.href=i,a.download=r,a.click(),URL.revokeObjectURL(i),{arquivo:r,bytes:n.size}}function Yn(e){let t=JSON.parse(e);if(typeof t!=`object`||!t)throw Error(In);let n=t;if(n.app!==`kobi-note`||typeof n.stores!=`object`||n.stores===null)throw Error(In);let r=n.stores,i=Object.keys(r).filter(e=>Array.isArray(r[e])),a=i.filter(Bn).reduce((e,t)=>e+r[t].length,0);return{arquivo:{...n,local:n.local??{}},registros:a,desconhecidos:i.filter(e=>!Bn(e))}}async function Xn(e){let t=e.arquivo.stores,n=0;for(let[e,r]of Object.entries(t))Bn(e)&&Array.isArray(r)&&(await o(e).substituirTudo(r.map(Hn)),n+=r.length);for(let[t,n]of Object.entries(e.arquivo.local))Vn(t)&&typeof n==`string`&&localStorage.setItem(t,n);return n}var Zn=`note_versoes_curado`,Qn={perguntas:`perguntas`,poesias:`poesias`,receitas:`receitas`,guias:`guias`,kits:`kits`,criacao_modulos:`criacao_modulos`,imite_cartoes:`imite_cartoes`,principios:`principios`,faq:`faq`,cronologia:`cronologia`,anotacao_modelos:`anotacao_modelos`,estoque_catalogo:`estoque_catalogo`,tutorial:`tutorial`};async function $n(e,t){return t.registros===void 0||t.registros===0||await o(e).contar().then(e=>e>0).catch(()=>!0)}function er(){try{return JSON.parse(localStorage.getItem(Zn)??`{}`)}catch{return{}}}async function tr(e){try{let t=await fetch(`${u.apiEndpoint}/${e}`,{cache:`no-cache`});return t.ok?await t.json():void 0}catch{return}}async function nr(){let e=await tr(`manifesto.json`);if(e===void 0)return{ok:!1,motivo:`offline`};let t=e.modulos;if(t===void 0)return{ok:!1,motivo:`sem-manifesto`};let n=er(),r=[];for(let[e,i]of Object.entries(t)){let t=Qn[e];if(t===void 0||!s.includes(t)||i.versao!==void 0&&n[e]===i.versao&&await $n(t,i))continue;let a=await tr(`${e}.json`);a!==void 0&&(await o(t).substituirTudo(a),i.versao!==void 0&&(n[e]=i.versao),r.push(e))}return localStorage.setItem(Zn,JSON.stringify(n)),await ir(`categorias_financeiro`,`categorias.json`).catch(rr),await or().catch(rr),{ok:!0,atualizados:r}}function rr(e){console.warn(`semeadura do padrão de fábrica falhou:`,e)}async function ir(e,t){let n=o(e);if((await n.todos().catch(()=>[])).length>0)return;let r=await tr(t);if(r!==void 0)for(let e of r){let{publicar:t,...r}=e;await n.salvar(r)}}var ar;function or(){return ar??=ir(`calendario_tipos`,`calendario_tipos.json`).catch(e=>{throw ar=void 0,e}),ar}var sr=`note_tema`,cr=`#ffffff`,lr=`#0f1115`;function ur(){return document.documentElement.classList.contains(`kk-theme-dark`)?`escuro`:`claro`}function dr(e){let t=e===`escuro`,n=document.documentElement.classList;n.toggle(`kk-theme-dark`,t),n.toggle(`kk-theme-light`,!t),document.querySelector(`meta[name="theme-color"]`)?.setAttribute(`content`,t?lr:cr),localStorage.setItem(sr,e)}function fr(){let e=ur()===`escuro`?`claro`:`escuro`;return dr(e),e}var pr,mr;function hr(){let e=document.querySelector(`.barra`);e!==null&&e!==mr&&(pr??=new ResizeObserver(e=>{let t=e[e.length-1]?.target;if(t===void 0)return;let n=t.getBoundingClientRect().height;document.documentElement.style.setProperty(`--note-barra-altura`,`${n}px`)}),mr!==void 0&&pr.unobserve(mr),pr.observe(e),mr=e)}var gr={projetos:{bioma:{versao:`1.0.0`,build:`2026-09-22T23:42:08.612Z`},admin:{versao:`1.0.144`,build:`2026-09-22T23:42:08.612Z`},note:{versao:`0.1.245`,build:`2026-09-22T20:48:23.740Z`},ui:{versao:`1.0.95`,build:`2026-09-22T23:40:15.756Z`},dev:{versao:`1.1.103`,build:`2026-09-17T19:59:18.980Z`},flow:{versao:`0.0.99`,build:`2026-09-22T20:46:35.576Z`},desk:{versao:`0.1.4`,build:`2026-09-18T11:18:23.576Z`},bin:{versao:`0.1.0`,build:`2026-09-04T17:43:53.952Z`},sql:{versao:`3.53.4`,build:`2026-09-04T17:18:39.584Z`}},componentesUi:83,pacotes:[{nome:`@kobi/admin`,versao:`1.0.144`,caminho:`apps/admin`},{nome:`@kobi/desk`,versao:`0.1.4`,caminho:`apps/desk`},{nome:`kobi-dev`,versao:`1.1.103`,caminho:`apps/dev`},{nome:`@kobi/flow`,versao:`0.0.99`,caminho:`apps/flow`},{nome:`@kobi/note`,versao:`0.1.245`,caminho:`apps/note`},{nome:`@bioma/bin`,versao:`0.1.0`,caminho:`packages/bin`},{nome:`@bioma/core`,versao:`0.1.0`,caminho:`packages/core`},{nome:`@bioma/js`,versao:`0.1.0`,caminho:`packages/js`},{nome:`@kobi/kit`,versao:`1.0.95`,caminho:`packages/kit`},{nome:`@bioma/sabores`,versao:`0.4.0`,caminho:`packages/sabores`},{nome:`@bioma/sql`,versao:`3.53.4`,caminho:`packages/sql`},{nome:`@bioma/wasm`,versao:`1.0.0`,caminho:`packages/wasm`}],sementes:{flw_respostas_rapidas:8,not_anotacao_modelos:7,not_calendario_tipos:6,not_categorias_financeiro:17,not_criacao_modulos:63,not_cronologia_eventos:594,not_estoque_alimentos:32,not_guias:15,not_imite_cartoes:89,not_itens_checklist:96,not_kits_checklist:6,not_perguntas:1273,not_poesias:275,not_principios:112,not_receitas:4}}.projetos.note?.build.slice(0,4)??``;function _r(){return v`
  ...
  `}function vr(){return v`
    <footer class="rodape">
      ...
      <p class="rodape__nota">
        ${gr===``?y:v`<span>${x.rodape.direitos(gr)}</span>`}
        <span>${x.rodape.feitoPara}</span>
      </p>
    </footer>
  `}function yr(e,t,n){let r=ur()===`escuro`;return v`
    <header class="barra">
    ...
    ${vr()}
  `}var br={criacao:{rotulo:`Teve um Projeto?`,icone:`compass`,cor:`#6610f2`},estudo:{rotulo:`Estudo Pessoal`,icone:`hourglass`,cor:`#6f42c1`},imite:{rotulo:`Imite a Sua Fé`,icone:`heart-handshake`,cor:`#d63384`},jogo:{rotulo:`Você se lembra?`,icone:`device-gamepad-2`,cor:`#198754`},principios:{rotulo:`Princípios Bíblicos`,icone:`scale`,cor:`#c92a2a`},faq:{rotulo:`Perguntas Frequentes`,icone:`message-question`,cor:`#4263eb`},avulso:{rotulo:`Avulso`,icone:`notes`,cor:`#0d6efd`}};function xr(e){return br[e]??br.avulso}var Sr=()=>o(`not_caderno_estudo`);function Cr(){return Sr().todos()}var wr={origem:`todas`,busca:``};function Tr(e,t){let n=c(t.busca.trim());return e.filter(e=>t.origem===`todas`||e.origem===t.origem).filter(e=>n===``||c(e.titulo).includes(n)||c(e.conteudo).includes(n)||c(e.referencia).includes(n)).sort((e,t)=>(t.atualizado||0)-(e.atualizado||0))}function Er(e){return Sr().salvar(e)}function Dr(e){return Sr().excluir(e)}var Or=`note_caderno_rascunho`;function kr(e){return sessionStorage.setItem(Or,JSON.stringify(e)),`caderno/novo`}function Ar(){try{let e=sessionStorage.getItem(Or);return sessionStorage.removeItem(Or),e===null?{}:JSON.parse(e)}catch{return{}}}async function jr(e){let t=Date.now(),n=e.ref_chave??null;return Er({...(n===null?void 0:(await Cr()).find(e=>e.ref_chave===n))??{criado:t,ref_chave:n},titulo:e.titulo??``,conteudo:e.conteudo??``,origem:e.origem??`avulso`,referencia:e.referencia??``,atualizado:t})}async function Mr(e){if(e===null||e===``)return;let t=(await Cr()).find(t=>t.ref_chave===e);t?.id!==void 0&&await Dr(t.id)}var Nr=`Geral`;async function Pr(){return(await o(`imite_cartoes`).todos()).sort((e,t)=>Number(e.ordem)-Number(t.ordem)||Number(e.id??0)-Number(t.id??0))}function Fr(e){try{let t=JSON.parse(e===``?`[]`:e);return Array.isArray(t)?t:[]}catch{return[]}}function Ir(e){return e===null?[]:Fr(e.lentes)}function Lr(e){return e===null?[]:Fr(e.exemplos)}function Rr(e,t){return e===null||t===null||t===``?!1:t===e.correta&&Ir(e).some(e=>e.id===t)}function zr(e){return e!==null&&Ir(e).some(t=>t.id===e.correta)}function Br(e,t){return(Ir(e).find(e=>e.id===t)?.resposta??``).trim()}function Vr(e,t){let n=new Map;for(let t of e){let e=t.tema.trim()===``?Nr:t.tema.trim(),r=n.get(e);r===void 0?n.set(e,[t]):r.push(t)}return[...n].map(([e,n])=>({tema:e,cartoes:n,concluido:n.every(t)}))}var Hr=`note_imite_progresso`;function Ur(){return{refletidos:{}}}function Wr(){try{let e=JSON.parse(localStorage.getItem(Hr)??`null`);return{...Ur(),...e}}catch{return Ur()}}function Gr(e){localStorage.setItem(Hr,JSON.stringify(e))}function Kr(e,t){let n=e.refletidos[String(t)],r={...e,refletidos:{...e.refletidos,[String(t)]:{tentativas:(n?.tentativas??0)+1,refletidoEm:Date.now()}}};return Gr(r),r}function qr(e,t){return t?.id!==void 0&&e.refletidos[String(t.id)]!==void 0}function Jr(e){return`imite:${e}`}async function Yr(){let e=new Map;for(let t of await Cr()){if(t.origem!==`imite`||t.ref_chave===null)continue;let n=Number(t.ref_chave.split(`:`)[1]);Number.isFinite(n)&&e.set(n,t.conteudo)}return e}function Xr(e,t,n){return n?.id!==void 0&&qr(e,n)&&(t.get(n.id)??``).trim()!==``}function Zr(e){return v`
    <div class="aviso">
  ...
  `}function ni(e){return e instanceof Error?e.message:String(e)}var S={anotacoes:0,eventosHoje:[],contas:{vencidas:0,hoje:0,aVencer:0},leituraPercentual:0,metasAtivas:0,metasConcluidas:0,focoMinutos:0,horasDoMes:0,estudosEsfriando:0,relatoriosPendentes:0,receitasFavoritas:0,prontidao:0,prontidaoTom:`perigo`,kits:0,autonomiaDias:0,dpaVencidoEm:``},ri=!1,ii=!1,ai=!0,oi=!1;function si(){oi||(oi=!0,addEventListener(`hashchange`,()=>{location.hash.replace(/^#\/?/,``).split(`/`)[0]!==`home`&&(ai=!0)}))}async function ci(e,t){try{return await e()}catch{return t}}async function li(){let e=un(),t=dn(),[n,r,i,a,o,s,c,l,u,d]=await Promise.all([ci(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await b(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await import(`./dados-XAI5RS8g.js`);return{FILTROS_INICIAIS:e,listarAnotacoes:t}},__vite__mapDeps([3,4,5]),import.meta.url);return(await t(e)).length},0),ci(async()=>{let t=await b(()=>import(`./dados-ClmRIpYV.js`),__vite__mapDeps([6,4]),import.meta.url),{eventos:n,tipos:r}=await t.carregar();return t.eventosDoDia(n,e).map(e=>({titulo:e.titulo,quando:e.dia_inteiro===1?x.painel.diaInteiro:t.comoHora(e.hora_inicio_min),cor:t.corDoTipo(r,e.tipo_id)}))},[]),ci(async()=>{let{carregar:e,contasPorPrazo:t}=await b(async()=>{let{carregar:e,contasPorPrazo:t}=await import(`./dados-DHNuBrHf.js`);return{carregar:e,contasPorPrazo:t}},__vite__mapDeps([7,4]),import.meta.url),{transacoes:n}=await e();return t(n)},{vencidas:0,hoje:0,aVencer:0}),ci(async()=>{let{lerLidos:e,percentualGeral:t}=await b(async()=>{let{lerLidos:e,percentualGeral:t}=await import(`./dados-CrToLRPu.js`);return{lerLidos:e,percentualGeral:t}},[],import.meta.url);return t(e())},0),ci(async()=>{let{listarMetas:e}=await b(async()=>{let{listarMetas:e}=await import(`./dados-DrNdQjJC.js`);return{listarMetas:e}},__vite__mapDeps([8,9,10,4,5,11]),import.meta.url),t=await e();return{ativas:t.filter(e=>e.esta_concluida!==1).length,concluidas:t.filter(e=>e.esta_concluida===1).length}},{ativas:0,concluidas:0}),ci(async()=>{let{listarSessoes:e,totalDeMinutos:n}=await b(async()=>{let{listarSessoes:e,totalDeMinutos:t}=await import(`./dados-CD8olhec.js`);return{listarSessoes:e,totalDeMinutos:t}},__vite__mapDeps([12,4]),import.meta.url);return n((await e()).filter(e=>dn(e.concluido_em)===t))},0),ci(async()=>{let{carregar:e,esfriando:t,lembreteDoRelatorio:n,relatoriosEmAtraso:r}=await b(async()=>{let{carregar:e,esfriando:t,lembreteDoRelatorio:n,relatoriosEmAtraso:r}=await import(`./dados-BSpo6Q5j.js`);return{carregar:e,esfriando:t,lembreteDoRelatorio:n,relatoriosEmAtraso:r}},__vite__mapDeps([13,4,5,14,15]),import.meta.url),{contador:i,estudos:a,registros:o,relatorios:s}=await e();return{horas:Math.floor(i.minutos/60),esfriando:t(a,o).length,pendentes:(n(s)===null?0:1)+r(s).length}},{horas:0,esfriando:0,pendentes:0}),ci(async()=>{let{lerFavoritos:e}=await b(async()=>{let{lerFavoritos:e}=await import(`./favoritos-DAEWA_Gd.js`);return{lerFavoritos:e}},[],import.meta.url),{CHAVE_FAVORITOS:t}=await b(async()=>{let{CHAVE_FAVORITOS:e}=await import(`./dados-y0xp7md9.js`);return{CHAVE_FAVORITOS:e}},__vite__mapDeps([16,4,17]),import.meta.url);return e(t).size},0),ci(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await b(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await import(`./dados-BgDpV8rv.js`);return{calcularProntidao:e,tomDaProntidao:t}},[],import.meta.url),{carregarKits:n,lerProgresso:r}=await b(async()=>{let{carregarKits:e,lerProgresso:t}=await import(`./kits-BlHykFnD.js`);return{carregarKits:e,lerProgresso:t}},__vite__mapDeps([18,4]),import.meta.url),{calcularAutonomia:i,carregarEstoque:a,lerPerfil:o}=await b(async()=>{let{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}=await import(`./estoque-CeQgoX2j.js`);return{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}},__vite__mapDeps([19,4,5,20]),import.meta.url),[s,c]=await Promise.all([n(),a()]),l=o(),u=e({kits:s,progresso:r(),estoque:c,perfil:l});return{prontidao:u,tom:t(u),kits:s.length,autonomiaDias:i(c,l).dias}},{prontidao:0,tom:`perigo`,kits:0,autonomiaDias:0}),ci(async()=>{let{carregarPerfil:e,dpaVencidoEm:t}=await b(async()=>{let{carregarPerfil:e,dpaVencidoEm:t}=await import(`./dados-B-JOo_RL.js`).then(e=>e.o);return{carregarPerfil:e,dpaVencidoEm:t}},__vite__mapDeps([14,15,4]),import.meta.url);return t(await e())},``)]);return{anotacoes:n,eventosHoje:r,contas:i,leituraPercentual:a,metasAtivas:o.ativas,metasConcluidas:o.concluidas,focoMinutos:s,horasDoMes:c.horas,estudosEsfriando:c.esfriando,relatoriosPendentes:c.pendentes,receitasFavoritas:l,prontidao:u.prontidao,prontidaoTom:u.tom,kits:u.kits,autonomiaDias:u.autonomiaDias,dpaVencidoEm:d}}function ui(){si(),!ii&&ai&&(ai=!1,ii=!0,(async()=>{try{S=await li(),ri=!0}catch(e){console.error(`Painel: a leitura do resumo falhou.`,e)}finally{ii=!1,en()}})())}function di(e){if(ri&&Jt(e)){if(e===`anotacoes`&&S.anotacoes>0)return x.painel.anotacoes(S.anotacoes);if(e===`calendario`&&S.eventosHoje.length>0)return x.painel.eventosHoje(S.eventosHoje.length);if(e===`financeiro`){let e=x.painel.contas(S.contas);if(e!==``)return e}if(e===`leitura`&&S.leituraPercentual>0)return x.painel.leitura(S.leituraPercentual);if(e===`metas`&&S.metasAtivas>0)return x.painel.metas(S.metasAtivas);if(e===`ministerio`&&S.horasDoMes>0)return x.painel.horas(S.horasDoMes);if(e===`perfil`&&S.dpaVencidoEm!==``)return x.perfil.dpaVencidoResumo;if(e===`estudo`&&S.focoMinutos>0)return x.painel.foco(S.focoMinutos);if(e===`receitas`&&S.receitasFavoritas>0)return x.painel.favoritas(S.receitasFavoritas);if(e===`guias`)return x.prep.guiasResumo}}function fi(e){if(ri&&Jt(`prep`)){if(e===`prep-kits`)return x.prep.contagemKits(S.kits);if(e===`prep-estoque`)return x.prep.diasAutonomia(S.autonomiaDias);if(e===`prep-cofre`)return x.prep.cofreResumo}}function pi(e,t,n){let r=Kt(e);return v`
    <button
      class="indicador"
      data-modulo=${e}
  ...
  `}function mi(){let e=new Date().toLocaleDateString(`pt-BR`,{weekday:`long`,day:`numeric`,month:`long`});return v`
    ${S.dpaVencidoEm===``?y:v`
  ...
  `}function hi(){return v`<div class="indicadores">${[S.focoMinutos>0?pi(`estudo`,x.painel.emHoras(S.focoMinutos),x.painel.rotuloFoco):y,S.contas.vencidas>0?pi(`financeiro`,String(S.contas.vencidas),x.painel.rotuloVencidas):y,S.contas.hoje>0?pi(`financeiro`,String(S.contas.hoje),x.painel.rotuloVencemHoje):y,S.contas.aVencer>0?pi(`financeiro`,String(S.contas.aVencer),x.painel.rotuloAVencer):y,S.estudosEsfriando>0?pi(`ministerio`,String(S.estudosEsfriando),x.painel.rotuloEsfriando):y,S.relatoriosPendentes>0?pi(`ministerio`,String(S.relatoriosPendentes),x.painel.rotuloRelatorios):y,pi(`metas`,`${S.metasConcluidas}/${S.metasAtivas+S.metasConcluidas}`,x.painel.rotuloMetas)].filter(e=>e!==y)}</div>`}function gi(){if(!Jt(`prep`))return y;let e=S.prontidao;return v`
  ...
  `}function _i(e){return ui(),ri?e===`hoje`?mi():e===`indicadores`?hi():gi():e===`hoje`?v`<p class="intro">${x.home.sub}</p>`:y}var vi=`#82c91e`,yi=`#ae3ec9`;function bi(e){let t=Jt(e.id);return wi({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:di(e.id),emBreve:!t,aoTocar:()=>Xt(e.id)})}function xi(e){let t=Jt(e.rota.split(`/`)[0]??``);return wi({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:fi(e.id),emBreve:!t,aoTocar:()=>Xt(e.rota)})}function Si(e){return wi({cor:vi,icone:`refresh`,rotulo:x.home.sincronizar,resumo:e.ocupado?x.home.sincronizando:void 0,ocupado:e.ocupado,aoTocar:()=>e.executar()})}function Ci(){return wi({cor:yi,icone:`share`,rotulo:x.convite.tile,resumo:x.convite.tileResumo,aoTocar:()=>{(async()=>{let{abrirConvite:e}=await b(async()=>{let{abrirConvite:e}=await import(`./convite-DhBqJlmj.js`);return{abrirConvite:e}},__vite__mapDeps([21,22]),import.meta.url);await e()})()}})}function wi(e){return v`
    <button
      class="tile"
      style="--cor: ${e.cor}"
  ...
  `}function Ti(e,t){return t?y:v`
    <hr class="divisor" />
    ${e.titulo===void 0?y:v`<h2 class="secao">${e.titulo}</h2>`}
  `}function Ei(e,t){return e.itens.map(e=>{if(e.tipo===`acao`)return e.id===`sincronizar`?Si(t):e.id===`convite`?Ci():y;if(e.tipo===`atalho`){let t=qt(e.id);return t===void 0?y:xi(t)}let n=Kt(e.id);return n===void 0?y:bi(n)}).filter(e=>e!==y)}function Di(e){return v`
    ${Ut.map((t,n)=>{let r=t.painel===void 0?y:_i(t.painel),i=Ei(t,e);return r===y&&i.length===0?y:v`
        ${Ti(t,n===0)}
        ${r}
        ${i.length===0?y:v`<div class="tiles">${i}</div>`}
      `})}
  `}function Oi(e){if(e.target!==e.currentTarget)return;let{source:t}=e.detail;t===`overlay`&&e.preventDefault()}function ki(e,t,n,r={}){let i=document.createElement(`kk-dialog`);return i.setAttribute(`label`,e),r.semCabecalho===!0&&i.setAttribute(`no-header`,``),r.classe!==void 0&&(i.className=r.classe),r.formulario===!0&&i.addEventListener(`kk-request-close`,Oi),document.body.append(i),new Promise(e=>{let r=t,a=e=>{r=e,i.open=!1},o=()=>{wt(n(a,i,o),i)};i.addEventListener(`kk-after-hide`,t=>{t.target===i&&(i.remove(),e(r))}),o(),i.updateComplete.then(()=>{i.open=!0})})}function Ai(e){return ki(e.titulo,!1,t=>v`
      ${e.texto??``}
    ...
    `)}function ji(e){return ki(e.titulo,null,(t,n)=>{let r=()=>{let r=n.querySelector(`kk-input`),i=r?.value.trim()??``;if(i===``){r!=null&&(r.helpText=e.erroVazio??x.acoes.obrigatorio,r.focus());return}t(i)};return v`
    ...
    `},{formulario:!0})}var Mi=4e3,Ni={success:`circle-check`,danger:`alert-triangle`,warning:`alert-triangle`,neutral:`info-circle`};function Pi(e,t=`success`){let n=Object.assign(document.createElement(`kk-alert`),{variant:t,closable:!0,duration:Mi}),r=document.createElement(`kk-icon`);r.setAttribute(`slot`,`icon`),r.setAttribute(`name`,Ni[t]),n.append(r,document.createTextNode(e)),document.body.append(n),n.toast()}async function Fi(){if(await Ai({titulo:x.armazenamento.apagarTudoTitulo,texto:x.armazenamento.apagarTudoTexto,rotuloConfirmar:x.armazenamento.apagarTudoConfirmar,variante:`danger`})){try{await Fn()}catch{Pi(x.armazenamento.apagarTudoFalhou,`warning`);return}Pi(x.armazenamento.apagarTudoFeito),location.reload()}}var Ii=null,Li=new Set;function Ri(){for(let e of[...Li])e()}function zi(e){e.preventDefault(),Ii=e,Ri()}typeof window<`u`&&(window.addEventListener(`beforeinstallprompt`,zi),window.addEventListener(`appinstalled`,()=>{Ii=null,Ri()}));function Bi(){return Ii!==null}async function Vi(){let e=Ii;if(e===null)return!1;Ii=null,Ri();let{outcome:t}=await e.prompt();return t===`accepted`}function Hi(e){return Li.add(e),()=>Li.delete(e)}var Ui=`note_boas_vindas_visto`,Wi=[{id:`bemVindo`,cor:`#fdf10d`},{id:`painel`,cor:`#6f42c1`},{id:`offline`,cor:`#198754`},{id:`privado`,cor:`#dc3545`},{id:`instalar`,cor:`#fd7e14`}];function Gi(){try{return localStorage.getItem(Ui)!==null}catch{return!0}}function Ki(){try{localStorage.setItem(Ui,`1`)}catch{}}function qi(e){let t=Wi[e];if(t===void 0)return v``;let n=x.boasVindas.passos[t.id];return v`
    <div class="bv" style="--cor: ${t.cor}">
      ...
      ${t.id===`instalar`&&Bi()?v`
            <kk-button class="bv__instalar" variant="primary" @click=${()=>void Vi()}>
      ...
      <div
        ...
        role="progressbar"
        aria-valuemin="1"
        aria-valuemax=${Wi.length}
        aria-valuenow=${e+1}
        aria-valuetext=${x.boasVindas.passo(e+1,Wi.length)}
      >
        ${Wi.map((t,n)=>v`<span class="bv__ponto ${n===e?`bv__ponto--atual`:``}"></span>`)}
      </div>
    </div>
  `}function Ji(){let e=0,t,n=Hi(()=>t?.());return ki(x.boasVindas.passos.bemVindo.titulo,void 0,(n,r,i)=>{t=i;let a=e===Wi.length-1;return v`
      ...
      `},{semCabecalho:!0,classe:`bv__dialogo`}).then(()=>{n(),Ki()})}async function Yi(){Gi()||await Ji()}var Xi=new Set,Zi=new Map,Qi,$i=`ltr`,ea=`en`,ta=typeof MutationObserver<`u`&&typeof document<`u`&&typeof document.documentElement<`u`;ta&&($i=document.documentElement.dir||`ltr`,ea=document.documentElement.lang||navigator.language,new MutationObserver(()=>ra()).observe(document.documentElement,{attributes:!0,attributeFilter:[`dir`,`lang`]}));function na(...e){for(let t of e){let e=t.$code.toLowerCase(),n=Zi.get(e);Zi.set(e,n?{...n,...t}:t),Qi??=t}ra()}function ra(){ta&&($i=document.documentElement.dir||`ltr`,ea=document.documentElement.lang||navigator.language);for(let e of Xi)e.requestUpdate()}function ia(e){let t;try{t=new Intl.Locale(e.replaceAll(`_`,`-`))}catch{return{regional:void 0,idioma:void 0}}let n=t.language.toLowerCase(),r=t.region?.toLowerCase()??``;return{regional:r?Zi.get(`${n}-${r}`):void 0,idioma:Zi.get(n)}}var aa=class{constructor(e){this.host=e,this.host.addController(this)}host;hostConnected(){Xi.add(this.host)}hostDisconnected(){Xi.delete(this.host)}dir(){return`${this.host.dir||$i}`.toLowerCase()}lang(){return`${this.host.lang||ea}`.toLowerCase()}exists(e,t){let{includeFallback:n=!1,lang:r=this.lang()}=t??{},{regional:i,idioma:a}=ia(r);return!!(i?.[e]??a?.[e]??(n?Qi?.[e]:void 0))}term(e,...t){let{regional:n,idioma:r}=ia(this.lang()),i=n?.[e]??r?.[e]??Qi?.[e];return i===void 0?(console.error(`Nenhuma tradu\xE7\xE3o encontrada para: ${String(e)}`),String(e)):typeof i==`function`?i(...t):String(i)}date(e,t){return new Intl.DateTimeFormat(this.lang(),t).format(new Date(e))}number(e,t){let n=Number(e);return Number.isNaN(n)?``:new Intl.NumberFormat(this.lang(),t).format(n)}relativeTime(e,t,n){return new Intl.RelativeTimeFormat(this.lang(),n).format(e,t)}},oa={$code:`en`,$name:`English`,$dir:`ltr`,actions:`Actions`,alpha:`Alpha`,browseFiles:`Browse files`,cancel:`Cancel`,carousel:`Carousel`,clearEntry:`Clear entry`,clearFilters:`Clear filters`,close:`Close`,copied:`Copied`,copy:`Copy`,currentValue:`Current value`,deleteItem:`Delete item`,dropFiles:`Drop files here`,editItem:`Edit item`,editorAlignCenter:`Align center`,editorAlignJustify:`Justify`,editorAlignLeft:`Align left`,editorAlignRight:`Align right`,editorArea:`Editing area`,editorBackgroundColor:`Background color`,editorBlockType:`Block type`,editorBold:`Bold`,editorBulletList:`Bulleted list`,editorClearFormat:`Clear formatting`,editorColorBlue:`Blue`,editorColorCyan:`Cyan`,editorColorDefault:`Default`,editorColorGray:`Gray`,editorColorGreen:`Green`,editorColorLime:`Lime`,editorColorOrange:`Orange`,editorColorPink:`Pink`,editorColorRed:`Red`,editorColorTeal:`Teal`,editorColorViolet:`Violet`,editorColorYellow:`Yellow`,editorFootnote:`Footnote`,editorFootnotePlaceholder:`Note text`,editorFootnoteText:`The text appears at the foot of the page, numbered when read.`,editorHeading1:`Heading 1`,editorHeading2:`Heading 2`,editorHeading3:`Heading 3`,editorHeading4:`Heading 4`,editorHighlight:`Highlight`,editorHorizontalRule:`Horizontal rule`,editorImage:`Image`,editorInsert:`Insert`,editorItalic:`Italic`,editorLineBreak:`Line break`,editorLink:`Link`,editorLinkText:`Link address.`,editorNoColor:`No color`,editorNumberedList:`Numbered list`,editorParagraph:`Paragraph`,editorParagraphBordered:`Bordered`,editorParagraphColumns:`Two columns`,editorParagraphDropCap:`Drop cap`,editorParagraphEpigraph:`Epigraph`,editorParagraphEpigraphSubtitle:`Epigraph subtitle`,editorParagraphFinePrint:`Fine print`,editorParagraphFootnotes:`Footnotes`,editorParagraphIndented:`Indented`,editorParagraphSmallCaps:`Small caps`,editorParagraphSmallCapsSubtitle:`Small caps subtitle`,editorParagraphSpaced:`Spaced`,editorParagraphStyle:`Paragraph style`,editorPoetry:`Poetry block`,editorPoetryDedication:`Dedication`,editorPoetryRefrain:`Refrain`,editorPoetryScripture:`Scripture`,editorPoetrySource:`Source`,editorPoetryTheme:`Theme text`,editorPoetryVerse:`Verse`,editorQuote:`Quote`,editorRedo:`Redo`,editorSource:`Source code`,editorStrikethrough:`Strikethrough`,editorTable:`Table`,editorTableColumnAfter:`Insert column right`,editorTableColumnBefore:`Insert column left`,editorTableColumnDelete:`Delete column`,editorTableDelete:`Delete table`,editorTableHeader:`Header row`,editorTableRowAbove:`Insert row above`,editorTableRowBelow:`Insert row below`,editorTableRowDelete:`Delete row`,editorTableSize:`Table size`,editorTextColor:`Text color`,editorToolbar:`Formatting toolbar`,editorTypoDoubleQuotes:`Double quotes`,editorTypoEmDash:`Em dash`,editorTypoEnDash:`En dash`,editorTypography:`Typography`,editorTypoNbsp:`Non-breaking space`,editorTypoSingleQuotes:`Single quotes`,editorUnderline:`Underline`,editorUndo:`Undo`,error:`Error`,finish:`Finish`,firstPage:`First page`,goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:`Hide password`,hsv:`HSV`,hue:`Hue`,lastPage:`Last page`,loading:`Loading`,menu:`Menu`,newItem:`New item`,next:`Next`,nextPage:`Next page`,nextSlide:`Next slide`,no:`No`,noResults:`No results found`,numOptionsSelected:e=>e===0?`No options selected`:e===1?`1 option selected`:`${e} options selected`,page:e=>`Page ${e}`,pagination:`Pagination`,previous:`Previous`,previousPage:`Previous page`,previousSlide:`Previous slide`,progress:`Progress`,remove:`Remove`,resize:`Resize`,resultsPerPage:`Results per page`,save:`Save`,search:`Search`,scrollToEnd:`Scroll to end`,scrollToStart:`Scroll to start`,selectAColorFromTheScreen:`Select a color from the screen`,selectAll:`Select all`,selectRow:`Select row`,showingResults:(e,t,n)=>`Showing ${e}\u2013${t} of ${n}`,showPassword:`Show password`,slideNum:e=>`Slide ${e}`,sortAscending:`Sort ascending`,sortClear:`Clear sorting`,sortDescending:`Sort descending`,stepNum:(e,t)=>`Step ${e} of ${t}`,toggleColorFormat:`Toggle color format`,valueMissing:`Please fill out this field.`,yes:`Yes`};na(oa);var sa=oa,ca=class extends aa{static{na(sa)}};na({$code:`pt`,$name:`Português (Brasil)`,$dir:`ltr`,actions:`Ações`,browseFiles:`Escolher arquivos`,cancel:`Cancelar`,carousel:`Carrossel`,clearEntry:`Limpar entrada`,clearFilters:`Limpar filtros`,close:`Fechar`,copied:`Copiado`,copy:`Copiar`,currentValue:`Valor atual`,deleteItem:`Excluir registro`,dropFiles:`Solte os arquivos aqui`,editItem:`Editar registro`,editorAlignCenter:`Centralizar`,editorAlignJustify:`Justificar`,editorAlignLeft:`Alinhar à esquerda`,editorAlignRight:`Alinhar à direita`,editorArea:`Área de edição`,editorBackgroundColor:`Cor de fundo`,editorBlockType:`Tipo de bloco`,editorBold:`Negrito`,editorBulletList:`Lista`,editorClearFormat:`Limpar formatação`,editorColorBlue:`Azul`,editorColorCyan:`Ciano`,editorColorDefault:`Padrão`,editorColorGray:`Cinza`,editorColorGreen:`Verde`,editorColorLime:`Limão`,editorColorOrange:`Laranja`,editorColorPink:`Rosa`,editorColorRed:`Vermelho`,editorColorTeal:`Azul-petróleo`,editorColorViolet:`Violeta`,editorColorYellow:`Amarelo`,editorFootnote:`Nota de rodapé`,editorFootnotePlaceholder:`Texto da nota`,editorFootnoteText:`O texto aparece no rodapé, numerado na leitura.`,editorHeading1:`Título 1`,editorHeading2:`Título 2`,editorHeading3:`Título 3`,editorHeading4:`Título 4`,editorHighlight:`Destaque`,editorHorizontalRule:`Linha horizontal`,editorImage:`Imagem`,editorInsert:`Inserir`,editorItalic:`Itálico`,editorLineBreak:`Quebra de linha`,editorLink:`Link`,editorLinkText:`Endereço do link.`,editorNoColor:`Sem cor`,editorNumberedList:`Lista numerada`,editorParagraph:`Parágrafo`,editorParagraphBordered:`Emoldurado`,editorParagraphColumns:`Duas colunas`,editorParagraphDropCap:`Capitular`,editorParagraphEpigraph:`Epígrafe`,editorParagraphEpigraphSubtitle:`Subtítulo da epígrafe`,editorParagraphFinePrint:`Letra miúda`,editorParagraphFootnotes:`Notas de rodapé`,editorParagraphIndented:`Recuado`,editorParagraphSmallCaps:`Versaletes`,editorParagraphSmallCapsSubtitle:`Subtítulo dos versaletes`,editorParagraphSpaced:`Espaçado`,editorParagraphStyle:`Estilo de parágrafo`,editorPoetry:`Bloco de poesia`,editorPoetryDedication:`Dedicatória`,editorPoetryRefrain:`Refrão`,editorPoetryScripture:`Escritura`,editorPoetrySource:`Fonte`,editorPoetryTheme:`Texto tema`,editorPoetryVerse:`Verso`,editorQuote:`Citação`,editorRedo:`Refazer`,editorSource:`Código-fonte`,editorStrikethrough:`Tachado`,editorTable:`Tabela`,editorTableColumnAfter:`Inserir coluna à direita`,editorTableColumnBefore:`Inserir coluna à esquerda`,editorTableColumnDelete:`Excluir coluna`,editorTableDelete:`Excluir tabela`,editorTableHeader:`Linha de cabeçalho`,editorTableRowAbove:`Inserir linha acima`,editorTableRowBelow:`Inserir linha abaixo`,editorTableRowDelete:`Excluir linha`,editorTableSize:`Tamanho da tabela`,editorTextColor:`Cor do texto`,editorToolbar:`Barra de formatação`,editorTypoDoubleQuotes:`Aspas duplas`,editorTypoEmDash:`Travessão`,editorTypoEnDash:`Meia-risca`,editorTypography:`Tipografia`,editorTypoNbsp:`Espaço inseparável`,editorTypoSingleQuotes:`Aspas simples`,editorUnderline:`Sublinhado`,editorUndo:`Desfazer`,error:`Erro`,finish:`Concluir`,firstPage:`Primeira página`,goToSlide:(e,t)=>`V\xE1 para o slide ${e} de ${t}`,hidePassword:`Esconder a senha`,alpha:`Alfa`,hsv:`HSV`,hue:`Matiz`,lastPage:`Última página`,loading:`Carregando`,menu:`Menu`,newItem:`Novo registro`,next:`Avançar`,nextPage:`Próxima página`,nextSlide:`Próximo slide`,no:`Não`,noResults:`Nenhum resultado encontrado`,numOptionsSelected:e=>e===0?`Nenhuma opção selecionada`:e===1?`1 opção selecionada`:`${e} op\xE7\xF5es selecionadas`,page:e=>`P\xE1gina ${e}`,pagination:`Paginação`,previous:`Voltar`,previousPage:`Página anterior`,previousSlide:`Slide anterior`,progress:`Progresso`,remove:`Remover`,resize:`Mudar o tamanho`,resultsPerPage:`Registros por página`,save:`Salvar`,search:`Pesquisar`,scrollToEnd:`Rolar até o final`,scrollToStart:`Rolar até o início`,selectAColorFromTheScreen:`Selecionar uma cor da tela`,selectAll:`Selecionar tudo`,selectRow:`Selecionar a linha`,showingResults:(e,t,n)=>`Mostrando ${e}\u2013${t} de ${n}`,showPassword:`Mostrar senha`,slideNum:e=>`Slide ${e}`,sortAscending:`Ordenar em ordem crescente`,sortClear:`Remover ordenação`,sortDescending:`Ordenar em ordem decrescente`,stepNum:(e,t)=>`Etapa ${e} de ${t}`,toggleColorFormat:`Trocar o formato de cor`,valueMissing:`Preencha este campo.`,yes:`Sim`});var la=globalThis,ua=la.ShadowRoot&&(la.ShadyCSS===void 0||la.ShadyCSS.nativeShadow)&&`adoptedStyleSheets`in Document.prototype&&`replace`in CSSStyleSheet.prototype,da=Symbol(),fa=new WeakMap,pa=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==da)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(ua&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=fa.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&fa.set(t,e))}return e}toString(){return this.cssText}},ma=e=>new pa(typeof e==`string`?e:e+``,void 0,da),C=(e,...t)=>new pa(e.length===1?e[0]:t.reduce((t,n,r)=>t+(e=>{if(e._$cssResult$===!0)return e.cssText;if(typeof e==`number`)return e;throw Error(`Value passed to 'css' function must be a 'css' function result: `+e+`. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)})(n)+e[r+1],e[0]),e,da),ha=(e,t)=>{if(ua)e.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let n of t){let t=document.createElement(`style`),r=la.litNonce;r!==void 0&&t.setAttribute(`nonce`,r),t.textContent=n.cssText,e.appendChild(t)}},ga=ua?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t=``;for(let n of e.cssRules)t+=n.cssText;return ma(t)})(e):e,{is:_a,defineProperty:va,getOwnPropertyDescriptor:ya,getOwnPropertyNames:ba,getOwnPropertySymbols:xa,getPrototypeOf:Sa}=Object,Ca=globalThis,wa=Ca.trustedTypes,Ta=wa?wa.emptyScript:``,Ea=Ca.reactiveElementPolyfillSupport,Da=(e,t)=>e,Oa={toAttribute(e,t){switch(t){case Boolean:e=e?Ta:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},ka=(e,t)=>!_a(e,t),Aa={attribute:!0,type:String,converter:Oa,reflect:!1,useDefault:!1,hasChanged:ka};Symbol.metadata??=Symbol(`metadata`),Ca.litPropertyMetadata??=new WeakMap;var ja=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Aa){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),r=this.getPropertyDescriptor(e,n,t);r!==void 0&&va(this.prototype,e,r)}}static getPropertyDescriptor(e,t,n){let{get:r,set:i}=ya(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:r,set(t){let a=r?.call(this);i?.call(this,t),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Aa}static _$Ei(){if(this.hasOwnProperty(Da(`elementProperties`)))return;let e=Sa(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Da(`finalized`)))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Da(`properties`))){let e=this.properties,t=[...ba(e),...xa(e)];for(let n of t)this.createProperty(n,e[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[e,n]of t)this.elementProperties.set(e,n)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let n=this._$Eu(e,t);n!==void 0&&this._$Eh.set(n,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let e of n)t.unshift(ga(e))}else e!==void 0&&t.push(ga(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n==`string`?n:typeof e==`string`?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ha(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,n);if(r!==void 0&&n.reflect===!0){let i=(n.converter?.toAttribute===void 0?Oa:n.converter).toAttribute(t,n.type);this._$Em=e,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(e,t){let n=this.constructor,r=n._$Eh.get(e);if(r!==void 0&&this._$Em!==r){let e=n.getPropertyOptions(r),i=typeof e.converter==`function`?{fromAttribute:e.converter}:e.converter?.fromAttribute===void 0?Oa:e.converter;this._$Em=r;let a=i.fromAttribute(t,e.type);this[r]=a??this._$Ej?.get(r)??a,this._$Em=null}}requestUpdate(e,t,n,r=!1,i){if(e!==void 0){let a=this.constructor;if(r===!1&&(i=this[e]),n??=a.getPropertyOptions(e),!((n.hasChanged??ka)(i,t)||n.useDefault&&n.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,n))))return;this.C(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:r,wrapped:i},a){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??t??this[e]),i!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[t,n]of e){let{wrapped:e}=n,r=this[t];e!==!0||this._$AL.has(t)||r===void 0||this.C(t,void 0,n,r)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(e){}firstUpdated(e){}};ja.elementStyles=[],ja.shadowRootOptions={mode:`open`},ja[Da(`elementProperties`)]=new Map,ja[Da(`finalized`)]=new Map,Ea?.({ReactiveElement:ja}),(Ca.reactiveElementVersions??=[]).push(`2.1.2`);var Ma=globalThis,Na=e=>e,Pa=Ma.trustedTypes,Fa=Pa?Pa.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,Ia=`$lit$`,La=`lit$${Math.random().toFixed(9).slice(2)}$`,Ra=`?`+La,za=`<${Ra}>`,Ba=document,Va=()=>Ba.createComment(``),Ha=e=>e===null||typeof e!=`object`&&typeof e!=`function`,Ua=Array.isArray,Wa=e=>Ua(e)||typeof e?.[Symbol.iterator]==`function`,Ga=`[ 	
\f\r]`,Ka=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qa=/-->/g,Ja=/>/g,Ya=RegExp(`>|${Ga}(?:([^\\s"'>=/]+)(${Ga}*=${Ga}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,`g`),Xa=/'/g,Za=/"/g,Qa=/^(?:script|style|textarea|title)$/i,w=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),$a=Symbol.for(`lit-noChange`),T=Symbol.for(`lit-nothing`),eo=new WeakMap,to=Ba.createTreeWalker(Ba,129);function no(e,t){if(!Ua(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return Fa===void 0?t:Fa.createHTML(t)}var ro=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=Ka;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Ka?c[1]===`!--`?o=qa:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=Ya):(Qa.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=Ya):o=Ja:o===Ya?c[0]===`>`?(o=i??Ka,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?Ya:c[3]===`"`?Za:Xa):o===Za||o===Xa?o=Ya:o===qa||o===Ja?o=Ka:(o=Ya,i=void 0);let d=o===Ya&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Ka?n+za:l>=0?(r.push(s),n.slice(0,l)+Ia+n.slice(l)+La+d):n+La+(l===-2?t:d)}return[no(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},io=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=ro(t,n);if(this.el=e.createElement(l,r),to.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=to.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(Ia)){let t=u[o++],n=i.getAttribute(e).split(La),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?lo:r[1]===`?`?uo:r[1]===`@`?fo:co}),i.removeAttribute(e)}else e.startsWith(La)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Qa.test(i.tagName)){let e=i.textContent.split(La),t=e.length-1;if(t>0){i.textContent=Pa?Pa.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Va()),to.nextNode(),c.push({type:2,index:++a});i.append(e[t],Va())}}}else if(i.nodeType===8){if(i.data===Ra)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(La,e+1))!==-1;)c.push({type:7,index:a}),e+=La.length-1}}a++}}static createElement(e,t){let n=Ba.createElement(`template`);return n.innerHTML=e,n}};function ao(e,t,n=e,r){if(t===$a)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=Ha(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=ao(e,i._$AS(e,t.values),i,r)),t}var oo=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Ba).importNode(t,!0);to.currentNode=r;let i=to.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new so(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new po(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=to.nextNode(),a++)}return to.currentNode=Ba,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},so=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=T,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ao(this,e,t),Ha(e)?e===T||e==null||e===``?(this._$AH!==T&&this._$AR(),this._$AH=T):e!==this._$AH&&e!==$a&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Wa(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==T&&Ha(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ba.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=io.createElement(no(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new oo(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=eo.get(e.strings);return t===void 0&&eo.set(e.strings,t=new io(e)),t}k(t){Ua(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(Va()),this.O(Va()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=Na(e).nextSibling;Na(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},co=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=T,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=T}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=ao(this,e,t,0),a=!Ha(e)||e!==this._$AH&&e!==$a,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=ao(this,r[n+o],t,o),s===$a&&(s=this._$AH[o]),a||=!Ha(s)||s!==this._$AH[o],s===T?e=T:e!==T&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===T?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},lo=class extends co{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===T?void 0:e}},uo=class extends co{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==T)}},fo=class extends co{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=ao(this,e,t,0)??T)===$a)return;let n=this._$AH,r=e===T&&n!==T||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==T&&(n===T||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},po=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ao(this,e)}},mo={M:Ia,P:La,A:Ra,C:1,L:ro,R:oo,D:Wa,V:ao,I:so,H:co,N:uo,U:fo,B:lo,F:po},ho=Ma.litHtmlPolyfillSupport;ho?.(io,so),(Ma.litHtmlVersions??=[]).push(`3.3.3`);var go=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new so(t.insertBefore(Va(),e),e,void 0,n??{})}return i._$AI(e),i},_o=globalThis,vo=class extends ja{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=go(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return $a}};vo._$litElement$=!0,vo.finalized=!0,_o.litElementHydrateSupport?.({LitElement:vo});var yo=_o.litElementPolyfillSupport;yo?.({LitElement:vo}),(_o.litElementVersions??=[]).push(`4.2.2`);var bo=C`
  :host {
...
`,xo={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},So=e=>(...t)=>({_$litDirective$:e,values:t}),Co=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},E=So(class extends Co{constructor(e){if(super(e),e.type!==xo.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return $a}}),D=C`
...
`,wo={attribute:!0,type:String,converter:Oa,reflect:!1,hasChanged:ka},To=(e=wo,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function O(e){return(t,n)=>typeof n==`object`?To(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function k(e){return O({...e,state:!0,attribute:!1})}var Eo=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n);function A(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return Eo(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return Eo(n,r,{get(){return a(this)}})}}var Do=new WeakMap,Oo=(e=`value`)=>(t,n)=>{n.addInitializer(function(){let t={observada:e,destino:String(n.name)},r=Do.get(this);r?r.push(t):Do.set(this,[t])})};function ko(e,t,n){let r=Do.get(e);if(!r)return;let i=e.constructor,a=e;for(let{observada:e,destino:o}of r){let r=i.getPropertyOptions(e);if(t!==(typeof r.attribute==`string`?r.attribute:e))continue;let s=r.converter||Oa,c=(typeof s==`function`?s:s?.fromAttribute??Oa.fromAttribute)(n,r.type);a[e]!==c&&(a[o]=c)}}var Ao=new WeakMap;function j(e,t){let n=Array.isArray(e)?e:[e],r=t?.waitUntilFirstUpdate??!1;return(e,t)=>{t.addInitializer(function(){let t={propriedades:n,handler:e,esperarPrimeiroRender:r},i=Ao.get(this);i?i.push(t):Ao.set(this,[t])})}}function jo(e,t){let n=Ao.get(e);if(!n)return;let r=e,i=new Set;for(let a=0;a<10;a++){let a=!1;for(let[o,{propriedades:s,handler:c,esperarPrimeiroRender:l}]of n.entries())if(!l||e.hasUpdated)for(let n of s){if(!t.has(n))continue;let s=`${o}:${n}`;if(i.has(s))continue;let l=t.get(n),u=r[n];l!==u&&(i.add(s),a=!0,c.call(e,l,u))}if(!a)return}}var Mo,No,Po,Fo,Io,Lo,Ro,M=class extends (Po=vo,No=[O()],Mo=[O()],Po){constructor(){super(),g(this,`_internals`),_(this,Io,m(Fo,8,this)),m(Fo,11,this),_(this,Lo,m(Fo,12,this)),m(Fo,15,this),_(this,Ro,!1),g(this,`initialReflectedProperties`,new Map),this._internals=this.attachInternals(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...t});return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v${t.version}`),`version`in r&&r.version&&(a=` v${r.version}`),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}addState(e){this._internals.states&&this._internals.states.add(e.startsWith(`--`)?e:`--${e}`)}removeState(e){this._internals.states&&this._internals.states.delete(e.startsWith(`--`)?e:`--${e}`)}toggleState(e,t){let n=e.startsWith(`--`)?e:`--${e}`;this._internals.states&&(typeof t==`boolean`?t?this._internals.states.add(n):this._internals.states.delete(n):this._internals.states.has(n)?this._internals.states.delete(n):this._internals.states.add(n))}attributeChangedCallback(e,t,n){he(this,Ro)||(this.constructor.elementProperties.forEach((e,t)=>{let n=t;e.reflect&&this[n]!=null&&this.initialReflectedProperties.set(n,this[n])}),ge(this,Ro,!0)),ko(this,e,n),super.attributeChangedCallback(e,t,n)}update(e){jo(this,e),super.update(e)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{let r=n;e.has(r)&&this[r]==null&&(this[r]=t)})}};Fo=f(Po),Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,h(Fo,4,`dir`,No,M,Io),h(Fo,4,`lang`,Mo,M,Lo),p(Fo,M),g(M,`version`,`0.0.0`),g(M,`dependencies`,{});var zo,Bo,Vo,Ho,Uo=class extends (Bo=M,zo=[O({reflect:!0})],Bo){constructor(){super(...arguments),_(this,Ho,m(Vo,8,this,`grouped`)),m(Vo,11,this),g(this,`aoAbrirSecao`,e=>{let t=this.secoes(),n=t.find(t=>t===e.target);if(n?.name)for(let e of t)e!==n&&e.name===n.name&&e.open&&e.hide()}),g(this,`aoTrocarSecoes`,()=>{let e=new Set;for(let t of this.secoes())!t.name||!t.open||(e.has(t.name)?t.open=!1:e.add(t.name))})}connectedCallback(){super.connectedCallback(),this.addEventListener(`kk-show`,this.aoAbrirSecao)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`kk-show`,this.aoAbrirSecao)}secoes(){return[...this.querySelectorAll(`:scope > kk-details`)]}render(){return w`
      <div
        part="base"
    ...
    `}};Vo=f(Bo),Ho=new WeakMap,h(Vo,4,`appearance`,zo,Uo,Ho),p(Vo,Uo),g(Uo,`styles`,[D,bo]),Uo.define(`kk-accordion`);var Wo=e=>{let{activeElement:t}=document;t&&e.contains(t)&&document.activeElement?.blur()},Go=C`
  :host {
...
`,Ko=Symbol.for(``),qo=e=>{if(e?.r===Ko)return e?._$litStatic$},Jo=(e,...t)=>({_$litStatic$:t.reduce((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(n)+e[r+1],e[0]),r:Ko}),Yo=new Map,Xo=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=qo(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=Yo.get(e))===void 0&&(o.raw=o,Yo.set(e,t=o)),n=s}return e(t,...n)})(w),Zo={fromAttribute:e=>e??``,toAttribute:e=>e===``?null:e},Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakSet,ns=new WeakMap,rs=class{host;form;options;constructor(e,t){this.host=e,e.addController(this),this.options={form:e=>{let t=e.form;if(t){let n=e.getRootNode().querySelector(`#${t}`);if(n)return n}return e.closest(`form`)},name:e=>e.name,value:e=>e.value,defaultValue:e=>e.defaultValue,disabled:e=>e.disabled??!1,reportValidity:e=>typeof e.reportValidity!=`function`||e.reportValidity(),checkValidity:e=>typeof e.checkValidity!=`function`||e.checkValidity(),setValue:(e,t)=>e.value=t,assumeInteractionOn:[`kk-input`],...t}}hostConnected(){let e=this.options.form(this.host);e&&this.attachForm(e),ns.set(this.host,[]),this.options.assumeInteractionOn.forEach(e=>{this.host.addEventListener(e,this.handleInteraction)})}hostDisconnected(){this.detachForm(),ns.delete(this.host),this.options.assumeInteractionOn.forEach(e=>{this.host.removeEventListener(e,this.handleInteraction)})}hostUpdated(){let e=this.options.form(this.host);e||this.detachForm(),e&&this.form!==e&&(this.detachForm(),this.attachForm(e)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(e){e?(this.form=e,Qo.has(this.form)?Qo.get(this.form).add(this.host):Qo.set(this.form,new Set([this.host])),this.form.addEventListener(`formdata`,this.handleFormData),this.form.addEventListener(`submit`,this.handleFormSubmit),this.form.addEventListener(`reset`,this.handleFormReset),$o.has(this.form)||($o.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity()),es.has(this.form)||(es.set(this.form,this.form.checkValidity),this.form.checkValidity=()=>this.checkFormValidity())):this.form=void 0}detachForm(){if(!this.form)return;let e=Qo.get(this.form);e&&(e.delete(this.host),e.size<=0&&(this.form.removeEventListener(`formdata`,this.handleFormData),this.form.removeEventListener(`submit`,this.handleFormSubmit),this.form.removeEventListener(`reset`,this.handleFormReset),$o.has(this.form)&&(this.form.reportValidity=$o.get(this.form),$o.delete(this.form)),es.has(this.form)&&(this.form.checkValidity=es.get(this.form),es.delete(this.form)),this.form=void 0))}handleFormData=e=>{let t=this.options.disabled(this.host),n=this.options.name(this.host),r=this.options.value(this.host),i=this.host.tagName.toLowerCase()===`kk-button`;this.host.isConnected&&!t&&!i&&typeof n==`string`&&n.length>0&&typeof r<`u`&&(Array.isArray(r)?r.forEach(t=>{e.formData.append(n,t.toString())}):e.formData.append(n,r.toString()))};handleFormSubmit=e=>{let t=this.options.disabled(this.host),n=this.options.reportValidity;this.form&&!this.form.noValidate&&Qo.get(this.form)?.forEach(e=>{this.setUserInteracted(e,!0)}),this.form&&!this.form.noValidate&&!t&&!n(this.host)&&(e.preventDefault(),e.stopImmediatePropagation())};handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),ns.set(this.host,[])};handleInteraction=e=>{let t=ns.get(this.host);t.includes(e.type)||t.push(e.type),t.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)};checkFormValidity=()=>{if(this.form&&!this.form.noValidate){let e=this.form.querySelectorAll(`*`);for(let t of e)if(typeof t.checkValidity==`function`&&!t.checkValidity())return!1}return!0};reportFormValidity=()=>{if(this.form&&!this.form.noValidate){let e=this.form.querySelectorAll(`*`);for(let t of e)if(typeof t.reportValidity==`function`&&!t.reportValidity())return!1}return!0};setUserInteracted(e,t){t?ts.add(e):ts.delete(e),e.requestUpdate()}doAction(e,t){this.form&&as(this.form,e,t)}getForm(){return this.form??null}reset(e){this.doAction(`reset`,e)}submit(e){this.doAction(`submit`,e)}setValidity(e){let t=this.host,n=!!ts.has(t),r=!!t.required;t.toggleAttribute(`data-required`,r),t.toggleAttribute(`data-optional`,!r),t.toggleAttribute(`data-invalid`,!e),t.toggleAttribute(`data-valid`,e),t.toggleAttribute(`data-user-invalid`,!e&&n),t.toggleAttribute(`data-user-valid`,e&&n)}updateValidity(){let e=this.host;this.setValidity(e.validity.valid)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.host.dispatchEvent(t)||e?.preventDefault()}},is=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1});Object.freeze({...is,valid:!1,valueMissing:!0}),Object.freeze({...is,valid:!1,customError:!0});function as(e,t,n){let r=document.createElement(`button`);r.type=t,r.style.position=`absolute`,r.style.width=`0`,r.style.height=`0`,r.style.clipPath=`inset(50%)`,r.style.overflow=`hidden`,r.style.whiteSpace=`nowrap`,n&&(r.name=n.name,r.value=n.value,[`formaction`,`formenctype`,`formmethod`,`formnovalidate`,`formtarget`].forEach(e=>{n.hasAttribute(e)&&r.setAttribute(e,n.getAttribute(e))})),e.append(r),r.click(),r.remove()}var N=e=>e??T,{I:os}=mo,ss=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t,cs=e=>e.strings===void 0,ls={},us=(e,t=ls)=>e._$AH=t,ds={caret:`
  ...
  `},fs=[{name:`default`,resolver:(e,t)=>ne(`assets/icons/${t}/${e}.svg`)},{name:`system`,resolver:e=>e in ds?`data:image/svg+xml,${encodeURIComponent(ds[e])}`:``}],ps=[];function ms(e){ps.push(e)}function hs(e){ps=ps.filter(t=>t!==e)}function gs(e){return fs.find(t=>t.name===e)}var _s=C`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`,Jc=class extends M{static styles=[D,qc];localize=new ca(this);render(){return w`
...
`,Xc,Zc,Qc,$c,el,tl,nl,rl,il,al,ol,sl,cl,ll,ul,dl,fl,pl,ml,hl,gl,_l,vl,yl,bl,xl,Sl,Cl,wl,Tl,R,El,Dl,Ol,kl,Al,jl,Ml,Nl,Pl,Fl,Il,Ll,Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,z=class extends (Tl=M,wl=[A(`.button`)],Cl=[k()],Sl=[k()],xl=[O()],bl=[O({reflect:!0})],yl=[O({reflect:!0})],vl=[O({type:Boolean,reflect:!0})],_l=[O({type:Boolean,reflect:!0})],gl=[O({type:Boolean,reflect:!0})],hl=[O({type:Boolean,reflect:!0})],ml=[O({type:Boolean,reflect:!0})],pl=[O({type:Boolean,reflect:!0})],fl=[O({type:Boolean,reflect:!0})],dl=[O({type:Boolean,reflect:!0})],ul=[O()],ll=[O()],cl=[O()],sl=[O()],ol=[O()],al=[O()],il=[O()],rl=[O()],nl=[O({attribute:`formaction`})],tl=[O({attribute:`formenctype`})],el=[O({attribute:`formmethod`})],$c=[O({attribute:`formnovalidate`,type:Boolean})],Qc=[O({attribute:`formtarget`})],Zc=[j(`disabled`,{waitUntilFirstUpdate:!0})],Xc=[j(`loading`,{waitUntilFirstUpdate:!0})],Tl){constructor(){super(...arguments),m(R,5,this),g(this,`formControlController`,new rs(this,{assumeInteractionOn:[`click`]})),g(this,`hasSlotController`,new fc(this,`[default]`,`prefix`,`suffix`)),g(this,`localize`,new ca(this)),_(this,El,m(R,8,this)),m(R,11,this),_(this,Dl,m(R,12,this,!1)),m(R,15,this),_(this,Ol,m(R,16,this,!1)),m(R,19,this),_(this,kl,m(R,20,this,``)),m(R,23,this),_(this,Al,m(R,24,this,`default`)),m(R,27,this),_(this,jl,m(R,28,this,`medium`)),m(R,31,this),_(this,Ml,m(R,32,this,!1)),m(R,35,this),_(this,Nl,m(R,36,this,!1)),m(R,39,this),_(this,Pl,m(R,40,this,!1)),m(R,43,this),_(this,Fl,m(R,44,this,!1)),m(R,47,this),_(this,Il,m(R,48,this,!1)),m(R,51,this),_(this,Ll,m(R,52,this,!1)),m(R,55,this),_(this,Rl,m(R,56,this,!1)),m(R,59,this),_(this,zl,m(R,60,this,!1)),m(R,63,this),_(this,Bl,m(R,64,this,`button`)),m(R,67,this),_(this,Vl,m(R,68,this,``)),m(R,71,this),_(this,Hl,m(R,72,this,``)),m(R,75,this),_(this,Ul,m(R,76,this,``)),m(R,79,this),_(this,Wl,m(R,80,this)),m(R,83,this),_(this,Gl,m(R,84,this,`noreferrer noopener`)),m(R,87,this),_(this,Kl,m(R,88,this)),m(R,91,this),_(this,ql,m(R,92,this)),m(R,95,this),_(this,Jl,m(R,96,this)),m(R,99,this),_(this,Yl,m(R,100,this)),m(R,103,this),_(this,Xl,m(R,104,this)),m(R,107,this),_(this,Zl,m(R,108,this)),m(R,111,this),_(this,Ql,m(R,112,this)),m(R,115,this)}get validity(){return this.isButton()?this.button.validity:is}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.isButton()&&this.formControlController.updateValidity()}handleLoadingChange(){this.toggleState(`--loading`,this.loading)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?Jo`a`:Jo`button`;return Xo`
      <${t}
        ...
        @click=${this.handleClick}
      >
        ${this.swipe?Xo`<span part="decor" class="button__decor"></span>`:``}
        <slot name="prefix" part="prefix" class="button__prefix"></slot>
        ${this.expand?Xo`<span class="button__reveal"><slot part="label" class="button__label"></slot></span>`:Xo`<slot part="label" class="button__label"></slot>`}
        <slot name="suffix" part="suffix" class="button__suffix"></slot>
        ${this.caret?Xo` <kk-icon part="caret" class="button__caret" library="system" name="caret"></kk-icon> `:``}
        ${this.loading?Xo`<kk-spinner part="spinner"></kk-spinner>`:``}
      </${t}>
...
`,Sp=So(class extends Co{constructor(e){if(super(e),e.type!==xo.PROPERTY&&e.type!==xo.ATTRIBUTE&&e.type!==xo.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!cs(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===$a||t===T)return t;let n=e.element,r=e.name;if(e.type===xo.PROPERTY){if(t===n[r])return $a}else if(e.type===xo.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return $a}else if(e.type===xo.ATTRIBUTE&&n.getAttribute(r)===t+``)return $a;return us(e),t}}),Cp=C`
...
`;function wp(e){return e.validity.valid?``:e.validationMessage===``?` `:e.validationMessage}var Tp=class{host;interacaoEm;vistos=new Set;interagiu=!1;constructor(e,t){this.host=e,this.interacaoEm=t?.interacaoEm??[`kk-blur`,`kk-input`],e.addController(this)}hostConnected(){this.host.addEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.addEventListener(e,this.aoInteragir)}hostDisconnected(){this.host.removeEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.removeEventListener(e,this.aoInteragir)}aoInvalidar=e=>{this.conferindo||this.marcarInteragido(),this.host.emitInvalidEvent(e)};conferindo=!1;conferir(e){this.conferindo=!0;try{return e()}finally{this.conferindo=!1}}aoInteragir=e=>{this.vistos.add(e.type),!(this.vistos.size<this.interacaoEm.length)&&this.marcarInteragido()};marcarInteragido(){this.interagiu||(this.interagiu=!0,this.host.updateValidity())}esquecerInteracao(){this.vistos.clear(),this.interagiu=!1}aplicar(e,t){let n=this.host.required===!0;t(`--required`,n),t(`--optional`,!n),t(`--valid`,e),t(`--invalid`,!e),t(`--user-valid`,e&&this.interagiu),t(`--user-invalid`,!e&&this.interagiu)}},Ep,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp,zp,Bp,Vp,Hp,Up,Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,G,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm,Tm,Em,Dm,Om,km,Am,jm,Mm,Nm,Pm,Fm,Im,Lm,Rm,zm,Bm,Vm,Hm,K=class extends (lm=M,cm=[A(`.input__control`)],sm=[k()],om=[O()],am=[O({reflect:!0})],im=[O()],rm=[O()],nm=[Oo()],tm=[O({reflect:!0})],em=[O({type:Boolean,reflect:!0})],$p=[O({type:Boolean,reflect:!0})],Qp=[O()],Zp=[O({attribute:`help-text`})],Xp=[O({type:Boolean})],Yp=[O({type:Boolean,reflect:!0})],Jp=[O()],qp=[O({type:Boolean,reflect:!0})],Kp=[O({attribute:`password-toggle`,type:Boolean})],Gp=[O({attribute:`password-visible`,type:Boolean})],Wp=[O({attribute:`no-spin-buttons`,type:Boolean})],Up=[O({reflect:!0,converter:Zo})],Hp=[O({type:Boolean,reflect:!0})],Vp=[O()],Bp=[O({type:Number})],zp=[O({type:Number})],Rp=[O()],Lp=[O()],Ip=[O()],Fp=[O()],Pp=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],Np=[O()],Mp=[O({type:Boolean})],jp=[O()],Ap=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],kp=[O()],Op=[j(`disabled`,{waitUntilFirstUpdate:!0})],Dp=[j(`step`,{waitUntilFirstUpdate:!0})],Ep=[j(`value`,{waitUntilFirstUpdate:!0})],lm){constructor(){super(...arguments),m(G,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),g(this,`localize`,new ca(this)),_(this,um,m(G,8,this)),m(G,11,this),_(this,dm,m(G,12,this,!1)),m(G,15,this),_(this,fm,m(G,16,this,``)),m(G,19,this),g(this,`__numberInput`,Object.assign(document.createElement(`input`),{type:`number`})),g(this,`__dateInput`,Object.assign(document.createElement(`input`),{type:`date`})),_(this,pm,m(G,20,this,`text`)),m(G,23,this),_(this,mm,m(G,24,this,``)),m(G,27,this),_(this,hm,m(G,28,this,``)),m(G,31,this),g(this,`defaultValue`,m(G,140,this,``)),m(G,143,this),_(this,gm,m(G,32,this,`medium`)),m(G,35,this),_(this,_m,m(G,36,this,!1)),m(G,39,this),_(this,vm,m(G,40,this,!1)),m(G,43,this),_(this,ym,m(G,44,this,``)),m(G,47,this),_(this,bm,m(G,48,this,``)),m(G,51,this),_(this,xm,m(G,52,this,!1)),m(G,55,this),_(this,Sm,m(G,56,this,!1)),m(G,59,this),_(this,Cm,m(G,60,this,``)),m(G,63,this),_(this,wm,m(G,64,this,!1)),m(G,67,this),_(this,Tm,m(G,68,this,!1)),m(G,71,this),_(this,Em,m(G,72,this,!1)),m(G,75,this),_(this,Dm,m(G,76,this,!1)),m(G,79,this),_(this,Om,m(G,80,this,``)),m(G,83,this),_(this,km,m(G,84,this,!1)),m(G,87,this),_(this,Am,m(G,88,this)),m(G,91,this),_(this,jm,m(G,92,this)),m(G,95,this),_(this,Mm,m(G,96,this)),m(G,99,this),_(this,Nm,m(G,100,this)),m(G,103,this),_(this,Pm,m(G,104,this)),m(G,107,this),_(this,Fm,m(G,108,this)),m(G,111,this),_(this,Im,m(G,112,this)),m(G,115,this),_(this,Lm,m(G,116,this,!0)),m(G,119,this),_(this,Rm,m(G,120,this)),m(G,123,this),_(this,zm,m(G,124,this)),m(G,127,this),_(this,Bm,m(G,128,this)),m(G,131,this),_(this,Vm,m(G,132,this,!0)),m(G,135,this),_(this,Hm,m(G,136,this)),m(G,139,this)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`kk-clear`),this.emit(`kk-input`),this.emit(`kk-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.updateValidity(),this.emit(`kk-input`)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this._internals.form?.requestSubmit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.input.disabled=this.disabled,this.updateValidity()}handleStepChange(){this.input.step=String(this.step),this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){let e=this.input.validity.valid;this.toggleState(`--empty`,!this.value),this.validade.aplicar(e,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return w`
    ...
    `}};Gh=f(Wh),Kh=new WeakMap,qh=new WeakMap,Jh=new WeakMap,h(Gh,4,`codigo`,Uh,Yh,Kh),h(Gh,4,`selecao`,Hh,Yh,qh),h(Gh,4,`readonly`,Vh,Yh,Jh),p(Gh,Yh),g(Yh,`dependencies`,{"kk-button":z,"kk-dialog":Vu,"kk-dropdown":Ff,"kk-icon":Ls,"kk-input":K,"kk-menu":yp,"kk-menu-item":pp}),Yh.define(`kk-editor`),Ls.define(`kk-icon`),I.define(`kk-icon-button`),K.define(`kk-input`),yp.define(`kk-menu`),pp.define(`kk-menu-item`);var Xh=C`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,q,sg,cg,lg,ug,dg,fg,pg=class extends (og=M,ag=[A(`.option__label`)],ig=[k()],rg=[k()],ng=[k()],tg=[O({reflect:!0})],eg=[O({type:Boolean,reflect:!0})],$h=[j(`disabled`)],Qh=[j(`selected`)],Zh=[j(`value`)],og){constructor(){super(...arguments),m(q,5,this),g(this,`localize`,new ca(this)),g(this,`isInitialized`,!1),_(this,sg,m(q,8,this)),m(q,11,this),_(this,cg,m(q,12,this,!1)),m(q,15,this),_(this,lg,m(q,16,this,!1)),m(q,19,this),_(this,ug,m(q,20,this,!1)),m(q,23,this),_(this,dg,m(q,24,this,``)),m(q,27,this),_(this,fg,m(q,28,this,!1)),m(q,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`kk-select`).then(()=>{let e=this.closest(`kk-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return w`
    ...
    `}};q=f(og),sg=new WeakMap,cg=new WeakMap,lg=new WeakMap,ug=new WeakMap,dg=new WeakMap,fg=new WeakMap,h(q,4,`defaultSlot`,ag,pg,sg),h(q,4,`current`,ig,pg,cg),h(q,4,`selected`,rg,pg,lg),h(q,4,`hasHover`,ng,pg,ug),h(q,4,`value`,tg,pg,dg),h(q,4,`disabled`,eg,pg,fg),h(q,1,`handleDisabledChange`,$h,pg),h(q,1,`handleSelectedChange`,Qh,pg),h(q,1,`handleValueChange`,Zh,pg),p(q,pg),g(pg,`styles`,[D,Xh]),g(pg,`dependencies`,{"kk-icon":Ls}),pg.define(`kk-option`);var mg=C`
  :host {
    display: block;
  }
...
`,gg=class extends Co{constructor(e){if(super(e),this.it=T,e.type!==xo.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===T||e==null)return this._t=void 0,this.it=e;if(e===$a)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};gg.directiveName=`unsafeHTML`,gg.resultType=1;var _g=So(gg);function vg(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}function yg(e,t,n=`vertical`,r=`smooth`){let i=vg(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,s=t.scrollLeft,c=t.scrollLeft+t.offsetWidth,l=t.scrollTop,u=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<s?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>c&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<l?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>u&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}var bg=C`
  :host {
    display: inline-block;
  }
...
`,xg,Sg,Cg,wg,Tg,Eg,Dg,Og,kg,Ag,jg=class extends (Tg=M,wg=[O({reflect:!0})],Cg=[O({reflect:!0})],Sg=[O({type:Boolean,reflect:!0})],xg=[O({type:Boolean})],Tg){constructor(){super(...arguments),g(this,`localize`,new ca(this)),_(this,Dg,m(Eg,8,this,`neutral`)),m(Eg,11,this),_(this,Og,m(Eg,12,this,`medium`)),m(Eg,15,this),_(this,kg,m(Eg,16,this,!1)),m(Eg,19,this),_(this,Ag,m(Eg,20,this,!1)),m(Eg,23,this)}handleRemoveClick(){this.emit(`kk-remove`)}render(){return w`
      <span
        part="base"
    ...
    `}};Eg=f(Tg),Dg=new WeakMap,Og=new WeakMap,kg=new WeakMap,Ag=new WeakMap,h(Eg,4,`variant`,wg,jg,Dg),h(Eg,4,`size`,Cg,jg,Og),h(Eg,4,`pill`,Sg,jg,kg),h(Eg,4,`removable`,xg,jg,Ag),p(Eg,jg),g(jg,`styles`,[D,bg]),g(jg,`dependencies`,{"kk-icon-button":I});var Mg,Ng,Pg,Fg,Ig,Lg,Rg,zg,Bg,Vg,Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_,r_,i_,a_,o_,s_,c_,l_,J,u_,d_,f_,p_,m_,h_,g_,__,v_,y_,b_,x_,S_,C_,w_,T_,E_,D_,O_,k_,A_,j_,M_,N_,P_,F_,I_,Y=class extends (l_=M,c_=[A(`.select`)],s_=[A(`.select__combobox`)],o_=[A(`.select__display-input`)],a_=[A(`.select__value-input`)],i_=[A(`.select__listbox`)],r_=[k()],n_=[k()],t_=[k()],e_=[k()],$g=[k()],Qg=[O()],Zg=[k()],Xg=[O({attribute:`value`})],Yg=[O({reflect:!0})],Jg=[O()],qg=[O({type:Boolean,reflect:!0})],Kg=[O({attribute:`max-options-visible`,type:Number})],Gg=[O({type:Boolean,reflect:!0})],Wg=[O({type:Boolean})],Ug=[O({type:Boolean,reflect:!0})],Hg=[O({type:Boolean,reflect:!0})],Vg=[O({type:Boolean,reflect:!0})],Bg=[O()],zg=[O({reflect:!0})],Rg=[O({attribute:`help-text`})],Lg=[O({reflect:!0,converter:Zo})],Ig=[O({type:Boolean,reflect:!0})],Fg=[O()],Pg=[j(`disabled`,{waitUntilFirstUpdate:!0})],Ng=[j([`defaultValue`,`value`],{waitUntilFirstUpdate:!0})],Mg=[j(`open`,{waitUntilFirstUpdate:!0})],l_){constructor(){super(...arguments),m(J,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),g(this,`localize`,new ca(this)),g(this,`typeToSelectString`,``),g(this,`typeToSelectTimeout`),g(this,`closeWatcher`),_(this,u_,m(J,8,this)),m(J,11,this),_(this,d_,m(J,12,this)),m(J,15,this),_(this,f_,m(J,16,this)),m(J,19,this),_(this,p_,m(J,20,this)),m(J,23,this),_(this,m_,m(J,24,this)),m(J,27,this),_(this,h_,m(J,28,this,!1)),m(J,31,this),_(this,g_,m(J,32,this,``)),m(J,35,this),_(this,__,m(J,36,this)),m(J,39,this),_(this,v_,m(J,40,this,[])),m(J,43,this),_(this,y_,m(J,44,this,!1)),m(J,47,this),_(this,b_,m(J,48,this,``)),m(J,51,this),g(this,`_value`,``),_(this,x_,m(J,52,this,``)),m(J,55,this),_(this,S_,m(J,56,this,`medium`)),m(J,59,this),_(this,C_,m(J,60,this,``)),m(J,63,this),_(this,w_,m(J,64,this,!1)),m(J,67,this),_(this,T_,m(J,68,this,3)),m(J,71,this),_(this,E_,m(J,72,this,!1)),m(J,75,this),_(this,D_,m(J,76,this,!1)),m(J,79,this),_(this,O_,m(J,80,this,!1)),m(J,83,this),_(this,k_,m(J,84,this,!1)),m(J,87,this),_(this,A_,m(J,88,this,!1)),m(J,91,this),_(this,j_,m(J,92,this,``)),m(J,95,this),_(this,M_,m(J,96,this,`bottom`)),m(J,99,this),_(this,N_,m(J,100,this,``)),m(J,103,this),_(this,P_,m(J,104,this,``)),m(J,107,this),_(this,F_,m(J,108,this,!1)),m(J,111,this),_(this,I_,m(J,112,this,e=>w`
      <kk-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};J=f(l_),u_=new WeakMap,d_=new WeakMap,f_=new WeakMap,p_=new WeakMap,m_=new WeakMap,h_=new WeakMap,g_=new WeakMap,__=new WeakMap,v_=new WeakMap,y_=new WeakMap,b_=new WeakMap,x_=new WeakMap,S_=new WeakMap,C_=new WeakMap,w_=new WeakMap,T_=new WeakMap,E_=new WeakMap,D_=new WeakMap,O_=new WeakMap,k_=new WeakMap,A_=new WeakMap,j_=new WeakMap,M_=new WeakMap,N_=new WeakMap,P_=new WeakMap,F_=new WeakMap,I_=new WeakMap,h(J,4,`popup`,c_,Y,u_),h(J,4,`combobox`,s_,Y,d_),h(J,4,`displayInput`,o_,Y,f_),h(J,4,`valueInput`,a_,Y,p_),h(J,4,`listbox`,i_,Y,m_),h(J,4,`hasFocus`,r_,Y,h_),h(J,4,`displayLabel`,n_,Y,g_),h(J,4,`currentOption`,t_,Y,__),h(J,4,`selectedOptions`,e_,Y,v_),h(J,4,`valueHasChanged`,$g,Y,y_),h(J,4,`name`,Qg,Y,b_),h(J,3,`value`,Zg,Y),h(J,4,`defaultValue`,Xg,Y,x_),h(J,4,`size`,Yg,Y,S_),h(J,4,`placeholder`,Jg,Y,C_),h(J,4,`multiple`,qg,Y,w_),h(J,4,`maxOptionsVisible`,Kg,Y,T_),h(J,4,`disabled`,Gg,Y,E_),h(J,4,`clearable`,Wg,Y,D_),h(J,4,`open`,Ug,Y,O_),h(J,4,`filled`,Hg,Y,k_),h(J,4,`pill`,Vg,Y,A_),h(J,4,`label`,Bg,Y,j_),h(J,4,`placement`,zg,Y,M_),h(J,4,`helpText`,Rg,Y,N_),h(J,4,`form`,Lg,Y,P_),h(J,4,`required`,Ig,Y,F_),h(J,4,`getTag`,Fg,Y,I_),h(J,1,`handleDisabledChange`,Pg,Y),h(J,1,`handleValueChange`,Ng,Y),h(J,1,`handleOpenChange`,Mg,Y),p(J,Y),g(Y,`styles`,[D,Cp,hg]),g(Y,`dependencies`,{"kk-icon":Ls,"kk-popup":H,"kk-tag":jg}),g(Y,`formAssociated`,!0);function L_(e){let t=document;if(typeof t.startViewTransition!=`function`){e();return}t.startViewTransition(()=>e()).finished?.catch(()=>{})}var R_=`…`,z_,B_,V_,H_,U_,W_,G_,K_,q_,J_,Y_,X_,Z_,X,Q_,$_,ev,tv,nv,rv,iv,av,ov,sv,cv,lv,uv=class extends (Z_=M,X_=[O({type:Number,reflect:!0})],Y_=[O({type:Number,reflect:!0})],J_=[O({attribute:`total-items`,type:Number})],q_=[O({attribute:`page-size`,type:Number})],K_=[O({attribute:`page-size-options`,type:Array})],G_=[O({type:Number})],W_=[O({type:Number})],U_=[O({reflect:!0})],H_=[O({type:Boolean,reflect:!0})],V_=[O({attribute:`show-edges`,type:Boolean})],B_=[O({attribute:`show-page-size`,type:Boolean})],z_=[O({attribute:`show-info`,type:Boolean})],Z_){constructor(){super(...arguments),g(this,`localize`,new ca(this)),_(this,Q_,m(X,8,this,1)),m(X,11,this),_(this,$_,m(X,12,this,1)),m(X,15,this),_(this,ev,m(X,16,this)),m(X,19,this),_(this,tv,m(X,20,this,10)),m(X,23,this),_(this,nv,m(X,24,this,[10,25,50,100])),m(X,27,this),_(this,rv,m(X,28,this,1)),m(X,31,this),_(this,iv,m(X,32,this,1)),m(X,35,this),_(this,av,m(X,36,this,`medium`)),m(X,39,this),_(this,ov,m(X,40,this,!1)),m(X,43,this),_(this,sv,m(X,44,this,!1)),m(X,47,this),_(this,cv,m(X,48,this,!1)),m(X,51,this),_(this,lv,m(X,52,this,!1)),m(X,55,this)}get pages(){return this.totalItems===void 0?Math.max(1,this.total):Math.max(1,Math.ceil(this.totalItems/this.pageSize))}goTo(e){e===this.value||e<1||e>this.pages||L_(()=>{this.value=e,this.emit(`kk-change`,{detail:{page:this.value,pageSize:this.pageSize}})})}handlePageSizeChange(e){e.stopPropagation();let t=Number(e.target.value);if(!Number.isFinite(t)||t<=0)return;let n=(this.value-1)*this.pageSize;this.pageSize=t,this.value=Math.min(Math.floor(n/t)+1,this.pages),this.emit(`kk-change`,{detail:{page:this.value,pageSize:this.pageSize}})}janela(){let e=this.pages,t=Math.max(0,this.boundaries),n=Math.max(0,this.siblings),r=(e,t)=>t<e?[]:Array.from({length:t-e+1},(t,n)=>e+n);if(e<=t*2+n*2+3)return r(1,e);let i=Math.max(this.value-n,t+1),a=Math.min(this.value+n,e-t),o=i>t+2,s=a<e-t-1;return!o&&s?[...r(1,n*2+t+2),R_,...r(e-t+1,e)]:o&&!s?[...r(1,t),R_,...r(e-(t+1+n*2),e)]:[...r(1,t),R_,...r(i,a),R_,...r(e-t+1,e)]}renderInfo(){if(!this.showInfo||this.totalItems===void 0)return T;let e=this.totalItems===0?0:(this.value-1)*this.pageSize+1,t=Math.min(this.value*this.pageSize,this.totalItems);return w`
      ...
      >
        ...
        <div class="pagination__controls">
          ...
          <div part="pages" class="pagination__pages">
            ${this.janela().map(e=>e===R_?w`<span class="pagination__ellipsis" aria-hidden="true">${R_}</span>`:w`
                    <kk-button
                      part="page"
    ...
    `}};X=f(Z_),Q_=new WeakMap,$_=new WeakMap,ev=new WeakMap,tv=new WeakMap,nv=new WeakMap,rv=new WeakMap,iv=new WeakMap,av=new WeakMap,ov=new WeakMap,sv=new WeakMap,cv=new WeakMap,lv=new WeakMap,h(X,4,`value`,X_,uv,Q_),h(X,4,`total`,Y_,uv,$_),h(X,4,`totalItems`,J_,uv,ev),h(X,4,`pageSize`,q_,uv,tv),h(X,4,`pageSizeOptions`,K_,uv,nv),h(X,4,`siblings`,G_,uv,rv),h(X,4,`boundaries`,W_,uv,iv),h(X,4,`size`,U_,uv,av),h(X,4,`pill`,H_,uv,ov),h(X,4,`showEdges`,V_,uv,sv),h(X,4,`showPageSize`,B_,uv,cv),h(X,4,`showInfo`,z_,uv,lv),p(X,uv),g(uv,`styles`,[D,mg]),g(uv,`dependencies`,{"kk-button":z,"kk-icon-button":I,"kk-option":pg,"kk-select":Y}),uv.define(`kk-pagination`);var dv=C`
  :host {
...
`,fv=`important`,pv=` !`+fv,mv=So(class extends Co{constructor(e){if(super(e),e.type!==xo.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(pv);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?fv:``):n[e]=r}}return $a}}),hv,gv,_v,vv,yv,bv,xv,Sv,Cv=class extends (vv=M,_v=[O({type:Number,reflect:!0})],gv=[O({type:Boolean,reflect:!0})],hv=[O()],vv){constructor(){super(...arguments),g(this,`localize`,new ca(this)),_(this,bv,m(yv,8,this,0)),m(yv,11,this),_(this,xv,m(yv,12,this,!1)),m(yv,15,this),_(this,Sv,m(yv,16,this,``)),m(yv,19,this)}render(){return w`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${mv({width:`${this.value}%`})}>
          ${this.indeterminate?``:w` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};yv=f(vv),bv=new WeakMap,xv=new WeakMap,Sv=new WeakMap,h(yv,4,`value`,_v,Cv,bv),h(yv,4,`indeterminate`,gv,Cv,xv),h(yv,4,`label`,hv,Cv,Sv),p(yv,Cv),g(Cv,`styles`,[D,dv]),Cv.define(`kk-progress-bar`),Y.define(`kk-select`),Jc.define(`kk-spinner`);var wv=C`
  :host {
    display: inline-block;
  }
...
`,Tv,Ev,Dv,Ov,kv,Av,jv,Mv,Nv,Pv,Fv,Iv,Lv,Rv,zv,Z,Bv,Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv,Xv,Zv=class extends (zv=M,Rv=[A(`input[type="checkbox"]`)],Lv=[k()],Iv=[O()],Fv=[O()],Pv=[O()],Nv=[O({reflect:!0})],Mv=[O({type:Boolean,reflect:!0})],jv=[O({type:Boolean,reflect:!0})],Av=[Oo(`checked`)],kv=[O({reflect:!0,converter:Zo})],Ov=[O({type:Boolean,reflect:!0})],Dv=[O({attribute:`help-text`})],Ev=[j([`checked`,`value`],{waitUntilFirstUpdate:!0})],Tv=[j(`disabled`,{waitUntilFirstUpdate:!0})],zv){constructor(){super(...arguments),m(Z,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`)),_(this,Bv,m(Z,8,this)),m(Z,11,this),_(this,Vv,m(Z,12,this,!1)),m(Z,15,this),_(this,Hv,m(Z,16,this,``)),m(Z,19,this),_(this,Uv,m(Z,20,this,``)),m(Z,23,this),_(this,Wv,m(Z,24,this)),m(Z,27,this),_(this,Gv,m(Z,28,this,`medium`)),m(Z,31,this),_(this,Kv,m(Z,32,this,!1)),m(Z,35,this),_(this,qv,m(Z,36,this,!1)),m(Z,39,this),g(this,`defaultChecked`,m(Z,52,this,!1)),m(Z,55,this),_(this,Jv,m(Z,40,this,``)),m(Z,43,this),_(this,Yv,m(Z,44,this,!1)),m(Z,47,this),_(this,Xv,m(Z,48,this,``)),m(Z,51,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.checked=this.defaultChecked,this._internals.setFormValue(this.checked?this.value||`on`:null),this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.checked?this.value||`on`:null),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleInput(){this.emit(`kk-input`)}handleClick(){this.checked=!this.checked,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`kk-change`),this.emit(`kk-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`kk-change`),this.emit(`kk-input`))}handleStateChange(){this._internals.setFormValue(this.checked?this.value||`on`:null),this.input.checked=this.checked,this.updateValidity()}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return w`
      <div
    ...
    `}};Z=f(zv),Bv=new WeakMap,Vv=new WeakMap,Hv=new WeakMap,Uv=new WeakMap,Wv=new WeakMap,Gv=new WeakMap,Kv=new WeakMap,qv=new WeakMap,Jv=new WeakMap,Yv=new WeakMap,Xv=new WeakMap,h(Z,4,`input`,Rv,Zv,Bv),h(Z,4,`hasFocus`,Lv,Zv,Vv),h(Z,4,`title`,Iv,Zv,Hv),h(Z,4,`name`,Fv,Zv,Uv),h(Z,4,`value`,Pv,Zv,Wv),h(Z,4,`size`,Nv,Zv,Gv),h(Z,4,`disabled`,Mv,Zv,Kv),h(Z,4,`checked`,jv,Zv,qv),h(Z,4,`form`,kv,Zv,Jv),h(Z,4,`required`,Ov,Zv,Yv),h(Z,4,`helpText`,Dv,Zv,Xv),h(Z,1,`handleStateChange`,Ev,Zv),h(Z,1,`handleDisabledChange`,Tv,Zv),h(Z,5,`defaultChecked`,Av,Zv),p(Z,Zv),g(Zv,`styles`,[D,Cp,wv]),g(Zv,`formAssociated`,!0),Zv.define(`kk-switch`);var Qv=C`
  :host {
    display: block;
  }
...
`,$v,ey,ty,ny,ry,iy,ay,oy,sy,cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Q,Oy,ky,Ay,jy,My,Ny,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy,Zy,Qy,$=class extends (Dy=M,Ey=[A(`.textarea__control`)],Ty=[k()],wy=[O()],Cy=[O()],Sy=[O()],xy=[O({reflect:!0})],by=[O({type:Boolean,reflect:!0})],yy=[O()],vy=[O({attribute:`help-text`})],_y=[O()],gy=[O({type:Number})],hy=[O()],my=[O({type:Boolean,reflect:!0})],py=[O({type:Boolean,reflect:!0})],fy=[O({reflect:!0,converter:Zo})],dy=[O({type:Boolean,reflect:!0})],uy=[O({type:Number})],ly=[O({type:Number})],cy=[O()],sy=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],oy=[O()],ay=[O({type:Boolean})],iy=[O()],ry=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],ny=[O()],ty=[Oo()],ey=[j(`disabled`,{waitUntilFirstUpdate:!0})],$v=[j(`value`,{waitUntilFirstUpdate:!0})],Dy){constructor(){super(...arguments),m(Q,5,this),g(this,`validade`,new Tp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new fc(this,`help-text`,`label`)),_(this,Oy,m(Q,8,this)),m(Q,11,this),_(this,ky,m(Q,12,this,!1)),m(Q,15,this),_(this,Ay,m(Q,16,this,``)),m(Q,19,this),_(this,jy,m(Q,20,this,``)),m(Q,23,this),_(this,My,m(Q,24,this,``)),m(Q,27,this),_(this,Ny,m(Q,28,this,`medium`)),m(Q,31,this),_(this,Py,m(Q,32,this,!1)),m(Q,35,this),_(this,Fy,m(Q,36,this,``)),m(Q,39,this),_(this,Iy,m(Q,40,this,``)),m(Q,43,this),_(this,Ly,m(Q,44,this,``)),m(Q,47,this),_(this,Ry,m(Q,48,this,4)),m(Q,51,this),_(this,zy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,By,m(Q,56,this,!1)),m(Q,59,this),_(this,Vy,m(Q,60,this,!1)),m(Q,63,this),_(this,Hy,m(Q,64,this,``)),m(Q,67,this),_(this,Uy,m(Q,68,this,!1)),m(Q,71,this),_(this,Wy,m(Q,72,this)),m(Q,75,this),_(this,Gy,m(Q,76,this)),m(Q,79,this),_(this,Ky,m(Q,80,this)),m(Q,83,this),_(this,qy,m(Q,84,this,!0)),m(Q,87,this),_(this,Jy,m(Q,88,this)),m(Q,91,this),_(this,Yy,m(Q,92,this)),m(Q,95,this),_(this,Xy,m(Q,96,this)),m(Q,99,this),_(this,Zy,m(Q,100,this,!0)),m(Q,103,this),_(this,Qy,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this._internals.setFormValue(this.value),this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleDisabledChange(){this.input.disabled=this.disabled,this.updateValidity()}handleValueChange(){this._internals.setFormValue(this.value)}updated(e){super.updated(e),e.has(`value`)&&this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){this.toggleState(`--empty`,!this.value),this.validade.aplicar(this.input.validity.valid,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,wp(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
      <div
        part="form-control"
        class=${E({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            <textarea
              ...
              placeholder=${N(this.placeholder)}
              rows=${N(this.rows)}
              style=${mv({"--rows":String(this.rows)})}
              minlength=${N(this.minlength)}
              maxlength=${N(this.maxlength)}
              autocapitalize=${N(this.autocapitalize)}
              autocorrect=${this.autocorrect?`on`:`off`}
    ...
    `}};Q=f(Dy),Oy=new WeakMap,ky=new WeakMap,Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,Fy=new WeakMap,Iy=new WeakMap,Ly=new WeakMap,Ry=new WeakMap,zy=new WeakMap,By=new WeakMap,Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakMap,Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakMap,qy=new WeakMap,Jy=new WeakMap,Yy=new WeakMap,Xy=new WeakMap,Zy=new WeakMap,Qy=new WeakMap,h(Q,4,`input`,Ey,$,Oy),h(Q,4,`hasFocus`,Ty,$,ky),h(Q,4,`title`,wy,$,Ay),h(Q,4,`name`,Cy,$,jy),h(Q,4,`value`,Sy,$,My),h(Q,4,`size`,xy,$,Ny),h(Q,4,`filled`,by,$,Py),h(Q,4,`label`,yy,$,Fy),h(Q,4,`helpText`,vy,$,Iy),h(Q,4,`placeholder`,_y,$,Ly),h(Q,4,`rows`,gy,$,Ry),h(Q,4,`resize`,hy,$,zy),h(Q,4,`disabled`,my,$,By),h(Q,4,`readonly`,py,$,Vy),h(Q,4,`form`,fy,$,Hy),h(Q,4,`required`,dy,$,Uy),h(Q,4,`minlength`,uy,$,Wy),h(Q,4,`maxlength`,ly,$,Gy),h(Q,4,`autocapitalize`,cy,$,Ky),h(Q,4,`autocorrect`,sy,$,qy),h(Q,4,`autocomplete`,oy,$,Jy),h(Q,4,`autofocus`,ay,$,Yy),h(Q,4,`enterkeyhint`,iy,$,Xy),h(Q,4,`spellcheck`,ry,$,Zy),h(Q,4,`inputmode`,ny,$,Qy),h(Q,1,`handleDisabledChange`,ey,$),h(Q,1,`handleValueChange`,$v,$),h(Q,5,`defaultValue`,ty,$),p(Q,$),g($,`styles`,[D,Cp,Qv]),g($,`formAssociated`,!0),$.define(`kk-textarea`),te(`./ui`);var $y=document.querySelector(`#app`);function eb(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:Di({executar:()=>void lb(!0),ocupado:ob})};let t=Kt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Qr()};if(tb[t.id]===void 0||!Jt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Zr(t)};let n=ab.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:ei(n)};let r=nb.get(t.id);return r===void 0?(ib(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:$r()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var tb={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-BMt03jKZ.js`);return{telaAnotacoes:e}},__vite__mapDeps([23,5,3,4,24,25]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-BS0A74NC.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-DcgpBjHY.js`);return{telaCalendario:e}},__vite__mapDeps([26,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-r8119kDp.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,28,29,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-r8119kDp.js`);return{telaCriacao:e}},__vite__mapDeps([27,4,24,28,29,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-BMaREJ9t.js`);return{telaFaq:e}},__vite__mapDeps([30,4,31,32,24,28]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-Pilh0nZV.js`);return{telaImite:e}},__vite__mapDeps([33,24,28]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-CC1lPwUt.js`);return{telaCronologia:e}},__vite__mapDeps([34,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-BuSjzYGd.js`);return{telaEstudo:e}},__vite__mapDeps([35,12,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-BBLocWxy.js`);return{telaFinanceiro:e}},__vite__mapDeps([36,10,9,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-I1CbZiza.js`);return{telaGuias:e}},__vite__mapDeps([37,4,5,24,25,38,17]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-DaiDHCXK.js`);return{telaJogo:e}},__vite__mapDeps([39,24,11,4]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-CAVsfxRZ.js`);return{telaLeitura:e}},__vite__mapDeps([40,41]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-WOCRpMrY.js`);return{telaMetas:e}},__vite__mapDeps([42,8,9,10,4,5,11]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-wbzlti4o.js`);return{telaMinisterio:e}},__vite__mapDeps([43,24,38,13,4,5,14,15]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-DGEhYfjx.js`);return{telaPerfil:e}},__vite__mapDeps([44,38,14,15,4,22]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-2eAkBM_m.js`);return{telaPoesia:e}},__vite__mapDeps([45,4,5,32,24,25,38,17]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-BB4yKIvd.js`);return{telaPrep:e}},__vite__mapDeps([46,9,4,20,19,5,18]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-kCYbVM9L.js`);return{telaPrincipios:e}},__vite__mapDeps([47,4,31,32,24,28]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-CU2LpcPH.js`);return{telaReceitas:e}},__vite__mapDeps([48,5,32,24,25,38,17,16,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-B0oczkiD.js`);return{telaServico:e}},__vite__mapDeps([49,8,9,10,4,5,11]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-DcBf0_P-.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-ByCn8mY8.js`);return{telaTutorial:e}},__vite__mapDeps([50,4,24,51]),import.meta.url)).telaTutorial},nb=new Map,rb=new Set;function ib(e){let t=tb[e];t===void 0||nb.has(e)||rb.has(e)||(rb.add(e),t().then(t=>{nb.set(e,t),sb()}).catch(t=>{rb.delete(e),ab.set(e,String(t)),sb()}))}var ab=new Map,ob=!1;function sb(){if($y===null)return;let e=cb,{cabecalho:t,conteudo:n}=eb(e);document.title=e.modulo===`home`?u.displayName:`${t.titulo} — ${u.displayName}`,document.documentElement.dataset.modulo=e.modulo,wt(yr(t,n,sb),$y),hr()}var cb={modulo:`home`,args:[],query:new URLSearchParams};async function lb(e){if(!ob){ob=!0,sb();try{let t=await nr();if(!e)return;t.ok?Pi(x.home.sincronizado(t.atualizados.length)):Pi(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}catch(t){console.error(`Sincronização: não terminou.`,t),e&&Pi(x.home.sincronizacaoFalhou,`danger`)}finally{ob=!1,sb()}}}function ub(){$y!==null&&wt(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
    `,$y)}function db(e){$y!==null&&wt(v`
      <div class="aviso">
        <kk-icon class="aviso__icone" name="alert-triangle"></kk-icon>
        <h2>${x.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
        <kk-button variant="danger" outline @click=${()=>void Fi()}>
          <kk-icon slot="prefix" name="trash"></kk-icon>
          ${x.armazenamento.apagarTudo}
        </kk-button>
      </div>
    `,$y)}function fb(e){switch(e){case`instancia-dupla`:return x.armazenamento.memoriaInstanciaDupla;case`indisponivel`:return x.armazenamento.memoriaIndisponivel;default:return x.armazenamento.memoriaOrigemInsegura}}async function pb(){await Bt(Rt()),ub(),$t(sb);try{let e=await i();e.persistente||Pi(fb(e.motivo),`warning`)}catch(e){db(String(e));return}$y?.removeAttribute(`aria-busy`),addEventListener(`unhandledrejection`,e=>{e.preventDefault(),console.error(`Kobi Note: uma ação falhou.`,e.reason),Pi(x.app.acaoFalhou,`danger`)}),Zt(e=>{cb=e,sb(),scrollTo({top:0})}),sn(),lb(!1),Dn(),Hi(sb),Yi()}window.__note={repositorio:o,apagarDados:Fn,navegacao:{MODULOS:Ht,ATALHOS:Vt,HOME:Ut},imite:{carregarCartoes:Pr,lerLentes:Ir},caderno:{listarAnotacoes:Cr},badge:{atualizar:Tn},backup:{montar:Gn,ler:Yn,restaurar:Xn}},location.hash===``&&Xt(`home`),pb();export{vn as $,Jr as A,jr as B,Yr as C,_ as Ct,Ir as D,Lr as E,wr as F,Er as G,xr as H,br as I,Jn as J,or as K,Ar as L,Kr as M,Br as N,Wr as O,zr as P,yn as Q,Dr as R,Pr as S,g as St,Rr as T,kr as U,Cr as V,Mr as W,Xn as X,Yn as Y,_n as Z,ji as _,St as _t,O as a,dn as at,ni as b,m as bt,w as c,Xt as ct,Vi as d,x as dt,pn as et,Bi as f,Lt as ft,Ai as g,v as gt,ki as h,ct as ht,A as i,fn as it,qr as j,Ur as k,C as l,Ht as lt,Pi as m,y as mt,hh as n,Sn as nt,M as o,xn as ot,Fi as p,b as pt,Kn as q,j as r,mn as rt,D as s,en as st,mv as t,un as tt,Ji as u,Kt as ut,Oi as v,p as vt,Xr as w,u as wt,Vr as x,h as xt,ti as y,f as yt,Tr as z};