import{A as e,C as t,D as n,E as r,F as i,I as a,M as o,N as s,O as c,P as l,S as u,T as d,at as f,ct as p,ft as m,it as h,j as g,k as _,ut as v,w as y,x as b}from"./index-DtxwN5g2.js";import{t as x}from"./unsafe-html-e5X31ccZ.js";import{t as S}from"./rascunho-CTD2iMeK.js";var C=[],w=g(),T=new Map,E=!1,D=!1,O=null,k=-1,A=null,j=!1,M=!1,N=``,P=``,F=S({origem:`imite`,idDe:e=>e.id,chaveDe:e=>o(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${p.imite.titulo} — ${e.titulo}`,lembrete:()=>T});function I(){E||D||O!==null||(D=!0,(async()=>{try{[C,T]=await Promise.all([y(),d()]),w=e(),E=!0}catch(e){console.error(`imite: a carga falhou.`,e),O=u(e)}finally{D=!1,h()}})())}function L(){O=null,I(),h()}function R(e){return C.find(t=>t.id===e)}function z(e){k!==e.id&&(k=e.id??-1,A=null,j=!1,M=!1,N=``,P=``,F.abrir(e.id===void 0?``:T.get(e.id)??``))}function B(e){j||A===null||(n(e,A)?(j=!0,P=`ok`,N=i(e,A)||p.imite.acerto,V(e)):(P=`erro`,N=i(e,A)||p.imite.erro),h())}function V(e){M||e.id===void 0||(w=l(w,e.id),M=!0)}function H(e){return r(w,T,e)}function U(e){return m`
