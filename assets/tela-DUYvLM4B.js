import{r as e}from"./numero-B0JnuQJ5.js";import{s as t}from"./banco-WSl22mr6.js";import{K as n,Y as r,_ as i,ct as a,et as o,g as s,it as c,m as l,ot as u,v as ee,y as te}from"./index-CFqbq_HS.js";import{CATEGORIAS as d,CATEGORIA_PADRAO as f,EMOJIS_DE_KIT as ne,caloriasDoItem as re,categoria as ie}from"./dados-BgDpV8rv.js";import{FAIXAS as ae,NIVEIS as oe,alertas as se,calcularAutonomia as ce,calcularLogistica as le,carregarEstoque as ue,diasParaVencer as de,excluirItem as fe,lerPerfil as pe,obterItem as me,porCategoria as he,rotuloDaFaixa as ge,rotuloDoNivel as _e,salvarItem as ve,salvarPerfil as ye,statusDeValidade as be,visiveis as xe}from"./estoque-CiELC02y.js";import{alternarItem as Se,carregarKits as Ce,excluirKit as we,itemMarcado as Te,kitCompleto as Ee,lerProgresso as De,marcadosDoKit as Oe,obterKit as ke,percentualDoKit as Ae,salvarKit as je}from"./kits-Lv_QqCxf.js";var p=`note_passkey`,Me=32;function m(e){let t=String.fromCharCode(...new Uint8Array(e));return btoa(t).replaceAll(`+`,`-`).replaceAll(`/`,`_`).replace(/=+$/,``)}function h(e){let t=atob(e.replaceAll(`-`,`+`).replaceAll(`_`,`/`));return Uint8Array.from(t,e=>e.charCodeAt(0))}function g(){let e=localStorage.getItem(p);if(e===null)return null;try{let t=JSON.parse(e);return typeof t.id==`string`&&typeof t.sal==`string`?{id:t.id,sal:t.sal}:null}catch{return null}}function Ne(){return g()!==null}function Pe(){return isSecureContext&&typeof PublicKeyCredential<`u`}var _=class extends Error{},v=class extends Error{};function y(){return location.hostname}var Fe=new TextEncoder().encode(`kobi-note`);async function Ie(){let e=crypto.getRandomValues(new Uint8Array(Me)),t;try{t=await navigator.credentials.create({publicKey:{rp:{name:`Kobi Note`,id:y()},user:{id:Fe,name:`kobi-note`,displayName:`Kobi Note`},challenge:crypto.getRandomValues(new Uint8Array(32)),pubKeyCredParams:[{type:`public-key`,alg:-7},{type:`public-key`,alg:-257}],authenticatorSelection:{residentKey:`required`,userVerification:`required`},extensions:{prf:{}}}})}catch{throw new _}if(!(t instanceof PublicKeyCredential))throw new _;if(t.getClientExtensionResults().prf?.enabled!==!0)throw new v;let n={id:m(t.rawId),sal:m(e)},r=await b(n);return localStorage.setItem(p,JSON.stringify(n)),r}async function b(e){let t;try{t=await navigator.credentials.get({publicKey:{rpId:y(),challenge:crypto.getRandomValues(new Uint8Array(32)),allowCredentials:[{type:`public-key`,id:h(e.id)}],userVerification:`required`,extensions:{prf:{eval:{first:h(e.sal)}}}}})}catch{throw new _}if(!(t instanceof PublicKeyCredential))throw new _;let n=t.getClientExtensionResults().prf?.results?.first;if(n===void 0)throw new v;let r=new Uint8Array(n.byteLength);return r.set(n instanceof ArrayBuffer?new Uint8Array(n):new Uint8Array(n.buffer,n.byteOffset,n.byteLength)),r}async function Le(){let e=g();if(e===null)throw new _;return b(e)}var x=16,Re=12,ze=new TextEncoder().encode(`kobi-note-cofre`),S=()=>t(`documentos_cofre`);async function C(e,t){let n=await crypto.subtle.importKey(`raw`,e,`HKDF`,!1,[`deriveKey`]);return crypto.subtle.deriveKey({name:`HKDF`,hash:`SHA-256`,salt:t,info:ze},n,{name:`AES-GCM`,length:256},!1,[`encrypt`,`decrypt`])}async function Be(e,t){let n=crypto.getRandomValues(new Uint8Array(x)),r=crypto.getRandomValues(new Uint8Array(Re)),i=await C(e,n),a=await crypto.subtle.encrypt({name:`AES-GCM`,iv:r},i,t),o=new Uint8Array(28+a.byteLength);return o.set(n,0),o.set(r,x),o.set(new Uint8Array(a),28),o}async function Ve(e,t){let n=t.slice(0,x),r=t.slice(x,28),i=t.slice(28),a=await C(e,n);return crypto.subtle.decrypt({name:`AES-GCM`,iv:r},a,i)}function w(){return S().todos()}async function He(e,t,n){await S().salvar({rotulo:n,tipo_mime:t.type===``?`application/octet-stream`:t.type,blob_criptografado:await Be(e,await t.arrayBuffer()),data_criacao:Date.now()})}function Ue(e,t){return S().salvar({...e,rotulo:t})}function We(e){return S().excluir(e)}async function Ge(e,t){let n=await Ve(e,t.blob_criptografado);return URL.createObjectURL(new Blob([n],{type:t.tipo_mime}))}var T=[],E={},D=[],O=pe(),k=new Set,A=new Set,j=!1,M=``,N=null,P=null,F=null,I=[],L=``,R=!1,z=null,B=!1,V=!1,H=null;async function U(){[T,D]=await Promise.all([Ce(),ue()]),E=De(),o()}function W(){B||V||H!==null||(V=!0,qe(),(async()=>{try{await U(),B=!0}catch(e){console.error(`prep: a carga falhou.`,e),H=te(e)}finally{V=!1,o()}})())}function Ke(){H=null,W(),o()}function G(e){let t=e.args[0];return t===`estoque`||t===`cofre`?t:`kits`}function K(){F=null,I=[],L=``,q()}function q(){z!==null&&URL.revokeObjectURL(z.url),z=null}var J=!1;function qe(){J||(J=!0,addEventListener(`hashchange`,()=>{let e=location.hash.replace(/^#\/?/,``).split(`/`);(e[0]!==`prep`||e[1]!==`cofre`)&&K()}))}function Je(e,t){let r=Te(E,e,t.id),i=[t.quantidade,t.observacoes,t.data_vencimento===0?``:c.prep.vence(n(t.data_vencimento))].filter(e=>e!==``).join(` · `);return a`
  ...
  `}function Ye(){return T.length===0?a`
      <div class="vazio">
    ...
    `:a`
    <div class="grupos">
      ${T.map(e=>{let t=String(e.id),n=k.has(t),r=Ee(E,e);return a`
          <div class="grupo" ?data-completo=${r}>
            <button
              type="button"
              class="grupo__alvo"
              aria-expanded=${n}
              @click=${()=>{let e=new Set(k);e.delete(t)||e.add(t),k=e,o()}}
            >
  ...
  `}async function et(e){await s({titulo:c.prep.removerItem,texto:c.prep.removerItemTexto,rotuloConfirmar:c.acoes.excluir,variante:`danger`})&&N!==null&&(N={...N,itens:N.itens.filter((t,n)=>n!==e)},o())}async function tt(){let e=N;if(e===null)return;let t=e.itens.some(e=>e.descricao.trim()!==``);if(e.nome.trim()===``&&!t){N=null,o();return}await je(e),N=null,l(c.prep.kitSalvo),await U()}function nt(){return{id:0,item:``,categoria:f,quantidade:1,peso:0,kcal:0,vencimento:``}}async function rt(){let e=P;e!==null&&(await ve({...e.id>0?{id:e.id}:{},item:e.item.trim(),categoria:e.categoria===``?f:e.categoria,quantidade:Number(e.quantidade),peso_unitario:Number(e.peso),calorias_por_100g:Number(e.kcal),data_vencimento:e.vencimento===``?0:it(e.vencimento)}),P=null,l(c.prep.itemSalvo),await U())}function it(e){let[t=1970,n=1,r=1]=e.split(`-`).map(Number);return new Date(t,n-1,r).getTime()}function X(e){let t=t=>{P={...P??e,...t}};return a`
    <div class="formulario formulario--cartao">
      <h2 class="formulario__titulo">
  ...
  `}function at(t){let n=e=>{O={...O,...e,pessoas:Math.max(1,e.pessoas??O.pessoas)},ye(O),o()},r=le(D,O);return a`
    <div class="tally">
      ...
      <div class="formulario__par">
        ...
        >
          ${ae.map(e=>a`<kk-option value=${e}>${ge(e)}</kk-option>`)}
        </kk-select>
        ...
        >
          ${oe.map(e=>a`<kk-option value=${e}>${_e(e)}</kk-option>`)}
        </kk-select>
      </div>
      ...
      <p class="discreto">
        ${c.prep.metaAutonomia(t.metaPercentual)} ·
        ${c.prep.necessidadeDiaria(e(t.doGrupo))}
      </p>
  ...
  `}function Z(e){let t=de(e);return t===null?u:t<0?a`<kk-badge variant="danger" pill>${c.prep.vencidoHa(Math.abs(t))}</kk-badge>`:t===0?a`<kk-badge variant="danger" pill>${c.prep.venceHoje}</kk-badge>`:t<7?a`<kk-badge variant="warning" pill>${c.prep.venceEm(t)}</kk-badge>`:u}function ot(t){let r=ie(t.categoria),i=re(t);return a`
    <div class="registro" data-status=${be(t)}>
      ...
      <button class="registro__alvo" @click=${()=>void Q(t)}>
        ...
        <span class="registro__resumo">
          ${c.prep.resumoDoItem(t.quantidade,e(t.peso_unitario))}
          ${i===null?``:`· ${e(i)} kcal`}
        </span>
        ${t.data_vencimento===0?u:a`<span class="registro__resumo">${c.prep.vence(n(t.data_vencimento))}</span>`}
      </button>
  ...
  `}async function Q(e){if(e.id===void 0)return;let t=await me(e.id)??e;P={id:t.id??0,item:t.item,categoria:t.categoria,quantidade:t.quantidade,peso:t.peso_unitario,kcal:t.calorias_por_100g,vencimento:t.data_vencimento===0?``:r(t.data_vencimento)},o()}async function st(e){await s({titulo:c.prep.excluirItem,texto:c.acervo.excluirTexto,rotuloConfirmar:c.acoes.excluir,variante:`danger`})&&e.id!==void 0&&(await fe(e.id),l(c.prep.itemExcluido),await U())}function ct(){if(P!==null)return X(P);let e=ce(D,O),t=se(D),n=he(xe(D,M));return a`
    ...
    ${n.length===0?a`
          <div class="vazio">
            ...
            <p>${D.length===0?c.prep.semEstoque:c.prep.semEstoqueFiltro}</p>
          </div>
        `:a`
          <div class="grupos">
            ${n.map(e=>{let t=A.has(e.nome);return a`
                <div class="grupo">
                  <button
                    class="grupo__alvo"
                    aria-expanded=${t}
                    @click=${()=>{let t=new Set(A);t.delete(e.nome)||t.add(e.nome),A=t,o()}}
                  >
        ...
        `}
  `}function lt(e){return e instanceof v?c.prep.semPrf:(e instanceof _,c.prep.gestoRecusado)}async function $(e){if(!R){R=!0,L=``,o();try{await e()}catch(e){L=lt(e)}finally{R=!1,o()}}}function ut(){return $(async()=>{F=await Ie(),I=await w()})}function dt(){return $(async()=>{F=await Le(),I=await w()})}async function ft(e){let t=e.files?.[0];if(t===void 0||F===null)return;let n=await i({titulo:c.prep.nomeDoDocumento,valor:t.name,placeholder:c.prep.nomeDoDocumento,rotuloConfirmar:c.acoes.salvar,erroVazio:c.prep.informeNome});e.value=``,n!==null&&(await He(F,t,n),I=await w(),l(c.prep.documentoGuardado),o())}function pt(){let e=L===``?u:a`<p class="erro">${L}</p>`;return F===null&&!Ne()?a`
      <div class="formulario formulario--cartao">
        <h2 class="formulario__titulo">${c.prep.configurarBiometria}</h2>
        <p class="discreto">${c.prep.biometriaAjuda}</p>
        ${Pe()?a`
              ${e}
              <kk-button variant="primary" ?loading=${R} @click=${()=>void ut()}>
                <kk-icon slot="prefix" name="fingerprint"></kk-icon>${c.prep.criarCofre}
              </kk-button>
            `:a`<p class="erro">${c.prep.semBiometria}</p>`}
      </div>
    `:F===null?a`
      <div class="formulario formulario--cartao">
        ...
        <kk-button
          ...
          @click=${()=>void dt()}
        >
          <kk-icon slot="prefix" name="fingerprint"></kk-icon>${c.prep.destrancarComBiometria}
        </kk-button>
      </div>
    `:a`
    ...
    ${z===null?u:a`
        ...
        `}
  `}async function mt(e){if(F!==null)try{q(),z={rotulo:e.rotulo,url:await Ge(F,e),tipo:e.tipo_mime},o()}catch{l(c.prep.falhaAoDecifrar,`warning`)}}async function ht(e){let t=await i({titulo:c.prep.renomearDocumento,valor:e.rotulo,placeholder:c.prep.nomeDoDocumento,rotuloConfirmar:c.acoes.renomear,erroVazio:c.prep.informeNome});t!==null&&t!==e.rotulo&&(await Ue(e,t),I=await w(),o())}async function gt(e){await s({titulo:c.prep.excluirDocumento,texto:c.prep.excluirDocumentoTexto,rotuloConfirmar:c.acoes.excluir,variante:`danger`})&&e.id!==void 0&&(await We(e.id),I=await w(),l(c.prep.documentoExcluido),o())}var _t={kits:c.prep.kits,estoque:c.prep.estoque,cofre:c.prep.cofre},vt={voltarPara(){return`home`},aoVoltar(e){let t=G(e);return t===`estoque`&&P!==null?(P=null,o(),!0):t===`kits`&&N!==null&&(N=null,o(),!0)},titulo(e){return _t[G(e)]},acoes(e){let t=G(e);if(t===`kits`&&N===null)return a`
        <kk-icon-button
          name="plus"
          label=${c.prep.novoKit}
          @click=${()=>{N=Ze(),o()}}
        ></kk-icon-button>
      `;if(t===`estoque`&&P===null)return a`
        <kk-icon-button
          name="plus"
          label=${c.prep.novoItem}
          @click=${()=>{P=nt(),o()}}
        ></kk-icon-button>
      `},conteudo(e){if(W(),H!==null)return ee(H,Ke);let t=G(e);return t!==`estoque`&&(P=null),t!==`kits`&&(N=null),B?t===`estoque`?ct():t===`cofre`?pt():N===null?Ye():$e(N):a`<div class="carregando"><kk-spinner></kk-spinner></div>`}};export{vt as telaPrep};