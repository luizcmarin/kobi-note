...
--
-- Irmão de forma de \`not_principios\`: acervo de CONSULTA, uma pergunta por linha,
-- com a resposta da organização e o artigo do jw.org que a trata. O que o separa
-- é \`pontos\` — os apoios já mastigados para quem vai explicar a resposta a
-- alguém.
CREATE TABLE IF NOT EXISTS not_faq (
  id               INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
  titulo           TEXT    NOT NULL DEFAULT '',                 -- a pergunta, com o texto exato da página do jw.org
  ...
  ordem            INTEGER NOT NULL DEFAULT 0,
  resposta_curta   TEXT    NOT NULL DEFAULT '',                 -- a resposta em 1–2 frases, em texto puro — o resumo da lista e do topo
  resposta         TEXT    NOT NULL DEFAULT '',                 -- a resposta completa, em HTML do editor do admin
  pontos           TEXT    NOT NULL DEFAULT '[]',               -- JSON: \`PontoDaResposta[]\`
  referencia       TEXT    NOT NULL DEFAULT '',                 -- os textos bíblicos que sustentam a resposta
  link_jw          TEXT    NOT NULL DEFAULT '',                 -- a URL do artigo no jw.org — aqui sempre há um
  publicar         INTEGER NOT NULL DEFAULT 0,                  -- booleano 0 | 1
  data_criacao     INTEGER NOT NULL DEFAULT 0,                  -- epoch em milissegundos
  data_atualizacao INTEGER NOT NULL DEFAULT 0                   -- epoch em milissegundos
) STRICT;
