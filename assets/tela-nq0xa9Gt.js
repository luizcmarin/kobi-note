import{K as e,Y as t,Z as n,ct as r,et as i,g as a,it as o,m as s,ot as c,tt as l,v as ee,y as te}from"./index-BGY_4f1A.js";import{t as u}from"./compartilhar-BoSMErxz.js";import{DIAS_DA_SEMANA as ne,MESES as d,TIPOS_PUBLICADOR as f,ajustado as re,alternarEnviado as p,carregar as m,comoHorario as h,contadorTemAtividade as g,contadorZerado as _,corDoEstudo as ie,deHorario as ae,esfriando as oe,estudosVisiveis as v,excluirEstudo as y,excluirRegistro as b,excluirRelatorio as x,horasDoContador as S,iniciais as C,lembreteDoRelatorio as w,mesEAno as T,observacoesDoContador as E,ordenarRelatorios as se,registrosDoEstudo as D,relataHoras as O,salvarContador as k,salvarEstudo as ce,salvarRegistro as le,salvarRelatorio as A,textoDoEstudo as ue,textoDoRelatorio as de,ultimoRelativo as fe,ultimoRelatorio as j}from"./dados-CimAVZ7K.js";var M=[],N=[],P=[],F=null,I=``,L=null,R=null,z=null,B=!1,V=!1,H=null;async function U(){let e=await m();M=e.relatorios,N=e.estudos,P=e.registros,F=e.contador,i()}function W(){B||V||H!==null||(V=!0,(async()=>{try{await U(),B=!0}catch(e){console.error(`ministerio: a carga falhou.`,e),H=te(e)}finally{V=!1,i()}})())}function pe(){H=null,W(),i()}function G(e,t,n,i){return r`
