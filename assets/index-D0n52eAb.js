...
\f\r]`,et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tt=/-->/g,nt=/>/g,rt=RegExp(`>|${$e}(?:([^\\s"'>=/]+)(${$e}*=${$e}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),it=/'/g,at=/"/g,ot=/^(?:script|style|textarea|title)$/i,v=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),st=Symbol.for(`lit-noChange`),y=Symbol.for(`lit-nothing`),ct=new WeakMap,lt=Je.createTreeWalker(Je,129);function ut(e,t){if(!Ze(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return Ue===void 0?t:Ue.createHTML(t)}var dt=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=et;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===et?c[1]===`!--`?o=tt:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=rt):(ot.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=rt):o=nt:o===rt?c[0]===`>`?(o=i??et,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?rt:c[3]===`"`?at:it):o===at||o===it?o=rt:o===tt||o===nt?o=et:(o=rt,i=void 0);let d=o===rt&&e[t+1].startsWith(`/>`)?` `:``;a+=o===et?n+qe:l>=0?(r.push(s),n.slice(0,l)+We+n.slice(l)+Ge+d):n+Ge+(l===-2?t:d)}return[ut(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},ft=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=dt(t,n);if(this.el=e.createElement(l,r),lt.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=lt.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(We)){let t=u[o++],n=i.getAttribute(e).split(Ge),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?_t:r[1]===`?`?vt:r[1]===`@`?yt:gt}),i.removeAttribute(e)}else e.startsWith(Ge)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(ot.test(i.tagName)){let e=i.textContent.split(Ge),t=e.length-1;if(t>0){i.textContent=He?He.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],Ye()),lt.nextNode(),c.push({type:2,index:++a});i.append(e[t],Ye())}}}else if(i.nodeType===8){if(i.data===Ke)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(Ge,e+1))!==-1;)c.push({type:7,index:a}),e+=Ge.length-1}}a++}}static createElement(e,t){let n=Je.createElement(`template`);return n.innerHTML=e,n}};function pt(e,t,n=e,r){if(t===st)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=Xe(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=pt(e,i._$AS(e,t.values),i,r)),t}var mt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??Je).importNode(t,!0);lt.currentNode=r;let i=lt.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new ht(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new bt(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=lt.nextNode(),a++)}return lt.currentNode=Je,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},ht=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=pt(this,e,t),Xe(e)?e===y||e==null||e===``?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==st&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Qe(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&Xe(this._$AH)?this._$AA.nextSibling.data=e:this.T(Je.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=ft.createElement(ut(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new mt(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=ct.get(e.strings);return t===void 0&&ct.set(e.strings,t=new ft(e)),t}k(t){Ze(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(Ye()),this.O(Ye()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=Ve(e).nextSibling;Ve(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},gt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=pt(this,e,t,0),a=!Xe(e)||e!==this._$AH&&e!==st,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=pt(this,r[n+o],t,o),s===st&&(s=this._$AH[o]),a||=!Xe(s)||s!==this._$AH[o],s===y?e=y:e!==y&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},_t=class extends gt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},vt=class extends gt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},yt=class extends gt{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=pt(this,e,t,0)??y)===st)return;let n=this._$AH,r=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==y&&(n===y||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},bt=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){pt(this,e)}},xt={M:We,P:Ge,A:Ke,C:1,L:dt,R:mt,D:Qe,V:pt,I:ht,H:gt,N:vt,U:yt,B:_t,F:bt},St=Be.litHtmlPolyfillSupport;St?.(ft,ht),(Be.litHtmlVersions??=[]).push(`3.3.3`);var Ct=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new ht(t.insertBefore(Ye(),e),e,void 0,n??{})}return i._$AI(e),i},wt=globalThis,Tt=class extends ze{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ct(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return st}};Tt._$litElement$=!0,Tt.finalized=!0,wt.litElementHydrateSupport?.({LitElement:Tt});var Et=wt.litElementPolyfillSupport;Et?.({LitElement:Tt}),(wt.litElementVersions??=[]).push(`4.2.2`);var Dt=`Sua mente fora da nuvem. Estudo pessoal, criatividade, finanças e preparo tático reunidos em um espaço sob seu domínio absoluto com zero distrações.`,Ot={app:{nome:`Kobi Note`,carregando:`Carregando...`},home:{saudacao:`Kobi Note`,sub:Dt,modulos:`Módulos`,sincronizar:`Sincronizar conteúdo`,sincronizando:`Sincronizando...`,sincronizado:e=>e===0?`Nenhuma novidade para hoje.`:`Conteúdo atualizado (${e} módulo(s)).`,semRede:`Sem conexão — o app continua funcionando com o que já está no aparelho.`,semManifesto:`O servidor de conteúdo não respondeu com um manifesto válido.`},modulos:{anotacoes:`Anotações`,guias:`Guias`,poesia:`Poesias`,receitas:`Receitas`,jogo:`A Língua Pura`,criacao:`Teve um Projeto?`,entenda:`Entenda Melhor`,imite:`Imite a Sua Fé`,principios:`Faça Suas Contas...`,faq:`Respostas Frequentes`,cronologia:`Cronologia`,caderno:`Caderno de Estudo`,prep:`Esteja Preparado`,financeiro:`Financeiro`,metas:`Metas`,ministerio:`Vida e Ministério`,servico:`Quero Fazer Mais`,estudo:`Meu Estudo Pessoal`,leitura:`Leitura da Bíblia`,calendario:`Calendário`,perfil:`Perfil / ICE`,tutorial:`Tutorial`,sobre:`Sobre`},secoes:{estudo:`Estudo Pessoal`,prep:`Esteja Preparado`,extras:`Extras`,pessoal:`Pessoal`,aplicativo:`O Aplicativo`},painel:{semEventos:`Nada marcado para hoje.`,diaInteiro:`Dia inteiro`,anotacoes:t=>e(t,{one:`1 anotação`,other:`${t} anotações`}),eventosHoje:t=>e(t,{one:`1 evento hoje`,other:`${t} eventos hoje`}),contasVencendo:t=>e(t,{one:`1 conta a vencer`,other:`${t} contas a vencer`}),leitura:e=>`${e}% da Bíblia`,metas:t=>e(t,{one:`1 meta em andamento`,other:`${t} metas em andamento`}),horas:t=>e(t,{one:`1 hora este mês`,other:`${t} horas este mês`}),foco:e=>`${Math.round(e/60)} h de foco no mês`,favoritas:t=>e(t,{one:`1 favorita`,other:`${t} favoritas`}),rotuloContas:`Contas a vencer`,rotuloFoco:`Estudo focado`,rotuloMetas:`Metas`,emHoras:e=>`${Math.round(e/60*10)/10} h`},convite:{titulo:`Compartilhar o Kobi Note`,tile:`Compartilhar`,tileResumo:`Convide alguém`,lema:`Compartilhe o Kobi Note com seus amigos!`,mascote:`Kobi, o mascote do Kobi Note`,mensagem:`Oi! Descobri o Kobi Note para organizar meu estudo pessoal, leitura da Bíblia, anotações, finanças e preparo tático — tudo fica no meu próprio aparelho, sem conta e sem nuvem, e funciona sem internet. Acho que você vai gostar:`,qrAlt:`QR com o endereço do Kobi Note`,dica:`Aponte a câmera para o código, ou use um dos botões abaixo.`,whatsapp:`WhatsApp`,compartilhar:`Compartilhar`,copiar:`Copiar`,copiado:`Convite copiado. É só colar onde quiser.`},rodape:{termos:`Termos de uso`,privacidade:`Privacidade`,direitos:e=>`© ${e} Luiz Marin`,feitoPara:`Feito com ❤️ para você.`},boasVindas:{titulo:`Boas-vindas`,reabrir:`Rever as boas-vindas`,mascote:`Kobi, o mascote do Kobi Note, dando boas-vindas`,pular:`Pular`,voltar:`Voltar`,proximo:`Próximo`,comecar:`Começar a usar`,passo:(e,t)=>`Passo ${e} de ${t}`,passos:{bemVindo:{titulo:`Bem-vindo ao Kobi Note`,texto:Dt,dica:`Leva um minuto para conhecer o básico.`},painel:{titulo:`A tela inicial é o seu painel`,texto:`Cada cartão abre uma área do app e mostra um resumo do que está acontecendo nela. A tela é dividida em seções intuitivas — Estudo Pessoal, Esteja Preparado, Extras e Pessoal.`,dica:`O botão ← sempre traz você de volta.`},offline:{titulo:`Funciona sem internet`,texto:`O Kobi Note guarda tudo no próprio aparelho. Você pode usar no ônibus, no campo ou em qualquer lugar sem sinal.`,dica:`Conteúdo novo é baixado quando houver internet.`},privado:{titulo:`Seus dados são só seus`,texto:`Não há nuvem, conta nem rastreador. Tudo fica apenas no seu aparelho inclusive o conteúdo do cofre.`,dica:`Ninguém — nem nós — consegue ver o que você faz aqui.`},instalar:{titulo:`Instale na tela inicial`,texto:`Pelo menu do navegador, escolha “Instalar aplicativo” ou “Adicionar à tela inicial”. O Kobi Note será instalado como um aplicativo, oferecendo uma experiência imersiva e nativa.`,dica:`Quer saber mais? Leia o Tutorial.`,botao:`Instalar agora`}}},instalacao:{instalar:`Instalar na tela inicial`},sobre:{titulo:`Sobre`,versao:e=>`Versão ${e}`,lema:Dt,seloOffline:`100% offline`,seloPrivado:`Privado`,seloSemRastreio:`Sem rastreadores`,seloInstalavel:`Instalável`,tudoNumLugar:`Tudo em um só lugar`,recEstudo:`Estudo e leitura`,recEstudoTexto:`Estudo pessoal, leitura da Bíblia, cronologia e caderno de estudo`,recJogo:`Aprender brincando`,recJogoTexto:`Língua Pura, Entenda Melhor, Imite a Sua Fé e "Teve um Projeto?"`,recCriar:`Criatividade`,recCriarTexto:`Poesia, receitas e anotações`,recFinancas:`Finanças e metas`,recFinancasTexto:`Orçamento, objetivos e calendário`,recPreparo:`Esteja Preparado`,recPreparoTexto:`Kits, estoque, cofre protegido e guias de sobrevivência`,recMinisterio:`Ministério e você`,recMinisterioTexto:`Seu ministério, estudos, relatórios, perfil e ICE`,privacidadeTitulo:`Seus dados são só seus`,privacidadeTexto:`Espaço para pensar, silêncio para criar. Apenas você e Kobi Note.`,documentos:`Documentos`,vejaTambem:`Veja também`,contato:`Contato:`,email:`kobinote.app@gmail.com`},emBreve:{titulo:`Em breve`,texto:e=>`O módulo “${e}” ainda não foi liberado para esta versão do Kobi Note.`,ajuda:`Ele ainda está em desenvolvimento... espere mais um pouquinho.`,voltar:`Voltar ao início`},erro:{banco:`Não foi possível abrir o banco local`,naoEncontrado:`Não encontramos esta tela`,naoEncontradoTexto:`O endereço não corresponde a nenhum módulo do Kobi Note.`,telaNaoVeio:`Não foi possível abrir este módulo`,telaNaoVeioTexto:`A tela é baixada na primeira vez que você entra nela, e desta vez ela não chegou. Verifique a conexão e tente de novo; se o app foi atualizado agora há pouco, recarregar a página resolve.`,telaNaoVeioRecarregar:`Recarregar`,cargaFalhou:`Este módulo não abriu`,cargaFalhouTexto:`Alguma coisa deu errado ao ler os dados deste módulo. O que já estava salvo continua no aparelho — nada foi perdido.`,cargaTentarDeNovo:`Tentar de novo`},armazenamento:{memoriaOrigemInsegura:`Este endereço não é uma origem confiável: os dados ficam num armazenamento de reserva. Abra o app por HTTPS para usar o armazenamento definitivo.`,memoriaInstanciaDupla:`O Kobi Note já está aberto em outra janela, e só uma por vez pode usar o armazenamento definitivo. Feche a outra janela e recarregue esta — o que você escrever aqui até lá não será guardado.`,memoriaIndisponivel:`O navegador não liberou o armazenamento definitivo neste aparelho: os dados ficam num armazenamento de reserva e podem se perder. Verifique o espaço livre e as permissões de dados do site.`,apagarTudo:`Apagar todos os dados deste aparelho`,apagarTudoTitulo:`Apagar tudo deste aparelho?`,apagarTudoTexto:`Isto remove o banco, as anotações, o progresso, os favoritos e as preferências guardados neste aparelho. O conteúdo original volta na próxima sincronização; o que é seu, não. Desinstalar o app não faz esta limpeza — o navegador guarda os dados mesmo sem o atalho.`,apagarTudoConfirmar:`Apagar tudo`,apagarTudoFeito:`Dados apagados. Recarregando...`,apagarTudoFalhou:`Não foi possível apagar tudo. Tente de novo.`},atualizacao:{titulo:`Kobi Note atualizado`,texto:`Uma versão nova do Kobi Note foi baixada.`,acao:`Recarregar`},acoes:{voltar:`Voltar`,tema:`Alternar tema`,idioma:`Idioma`,fechar:`Fechar`,cancelar:`Cancelar`,confirmar:`Confirmar`,salvar:`Salvar`,criar:`Criar`,renomear:`Renomear`,excluir:`Excluir`,editar:`Editar`,substituir:`Substituir`,obrigatorio:`Preencha este campo.`},leitura:{apresentar:`Apresentar (rolagem automática)`,ler:`Ler em voz alta`,pausarLeitura:`Pausar leitura`,retomarLeitura:`Retomar leitura`,pausar:`Pausar`,continuar:`Continuar`,maisDevagar:`Mais devagar`,maisRapido:`Mais rápido`,velocidade:e=>`Vel. ${e}`,compartilhar:`Compartilhar`,copiado:`Conteúdo copiado para a área de transferência.`,semCopiar:`Não foi possível copiar o conteúdo.`},acervo:{meu:`Minha`,semTitulo:`Sem título`,salvando:`Salvando...`,salvoAs:e=>`Salvo às ${e}`,informeTitulo:`Informe um título para salvar`,tituloEConteudo:`Informe o título e o conteúdo para salvar`,excluirTexto:`A ação não pode ser desfeita.`},pasta:{nova:`Nova pasta`,novaTexto:`Como quer chamar a pasta?`,placeholder:`Nome da pasta`,renomear:`Renomear pasta`,excluir:`Excluir pasta`,excluirTexto:`As anotações dela voltam para “Sem pasta”.`,erroVazio:`Dê um nome à pasta.`},anotacoes:{nova:`Nova anotação`,buscar:`Buscar anotações...`,todosModelos:`Todos os modelos`,todas:`Todas`,arquivadas:`Arquivadas`,semAnotacoes:`Nenhuma anotação por aqui. Toque em + para criar a primeira.`,semArquivadas:`Nada arquivado.`,semTitulo:`(sem título)`,semPasta:`Sem pasta`,escolhaModelo:`Escolha um modelo`,tituloPlaceholder:`Título...`,salvando:`Salvando...`,informeTitulo:`Informe um título para salvar`,salvoAs:e=>`Salvo às ${e}`,fixar:`Fixar`,desafixar:`Desafixar`,arquivar:`Arquivar`,restaurar:`Restaurar`,reuniao:`Ir para a reunião (abre a anotação com o modelo do dia)`,excluir:`Excluir anotação`,excluirTexto:`A ação não pode ser desfeita.`,excluida:`Anotação excluída.`},guias:{nova:`Nova guia`,buscar:`Buscar guias...`,vazio:`Nenhuma guia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da guia...`,novaTitulo:`Nova guia`,excluir:`Excluir guia`,excluida:`Guia excluída.`},poesia:{nova:`Nova poesia`,buscar:`Buscar poesias...`,vazio:`Nenhuma poesia ainda. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da poesia...`,novaTitulo:`Nova poesia`,excluir:`Excluir poesia`,excluida:`Poesia excluída.`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`,anterior:`Anterior`,proxima:`Próxima`,sobre:`Sobre estas obras`,referencia:e=>`#${e??``}`,aviso:[`As obras aqui expostas têm um valor artístico, literário, baseado nas crenças das Testemunhas de Jeová. Seu objetivo é enaltecer a Jeová, o verdadeiro Deus e legítimo Soberano Universal, fortalecer a esperança em Suas maravilhosas e incomparáveis promessas, ocupar nossos pensamentos com “tudo que é verdadeiro, tudo que é de séria preocupação, tudo que é justo, tudo que é casto, tudo que é amável, tudo de que se fala bem, tudo que é virtuoso e tudo que é digno de louvor.” (Fil 4:8) A glória por qualquer benefício daqui derivado cabe a Jeová, o dador de todo presente perfeito, inclusive nossa capacidade de pensar e amar.`,`Todos os personagens usados nesta obra são fictícios. Quaisquer nomes de personagens originam-se de nomes de raças felinas e imagens são meramente ilustrativas.`,`Para saber mais sobre as crenças das Testemunhas de Jeová acesse o site jw.org.`]},receitas:{nova:`Nova receita`,buscar:`Buscar receitas...`,vazio:`Nenhuma receita disponível. Toque em + para criar a primeira, ou sincronize.`,tituloPlaceholder:`Título da receita...`,novaTitulo:`Nova receita`,excluir:`Excluir receita`,excluida:`Receita excluída.`,todas:`Todas`,categoria:`Categoria`,ingredientes:`Ingredientes`,preparo:`Modo de preparo`,ingredientesPlaceholder:`Um ingrediente por linha...`,preparoPlaceholder:`Um passo por linha...`,favoritar:`Adicionar aos favoritos`,desfavoritar:`Remover dos favoritos`},estudo:{intro:`Uma sessão de estudo: escolha o tipo, ore, cronometre e guarde o que aprendeu.`,tipo:`Tipo de estudo`,assunto:`Assunto`,assuntoPlaceholder:`O que você vai estudar...`,semAssunto:`(sem assunto)`,alvo:`Alvo de tempo`,minutos:e=>`${e} min`,de:e=>`de ${e} min`,comecar:`Começar`,oracaoTitulo:`Antes de começar`,oracaoTexto:`Portanto, se falta sabedoria a algum de vocês, que ele persista em pedi-la a Deus — pois ele dá a todos generosamente, sem censurar —, e ela lhe será dada. (Tiago 1:5)`,orei:`Já orei — começar`,emSessao:`Em estudo`,alvoAtingido:`Alvo de tempo atingido. Siga enquanto o assunto render.`,encerrar:`Encerrar`,descartar:`Descartar`,perola:`Pérola`,perolaIntro:e=>`${e} min de estudo. O que você leva daqui?`,perolaPlaceholder:`Uma ideia, um texto, uma aplicação...`,viraAnotacao:`Virar anotação`,viraAnotacaoFeito:`Anotação criada`,vaiCaderno:`Salvar no caderno`,vaiCadernoFeito:`Salvo no caderno de estudo`,salvarSessao:`Salvar sessão`,historico:`Histórico`,totais:(t,n)=>`${e(t,{one:`${t} sessão`,other:`${t} sessões`})} · ${n} de estudo.`,semSessoes:`Nenhuma sessão registrada ainda.`,excluir:`Excluir sessão`},prep:{indice:`Índice de prontidão`,indiceAjuda:`Checklists + autonomia de alimentos`,kits:`Kits de checklist`,estoque:`Estoque de alimentos`,cofre:`Cofre de documentos`,guias:`Guias`,guiasResumo:`Orientações e procedimentos`,cofreResumo:`Documentos criptografados`,contagemKits:t=>e(t,{one:`${t} kit`,other:`${t} kits`}),diasAutonomia:t=>e(t,{one:`${t} dia de autonomia`,other:`${t} dias de autonomia`}),semKits:`Nenhum kit ainda. Toque em + para criar o primeiro checklist.`,novoKit:`Novo checklist`,editarKit:`Editar checklist`,kitSemNome:`Sem nome`,nomeDoKit:`Nome do checklist`,emoji:`Emoji`,emojiAjuda:`Um emoji para reconhecer o kit na lista (opcional).`,itens:`Itens`,descricaoDoItem:`O que levar...`,quantidade:`Quantidade`,observacoes:`Observações`,adicionarItem:`Adicionar item`,removerItem:`Remover item`,removerItemTexto:`O item sai deste checklist.`,kitSalvo:`Checklist salvo.`,excluirKit:`Excluir checklist`,kitExcluido:`Checklist excluído.`,vence:e=>`vence ${e}`,novoItem:`Novo item`,editarItem:`Editar item`,item:`Item`,categoria:`Categoria`,pesoUnitario:`Peso unitário (g)`,kcal:`Calorias por 100 g`,validade:`Validade`,itemSalvo:`Item salvo.`,excluirItem:`Excluir item`,itemExcluido:`Item excluído.`,buscarItens:`Buscar no estoque...`,semEstoque:`O estoque está vazio.`,semEstoqueFiltro:`Nenhum item para esta busca.`,resumoDoItem:(e,t)=>`${e} × ${t} g`,alertas:t=>e(t,{one:`${t} alerta de validade`,other:`${t} alertas de validade`}),vencidoHa:e=>`Vencido há ${e} d`,venceHoje:`Vence hoje`,venceEm:e=>`Vence em ${e} d`,calculadora:`Calculadora de autonomia`,calculadoraAjuda:`Quem come, quanto gasta e quantos são`,faixaEtaria:`Faixa etária`,atividade:`Atividade física`,pessoas:`Pessoas`,maisPessoas:`Mais uma pessoa`,menosPessoas:`Menos uma pessoa`,diasDeAutonomia:`Dias de autonomia`,aguaSugerida:`Água sugerida`,pesoTotal:`Peso total`,metaAutonomia:e=>`${e}% da meta de 30 dias`,necessidadeDiaria:e=>`${e} kcal por dia para o grupo`,logistica:`Logística tática`,diasSemFogo:`Dias sem água/fogo`,diasComFogo:`Dias com cozimento`,itensDeFibra:`Itens de fibra`,vulneravel:`Poucos itens de fibras e vitaminas. Numa autonomia longa isso vira problema de saúde antes de virar problema de caloria.`,semBiometria:`Este navegador não oferece passkey. O cofre precisa dele para existir.`,configurarBiometria:`Proteger o cofre com a biometria`,biometriaAjuda:`O cofre abre pela biometria do aparelho (a mesma da tela de bloqueio), por um passkey criado só para ele. A chave que cifra cada documento nasce assim e não é gravada em lugar nenhum. Sem o passkey — aparelho trocado, dados do navegador apagados — não há como recuperar o que está guardado aqui. O resto do Kobi Note não depende dele.`,criarCofre:`Criar o cofre`,semPrf:`O autenticador deste aparelho não entrega a chave necessária. Tente outro autenticador, como o celular pelo QR.`,gestoRecusado:`O gesto foi cancelado.`,destrancarComBiometria:`Destrancar com a biometria`,cofreTrancado:`Cofre trancado`,destranqueAjuda:`Ele volta a trancar sozinho quando você sai desta tela.`,destrancar:`Destrancar`,trancar:`Trancar`,guardarDocumento:`Guardar um documento`,nomeDoDocumento:`Nome do documento`,informeNome:`Informe um nome.`,documentoGuardado:`Documento guardado e cifrado.`,semDocumentos:`Nenhum documento guardado ainda.`,renomearDocumento:`Renomear documento`,excluirDocumento:`Excluir documento`,excluirDocumentoTexto:`O documento cifrado é apagado do aparelho. Não há como recuperá-lo.`,documentoExcluido:`Documento excluído.`,falhaAoDecifrar:`Não foi possível decifrar: este documento foi guardado com outra chave.`,semPreVisualizacao:`Este tipo de arquivo não abre aqui. Baixe para ver.`,baixar:`Baixar`},financeiro:{transacoes:`Transações`,novaTransacao:`Nova transação`,transacaoSalva:`Transação salva.`,excluirTransacao:`Excluir transação`,transacaoExcluida:`Transação excluída.`,categorias:`Categorias`,novaCategoria:`Nova categoria`,categoriaSalva:`Categoria salva.`,excluirCategoria:`Excluir categoria`,excluirCategoriaTexto:`As transações dela continuam existindo, mas ficam sem categoria.`,categoriaExcluida:`Categoria excluída.`,recorrencias:`Recorrências`,novaRecorrencia:`Nova recorrência`,recorrenciaSalva:`Recorrência salva.`,excluirRecorrencia:`Excluir recorrência`,excluirRecorrenciaTexto:`Os lançamentos já gerados por ela continuam onde estão.`,recorrenciaExcluida:`Recorrência excluída.`,receber:`Confirmar recebimento`,receberTexto:(e,t)=>`Marcar “${e}” como recebida, no valor de ${t}?`,pagar:`Confirmar pagamento`,pagarTexto:(e,t)=>`Marcar “${e}” como paga, no valor de ${t}?`,estornar:`Desfazer a baixa`,estornarTexto:e=>`“${e}” volta a constar como em aberto.`},calendario:{vista:`Visualização`,vistas:{dia:`Dia`,semana:`Semana`,mes:`Mês`,ano:`Ano`,agenda:`Agenda`},meses:[`Janeiro`,`Fevereiro`,`Março`,`Abril`,`Maio`,`Junho`,`Julho`,`Agosto`,`Setembro`,`Outubro`,`Novembro`,`Dezembro`],mes:`Mês`,ano:`Ano`,anterior:`Período anterior`,proximo:`Próximo período`,hoje:`Hoje`,novoEvento:`Novo evento`,editarEvento:`Editar evento`,novoAs:(e,t)=>`Novo evento em ${e}, ${t}`,novoEm:e=>`Novo evento em ${e}`,titulo:`Título`,tituloPlaceholder:`Ex.: Reunião do meio de semana`,tipo:`Tipo`,diaInteiro:`Dia inteiro`,dataInicio:`Data de início`,horaInicio:`Hora de início`,dataFim:`Data de fim`,horaFim:`Hora de fim`,descricao:`Descrição`,descricaoPlaceholder:`Detalhes (opcional)...`,eventoSalvo:`Evento salvo.`,excluirEvento:`Excluir evento`,eventoExcluido:`Evento excluído.`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),semEventos:`Nenhum evento nesta semana.`,tipos:`Tipos de evento`,novoTipo:`Novo tipo`,tipoNome:`Nome`,cor:`Cor`,icone:`Ícone`,marcaEspecial:`Contar no “próximo especial”`,especial:`Especial`,tipoSemNome:`Sem nome`,excluirTipo:`Excluir tipo`,tipoEmUsoTitulo:`Tipo em uso`,tipoEmUsoTexto:`Este tipo tem eventos e não pode ser excluído.`,dataInvalida:`A data de início não é uma data válida.`,eventoNaoSalvo:`O evento não pôde ser salvo. Confira os campos e tente de novo.`,eventoNaoExcluido:`O evento não pôde ser excluído.`,tipoNaoSalvo:`O tipo não pôde ser salvo.`,tipoNaoExcluido:`O tipo não pôde ser excluído. Ele pode ter ganhado eventos agora há pouco.`},ministerio:{esfriando:(t,n)=>e(t,{one:`${t} estudo está esfriando (${n}+ dias).`,other:`${t} estudos estão esfriando (${n}+ dias).`}),verEstudos:`Ver`,lembrete:(e,t)=>`Relatório de ${e} ainda ${t?`não foi enviado`:`não foi feito`}.`,preencher:`Preencher`,atalhoRelatorios:`Relatórios`,atalhoRelatoriosSub:e=>`${e} no total`,atalhoEstudos:`Estudos`,atalhoEstudosSub:e=>`${e} ativos`,atalhoServico:`Quero fazer mais`,atalhoServicoSub:`Planejar as horas e virar meta`,ultimoRelatorio:`Último relatório`,participou:`Participou`,naoParticipou:`Não participou`,estudosDoRelatorio:e=>`${e} estudos`,enviado:`Enviado`,pendente:`Pendente`,contadores:`Contadores do mês`,zerar:`Zerar contadores`,zerarTexto:`Os cinco contadores deste mês voltam a zero. Quer continuar?`,tempo:`Tempo`,estudos:`Estudos`,revisitas:`Revisitas`,publicacoes:`Publicações`,videos:`Vídeos`,maisUmaHora:`+1h`,aumentar:e=>`Aumentar ${e}`,diminuir:e=>`Diminuir ${e}`,gerarRelatorio:`Gerar relatório do mês`,obsRevisitas:e=>`Revisitas: ${e}`,obsPublicacoes:e=>`Publicações: ${e}`,obsVideos:e=>`Vídeos: ${e}`,obsTempo:e=>`Tempo: ${e}`,novoRelatorio:`Novo relatório`,editarRelatorio:`Editar relatório`,semRelatorios:`Nenhum relatório ainda.`,mes:`Mês`,ano:`Ano`,tipoPublicador:`Tipo de publicador`,participacao:`Participou no ministério`,horas:`Horas`,metaHoras:`Meta de horas`,estudosBiblicos:`Estudos bíblicos`,observacoes:`Observações`,compartilhar:`Compartilhar`,marcarEnviado:`Marcar como enviado`,marcarPendente:`Marcar como pendente`,excluirRelatorio:`Excluir relatório`,relatorioSalvo:`Relatório salvo.`,relatorioExcluido:`Relatório excluído.`,resumoRelatorio:(e,t,n,r)=>`${e} · ${t?`participou`:`não participou`} · ${n} estudos${r}`,sufixoHoras:e=>` · ${e}h`,relatorioDe:e=>`📋 Relatório — ${e}`,linhaTipo:e=>`Tipo: ${e}`,linhaParticipacao:e=>`Participou no ministério: ${e?`Sim`:`Não`}`,linhaHoras:e=>`Horas: ${e}`,linhaEstudos:e=>`Estudos bíblicos: ${e}`,linhaObservacoes:e=>`Observações: ${e}`,novoEstudo:`Novo estudo`,editarEstudo:`Editar estudo`,buscarEstudos:`Buscar estudos...`,semEstudos:`Nenhum estudo aqui.`,semEstudosFiltro:`Nenhum estudo para esta busca.`,nome:`Nome`,semNome:`Sem nome`,contato:`Contato`,contatoPlaceholder:`Telefone, e-mail...`,endereco:`Endereço`,publicacaoAtual:`Publicação atual`,publicacaoPlaceholder:`Publicação usada no estudo`,diaSemana:`Dia da semana`,escolhaDia:`Escolha o dia...`,horario:`Horário`,notas:`Notas`,excluirEstudo:`Excluir estudo`,excluirEstudoTexto:`A linha do tempo deste estudo é apagada junto.`,estudoSalvo:`Estudo salvo.`,estudoExcluido:`Estudo excluído.`,informeNome:`Dê um nome ao estudo.`,seloEsfriando:`Esfriando`,ultimoEstudo:`Último estudo:`,parouEm:`Parou em:`,nenhumRegistro:`Nenhum registro`,hoje:`Hoje`,ontem:`Ontem`,haDias:e=>`Há ${e} dias`,estudoDe:e=>`📖 ${e}`,linhaPublicacao:e=>`Publicação: ${e}`,linhaOndeParou:e=>`Onde parou: ${e}`,linhaDia:(e,t)=>`Dia: ${e} ${t}`,linhaContato:e=>`Contato: ${e}`,linhaEndereco:e=>`Endereço: ${e}`,linhaDoTempo:`Linha do tempo`,registrarEstudo:`Registrar estudo`,editarRegistro:`Editar registro`,semRegistros:`Nenhum registro ainda. Toque em + após cada estudo.`,data:`Data`,ondeParou:`Onde parou`,ondeParouPlaceholder:`Ex.: lição 12, parágrafo 5`,informeOndeParou:`Informe onde o estudo parou.`,comentario:`Comentário`,comentarioPlaceholder:`Como foi o estudo, dúvidas, próximos passos...`,excluirRegistro:`Excluir registro`,registroSalvo:`Registro salvo.`,registroExcluido:`Registro excluído.`},jogo:{restantes:`Restantes`,acertos:`Acertos`,erros:`Erros`,partidas:`Partidas`,xpDisponivel:`XP disponível`,modo:`Modo`,modos:{estudo:`Estudo`,desafio:`Desafio`},desafioAjuda:`Timer por pergunta · bônus de XP por velocidade e sequência`,dificuldade:`Dificuldade`,dificuldades:[`Todas`,`Fácil`,`Médio`,`Difícil`],jogar:`Jogar`,semBanco:`Sem perguntas — sincronize`,semPerguntas:`Esta dificuldade não tem perguntas suficientes (mínimo 2). Escolha outra ou sincronize mais perguntas.`,tudoConcluido:`Você já respondeu todas as perguntas desta dificuldade!`,reiniciar:`Reiniciar`,reiniciarTitulo:`Reiniciar perguntas`,reiniciarTexto:`Zera as perguntas já respondidas (seu XP é mantido). Quer continuar?`,encerrar:`Encerrar jogo`,segundos:e=>`${e}s`,pausadoSelo:`pausado`,pausar:`Pausar`,retomar:`Retomar`,dica:e=>`Dica (${e} XP)`,explicacao:`Explicação`,feedbackCorreto:e=>`Correto! +${e} XP`,feedbackIncorreto:`Resposta incorreta`,feedbackTempo:`Tempo esgotado!`,proxima:`Próxima`,verResultado:`Ver resultado`,tituloResultado:`Resultado`,resultados:{perfeito:`Perfeito! 🎉`,excelente:`Excelente!`,muitoBem:`Muito bem!`,continue:`Continue praticando!`,naoDesista:`Não desista, tente de novo!`},acertosDe:(e,t,n)=>`${e} de ${t} acertos (${n}%)`,xpGanho:`XP ganho`,nivel:`Nível`,xpSaldo:`XP saldo`,anotarNoCaderno:`Anotar no Caderno de Estudo`,cadernoReferencia:`Jogo Língua Pura`,cadernoTitulo:`Jogo Língua Pura`,cadernoConteudo:(e,t,n)=>`Acertei ${e} de ${t} (${n}%). O que aprendi:\n`,jogarDeNovo:`Jogar de novo`,inicio:`Início`},leituraBiblia:{visualizacao:`Visualização`,visoes:{canonica:`Canônica`,cronologica:`Cronológica`,escritor:`Escritor`,celebracao:`Celebração`},visoesAjuda:{canonica:`Ordem canônica: Gênesis a Apocalipse`,cronologica:`Pela estimativa de quando cada livro foi escrito`,escritor:`Agrupada por escritor`,celebracao:`Leitura para a época da Celebração da morte de Cristo`},progressoGeral:`Progresso geral`,capitulos:(e,t)=>`${e} de ${t} capítulos`,capituloAbrev:(e,t)=>`${e}/${t} cap.`,livros:(e,t)=>`${e} de ${t} livros`,livroInteiro:`Livro inteiro`,limpar:`Limpar`,roteiro:`Roteiro da Celebração`,roteiroNota:`Acontecimentos da última semana de Jesus na Terra (Nisã 8 a 16) — leitura para a época da Celebração da morte de Cristo.`,trechos:(e,t)=>`${e} de ${t} trechos lidos`},servico:{intro:`Uma meta anual não cabe na cabeça de ninguém; "duas horas e meia, três vezes por semana" cabe. Escolha o alvo e os dias, e veja o que ele pede de cada saída.`,modalidade:`Modalidade de serviço`,semCota:`sem cota de horas`,horasMes:e=>`${e} h por mês`,alvo:`Alvo de horas no período`,alvoValor:e=>`${e} h`,prazo:`Período`,prazoValor:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mediaMes:e=>`Média de ${e} por mês.`,diasTitulo:`Dias em que pretendo sair`,semDias:`Escolha ao menos um dia da semana para a conta ter onde cair.`,gradeTitulo:`O que isso significa`,porSaida:`Em cada saída`,porSemana:`Por semana`,porMes:`Por mês`,porAno:`No ritmo de um ano`,saidas:`Saídas no período`,saidasValor:t=>e(t,{one:`${t} saída`,other:`${t} saídas`}),inviavel:`Mais de dez horas numa só saída — o alvo não cabe nos dias escolhidos. Acrescente dias, alongue o período ou reduza o alvo.`,mesAnterior:`Mês anterior`,mesSeguinte:`Próximo mês`,resumoDoMes:(t,n)=>e(t,{one:`${t} saída neste mês, para ${n}.`,other:`${t} saídas neste mês, para ${n}.`}),registrar:`Registrar como meta`,gravando:`Gravando...`,gravada:`Meta registrada. Ela acompanha sozinha as horas dos seus relatórios.`,naoGravada:`A meta não pôde ser registrada. Tente de novo.`,verMetas:`Ver metas`,tituloDaMeta:e=>`${e}: horas de campo`,fonteAviso:`As horas de cada modalidade são um ponto de partida para preencher o campo, não uma exigência afirmada por este app: confirme sempre a instrução vigente. Referências no jw.org:`,referencias:[{rotulo:`🌐 Alcance mais no serviço a Jeová`,url:`https://www.jw.org/finder?wtlocale=T&docid=201999284`},{rotulo:`🌐 Você pode aumentar sua participação?`,url:`https://www.jw.org/finder?wtlocale=T&docid=201998083`}]},metas:{nova:`Nova meta`,editar:`Editar meta`,buscar:`Buscar metas...`,filtros:{ativas:`Ativas`,concluidas:`Concluídas`,todas:`Todas`},resumo:(t,n)=>`${t} em andamento · ${e(n,{one:`${n} concluída`,other:`${n} concluídas`})}.`,vazio:`Nenhuma meta ainda. Toque em + para criar a primeira.`,semFiltro:`Nenhuma meta para este filtro.`,titulo:`Título`,tituloPlaceholder:`O que você quer alcançar...`,informeTitulo:`Dê um título à meta.`,categoria:`Categoria`,ativo:`Categoria do Financeiro`,alvo:e=>`Alvo (${e})`,automatica:`Automática`,automaticaAjuda:`O progresso vem do módulo de origem — não é digitado aqui.`,inicio:`Início`,prazoFinal:`Prazo final`,prazo:e=>`prazo ${e}`,aumentar:`Aumentar o progresso`,diminuir:`Diminuir o progresso`,concluir:`Concluir`,reabrir:`Reabrir`,salva:`Meta salva.`,excluir:`Excluir meta`,excluida:`Meta excluída.`},perfil:{cartao:`Cartão de visita`,secretario:`Secretário da Congregação`,saude:`Saúde (ICE — Em Caso de Emergência)`,gestacao:`Gestação`,dpa:`Diretrizes de sangue (DPA)`,emergencia:`Contato de emergência`,colih:`CoLiH`,identificacao:`Identificação complementar`,nome:`Nome completo`,telefone:`Telefone`,email:`E-mail`,link:`Link pessoal`,comentario:`Observação (nota aparece no contato)`,telefoneDuvidoso:`Este telefone não parece completo — dá para salvar assim mesmo.`,emailDuvidoso:`Este e-mail não parece completo — dá para salvar assim mesmo.`,cpfDuvidoso:`Este CPF não confere — dá para salvar assim mesmo.`,dataDuvidosa:`Esta data não existe no calendário e não foi salva. Corrija-a.`,tipo_sanguineo:`Tipo sanguíneo`,selecione:`Selecione...`,doador:`Doador de órgãos`,alergias:`Alergias`,medicamentos:`Medicamentos em uso`,observacoes:`Observações médicas`,gestante:`Gestante`,meses:`Meses de gestação`,mes:t=>e(t,{one:`${t} mês`,other:`${t} meses`}),mesesGestacao:t=>e(t,{one:`${t} mês de gestação`,other:`${t} meses de gestação`}),parto:`Data prevista do parto`,partoEm:e=>`parto previsto ${e}`,recusa:`Recuso transfusão de sangue`,naoApliqueSangue:`NÃO APLIQUE SANGUE`,portadorDiretriz:`Portador de cartão de diretrizes de recusa de transfusão.`,fracoes:`Frações aceitas por consciência`,dpaAssinado:`Cartão DPA físico atualizado e assinado em`,dpa_assinado_em:e=>`DPA assinado em ${e}`,dpaRenovar:e=>`· renovar em ${e} dias`,dpaVencido:`· vencido`,dpaVencidoAviso:e=>`O cartão DPA venceu em ${e}. Renove-o e atualize a data da assinatura.`,dpaVencidoResumo:`DPA vencido`,abrirPerfil:`Abrir o Perfil`,contatoNome:`Nome do contato`,contatoTelefone:`Telefone do contato`,sus:`Cartão SUS`,cpf:`CPF do titular`,upa:`UPA / hospital de referência`,sim:`Sim`,gestanteMaiusculo:`GESTANTE`,tituloCartao:`Cartão de contato`,tituloFicha:`Ficha de emergência`,semNome:`Sem nome`,semCartao:`Preencha nome e telefone no perfil para gerar o cartão.`,qrAlt:`QR com o cartão de contato (vCard)`,semFicha:`Sem dados de emergência. Preencha no perfil.`},cronologia:{intro:`De um lado a cronologia bíblica, do outro os fatos da história. Cada evento tem o link da fonte de onde saiu. Os cards “históricos” vêm de acervos oficiais fora de jw.org (UNESCO, Louvre, ONU, arquivos, museus, etc.) e seguem a datação acadêmica convencional.`,buscar:`Buscar na linha do tempo...`,limpar:`Limpar filtros`,fonte:`Ver a fonte`,eventos:t=>e(t,{one:`${t} evento`,other:`${t} eventos`}),vazio:`A linha do tempo ainda não foi sincronizada. Aguarde novidades em breve.`,semFiltro:`Nenhum evento para este filtro.`},imite:{titulo:`Imite a Sua Fé`,subtitulo:`Um atrito por cartão, e a pergunta que o desarma: e se a intenção dele fosse boa? A lente certa (o modo como vemos as coisas) muda a história que contamos a nós mesmos. Errar a lente não custa nada — é nas lentes erradas que está o ensino.`,vazio:`Nenhum cartão disponível ainda. Aguarde novidades em breve.`,cenario:`O atrito`,julgamento:`O que passa pela cabeça`,pergunta:`Qual destas lentes explica melhor a intenção do outro?`,espelhoDica:`No fim do cartão há uma pergunta sobre você. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que muda quando a intenção é lida assim.`,erro:`Essa lente ainda julga a pessoa, e não a intenção. Olhe de novo.`,lente:`A lente da boa intenção`,exemplos:`Quem mais fez isso na Bíblia`,lerFonte:`Ler a fonte no jw.org`,espelhoTitulo:`Seu Reflexo no Espelho`,espelhoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,seloEspelho:`Espelho Escrito`,seloFeito:`Selo do Espelho Escrito conquistado!`,outrosCartoes:`Outros cartões`,inicio:`Início`},principios:{titulo:`Princípios Bíblicos`,subtitulo:`O que a Bíblia diz sobre as decisões do dia a dia — a frase que resume, os textos que a sustentam e como ela se parece numa terça-feira comum.`,vazio:`Nenhum princípio disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhum princípio para esta busca.`,buscar:`Buscar por assunto ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,comAnotacao:`Você escreveu sobre este princípio`,lido:`Você já leu este princípio`,areaLida:`Você leu todos os princípios desta área`,progresso:`Quantos princípios do acervo você já leu`,porQue:`Por que isso existe`,naPratica:`Como isso se parece num dia comum`,lerFonte:`Ler o texto na Bíblia on-line`,paraRefletir:`Para refletir`,reflexaoPlaceholder:`Responda com sinceridade — ninguém além de você vai ler...`,outros:`Outros princípios`,inicio:`Início`},faq:{titulo:`Perguntas Frequentes`,subtitulo:`Uma pergunta por vez, das que aparecem na porta, no trabalho, na mesa de domingo. Primeiro a cena e a resposta que vem de impulso; depois as lentes — os ângulos por onde dá para responder. Errar a lente não custa nada: é nelas que está o ensino.`,vazio:`Nenhuma pergunta disponível ainda. Aguarde novidades em breve.`,semResultado:`Nenhuma pergunta para esta busca.`,buscar:`Buscar por pergunta ou texto bíblico...`,favoritos:`Seus favoritos`,favoritar:`Marcar como favorito`,desfavoritar:`Tirar dos favoritos`,respondida:`Você já fez esta pergunta`,categoriaConcluida:`Você fez todas as perguntas desta categoria`,progresso:`Quantas perguntas do acervo você já fez`,cenario:`Onde a pergunta aparece`,impulso:`O que vem primeiro à cabeça`,enunciado:`Qual destas lentes responde de verdade o que foi perguntado?`,preparoDica:`No fim há um espaço para a sua resposta, com as suas palavras. O que você escrever ali fica no Caderno de Estudo.`,comecar:`Escolher a lente`,conferir:`Confirmar a lente`,acerto:`É essa. Repare no que ela abre em vez de fechar.`,erro:`Essa lente responde outra coisa, ou encerra a conversa. Olhe de novo.`,aResposta:`A resposta pela Bíblia`,exemplos:`Quem respondeu assim na Bíblia`,lerArtigo:`Ler o assunto no jw.org`,paraPreparar:`Com as suas palavras`,respostaPlaceholder:`Escreva como você diria isso em suas próprias palavras...`,seloPalavras:`Você escreveu a sua resposta`,seloFeito:`Selo “Com as Suas Palavras” conquistado!`,outras:`Outras perguntas`,inicio:`Início`},criacao:{vazio:`Nenhum módulo disponível ainda. Aguarde novidades em breve.`,acerto:`Isso mesmo!`,erro:`Ainda não. Observe e tente de novo.`,ajuste:`Quase lá — ajuste até alcançar a meta.`,escolha:`Escolha uma opção antes de verificar.`,equilValorX:`Valor do x`,equilPendeDir:`A balança pende para a direita: o lado do x está leve. Aumente o x.`,equilPendeEsq:`A balança pende para a esquerda: o lado do x está pesado. Diminua o x.`,equilOk:e=>`Equilíbrio! Os dois lados pesam ${e}. Você achou o x que nivela a balança.`,paresErro:`Reveja: marque exatamente as colunas com pareamento errado (A-T, C-G).`,rotaIncompleta:`Visite todas as flores antes de verificar.`,rotaOtima:`Rota mais curta encontrada!`,rotaLonga:`Há um caminho mais curto. Tente recomeçar.`,orbInforme:`Ajuste a velocidade de impulso e toque em Lançar.`,orbVoando:`Em trajetória...`,orbCai:`Velocidade baixa demais: o corpo caiu em direção ao Sol.`,orbEscapa:`Velocidade alta demais: o corpo escapou para o espaço.`,orbAjuste:`Ainda não. Ajuste a velocidade e lance de novo até obter uma órbita estável.`,escudoFraco:`Campo fraco: o vento solar ainda atinge a Terra.`,escudoOk:`Campo forte: as partículas são desviadas para os polos (auroras) ✔`,conceito:`Conceito`,desafio:`Desafio`,ampliar:`Toque para ampliar`,fechar:`Fechar`,fonte:`Fonte: jw.org`,lerFonte:`Ler a fonte no jw.org`,comecar:`Começar`,verificar:`Verificar`,avancar:`Confirmar e avançar`,concluirMapa:`Concluir o mapa`,concluir:`Concluir`,leiaReflexao:`Leia a reflexão a seguir.`,concluido:`Módulo concluído — leia a reflexão abaixo.`,diligenteSelo:`Estudo Diligente`,diligenteDica:`Ao concluir, escreva no Caderno o que você aprendeu para ganhar o selo de Estudo Diligente.`,diligenteFeito:`Selo de Estudo Diligente conquistado!`,reflexaoTitulo:`Teve um Projeto?`,reflexaoEntenda:`O que você acabou de entender`,cadernoTitulo:`Caderno do Investigador`,cadernoPlaceholder:`Escreva, com suas palavras, o que este módulo lhe ensinou sobre a sabedoria do Criador...`,outrosModulos:`Outros módulos`,inicio:`Início`,recomecar:`Recomeçar`,lancar:`Lançar`,girar:`Arraste para girar · pinça/scroll para aproximar.`,atomoDica:`Um próton por vez: veja as camadas se refazerem a cada elemento.`,proximoNumero:`Escolha o próximo número`,ordenarDica:`Toque os eventos na ordem em que aconteceram (toque de novo para tirar).`,paresDica:`Toque nas colunas cujo pareamento está errado (válidos: A-T e C-G).`,rotaDica:`A abelha sai da colmeia, visita todas as flores e volta. Toque nas flores na ordem que faz o caminho mais curto (toque de novo para desfazer).`,rotaMedida:(e,t)=>`Seu caminho: ${e}  ·  menor possível: ${t}`,ciclosRecomecar:`Começar de novo`,explorarDica:`Toque cada visão para abri-la.`,explorarDesdobra:`desdobra`,gaivotaMesmo:`Mesma direção`,gaivotaOposto:`Direções opostas`,gaivotaVolta:`Volta ao corpo`,gaivotaPe:`Chega ao pé`,gaivotaCalor:`Calor recuperado`,proteinaRecorde:`Recorde`,proteinaAgora:`Agora`,proteinaRelogio:`Relógio da improbabilidade`,proteinaNecessarias:`Tentativas necessárias`,proteinaFaltam:`Ainda faltam`,proteinaTempo:`A 1 bilhão de tentativas por segundo, o cálculo levaria`,proteinaAnos:`anos para concluir.`,ciclosFechados:`ciclos fechados`,visoes:`visões`,camadas:`camadas`},caderno:{ver:`Ver no Caderno de Estudo`,intro:`Reúne o que você escreve em Entenda Melhor, Teve um Projeto?, Estudo Pessoal e outros módulos — e as suas anotações avulsas.`,nova:`Nova anotação`,editar:`Editar anotação`,buscar:`Buscar...`,todasOrigens:`Todas as origens`,origem:`Origem`,titulo:`Título`,tituloPlaceholder:`Um título curto (opcional)`,referencia:`Referência`,referenciaPlaceholder:`Módulo, texto bíblico, assunto... (opcional)`,conteudo:`O que você aprendeu`,conteudoPlaceholder:`Escreva, com suas palavras, o que este estudo lhe ensinou...`,semConteudo:`Escreva o que você aprendeu antes de salvar.`,vazio:`Seu caderno está vazio. Anote o que aprender nos estudos.`,semFiltro:`Nenhuma anotação para este filtro.`,salva:`Anotação salva.`,excluir:`Excluir anotação`,excluida:`Anotação excluída.`},tutorial:{intro:`Como usar o Kobi Note — uma explicação por módulo.`,visaoGeral:`Visão geral`,modulos:`Módulos`,vazio:`O tutorial ainda não foi sincronizado. Aguarde novidades em breve.`,semTopico:`Este módulo ainda não tem um tópico escrito no tutorial.`},notas:{titulo:`Notas de rodapé`,voltar:`Voltar ao ponto da nota`}},kt=`modulepreload`,At=function(e,t){return new URL(e,t).href},jt={},b=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=At(t,n),t=s(t),t in jt)return;jt[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:kt,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Mt=[{tag:`pt-BR`,nome:`Português (Brasil)`},{tag:`en`,nome:`English`,carregar:()=>b(()=>import(`./en-Cj_lQrHp.js`),__vite__mapDeps([0,1]),import.meta.url)},{tag:`es-ES`,nome:`Español (España)`,carregar:()=>b(()=>import(`./es-ES-C0wjyLo-.js`),__vite__mapDeps([2,1]),import.meta.url)}],Nt=`note_idioma`,Pt=Ot,Ft=Mt[0]?.tag??`pt-BR`,x=Pt;function It(){let e=null;try{e=localStorage.getItem(Nt)}catch{}if(e!==null&&Mt.some(({tag:t})=>t===e))return e;let t=navigator.language?.toLowerCase()??``;return Mt.find(({tag:e})=>e.toLowerCase().split(`-`)[0]===t.split(`-`)[0])?.tag??Ft}function Lt(e,t){let n={...e};for(let[r,i]of Object.entries(t)){let t=e[r];n[r]=typeof t==`object`&&t&&!Array.isArray(t)?{...t,...i}:i}return n}async function Rt(e){let n=Mt.find(t=>t.tag===e);if(n===void 0)throw Error(`idioma desconhecido: ${e} (ver src/i18n/idioma.ts)`);Pt=n.carregar===void 0?Ot:Lt(Ot,(await n.carregar()).default),x=Pt,Ft=n.tag,t(n.tag),document.documentElement.lang=n.tag;try{localStorage.setItem(Nt,n.tag)}catch{}}var zt=[{id:`prep-kits`,get rotulo(){return x.prep.kits},icone:`clipboard-list`,cor:`#dc3545`,rota:`prep/kits`},{id:`prep-estoque`,get rotulo(){return x.prep.estoque},icone:`package`,cor:`#e8590c`,rota:`prep/estoque`},{id:`prep-cofre`,get rotulo(){return x.prep.cofre},icone:`lock`,cor:`#495057`,rota:`prep/cofre`}],Bt=[{id:`anotacoes`,get rotulo(){return x.modulos.anotacoes},icone:`notes`,cor:`#0d6efd`},{id:`guias`,get rotulo(){return x.modulos.guias},icone:`map-2`,cor:`#20c997`},{id:`poesia`,get rotulo(){return x.modulos.poesia},icone:`feather`,cor:`#0dcaf0`},{id:`receitas`,get rotulo(){return x.modulos.receitas},icone:`chef-hat`,cor:`#fd7e14`},{id:`jogo`,get rotulo(){return x.modulos.jogo},icone:`device-gamepad-2`,cor:`#2f9e44`},{id:`criacao`,get rotulo(){return x.modulos.criacao},icone:`compass`,cor:`#0ca678`},{id:`entenda`,get rotulo(){return x.modulos.entenda},icone:`bulb`,cor:`#fd7e14`},{id:`imite`,get rotulo(){return x.modulos.imite},icone:`heart-handshake`,cor:`#d63384`},{id:`principios`,get rotulo(){return x.modulos.principios},icone:`scale`,cor:`#c92a2a`},{id:`faq`,get rotulo(){return x.modulos.faq},icone:`message-question`,cor:`#4263eb`},{id:`cronologia`,get rotulo(){return x.modulos.cronologia},icone:`timeline`,cor:`#82c91e`},{id:`caderno`,get rotulo(){return x.modulos.caderno},icone:`book-2`,cor:`#f59f00`},{id:`prep`,get rotulo(){return x.modulos.prep},icone:`shield-check`,cor:`#dc3545`},{id:`financeiro`,get rotulo(){return x.modulos.financeiro},icone:`cash`,cor:`#198754`},{id:`metas`,get rotulo(){return x.modulos.metas},icone:`target`,cor:`#0d6efd`,noPainel:!0},{id:`ministerio`,get rotulo(){return x.modulos.ministerio},icone:`users`,cor:`#0ca678`},{id:`servico`,get rotulo(){return x.modulos.servico},icone:`trending-up`,cor:`#0dcaf0`,dentroDe:`ministerio`},{id:`estudo`,get rotulo(){return x.modulos.estudo},icone:`hourglass`,cor:`#7048e8`},{id:`leitura`,get rotulo(){return x.modulos.leitura},icone:`book`,cor:`#1c7ed6`},{id:`calendario`,get rotulo(){return x.modulos.calendario},icone:`calendar`,cor:`#0dcaf0`},{id:`perfil`,get rotulo(){return x.modulos.perfil},icone:`id-badge-2`,cor:`#dc3545`},{id:`tutorial`,get rotulo(){return x.modulos.tutorial},icone:`help-circle`,cor:`#f59f00`},{id:`sobre`,get rotulo(){return x.modulos.sobre},icone:`info-circle`,cor:`#6c757d`}],Vt=[{id:`dia`,painel:`hoje`,itens:[{tipo:`modulo`,id:`anotacoes`},{tipo:`modulo`,id:`calendario`},{tipo:`modulo`,id:`ministerio`}]},{id:`numeros`,painel:`indicadores`,itens:[]},{id:`estudo`,get titulo(){return x.secoes.estudo},itens:[{tipo:`modulo`,id:`leitura`},{tipo:`modulo`,id:`estudo`},{tipo:`modulo`,id:`imite`},{tipo:`modulo`,id:`principios`},{tipo:`modulo`,id:`faq`},{tipo:`modulo`,id:`jogo`},{tipo:`modulo`,id:`entenda`},{tipo:`modulo`,id:`criacao`},{tipo:`modulo`,id:`cronologia`},{tipo:`modulo`,id:`poesia`},{tipo:`modulo`,id:`caderno`}]},{id:`prep`,get titulo(){return x.secoes.prep},painel:`prontidao`,itens:[{tipo:`atalho`,id:`prep-kits`},{tipo:`atalho`,id:`prep-estoque`},{tipo:`atalho`,id:`prep-cofre`},{tipo:`modulo`,id:`guias`}]},{id:`extras`,get titulo(){return x.secoes.extras},itens:[{tipo:`modulo`,id:`receitas`}]},{id:`pessoal`,get titulo(){return x.secoes.pessoal},itens:[{tipo:`modulo`,id:`financeiro`},{tipo:`modulo`,id:`perfil`}]},{id:`aplicativo`,get titulo(){return x.secoes.aplicativo},itens:[{tipo:`modulo`,id:`tutorial`},{tipo:`acao`,id:`sincronizar`},{tipo:`acao`,id:`convite`},{tipo:`modulo`,id:`sobre`}]}],Ht=new Map(Bt.map(e=>[e.id,e])),Ut=new Map(zt.map(e=>[e.id,e]));function Wt(e){return Ht.get(e)}function Gt(e){return Ut.get(e)}function Kt(e){return l.features[e]===!0}function qt(){let[e=``,t=``]=location.hash.replace(/^#\/?/,``).split(`?`),n=e.split(`/`).filter(e=>e!==``);return{modulo:n[0]??`home`,args:n.slice(1),query:new URLSearchParams(t)}}function Jt(e){location.hash=e.startsWith(`#`)?e:`#/${e.replace(/^\//,``)}`}function Yt(e){addEventListener(`hashchange`,()=>e(qt())),e(qt())}var Xt=()=>{};function Zt(e){Xt=e}function Qt(){Xt()}var $t=`false`,en=`false`,tn=$t===`true`,nn=en===`true`;function rn(e={}){let{immediate:t=!1,onNeedReload:n,onNeedRefresh:r,onOfflineReady:i,onRegistered:a,onRegisteredSW:o,onRegisterError:s}=e,c,l,u,d=async(e=!0)=>{await l,tn||u?.()};async function ee(){if(`serviceWorker`in navigator){if(c=await b(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-Bd17z0YL.js`);return{Workbox:e}},[],import.meta.url).then(({Workbox:e})=>new e(`./sw.js`,{scope:`./`,type:`classic`})).catch(e=>{s?.(e)}),!c)return;if(u=()=>{c?.messageSkipWaiting()},!nn){if(tn)c.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&(n?n():window.location.reload())}),c.addEventListener(`installed`,e=>{e.isUpdate||i?.()});else{let e=!1,t=()=>{e=!0,c?.addEventListener(`controlling`,e=>{e.isUpdate&&(n?n():window.location.reload())}),r?.()};c.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&i?.():n.isExternal?t():!e&&i?.():n.isUpdate||i?.()}),c.addEventListener(`waiting`,t)}}c.register({immediate:t}).then(e=>{o?o(`./sw.js`,e):a?.(e)}).catch(e=>{s?.(e)})}}return l=ee(),d}function an(){let e=rn({onNeedRefresh(){on(()=>{e(!0)})}})}function on(e){let t=Object.assign(document.createElement(`kk-alert`),{variant:`primary`,closable:!0}),n=document.createElement(`kk-icon`);n.setAttribute(`slot`,`icon`),n.setAttribute(`name`,`sparkles`);let r=document.createElement(`strong`);r.textContent=x.atualizacao.titulo;let i=document.createElement(`kk-button`);i.setAttribute(`size`,`small`),i.setAttribute(`variant`,`primary`),i.textContent=x.atualizacao.acao,i.addEventListener(`click`,e),t.append(n,r,document.createTextNode(` ${x.atualizacao.texto} `),i),document.body.append(t),t.toast()}var sn=864e5;function cn(e=new Date){let t=e instanceof Date?e:new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function ln(e=new Date){return cn(e).slice(0,7)}function un(e){return cn(new Date(Date.now()+e*sn))}function dn(e){if(!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t=0,n=0,r=0]=e.split(`-`).map(Number),i=new Date(t,n-1,r);return i.getFullYear()===t&&i.getMonth()===n-1&&i.getDate()===r}function fn(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1,0,0,0,0).getTime()}var pn=e=>String(e).padStart(2,`0`);function mn(e){return`${pn(e.getDate())}/${pn(e.getMonth()+1)}/${e.getFullYear()}`}function hn(e){return e===void 0||e===0||Number.isNaN(e)?``:mn(new Date(e))}function gn(e){if(e===void 0||e===0||Number.isNaN(e))return``;let t=new Date(e);return`${mn(t)}, ${pn(t.getHours())}:${pn(t.getMinutes())}`}function _n(e){if(e===void 0||e===``)return``;let[t,n,r]=e.split(`-`);return t===void 0||n===void 0||r===void 0?e:`${r}/${n}/${t}`}function vn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number);return cn(new Date(n,r-1,i+t))}function yn(e,t){let[n=0,r=1,i=1]=e.split(`-`).map(Number),a=new Date(n,r-1+t,1),o=new Date(a.getFullYear(),a.getMonth()+1,0).getDate();return cn(new Date(a.getFullYear(),a.getMonth(),Math.min(i,o)))}function bn(e,t){if(e===``||t===``)return 0;let[n=0,r=1,i=1]=e.split(`-`).map(Number),[a=0,o=1,s=1]=t.split(`-`).map(Number),c=new Date(a,o-1,s).getTime()-new Date(n,r-1,i).getTime();return Math.round(c/sn)}function xn(){let e=cn();return{inicio:fn(e),fim:fn(vn(e,1))-1}}async function Sn(){let{inicio:e,fim:t}=xn(),[n]=await i(`eventosDoDia`,[t,e]);return Number(n?.total??0)}async function Cn(){if(typeof navigator.setAppBadge==`function`)try{let e=await Sn();await(e>0?navigator.setAppBadge(e):navigator.clearAppBadge())}catch{}}var wn=!1;function Tn(){Cn(),!wn&&(wn=!0,document.addEventListener(`visibilitychange`,()=>{Cn()}))}var En=10,Dn=100,On=e=>new Promise(t=>setTimeout(t,e));async function kn(){let e=await navigator.storage?.getDirectory?.();if(e!==void 0)for(let t=0;t<En;t++){let t=[];for await(let n of e.keys())t.push(n);if(t.length===0)return;let n=!1;for(let r of t)try{await e.removeEntry(r,{recursive:!0})}catch{n=!0}if(!n)return;await On(Dn)}}function An(e){return new Promise(t=>{let n=indexedDB.deleteDatabase(e);n.onsuccess=()=>t(!0),n.onerror=()=>t(!1),n.onblocked=()=>t(!1)})}async function jn(){for(let e=0;e<En;e++){let e=(await indexedDB.databases?.()??[]).map(({name:e})=>e).filter(e=>e!==void 0);if(e.length===0||(await Promise.all(e.map(An))).every(Boolean))return;await On(Dn)}}async function Mn(){let e=await navigator.serviceWorker?.getRegistrations?.()??[];await Promise.all(e.map(e=>e.unregister()));let t=await caches?.keys?.()??[];await Promise.all(t.map(e=>caches.delete(e)))}async function Nn(){n(),await kn(),await Mn(),await jn(),localStorage.clear(),sessionStorage.clear()}var Pn=`note_versoes_curado`,Fn={perguntas:`perguntas`,poesias:`poesias`,receitas:`receitas`,guias:`guias`,kits:`kits`,criacao_modulos:`criacao_modulos`,imite_cartoes:`imite_cartoes`,principios:`principios`,faq:`faq`,cronologia:`cronologia`,anotacao_modelos:`anotacao_modelos`,estoque_catalogo:`estoque_catalogo`,tutorial:`tutorial`};async function In(e,t){return t.registros===void 0||t.registros===0||await a(e).contar().then(e=>e>0).catch(()=>!0)}function Ln(){try{return JSON.parse(localStorage.getItem(Pn)??`{}`)}catch{return{}}}async function Rn(e){try{let t=await fetch(`${l.apiEndpoint}/${e}`,{cache:`no-cache`});return t.ok?await t.json():void 0}catch{return}}async function zn(){let e=await Rn(`manifesto.json`);if(e===void 0)return{ok:!1,motivo:`offline`};let t=e.modulos;if(t===void 0)return{ok:!1,motivo:`sem-manifesto`};let n=Ln(),r=[];for(let[e,i]of Object.entries(t)){let t=Fn[e];if(t===void 0||!o.includes(t)||i.versao!==void 0&&n[e]===i.versao&&await In(t,i))continue;let s=await Rn(`${e}.json`);s!==void 0&&(await a(t).substituirTudo(s),i.versao!==void 0&&(n[e]=i.versao),r.push(e))}return localStorage.setItem(Pn,JSON.stringify(n)),await Vn(`categorias_financeiro`,`categorias.json`).catch(Bn),await Un().catch(Bn),{ok:!0,atualizados:r}}function Bn(e){console.warn(`semeadura do padrão de fábrica falhou:`,e)}async function Vn(e,t){let n=a(e);if((await n.todos().catch(()=>[])).length>0)return;let r=await Rn(t);if(r!==void 0)for(let e of r){let{publicar:t,...r}=e;await n.salvar(r)}}var Hn;function Un(){return Hn??=Vn(`calendario_tipos`,`calendario_tipos.json`).catch(e=>{throw Hn=void 0,e}),Hn}var Wn=`note_tema`,Gn=`#ffffff`,Kn=`#0f1115`;function qn(){return document.documentElement.classList.contains(`kk-theme-dark`)?`escuro`:`claro`}function Jn(e){let t=e===`escuro`,n=document.documentElement.classList;n.toggle(`kk-theme-dark`,t),n.toggle(`kk-theme-light`,!t),document.querySelector(`meta[name="theme-color"]`)?.setAttribute(`content`,t?Kn:Gn),localStorage.setItem(Wn,e)}function Yn(){let e=qn()===`escuro`?`claro`:`escuro`;return Jn(e),e}var Xn,Zn;function Qn(){let e=document.querySelector(`.barra`);e!==null&&e!==Zn&&(Xn??=new ResizeObserver(e=>{let t=e[e.length-1]?.target;if(t===void 0)return;let n=t.getBoundingClientRect().height;document.documentElement.style.setProperty(`--note-barra-altura`,`${n}px`)}),Zn!==void 0&&Xn.unobserve(Zn),Xn.observe(e),Zn=e)}var $n={projetos:{bioma:{versao:`1.0.0`,build:`2026-09-14T21:10:42.779Z`},admin:{versao:`1.0.130`,build:`2026-09-14T21:10:42.779Z`},note:{versao:`0.0.228`,build:`2026-09-12T23:12:32.824Z`},ui:{versao:`1.0.80`,build:`2026-09-14T21:09:18.628Z`},dev:{versao:`1.1.102`,build:`2026-09-10T23:17:21.120Z`},flow:{versao:`0.0.84`,build:`2026-09-10T23:40:16.940Z`},bin:{versao:`0.0.0`,build:`2026-09-04T17:43:53.952Z`},sql:{versao:`3.53.4`,build:`2026-09-04T17:18:39.584Z`}},componentesUi:81,pacotes:[{nome:`@kobi/admin`,versao:`1.0.130`,caminho:`apps/admin`},{nome:`kobi-dev`,versao:`1.1.102`,caminho:`apps/dev`},{nome:`@kobi/flow`,versao:`0.0.84`,caminho:`apps/flow`},{nome:`@kobi/note`,versao:`0.0.228`,caminho:`apps/note`},{nome:`@bioma/bin`,versao:`0.0.0`,caminho:`packages/bin`},{nome:`@bioma/core`,versao:`0.0.0`,caminho:`packages/core`},{nome:`@bioma/js`,versao:`0.1.0`,caminho:`packages/js`},{nome:`@kobi/kit`,versao:`1.0.80`,caminho:`packages/kit`},{nome:`@bioma/sabores`,versao:`0.0.0`,caminho:`packages/sabores`},{nome:`@bioma/sql`,versao:`3.53.4`,caminho:`packages/sql`},{nome:`@bioma/wasm`,versao:`1.0.0`,caminho:`packages/wasm`}],sementes:{flw_respostas_rapidas:8,not_anotacao_modelos:7,not_calendario_tipos:6,not_categorias_financeiro:17,not_criacao_modulos:63,not_cronologia_eventos:594,not_estoque_alimentos:32,not_guias:15,not_imite_cartoes:89,not_itens_checklist:96,not_kits_checklist:6,not_perguntas:1273,not_poesias:275,not_principios:112,not_receitas:4}}.projetos.note?.build.slice(0,4)??``;function er(){return v`
  ...
  `}function tr(){return v`
    <footer class="rodape">
      ...
      <p class="rodape__nota">
        ${$n===``?y:v`<span>${x.rodape.direitos($n)}</span>`}
        <span>${x.rodape.feitoPara}</span>
      </p>
    </footer>
  `}function nr(e,t,n){let r=qn()===`escuro`;return v`
    <header class="barra">
    ...
    ${tr()}
  `}var rr={criacao:{rotulo:`Teve um Projeto?`,icone:`compass`,cor:`#6610f2`},estudo:{rotulo:`Estudo Pessoal`,icone:`hourglass`,cor:`#6f42c1`},imite:{rotulo:`Imite a Sua Fé`,icone:`heart-handshake`,cor:`#d63384`},jogo:{rotulo:`Língua Pura`,icone:`device-gamepad-2`,cor:`#198754`},principios:{rotulo:`Princípios Bíblicos`,icone:`scale`,cor:`#c92a2a`},faq:{rotulo:`Perguntas Frequentes`,icone:`message-question`,cor:`#4263eb`},avulso:{rotulo:`Avulso`,icone:`notes`,cor:`#0d6efd`}};function ir(e){return rr[e]??rr.avulso}var ar=()=>a(`not_caderno_estudo`);function or(){return ar().todos()}var sr={origem:`todas`,busca:``};function cr(e,t){let n=s(t.busca.trim());return e.filter(e=>t.origem===`todas`||e.origem===t.origem).filter(e=>n===``||s(e.titulo).includes(n)||s(e.conteudo).includes(n)||s(e.referencia).includes(n)).sort((e,t)=>(t.atualizado||0)-(e.atualizado||0))}function lr(e){return ar().salvar(e)}function ur(e){return ar().excluir(e)}var dr=`note_caderno_rascunho`;function fr(e){return sessionStorage.setItem(dr,JSON.stringify(e)),`caderno/novo`}function pr(){try{let e=sessionStorage.getItem(dr);return sessionStorage.removeItem(dr),e===null?{}:JSON.parse(e)}catch{return{}}}async function mr(e){let t=Date.now(),n=e.ref_chave??null;return lr({...(n===null?void 0:(await or()).find(e=>e.ref_chave===n))??{criado:t,ref_chave:n},titulo:e.titulo??``,conteudo:e.conteudo??``,origem:e.origem??`avulso`,referencia:e.referencia??``,atualizado:t})}async function hr(e){if(e===null||e===``)return;let t=(await or()).find(t=>t.ref_chave===e);t?.id!==void 0&&await ur(t.id)}var gr=`Geral`;async function _r(){return(await a(`imite_cartoes`).todos()).sort((e,t)=>Number(e.ordem)-Number(t.ordem)||Number(e.id??0)-Number(t.id??0))}function vr(e){try{let t=JSON.parse(e===``?`[]`:e);return Array.isArray(t)?t:[]}catch{return[]}}function yr(e){return e===null?[]:vr(e.lentes)}function br(e){return e===null?[]:vr(e.exemplos)}function xr(e,t){return e===null||t===null||t===``?!1:t===e.correta&&yr(e).some(e=>e.id===t)}function Sr(e){return e!==null&&yr(e).some(t=>t.id===e.correta)}function Cr(e,t){return(yr(e).find(e=>e.id===t)?.resposta??``).trim()}function wr(e,t){let n=new Map;for(let t of e){let e=t.tema.trim()===``?gr:t.tema.trim(),r=n.get(e);r===void 0?n.set(e,[t]):r.push(t)}return[...n].map(([e,n])=>({tema:e,cartoes:n,concluido:n.every(t)}))}var Tr=`note_imite_progresso`;function Er(){return{refletidos:{}}}function Dr(){try{let e=JSON.parse(localStorage.getItem(Tr)??`null`);return{...Er(),...e}}catch{return Er()}}function Or(e){localStorage.setItem(Tr,JSON.stringify(e))}function kr(e,t){let n=e.refletidos[String(t)],r={...e,refletidos:{...e.refletidos,[String(t)]:{tentativas:(n?.tentativas??0)+1,refletidoEm:Date.now()}}};return Or(r),r}function Ar(e,t){return t?.id!==void 0&&e.refletidos[String(t.id)]!==void 0}function jr(e){return`imite:${e}`}async function Mr(){let e=new Map;for(let t of await or()){if(t.origem!==`imite`||t.ref_chave===null)continue;let n=Number(t.ref_chave.split(`:`)[1]);Number.isFinite(n)&&e.set(n,t.conteudo)}return e}function Nr(e,t,n){return n?.id!==void 0&&Ar(e,n)&&(t.get(n.id)??``).trim()!==``}function Pr(e){return v`
    <div class="aviso">
  ...
  `}function zr(e){return e instanceof Error?e.message:String(e)}var S={anotacoes:0,eventosHoje:[],contasVencendo:0,leituraPercentual:0,metasAtivas:0,metasConcluidas:0,focoMinutos:0,horasDoMes:0,receitasFavoritas:0,prontidao:0,prontidaoTom:`perigo`,kits:0,autonomiaDias:0,dpaVencidoEm:``},Br=!1,Vr=!1,Hr=!0,Ur=!1;function Wr(){Ur||(Ur=!0,addEventListener(`hashchange`,()=>{location.hash.replace(/^#\/?/,``).split(`/`)[0]!==`home`&&(Hr=!0)}))}async function Gr(e,t){try{return await e()}catch{return t}}async function Kr(){let e=cn(),t=ln(),[n,r,i,a,o,s,c,l,u,d]=await Promise.all([Gr(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await b(async()=>{let{FILTROS_INICIAIS:e,listarAnotacoes:t}=await import(`./dados-Vl9m1oPA.js`);return{FILTROS_INICIAIS:e,listarAnotacoes:t}},__vite__mapDeps([3,4,5]),import.meta.url);return(await t(e)).length},0),Gr(async()=>{let t=await b(()=>import(`./dados-PeJuDTqT.js`),__vite__mapDeps([6,4]),import.meta.url),{eventos:n,tipos:r}=await t.carregar();return t.eventosDoDia(n,e).map(e=>({titulo:e.titulo,quando:e.dia_inteiro===1?x.painel.diaInteiro:t.comoHora(e.hora_inicio_min),cor:t.corDoTipo(r,e.tipo_id)}))},[]),Gr(async()=>{let{carregar:t,TIPO_DESPESA:n}=await b(async()=>{let{carregar:e,TIPO_DESPESA:t}=await import(`./dados-B6A37GIf.js`);return{carregar:e,TIPO_DESPESA:t}},__vite__mapDeps([7,8,9,4]),import.meta.url),{transacoes:r}=await t(),i=new Date(`${e}T23:59:59`).getTime();return r.filter(e=>e.tipo===n&&e.esta_pago!==1&&e.data_vencimento!==0&&e.data_vencimento<=i).length},0),Gr(async()=>{let{lerLidos:e,percentualGeral:t}=await b(async()=>{let{lerLidos:e,percentualGeral:t}=await import(`./dados-CrToLRPu.js`);return{lerLidos:e,percentualGeral:t}},[],import.meta.url);return t(e())},0),Gr(async()=>{let{listarMetas:e}=await b(async()=>{let{listarMetas:e}=await import(`./dados-DRfDGN3d.js`);return{listarMetas:e}},__vite__mapDeps([10,9,8,4,5]),import.meta.url),t=await e();return{ativas:t.filter(e=>e.esta_concluida!==1).length,concluidas:t.filter(e=>e.esta_concluida===1).length}},{ativas:0,concluidas:0}),Gr(async()=>{let{listarSessoes:e,totalDeMinutos:n}=await b(async()=>{let{listarSessoes:e,totalDeMinutos:t}=await import(`./dados-DcI6nXDl.js`);return{listarSessoes:e,totalDeMinutos:t}},__vite__mapDeps([11,4]),import.meta.url);return n((await e()).filter(e=>ln(e.concluido_em)===t))},0),Gr(async()=>{let{carregar:e}=await b(async()=>{let{carregar:e}=await import(`./dados-C5JovN20.js`);return{carregar:e}},__vite__mapDeps([12,4,5]),import.meta.url),{contador:t}=await e();return Math.floor(t.minutos/60)},0),Gr(async()=>{let{lerFavoritos:e}=await b(async()=>{let{lerFavoritos:e}=await import(`./favoritos-DAEWA_Gd.js`);return{lerFavoritos:e}},[],import.meta.url),{CHAVE_FAVORITOS:t}=await b(async()=>{let{CHAVE_FAVORITOS:e}=await import(`./dados-DwwkEHCQ.js`);return{CHAVE_FAVORITOS:e}},__vite__mapDeps([13,4,14]),import.meta.url);return e(t).size},0),Gr(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await b(async()=>{let{calcularProntidao:e,tomDaProntidao:t}=await import(`./dados-BgDpV8rv.js`);return{calcularProntidao:e,tomDaProntidao:t}},[],import.meta.url),{carregarKits:n,lerProgresso:r}=await b(async()=>{let{carregarKits:e,lerProgresso:t}=await import(`./kits-CDPhdmZ8.js`);return{carregarKits:e,lerProgresso:t}},__vite__mapDeps([15,4]),import.meta.url),{calcularAutonomia:i,carregarEstoque:a,lerPerfil:o}=await b(async()=>{let{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}=await import(`./estoque-CiELC02y.js`);return{calcularAutonomia:e,carregarEstoque:t,lerPerfil:n}},__vite__mapDeps([16,4,5,17]),import.meta.url),[s,c]=await Promise.all([n(),a()]),l=o(),u=e({kits:s,progresso:r(),estoque:c,perfil:l});return{prontidao:u,tom:t(u),kits:s.length,autonomiaDias:i(c,l).dias}},{prontidao:0,tom:`perigo`,kits:0,autonomiaDias:0}),Gr(async()=>{let{carregarPerfil:e,dpaVencidoEm:t}=await b(async()=>{let{carregarPerfil:e,dpaVencidoEm:t}=await import(`./dados-zX3xZcbT.js`);return{carregarPerfil:e,dpaVencidoEm:t}},__vite__mapDeps([18,4]),import.meta.url);return t(await e())},``)]);return{anotacoes:n,eventosHoje:r,contasVencendo:i,leituraPercentual:a,metasAtivas:o.ativas,metasConcluidas:o.concluidas,focoMinutos:s,horasDoMes:c,receitasFavoritas:l,prontidao:u.prontidao,prontidaoTom:u.tom,kits:u.kits,autonomiaDias:u.autonomiaDias,dpaVencidoEm:d}}function qr(){Wr(),!Vr&&Hr&&(Hr=!1,Vr=!0,(async()=>{try{S=await Kr(),Br=!0}finally{Vr=!1,Qt()}})())}function Jr(e){if(Br&&Kt(e)){if(e===`anotacoes`&&S.anotacoes>0)return x.painel.anotacoes(S.anotacoes);if(e===`calendario`&&S.eventosHoje.length>0)return x.painel.eventosHoje(S.eventosHoje.length);if(e===`financeiro`&&S.contasVencendo>0)return x.painel.contasVencendo(S.contasVencendo);if(e===`leitura`&&S.leituraPercentual>0)return x.painel.leitura(S.leituraPercentual);if(e===`metas`&&S.metasAtivas>0)return x.painel.metas(S.metasAtivas);if(e===`ministerio`&&S.horasDoMes>0)return x.painel.horas(S.horasDoMes);if(e===`perfil`&&S.dpaVencidoEm!==``)return x.perfil.dpaVencidoResumo;if(e===`estudo`&&S.focoMinutos>0)return x.painel.foco(S.focoMinutos);if(e===`receitas`&&S.receitasFavoritas>0)return x.painel.favoritas(S.receitasFavoritas);if(e===`guias`)return x.prep.guiasResumo}}function Yr(e){if(Br&&Kt(`prep`)){if(e===`prep-kits`)return x.prep.contagemKits(S.kits);if(e===`prep-estoque`)return x.prep.diasAutonomia(S.autonomiaDias);if(e===`prep-cofre`)return x.prep.cofreResumo}}function Xr(e,t,n){let r=Wt(e);return v`
    <button
      class="indicador"
      data-modulo=${e}
  ...
  `}function Zr(){let e=new Date().toLocaleDateString(`pt-BR`,{weekday:`long`,day:`numeric`,month:`long`});return v`
    ${S.dpaVencidoEm===``?y:v`
          <kk-alert variant="warning" open class="painel__aviso">
            ...
            <kk-button size="small" variant="warning" @click=${()=>Jt(`perfil`)}>
  ...
  `}function Qr(){return v`<div class="indicadores">${[S.focoMinutos>0?Xr(`estudo`,x.painel.emHoras(S.focoMinutos),x.painel.rotuloFoco):y,S.contasVencendo>0?Xr(`financeiro`,String(S.contasVencendo),x.painel.rotuloContas):y,Xr(`metas`,`${S.metasConcluidas}/${S.metasAtivas+S.metasConcluidas}`,x.painel.rotuloMetas)].filter(e=>e!==y)}</div>`}function $r(){if(!Kt(`prep`))return y;let e=S.prontidao;return v`
  ...
  `}function ei(e){return qr(),Br?e===`hoje`?Zr():e===`indicadores`?Qr():$r():e===`hoje`?v`<p class="intro">${x.home.sub}</p>`:y}var ti=`#82c91e`,ni=`#ae3ec9`;function ri(e){let t=Kt(e.id);return si({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:Jr(e.id),emBreve:!t,aoTocar:()=>Jt(e.id)})}function ii(e){let t=Kt(e.rota.split(`/`)[0]??``);return si({cor:e.cor,icone:e.icone,rotulo:e.rotulo,resumo:Yr(e.id),emBreve:!t,aoTocar:()=>Jt(e.rota)})}function ai(e){return si({cor:ti,icone:`refresh`,rotulo:x.home.sincronizar,resumo:e.ocupado?x.home.sincronizando:void 0,ocupado:e.ocupado,aoTocar:()=>e.executar()})}function oi(){return si({cor:ni,icone:`share`,rotulo:x.convite.tile,resumo:x.convite.tileResumo,aoTocar:()=>{(async()=>{let{abrirConvite:e}=await b(async()=>{let{abrirConvite:e}=await import(`./convite-CSP9lNGA.js`);return{abrirConvite:e}},__vite__mapDeps([19,20]),import.meta.url);await e()})()}})}function si(e){return v`
    <button
      class="tile"
      style="--cor: ${e.cor}"
  ...
  `}function ci(e,t){return t?y:v`
    <hr class="divisor" />
    ${e.titulo===void 0?y:v`<h2 class="secao">${e.titulo}</h2>`}
  `}function li(e,t){return e.itens.map(e=>{if(e.tipo===`acao`)return e.id===`sincronizar`?ai(t):e.id===`convite`?oi():y;if(e.tipo===`atalho`){let t=Gt(e.id);return t===void 0?y:ii(t)}let n=Wt(e.id);return n===void 0?y:ri(n)}).filter(e=>e!==y)}function ui(e){return v`
    ${Vt.map((t,n)=>{let r=t.painel===void 0?y:ei(t.painel),i=li(t,e);return r===y&&i.length===0?y:v`
        ${ci(t,n===0)}
        ${r}
        ${i.length===0?y:v`<div class="tiles">${i}</div>`}
      `})}
  `}function di(e,t,n,r={}){let i=document.createElement(`kk-dialog`);return i.setAttribute(`label`,e),r.semCabecalho===!0&&i.setAttribute(`no-header`,``),r.classe!==void 0&&(i.className=r.classe),document.body.append(i),new Promise(e=>{let r=t,a=e=>{r=e,i.open=!1},o=()=>{Ct(n(a,i,o),i)};i.addEventListener(`kk-after-hide`,t=>{t.target===i&&(i.remove(),e(r))}),o(),i.updateComplete.then(()=>{i.open=!0})})}function fi(e){return di(e.titulo,!1,t=>v`
      ${e.texto??``}
    ...
    `)}function pi(e){return di(e.titulo,null,(t,n)=>{let r=()=>{let r=n.querySelector(`kk-input`),i=r?.value.trim()??``;if(i===``){r!=null&&(r.helpText=e.erroVazio??x.acoes.obrigatorio,r.focus());return}t(i)};return v`
    ...
    `})}var mi=4e3,hi={success:`circle-check`,danger:`alert-triangle`,warning:`alert-triangle`,neutral:`info-circle`};function gi(e,t=`success`){let n=Object.assign(document.createElement(`kk-alert`),{variant:t,closable:!0,duration:mi}),r=document.createElement(`kk-icon`);r.setAttribute(`slot`,`icon`),r.setAttribute(`name`,hi[t]),n.append(r,document.createTextNode(e)),document.body.append(n),n.toast()}async function _i(){if(await fi({titulo:x.armazenamento.apagarTudoTitulo,texto:x.armazenamento.apagarTudoTexto,rotuloConfirmar:x.armazenamento.apagarTudoConfirmar,variante:`danger`})){try{await Nn()}catch{gi(x.armazenamento.apagarTudoFalhou,`warning`);return}gi(x.armazenamento.apagarTudoFeito),location.reload()}}var vi=null,yi=new Set;function bi(){for(let e of[...yi])e()}function xi(e){e.preventDefault(),vi=e,bi()}typeof window<`u`&&(window.addEventListener(`beforeinstallprompt`,xi),window.addEventListener(`appinstalled`,()=>{vi=null,bi()}));function Si(){return vi!==null}async function Ci(){let e=vi;if(e===null)return!1;vi=null,bi();let{outcome:t}=await e.prompt();return t===`accepted`}function wi(e){return yi.add(e),()=>yi.delete(e)}var Ti=`note_boas_vindas_visto`,Ei=[{id:`bemVindo`,cor:`#fdf10d`},{id:`painel`,cor:`#6f42c1`},{id:`offline`,cor:`#198754`},{id:`privado`,cor:`#dc3545`},{id:`instalar`,cor:`#fd7e14`}];function Di(){try{return localStorage.getItem(Ti)!==null}catch{return!0}}function Oi(){try{localStorage.setItem(Ti,`1`)}catch{}}function ki(e){let t=Ei[e];if(t===void 0)return v``;let n=x.boasVindas.passos[t.id];return v`
    <div class="bv" style="--cor: ${t.cor}">
      ...
      ${t.id===`instalar`&&Si()?v`
            <kk-button class="bv__instalar" variant="primary" @click=${()=>void Ci()}>
      ...
      <div
        ...
        role="progressbar"
        aria-valuemin="1"
        aria-valuemax=${Ei.length}
        aria-valuenow=${e+1}
        aria-valuetext=${x.boasVindas.passo(e+1,Ei.length)}
      >
        ${Ei.map((t,n)=>v`<span class="bv__ponto ${n===e?`bv__ponto--atual`:``}"></span>`)}
      </div>
    </div>
  `}function Ai(){let e=0,t,n=wi(()=>t?.());return di(x.boasVindas.passos.bemVindo.titulo,void 0,(n,r,i)=>{t=i;let a=e===Ei.length-1;return v`
...
`,no={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ro=e=>(...t)=>({_$litDirective$:e,values:t}),io=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},E=ro(class extends io{constructor(e){if(super(e),e.type!==no.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return Fa}}),D=C`
...
`,ao={attribute:!0,type:String,converter:ua,reflect:!1,hasChanged:da},oo=(e=ao,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function O(e){return(t,n)=>typeof n==`object`?oo(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function k(e){return O({...e,state:!0,attribute:!1})}var so=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n);function A(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return so(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return so(n,r,{get(){return a(this)}})}}var co=new WeakMap,lo=(e=`value`)=>(t,n)=>{n.addInitializer(function(){let t={observada:e,destino:String(n.name)},r=co.get(this);r?r.push(t):co.set(this,[t])})};function uo(e,t,n){let r=co.get(e);if(!r)return;let i=e.constructor,a=e;for(let{observada:e,destino:o}of r){let r=i.getPropertyOptions(e);if(t!==(typeof r.attribute==`string`?r.attribute:e))continue;let s=r.converter||ua,c=(typeof s==`function`?s:s?.fromAttribute??ua.fromAttribute)(n,r.type);a[e]!==c&&(a[o]=c)}}var fo=new WeakMap;function j(e,t){let n=Array.isArray(e)?e:[e],r=t?.waitUntilFirstUpdate??!1;return(e,t)=>{t.addInitializer(function(){let t={propriedades:n,handler:e,esperarPrimeiroRender:r},i=fo.get(this);i?i.push(t):fo.set(this,[t])})}}function po(e,t){let n=fo.get(e);if(!n)return;let r=e,i=new Set;for(let a=0;a<10;a++){let a=!1;for(let[o,{propriedades:s,handler:c,esperarPrimeiroRender:l}]of n.entries())if(!l||e.hasUpdated)for(let n of s){if(!t.has(n))continue;let s=`${o}:${n}`;if(i.has(s))continue;let l=t.get(n),u=r[n];l!==u&&(i.add(s),a=!0,c.call(e,l,u))}if(!a)return}}var mo,ho,go,_o,vo,yo,bo,M=class extends (go=$a,ho=[O()],mo=[O()],go){constructor(){super(),g(this,`_internals`),_(this,vo,m(_o,8,this)),m(_o,11,this),_(this,yo,m(_o,12,this)),m(_o,15,this),_(this,bo,!1),g(this,`initialReflectedProperties`,new Map),this._internals=this.attachInternals(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...t});return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v${t.version}`),`version`in r&&r.version&&(a=` v${r.version}`),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}addState(e){this._internals.states&&this._internals.states.add(e.startsWith(`--`)?e:`--${e}`)}removeState(e){this._internals.states&&this._internals.states.delete(e.startsWith(`--`)?e:`--${e}`)}toggleState(e,t){let n=e.startsWith(`--`)?e:`--${e}`;this._internals.states&&(typeof t==`boolean`?t?this._internals.states.add(n):this._internals.states.delete(n):this._internals.states.has(n)?this._internals.states.delete(n):this._internals.states.add(n))}attributeChangedCallback(e,t,n){me(this,bo)||(this.constructor.elementProperties.forEach((e,t)=>{let n=t;e.reflect&&this[n]!=null&&this.initialReflectedProperties.set(n,this[n])}),he(this,bo,!0)),uo(this,e,n),super.attributeChangedCallback(e,t,n)}update(e){po(this,e),super.update(e)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{let r=n;e.has(r)&&this[r]==null&&(this[r]=t)})}};_o=f(go),vo=new WeakMap,yo=new WeakMap,bo=new WeakMap,h(_o,4,`dir`,ho,M,vo),h(_o,4,`lang`,mo,M,yo),p(_o,M),g(M,`version`,`0.0.0`),g(M,`dependencies`,{});var xo,So,Co,wo,To=class extends (So=M,xo=[O({reflect:!0})],So){constructor(){super(...arguments),_(this,wo,m(Co,8,this,`grouped`)),m(Co,11,this),g(this,`aoAbrirSecao`,e=>{let t=this.secoes(),n=t.find(t=>t===e.target);if(n?.name)for(let e of t)e!==n&&e.name===n.name&&e.open&&e.hide()}),g(this,`aoTrocarSecoes`,()=>{let e=new Set;for(let t of this.secoes())!t.name||!t.open||(e.has(t.name)?t.open=!1:e.add(t.name))})}connectedCallback(){super.connectedCallback(),this.addEventListener(`kk-show`,this.aoAbrirSecao)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`kk-show`,this.aoAbrirSecao)}secoes(){return[...this.querySelectorAll(`:scope > kk-details`)]}render(){return w`
      <div
        part="base"
    ...
    `}};Co=f(So),wo=new WeakMap,h(Co,4,`appearance`,xo,To,wo),p(Co,To),g(To,`styles`,[D,to]),To.define(`kk-accordion`);var Eo=e=>{let{activeElement:t}=document;t&&e.contains(t)&&document.activeElement?.blur()},Do=C`
  :host {
...
`,Jo={name:`default`,resolver:(e,t)=>te(`assets/icons/${t}/${e}.svg`)},Yo={caret:`
  ...
  `},Xo=[Jo,{name:`system`,resolver:e=>e in Yo?`data:image/svg+xml,${encodeURIComponent(Yo[e])}`:``}],Zo=[];function Qo(e){Zo.push(e)}function $o(e){Zo=Zo.filter(t=>t!==e)}function es(e){return Xo.find(t=>t.name===e)}var ts=Symbol(),ns=Symbol(),rs,is=new Map,as,os,ss,cs,ls,us,ds,fs,ps,P,ms,hs,gs,_s,vs,ys,bs=class extends (ps=M,fs=[k()],ds=[O({reflect:!0})],us=[O()],ls=[O()],cs=[O({reflect:!0})],ss=[O({reflect:!0})],os=[j(`label`)],as=[j([`name`,`src`,`library`,`variant`])],ps){constructor(){super(...arguments),m(P,5,this),g(this,`initialRender`,!1),_(this,ms,m(P,8,this,null)),m(P,11,this),_(this,hs,m(P,12,this)),m(P,15,this),_(this,gs,m(P,16,this)),m(P,19,this),_(this,_s,m(P,20,this,``)),m(P,23,this),_(this,vs,m(P,24,this,`default`)),m(P,27,this),_(this,ys,m(P,28,this,`outline`)),m(P,31,this)}async resolveIcon(e,t){let n;if(t?.spriteSheet)return this.svg=w`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(n=await fetch(e,{mode:`cors`}),!n.ok)return n.status===410?ts:ns}catch{return ns}try{let e=document.createElement(`div`);e.innerHTML=await n.text();let t=e.firstElementChild;if(t?.tagName?.toLowerCase()!==`svg`)return ts;rs||=new DOMParser;let r=rs.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return r?(r.part.add(`svg`),document.adoptNode(r)):ts}catch{return ts}}connectedCallback(){super.connectedCallback(),Qo(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),$o(this)}getIconSource(){let e=es(this.library);return this.name&&e?{url:e.resolver(this.name,this.variant),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){let{url:e,fromLibrary:t}=this.getIconSource(),n=t?es(this.library):void 0;if(!e){this.svg=null;return}let r=is.get(e);if(r||(r=this.resolveIcon(e,n),is.set(e,r)),!this.initialRender)return;let i=await r;if(i===ns&&is.delete(e),e===this.getIconSource().url){if(Uo(i)){if(this.svg=i,n){await this.updateComplete;let e=this.shadowRoot.querySelector(`[part='svg']`);typeof n.mutator==`function`&&e&&n.mutator(e)}return}switch(i){case ns:case ts:this.svg=null,this.emit(`kk-error`);break;default:this.svg=i.cloneNode(!0),n?.mutator?.(this.svg),this.emit(`kk-load`)}}}render(){return this.svg}};P=f(ps),ms=new WeakMap,hs=new WeakMap,gs=new WeakMap,_s=new WeakMap,vs=new WeakMap,ys=new WeakMap,h(P,4,`svg`,fs,bs,ms),h(P,4,`name`,ds,bs,hs),h(P,4,`src`,us,bs,gs),h(P,4,`label`,ls,bs,_s),h(P,4,`library`,cs,bs,vs),h(P,4,`variant`,ss,bs,ys),h(P,1,`handleLabelChange`,os,bs),h(P,1,`setIcon`,as,bs),p(P,bs),g(bs,`styles`,[D,qo]);var xs,Ss,Cs,ws,Ts,Es,Ds,Os,ks,As,js,Ms,Ns,Ps,F,Fs,Is,Ls,Rs,zs,Bs,Vs,Hs,Us,Ws,Gs,Ks,qs,I=class extends (Ps=M,Ns=[A(`.icon-button`)],Ms=[k()],js=[O()],As=[O()],ks=[O()],Os=[O()],Ds=[O()],Es=[O()],Ts=[O()],ws=[O()],Cs=[O({type:Boolean,reflect:!0})],Ss=[O()],xs=[O({reflect:!0})],Ps){constructor(){super(...arguments),_(this,Fs,m(F,8,this)),m(F,11,this),_(this,Is,m(F,12,this,!1)),m(F,15,this),_(this,Ls,m(F,16,this)),m(F,19,this),_(this,Rs,m(F,20,this)),m(F,23,this),_(this,zs,m(F,24,this,`outline`)),m(F,27,this),_(this,Bs,m(F,28,this)),m(F,31,this),_(this,Vs,m(F,32,this)),m(F,35,this),_(this,Hs,m(F,36,this)),m(F,39,this),_(this,Us,m(F,40,this)),m(F,43,this),_(this,Ws,m(F,44,this,``)),m(F,47,this),_(this,Gs,m(F,48,this,!1)),m(F,51,this),_(this,Ks,m(F,52,this,`button`)),m(F,55,this),_(this,qs,m(F,56,this)),m(F,59,this)}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}if(this.type!==`button`){let e=this.form?this.getRootNode().querySelector(`#${this.form}`):this.closest(`form`);e&&Vo(e,this.type)}}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?Ao`a`:Ao`button`;return Mo`
      <${t}
        part="base"
    ...
    `}};F=f(Ps),Fs=new WeakMap,Is=new WeakMap,Ls=new WeakMap,Rs=new WeakMap,zs=new WeakMap,Bs=new WeakMap,Vs=new WeakMap,Hs=new WeakMap,Us=new WeakMap,Ws=new WeakMap,Gs=new WeakMap,Ks=new WeakMap,qs=new WeakMap,h(F,4,`button`,Ns,I,Fs),h(F,4,`hasFocus`,Ms,I,Is),h(F,4,`name`,js,I,Ls),h(F,4,`library`,As,I,Rs),h(F,4,`variant`,ks,I,zs),h(F,4,`src`,Os,I,Bs),h(F,4,`href`,Ds,I,Vs),h(F,4,`target`,Es,I,Hs),h(F,4,`download`,Ts,I,Us),h(F,4,`label`,ws,I,Ws),h(F,4,`disabled`,Cs,I,Gs),h(F,4,`type`,Ss,I,Ks),h(F,4,`form`,xs,I,qs),p(F,I),g(I,`styles`,[D,Do]),g(I,`dependencies`,{"kk-icon":bs});function Js(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}var Ys=class{host;slotNames=[];constructor(e,...t){this.host=e,e.addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!==``)return!0;if(e.nodeType===e.ELEMENT_NODE){let t=e;if(t.tagName.toLowerCase()===`kk-visually-hidden`)return!1;if(!t.hasAttribute(`slot`))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e===`[default]`?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener(`slotchange`,this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener(`slotchange`,this.handleSlotChange)}handleSlotChange=e=>{let t=e.target;(this.slotNames.includes(`[default]`)&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}};function Xs(e){if(!e)return``;let t=e.assignedNodes({flatten:!0}),n=``;return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(n+=e.textContent)}),n}var Zs=C`
  :host {
    display: contents;
...
`,Qs,$s,ec,tc,nc,rc,ic,ac,oc,sc,cc,lc,L,uc,dc,fc,pc,mc,hc,gc,_c,vc,yc=class e extends (lc=M,cc=[A(`[part~="base"]`)],sc=[A(`.alert__countdown-elapsed`)],oc=[O({type:Boolean,reflect:!0})],ac=[O({type:Boolean,reflect:!0})],ic=[O({reflect:!0})],rc=[O({type:Number})],nc=[O({type:String,reflect:!0})],tc=[k()],ec=[k()],$s=[j(`open`,{waitUntilFirstUpdate:!0})],Qs=[j(`duration`)],lc){constructor(){super(...arguments),m(L,5,this),g(this,`autoHideTimeout`),g(this,`remainingTimeInterval`),g(this,`countdownAnimation`),g(this,`hasSlotController`,new Ys(this,`icon`,`suffix`)),g(this,`localize`,new Wi(this)),_(this,uc,m(L,8,this)),m(L,11,this),_(this,dc,m(L,12,this)),m(L,15,this),_(this,fc,m(L,16,this,!1)),m(L,19,this),_(this,pc,m(L,20,this,!1)),m(L,23,this),_(this,mc,m(L,24,this,`primary`)),m(L,27,this),_(this,hc,m(L,28,this,1/0)),m(L,31,this),_(this,gc,m(L,32,this)),m(L,35,this),_(this,_c,m(L,36,this,this.duration)),m(L,39,this),_(this,vc,m(L,40,this,!1)),m(L,43,this)}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`kk-toast-stack`}),this.currentToastStack}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:e}=this;this.countdownAnimation=e.animate([{width:`100%`},{width:`0`}],{duration:this.duration,easing:`linear`})}}handleCloseClick(){this.hide()}async handleOpenChange(){this.transicao=!0,this.open?(this.emit(`kk-show`),this.duration<1/0&&this.restartAutoHide(),await this.esperarTransicao(),this.emit(`kk-after-show`)):(Eo(this),this.emit(`kk-hide`),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await this.esperarTransicao(),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.base.getAnimations().map(e=>e.finished))}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Js(this,`kk-after-show`)}async hide(){if(this.open)return this.open=!1,Js(this,`kk-after-hide`)}async toast(){return new Promise(t=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`kk-after-hide`,()=>{e.toastStack.removeChild(this),t(),e.toastStack.querySelector(`kk-alert`)===null&&e.toastStack.remove()},{once:!0})})}render(){return w`
    ...
    `}};L=f(lc),uc=new WeakMap,dc=new WeakMap,fc=new WeakMap,pc=new WeakMap,mc=new WeakMap,hc=new WeakMap,gc=new WeakMap,_c=new WeakMap,vc=new WeakMap,h(L,4,`base`,cc,yc,uc),h(L,4,`countdownElement`,sc,yc,dc),h(L,4,`open`,oc,yc,fc),h(L,4,`closable`,ac,yc,pc),h(L,4,`variant`,ic,yc,mc),h(L,4,`duration`,rc,yc,hc),h(L,4,`countdown`,nc,yc,gc),h(L,4,`remainingTime`,tc,yc,_c),h(L,4,`transicao`,ec,yc,vc),h(L,1,`handleOpenChange`,$s,yc),h(L,1,`handleDurationChange`,Qs,yc),p(L,yc),g(yc,`styles`,[D,Zs]),g(yc,`dependencies`,{"kk-icon-button":I}),g(yc,`currentToastStack`),yc.define(`kk-alert`);var bc=C`
  :host {
    display: inline-flex;
  }
...
`,xc,Sc,Cc,wc,Tc,Ec,Dc,Oc,kc=class extends (wc=M,Cc=[O({reflect:!0})],Sc=[O({type:Boolean,reflect:!0})],xc=[O({type:Boolean,reflect:!0})],wc){constructor(){super(...arguments),_(this,Ec,m(Tc,8,this,`primary`)),m(Tc,11,this),_(this,Dc,m(Tc,12,this,!1)),m(Tc,15,this),_(this,Oc,m(Tc,16,this,!1)),m(Tc,19,this)}render(){return w`
      <span
        part="base"
    ...
    `}};Tc=f(wc),Ec=new WeakMap,Dc=new WeakMap,Oc=new WeakMap,h(Tc,4,`variant`,Cc,kc,Ec),h(Tc,4,`pill`,Sc,kc,Dc),h(Tc,4,`pulse`,xc,kc,Oc),p(Tc,kc),g(kc,`styles`,[D,bc]),kc.define(`kk-badge`);var Ac=C`
  :host {
...
`,jc=class extends M{static styles=[D,Ac];localize=new Wi(this);render(){return w`
...
`,Nc,Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc,qc,Jc,Yc,Xc,Zc,Qc,$c,el,tl,nl,rl,il,al,ol,sl,cl,R,ll,ul,dl,fl,pl,ml,hl,gl,_l,vl,yl,bl,xl,Sl,Cl,wl,Tl,El,Dl,Ol,kl,Al,jl,Ml,Nl,Pl,Fl,z=class extends (cl=M,sl=[A(`.button`)],ol=[k()],al=[k()],il=[O()],rl=[O({reflect:!0})],nl=[O({reflect:!0})],tl=[O({type:Boolean,reflect:!0})],el=[O({type:Boolean,reflect:!0})],$c=[O({type:Boolean,reflect:!0})],Qc=[O({type:Boolean,reflect:!0})],Zc=[O({type:Boolean,reflect:!0})],Xc=[O({type:Boolean,reflect:!0})],Yc=[O({type:Boolean,reflect:!0})],Jc=[O({type:Boolean,reflect:!0})],qc=[O()],Kc=[O()],Gc=[O()],Wc=[O()],Uc=[O()],Hc=[O()],Vc=[O()],Bc=[O()],zc=[O({attribute:`formaction`})],Rc=[O({attribute:`formenctype`})],Lc=[O({attribute:`formmethod`})],Ic=[O({attribute:`formnovalidate`,type:Boolean})],Fc=[O({attribute:`formtarget`})],Pc=[j(`disabled`,{waitUntilFirstUpdate:!0})],Nc=[j(`loading`,{waitUntilFirstUpdate:!0})],cl){constructor(){super(...arguments),m(R,5,this),g(this,`formControlController`,new zo(this,{assumeInteractionOn:[`click`]})),g(this,`hasSlotController`,new Ys(this,`[default]`,`prefix`,`suffix`)),g(this,`localize`,new Wi(this)),_(this,ll,m(R,8,this)),m(R,11,this),_(this,ul,m(R,12,this,!1)),m(R,15,this),_(this,dl,m(R,16,this,!1)),m(R,19,this),_(this,fl,m(R,20,this,``)),m(R,23,this),_(this,pl,m(R,24,this,`default`)),m(R,27,this),_(this,ml,m(R,28,this,`medium`)),m(R,31,this),_(this,hl,m(R,32,this,!1)),m(R,35,this),_(this,gl,m(R,36,this,!1)),m(R,39,this),_(this,_l,m(R,40,this,!1)),m(R,43,this),_(this,vl,m(R,44,this,!1)),m(R,47,this),_(this,yl,m(R,48,this,!1)),m(R,51,this),_(this,bl,m(R,52,this,!1)),m(R,55,this),_(this,xl,m(R,56,this,!1)),m(R,59,this),_(this,Sl,m(R,60,this,!1)),m(R,63,this),_(this,Cl,m(R,64,this,`button`)),m(R,67,this),_(this,wl,m(R,68,this,``)),m(R,71,this),_(this,Tl,m(R,72,this,``)),m(R,75,this),_(this,El,m(R,76,this,``)),m(R,79,this),_(this,Dl,m(R,80,this)),m(R,83,this),_(this,Ol,m(R,84,this,`noreferrer noopener`)),m(R,87,this),_(this,kl,m(R,88,this)),m(R,91,this),_(this,Al,m(R,92,this)),m(R,95,this),_(this,jl,m(R,96,this)),m(R,99,this),_(this,Ml,m(R,100,this)),m(R,103,this),_(this,Nl,m(R,104,this)),m(R,107,this),_(this,Pl,m(R,108,this)),m(R,111,this),_(this,Fl,m(R,112,this)),m(R,115,this)}get validity(){return this.isButton()?this.button.validity:Bo}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.isButton()&&this.formControlController.updateValidity()}handleLoadingChange(){this.toggleState(`--loading`,this.loading)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?Ao`a`:Ao`button`;return Mo`
      <${t}
        part="base"
        ...
        @click=${this.handleClick}
      >
        ${this.swipe?Mo`<span part="decor" class="button__decor"></span>`:``}
        <slot name="prefix" part="prefix" class="button__prefix"></slot>
        ${this.expand?Mo`<span class="button__reveal"><slot part="label" class="button__label"></slot></span>`:Mo`<slot part="label" class="button__label"></slot>`}
        <slot name="suffix" part="suffix" class="button__suffix"></slot>
        ${this.caret?Mo` <kk-icon part="caret" class="button__caret" library="system" name="caret"></kk-icon> `:``}
        ${this.loading?Mo`<kk-spinner part="spinner"></kk-spinner>`:``}
      </${t}>
    `}};R=f(cl),ll=new WeakMap,ul=new WeakMap,dl=new WeakMap,fl=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,vl=new WeakMap,yl=new WeakMap,bl=new WeakMap,xl=new WeakMap,Sl=new WeakMap,Cl=new WeakMap,wl=new WeakMap,Tl=new WeakMap,El=new WeakMap,Dl=new WeakMap,Ol=new WeakMap,kl=new WeakMap,Al=new WeakMap,jl=new WeakMap,Ml=new WeakMap,Nl=new WeakMap,Pl=new WeakMap,Fl=new WeakMap,h(R,4,`button`,sl,z,ll),h(R,4,`hasFocus`,ol,z,ul),h(R,4,`invalid`,al,z,dl),h(R,4,`title`,il,z,fl),h(R,4,`variant`,rl,z,pl),h(R,4,`size`,nl,z,ml),h(R,4,`caret`,tl,z,hl),h(R,4,`disabled`,el,z,gl),h(R,4,`loading`,$c,z,_l),h(R,4,`outline`,Qc,z,vl),h(R,4,`pill`,Zc,z,yl),h(R,4,`circle`,Xc,z,bl),h(R,4,`swipe`,Yc,z,xl),h(R,4,`expand`,Jc,z,Sl),h(R,4,`type`,qc,z,Cl),h(R,4,`name`,Kc,z,wl),h(R,4,`value`,Gc,z,Tl),h(R,4,`href`,Wc,z,El),h(R,4,`target`,Uc,z,Dl),h(R,4,`rel`,Hc,z,Ol),h(R,4,`download`,Vc,z,kl),h(R,4,`form`,Bc,z,Al),h(R,4,`formAction`,zc,z,jl),h(R,4,`formEnctype`,Rc,z,Ml),h(R,4,`formMethod`,Lc,z,Nl),h(R,4,`formNoValidate`,Ic,z,Pl),h(R,4,`formTarget`,Fc,z,Fl),h(R,1,`handleDisabledChange`,Pc,z),h(R,1,`handleLoadingChange`,Nc,z),p(R,z),g(z,`styles`,[D,Mc]),g(z,`dependencies`,{"kk-icon":bs,"kk-spinner":jc}),z.define(`kk-button`);var Il=C`
  :host {
...
`,Ll,Rl,zl,Bl,Vl,Hl,Ul=class extends (zl=M,Rl=[O({reflect:!0})],Ll=[O({reflect:!0})],zl){constructor(){super(...arguments),g(this,`hasSlotController`,new Ys(this,`footer`,`header`,`image`)),_(this,Vl,m(Bl,8,this,`vertical`)),m(Bl,11,this),_(this,Hl,m(Bl,12,this,`default`)),m(Bl,15,this)}render(){return w`
      <div
        part="base"
    ...
    `}};Bl=f(zl),Vl=new WeakMap,Hl=new WeakMap,h(Bl,4,`orientation`,Rl,Ul,Vl),h(Bl,4,`variant`,Ll,Ul,Hl),p(Bl,Ul),g(Ul,`styles`,[D,Il]),Ul.define(`kk-card`);var Wl=C`
  :host {
    display: block;
  }
...
`,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,$l,eu,tu,B,nu,ru,iu,au,ou,su,cu,lu,uu,du=class extends (tu=M,eu=[A(`.details`)],$l=[A(`.details__header`)],Ql=[A(`.details__body`)],Zl=[A(`.details__expand-icon-slot`)],Xl=[k()],Yl=[O({type:Boolean,reflect:!0})],Jl=[O()],ql=[O({type:Boolean,reflect:!0})],Kl=[O({reflect:!0})],Gl=[j(`open`,{waitUntilFirstUpdate:!0})],tu){constructor(){super(...arguments),m(B,5,this),g(this,`localize`,new Wi(this)),_(this,nu,m(B,8,this)),m(B,11,this),_(this,ru,m(B,12,this)),m(B,15,this),_(this,iu,m(B,16,this)),m(B,19,this),_(this,au,m(B,20,this)),m(B,23,this),g(this,`detailsObserver`),_(this,ou,m(B,24,this,!1)),m(B,27,this),_(this,su,m(B,28,this,!1)),m(B,31,this),_(this,cu,m(B,32,this)),m(B,35,this),_(this,lu,m(B,36,this,!1)),m(B,39,this),_(this,uu,m(B,40,this)),m(B,43,this)}firstUpdated(){this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.transicao=!0,this.open){if(this.details.open=!0,this.emit(`kk-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await this.esperarTransicao(),this.emit(`kk-after-show`)}else{if(this.emit(`kk-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await this.esperarTransicao(),this.open||(this.details.open=!1),this.emit(`kk-after-hide`)}}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.body.getAnimations().map(e=>e.finished))}async show(){if(!(this.open||this.disabled))return this.open=!0,Js(this,`kk-after-show`)}async hide(){if(this.open&&!this.disabled)return this.open=!1,Js(this,`kk-after-hide`)}render(){let e=this.localize.dir()===`rtl`;return w`
      <details
        part="base"
    ...
    `}};B=f(tu),nu=new WeakMap,ru=new WeakMap,iu=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,h(B,4,`details`,eu,du,nu),h(B,4,`header`,$l,du,ru),h(B,4,`body`,Ql,du,iu),h(B,4,`expandIconSlot`,Zl,du,au),h(B,4,`transicao`,Xl,du,ou),h(B,4,`open`,Yl,du,su),h(B,4,`summary`,Jl,du,cu),h(B,4,`disabled`,ql,du,lu),h(B,4,`name`,Kl,du,uu),h(B,1,`handleOpenChange`,Gl,du),p(B,du),g(du,`styles`,[D,Wl]),g(du,`dependencies`,{"kk-icon":bs}),du.define(`kk-details`);var fu=C`
  :host {
    display: contents;
  }
...
`,pu,mu,hu,gu,_u,vu,yu,bu,xu,Su,Cu,wu=class extends (vu=M,_u=[A(`.dialog`)],gu=[O({type:Boolean,reflect:!0})],hu=[O({reflect:!0})],mu=[O({attribute:`no-header`,type:Boolean,reflect:!0})],pu=[j(`open`,{waitUntilFirstUpdate:!0})],vu){constructor(){super(...arguments),m(yu,5,this),g(this,`hasSlotController`,new Ys(this,`footer`)),g(this,`localize`,new Wi(this)),_(this,bu,m(yu,8,this)),m(yu,11,this),_(this,xu,m(yu,12,this,!1)),m(yu,15,this),_(this,Su,m(yu,16,this,``)),m(yu,19,this),_(this,Cu,m(yu,20,this,!1)),m(yu,23,this)}requestClose(e){this.emit(`kk-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented||this.hide()}firstUpdated(){this.open&&this.abrir()}abrir(){this.dialog.open||(this.dialog.showModal(),this.emit(`kk-initial-focus`,{cancelable:!0}))}fechar(){this.dialog.open&&this.dialog.close()}handleOpenChange(){this.open?(this.emit(`kk-show`),this.abrir(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.fechar(),this.emit(`kk-after-hide`))}async show(){this.open||=!0}async hide(){this.open&&=!1}handleCancel(e){e.preventDefault(),this.requestClose(`keyboard`)}handleClose(){this.open=!1}render(){return w`
      <dialog
        part="base"
        class="dialog"
    ...
    `}};yu=f(vu),bu=new WeakMap,xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,h(yu,4,`dialog`,_u,wu,bu),h(yu,4,`open`,gu,wu,xu),h(yu,4,`label`,hu,wu,Su),h(yu,4,`noHeader`,mu,wu,Cu),h(yu,1,`handleOpenChange`,pu,wu),p(yu,wu),g(wu,`styles`,[D,fu]),g(wu,`dependencies`,{"kk-icon-button":I}),wu.define(`kk-dialog`);var Tu=C`
  :host {
...
`,Eu={top:`bottom`,bottom:`top`,left:`right`,right:`left`};function Du(e){return e.split(`-`)[0]}function Ou(e){return e.split(`-`)[1]}function ku(e){return e===`top`||e===`bottom`}function Au(e){let t=Ou(e),n=Eu[Du(e)];return t===void 0?n:`${n}-${t}`}function ju(e,t){let n={esquerda:0,topo:0,direita:window.innerWidth,base:window.innerHeight},r=e===void 0?[]:Array.isArray(e)?e:[e];for(let e of r){let t=e.getBoundingClientRect();n.esquerda=Math.max(n.esquerda,t.left),n.topo=Math.max(n.topo,t.top),n.direita=Math.min(n.direita,t.right),n.base=Math.min(n.base,t.bottom)}return{esquerda:n.esquerda+t,topo:n.topo+t,direita:n.direita-t,base:n.base-t}}function Mu(e,t,n,r,i,a){let o=Du(r),s=Ou(r),c=0,l=0;return ku(o)?(l=o===`top`?e.top-n-i:e.bottom+i,c=s===`start`?e.left:s===`end`?e.right-t:e.left+(e.width-t)/2,c+=a):(c=o===`left`?e.left-t-i:e.right+i,l=s===`start`?e.top:s===`end`?e.bottom-n:e.top+(e.height-n)/2,l+=a),{x:c,y:l}}function Nu(e,t,n,r,i){return Math.max(0,i.esquerda-e)+Math.max(0,i.topo-t)+Math.max(0,e+n-i.direita)+Math.max(0,t+r-i.base)}function Pu(e,t,n,r,i,a){switch(i){case`top`:return Math.max(0,a.topo-t);case`bottom`:return Math.max(0,t+r-a.base);case`left`:return Math.max(0,a.esquerda-e);case`right`:return Math.max(0,e+n-a.direita)}}function Fu(e,t,n,r){let i=r.direita-r.esquerda,a=r.base-r.topo;switch(t){case`top`:return{largura:i,altura:e.top-r.topo-n};case`bottom`:return{largura:i,altura:r.base-e.bottom-n};case`left`:return{largura:e.left-r.esquerda-n,altura:a};case`right`:return{largura:r.direita-e.right-n,altura:a}}}function Iu(e){let t=e.contextElement??(e instanceof Element?e:void 0);if(t===void 0)return!1;let n=t.getBoundingClientRect();if(n.width===0&&n.height===0)return!0;for(let e=t.parentElement;e!==null;e=e.parentElement){let t=getComputedStyle(e);if(!/auto|scroll|hidden|clip/.test(t.overflow+t.overflowX+t.overflowY))continue;let r=e.getBoundingClientRect();if(n.bottom<=r.top||n.top>=r.bottom||n.right<=r.left||n.left>=r.right)return!0}return!1}function Lu(e,t,n){let r=n.distancia??0,i=n.desvio??0,a=e.getBoundingClientRect();if(n.espelhar!==void 0){let e=n.espelhar===`width`||n.espelhar===`both`,r=n.espelhar===`height`||n.espelhar===`both`;t.style.width=e?`${a.width}px`:``,t.style.height=r?`${a.height}px`:``}else t.style.width=``,t.style.height=``;let o=t.offsetWidth,s=t.offsetHeight,c=n.posicionamento,l=ju(n.virarLimite,n.virarPreenchimento??0);if(n.virar===!0){let e=[n.posicionamento,...n.virarAlternativas??[Au(n.posicionamento)]],t=n.posicionamento,u=1/0,d=!1;for(let n of e){let{x:e,y:c}=Mu(a,o,s,n,r,i);if(Pu(e,c,o,s,Du(n),l)===0){t=n,d=!0;break}let ee=Nu(e,c,o,s,l);ee<u&&(u=ee,t=n)}c=d||(n.virarEstrategia??`melhor-encaixe`)===`melhor-encaixe`?t:n.posicionamento}let u=Du(c),{x:d,y:ee}=Mu(a,o,s,c,r,i);if(n.deslizar===!0){let e=ju(n.deslizarLimite,n.deslizarPreenchimento??0);ku(u)?d=Math.min(Math.max(d,e.esquerda),Math.max(e.esquerda,e.direita-o)):ee=Math.min(Math.max(ee,e.topo),Math.max(e.topo,e.base-s))}let te=n.medirEspaco===!0?Fu(a,u,r,ju(n.medirLimite,n.medirPreenchimento??0)):{largura:1/0,altura:1/0},ne={};if(n.seta!==void 0){let e=n.setaPreenchimento??0,t=ku(u)?n.seta.offsetWidth:n.seta.offsetHeight;if(ku(u)){let n=a.left+a.width/2-d-t/2;ne.x=Math.min(Math.max(n,e),o-t-e)}else{let n=a.top+a.height/2-ee-t/2;ne.y=Math.min(Math.max(n,e),s-t-e)}}return{x:Math.round(d),y:Math.round(ee),posicionamento:c,espacoLivre:te,ancoraOculta:Iu(e),seta:ne}}function Ru(e,t,n){let r=e.contextElement??(e instanceof Element?e:void 0),i=[window];for(let e=r?.parentElement??null;e!==null;e=e.parentElement){let t=getComputedStyle(e);/auto|scroll|overlay/.test(t.overflow+t.overflowX+t.overflowY)&&i.push(e)}for(let e of i)e.addEventListener(`scroll`,n,{passive:!0,capture:!0});window.addEventListener(`resize`,n,{passive:!0});let a=new ResizeObserver(n);return r!==void 0&&a.observe(r),a.observe(t),n(),()=>{for(let e of i)e.removeEventListener(`scroll`,n,{capture:!0});window.removeEventListener(`resize`,n),a.disconnect()}}function zu(e){return(Array.isArray(e)?e:String(e).split(` `)).map(e=>e.trim()).filter(e=>e!==``)}function Bu(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e.contextElement instanceof Element:!0)}var Vu,Hu,Uu,Wu,Gu,Ku,qu,Ju,Yu,Xu,Zu,Qu,$u,ed,td,nd,rd,id,ad,od,sd,cd,ld,ud,dd,V,fd,pd,md,hd,gd,_d,vd,yd,bd,xd,Sd,Cd,wd,Td,Ed,Dd,Od,kd,Ad,jd,Md,Nd,Pd,Fd,H=class extends (dd=M,ud=[A(`.popup`)],ld=[A(`.popup__arrow`)],cd=[A(`.popup-hover-bridge`)],sd=[O()],od=[O({type:Boolean,reflect:!0})],ad=[O({reflect:!0})],id=[O({type:Number})],rd=[O({type:Number})],nd=[O({type:Boolean})],td=[O({attribute:`arrow-placement`})],ed=[O({attribute:`arrow-padding`,type:Number})],$u=[O({type:Boolean})],Qu=[O({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],Zu=[O({attribute:`flip-fallback-strategy`})],Xu=[O({type:Object})],Yu=[O({attribute:`flip-padding`,type:Number})],Ju=[O({type:Boolean})],qu=[O({type:Object})],Ku=[O({attribute:`shift-padding`,type:Number})],Gu=[O({attribute:`auto-size`})],Wu=[O()],Uu=[O({type:Object})],Hu=[O({attribute:`auto-size-padding`,type:Number})],Vu=[O({attribute:`hover-bridge`,type:Boolean})],dd){constructor(){super(...arguments),g(this,`anchorEl`),g(this,`cleanup`),g(this,`localize`,new Wi(this)),_(this,fd,m(V,8,this)),m(V,11,this),_(this,pd,m(V,12,this)),m(V,15,this),_(this,md,m(V,16,this)),m(V,19,this),_(this,hd,m(V,20,this)),m(V,23,this),_(this,gd,m(V,24,this,!1)),m(V,27,this),_(this,_d,m(V,28,this,`top`)),m(V,31,this),_(this,vd,m(V,32,this,0)),m(V,35,this),_(this,yd,m(V,36,this,0)),m(V,39,this),_(this,bd,m(V,40,this,!1)),m(V,43,this),_(this,xd,m(V,44,this,`anchor`)),m(V,47,this),_(this,Sd,m(V,48,this,10)),m(V,51,this),_(this,Cd,m(V,52,this,!1)),m(V,55,this),_(this,wd,m(V,56,this,``)),m(V,59,this),_(this,Td,m(V,60,this,`best-fit`)),m(V,63,this),_(this,Ed,m(V,64,this)),m(V,67,this),_(this,Dd,m(V,68,this,0)),m(V,71,this),_(this,Od,m(V,72,this,!1)),m(V,75,this),_(this,kd,m(V,76,this)),m(V,79,this),_(this,Ad,m(V,80,this,0)),m(V,83,this),_(this,jd,m(V,84,this)),m(V,87,this),_(this,Md,m(V,88,this)),m(V,91,this),_(this,Nd,m(V,92,this)),m(V,95,this),_(this,Pd,m(V,96,this,0)),m(V,99,this),_(this,Fd,m(V,100,this,!1)),m(V,103,this),g(this,`updateHoverBridge`,()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--kk-popup-hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--kk-popup-hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--kk-popup-hover-bridge-bottom-right-y`,`${u}px`)}})}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),(e.has(`active`)||e.has(`hoverBridge`))&&this.syncTopLayer(),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}syncTopLayer(){if(!this.isConnected||!this.popup||!this.hoverBridgeEl)return;let e=this.active&&this.hoverBridge;e&&!this.hoverBridgeEl.matches(`:popover-open`)&&this.popup.matches(`:popover-open`)&&this.popup.hidePopover(),e!==this.hoverBridgeEl.matches(`:popover-open`)&&(e?this.hoverBridgeEl.showPopover():this.hoverBridgeEl.hidePopover()),this.active!==this.popup.matches(`:popover-open`)&&(this.active?this.popup.showPopover():this.popup.hidePopover())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor==`string`){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchorEl=this.anchor instanceof Element||Bu(this.anchor)?this.anchor:this.querySelector(`[slot="anchor"]`);this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Ru(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.removeAttribute(`data-anchor-hidden`),this.style.removeProperty(`--kk-popup-auto-size-available-width`),this.style.removeProperty(`--kk-popup-auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let{x:e,y:t,posicionamento:n,espacoLivre:r,ancoraOculta:i,seta:a}=Lu(this.anchorEl,this.popup,{posicionamento:this.placement,distancia:this.distance,desvio:this.skidding,virar:this.flip,...this.flipFallbackPlacements.length>0?{virarAlternativas:zu(this.flipFallbackPlacements)}:{},virarEstrategia:this.flipFallbackStrategy===`best-fit`?`melhor-encaixe`:`inicial`,virarLimite:this.flipBoundary,virarPreenchimento:this.flipPadding,deslizar:this.shift,deslizarLimite:this.shiftBoundary,deslizarPreenchimento:this.shiftPadding,medirEspaco:!!this.autoSize,medirLimite:this.autoSizeBoundary,medirPreenchimento:this.autoSizePadding,...this.sync?{espelhar:this.sync}:{},...this.arrow?{seta:this.arrowEl,setaPreenchimento:this.arrowPadding}:{}});if(this.setAttribute(`data-current-placement`,n),this.toggleAttribute(`data-anchor-hidden`,i),this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-height`,`${r.altura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--kk-popup-auto-size-available-width`,`${r.largura}px`):this.style.removeProperty(`--kk-popup-auto-size-available-width`),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=this.localize.dir()===`rtl`,t={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[n.split(`-`)[0]],r=``,i=``,o=``,s=``;if(this.arrowPlacement===`start`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;r=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``,i=e?t:``,s=e?``:t}else if(this.arrowPlacement===`end`){let t=typeof a.x==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``;i=e?``:t,s=e?t:``,o=typeof a.y==`number`?`calc(${this.arrowPadding}px - var(--kk-popup-arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(s=typeof a.x==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``,r=typeof a.y==`number`?`calc(50% - var(--kk-popup-arrow-size-diagonal))`:``):(s=typeof a.x==`number`?`${a.x}px`:``,r=typeof a.y==`number`?`${a.y}px`:``);Object.assign(this.arrowEl.style,{top:r,right:i,bottom:o,left:s,[t]:`calc(var(--kk-popup-arrow-size-diagonal) * -1)`})}requestAnimationFrame(()=>this.updateHoverBridge()),this.emit(`kk-reposition`)}render(){return w`
    ...
    `}};V=f(dd),fd=new WeakMap,pd=new WeakMap,md=new WeakMap,hd=new WeakMap,gd=new WeakMap,_d=new WeakMap,vd=new WeakMap,yd=new WeakMap,bd=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,h(V,4,`popup`,ud,H,fd),h(V,4,`arrowEl`,ld,H,pd),h(V,4,`hoverBridgeEl`,cd,H,md),h(V,4,`anchor`,sd,H,hd),h(V,4,`active`,od,H,gd),h(V,4,`placement`,ad,H,_d),h(V,4,`distance`,id,H,vd),h(V,4,`skidding`,rd,H,yd),h(V,4,`arrow`,nd,H,bd),h(V,4,`arrowPlacement`,td,H,xd),h(V,4,`arrowPadding`,ed,H,Sd),h(V,4,`flip`,$u,H,Cd),h(V,4,`flipFallbackPlacements`,Qu,H,wd),h(V,4,`flipFallbackStrategy`,Zu,H,Td),h(V,4,`flipBoundary`,Xu,H,Ed),h(V,4,`flipPadding`,Yu,H,Dd),h(V,4,`shift`,Ju,H,Od),h(V,4,`shiftBoundary`,qu,H,kd),h(V,4,`shiftPadding`,Ku,H,Ad),h(V,4,`autoSize`,Gu,H,jd),h(V,4,`sync`,Wu,H,Md),h(V,4,`autoSizeBoundary`,Uu,H,Nd),h(V,4,`autoSizePadding`,Hu,H,Pd),h(V,4,`hoverBridge`,Vu,H,Fd),p(V,H),g(H,`styles`,[D,Tu]);function*Id(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Id(e.shadowRoot.activeElement)))}function Ld(){return[...Id()].pop()}var Rd=new WeakMap;function zd(e){let t=Rd.get(e);return t||(t=window.getComputedStyle(e,null),Rd.set(e,t)),t}function Bd(e){if(typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=zd(e);return t.visibility!==`hidden`&&t.display!==`none`}function Vd(e){let{overflowY:t,overflowX:n}=zd(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function Hd(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));if(e.hasAttribute(`tabindex`)&&(Number.isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`))return!1;if(t===`input`&&e.getAttribute(`type`)===`radio`){let t=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute(`name`)}"]`,r=t.querySelector(`${n}:checked`);return r?r===e:t.querySelector(n)===e}return Bd(e)?(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:Vd(e):!1}function Ud(e){let t=Gd(e);return{start:t[0]??null,end:t.at(-1)??null}}function Wd(e,t){return e.getRootNode({composed:!0})?.host!==t}function Gd(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),i instanceof HTMLElement&&!n.includes(i)&&Hd(i)&&n.push(i),i instanceof HTMLSlotElement&&Wd(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of i.children)r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var Kd=C`
  :host {
    display: inline-block;
  }
...
`,qd,Jd,Yd,Xd,Zd,Qd,$d,ef,tf,nf,rf,af,of,U,sf,cf,lf,uf,df,ff,pf,mf,hf,gf,_f,vf=class extends (of=M,af=[A(`.dropdown`)],rf=[A(`.dropdown__trigger`)],nf=[A(`.dropdown__panel`)],tf=[O({type:Boolean,reflect:!0})],ef=[O({reflect:!0})],$d=[O({type:Boolean,reflect:!0})],Qd=[O({attribute:`stay-open-on-select`,type:Boolean,reflect:!0})],Zd=[O({attribute:!1})],Xd=[O({type:Number})],Yd=[O({type:Number})],Jd=[O({reflect:!0})],qd=[j(`open`,{waitUntilFirstUpdate:!0})],of){constructor(){super(...arguments),m(U,5,this),_(this,sf,m(U,8,this)),m(U,11,this),_(this,cf,m(U,12,this)),m(U,15,this),_(this,lf,m(U,16,this)),m(U,19,this),g(this,`closeWatcher`),_(this,uf,m(U,20,this,!1)),m(U,23,this),_(this,df,m(U,24,this,`bottom-start`)),m(U,27,this),_(this,ff,m(U,28,this,!1)),m(U,31,this),_(this,pf,m(U,32,this,!1)),m(U,35,this),_(this,mf,m(U,36,this)),m(U,39,this),_(this,hf,m(U,40,this,0)),m(U,43,this),_(this,gf,m(U,44,this,0)),m(U,47,this),_(this,_f,m(U,48,this)),m(U,51,this),g(this,`handleKeyDown`,e=>{this.open&&e.key===`Escape`&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())}),g(this,`handleDocumentKeyDown`,e=>{if(e.key===`Escape`&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key===`Tab`){if(this.open&&document.activeElement?.tagName.toLowerCase()===`kk-menu-item`){e.preventDefault(),this.hide(),this.focusOnTrigger();return}let t=(e,n)=>{if(!e)return null;let r=e.closest(n);if(r)return r;let i=e.getRootNode();return i instanceof ShadowRoot?t(i.host,n):null};setTimeout(()=>{let e=this.containingElement?.getRootNode()instanceof ShadowRoot?Ld():document.activeElement;(!this.containingElement||t(e,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}}),g(this,`handleDocumentMouseDown`,e=>{let t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()}),g(this,`handlePanelSelect`,e=>{let t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()===`kk-menu`&&(this.hide(),this.focusOnTrigger())})}connectedCallback(){super.connectedCallback(),this.containingElement||=this}firstUpdated(){this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){let e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus==`function`&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()===`kk-menu`)}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([` `,`Enter`].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}let t=this.getMenu();if(t){let n=t.getAllItems();if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){e.preventDefault(),this.open||(this.show(),await this.updateComplete);let r=e.key===`ArrowDown`||e.key===`Home`?n.at(0):n.at(-1);r&&this.updateComplete.then(()=>{t.setCurrentItem(r),r.focus()})}}}handleTriggerKeyUp(e){e.key===` `&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){let e=this.trigger.assignedElements({flatten:!0}).find(e=>Ud(e).start),t;if(e){switch(e.tagName.toLowerCase()){case`kk-button`:case`kk-icon-button`:t=e.button;break;default:t=e}t.setAttribute(`aria-haspopup`,`true`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`)}}async show(){if(!this.open)return this.open=!0,Js(this,`kk-after-show`)}painelTemFoco(){let e=this.panel?.assignedElements({flatten:!0})??[];for(let t of Id())if(e.some(e=>e===t||e.contains(t)))return!0;return!1}async hide(){if(this.open)return this.painelTemFoco()&&this.focusOnTrigger(),this.open=!1,Js(this,`kk-after-hide`)}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener(`kk-select`,this.handlePanelSelect),`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`mousedown`,this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener(`kk-select`,this.handlePanelSelect),this.panel.removeEventListener(`keydown`,this.handleKeyDown)),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`mousedown`,this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}this.updateAccessibleTrigger(),this.open?(this.emit(`kk-show`),this.addOpenListeners(),this.popup.active=!0,await this.esperarTransicao(),this.emit(`kk-after-show`)):(this.emit(`kk-hide`),this.removeOpenListeners(),await this.esperarTransicao(),this.open||(this.popup.active=!1),this.emit(`kk-after-hide`))}async esperarTransicao(){await this.updateComplete,await Promise.allSettled(this.popup.popup.getAnimations().map(e=>e.finished))}render(){return w`
      <kk-popup
        part="base"
    ...
    `}};U=f(of),sf=new WeakMap,cf=new WeakMap,lf=new WeakMap,uf=new WeakMap,df=new WeakMap,ff=new WeakMap,pf=new WeakMap,mf=new WeakMap,hf=new WeakMap,gf=new WeakMap,_f=new WeakMap,h(U,4,`popup`,af,vf,sf),h(U,4,`trigger`,rf,vf,cf),h(U,4,`panel`,nf,vf,lf),h(U,4,`open`,tf,vf,uf),h(U,4,`placement`,ef,vf,df),h(U,4,`disabled`,$d,vf,ff),h(U,4,`stayOpenOnSelect`,Qd,vf,pf),h(U,4,`containingElement`,Zd,vf,mf),h(U,4,`distance`,Xd,vf,hf),h(U,4,`skidding`,Yd,vf,gf),h(U,4,`sync`,Jd,vf,_f),h(U,1,`handleOpenChange`,qd,vf),p(U,vf),g(vf,`styles`,[D,Kd]),g(vf,`dependencies`,{"kk-popup":H}),vf.define(`kk-dropdown`);var yf=C`
  :host {
    display: block;
    position: relative;
...
`,bf,xf,Sf,Cf,wf=class extends (xf=M,bf=[A(`slot`)],xf){constructor(){super(...arguments),_(this,Cf,m(Sf,8,this)),m(Sf,11,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`menu`)}handleClick(e){let t=[`menuitem`,`menuitemcheckbox`],n=e.composedPath(),r=n.find(e=>e instanceof Element&&t.includes(e.getAttribute(`role`)??``));if(!r||n.find(e=>e instanceof Element&&e.getAttribute(`role`)===`menu`)!==this)return;let i=r;i.type===`checkbox`&&(i.checked=!i.checked),this.emit(`kk-select`,{detail:{item:i}})}handleKeyDown(e){if(e.key===`Enter`||e.key===` `){let t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){let t=this.getAllItems(),n=this.getCurrentItem(),r=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key===`ArrowDown`?r++:e.key===`ArrowUp`?r--:e.key===`Home`?r=0:e.key===`End`&&(r=t.length-1),r<0&&(r=t.length-1),r>t.length-1&&(r=0),this.setCurrentItem(t[r]),t[r].focus())}}handleMouseDown(e){let t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){let e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()===`kk-menu-item`||[`menuitem`,`menuitemcheckbox`,`menuitemradio`].includes(e.getAttribute(`role`)??``)}getAllItems(){return this.defaultSlot.assignedElements({flatten:!0}).filter(e=>!(!(e instanceof HTMLElement)||e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute(`tabindex`)===`0`)}setCurrentItem(e){this.getAllItems().forEach(t=>{t.setAttribute(`tabindex`,t===e?`0`:`-1`)})}render(){return w`
      ...
      ></slot>
    `}};Sf=f(xf),Cf=new WeakMap,h(Sf,4,`defaultSlot`,bf,wf,Cf),p(Sf,wf),g(wf,`styles`,[D,yf]);var Tf=C`
  :host {
...
`,Ef=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Ef(e,t);return!0},Df=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Of=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),jf(t)}};function kf(e){this._$AN===void 0?this._$AM=e:(Df(this),this._$AM=e,Of(this))}function Af(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0){if(t){if(Array.isArray(r))for(let e=n;e<r.length;e++)Ef(r[e],!1),Df(r[e]);else r!=null&&(Ef(r,!1),Df(r))}else Ef(this,e)}}var jf=e=>{e.type==no.CHILD&&(e._$AP??=Af,e._$AQ??=kf)},Mf=class extends io{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Of(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ef(this,e),Df(this))}setValue(e){if(Wo(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Nf=()=>new Pf,Pf=class{},Ff=new WeakMap,If=ro(class extends Mf{render(e){return T}update(e,[t]){let n=t!==this.G;return n&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),T}rt(e){if(this.G!==void 0){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=Ff.get(t);n===void 0&&(n=new WeakMap,Ff.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}}get lt(){return typeof this.G==`function`?Ff.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Lf=class{host;popupRef=Nf();enableSubmenuTimer=-1;isConnected=!1;isPopupConnected=!1;skidding=0;hasSlotController;submenuOpenDelay=100;constructor(e,t){this.host=e,e.addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test(`submenu`)&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test(`submenu`)&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||=(this.host.addEventListener(`mousemove`,this.handleMouseMove),this.host.addEventListener(`mouseover`,this.handleMouseOver),this.host.addEventListener(`keydown`,this.handleKeyDown),this.host.addEventListener(`click`,this.handleClick),this.host.addEventListener(`focusout`,this.handleFocusOut),!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.addEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&=(this.host.removeEventListener(`mousemove`,this.handleMouseMove),this.host.removeEventListener(`mouseover`,this.handleMouseOver),this.host.removeEventListener(`keydown`,this.handleKeyDown),this.host.removeEventListener(`click`,this.handleClick),this.host.removeEventListener(`focusout`,this.handleFocusOut),!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.removeEventListener(`kk-reposition`,this.handlePopupReposition),this.isPopupConnected=!1)}handleMouseMove=e=>{this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-x`,`${e.clientX}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-cursor-y`,`${e.clientY}px`)};handleMouseOver=()=>{this.hasSlotController.test(`submenu`)&&this.enableSubmenu()};handleSubmenuEntry(e){let t=this.host.renderRoot.querySelector(`slot[name='submenu']`);if(!t){console.error(`Cannot activate a submenu if no corresponding menuitem can be found.`,this);return}let n=null;for(let e of t.assignedElements())if(n=e.querySelectorAll(`kk-menu-item, [role^='menuitem']`),n.length!==0)break;if(n&&n.length!==0){n[0].setAttribute(`tabindex`,`0`);for(let e=1;e!==n.length;++e)n[e].setAttribute(`tabindex`,`-1`);this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?n[0]instanceof HTMLElement&&n[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{n[0]instanceof HTMLElement&&n[0].focus()}),this.host.requestUpdate()))}}handleKeyDown=e=>{switch(e.key){case`Escape`:case`Tab`:this.disableSubmenu();break;case`ArrowLeft`:e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case`ArrowRight`:case`Enter`:case` `:this.handleSubmenuEntry(e)}};handleClick=e=>{e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName===`kk-menu-item`||e.target.role?.startsWith(`menuitem`))&&this.disableSubmenu()};handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu()};handlePopupMouseover=e=>{e.stopPropagation()};handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector(`slot[name='submenu']`)?.assignedElements({flatten:!0}).filter(e=>e.localName===`kk-menu`)[0],t=getComputedStyle(this.host).direction===`rtl`;if(!e)return;let{left:n,top:r,width:i,height:a}=e.getBoundingClientRect();this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-start-y`,`${r}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--kk-menu-item-safe-triangle-submenu-end-y`,`${r+a}px`)};setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;let e=this.host.parentElement.computedStyleMap(),t=[`padding-top`,`border-top-width`,`margin-top`].reduce((t,n)=>{let r=e.get(n)??new CSSUnitValue(0,`px`);return t-(r instanceof CSSUnitValue?r:new CSSUnitValue(0,`px`)).to(`px`).value},0);this.skidding=t}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){let e=getComputedStyle(this.host).direction===`rtl`;return this.isConnected?w`
    ...
    `:w` <slot name="submenu" hidden></slot> `}},Rf,zf,Bf,Vf,Hf,Uf,Wf,Gf,Kf,qf,Jf,W,Yf,Xf,Zf,Qf,$f,ep,tp,np=class extends (Jf=M,qf=[A(`slot:not([name])`)],Kf=[A(`.menu-item`)],Gf=[O()],Wf=[O({type:Boolean,reflect:!0})],Uf=[O()],Hf=[O({type:Boolean,reflect:!0})],Vf=[O({type:Boolean,reflect:!0})],Bf=[j(`checked`)],zf=[j(`disabled`)],Rf=[j(`type`)],Jf){constructor(){super(...arguments),m(W,5,this),g(this,`cachedTextLabel`),g(this,`localize`,new Wi(this)),_(this,Yf,m(W,8,this)),m(W,11,this),_(this,Xf,m(W,12,this)),m(W,15,this),_(this,Zf,m(W,16,this,`normal`)),m(W,19,this),_(this,Qf,m(W,20,this,!1)),m(W,23,this),_(this,$f,m(W,24,this,``)),m(W,27,this),_(this,ep,m(W,28,this,!1)),m(W,31,this),_(this,tp,m(W,32,this,!1)),m(W,35,this),g(this,`hasSlotController`,new Ys(this,`submenu`)),g(this,`submenuController`,new Lf(this,this.hasSlotController)),g(this,`handleHostClick`,e=>{this.disabled&&(e.preventDefault(),e.stopImmediatePropagation())}),g(this,`handleMouseOver`,e=>{this.focus(),e.stopPropagation()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.handleHostClick),this.addEventListener(`mouseover`,this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.handleHostClick),this.removeEventListener(`mouseover`,this.handleMouseOver)}handleDefaultSlotChange(){let e=this.getTextLabel();if(typeof this.cachedTextLabel>`u`){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit(`slotchange`,{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!==`checkbox`){this.checked=!1,console.error(`The checked attribute can only be used on menu items with type="checkbox"`,this);return}this.type===`checkbox`?this.setAttribute(`aria-checked`,this.checked?`true`:`false`):this.removeAttribute(`aria-checked`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleTypeChange(){this.type===`checkbox`?(this.setAttribute(`role`,`menuitemcheckbox`),this.setAttribute(`aria-checked`,this.checked?`true`:`false`)):(this.setAttribute(`role`,`menuitem`),this.removeAttribute(`aria-checked`))}getTextLabel(){return Xs(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test(`submenu`)}render(){let e=this.localize.dir()===`rtl`,t=this.submenuController.isExpanded();return w`
      <div
        id="anchor"
        part="base"
    ...
    `}};W=f(Jf),Yf=new WeakMap,Xf=new WeakMap,Zf=new WeakMap,Qf=new WeakMap,$f=new WeakMap,ep=new WeakMap,tp=new WeakMap,h(W,4,`defaultSlot`,qf,np,Yf),h(W,4,`menuItem`,Kf,np,Xf),h(W,4,`type`,Gf,np,Zf),h(W,4,`checked`,Wf,np,Qf),h(W,4,`value`,Uf,np,$f),h(W,4,`loading`,Hf,np,ep),h(W,4,`disabled`,Vf,np,tp),h(W,1,`handleCheckedChange`,Bf,np),h(W,1,`handleDisabledChange`,zf,np),h(W,1,`handleTypeChange`,Rf,np),p(W,np),g(np,`styles`,[D,Tf]),g(np,`dependencies`,{"kk-icon":bs,"kk-popup":H,"kk-spinner":jc});var rp=C`
  /*
  ...
  .paragrafo--versaletes {
    ...
    margin-bottom: var(--kk-spacing-3x-small) !important;
    letter-spacing: var(--kk-letter-spacing-loose);
  }
  ...
  .poesia--escritura {
    ...
    background-color: var(--kk-color-gray-50);
    font-style: italic;
    text-indent: 0;
  }
...
`,ap=ro(class extends io{constructor(e){if(super(e),e.type!==no.PROPERTY&&e.type!==no.ATTRIBUTE&&e.type!==no.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Wo(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Fa||t===T)return t;let n=e.element,r=e.name;if(e.type===no.PROPERTY){if(t===n[r])return Fa}else if(e.type===no.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Fa}else if(e.type===no.ATTRIBUTE&&n.getAttribute(r)===t+``)return Fa;return Ko(e),t}});function op(e){return e.validity.valid?``:e.validationMessage===``?` `:e.validationMessage}var sp=class{host;interacaoEm;vistos=new Set;interagiu=!1;constructor(e,t){this.host=e,this.interacaoEm=t?.interacaoEm??[`kk-blur`,`kk-input`],e.addController(this)}hostConnected(){this.host.addEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.addEventListener(e,this.aoInteragir)}hostDisconnected(){this.host.removeEventListener(`invalid`,this.aoInvalidar);for(let e of this.interacaoEm)this.host.removeEventListener(e,this.aoInteragir)}aoInvalidar=e=>{this.conferindo||this.marcarInteragido(),this.host.emitInvalidEvent(e)};conferindo=!1;conferir(e){this.conferindo=!0;try{return e()}finally{this.conferindo=!1}}aoInteragir=e=>{this.vistos.add(e.type),!(this.vistos.size<this.interacaoEm.length)&&this.marcarInteragido()};marcarInteragido(){this.interagiu||(this.interagiu=!0,this.host.updateValidity())}esquecerInteracao(){this.vistos.clear(),this.interagiu=!1}aplicar(e,t){let n=this.host.required===!0;t(`--required`,n),t(`--optional`,!n),t(`--valid`,e),t(`--invalid`,!e),t(`--user-valid`,e&&this.interagiu),t(`--user-invalid`,!e&&this.interagiu)}},cp=C`
...
`,lp,up,dp,fp,pp,mp,hp,gp,_p,vp,yp,bp,xp,Sp,Cp,wp,Tp,Ep,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp,zp,Bp,Vp,Hp,Up,Wp,Gp,Kp,G,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm,Tm,K=class extends (Kp=M,Gp=[A(`.input__control`)],Wp=[k()],Up=[O()],Hp=[O({reflect:!0})],Vp=[O()],Bp=[O()],zp=[lo()],Rp=[O({reflect:!0})],Lp=[O({type:Boolean,reflect:!0})],Ip=[O({type:Boolean,reflect:!0})],Fp=[O()],Pp=[O({attribute:`help-text`})],Np=[O({type:Boolean})],Mp=[O({type:Boolean,reflect:!0})],jp=[O()],Ap=[O({type:Boolean,reflect:!0})],kp=[O({attribute:`password-toggle`,type:Boolean})],Op=[O({attribute:`password-visible`,type:Boolean})],Dp=[O({attribute:`no-spin-buttons`,type:Boolean})],Ep=[O({reflect:!0,converter:No})],Tp=[O({type:Boolean,reflect:!0})],wp=[O()],Cp=[O({type:Number})],Sp=[O({type:Number})],xp=[O()],bp=[O()],yp=[O()],vp=[O()],_p=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],gp=[O()],hp=[O({type:Boolean})],mp=[O()],pp=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],fp=[O()],dp=[j(`disabled`,{waitUntilFirstUpdate:!0})],up=[j(`step`,{waitUntilFirstUpdate:!0})],lp=[j(`value`,{waitUntilFirstUpdate:!0})],Kp){constructor(){super(...arguments),m(G,5,this),g(this,`validade`,new sp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new Ys(this,`help-text`,`label`)),g(this,`localize`,new Wi(this)),_(this,qp,m(G,8,this)),m(G,11,this),_(this,Jp,m(G,12,this,!1)),m(G,15,this),_(this,Yp,m(G,16,this,``)),m(G,19,this),g(this,`__numberInput`,Object.assign(document.createElement(`input`),{type:`number`})),g(this,`__dateInput`,Object.assign(document.createElement(`input`),{type:`date`})),_(this,Xp,m(G,20,this,`text`)),m(G,23,this),_(this,Zp,m(G,24,this,``)),m(G,27,this),_(this,Qp,m(G,28,this,``)),m(G,31,this),g(this,`defaultValue`,m(G,140,this,``)),m(G,143,this),_(this,$p,m(G,32,this,`medium`)),m(G,35,this),_(this,em,m(G,36,this,!1)),m(G,39,this),_(this,tm,m(G,40,this,!1)),m(G,43,this),_(this,nm,m(G,44,this,``)),m(G,47,this),_(this,rm,m(G,48,this,``)),m(G,51,this),_(this,im,m(G,52,this,!1)),m(G,55,this),_(this,am,m(G,56,this,!1)),m(G,59,this),_(this,om,m(G,60,this,``)),m(G,63,this),_(this,sm,m(G,64,this,!1)),m(G,67,this),_(this,cm,m(G,68,this,!1)),m(G,71,this),_(this,lm,m(G,72,this,!1)),m(G,75,this),_(this,um,m(G,76,this,!1)),m(G,79,this),_(this,dm,m(G,80,this,``)),m(G,83,this),_(this,fm,m(G,84,this,!1)),m(G,87,this),_(this,pm,m(G,88,this)),m(G,91,this),_(this,mm,m(G,92,this)),m(G,95,this),_(this,hm,m(G,96,this)),m(G,99,this),_(this,gm,m(G,100,this)),m(G,103,this),_(this,_m,m(G,104,this)),m(G,107,this),_(this,vm,m(G,108,this)),m(G,111,this),_(this,ym,m(G,112,this)),m(G,115,this),_(this,bm,m(G,116,this,!0)),m(G,119,this),_(this,xm,m(G,120,this)),m(G,123,this),_(this,Sm,m(G,124,this)),m(G,127,this),_(this,Cm,m(G,128,this)),m(G,131,this),_(this,wm,m(G,132,this,!0)),m(G,135,this),_(this,Tm,m(G,136,this)),m(G,139,this)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}formResetCallback(){this.validade.esquecerInteracao(),this.value=this.defaultValue,this.updateValidity()}firstUpdated(){this._internals.setFormValue(this.value),this.updateValidity()}handleBlur(){this.hasFocus=!1,this.removeState(`--focused`),this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`kk-clear`),this.emit(`kk-input`),this.emit(`kk-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.addState(`--focused`),this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.updateValidity(),this.emit(`kk-input`)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this._internals.form?.requestSubmit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.toggleState(`--disabled`,this.disabled),this.input.disabled=this.disabled,this.updateValidity()}handleStepChange(){this.input.step=String(this.step),this.updateValidity()}async handleValueChange(){this._internals.setFormValue(this.value),await this.updateComplete,this.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.validade.conferir(()=>this._internals.checkValidity())}getForm(){return this._internals.form}reportValidity(){return this.validade.conferir(()=>this._internals.reportValidity())}setCustomValidity(e){this.input.setCustomValidity(e),this.updateValidity()}updateValidity(){let e=this.input.validity.valid;this.toggleState(`--empty`,!this.value),this.validade.aplicar(e,(e,t)=>this.toggleState(e,t)),this._internals.setValidity(this.input.validity,op(this.input),this.input)}emitInvalidEvent(e){let t=new CustomEvent(`kk-invalid`,{bubbles:!1,composed:!1,cancelable:!0,detail:{}});e||t.preventDefault(),this.dispatchEvent(t)||e?.preventDefault()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return w`
      <div
        part="form-control"
    ...
    `}};G=f(Kp),qp=new WeakMap,Jp=new WeakMap,Yp=new WeakMap,Xp=new WeakMap,Zp=new WeakMap,Qp=new WeakMap,$p=new WeakMap,em=new WeakMap,tm=new WeakMap,nm=new WeakMap,rm=new WeakMap,im=new WeakMap,am=new WeakMap,om=new WeakMap,sm=new WeakMap,cm=new WeakMap,lm=new WeakMap,um=new WeakMap,dm=new WeakMap,fm=new WeakMap,pm=new WeakMap,mm=new WeakMap,hm=new WeakMap,gm=new WeakMap,_m=new WeakMap,vm=new WeakMap,ym=new WeakMap,bm=new WeakMap,xm=new WeakMap,Sm=new WeakMap,Cm=new WeakMap,wm=new WeakMap,Tm=new WeakMap,h(G,4,`input`,Gp,K,qp),h(G,4,`hasFocus`,Wp,K,Jp),h(G,4,`title`,Up,K,Yp),h(G,4,`type`,Hp,K,Xp),h(G,4,`name`,Vp,K,Zp),h(G,4,`value`,Bp,K,Qp),h(G,4,`size`,Rp,K,$p),h(G,4,`filled`,Lp,K,em),h(G,4,`pill`,Ip,K,tm),h(G,4,`label`,Fp,K,nm),h(G,4,`helpText`,Pp,K,rm),h(G,4,`clearable`,Np,K,im),h(G,4,`disabled`,Mp,K,am),h(G,4,`placeholder`,jp,K,om),h(G,4,`readonly`,Ap,K,sm),h(G,4,`passwordToggle`,kp,K,cm),h(G,4,`passwordVisible`,Op,K,lm),h(G,4,`noSpinButtons`,Dp,K,um),h(G,4,`form`,Ep,K,dm),h(G,4,`required`,Tp,K,fm),h(G,4,`pattern`,wp,K,pm),h(G,4,`minlength`,Cp,K,mm),h(G,4,`maxlength`,Sp,K,hm),h(G,4,`min`,xp,K,gm),h(G,4,`max`,bp,K,_m),h(G,4,`step`,yp,K,vm),h(G,4,`autocapitalize`,vp,K,ym),h(G,4,`autocorrect`,_p,K,bm),h(G,4,`autocomplete`,gp,K,xm),h(G,4,`autofocus`,hp,K,Sm),h(G,4,`enterkeyhint`,mp,K,Cm),h(G,4,`spellcheck`,pp,K,wm),h(G,4,`inputmode`,fp,K,Tm),h(G,1,`handleDisabledChange`,dp,K),h(G,1,`handleStepChange`,up,K),h(G,1,`handleValueChange`,lp,K),h(G,5,`defaultValue`,zp,K),p(G,K),g(K,`styles`,[D,cp,ip]),g(K,`dependencies`,{"kk-icon":bs}),g(K,`formAssociated`,!0);function Em(e,t,n){return(e=>Object.is(e,-0)?0:e)(e<t?t:e>n?n:e)}var Dm=new Set(`p.br.div.span.h1.h2.h3.h4.strong.b.em.i.u.s.strike.sub.sup.mark.ul.ol.li.blockquote.hr.a.img.table.thead.tbody.tr.th.td`.split(`.`)),Om={"*":[`class`,`style`],a:[`href`,`title`,`data-nota`],img:[`src`,`alt`],td:[`colspan`,`rowspan`],th:[`colspan`,`rowspan`]},km=new Set([`script`,`style`,`iframe`,`object`,`embed`,`template`]),Am=[{classe:`destaque--azul`,termo:`editorColorBlue`,icone:`highlight`},{classe:`destaque--verde`,termo:`editorColorGreen`,icone:`highlight`},{classe:`destaque--vermelho`,termo:`editorColorRed`,icone:`highlight`},{classe:`destaque--amarelo`,termo:`editorColorYellow`,icone:`highlight`},{classe:`destaque--ciano`,termo:`editorColorCyan`,icone:`highlight`}],jm=Am.map(e=>e.classe),Mm=[{classe:`paragrafo--espacado`,termo:`editorParagraphSpaced`,icone:`line-height`},{classe:`paragrafo--emoldurado`,termo:`editorParagraphBordered`,icone:`border-horizontal`},{classe:`paragrafo--recuado`,termo:`editorParagraphIndented`,icone:`indent-increase`},{classe:`paragrafo--capitular`,termo:`editorParagraphDropCap`,icone:`letter-a`},{classe:`paragrafo--epigrafe`,termo:`editorParagraphEpigraph`,icone:`quote`},{classe:`paragrafo--epigrafe-subtitulo`,termo:`editorParagraphEpigraphSubtitle`,icone:`text-caption`},{classe:`paragrafo--versaletes`,termo:`editorParagraphSmallCaps`,icone:`letter-case-upper`},{classe:`paragrafo--versaletes-subtitulo`,termo:`editorParagraphSmallCapsSubtitle`,icone:`text-caption`},{classe:`paragrafo--miudo`,termo:`editorParagraphFinePrint`,icone:`text-decrease`},{classe:`paragrafo--colunas`,termo:`editorParagraphColumns`,icone:`columns-2`},{classe:`rodape-notas`,termo:`editorParagraphFootnotes`,icone:`notes`}],Nm=Mm.map(e=>e.classe),Pm={"paragrafo--epigrafe":`paragrafo--epigrafe-subtitulo`,"paragrafo--versaletes":`paragrafo--versaletes-subtitulo`,"poesia--escritura":`poesia--fonte`},Fm=Object.keys(Pm).map(e=>`.${e}`).join(`, `);function Im(e){let t=[...e.querySelectorAll(`br`)];if(t.length===0)return null;for(let n of t){let t=document.createRange();if(t.setStartAfter(n),t.setEnd(e,e.childNodes.length),/^[\s\u00a0]*[—–]/.test(t.toString()))return n}return t[t.length-1]??null}function Lm(e,t){let n=Im(e);if(n===null)return;let r=document.createRange();r.setStartAfter(n),r.setEnd(e,e.childNodes.length);let i=r.extractContents();n.remove();let a=document.createElement(`p`);a.className=t,a.append(i),Rm(a),Rm(e),a.textContent?.trim()!==``&&e.after(a)}function Rm(e){let t=e.querySelector(`:not(br, img, hr):empty`);for(;t!==null;)t.remove(),t=e.querySelector(`:not(br, img, hr):empty`)}function zm(e){if(!Object.keys(Pm).some(t=>e.includes(t)))return e;let t=document.createElement(`div`);t.innerHTML=e;for(let e of t.querySelectorAll(Fm))for(let[t,n]of Object.entries(Pm))e.classList.contains(t)&&Lm(e,n);return t.innerHTML}var Bm=[{classe:`poesia--tema`,termo:`editorPoetryTheme`,icone:`book-2`},{classe:`poesia--verso`,termo:`editorPoetryVerse`,icone:`text-wrap`},{classe:`poesia--escritura`,termo:`editorPoetryScripture`,icone:`quote`},{classe:`poesia--fonte`,termo:`editorPoetrySource`,icone:`signature`},{classe:`poesia--refrao`,termo:`editorPoetryRefrain`,icone:`repeat`},{classe:`poesia--dedicatoria`,termo:`editorPoetryDedication`,icone:`gift`}],Vm=Bm.map(e=>e.classe),Hm=[{termo:`editorTypoEmDash`,amostra:`—`,abre:`— `},{termo:`editorTypoEnDash`,amostra:`–`,abre:`–`},{termo:`editorTypoDoubleQuotes`,amostra:`“ ”`,abre:`“`,fecha:`”`},{termo:`editorTypoSingleQuotes`,amostra:`‘ ’`,abre:`‘`,fecha:`’`},{termo:`editorTypoNbsp`,amostra:`␣`,abre:`\xA0`}],Um=new Set([...jm,...Nm,...Vm,`note-nota-ref`]),Wm=/^var\(--kk-color-[a-z0-9-]+\)$/,Gm={"text-align":/^(left|center|right|justify)$/,color:Wm,"background-color":Wm};function Km(e){let t=[];for(let n of e.split(`;`)){let e=n.indexOf(`:`);if(e<0)continue;let r=n.slice(0,e).trim().toLowerCase(),i=n.slice(e+1).replace(/!\s*important/i,``).toLowerCase().replace(/\s+/g,``),a=Gm[r];a===void 0||!a.test(i)||t.push(`${r}: ${i}`)}return t.join(`; `)}var qm=/^data:image\/(?:png|jpeg|jpg|gif|webp|avif|bmp);base64,[A-Za-z0-9+/=]+$/,Jm=[`image/png`,`image/jpeg`,`image/gif`,`image/webp`,`image/avif`,`image/bmp`],Ym=`http://www.w3.org/1999/xhtml`;function Xm(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Zm(e){let t=new DOMParser().parseFromString(e,`text/html`),n=t.createTreeWalker(t.body,NodeFilter.SHOW_COMMENT),r=[];for(let e=n.nextNode();e!==null;e=n.nextNode())r.push(e);for(let e of r)e.remove();for(let e of[...t.body.querySelectorAll(`*`)]){if(e.namespaceURI!==Ym){e.remove();continue}let t=e.tagName.toLowerCase();if(km.has(t)){e.remove();continue}if(!Dm.has(t)){e.replaceWith(...e.childNodes);continue}let n=[...Om[`*`]??[],...Om[t]??[]];for(let t of[...e.attributes]){if(!n.includes(t.name)){e.removeAttribute(t.name);continue}if(t.name===`style`){let n=Km(t.value);n===``?e.removeAttribute(`style`):e.setAttribute(`style`,n)}if(t.name===`class`){let n=t.value.split(/\s+/).filter(e=>Um.has(e));n.length===0?e.removeAttribute(`class`):e.setAttribute(`class`,n.join(` `))}if(t.name===`href`||t.name===`src`){let n=t.value.trim();/^(https?:|mailto:|#|\/|\.)/i.test(n)||t.name===`src`&&qm.test(n)||e.removeAttribute(t.name)}}}return t.body.innerHTML}function Qm(e){let t=e??``;for(let e=0;e<3;e+=1){let e=Zm(t);if(e===t)return e;t=e}return Xm(new DOMParser().parseFromString(t,`text/html`).body.textContent??``)}var $m=[{rampa:`neutral`,termo:`editorColorGray`},{rampa:`red`,termo:`editorColorRed`},{rampa:`orange`,termo:`editorColorOrange`},{rampa:`yellow`,termo:`editorColorYellow`},{rampa:`lime`,termo:`editorColorLime`},{rampa:`green`,termo:`editorColorGreen`},{rampa:`teal`,termo:`editorColorTeal`},{rampa:`cyan`,termo:`editorColorCyan`},{rampa:`blue`,termo:`editorColorBlue`},{rampa:`violet`,termo:`editorColorViolet`},{rampa:`pink`,termo:`editorColorPink`}],eh=[{valor:`var(--kk-color-neutral-900)`,termo:`editorColorDefault`},...$m.map(e=>({valor:`var(--kk-color-${e.rampa}-600)`,termo:e.termo}))],th=[{valor:`var(--kk-color-neutral-0)`,termo:`editorColorDefault`},...$m.map(e=>({valor:`var(--kk-color-${e.rampa}-200)`,termo:e.termo}))],nh={color:`#010203`,"background-color":`#040506`};function rh(e,t){let n=document.createElement(`span`);return n.style.setProperty(e,t),n.style.getPropertyValue(e)}var ih=`p, h1, h2, h3, h4, li, blockquote, div, td, th`,ah=8,oh=10,sh=Array.from({length:ah*oh},(e,t)=>({linha:Math.floor(t/oh)+1,coluna:t%oh+1}));function ch(e){let t=document.createElement(e);return t.append(document.createElement(`br`)),t}function lh(e,t){return`<table><tbody>${`<tr>${`<td><br></td>`.repeat(t)}</tr>`.repeat(e)}</tbody></table><p><br></p>`}function uh(e,t){if(e.tagName.toLowerCase()===t)return;let n=document.createElement(t);for(let t of[...e.attributes])n.setAttribute(t.name,t.value);n.append(...e.childNodes),e.replaceWith(n)}function dh(e,t){let n=e.closest(`tr`),r=n?.parentElement;if(n===null||r==null)return;let i=document.createElement(`tr`),a=r.tagName===`THEAD`?`th`:`td`;for(let e=0;e<n.cells.length;e+=1)i.append(ch(a));r.insertBefore(i,t?n.nextSibling:n)}function fh(e){let t=e.closest(`tr`),n=e.closest(`table`);if(t===null||n===null)return;if(n.rows.length<=1){n.remove();return}let r=t.parentElement;t.remove(),r!==null&&r.children.length===0&&r.remove()}function ph(e,t){let n=e.closest(`table`);if(n===null)return;let r=e.cellIndex;for(let e of[...n.rows]){let n=e.cells[r],i=ch(n?.tagName===`TH`?`th`:`td`);n===void 0?e.append(i):e.insertBefore(i,t?n.nextSibling:n)}}function mh(e){let t=e.closest(`table`);if(t===null)return;let n=e.cellIndex;if(Math.max(...[...t.rows].map(e=>e.cells.length))<=1){t.remove();return}for(let e of[...t.rows])e.cells[n]?.remove()}function hh(e){let t=e.closest(`table`);if(t===null)return;let n=t.tHead;if(n!==null){let e=t.tBodies[0]??t.createTBody();for(let t of[...n.rows].reverse()){for(let e of[...t.cells])uh(e,`td`);e.insertBefore(t,e.firstChild)}n.remove();return}let r=t.rows[0];if(r===void 0)return;for(let e of[...r.cells])uh(e,`th`);let i=r.parentElement;t.createTHead().append(r),i!==null&&i.children.length===0&&i.remove()}function gh(e){e.closest(`table`)?.remove()}var _h=[{termo:`editorTableRowAbove`,icone:`row-insert-top`,executar:e=>dh(e,!1)},{termo:`editorTableRowBelow`,icone:`row-insert-bottom`,executar:e=>dh(e,!0)},{termo:`editorTableRowDelete`,icone:`row-remove`,executar:fh},{termo:`editorTableColumnBefore`,icone:`column-insert-left`,executar:e=>ph(e,!1)},{termo:`editorTableColumnAfter`,icone:`column-insert-right`,executar:e=>ph(e,!0)},{termo:`editorTableColumnDelete`,icone:`column-remove`,executar:mh},{termo:`editorTableHeader`,icone:`layout-navbar`,executar:hh},{termo:`editorTableDelete`,icone:`trash`,executar:gh}],vh=[{icone:`arrow-back-up`,termo:`editorUndo`,comando:`undo`},{icone:`arrow-forward-up`,termo:`editorRedo`,comando:`redo`}],yh=[[{icone:`bold`,termo:`editorBold`,comando:`bold`,alterna:!0},{icone:`italic`,termo:`editorItalic`,comando:`italic`,alterna:!0},{icone:`underline`,termo:`editorUnderline`,comando:`underline`,alterna:!0},{icone:`strikethrough`,termo:`editorStrikethrough`,comando:`strikeThrough`,alterna:!0}],[{icone:`list`,termo:`editorBulletList`,comando:`insertUnorderedList`,alterna:!0},{icone:`list-numbers`,termo:`editorNumberedList`,comando:`insertOrderedList`,alterna:!0}],[{icone:`align-left`,termo:`editorAlignLeft`,comando:`justifyLeft`,alterna:!0},{icone:`align-center`,termo:`editorAlignCenter`,comando:`justifyCenter`,alterna:!0},{icone:`align-right`,termo:`editorAlignRight`,comando:`justifyRight`,alterna:!0},{icone:`align-justified`,termo:`editorAlignJustify`,comando:`justifyFull`,alterna:!0}],[{icone:`corner-down-left`,termo:`editorLineBreak`,comando:`insertLineBreak`},{icone:`separator-horizontal`,termo:`editorHorizontalRule`,comando:`insertHorizontalRule`}]],bh=[vh,...yh].flat().filter(e=>e.alterna===!0).map(e=>e.comando),xh={tag:`p`,termo:`editorParagraph`,icone:`pilcrow`},Sh=[xh,{tag:`h1`,termo:`editorHeading1`,icone:`h-1`},{tag:`h2`,termo:`editorHeading2`,icone:`h-2`},{tag:`h3`,termo:`editorHeading3`,icone:`h-3`},{tag:`h4`,termo:`editorHeading4`,icone:`h-4`},{tag:`blockquote`,termo:`editorQuote`,icone:`blockquote`}];typeof document<`u`&&rp.styleSheet!==void 0&&(document.adoptedStyleSheets=[...document.adoptedStyleSheets,rp.styleSheet]);function Ch(e){let t=e.getRootNode(),n=rp.styleSheet;n===void 0||!(t instanceof ShadowRoot)||t.adoptedStyleSheets.includes(n)||(t.adoptedStyleSheets=[...t.adoptedStyleSheets,n])}var wh,Th,Eh,Dh,Oh,kh,Ah,jh,Mh=class e extends (Dh=M,Eh=[k()],Th=[k()],wh=[O({type:Boolean,reflect:!0})],Dh){constructor(){super(...arguments),g(this,`localize`,new Wi(this)),g(this,`area`,document.createElement(`div`)),g(this,`fonte`,document.createElement(`textarea`)),g(this,`conteudo`,``),_(this,kh,m(Oh,8,this,!1)),m(Oh,11,this),_(this,Ah,m(Oh,12,this,0)),m(Oh,15,this),g(this,`assinaturaDaBarra`,``),g(this,`ultimaFaixa`,null),g(this,`quadro`,0),_(this,jh,m(Oh,16,this,!1)),m(Oh,19,this),g(this,`handleFonteInput`,()=>{this.conteudo=this.fonte.value,this.emit(`kk-input`,{detail:{value:this.conteudo}})}),g(this,`handleInput`,()=>{this.conteudo=this.area.innerHTML,this.emit(`kk-input`,{detail:{value:this.conteudo}}),this.sincronizarBarra()}),g(this,`sincronizarBarra`,()=>{this.guardarSelecao(),this.quadro===0&&(this.quadro=requestAnimationFrame(()=>{this.quadro=0;let e=[this.tagDoBlocoCorrente(),...bh.map(e=>this.comandoLigado(e)?`1`:`0`),this.corCorrente(`color`)??``,this.corCorrente(`background-color`)??``,this.blocoCorrente()?.className??``,this.celulaCorrente()===void 0?``:`tabela`].join(`|`);e!==this.assinaturaDaBarra&&(this.assinaturaDaBarra=e,this.selecao+=1)}))}),g(this,`handlePaste`,e=>{e.preventDefault();let t=e.clipboardData;if(t===null)return;let n=t.getData(`text/html`),r=t.getData(`text/plain`);n===``?document.execCommand(`insertText`,!1,r):document.execCommand(`insertHTML`,!1,Qm(n)),this.handleInput()}),g(this,`aoApontarNaGrade`,e=>{let t=e.target.closest(`[data-linha]`);t!==null&&this.marcarGrade(Number(t.dataset.linha),Number(t.dataset.coluna))}),g(this,`aoTeclarNaGrade`,e=>{let t={ArrowUp:[-1,0],ArrowDown:[1,0],ArrowLeft:[0,-1],ArrowRight:[0,1]}[e.key],n=e.target.closest(`[data-linha]`);if(t===void 0||n===null)return;e.preventDefault();let r=Em(Number(n.dataset.linha)+t[0],1,ah),i=Em(Number(n.dataset.coluna)+t[1],1,oh);this.querySelector(`[data-linha="${r}"][data-coluna="${i}"]`)?.focus()})}get value(){return this.conteudo}set value(e){let t=zm(Qm(e??``));t===this.conteudo||t===zm(Qm(this.conteudo))||(this.conteudo=t,this.area.innerHTML=t,this.codigo&&(this.fonte.value=t))}connectedCallback(){super.connectedCallback(),Ch(this),this.area.className=`kk-editor__content kk-prose`,this.area.contentEditable=this.readonly?`false`:`true`,this.area.spellcheck=!0,this.area.setAttribute(`role`,`textbox`),this.area.setAttribute(`aria-multiline`,`true`),this.area.setAttribute(`aria-label`,this.localize.term(`editorArea`)),this.area.innerHTML=this.conteudo,document.execCommand(`styleWithCSS`,!1,`false`),this.fonte.className=`kk-editor__source`,this.fonte.spellcheck=!1,this.fonte.setAttribute(`aria-label`,this.localize.term(`editorSource`)),this.area.addEventListener(`input`,this.handleInput),this.area.addEventListener(`paste`,this.handlePaste),this.area.addEventListener(`keyup`,this.sincronizarBarra),this.area.addEventListener(`mouseup`,this.sincronizarBarra),this.area.addEventListener(`focus`,this.sincronizarBarra),this.fonte.addEventListener(`input`,this.handleFonteInput)}disconnectedCallback(){super.disconnectedCallback(),this.area.removeEventListener(`input`,this.handleInput),this.area.removeEventListener(`paste`,this.handlePaste),this.area.removeEventListener(`keyup`,this.sincronizarBarra),this.area.removeEventListener(`mouseup`,this.sincronizarBarra),this.area.removeEventListener(`focus`,this.sincronizarBarra),this.fonte.removeEventListener(`input`,this.handleFonteInput),this.quadro!==0&&(cancelAnimationFrame(this.quadro),this.quadro=0)}createRenderRoot(){return this}focus(e){(this.codigo?this.fonte:this.area).focus(e)}get travado(){return this.readonly||this.codigo}alternarCodigo(){if(this.codigo){let e=zm(Qm(this.fonte.value)),t=e!==this.conteudo;this.conteudo=e,this.area.innerHTML=e,this.codigo=!1,t&&this.emit(`kk-input`,{detail:{value:e}})}else this.conteudo=this.area.innerHTML,this.fonte.value=this.conteudo,this.fonte.readOnly=this.readonly,this.codigo=!0;this.updateComplete.then(()=>this.focus())}aplicar(e,t){this.area.focus(),this.restaurarSelecao(),document.execCommand(e,!1,t),this.handleInput()}selecaoAtual(){let e=this.getRootNode();return`getSelection`in e?e.getSelection():getSelection()}guardarSelecao(){let e=this.selecaoAtual();if(e===null||e.rangeCount===0)return;let t=e.getRangeAt(0);this.area.contains(t.commonAncestorContainer)&&(this.ultimaFaixa=t.cloneRange())}restaurarSelecao(){let e=this.ultimaFaixa,t=this.selecaoAtual();e===null||t===null||this.area.contains(e.commonAncestorContainer)&&(t.removeAllRanges(),t.addRange(e))}faixaCorrente(){let e=this.selecaoAtual();if(e!==null&&e.rangeCount>0){let t=e.getRangeAt(0);if(this.area.contains(t.commonAncestorContainer))return t}let t=this.ultimaFaixa;if(t!==null&&this.area.contains(t.commonAncestorContainer))return t}elementoCorrente(){let e=this.faixaCorrente()?.startContainer;return e===void 0?void 0:(e.nodeType===Node.ELEMENT_NODE?e:e.parentElement)??void 0}blocoCorrente(){let e=this.elementoCorrente()?.closest(ih);return e!=null&&this.area.contains(e)?e:void 0}celulaCorrente(){let e=this.elementoCorrente()?.closest(`td, th`);return e!=null&&this.area.contains(e)?e:void 0}blocosDaSelecao(){let e=this.faixaCorrente();if(e===void 0)return[];if(e.collapsed){let e=this.blocoCorrente();return e===void 0?[]:[e]}return[...this.area.querySelectorAll(ih)].filter(t=>t.querySelector(ih)===null&&e.intersectsNode(t))}marcarBlocos(e,t){this.area.focus(),this.restaurarSelecao();let n=this.blocosDaSelecao();if(n.length===0)return;let r=n[0]?.classList.contains(e)===!0;for(let i of n){i.classList.remove(...t),i.classList.toggle(e,!r),i.className===``&&i.removeAttribute(`class`);let n=Pm[e];!r&&n!==void 0&&Lm(i,n)}this.handleInput()}limparFormatacao(){this.area.focus(),this.restaurarSelecao(),document.execCommand(`removeFormat`),document.execCommand(`unlink`);for(let e of this.blocosDaSelecao())e.removeAttribute(`class`),e.removeAttribute(`style`);let e=this.tagDoBlocoCorrente();e!==`p`&&e!==`li`&&e!==`td`&&e!==`th`&&document.execCommand(`formatBlock`,!1,`p`),this.handleInput()}inserirTipografia(e,t){this.area.focus(),this.restaurarSelecao();let n=t===void 0?``:this.faixaCorrente()?.toString()??``;if(document.execCommand(`insertText`,!1,`${e}${n}${t??``}`),t!==void 0&&n===``){let e=this.selecaoAtual()?.getRangeAt(0);e!==void 0&&e.startContainer.nodeType===Node.TEXT_NODE&&(e.setStart(e.startContainer,e.startOffset-t.length),e.collapse(!0),this.ultimaFaixa=e.cloneRange())}this.handleInput()}corCorrente(e){let t=this.elementoCorrente();for(;t!==void 0&&t!==this.area;){let n=t.style?.getPropertyValue(e)??``;if(n!==``)return n;t=t.parentElement??void 0}}pintar(e,t){this.area.focus(),this.restaurarSelecao();let n=nh[e];document.execCommand(`styleWithCSS`,!1,`true`),document.execCommand(e===`color`?`foreColor`:`hiliteColor`,!1,n),document.execCommand(`styleWithCSS`,!1,`false`);let r=rh(e,n);for(let n of[...this.area.querySelectorAll(`[style]`)])n.style.getPropertyValue(e)===r&&(t===null?n.style.removeProperty(e):n.style.setProperty(e,t),n.getAttribute(`style`)===``&&n.removeAttribute(`style`),n.tagName===`SPAN`&&n.attributes.length===0&&n.replaceWith(...n.childNodes));this.handleInput()}pedirTexto(e){let t=document.createElement(`kk-dialog`);return t.label=e.rotulo,document.body.append(t),new Promise(n=>{let r=null,i=e=>{r=e,t.open=!1},a=()=>{let e=t.querySelector(`kk-input`),n=e?.value.trim()??``;if(n===``){e?.focus();return}i(n)};t.addEventListener(`kk-after-hide`,e=>{e.target===t&&(t.remove(),n(r))}),Za(w`
          <p>${e.texto}</p>
          <kk-input
            autofocus
            placeholder=${e.placeholder??``}
    ...
    </div>`}renderSeletorDeBloco(){let e=this.tagDoBlocoCorrente(),t=Sh.find(t=>t.tag===e)??xh,n=`${this.localize.term(`editorBlockType`)}: ${this.localize.term(t.termo)}`;return w`
    ...
    `}render(){return this.selecao,w`
      <div class="kk-editor__toolbar" role="toolbar" aria-label=${this.localize.term(`editorToolbar`)}>
        ${this.renderGrupo(vh)} ${this.renderSeletorDeBloco()}
        ${yh.map(e=>this.renderGrupo(e))}

        <div class="kk-editor__group">
          ${this.renderPaleta(`color`,eh,`text-color`,`editorTextColor`)}
          ${this.renderPaleta(`background-color`,th,`background`,`editorBackgroundColor`)}
          ${this.renderMenuDeClasses(`article`,`editorParagraphStyle`,Mm,Nm)}
          ${this.renderMenuDeClasses(`feather`,`editorPoetry`,Bm,Vm)}
          ${this.renderMenuDeClasses(`highlight`,`editorHighlight`,Am,jm)}
    ...
    `}};Oh=f(Dh),kh=new WeakMap,Ah=new WeakMap,jh=new WeakMap,h(Oh,4,`codigo`,Eh,Mh,kh),h(Oh,4,`selecao`,Th,Mh,Ah),h(Oh,4,`readonly`,wh,Mh,jh),p(Oh,Mh),g(Mh,`dependencies`,{"kk-button":z,"kk-dialog":wu,"kk-dropdown":vf,"kk-icon":bs,"kk-input":K,"kk-menu":wf,"kk-menu-item":np}),Mh.define(`kk-editor`);var Nh=C`
  :host {
    display: block;
...
`,Fh,Ih,Lh,Rh,zh,Bh,Vh,Hh,Uh,Wh,Gh,Kh,qh,Jh,Yh,q,Xh,Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg=class extends (Yh=M,Jh=[A(`input[type="checkbox"]`)],qh=[k()],Kh=[O()],Gh=[O()],Wh=[O()],Uh=[O({reflect:!0})],Hh=[O({type:Boolean,reflect:!0})],Vh=[O({type:Boolean,reflect:!0})],Bh=[lo(`checked`)],zh=[O({reflect:!0})],Rh=[O({type:Boolean,reflect:!0})],Lh=[O({attribute:`help-text`})],Ih=[j(`checked`,{waitUntilFirstUpdate:!0})],Fh=[j(`disabled`,{waitUntilFirstUpdate:!0})],Yh){constructor(){super(...arguments),m(q,5,this),g(this,`formControlController`,new zo(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=!!t})),g(this,`hasSlotController`,new Ys(this,`help-text`)),_(this,Xh,m(q,8,this)),m(q,11,this),_(this,Zh,m(q,12,this,!1)),m(q,15,this),_(this,Qh,m(q,16,this,``)),m(q,19,this),_(this,$h,m(q,20,this,``)),m(q,23,this),_(this,eg,m(q,24,this)),m(q,27,this),_(this,tg,m(q,28,this,`medium`)),m(q,31,this),_(this,ng,m(q,32,this,!1)),m(q,35,this),_(this,rg,m(q,36,this,!1)),m(q,39,this),g(this,`defaultChecked`,m(q,52,this,!1)),m(q,55,this),_(this,ig,m(q,40,this,``)),m(q,43,this),_(this,ag,m(q,44,this,!1)),m(q,47,this),_(this,og,m(q,48,this,``)),m(q,51,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleInput(){this.emit(`kk-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`kk-change`),this.emit(`kk-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`kk-change`),this.emit(`kk-input`))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return w`
      <div
    ...
    `}};q=f(Yh),Xh=new WeakMap,Zh=new WeakMap,Qh=new WeakMap,$h=new WeakMap,eg=new WeakMap,tg=new WeakMap,ng=new WeakMap,rg=new WeakMap,ig=new WeakMap,ag=new WeakMap,og=new WeakMap,h(q,4,`input`,Jh,sg,Xh),h(q,4,`hasFocus`,qh,sg,Zh),h(q,4,`title`,Kh,sg,Qh),h(q,4,`name`,Gh,sg,$h),h(q,4,`value`,Wh,sg,eg),h(q,4,`size`,Uh,sg,tg),h(q,4,`disabled`,Hh,sg,ng),h(q,4,`checked`,Vh,sg,rg),h(q,4,`form`,zh,sg,ig),h(q,4,`required`,Rh,sg,ag),h(q,4,`helpText`,Lh,sg,og),h(q,1,`handleCheckedChange`,Ih,sg),h(q,1,`handleDisabledChange`,Fh,sg),h(q,5,`defaultChecked`,Bh,sg),p(q,sg),g(sg,`styles`,[D,cp,Ph]);var cg=C`
  :host {
    display: block;
  }
...
`,lg=class extends io{constructor(e){if(super(e),this.it=T,e.type!==no.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===T||e==null)return this._t=void 0,this.it=e;if(e===Fa)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};lg.directiveName=`unsafeHTML`,lg.resultType=1;var ug=ro(lg);function dg(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}function fg(e,t,n=`vertical`,r=`smooth`){let i=dg(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,s=t.scrollLeft,c=t.scrollLeft+t.offsetWidth,l=t.scrollTop,u=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<s?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>c&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<l?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>u&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}var pg=C`
  :host {
    display: inline-block;
  }
...
`,mg,hg,gg,_g,vg,yg,bg,xg,Sg,Cg,wg=class extends (vg=M,_g=[O({reflect:!0})],gg=[O({reflect:!0})],hg=[O({type:Boolean,reflect:!0})],mg=[O({type:Boolean})],vg){constructor(){super(...arguments),g(this,`localize`,new Wi(this)),_(this,bg,m(yg,8,this,`neutral`)),m(yg,11,this),_(this,xg,m(yg,12,this,`medium`)),m(yg,15,this),_(this,Sg,m(yg,16,this,!1)),m(yg,19,this),_(this,Cg,m(yg,20,this,!1)),m(yg,23,this)}handleRemoveClick(){this.emit(`kk-remove`)}render(){return w`
      <span
        part="base"
    ...
    `}};yg=f(vg),bg=new WeakMap,xg=new WeakMap,Sg=new WeakMap,Cg=new WeakMap,h(yg,4,`variant`,_g,wg,bg),h(yg,4,`size`,gg,wg,xg),h(yg,4,`pill`,hg,wg,Sg),h(yg,4,`removable`,mg,wg,Cg),p(yg,wg),g(wg,`styles`,[D,pg]),g(wg,`dependencies`,{"kk-icon-button":I});var Tg,Eg,Dg,Og,kg,Ag,jg,Mg,Ng,Pg,Fg,Ig,Lg,Rg,zg,Bg,Vg,Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_,J,r_,i_,a_,o_,s_,c_,l_,u_,d_,f_,p_,m_,h_,g_,__,v_,y_,b_,x_,S_,C_,w_,T_,E_,D_,O_,k_,Y=class extends (n_=M,t_=[A(`.select`)],e_=[A(`.select__combobox`)],$g=[A(`.select__display-input`)],Qg=[A(`.select__value-input`)],Zg=[A(`.select__listbox`)],Xg=[k()],Yg=[k()],Jg=[k()],qg=[k()],Kg=[k()],Gg=[O()],Wg=[k()],Ug=[O({attribute:`value`})],Hg=[O({reflect:!0})],Vg=[O()],Bg=[O({type:Boolean,reflect:!0})],zg=[O({attribute:`max-options-visible`,type:Number})],Rg=[O({type:Boolean,reflect:!0})],Lg=[O({type:Boolean})],Ig=[O({type:Boolean,reflect:!0})],Fg=[O({type:Boolean,reflect:!0})],Pg=[O({type:Boolean,reflect:!0})],Ng=[O()],Mg=[O({reflect:!0})],jg=[O({attribute:`help-text`})],Ag=[O({reflect:!0,converter:No})],kg=[O({type:Boolean,reflect:!0})],Og=[O()],Dg=[j(`disabled`,{waitUntilFirstUpdate:!0})],Eg=[j([`defaultValue`,`value`],{waitUntilFirstUpdate:!0})],Tg=[j(`open`,{waitUntilFirstUpdate:!0})],n_){constructor(){super(...arguments),m(J,5,this),g(this,`validade`,new sp(this,{interacaoEm:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new Ys(this,`help-text`,`label`)),g(this,`localize`,new Wi(this)),g(this,`typeToSelectString`,``),g(this,`typeToSelectTimeout`),g(this,`closeWatcher`),_(this,r_,m(J,8,this)),m(J,11,this),_(this,i_,m(J,12,this)),m(J,15,this),_(this,a_,m(J,16,this)),m(J,19,this),_(this,o_,m(J,20,this)),m(J,23,this),_(this,s_,m(J,24,this)),m(J,27,this),_(this,c_,m(J,28,this,!1)),m(J,31,this),_(this,l_,m(J,32,this,``)),m(J,35,this),_(this,u_,m(J,36,this)),m(J,39,this),_(this,d_,m(J,40,this,[])),m(J,43,this),_(this,f_,m(J,44,this,!1)),m(J,47,this),_(this,p_,m(J,48,this,``)),m(J,51,this),g(this,`_value`,``),_(this,m_,m(J,52,this,``)),m(J,55,this),_(this,h_,m(J,56,this,`medium`)),m(J,59,this),_(this,g_,m(J,60,this,``)),m(J,63,this),_(this,__,m(J,64,this,!1)),m(J,67,this),_(this,v_,m(J,68,this,3)),m(J,71,this),_(this,y_,m(J,72,this,!1)),m(J,75,this),_(this,b_,m(J,76,this,!1)),m(J,79,this),_(this,x_,m(J,80,this,!1)),m(J,83,this),_(this,S_,m(J,84,this,!1)),m(J,87,this),_(this,C_,m(J,88,this,!1)),m(J,91,this),_(this,w_,m(J,92,this,``)),m(J,95,this),_(this,T_,m(J,96,this,`bottom`)),m(J,99,this),_(this,E_,m(J,100,this,``)),m(J,103,this),_(this,D_,m(J,104,this,``)),m(J,107,this),_(this,O_,m(J,108,this,!1)),m(J,111,this),_(this,k_,m(J,112,this,e=>w`
      <kk-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};J=f(n_),r_=new WeakMap,i_=new WeakMap,a_=new WeakMap,o_=new WeakMap,s_=new WeakMap,c_=new WeakMap,l_=new WeakMap,u_=new WeakMap,d_=new WeakMap,f_=new WeakMap,p_=new WeakMap,m_=new WeakMap,h_=new WeakMap,g_=new WeakMap,__=new WeakMap,v_=new WeakMap,y_=new WeakMap,b_=new WeakMap,x_=new WeakMap,S_=new WeakMap,C_=new WeakMap,w_=new WeakMap,T_=new WeakMap,E_=new WeakMap,D_=new WeakMap,O_=new WeakMap,k_=new WeakMap,h(J,4,`popup`,t_,Y,r_),h(J,4,`combobox`,e_,Y,i_),h(J,4,`displayInput`,$g,Y,a_),h(J,4,`valueInput`,Qg,Y,o_),h(J,4,`listbox`,Zg,Y,s_),h(J,4,`hasFocus`,Xg,Y,c_),h(J,4,`displayLabel`,Yg,Y,l_),h(J,4,`currentOption`,Jg,Y,u_),h(J,4,`selectedOptions`,qg,Y,d_),h(J,4,`valueHasChanged`,Kg,Y,f_),h(J,4,`name`,Gg,Y,p_),h(J,3,`value`,Wg,Y),h(J,4,`defaultValue`,Ug,Y,m_),h(J,4,`size`,Hg,Y,h_),h(J,4,`placeholder`,Vg,Y,g_),h(J,4,`multiple`,Bg,Y,__),h(J,4,`maxOptionsVisible`,zg,Y,v_),h(J,4,`disabled`,Rg,Y,y_),h(J,4,`clearable`,Lg,Y,b_),h(J,4,`open`,Ig,Y,x_),h(J,4,`filled`,Fg,Y,S_),h(J,4,`pill`,Pg,Y,C_),h(J,4,`label`,Ng,Y,w_),h(J,4,`placement`,Mg,Y,T_),h(J,4,`helpText`,jg,Y,E_),h(J,4,`form`,Ag,Y,D_),h(J,4,`required`,kg,Y,O_),h(J,4,`getTag`,Og,Y,k_),h(J,1,`handleDisabledChange`,Dg,Y),h(J,1,`handleValueChange`,Eg,Y),h(J,1,`handleOpenChange`,Tg,Y),p(J,Y),g(Y,`styles`,[D,cp,cg]),g(Y,`dependencies`,{"kk-icon":bs,"kk-popup":H,"kk-tag":wg}),g(Y,`formAssociated`,!0);var A_=C`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,j_,M_,N_,P_,F_,I_,L_,R_,z_,B_,X,V_,H_,U_,W_,G_,K_,q_=class extends (B_=M,z_=[A(`.option__label`)],R_=[k()],L_=[k()],I_=[k()],F_=[O({reflect:!0})],P_=[O({type:Boolean,reflect:!0})],N_=[j(`disabled`)],M_=[j(`selected`)],j_=[j(`value`)],B_){constructor(){super(...arguments),m(X,5,this),g(this,`localize`,new Wi(this)),g(this,`isInitialized`,!1),_(this,V_,m(X,8,this)),m(X,11,this),_(this,H_,m(X,12,this,!1)),m(X,15,this),_(this,U_,m(X,16,this,!1)),m(X,19,this),_(this,W_,m(X,20,this,!1)),m(X,23,this),_(this,G_,m(X,24,this,``)),m(X,27,this),_(this,K_,m(X,28,this,!1)),m(X,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`kk-select`).then(()=>{let e=this.closest(`kk-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return w`
    ...
    `}};X=f(B_),V_=new WeakMap,H_=new WeakMap,U_=new WeakMap,W_=new WeakMap,G_=new WeakMap,K_=new WeakMap,h(X,4,`defaultSlot`,z_,q_,V_),h(X,4,`current`,R_,q_,H_),h(X,4,`selected`,L_,q_,U_),h(X,4,`hasHover`,I_,q_,W_),h(X,4,`value`,F_,q_,G_),h(X,4,`disabled`,P_,q_,K_),h(X,1,`handleDisabledChange`,N_,q_),h(X,1,`handleSelectedChange`,M_,q_),h(X,1,`handleValueChange`,j_,q_),p(X,q_),g(q_,`styles`,[D,A_]),g(q_,`dependencies`,{"kk-icon":bs});var J_=`🛒.🍕.☕.🏠.💡.💧.🔌.🚌.⛽.🚗.💊.🏥.🩺.👕.🎁.🎮.🎵.📚.🎓.🏖️.💰.💳.🧾.🐾.📱.💼.💇.🧴.🧺.🏋️.🛡️.🧸`.split(`.`),Y_=[[`diaria`,`financeDaily`],[`semanal`,`financeWeekly`],[`mensal`,`financeMonthly`],[`anual`,`financeYearly`]],X_=`••••`,Z_={descricao:!1,valor:!1,diaMes:!1};function Q_(e){let t=new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function $_(e){return Q_(e).slice(0,7)}function ev(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1).getTime()}var tv,nv,rv,iv,av,ov,sv,cv,lv,uv,dv,Z,fv,pv,mv,hv,gv,_v,vv,yv,bv,xv=class e extends (dv=M,uv=[O({reflect:!0})],lv=[O({type:Array})],cv=[O({type:Array})],sv=[O({type:Array})],ov=[O({type:Array})],av=[O({reflect:!0})],iv=[O({type:Boolean,reflect:!0})],rv=[O()],nv=[k()],tv=[j(`vista`,{waitUntilFirstUpdate:!0})],dv){constructor(){super(...arguments),m(Z,5,this),g(this,`localize`,new Wi(this)),_(this,fv,m(Z,8,this,`painel`)),m(Z,11,this),_(this,pv,m(Z,12,this,[])),m(Z,15,this),_(this,mv,m(Z,16,this,[])),m(Z,19,this),_(this,hv,m(Z,20,this,[])),m(Z,23,this),_(this,gv,m(Z,24,this,[])),m(Z,27,this),_(this,_v,m(Z,28,this,``)),m(Z,31,this),_(this,vv,m(Z,32,this,!1)),m(Z,35,this),_(this,yv,m(Z,36,this,`BRL`)),m(Z,39,this),_(this,bv,m(Z,40,this,null)),m(Z,43,this)}get aberto(){return this.formulario!==null}novo(){this.vista===`transacoes`&&this.abrir({especie:`transacao`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,vencimento:Q_(Date.now()),pago:!1,parte:0}}),this.vista===`categorias`&&this.abrir({especie:`categoria`,dados:{id:0,nome:``,icone:``,cor:`#0d6efd`,limite:``,erroNome:!1}}),this.vista===`recorrencias`&&this.abrir({especie:`recorrencia`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,periodicidade:`mensal`,diaMes:1,diaSemana:1,gerarComoPago:!1,ativa:!0,erros:Z_}})}fechar(){this.formulario!==null&&(this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}))}handleVistaChange(){this.fechar()}abrir(e){this.formulario=e,this.emit(`kk-form`,{detail:{aberto:!0}})}get mesCorrente(){return this.mes===``?$_(Date.now()):this.mes}dinheiro(e){return this.localize.number(e,{style:`currency`,currency:this.moeda,minimumFractionDigits:2,maximumFractionDigits:2})}cifra(e){return this.oculto?X_:this.dinheiro(e)}data(e){return e===0?`—`:this.localize.date(new Date(e),{dateStyle:`short`})}get simboloDaMoeda(){return new Intl.NumberFormat(this.localize.lang(),{style:`currency`,currency:this.moeda}).formatToParts(0).find(e=>e.type===`currency`)?.value??this.moeda}get separadores(){let e=new Intl.NumberFormat(this.localize.lang(),{minimumFractionDigits:2}).formatToParts(1234.5);return{grupo:e.find(e=>e.type===`group`)?.value??`.`,decimal:e.find(e=>e.type===`decimal`)?.value??`,`}}mascarar(e){let t=e.replace(/\D/g,``).replace(/^0+(?=\d)/,``);if(t===``)return``;let n=t.padStart(3,`0`),r=Number(n.slice(0,-2));return`${this.localize.number(r)}${this.separadores.decimal}${n.slice(-2)}`}desmascarar(e){let{grupo:t,decimal:n}=this.separadores,r=Number(e.split(t).join(``).replace(n,`.`));return Number.isFinite(r)?Math.abs(r):0}valorEmTexto(e){return e===0?``:this.localize.number(e,{minimumFractionDigits:2,maximumFractionDigits:2})}categoriaPorId(e){return this.categorias.find(t=>t.id===e)}partePorId(e){return e===void 0||e===0?void 0:this.partes.find(t=>t.id===e)}get partesOrdenadas(){return[...this.partes].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get categoriasOrdenadas(){return[...this.categorias].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get doMes(){return this.transacoes.filter(e=>e.vencimento!==0&&$_(e.vencimento)===this.mesCorrente)}static soma(e){return e.reduce((e,t)=>e+Number(t.valor),0)}corDa(e){let t=this.categoriaPorId(e.categoria);return t!==void 0&&t.cor!==``?t.cor:e.tipo===`receita`?`var(--kk-financeiro-receita)`:`var(--kk-financeiro-despesa)`}get anosComMovimento(){let e=new Set([new Date().getFullYear(),Number(this.mesCorrente.slice(0,4))]);for(let t of this.transacoes)t.vencimento!==0&&e.add(new Date(t.vencimento).getFullYear());return[...e].sort((e,t)=>t-e)}renderSaldo(){let e=this.transacoes.reduce((e,t)=>e+(t.tipo===`receita`?Number(t.valor):-Number(t.valor)),0);return w`
      <div class="saldo">
              ...
              <span class="limite__topo">
                ...
                <span class="limite__valores">
                  ...
                  ${e.limite===0?T:w`<small>
                        ${this.localize.term(`financeOfLimit`,this.oculto?X_:this.dinheiro(e.limite))}
                      </small>`}
                </span>
              </span>
    ...
    `}salvar(e,t){this.formulario=null,this.emit(`kk-form`,{detail:{aberto:!1}}),this.emit(`kk-save`,{detail:{especie:e,registro:t}})}renderFormTransacao(e){let t=t=>{this.formulario={especie:`transacao`,dados:{...e,...t}}};return w`
      <div class="formulario">
        ...
        ${this.renderAcoes(()=>this.salvar(`transacao`,{id:e.id,descricao:e.descricao.trim(),valor:this.desmascarar(e.valor),tipo:e.tipo,categoria:Number(e.categoria),vencimento:e.vencimento===``?Date.now():ev(e.vencimento),pago:e.pago,parte:Number(e.parte)}))}
      </div>
        ...
        ${e.map(e=>{let t=e.tipo===`receita`,n=this.categoriaPorId(e.categoria),r=this.partePorId(e.parte),i=this.corDa(e);return w`
            <div class="registro" data-status=${e.pago?`ok`:`pendente`}>
              ...
              <button
                ...
                type="button"
                @click=${()=>this.abrir({especie:`transacao`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,vencimento:Q_(e.vencimento===0?Date.now():e.vencimento),pago:e.pago,parte:e.parte??0}})}
              >
      ...
      <div class="categorias">
        ${this.categoriasOrdenadas.map(e=>w`
            <div class="categoria">
              ...
              ${e.limite>0?w`
                    <span class="discreto">
                      ${this.localize.term(`financeLimitOf`,this.oculto?X_:this.dinheiro(e.limite))}
                    </span>
                  `:T}
              <kk-icon-button
                name="pencil"
    ...
    `}nomeDaPeriodicidade(e){let t=Y_.find(([t])=>t===e);return t===void 0?e:this.localize.term(t[1])}descreverPeriodo(e){let t=this.nomeDaPeriodicidade(e.periodicidade);return e.periodicidade===`mensal`?`${t} \xB7 ${this.localize.term(`financeDayNum`,e.diaMes)}`:e.periodicidade===`semanal`?`${t} \xB7 ${this.nomeDoDia(e.diaSemana)}`:t}nomeDoDia(e){return this.localize.date(new Date(2001,0,e),{weekday:`long`})}renderFormRecorrencia(e){let t=t=>{this.formulario={especie:`recorrencia`,dados:{...e,...t}}};return w`
      <div class="formulario">
        ...
        >
          ${Y_.map(([e,t])=>w`<kk-option value=${e}>${this.localize.term(t)}</kk-option>`)}
        </kk-select>
        ...
        ${this.recorrencias.map(e=>{let t=e.tipo===`receita`;return w`
            <div class="registro" data-status=${e.ativa?`ok`:`pendente`}>
              ...
              <button
                class="registro__alvo"
                type="button"
                @click=${()=>this.abrir({especie:`recorrencia`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,periodicidade:e.periodicidade,diaMes:e.diaMes,diaSemana:e.diaSemana,gerarComoPago:e.gerarComoPago,ativa:e.ativa,erros:Z_}})}
              >
                <span class="registro__topo">
                  <span class="registro__titulo">${e.descricao}</span>
                  <span class="registro__valor" data-tom=${e.tipo}>
    ...
    `}renderVista(){let e=this.formulario;return e===null?this.vista===`transacoes`?this.renderTransacoes():this.vista===`categorias`?this.renderCategorias():this.vista===`recorrencias`?this.renderRecorrencias():this.renderPainel():e.especie===`transacao`?this.renderFormTransacao(e.dados):e.especie===`categoria`?this.renderFormCategoria(e.dados):this.renderFormRecorrencia(e.dados)}render(){return w`<div part="base" class="financeiro">${this.renderVista()}</div>`}};Z=f(dv),fv=new WeakMap,pv=new WeakMap,mv=new WeakMap,hv=new WeakMap,gv=new WeakMap,_v=new WeakMap,vv=new WeakMap,yv=new WeakMap,bv=new WeakMap,h(Z,4,`vista`,uv,xv,fv),h(Z,4,`categorias`,lv,xv,pv),h(Z,4,`partes`,cv,xv,mv),h(Z,4,`transacoes`,sv,xv,hv),h(Z,4,`recorrencias`,ov,xv,gv),h(Z,4,`mes`,av,xv,_v),h(Z,4,`oculto`,iv,xv,vv),h(Z,4,`moeda`,rv,xv,yv),h(Z,4,`formulario`,nv,xv,bv),h(Z,1,`handleVistaChange`,tv,xv),p(Z,xv),g(xv,`styles`,[D,Nh]),g(xv,`dependencies`,{"kk-button":z,"kk-icon":bs,"kk-icon-button":I,"kk-input":K,"kk-option":q_,"kk-select":Y,"kk-switch":sg}),xv.define(`kk-financeiro`),bs.define(`kk-icon`),I.define(`kk-icon-button`),K.define(`kk-input`),wf.define(`kk-menu`),np.define(`kk-menu-item`),q_.define(`kk-option`);var Sv=C`
  :host {
...
`,Cv=`important`,wv=` !`+Cv,Tv=ro(class extends io{constructor(e){if(super(e),e.type!==no.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(wv);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Cv:``):n[e]=r}}return Fa}}),Ev,Dv,Ov,kv,Av,jv,Mv,Nv,Pv=class extends (kv=M,Ov=[O({type:Number,reflect:!0})],Dv=[O({type:Boolean,reflect:!0})],Ev=[O()],kv){constructor(){super(...arguments),g(this,`localize`,new Wi(this)),_(this,jv,m(Av,8,this,0)),m(Av,11,this),_(this,Mv,m(Av,12,this,!1)),m(Av,15,this),_(this,Nv,m(Av,16,this,``)),m(Av,19,this)}render(){return w`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${Tv({width:`${this.value}%`})}>
          ${this.indeterminate?``:w` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};Av=f(kv),jv=new WeakMap,Mv=new WeakMap,Nv=new WeakMap,h(Av,4,`value`,Ov,Pv,jv),h(Av,4,`indeterminate`,Dv,Pv,Mv),h(Av,4,`label`,Ev,Pv,Nv),p(Av,Pv),g(Pv,`styles`,[D,Sv]),Pv.define(`kk-progress-bar`),Y.define(`kk-select`),jc.define(`kk-spinner`),sg.define(`kk-switch`);var Fv=C`
  :host {
    display: block;
  }
...
`,Iv,Lv,Rv,zv,Bv,Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv,Xv,Zv,Qv,$v,ey,ty,ny,ry,iy,ay,oy,sy,cy,ly,uy,Q,dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Ay,jy,My,Ny,Py,Fy,$=class extends (uy=M,ly=[A(`.textarea__control`)],cy=[k()],sy=[O()],oy=[O()],ay=[O()],iy=[O({reflect:!0})],ry=[O({type:Boolean,reflect:!0})],ny=[O()],ty=[O({attribute:`help-text`})],ey=[O()],$v=[O({type:Number})],Qv=[O()],Zv=[O({type:Boolean,reflect:!0})],Xv=[O({type:Boolean,reflect:!0})],Yv=[O({reflect:!0})],Jv=[O({type:Boolean,reflect:!0})],qv=[O({type:Number})],Kv=[O({type:Number})],Gv=[O()],Wv=[O({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],Uv=[O()],Hv=[O({type:Boolean})],Vv=[O()],Bv=[O({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],zv=[O()],Rv=[lo()],Lv=[j(`disabled`,{waitUntilFirstUpdate:!0})],Iv=[j(`value`,{waitUntilFirstUpdate:!0})],uy){constructor(){super(...arguments),m(Q,5,this),g(this,`formControlController`,new zo(this,{assumeInteractionOn:[`kk-blur`,`kk-input`]})),g(this,`hasSlotController`,new Ys(this,`help-text`,`label`)),_(this,dy,m(Q,8,this)),m(Q,11,this),_(this,fy,m(Q,12,this,!1)),m(Q,15,this),_(this,py,m(Q,16,this,``)),m(Q,19,this),_(this,my,m(Q,20,this,``)),m(Q,23,this),_(this,hy,m(Q,24,this,``)),m(Q,27,this),_(this,gy,m(Q,28,this,`medium`)),m(Q,31,this),_(this,_y,m(Q,32,this,!1)),m(Q,35,this),_(this,vy,m(Q,36,this,``)),m(Q,39,this),_(this,yy,m(Q,40,this,``)),m(Q,43,this),_(this,by,m(Q,44,this,``)),m(Q,47,this),_(this,xy,m(Q,48,this,4)),m(Q,51,this),_(this,Sy,m(Q,52,this,`vertical`)),m(Q,55,this),_(this,Cy,m(Q,56,this,!1)),m(Q,59,this),_(this,wy,m(Q,60,this,!1)),m(Q,63,this),_(this,Ty,m(Q,64,this,``)),m(Q,67,this),_(this,Ey,m(Q,68,this,!1)),m(Q,71,this),_(this,Dy,m(Q,72,this)),m(Q,75,this),_(this,Oy,m(Q,76,this)),m(Q,79,this),_(this,ky,m(Q,80,this)),m(Q,83,this),_(this,Ay,m(Q,84,this,!0)),m(Q,87,this),_(this,jy,m(Q,88,this)),m(Q,91,this),_(this,My,m(Q,92,this)),m(Q,95,this),_(this,Ny,m(Q,96,this)),m(Q,99,this),_(this,Py,m(Q,100,this,!0)),m(Q,103,this),_(this,Fy,m(Q,104,this)),m(Q,107,this),g(this,`defaultValue`,m(Q,108,this,``)),m(Q,111,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`kk-blur`)}handleChange(){this.value=this.input.value,this.emit(`kk-change`)}handleFocus(){this.hasFocus=!0,this.emit(`kk-focus`)}handleInput(){this.value=this.input.value,this.emit(`kk-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return w`
      <div
        part="form-control"
        class=${E({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            <textarea
              ...
              placeholder=${N(this.placeholder)}
              rows=${N(this.rows)}
              style=${Tv({"--rows":String(this.rows)})}
              minlength=${N(this.minlength)}
              maxlength=${N(this.maxlength)}
              autocapitalize=${N(this.autocapitalize)}
              autocorrect=${this.autocorrect?`on`:`off`}
    ...
    `}};Q=f(uy),dy=new WeakMap,fy=new WeakMap,py=new WeakMap,my=new WeakMap,hy=new WeakMap,gy=new WeakMap,_y=new WeakMap,vy=new WeakMap,yy=new WeakMap,by=new WeakMap,xy=new WeakMap,Sy=new WeakMap,Cy=new WeakMap,wy=new WeakMap,Ty=new WeakMap,Ey=new WeakMap,Dy=new WeakMap,Oy=new WeakMap,ky=new WeakMap,Ay=new WeakMap,jy=new WeakMap,My=new WeakMap,Ny=new WeakMap,Py=new WeakMap,Fy=new WeakMap,h(Q,4,`input`,ly,$,dy),h(Q,4,`hasFocus`,cy,$,fy),h(Q,4,`title`,sy,$,py),h(Q,4,`name`,oy,$,my),h(Q,4,`value`,ay,$,hy),h(Q,4,`size`,iy,$,gy),h(Q,4,`filled`,ry,$,_y),h(Q,4,`label`,ny,$,vy),h(Q,4,`helpText`,ty,$,yy),h(Q,4,`placeholder`,ey,$,by),h(Q,4,`rows`,$v,$,xy),h(Q,4,`resize`,Qv,$,Sy),h(Q,4,`disabled`,Zv,$,Cy),h(Q,4,`readonly`,Xv,$,wy),h(Q,4,`form`,Yv,$,Ty),h(Q,4,`required`,Jv,$,Ey),h(Q,4,`minlength`,qv,$,Dy),h(Q,4,`maxlength`,Kv,$,Oy),h(Q,4,`autocapitalize`,Gv,$,ky),h(Q,4,`autocorrect`,Wv,$,Ay),h(Q,4,`autocomplete`,Uv,$,jy),h(Q,4,`autofocus`,Hv,$,My),h(Q,4,`enterkeyhint`,Vv,$,Ny),h(Q,4,`spellcheck`,Bv,$,Py),h(Q,4,`inputmode`,zv,$,Fy),h(Q,1,`handleDisabledChange`,Lv,$),h(Q,1,`handleValueChange`,Iv,$),h(Q,5,`defaultValue`,Rv,$),p(Q,$),g($,`styles`,[D,cp,Fv]),$.define(`kk-textarea`),ee(`./ui`);var Iy=document.querySelector(`#app`);function Ly(e){if(e.modulo===`home`)return{cabecalho:{titulo:x.home.saudacao},conteudo:ui({executar:()=>void Ky(!0),ocupado:Uy})};let t=Wt(e.modulo);if(t===void 0)return{cabecalho:{titulo:x.erro.naoEncontrado,voltarPara:`home`},conteudo:Fr()};if(Ry[t.id]===void 0||!Kt(t.id))return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Pr(t)};let n=Hy.get(t.id);if(n!==void 0)return{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Lr(n)};let r=zy.get(t.id);return r===void 0?(Vy(t.id),{cabecalho:{titulo:t.rotulo,voltarPara:`home`},conteudo:Ir()}):{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,capaPropria:r.capaPropria?.(e)??!1,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:r.acoes?.(e)},conteudo:r.conteudo(e)}}var Ry={anotacoes:async()=>(await b(async()=>{let{telaAnotacoes:e}=await import(`./tela-Bjfo1jbo.js`);return{telaAnotacoes:e}},__vite__mapDeps([21,5,3,4,22,23,24]),import.meta.url)).telaAnotacoes,caderno:async()=>(await b(async()=>{let{telaCaderno:e}=await import(`./tela-DpZoao9Q.js`);return{telaCaderno:e}},[],import.meta.url)).telaCaderno,calendario:async()=>(await b(async()=>{let{telaCalendario:e}=await import(`./tela-CQ5rD_lD.js`);return{telaCalendario:e}},__vite__mapDeps([25,6,4]),import.meta.url)).telaCalendario,criacao:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-DfDQuMWT.js`);return{telaCriacao:e}},__vite__mapDeps([26,4,23,22,27,28,29,9]),import.meta.url)).telaCriacao,entenda:async()=>(await b(async()=>{let{telaCriacao:e}=await import(`./tela-DfDQuMWT.js`);return{telaCriacao:e}},__vite__mapDeps([26,4,23,22,27,28,29,9]),import.meta.url)).telaCriacao,faq:async()=>(await b(async()=>{let{telaFaq:e}=await import(`./tela-CZWMBooK.js`);return{telaFaq:e}},__vite__mapDeps([30,4,31,32,22,23,28]),import.meta.url)).telaFaq,imite:async()=>(await b(async()=>{let{telaImite:e}=await import(`./tela-DdYxFvBj.js`);return{telaImite:e}},__vite__mapDeps([33,22,23,28]),import.meta.url)).telaImite,cronologia:async()=>(await b(async()=>{let{telaCronologia:e}=await import(`./tela-BiKFVKck.js`);return{telaCronologia:e}},__vite__mapDeps([34,4]),import.meta.url)).telaCronologia,estudo:async()=>(await b(async()=>{let{telaEstudo:e}=await import(`./tela-BCUQAabi.js`);return{telaEstudo:e}},__vite__mapDeps([35,11,4]),import.meta.url)).telaEstudo,financeiro:async()=>(await b(async()=>{let{telaFinanceiro:e}=await import(`./tela-Dk-PQTA7.js`);return{telaFinanceiro:e}},__vite__mapDeps([36,8,9,27,23,7,4]),import.meta.url)).telaFinanceiro,guias:async()=>(await b(async()=>{let{telaGuias:e}=await import(`./tela-DzgV_AsB.js`);return{telaGuias:e}},__vite__mapDeps([37,4,5,22,23,24,38,14]),import.meta.url)).telaGuias,jogo:async()=>(await b(async()=>{let{telaJogo:e}=await import(`./tela-DzW05oua.js`);return{telaJogo:e}},__vite__mapDeps([39,4,22,23]),import.meta.url)).telaJogo,leitura:async()=>(await b(async()=>{let{telaLeitura:e}=await import(`./tela-CAK2bpYm.js`);return{telaLeitura:e}},__vite__mapDeps([40,41]),import.meta.url)).telaLeitura,metas:async()=>(await b(async()=>{let{telaMetas:e}=await import(`./tela-Dtb2rg63.js`);return{telaMetas:e}},__vite__mapDeps([42,10,9,8,4,5]),import.meta.url)).telaMetas,ministerio:async()=>(await b(async()=>{let{telaMinisterio:e}=await import(`./tela-CLM0Y4aF.js`);return{telaMinisterio:e}},__vite__mapDeps([43,22,23,38,12,4,5]),import.meta.url)).telaMinisterio,perfil:async()=>(await b(async()=>{let{telaPerfil:e}=await import(`./tela-BwvBvT0g.js`);return{telaPerfil:e}},__vite__mapDeps([44,38,18,4,20]),import.meta.url)).telaPerfil,poesia:async()=>(await b(async()=>{let{telaPoesia:e}=await import(`./tela-wKStnDy-.js`);return{telaPoesia:e}},__vite__mapDeps([45,4,5,32,22,23,24,38,14]),import.meta.url)).telaPoesia,prep:async()=>(await b(async()=>{let{telaPrep:e}=await import(`./tela-DXV_lvCA.js`);return{telaPrep:e}},__vite__mapDeps([46,9,4,17,16,5,15]),import.meta.url)).telaPrep,principios:async()=>(await b(async()=>{let{telaPrincipios:e}=await import(`./tela-DZnjDX5Q.js`);return{telaPrincipios:e}},__vite__mapDeps([47,4,31,32,22,23,28]),import.meta.url)).telaPrincipios,receitas:async()=>(await b(async()=>{let{telaReceitas:e}=await import(`./tela-BqwagSJO.js`);return{telaReceitas:e}},__vite__mapDeps([48,5,32,22,23,24,38,14,13,4]),import.meta.url)).telaReceitas,servico:async()=>(await b(async()=>{let{telaServico:e}=await import(`./tela-CSBXOHQV.js`);return{telaServico:e}},__vite__mapDeps([49,10,9,8,4,5]),import.meta.url)).telaServico,sobre:async()=>(await b(async()=>{let{telaSobre:e}=await import(`./tela-TymSmu3N.js`);return{telaSobre:e}},[],import.meta.url)).telaSobre,tutorial:async()=>(await b(async()=>{let{telaTutorial:e}=await import(`./tela-DUsved9P.js`);return{telaTutorial:e}},__vite__mapDeps([50,4,22,23,51]),import.meta.url)).telaTutorial},zy=new Map,By=new Set;function Vy(e){let t=Ry[e];t===void 0||zy.has(e)||By.has(e)||(By.add(e),t().then(t=>{zy.set(e,t),Wy()}).catch(t=>{By.delete(e),Hy.set(e,String(t)),Wy()}))}var Hy=new Map,Uy=!1;function Wy(){if(Iy===null)return;let e=Gy,{cabecalho:t,conteudo:n}=Ly(e);document.title=e.modulo===`home`?l.displayName:`${t.titulo} — ${l.displayName}`,Ct(nr(t,n,Wy),Iy),Qn()}var Gy={modulo:`home`,args:[],query:new URLSearchParams};async function Ky(e){if(!Uy){Uy=!0,Wy();try{let t=await zn();if(!e)return;t.ok?gi(x.home.sincronizado(t.atualizados.length)):gi(t.motivo===`offline`?x.home.semRede:x.home.semManifesto,`warning`)}finally{Uy=!1,Wy()}}}function qy(){Iy!==null&&Ct(v`
      <div class="carregando">
        <kk-spinner></kk-spinner>
        <p>${x.app.carregando}</p>
      </div>
    `,Iy)}function Jy(e){Iy!==null&&Ct(v`
      <div class="aviso">
        <kk-icon class="aviso__icone" name="alert-triangle"></kk-icon>
        <h2>${x.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
        <kk-button variant="danger" outline @click=${()=>void _i()}>
          <kk-icon slot="prefix" name="trash"></kk-icon>
          ${x.armazenamento.apagarTudo}
        </kk-button>
      </div>
    `,Iy)}function Yy(e){switch(e){case`instancia-dupla`:return x.armazenamento.memoriaInstanciaDupla;case`indisponivel`:return x.armazenamento.memoriaIndisponivel;default:return x.armazenamento.memoriaOrigemInsegura}}async function Xy(){await Rt(It()),qy(),Zt(Wy);try{let e=await r();e.persistente||gi(Yy(e.motivo),`warning`)}catch(e){Jy(String(e));return}Iy?.removeAttribute(`aria-busy`),Yt(e=>{Gy=e,Wy(),scrollTo({top:0})}),an(),Ky(!1),Tn(),wi(Wy),ji()}window.__note={repositorio:a,apagarDados:Nn,navegacao:{MODULOS:Bt,ATALHOS:zt,HOME:Vt},imite:{carregarCartoes:_r,lerLentes:yr},caderno:{listarAnotacoes:or},badge:{atualizar:Cn}},location.hash===``&&Jt(`home`),Xy();export{un as $,Ar as A,or as B,Nr as C,Dr as D,yr as E,rr as F,Un as G,fr as H,pr as I,gn as J,hn as K,ur as L,Cr as M,Sr as N,Er as O,sr as P,fn as Q,cr as R,Mr as S,br as T,hr as U,ir as V,lr as W,cn as X,dn as Y,bn as Z,pi as _,l as _t,O as a,x as at,wr as b,w as c,st as ct,Ci as d,p as dt,yn as et,Si as f,f as ft,fi as g,_ as gt,di as h,g as ht,A as i,Wt as it,kr as j,jr as k,C as l,v as lt,gi as m,h as mt,Qm as n,Jt as nt,M as o,b as ot,_i as p,m as pt,_n as q,j as r,Bt as rt,D as s,y as st,Tv as t,Qt as tt,Ai as u,xt as ut,Rr as v,xr as w,_r as x,zr as y,mr as z};