import{a as e,s as t}from"./banco-WSl22mr6.js";import{r as n}from"./catalogo-B2Z121mU.js";import{B as r,ct as i,et as a,it as o,ot as s,tt as c,v as l,y as u}from"./index-CFqbq_HS.js";import{alternarFavorito as d,chaveFavorito as ee,lerFavoritos as te}from"./favoritos-DAEWA_Gd.js";import{t as f}from"./unsafe-html-QuUKS8vu.js";import{t as ne}from"./rascunho-TsVq0MpB.js";var p=`note_faq_favoritos`,re=`message-question`;async function ie(){return(await t(`faq`).todos()).sort((e,t)=>h(e.categoria)-h(t.categoria)||Number(e.ordem)-Number(t.ordem)||Number(e.id??0)-Number(t.id??0))}var m=Object.keys(n);function h(e){let t=m.indexOf(e);return t===-1?m.length:t}function g(e){return e===``?n.crencas??e:n[e]??e}function _(e){try{let t=JSON.parse(e===``?`[]`:e);return Array.isArray(t)?t:[]}catch{return[]}}function v(e){return e===null?[]:_(e.lentes)}function ae(e){return e===null?[]:_(e.exemplos)}function oe(e,t){return e===null||t===null||t===``?!1:t===e.correta&&v(e).some(e=>e.id===t)}function se(e){return e!==null&&v(e).some(t=>t.id===e.correta)}function y(e,t){return(v(e).find(e=>e.id===t)?.resposta??``).trim()}var ce={busca:``};function le(e,t){return t===null?e:e.filter(e=>t.has(Number(e.id)))}function ue(e,t){let n=new Map;for(let t of e){let e=n.get(t.categoria);e===void 0?n.set(t.categoria,[t]):e.push(t)}return[...n].map(([e,n])=>({categoria:e,rotulo:g(e),perguntas:n,concluida:n.every(t)}))}var b=`note_faq_progresso`;function x(){return{respondidos:{}}}function de(){try{let e=JSON.parse(localStorage.getItem(b)??`null`);return{...x(),...e}}catch{return x()}}function S(e){localStorage.setItem(b,JSON.stringify(e))}function fe(e,t){let n=e.respondidos[String(t)],r={...e,respondidos:{...e.respondidos,[String(t)]:{tentativas:(n?.tentativas??0)+1,respondidoEm:Date.now()}}};return S(r),r}function C(e,t){return t?.id!==void 0&&e.respondidos[String(t.id)]!==void 0}function w(e,t){return t.filter(t=>C(e,t)).length}function T(e){return`faq:${e}`}async function E(){let e=new Map;for(let t of await r()){if(t.origem!==`faq`||t.ref_chave===null)continue;let n=Number(t.ref_chave.split(`:`)[1]);Number.isFinite(n)&&e.set(n,t.conteudo)}return e}function pe(e,t,n){return n?.id!==void 0&&C(e,n)&&(t.get(n.id)??``).trim()!==``}function me(e,t){return t?.id!==void 0&&(e.get(t.id)??``).trim()!==``}var D=[],O=new Map,k=new Set,A=x(),j=!1,M=!1,N=null,P=ce,F=null,I=``;function L(t){I=t,e(`not_faq`,t).then(e=>{I===t&&(F=e===null?null:new Set(e),a())})}var R=-1,z=null,B=!1,V=!1,H=``,U=``,W=ne({origem:`faq`,idDe:e=>e.id,chaveDe:e=>T(e.id??0),referenciaDe:e=>e.referencia,tituloDe:e=>`${o.faq.titulo} — ${e.titulo}`,lembrete:()=>O});function G(){j||M||N!==null||(M=!0,(async()=>{try{[D,O]=await Promise.all([ie(),E()]),k=te(p),A=de(),j=!0}catch(e){console.error(`faq: a carga falhou.`,e),N=u(e)}finally{M=!1,a()}})())}function he(){N=null,G(),a()}function ge(e){return D.find(t=>t.id===e)}function _e(e){R!==e.id&&(R=e.id??-1,z=null,B=!1,V=!1,H=``,U=``,W.abrir(e.id===void 0?``:O.get(e.id)??``))}function ve(e){B||z===null||(oe(e,z)?(B=!0,U=`ok`,H=y(e,z)||o.faq.acerto,K(e)):(U=`erro`,H=y(e,z)||o.faq.erro),a())}function K(e){V||e.id===void 0||(A=fe(A,e.id),V=!0)}function q(e){return ee(`curado`,e.id)}function J(e){return k.has(q(e))}function Y(e){k=d(p,k,q(e)),a()}function ye(e){return e.icone===``?re:e.icone}function be(e){return pe(A,O,e)}function xe(e){let t=J(e);return i`
  ...
  `}function X(e,t,n,r,a=!1){return i`
  ...
  `}function Se(e){return Math.max(e.findIndex(e=>!e.concluida),0)}function Ce(){if(D.length===0)return i`<p class="vazio">${M?o.app.carregando:o.faq.vazio}</p>`;let e=le(D,F),t=P.busca.trim()===``,n=e=>C(A,e),r=ue(e,n),c=w(A,D),l=Math.round(c/D.length*100),u=t?D.filter(J):[],d=Se(r);return i`
    <div class="faq">
      ...
      <div class="faq__progresso" title=${o.faq.progresso}>
        ...
        <span class="faq__contagem">${c}/${D.length}</span>
      </div>
      ...
      <div class="filtros">
        <kk-input
          ...
          .value=${P.busca}
          @kk-input=${e=>{P={...P,busca:e.target.value},L(P.busca),a()}}
        ></kk-input>
      </div>

      ${e.length===0?i`<p class="vazio">${o.faq.semResultado}</p>`:i`
            <kk-accordion class="faq__categorias">
              ${u.length===0?s:X(o.faq.favoritos,u,!0,u.every(n),!0)}
  ...
  `}function Ee(e){return _e(e),se(e)?i`
    <div class="faq">
      <article class="faq__bloco faq__bloco--impulso">
        <h2 class="faq__secao-titulo">${o.faq.impulso}</h2>
        <div class="prosa">${f(e.impulso)}</div>
        ...
        ${H===``?s:i`<p class="faq__feedback faq__feedback--${U}">${H}</p>`}
  ...
  `:(V||K(e),i`<div class="faq">${Z(e)}</div>`)}function De(e){let t=ae(e);return t.length===0?s:i`
    <article class="faq__bloco">
  ...
  `}function Z(e){return i`
    <div class="faq__final">
      ${be(e)?i`<p class="faq__selo-feito"><kk-icon name="notes"></kk-icon>${o.faq.seloFeito}</p>`:s}
      ...
      ${W.campo({item:e,id:`faq-preparo`,rotulo:o.faq.paraPreparar,placeholder:o.faq.respostaPlaceholder,apoio:e.preparo===``?s:i`<p class="rascunho__apoio">${e.preparo}</p>`})}
  ...
  `}function Q(e){let t=Number(e.args[0]);return Number.isFinite(t)?ge(t):void 0}function $(e){return e.args[1]===`lente`}var Oe={titulo(e){return Q(e)?.titulo},voltarPara(e){let t=Q(e);return t===void 0?`home`:$(e)?`faq/${t.id}`:`faq`},acoes(e){let t=Q(e);if(t===void 0)return;let n=J(t);return i`
      <kk-icon-button
        name="star"
