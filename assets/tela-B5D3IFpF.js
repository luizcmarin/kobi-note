import{$ as e,Q as t,at as n,g as r,nt as i,p as a,rt as o,u as s,x as c,y as l}from"./index-CrGkgQIm.js";import{t as u}from"./compartilhar-Dqe6PcPQ.js";import{DIAS_DA_SEMANA as ee,MESES as d,TIPOS_PUBLICADOR as f,ajustado as p,alternarEnviado as m,carregar as h,comoHorario as g,contadorTemAtividade as _,contadorZerado as v,corDoEstudo as te,deHorario as ne,esfriando as re,estudosVisiveis as ie,excluirEstudo as ae,excluirRegistro as oe,excluirRelatorio as y,horasDoContador as b,iniciais as x,lembreteDoRelatorio as S,mesEAno as C,observacoesDoContador as w,ordenarRelatorios as T,registrosDoEstudo as E,relataHoras as D,salvarContador as O,salvarEstudo as k,salvarRegistro as A,salvarRelatorio as j,textoDoEstudo as se,textoDoRelatorio as ce,ultimoRelativo as le,ultimoRelatorio as M}from"./dados-D05mSlXL.js";var N=[],P=[],F=[],I=null,L=``,R=null,z=null,B=null,V=!1,H=!1;async function U(){let e=await h();N=e.relatorios,P=e.estudos,F=e.registros,I=e.contador,t()}function W(){V||H||(H=!0,(async()=>{try{await U(),V=!0}finally{H=!1,t()}})())}function G(t,r,i,a){return n`
