import{ct as e,gt as t,h as n,it as r,m as i}from"./index-BGY_4f1A.js";import{t as a}from"./qr-Baq6WNsj.js";var o=`https://luizcmarin.github.io/kobi-note`;function s(e=o){return`${r.convite.mensagem}\n\n${e}`}function c(e){return`https://wa.me/?text=${encodeURIComponent(s(e))}`}async function l(e){try{await navigator.clipboard.writeText(s(e)),i(r.convite.copiado)}catch{i(r.leitura.semCopiar,`warning`)}}async function u(e){if(typeof navigator.share!=`function`){await l(e);return}try{await navigator.share({title:t.displayName,text:r.convite.mensagem,url:e})}catch{}}function d(){let i=o;return a(),n(r.convite.titulo,void 0,(n,a)=>e`
        <div class="convite">
          <img
