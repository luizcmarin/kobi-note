import{a as e,i as t,n}from"./dinheiro-CwI0T249.js";import{Z as r,at as i,b as a,ct as o,dt as s,ft as c,g as l,gt as u,m as d,mt as f,rt as ee,st as p,tt as te,y as ne}from"./index-DGzM8AUH.js";import{alternarAtivo as re,alternarPago as ie,carregar as ae,excluirCategoria as oe,excluirRecorrencia as se,excluirTransacao as ce,gerarPendentes as m,paraCategoria as le,paraRecorrencia as ue,paraTransacao as de,salvarCategoria as fe,salvarRecorrencia as pe,salvarTransacao as me}from"./dados-CsbepvgB.js";var he=`🛒.🍕.☕.🏠.💡.💧.🔌.🚌.⛽.🚗.💊.🏥.🩺.👕.🎁.🎮.🎵.📚.🎓.🏖️.💰.💳.🧾.🐾.📱.💼.💇.🧴.🧺.🏋️.🛡️.🧸`.split(`.`);function h(){let e=new Date;return e.setHours(0,0,0,0),e.getTime()}function g(e){return e===``?i():e}function _(e,t){return e.filter(e=>e.vencimento!==0&&i(e.vencimento)===t)}function v(e,t=h()){return e.pago||e.vencimento===0?!1:e.vencimento<t}function y(e){return e===`vencidas`||e===`a-vencer`}function ge(e,t,n=h()){return t===`pagas`?e.pago:t===`vencidas`?v(e,n):t!==`a-vencer`||!e.pago&&!v(e,n)}function b(e,t,n,r=h()){return(y(n)?e:_(e,t)).filter(e=>ge(e,n,r))}function _e(e,t,n,r=h()){let i=b(e,t,n,r);if(!y(n))return i.sort((e,t)=>t.vencimento-e.vencimento);let a=2**53-1;return i.sort((e,t)=>(e.vencimento===0?a:e.vencimento)-(t.vencimento===0?a:t.vencimento))}function x(e){return e.reduce((e,t)=>e+t.valor,0)}function S(e){return e.reduce((e,t)=>e+(t.tipo===`receita`?t.valor:-t.valor),0)}function ve(e){return{realizado:S(e.filter(e=>e.pago)),previsto:S(e)}}function ye(e){return{receitas:x(e.filter(e=>e.tipo===`receita`)),despesas:x(e.filter(e=>e.tipo===`despesa`)),aReceber:x(e.filter(e=>e.tipo===`receita`&&!e.pago)),aPagar:x(e.filter(e=>e.tipo===`despesa`&&!e.pago))}}function be(e){let t=new Map;for(let n of e){let e=t.get(n.categoria)??{receita:0,despesa:0};n.tipo===`receita`?e.receita+=n.valor:e.despesa+=n.valor,t.set(n.categoria,e)}return[...t].map(([e,t])=>({categoria:e,...t})).sort((e,t)=>t.receita+t.despesa-(e.receita+e.despesa))}function xe(e){let t=new Map;for(let n of e)n.tipo===`despesa`&&t.set(n.categoria,(t.get(n.categoria)??0)+n.valor);return[...t].map(([e,t])=>({categoria:e,total:t})).sort((e,t)=>t.total-e.total)}function Se(e,t){let n=new Set([new Date().getFullYear(),Number(t.slice(0,4))]);for(let t of e)t.vencimento!==0&&n.add(new Date(t.vencimento).getFullYear());return[...n].sort((e,t)=>t-e)}function C(e){return te(e===0?Date.now():e)}var Ce=`••••`,we=`R$`,w={descricao:!1,valor:!1,diaMes:!1},T={vista:null,formulario:null,situacao:`vencidas`,pagina:1,mes:``,oculto:!0};function E(e){T.vista!==e&&(T.vista!==null&&(T.formulario=null,T.situacao=`vencidas`,T.pagina=1),T.vista=e)}function Te(){return T.formulario!==null}function D(){T.formulario=null}function Ee(){T.oculto=!0}function De(){T.vista===`transacoes`&&O({especie:`transacao`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,vencimento:C(0),pago:!1}}),T.vista===`categorias`&&O({especie:`categoria`,dados:{id:0,nome:``,icone:``,cor:`#0d6efd`,limite:``,erroNome:!1}}),T.vista===`recorrencias`&&O({especie:`recorrencia`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,periodicidade:`mensal`,diaMes:1,diaSemana:1,gerarComoPago:!1,ativa:!0,lancarCorrente:!1,erros:w}})}function O(e){T.formulario=e,p()}function k(e){return T.oculto?Ce:t(e)}function A(e){return e===0?`—`:r(e)}function Oe(t){return e(Number(t.replace(/\D/g,``)))}function j(e){return[...e].sort((e,t)=>e.nome.localeCompare(t.nome,c(),{sensitivity:`base`}))}function ke(e){return new Date(2001,e-1,1).toLocaleDateString(c(),{month:`long`})}function M(e){return new Date(2001,0,e).toLocaleDateString(c(),{weekday:`long`})}function N(e){return e===`diaria`?s.financeiro.diaria:e===`semanal`?s.financeiro.semanal:e===`anual`?s.financeiro.anual:s.financeiro.mensal}var Ae=[`diaria`,`semanal`,`mensal`,`anual`];function je(e){let{realizado:t,previsto:n}=ve(e.transacoes);return u`
  ...
  `}function P(e){let t=g(T.mes),[n=0,r=1]=t.split(`-`).map(Number),i=(e,t)=>{T.mes=`${e}-${String(t).padStart(2,`0`)}`,T.pagina=1,p()};return u`
    <div class="financeiro-periodo">
      ...
      >
        ${Array.from({length:12},(e,t)=>t+1).map(e=>u`<kk-option value=${e}>${ke(e)}</kk-option>`)}
      </kk-select>
      ...
      >
        ${Se(e.transacoes,t).map(e=>u`<kk-option value=${e}>${e}</kk-option>`)}
      </kk-select>
    </div>
  `}function Me(e){let{receitas:t,despesas:n,aReceber:r,aPagar:i}=ye(e),a=[[t,`receita`,s.financeiro.receitas],[n,`despesa`,s.financeiro.despesas],[r,`aviso`,s.financeiro.aReceber],[i,`aviso`,s.financeiro.aPagar]];return u`
  ...
  `}function Ne(e,t){return e.categorias.find(e=>e.id===t)?.nome??s.financeiro.semCategoria}function F(e,n){let r=be(n);if(r.length===0)return I(`chart-bar`,s.financeiro.semMovimento);let i=Math.max(...r.map(e=>Math.max(e.receita,e.despesa))),a=e=>i<=0||e<=0?`0%`:`${Math.max(1.5,e/i*100)}%`,o=(e,n)=>u`
      ...
      <div class="financeiro-grafico__linhas">
        ${r.map(t=>u`
            <div class="financeiro-grafico__grupo">
              ...
              ${t.receita>0?o(t.receita,`receita`):f}
              ${t.despesa>0?o(t.despesa,`despesa`):f}
            </div>
          `)}
      </div>
    </figure>
  `}function Pe(e,t){let n=xe(t).map(({categoria:t,total:n})=>{let r=e.categorias.find(e=>e.id===t);return{nome:r?.nome??s.financeiro.semCategoria,cor:r?.cor??`var(--kk-color-expense)`,icone:r?.icone??``,limite:r?.limite??0,total:n}});return n.length===0?f:u`
    <h2 class="financeiro__secao">${s.financeiro.limites}</h2>
    <div class="financeiro-limites">
      ${n.map(e=>{let t=e.limite>0&&e.total>e.limite,n=e.limite>0?Math.min(100,e.total/e.limite*100):0;return u`
          <div class="financeiro-limite" ?data-estourou=${t}>
            <span class="financeiro-limite__topo">
              <span class="financeiro-limite__nome">
                ${e.icone===``?f:u`<span>${e.icone}</span>`} ${e.nome}
              </span>
              <span class="financeiro-limite__valores">
                ${k(e.total)}
                ${e.limite===0?f:u`<small>${s.financeiro.deLimite(k(e.limite))}</small>`}
              </span>
            </span>
  ...
  `}function Fe(e,t){let n=[[`transacoes`,`receipt`,s.financeiro.transacoes,e.transacoes.length],[`categorias`,`tags`,s.financeiro.categorias,e.categorias.length],[`recorrencias`,`repeat`,s.financeiro.recorrencias,e.recorrencias.length]];return u`
    <div class="financeiro-atalhos">
      ${n.map(([e,n,r,i])=>u`
          <button class="financeiro-atalho" type="button" @click=${()=>t.navegar(e)}>
            ...
            <span class="financeiro-atalho__resumo">${s.financeiro.registros(i)}</span>
          </button>
        `)}
    </div>
  `}function Ie(e,t){let n=_(e.transacoes,g(T.mes));return u`
    ${Fe(e,t)} ${je(e)} ${P(e)}
    ${Me(n)} ${Pe(e,n)}
    ${T.oculto?u`<p class="financeiro__discreto">${s.financeiro.valoresOcultos}</p>`:F(e,n)}
  `}function I(e,t){return u`
    <div class="financeiro-vazio">
      <kk-icon class="financeiro-vazio__icone" name=${e}></kk-icon>
      <p>${t}</p>
    </div>
  `}function L(e,t,n){return u`
    <kk-input
      label=${t}
      inputmode="numeric"
      .value=${e}
  ...
  `}function R(e,t){let n=[[`receita`,`arrow-up`,s.financeiro.receita],[`despesa`,`arrow-down`,s.financeiro.despesa]];return u`
    <div>
  ...
  `}function V(e,t){D(),p(),e.salvar(t)}function Le(e,t,r){let i=e=>{T.formulario={especie:`transacao`,dados:{...r,...e}},p()};return u`
    <div class="financeiro-formulario">
      ...
      ${L(r.valor,s.financeiro.valor,e=>i({valor:e}))}
      ${R(r.tipo,e=>i({tipo:e}))}
  ...
  `}function Re(e){let t=g(T.mes),n=[[`vencidas`,s.financeiro.vencidas],[`a-vencer`,s.financeiro.aVencer],[`pagas`,s.financeiro.pagas],[`todas`,s.financeiro.todas]];return u`
  ...
  `}function ze(e,t){return e<=20?f:u`
    <kk-pagination
    ...
    ></kk-pagination>
  `}function Be(e){return T.situacao===`vencidas`?s.financeiro.nenhumaVencida:T.situacao===`a-vencer`?s.financeiro.nadaAVencer:_(e.transacoes,g(T.mes)).length===0?s.financeiro.nenhumaNoMes:s.financeiro.nadaPagoNoMes}function Ve(t,n){if(t.transacoes.length===0)return I(`receipt`,s.financeiro.nenhumaTransacao);let r=u`
    ${Re(t)}
    ${y(T.situacao)?f:P(t)}
  `,i=_e(t.transacoes,g(T.mes),T.situacao);if(i.length===0)return u`${r} ${I(`filter`,Be(t))}`;let a=Math.ceil(i.length/20),o=Math.min(T.pagina,a),c=i.slice((o-1)*20,o*20);return u`
    ${r}
    <div class="financeiro-registros">
      ${c.map(r=>{let i=r.tipo===`receita`,a=t.categorias.find(e=>e.id===r.categoria),o=a!==void 0&&a.cor!==``?a.cor:i?`var(--kk-color-income)`:`var(--kk-color-expense)`;return u`
          <div class="financeiro-registro" data-status=${r.pago?`ok`:`pendente`}>
            ...
            >
              ${a===void 0||a.icone===``?u`<kk-icon name=${i?`arrow-up`:`arrow-down`}></kk-icon>`:a.icone}
            </span>
    ...
    ${ze(i.length,o)}
  `}function He(e,t){let r=e=>{T.formulario={especie:`categoria`,dados:{...t,...e}},p()};return u`
    <div class="financeiro-formulario">
      <h2 class="financeiro-formulario__titulo">
  ...
  `}function Ue(t,n){return t.categorias.length===0?I(`tags`,s.financeiro.nenhumaCategoria):u`
    <div class="financeiro-categorias">
      ${j(t.categorias).map(t=>u`
  ...
  `}function We(e){let t=N(e.periodicidade);return e.periodicidade===`mensal`?`${t} · ${s.financeiro.diaN(e.diaMes)}`:e.periodicidade===`semanal`?`${t} · ${M(e.diaSemana)}`:t}function Ge(e,t,r){let i=e=>{T.formulario={especie:`recorrencia`,dados:{...r,...e}},p()};return u`
    <div class="financeiro-formulario">
      <h2 class="financeiro-formulario__titulo">
      ...
      ${L(r.valor,s.financeiro.valor,e=>i({valor:e,erros:{...r.erros,valor:!1}}))}
      ${r.erros.valor?u`<p class="financeiro__erro">${s.financeiro.valorObrigatorio}</p>`:f}
      ${R(r.tipo,e=>i({tipo:e}))}
      ${z(e,r.categoria,e=>i({categoria:e}))}
      ...
      >
        ${Ae.map(e=>u`<kk-option value=${e}>${N(e)}</kk-option>`)}
      </kk-select>

      ${r.periodicidade===`mensal`?u`
            <kk-input
              type="number"
              min="1"
              max="31"
  ...
  `}function Ke(t,n){return t.recorrencias.length===0?I(`repeat`,s.financeiro.nenhumaRecorrencia):u`
    <div class="financeiro-registros">
      ${t.recorrencias.map(t=>{let r=t.tipo===`receita`;return u`
  ...
  `}function qe(e,t){let n=T.formulario;return n===null?e.vista===`transacoes`?Ve(e,t):e.vista===`categorias`?Ue(e,t):e.vista===`recorrencias`?Ke(e,t):Ie(e,t):n.especie===`transacao`?Le(e,t,n.dados):n.especie===`categoria`?He(t,n.dados):Ge(e,t,n.dados)}function Je(e,t){return E(e.vista),u`<div class="financeiro">${qe(e,t)}</div>`}var H=[],U=[],W=[],G=!1,K=!1,q=!1,J=null;async function Y(){let e=await ae();H=e.categorias,U=e.transacoes,W=e.recorrencias,p()}function X(){K||q||J!==null||(q=!0,(async()=>{try{await Y(),await m(W)&&await Y(),K=!0}catch(e){console.error(`financeiro: a carga falhou.`,e),J=a(e)}finally{q=!1,p()}})())}function Ye(){J=null,X(),p()}function Z(e){let t=e.args[0];return t===`transacoes`||t===`categorias`||t===`recorrencias`?t:`painel`}function Xe(){G||(Ee(),G=!0,Ze())}var Q=!1;function Ze(){Q||(Q=!0,addEventListener(`hashchange`,()=>{location.hash.replace(/^#\/?/,``).split(`/`)[0]!==`financeiro`&&(G=!1,D())}))}function $(e,t){return t>0?e.find(e=>e.id===t):void 0}async function Qe(e){try{if(e.especie===`transacao`){await me(e.registro,$(U,e.registro.id)),d(s.financeiro.transacaoSalva),await Y();return}if(e.especie===`categoria`){await fe(e.registro),d(s.financeiro.categoriaSalva),await Y();return}await pe(e.registro,$(W,e.registro.id)),d(s.financeiro.recorrenciaSalva),await Y(),await m(W)&&await Y()}catch(e){console.error(`Financeiro: a gravação falhou.`,e),d(s.financeiro.naoSalvo,`danger`)}}function $e(e){return e===`transacao`?{titulo:s.financeiro.excluirTransacao,texto:s.acervo.excluirTexto,feito:s.financeiro.transacaoExcluida,excluir:ce}:e===`categoria`?{titulo:s.financeiro.excluirCategoria,texto:s.financeiro.excluirCategoriaTexto,feito:s.financeiro.categoriaExcluida,excluir:oe}:{titulo:s.financeiro.excluirRecorrencia,texto:s.financeiro.excluirRecorrenciaTexto,feito:s.financeiro.recorrenciaExcluida,excluir:se}}async function et(e){let t=$e(e.especie);if(await l({titulo:t.titulo,texto:t.texto,rotuloConfirmar:s.acoes.excluir,variante:`danger`})){try{await t.excluir(e.registro.id)}catch(e){console.error(`Financeiro: a exclusão falhou.`,e),d(s.financeiro.naoExcluido,`danger`);return}d(t.feito),await Y()}}async function tt(e){try{if(e.especie===`transacao`){let t=$(U,e.registro.id);t!==void 0&&await nt(t)&&await ie(t)}if(e.especie===`recorrencia`){let t=$(W,e.registro.id);t!==void 0&&await re(t)}}catch(e){console.error(`Financeiro: a alteração falhou.`,e),d(s.financeiro.naoAlterado,`danger`);return}await Y()}function nt(e){if(e.esta_pago===1)return l({titulo:s.financeiro.estornar,texto:s.financeiro.estornarTexto(e.descricao),rotuloConfirmar:s.acoes.confirmar,variante:`warning`});let n=e.tipo===0,r=t(e.valor);return l({titulo:n?s.financeiro.receber:s.financeiro.pagar,texto:n?s.financeiro.receberTexto(e.descricao,r):s.financeiro.pagarTexto(e.descricao,r),rotuloConfirmar:s.acoes.confirmar,variante:`primary`})}function rt(e){if(e===`transacoes`)return s.financeiro.transacoes;if(e===`categorias`)return s.financeiro.categorias;if(e===`recorrencias`)return s.financeiro.recorrencias}function it(e){return e===`transacoes`?s.financeiro.novaTransacao:e===`categorias`?s.financeiro.novaCategoria:s.financeiro.novaRecorrencia}var at={voltarPara(e){return Z(e)===`painel`?`home`:`financeiro`},titulo(e){return rt(Z(e))},acoes(e){let t=Z(e);if(E(t),!(t===`painel`||Te()))return u`
      <kk-icon-button name="plus" label=${it(t)} @click=${De}></kk-icon-button>
    `},conteudo(e){return X(),J===null?(Xe(),K?Je({vista:Z(e),categorias:H.map(le),transacoes:U.map(de),recorrencias:W.map(ue)},{navegar:e=>o(`financeiro/${e}`),salvar:e=>void Qe(e),excluir:e=>void et(e),alternar:e=>void tt(e)}):u`<div class="carregando"><kk-spinner></kk-spinner></div>`):ne(J,Ye)}};export{at as telaFinanceiro};