import{bt as e,ct as t,ft as n,m as r,u as i}from"./index-BBOYxO_i.js";import{t as a}from"./qr-bTL_4I0_.js";var o=`https://luizcmarin.github.io/kobi-note`;function s(e=o){return`${t.convite.mensagem}\n\n${e}`}function c(e){return`https://wa.me/?text=${encodeURIComponent(s(e))}`}async function l(e){try{await navigator.clipboard.writeText(s(e)),i(t.convite.copiado)}catch{i(t.leitura.semCopiar,`warning`)}}async function u(n){if(typeof navigator.share!=`function`){await l(n);return}try{await navigator.share({title:e.displayName,text:t.convite.mensagem,url:n})}catch{}}function d(){let i=o;return a(),r(t.convite.titulo,void 0,(r,a)=>n`
        <div class="convite">
          <img
